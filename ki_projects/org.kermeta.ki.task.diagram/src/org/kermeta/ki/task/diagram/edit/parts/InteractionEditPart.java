...
import org.kermeta.ki.task.diagram.edit.policies.InteractionItemSemanticEditPolicy;
...
public class InteractionEditPart extends ShapeNodeEditPart {
		...
		if (childEditPart instanceof InteractionNameEditPart) {
			((InteractionNameEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureInteractionNameFigure());
			return true;
		}
		if (childEditPart instanceof InteractionOperationEditPart) {
			((InteractionOperationEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureUnaryOpLabelInter());
			return true;
		}
		return false;
	}
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof org.kermeta.ki.task.diagram.edit.parts.InteractionEditPart) {
			types.add(TaskElementTypes.Enabling_4001);
		}
	...
	public class InteractionFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureUnaryOpLabelInter;
		...
		private void createContents() {
			...
			RectangleFigure recInterUnary0 = new RectangleFigure();
			recInterUnary0.setFill(false);
			recInterUnary0.setOutline(false);
			recInterUnary0.setLineWidth(0);

			this.add(recInterUnary0);

			ToolbarLayout layoutRecInterUnary0 = new ToolbarLayout();
			layoutRecInterUnary0.setStretchMinorAxis(false);
			layoutRecInterUnary0.setMinorAlignment(ToolbarLayout.ALIGN_TOPLEFT);

			layoutRecInterUnary0.setSpacing(5);
			layoutRecInterUnary0.setVertical(false);

			recInterUnary0.setLayoutManager(layoutRecInterUnary0);

			SVGFigure interaction1 = new SVGFigure();
			interaction1
					.setURI("platform:/plugin/org.kermeta.ki.task/resources/interaction.svg");
			interaction1.setPreferredSize(new Dimension(getMapMode()
					.DPtoLP(100), getMapMode().DPtoLP(100)));

			recInterUnary0.add(interaction1);

			fFigureUnaryOpLabelInter = new WrappingLabel();
			fFigureUnaryOpLabelInter.setText(" ");

			recInterUnary0.add(fFigureUnaryOpLabelInter);

			fFigureInteractionNameFigure = new WrappingLabel();
			fFigureInteractionNameFigure.setText("<...>");

			this.add(fFigureInteractionNameFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureUnaryOpLabelInter() {
			return fFigureUnaryOpLabelInter;
		}
