...
public class EnablingCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public EnablingCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return TaskBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateEnabling_4001(getContainer(), getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		Enabling newElement = TaskFactory.eINSTANCE.createEnabling();
	 ...
	 * @generated
	 */
	protected void doConfigure(Enabling newElement, IProgressMonitor monitor,
			IAdaptable info) throws ExecutionException {
