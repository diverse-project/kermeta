 ...
 * @generated
 */
public class Interleaving2ReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public Interleaving2ReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof Interleaving) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return TaskBaseItemSemanticEditPolicy.LinkConstraints
				.canExistInterleaving_4003(container, getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		TaskModel container = (TaskModel) getLink().eContainer();
		return TaskBaseItemSemanticEditPolicy.LinkConstraints
				.canExistInterleaving_4003(container, source, getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected Interleaving getLink() {
		return (Interleaving) getElementToEdit();
	}
