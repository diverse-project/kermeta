...
import org.kermeta.ki.task.diagram.part.Messages;
...
public class TaskNavigatorContentProvider implements ICommonContentProvider {
	...
	public Object[] getChildren(Object parentElement) {
		if (parentElement instanceof IFile) {
			...
			result.addAll(createNavigatorItems(selectViewsByType(resource
					.getContents(), TaskModelEditPart.MODEL_ID), file, false));
	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case TaskModelEditPart.VISUAL_ID: {
			...
			TaskNavigatorGroup links = new TaskNavigatorGroup(
					Messages.NavigatorGroupName_TaskModel_1000_links,
					"icons/linksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getChildrenByType(Collections
					.singleton(view), TaskVisualIDRegistry
					.getType(UserEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(Collections.singleton(view),
					TaskVisualIDRegistry.getType(InteractionEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(Collections.singleton(view),
					TaskVisualIDRegistry.getType(ApplicationEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(Collections.singleton(view),
					TaskVisualIDRegistry.getType(AbstractEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getDiagramLinksByType(Collections.singleton(view),
					TaskVisualIDRegistry.getType(EnablingEditPart.VISUAL_ID));
			links
		...
		case UserEditPart.VISUAL_ID: {
			...
			Collection connectedViews = getIncomingLinksByType(Collections
					.singleton(view), TaskVisualIDRegistry
					.getType(EnablingEditPart.VISUAL_ID));
			incominglinks.addChildren(createNavigatorItems(connectedViews,
					incominglinks, true));
			connectedViews = getOutgoingLinksByType(
					Collections.singleton(view), TaskVisualIDRegistry
							.getType(EnablingEditPart.VISUAL_ID));
		...
		case InteractionEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			TaskNavigatorGroup incominglinks = new TaskNavigatorGroup(
					Messages.NavigatorGroupName_Interaction_2002_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			TaskNavigatorGroup outgoinglinks = new TaskNavigatorGroup(
					Messages.NavigatorGroupName_Interaction_2002_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getIncomingLinksByType(Collections
					.singleton(view), TaskVisualIDRegistry
					.getType(EnablingEditPart.VISUAL_ID));
		...
		case ApplicationEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			TaskNavigatorGroup incominglinks = new TaskNavigatorGroup(
					Messages.NavigatorGroupName_Application_2003_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			TaskNavigatorGroup outgoinglinks = new TaskNavigatorGroup(
					Messages.NavigatorGroupName_Application_2003_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getIncomingLinksByType(Collections
					.singleton(view), TaskVisualIDRegistry
					.getType(EnablingEditPart.VISUAL_ID));
		...
		case AbstractEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			TaskNavigatorGroup incominglinks = new TaskNavigatorGroup(
					Messages.NavigatorGroupName_Abstract_2004_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			TaskNavigatorGroup outgoinglinks = new TaskNavigatorGroup(
					Messages.NavigatorGroupName_Abstract_2004_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getIncomingLinksByType(Collections
					.singleton(view), TaskVisualIDRegistry
					.getType(EnablingEditPart.VISUAL_ID));
		...
		case EnablingEditPart.VISUAL_ID: {
			...
			TaskNavigatorGroup target = new TaskNavigatorGroup(
					Messages.NavigatorGroupName_Enabling_4001_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			TaskNavigatorGroup source = new TaskNavigatorGroup(
					Messages.NavigatorGroupName_Enabling_4001_source,
			...
			connectedViews = getLinksSourceByType(Collections.singleton(view),
					TaskVisualIDRegistry.getType(UserEditPart.VISUAL_ID));
		...
		case EnablingWithInformationEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			TaskNavigatorGroup target = new TaskNavigatorGroup(
					Messages.NavigatorGroupName_EnablingWithInformation_4002_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			TaskNavigatorGroup source = new TaskNavigatorGroup(
					Messages.NavigatorGroupName_EnablingWithInformation_4002_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getLinksTargetByType(Collections
					.singleton(view), TaskVisualIDRegistry
					.getType(UserEditPart.VISUAL_ID));
		...
		case Interleaving2EditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			TaskNavigatorGroup target = new TaskNavigatorGroup(
					Messages.NavigatorGroupName_Interleaving_4003_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			TaskNavigatorGroup source = new TaskNavigatorGroup(
					Messages.NavigatorGroupName_Interleaving_4003_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getLinksTargetByType(Collections
					.singleton(view), TaskVisualIDRegistry
					.getType(UserEditPart.VISUAL_ID));
		...
		case InterleavingEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			TaskNavigatorGroup target = new TaskNavigatorGroup(
					Messages.NavigatorGroupName_Synchronization_4004_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			TaskNavigatorGroup source = new TaskNavigatorGroup(
					Messages.NavigatorGroupName_Synchronization_4004_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getLinksTargetByType(Collections
					.singleton(view), TaskVisualIDRegistry
					.getType(UserEditPart.VISUAL_ID));
		...
		case DesactivationEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			TaskNavigatorGroup target = new TaskNavigatorGroup(
					Messages.NavigatorGroupName_Desactivation_4005_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			TaskNavigatorGroup source = new TaskNavigatorGroup(
					Messages.NavigatorGroupName_Desactivation_4005_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getLinksTargetByType(Collections
					.singleton(view), TaskVisualIDRegistry
					.getType(UserEditPart.VISUAL_ID));
		...
		case TaskSubtasksEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			TaskNavigatorGroup target = new TaskNavigatorGroup(
					Messages.NavigatorGroupName_TaskSubtasks_4006_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			TaskNavigatorGroup source = new TaskNavigatorGroup(
					Messages.NavigatorGroupName_TaskSubtasks_4006_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getLinksTargetByType(Collections
					.singleton(view), TaskVisualIDRegistry
					.getType(UserEditPart.VISUAL_ID));
	...
	private Collection createNavigatorItems(Collection views, Object parent,
		...
		for (Iterator it = views.iterator(); it.hasNext();) {
			result
					.add(new TaskNavigatorItem((View) it.next(), parent,
							isLeafs));
		}
		return result;
	}
