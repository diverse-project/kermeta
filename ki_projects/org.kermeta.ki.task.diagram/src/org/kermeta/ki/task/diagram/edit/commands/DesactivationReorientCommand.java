 ...
 * @generated
 */
public class DesactivationReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public DesactivationReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof org.kermeta.ki.task.desactivation) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return TaskBaseItemSemanticEditPolicy.LinkConstraints
				.canExistDesactivation_4005(container, getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		TaskModel container = (TaskModel) getLink().eContainer();
		return TaskBaseItemSemanticEditPolicy.LinkConstraints
				.canExistDesactivation_4005(container, source, getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected org.kermeta.ki.task.desactivation getLink() {
		return (org.kermeta.ki.task.desactivation) getElementToEdit();
	}
