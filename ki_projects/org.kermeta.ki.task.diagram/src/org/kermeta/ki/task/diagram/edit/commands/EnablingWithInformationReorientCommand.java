 ...
 * @generated
 */
public class EnablingWithInformationReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public EnablingWithInformationReorientCommand(
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof EnablingWithInformation) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return TaskBaseItemSemanticEditPolicy.LinkConstraints
				.canExistEnablingWithInformation_4002(container,
						getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		TaskModel container = (TaskModel) getLink().eContainer();
		return TaskBaseItemSemanticEditPolicy.LinkConstraints
				.canExistEnablingWithInformation_4002(container, source,
						getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected EnablingWithInformation getLink() {
		return (EnablingWithInformation) getElementToEdit();
	}
