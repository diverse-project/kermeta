 ...
 * @generated
 */
public class TaskSubtasksCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public TaskSubtasksCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return TaskBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateTaskSubtasks_4006(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getSubtasks().add(getTarget());
		}
