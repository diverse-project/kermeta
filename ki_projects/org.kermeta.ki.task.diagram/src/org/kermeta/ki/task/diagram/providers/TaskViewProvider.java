...
public class TaskViewProvider extends AbstractProvider implements IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return TaskModelEditPart.MODEL_ID.equals(op.getSemanticHint())
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = TaskVisualIDRegistry.getNodeVisualID(op
		...
		return UserEditPart.VISUAL_ID == visualID
				|| InteractionEditPart.VISUAL_ID == visualID
				|| ApplicationEditPart.VISUAL_ID == visualID
				|| AbstractEditPart.VISUAL_ID == visualID;
	}
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(TaskModelEditPart.MODEL_ID);
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		case InteractionEditPart.VISUAL_ID:
			return createInteraction_2002(domainElement, containerView, index,
					persisted, preferencesHint);
		case ApplicationEditPart.VISUAL_ID:
			return createApplication_2003(domainElement, containerView, index,
					persisted, preferencesHint);
		case AbstractEditPart.VISUAL_ID:
			return createAbstract_2004(domainElement, containerView, index,
					persisted, preferencesHint);
		}
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		case EnablingEditPart.VISUAL_ID:
			return createEnabling_4001(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		case EnablingWithInformationEditPart.VISUAL_ID:
			return createEnablingWithInformation_4002(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case Interleaving2EditPart.VISUAL_ID:
			return createInterleaving_4003(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		case InterleavingEditPart.VISUAL_ID:
			return createSynchronization_4004(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case DesactivationEditPart.VISUAL_ID:
			return createDesactivation_4005(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case TaskSubtasksEditPart.VISUAL_ID:
			return createTaskSubtasks_4006(containerView, index, persisted,
					preferencesHint);
		}
	...
	public Node createUser_2001(EObject domainElement, View containerView,
		...
		node.setType(TaskVisualIDRegistry.getType(UserEditPart.VISUAL_ID));
		...
		Node label5001 = createLabel(node, TaskVisualIDRegistry
				.getType(UserNameEditPart.VISUAL_ID));
		Node label5002 = createLabel(node, TaskVisualIDRegistry
				.getType(UserOperationEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createInteraction_2002(EObject domainElement,
		...
		ViewUtil.setStructuralFeatureValue(node, NotationPackage.eINSTANCE
				.getFillStyle_FillColor(), FigureUtilities
				.RGBToInteger(fillRGB));
		Node label5003 = createLabel(node, TaskVisualIDRegistry
				.getType(InteractionNameEditPart.VISUAL_ID));
		Node label5004 = createLabel(node, TaskVisualIDRegistry
				.getType(InteractionOperationEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createApplication_2003(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		...
		ViewUtil.setStructuralFeatureValue(node, NotationPackage.eINSTANCE
				.getFillStyle_FillColor(), FigureUtilities
				.RGBToInteger(fillRGB));
		Node label5005 = createLabel(node, TaskVisualIDRegistry
				.getType(ApplicationNameEditPart.VISUAL_ID));
		Node label5006 = createLabel(node, TaskVisualIDRegistry
				.getType(ApplicationOperationEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createAbstract_2004(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(TaskVisualIDRegistry.getType(AbstractEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
		...
		ViewUtil.setStructuralFeatureValue(node, NotationPackage.eINSTANCE
				.getFillStyle_FillColor(), FigureUtilities
				.RGBToInteger(fillRGB));
		Node label5007 = createLabel(node, TaskVisualIDRegistry
				.getType(AbstractNameEditPart.VISUAL_ID));
		Node label5008 = createLabel(node, TaskVisualIDRegistry
				.getType(AbstractOperationEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Edge createEnabling_4001(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		...
		edge.setType(TaskVisualIDRegistry.getType(EnablingEditPart.VISUAL_ID));
		...
		Node label6001 = createLabel(edge, TaskVisualIDRegistry
	 ...
	 * @generated
	 */
	public Edge createEnablingWithInformation_4002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		edge.setType(TaskVisualIDRegistry
				.getType(EnablingWithInformationEditPart.VISUAL_ID));
		edge.setElement(domainElement);
		// initializePreferences
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
				.getPreferenceStore();
		...
		Node label6002 = createLabel(edge, TaskVisualIDRegistry
	 ...
	 * @generated
	 */
	public Edge createInterleaving_4003(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(TaskVisualIDRegistry
				.getType(Interleaving2EditPart.VISUAL_ID));
		edge.setElement(domainElement);
		// initializePreferences
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
				.getPreferenceStore();
		...
		Node label6003 = createLabel(edge, TaskVisualIDRegistry
	 ...
	 * @generated
	 */
	public Edge createSynchronization_4004(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(TaskVisualIDRegistry
				.getType(InterleavingEditPart.VISUAL_ID));
		edge.setElement(domainElement);
		// initializePreferences
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
				.getPreferenceStore();
		...
		Node label6004 = createLabel(edge, TaskVisualIDRegistry
	 ...
	 * @generated
	 */
	public Edge createDesactivation_4005(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(TaskVisualIDRegistry
				.getType(DesactivationEditPart.VISUAL_ID));
		edge.setElement(domainElement);
		// initializePreferences
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
				.getPreferenceStore();
		...
		Node label6005 = createLabel(edge, TaskVisualIDRegistry
	 ...
	 * @generated
	 */
	public Edge createTaskSubtasks_4006(View containerView, int index,
		...
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(TaskVisualIDRegistry
				.getType(TaskSubtasksEditPart.VISUAL_ID));
	...
	private void stampShortcut(View containerView, Node target) {
		if (!TaskModelEditPart.MODEL_ID.equals(TaskVisualIDRegistry
			...
			shortcutAnnotation.getDetails().put(
					"modelID", TaskModelEditPart.MODEL_ID); //$NON-NLS-1$
