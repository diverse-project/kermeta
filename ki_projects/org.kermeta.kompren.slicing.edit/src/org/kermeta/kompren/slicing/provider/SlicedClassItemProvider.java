...
/**
 * This is the item provider adapter for a {@link org.kermeta.kompren.slicing.SlicedClass} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SlicedClassItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SlicingPackage.Literals.SLICED_CLASS__DOMAIN,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SlicingPackage.Literals.SLICED_CLASS__CTX);
		}
	...
	public String getText(Object object) {
		final SlicedClass slicedClass = (SlicedClass)object;
		final EClass domain = slicedClass.getDomain();
		
		return getString("_UI_SlicedClass_type") + (domain==null ? "" : " " + domain.getName());
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SlicingPackage.Literals.SLICED_CLASS__CTX,
