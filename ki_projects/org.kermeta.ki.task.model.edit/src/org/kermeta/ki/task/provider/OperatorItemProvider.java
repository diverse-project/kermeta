...
/**
 * This is the item provider adapter for a {@link org.kermeta.ki.task.Operator} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Operator_src_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Operator_src_feature", "_UI_Operator_type"),
				 TaskPackage.Literals.OPERATOR__SRC,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addTargetPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Operator_target_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Operator_target_feature", "_UI_Operator_type"),
				 TaskPackage.Literals.OPERATOR__TARGET,
				 true,
				 false,
				 true,
				 null,
