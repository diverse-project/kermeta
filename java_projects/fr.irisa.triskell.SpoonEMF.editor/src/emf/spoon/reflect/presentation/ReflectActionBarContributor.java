...
/**
 * This is the action bar contributor for the Reflect model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ReflectActionBarContributor
	 ...
	 * @generated
	 */
	public ReflectActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("reflect-settings"));
		toolBarManager.add(new Separator("reflect-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(Java5EditorPlugin.INSTANCE.getString("_UI_ReflectEditor_menu"), "emf.spoon.reflectMenuID");
