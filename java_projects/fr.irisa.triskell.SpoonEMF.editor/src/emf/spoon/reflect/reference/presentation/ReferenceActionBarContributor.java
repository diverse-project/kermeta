...
/**
 * This is the action bar contributor for the Reference model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ReferenceActionBarContributor
	...
	protected IAction showPropertiesViewAction =
		new Action(Java5EditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
			public void run() {
				try {
	...
	protected IAction refreshViewerAction =
		new Action(Java5EditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
	 ...
	 * @generated
	 */
	public ReferenceActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("reference-settings"));
		toolBarManager.add(new Separator("reference-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(Java5EditorPlugin.INSTANCE.getString("_UI_ReferenceEditor_menu"), "emf.spoon.reflect.referenceMenuID");
		...
		//
		createChildMenuManager = new MenuManager(Java5EditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		submenuManager.insertBefore("additions", createChildMenuManager);

		// Prepare for CreateSibling item addition or removal.
		//
		createSiblingMenuManager = new MenuManager(Java5EditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
	...
	public void menuAboutToShow(IMenuManager menuManager) {
		...
		submenuManager = new MenuManager(Java5EditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		populateManager(submenuManager, createChildSubmenuActions, null);
		populateManager(submenuManager, createChildActions, null);
		menuManager.insertBefore("edit", submenuManager);

		submenuManager = new MenuManager(Java5EditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
