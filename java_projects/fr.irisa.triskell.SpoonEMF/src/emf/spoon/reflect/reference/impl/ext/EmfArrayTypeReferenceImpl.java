...
public class EmfArrayTypeReferenceImpl extends CtArrayTypeReferenceImpl {
	...
	public <A extends Annotation> A getAnnotation(Class<A> annotationType) {
		return (A) getActualClass().getAnnotation(annotationType);
	...
	public void setComponentType(CtTypeReference componentType) {
		this.componentType = (emf.spoon.reflect.reference.CtTypeReference) componentType;
	}
