...
import emf.spoon.reflect.code.impl.CtReturnImpl;

public class EmfReturnImpl extends CtReturnImpl {

	public void accept(CtVisitor visitor) {
		visitor.visitCtReturn(this);
	}
	
	public void setReturnedExpression(CtExpression returnedExpression) {
		this.setReturnedExpression((emf.spoon.reflect.code.CtExpression) returnedExpression);
