...
import emf.spoon.reflect.declaration.impl.CtInterfaceImpl;

public class EmfInterfaceImpl extends CtInterfaceImpl {
...
public CtMethod getMethod(CtTypeReference returnType, String name, CtTypeReference... parameterTypes) {
	...
	public EClass eClass() {
		return DeclarationPackage.eINSTANCE.getCtInterface();
