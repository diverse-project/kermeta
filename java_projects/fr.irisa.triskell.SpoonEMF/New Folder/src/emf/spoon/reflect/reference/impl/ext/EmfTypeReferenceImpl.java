...
import emf.spoon.reflect.reference.impl.CtTypeReferenceImpl;

public class EmfTypeReferenceImpl extends CtTypeReferenceImpl {
	...
	public boolean isSubtypeOf(CtTypeReference type){
        ...
        if (t1 == null && t2 == null) {
                ...
                Class<?> c1;
				try {
					c1 = Class.forName(this.getQualifiedName());
					Class<?> c2 = Class.forName(type.getQualifiedName());
	                return c2.isAssignableFrom(c1);
	                
				} catch (ClassNotFoundException e) {
					System.err.println("warning, the class you are parsed are not in your classpath");
					return false;
				}
