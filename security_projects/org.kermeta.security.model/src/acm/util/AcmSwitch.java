 ...
 * </copyright>
 *
 * $Id: AcmSwitch.java,v 1.1 2008-02-20 14:16:35 ffleurey Exp $
 */
package acm.util;
...
public class AcmSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case AcmPackage.POLICY_TYPE: {
				PolicyType policyType = (PolicyType)theEObject;
				T result = casePolicyType(policyType);
				if (result == null) result = caseNamedElement(policyType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AcmPackage.NAMED_ELEMENT: {
				NamedElement namedElement = (NamedElement)theEObject;
				T result = caseNamedElement(namedElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AcmPackage.RULE_TYPE: {
				RuleType ruleType = (RuleType)theEObject;
				T result = caseRuleType(ruleType);
				if (result == null) result = caseNamedElement(ruleType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AcmPackage.ELEMENT_TYPE: {
			...
			case AcmPackage.POLICY: {
				Policy policy = (Policy)theEObject;
				T result = casePolicy(policy);
				if (result == null) result = caseElementType(policy);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Policy Type</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Policy Type</em>'.
