 ...
 * <ul>
 *   <li>{@link org.kermeta.kp.impl.StringExpressionImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StringExpressionImpl extends ExpressionImpl implements StringExpression {
	...
	protected EClass eStaticClass() {
		return KpPackage.Literals.STRING_EXPRESSION;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KpPackage.STRING_EXPRESSION__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case KpPackage.STRING_EXPRESSION__VALUE:
				return getValue();
		}
