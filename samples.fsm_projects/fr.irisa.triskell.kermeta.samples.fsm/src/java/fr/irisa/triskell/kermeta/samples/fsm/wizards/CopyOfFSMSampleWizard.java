...
public class CopyOfFSMSampleWizard extends Wizard implements INewWizard {
	...
	private void throwCoreException(String message) throws CoreException {
		IStatus status =
			new Status(IStatus.ERROR, "fr.irisa.triskell.kermeta.samples.fsm.core", IStatus.OK, message, null);
