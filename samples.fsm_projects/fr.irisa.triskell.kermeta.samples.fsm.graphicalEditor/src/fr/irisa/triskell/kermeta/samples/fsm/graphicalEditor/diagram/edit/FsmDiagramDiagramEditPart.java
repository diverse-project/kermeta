...
import fr.irisa.triskell.kermeta.samples.fsm.graphicalEditor.diagram.figures.FsmDiagramDiagramFigure;
import fr.irisa.triskell.kermeta.samples.fsm.graphicalEditor.diagram.policies.FsmDiagramDiagramLayoutEditPolicy;
...
public class FsmDiagramDiagramEditPart extends DiagramEditPart {
	...
	protected EditPolicy getLayoutEditPolicy() {
		return new FsmDiagramDiagramLayoutEditPolicy();
	}
	...
	protected IFigure createBodyFigure() {
		return new FsmDiagramDiagramFigure();
	}
