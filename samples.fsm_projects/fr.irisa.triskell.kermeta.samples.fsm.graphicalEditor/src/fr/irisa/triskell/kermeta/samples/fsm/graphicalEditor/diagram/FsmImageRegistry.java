...
public final class FsmImageRegistry {
	 ...
	 * @generated
	 */
	public static final String BUNDLE = "fr.irisa.triskell.kermeta.samples.fsm.graphicalEditor.diagram.images";
	...
	public static Image getImage(String key) {
		return ImageRegistry.getInstance().get(
				FsmPlugin.getDefault().getBundle(), getImageLocation(key));
	}
