 ...
 * </p>
 *
 * @see fsm.FsmDemoPackage#getTransition()
 * @model
 * @generated
 */
public interface Transition extends EObject {
	 ...
	 * @see #setSource(State)
	 * @see fsm.FsmDemoPackage#getTransition_Source()
	 ...
	 * @see #setTarget(State)
	 * @see fsm.FsmDemoPackage#getTransition_Target()
	 ...
	 * @see #setInput(String)
	 * @see fsm.FsmDemoPackage#getTransition_Input()
	 ...
	 * @see fsm.FsmDemoPackage#getTransition_Output()
	 * @model dataType="fsm.String"
	 * @generated
	 */
	String getOutput();
