...
public class StateName2EditPart extends CompartmentEditPart implements
	...
	public void setLabelText(String text) {
		...
		if (pdEditPolicy instanceof FsmTextSelectionEditPolicy) {
			((FsmTextSelectionEditPolicy) pdEditPolicy).refreshFeedback();
		}
		Object sfEditPolicy = getEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE);
		if (sfEditPolicy instanceof FsmTextSelectionEditPolicy) {
			((FsmTextSelectionEditPolicy) sfEditPolicy).refreshFeedback();
		}
	}
		...
		if (parser == null) {
			parser = FsmParserProvider
					.getParser(
							...
							getParserElement(),
							FsmVisualIDRegistry
									.getType(fsm.diagram.edit.parts.StateName2EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, TextDirectEditManager
					.getTextCellEditorClass(this), FsmEditPartFactory
