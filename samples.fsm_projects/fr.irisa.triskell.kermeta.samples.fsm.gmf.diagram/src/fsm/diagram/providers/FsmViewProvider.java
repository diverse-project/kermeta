...
public class FsmViewProvider extends AbstractProvider implements IViewProvider {
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = FsmVisualIDRegistry.getNodeVisualID(op
	...
	public Node createState_2001(EObject domainElement, View containerView,
		...
		node.setType(FsmVisualIDRegistry.getType(StateEditPart.VISUAL_ID));
		...
		Node label5001 = createLabel(node, FsmVisualIDRegistry
				.getType(StateNameEditPart.VISUAL_ID));
		Node label5002 = createLabel(node, FsmVisualIDRegistry
