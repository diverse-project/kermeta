...
import org.kermeta.art2.framework.message.Art2BindMessage
import scala.collection.JavaConversions._

class Art2RequirePortRemoteClient(bindmsg : Art2BindMessage,modelHandler : Art2ModelHandlerService,delegate : Actor,timeout : Int) extends TcpClientRemoteActor(delegate : Actor,timeout : Int) {
  ...
  def getRemoteAddr : InetSocketAddress = {
    ...
    var nodenetwork = platformModel.getNodeNetworks.filter{loopNN=> loopNN.getTarget == bindmsg.getTargetNodeName }
