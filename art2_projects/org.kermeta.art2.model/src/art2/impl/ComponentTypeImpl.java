 ...
 *   <li>{@link art2.impl.ComponentTypeImpl#getFactoryBean <em>Factory Bean</em>}</li>
 *   <li>{@link art2.impl.ComponentTypeImpl#getRequired <em>Required</em>}</li>
...
public class ComponentTypeImpl extends DeployUnitImpl implements ComponentType {
	...
	public void setFactoryBean(String newFactoryBean) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Art2Package.COMPONENT_TYPE__FACTORY_BEAN, oldFactoryBean, factoryBean));
	}
