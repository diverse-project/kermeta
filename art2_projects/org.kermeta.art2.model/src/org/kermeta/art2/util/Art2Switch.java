...
public class Art2Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case Art2Package.HUB: {
				Hub hub = (Hub)theEObject;
				T result = caseHub(hub);
				if (result == null) result = caseNamedElement(hub);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Art2Package.HUB_TYPE: {
				HubType hubType = (HubType)theEObject;
				T result = caseHubType(hubType);
				if (result == null) result = caseTypeDefinition(hubType);
				if (result == null) result = caseNamedElement(hubType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Hub Type</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Hub Type</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseHubType(HubType object) {
		return null;
	}
