...
public class Art2Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case Art2Package.TOPIC: {
				Topic topic = (Topic)theEObject;
				T result = caseTopic(topic);
				if (result == null) result = caseMessageHub(topic);
				if (result == null) result = caseNamedElement(topic);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Art2Package.MESSAGE_HUB: {
				MessageHub messageHub = (MessageHub)theEObject;
				T result = caseMessageHub(messageHub);
				if (result == null) result = caseNamedElement(messageHub);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Art2Package.QUEUE: {
				Queue queue = (Queue)theEObject;
				T result = caseQueue(queue);
				if (result == null) result = caseMessageHub(queue);
				if (result == null) result = caseNamedElement(queue);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Message Hub</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Message Hub</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseMessageHub(MessageHub object) {
		return null;
	}
