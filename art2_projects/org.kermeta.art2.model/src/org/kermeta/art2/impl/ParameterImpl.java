 ...
 * <ul>
 *   <li>{@link org.kermeta.art2.impl.ParameterImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ParameterImpl extends NamedElementImpl implements Parameter {
	...
	protected EClass eStaticClass() {
		return Art2Package.Literals.PARAMETER;
	}
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Art2Package.PARAMETER__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(TypedElement newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Art2Package.PARAMETER__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Art2Package.PARAMETER__TYPE:
