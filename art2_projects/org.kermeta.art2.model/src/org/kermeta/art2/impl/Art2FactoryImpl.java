...
public class Art2FactoryImpl extends EFactoryImpl implements Art2Factory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case Art2Package.TYPE_LIBRARY: return createTypeLibrary();
			...
			case Art2Package.HUB: return createHub();
			...
			case Art2Package.HUB_TYPE: return createHubType();
			case Art2Package.TYPE_DEFINITION: return createTypeDefinition();
			default:
	...
	public HubType createHubType() {
		HubTypeImpl hubType = new HubTypeImpl();
		return hubType;
	}
