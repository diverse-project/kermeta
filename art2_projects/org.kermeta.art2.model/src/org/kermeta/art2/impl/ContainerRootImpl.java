...
public class ContainerRootImpl extends EObjectImpl implements ContainerRoot {
	...
	public EList<Channel> getHubs() {
		if (hubs == null) {
			hubs = new EObjectContainmentEList<Channel>(Channel.class, this, Art2Package.CONTAINER_ROOT__HUBS);
		}
		return hubs;
	}
	...
	public EList<DeployUnit> getDeployUnits() {
		if (deployUnits == null) {
			deployUnits = new EObjectContainmentEList<DeployUnit>(DeployUnit.class, this, Art2Package.CONTAINER_ROOT__DEPLOY_UNITS);
		}
		return deployUnits;
	}
