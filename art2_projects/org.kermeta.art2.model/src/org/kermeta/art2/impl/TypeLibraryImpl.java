 ...
 * <ul>
 *   <li>{@link org.kermeta.art2.impl.TypeLibraryImpl#getSubTypes <em>Sub Types</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TypeLibraryImpl extends NamedElementImpl implements TypeLibrary {
	...
	protected EClass eStaticClass() {
		return Art2Package.Literals.TYPE_LIBRARY;
	}
	...
	public EList<TypeDefinition> getSubTypes() {
		if (subTypes == null) {
			subTypes = new EObjectResolvingEList<TypeDefinition>(TypeDefinition.class, this, Art2Package.TYPE_LIBRARY__SUB_TYPES);
		}
		return subTypes;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Art2Package.TYPE_LIBRARY__SUB_TYPES:
				return getSubTypes();
		}
