...
public class Art2PackageImpl extends EPackageImpl implements Art2Package {
	 ...
	 * @generated
	 */
	private EClass messageHubEClass = null;
	 ...
	 * @generated
	 */
	public EClass getMessageHub() {
		return messageHubEClass;
	}
	...
	public void createPackageContents() {
		...
		messageHubEClass = createEClass(MESSAGE_HUB);
	...
	public void initializePackageContents() {
		...
		topicEClass.getESuperTypes().add(this.getMessageHub());
		messageHubEClass.getESuperTypes().add(this.getNamedElement());
		queueEClass.getESuperTypes().add(this.getMessageHub());
		...
		initEClass(messageHubEClass, MessageHub.class, "MessageHub", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		...
		initEReference(getMBinding_Hub(), this.getMessageHub(), null, "hub", null, 1, 1, MBinding.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
