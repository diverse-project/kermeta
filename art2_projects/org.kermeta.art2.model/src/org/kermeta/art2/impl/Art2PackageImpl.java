...
public class Art2PackageImpl extends EPackageImpl implements Art2Package {
	 ...
	 * @generated
	 */
	private EClass hubTypeEClass = null;
	 ...
	 * @generated
	 */
	public EReference getComponentTypeLibrary_SubTypes() {
	 ...
	 * @generated
	 */
	public EAttribute getHubType_FactoryBean() {
		return (EAttribute)hubTypeEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getHubType_Bean() {
		return (EAttribute)hubTypeEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getHubType_StartMethod() {
		return (EAttribute)hubTypeEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EAttribute getHubType_StopMethod() {
		return (EAttribute)hubTypeEClass.getEStructuralFeatures().get(3);
	}
	...
	public void createPackageContents() {
		...
		createEReference(componentTypeLibraryEClass, COMPONENT_TYPE_LIBRARY__SUB_TYPES);
		...
		createEReference(hubEClass, HUB__TYPE);
		...
		hubTypeEClass = createEClass(HUB_TYPE);
		createEAttribute(hubTypeEClass, HUB_TYPE__FACTORY_BEAN);
		createEAttribute(hubTypeEClass, HUB_TYPE__BEAN);
		createEAttribute(hubTypeEClass, HUB_TYPE__START_METHOD);
		createEAttribute(hubTypeEClass, HUB_TYPE__STOP_METHOD);
	...
	public void initializePackageContents() {
		...
		initEReference(getContainerRoot_Libraries(), this.getComponentTypeLibrary(), null, "libraries", null, 0, -1, ContainerRoot.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getComponentTypeLibrary_SubTypes(), this.getTypeDefinition(), null, "subTypes", null, 0, -1, ComponentTypeLibrary.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getHub_Type(), this.getHubType(), null, "type", null, 0, 1, Hub.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getMBinding_Hub(), this.getHub(), null, "hub", null, 1, 1, MBinding.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(hubTypeEClass, HubType.class, "HubType", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getHubType_FactoryBean(), ecorePackage.getEString(), "factoryBean", null, 0, 1, HubType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getHubType_Bean(), ecorePackage.getEString(), "bean", null, 0, 1, HubType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getHubType_StartMethod(), ecorePackage.getEString(), "startMethod", null, 0, 1, HubType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getHubType_StopMethod(), ecorePackage.getEString(), "stopMethod", null, 0, 1, HubType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
