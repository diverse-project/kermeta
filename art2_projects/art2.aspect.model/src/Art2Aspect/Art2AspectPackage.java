...
public interface Art2AspectPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int ASPECT_DEFINITION__BINDINGS = 0;
	 ...
	 * @ordered
	 */
	int ASPECT_DEFINITION__POINTCUT = 1;
	 ...
	 * @ordered
	 */
	int ASPECT_DEFINITION__ADVICE = 2;
	 ...
	 * @ordered
	 */
	int ASPECT_DEFINITION_FEATURE_COUNT = 3;
	...
	/**
	 * The feature id for the '<em><b>Component Type Patterns</b></em>' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 ...
	 * @ordered
	 */
	int POINTCUT_DEFINITION_FEATURE_COUNT = 2;
	 ...
	 * @ordered
	 */
	int COMPONENT_TYPE_PATTERN__PORT_TYPE_PATTERNS = 0;

	/**
	 * The feature id for the '<em><b>Port Patterns</b></em>' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int COMPONENT_TYPE_PATTERN__PORT_PATTERNS = 1;
	 ...
	 * @ordered
	 */
	int NODE_PATTERN__COMPONENT_PATTERNS = 0;
	 ...
	 * @ordered
	 */
	int NODE_PATTERN_FEATURE_COUNT = 1;
	 ...
	 * @ordered
	 */
	int PORT_PATTERN_FEATURE_COUNT = 0;
	 ...
	 * @ordered
	 */
	int COMPONENT_PATTERN__PORT_PATTERNS = 0;
	 ...
	 * @ordered
	 */
	int COMPONENT_PATTERN_FEATURE_COUNT = 1;
	 ...
	 * @ordered
	 */
	int PORT_TYPE_REF_PATTERN__REF = 0;
	 ...
	 * @ordered
	 */
	int PORT_TYPE_REF_PATTERN_FEATURE_COUNT = 1;
	 ...
	 * @ordered
	 */
	int PATTERN_NAMED_ELEMENT__PORT_PATTERNS = COMPONENT_PATTERN__PORT_PATTERNS;
	 ...
	 * @ordered
	 */
	int PATTERN_NAMED_ELEMENT__REF = COMPONENT_PATTERN_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int PATTERN_NAMED_ELEMENT__NAME_PATTERN = COMPONENT_PATTERN_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int PATTERN_NAMED_ELEMENT_FEATURE_COUNT = COMPONENT_PATTERN_FEATURE_COUNT + 2;
	...
	/**
	 * Returns the meta object for the containment reference '{@link Art2Aspect.PointcutDefinition#getComponentTypePatterns <em>Component Type Patterns</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>Component Type Patterns</em>'.
	...
	/**
	 * Returns the meta object for the containment reference list '{@link Art2Aspect.ComponentTypePattern#getPortTypePatterns <em>Port Type Patterns</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Port Type Patterns</em>'.
	 * @see Art2Aspect.ComponentTypePattern#getPortTypePatterns()
	 * @see #getComponentTypePattern()
	 * @generated
	 */
	EReference getComponentTypePattern_PortTypePatterns();

	/**
	 * Returns the meta object for the containment reference list '{@link Art2Aspect.ComponentTypePattern#getPortPatterns <em>Port Patterns</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Port Patterns</em>'.
	 * @see Art2Aspect.ComponentTypePattern#getPortPatterns()
	 * @see #getComponentTypePattern()
	 * @generated
	 */
	EReference getComponentTypePattern_PortPatterns();
	...
	/**
	 * Returns the meta object for the containment reference list '{@link Art2Aspect.ComponentPattern#getPortPatterns <em>Port Patterns</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Port Patterns</em>'.
	 * @see Art2Aspect.ComponentPattern#getPortPatterns()
	 * @see #getComponentPattern()
	 * @generated
	 */
	EReference getComponentPattern_PortPatterns();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Component Type Patterns</b></em>' containment reference feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		 ...
		 * @generated
		 */
		EReference COMPONENT_TYPE_PATTERN__PORT_TYPE_PATTERNS = eINSTANCE.getComponentTypePattern_PortTypePatterns();

		/**
		 * The meta object literal for the '<em><b>Port Patterns</b></em>' containment reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference COMPONENT_TYPE_PATTERN__PORT_PATTERNS = eINSTANCE.getComponentTypePattern_PortPatterns();
		 ...
		 * @generated
		 */
		EReference COMPONENT_PATTERN__PORT_PATTERNS = eINSTANCE.getComponentPattern_PortPatterns();
