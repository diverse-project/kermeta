 ...
 * <ul>
 *   <li>{@link Art2Aspect.impl.ComponentTypePatternImpl#getPortTypePatterns <em>Port Type Patterns</em>}</li>
 *   <li>{@link Art2Aspect.impl.ComponentTypePatternImpl#getPortPatterns <em>Port Patterns</em>}</li>
...
public class ComponentTypePatternImpl extends EObjectImpl implements ComponentTypePattern {
	...
	public EList getPortTypePatterns() {
		if (portTypePatterns == null) {
			portTypePatterns = new EObjectContainmentEList(PortTypePattern.class, this, Art2AspectPackage.COMPONENT_TYPE_PATTERN__PORT_TYPE_PATTERNS);
		}
	...
	public EList getPortPatterns() {
		if (portPatterns == null) {
			portPatterns = new EObjectContainmentEList(PortTypeRefPattern.class, this, Art2AspectPackage.COMPONENT_TYPE_PATTERN__PORT_PATTERNS);
		}
		return portPatterns;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Art2AspectPackage.COMPONENT_TYPE_PATTERN__PORT_TYPE_PATTERNS:
				return ((InternalEList)getPortTypePatterns()).basicRemove(otherEnd, msgs);
			case Art2AspectPackage.COMPONENT_TYPE_PATTERN__PORT_PATTERNS:
