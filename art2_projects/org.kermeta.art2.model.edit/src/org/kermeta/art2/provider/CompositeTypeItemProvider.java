...
/**
 * This is the item provider adapter for a {@link org.kermeta.art2.CompositeType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CompositeTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CompositeType_childs_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CompositeType_childs_feature", "_UI_CompositeType_type"),
				 Art2Package.Literals.COMPOSITE_TYPE__CHILDS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Art2Package.Literals.COMPOSITE_TYPE__WIRES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Art2Package.Literals.COMPOSITE_TYPE__WIRES,
				 Art2Factory.eINSTANCE.createWire()));
	}
