	...
	protected void addMetricsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Port_metrics_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Port_metrics_feature", "_UI_Port_type"),
				 Art2Package.Literals.PORT__METRICS,
				 true,
				 false,
				 true,
				 null,
