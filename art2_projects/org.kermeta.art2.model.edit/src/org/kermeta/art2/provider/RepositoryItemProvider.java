...
/**
 * This is the item provider adapter for a {@link org.kermeta.art2.Repository} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Repository_units_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Repository_units_feature", "_UI_Repository_type"),
				 Art2Package.Literals.REPOSITORY__UNITS,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Art2Package.Literals.REPOSITORY__URL,
				 true,
				 false,
				 false,
