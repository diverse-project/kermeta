...
/**
 * This is the item provider adapter for a {@link org.kermeta.art2.DeployUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DeployUnitItemProvider
	 ...
	 * @generated
	 */
	public DeployUnitItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DeployUnit_groupName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DeployUnit_groupName_feature", "_UI_DeployUnit_type"),
				 Art2Package.Literals.DEPLOY_UNIT__GROUP_NAME,
				 true,
				 false,
				 false,
	...
	protected void addUnitNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DeployUnit_unitName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DeployUnit_unitName_feature", "_UI_DeployUnit_type"),
				 Art2Package.Literals.DEPLOY_UNIT__UNIT_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addVersionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DeployUnit_version_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DeployUnit_version_feature", "_UI_DeployUnit_type"),
				 Art2Package.Literals.DEPLOY_UNIT__VERSION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((DeployUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_DeployUnit_type") :
			getString("_UI_DeployUnit_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DeployUnit.class)) {
