...
public class Art2AspectPackageImpl extends EPackageImpl implements Art2AspectPackage {
	 ...
	 * @generated
	 */
	public EReference getPointcutDefinition_PortTypePatterns() {
		return (EReference)pointcutDefinitionEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EReference getComponentTypePattern_RequiredPortTypeRefPatterns() {
	 ...
	 * @generated
	 */
	public EReference getComponentTypePattern_ProvidedPortTypeRefPatterns() {
	 ...
	 * @generated
	 */
	public EReference getPortPattern_Ref() {
	 ...
	 * @generated
	 */
	public EReference getComponentPattern_ProvidedPortPatterns() {
	 ...
	 * @generated
	 */
	public EReference getComponentPattern_RequiredPortPatterns() {
		return (EReference)componentPatternEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		createEReference(pointcutDefinitionEClass, POINTCUT_DEFINITION__PORT_TYPE_PATTERNS);
		...
		createEReference(componentTypePatternEClass, COMPONENT_TYPE_PATTERN__REQUIRED_PORT_TYPE_REF_PATTERNS);
		createEReference(componentTypePatternEClass, COMPONENT_TYPE_PATTERN__PROVIDED_PORT_TYPE_REF_PATTERNS);
		...
		createEReference(portPatternEClass, PORT_PATTERN__REF);

		componentPatternEClass = createEClass(COMPONENT_PATTERN);
		createEReference(componentPatternEClass, COMPONENT_PATTERN__PROVIDED_PORT_PATTERNS);
		createEReference(componentPatternEClass, COMPONENT_PATTERN__REQUIRED_PORT_PATTERNS);
	...
	public void initializePackageContents() {
		...
		aspectDefinitionEClass.getESuperTypes().add(theArt2Package.getNamedElement());
		nodePatternEClass.getESuperTypes().add(this.getPatternNamedElement());
		componentPatternEClass.getESuperTypes().add(this.getPatternNamedElement());
		portTypeRefPatternEClass.getESuperTypes().add(this.getPatternNamedElement());
		...
		initEReference(getPointcutDefinition_PortTypePatterns(), this.getPortTypePattern(), null, "portTypePatterns", null, 0, -1, PointcutDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getComponentTypePattern_RequiredPortTypeRefPatterns(), this.getPortTypeRefPattern(), null, "requiredPortTypeRefPatterns", null, 0, -1, ComponentTypePattern.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getComponentTypePattern_ProvidedPortTypeRefPatterns(), this.getPortTypeRefPattern(), null, "providedPortTypeRefPatterns", null, 0, -1, ComponentTypePattern.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getPortPattern_Ref(), this.getPortTypeRefPattern(), null, "ref", null, 0, 1, PortPattern.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getComponentPattern_ProvidedPortPatterns(), this.getPortPattern(), null, "providedPortPatterns", null, 0, -1, ComponentPattern.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getComponentPattern_RequiredPortPatterns(), this.getPortPattern(), null, "requiredPortPatterns", null, 0, -1, ComponentPattern.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
