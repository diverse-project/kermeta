	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case Art2AspectPackage.ASPECT_DEFINITION: {
				...
				if (result == null) result = caseNamedElement(aspectDefinition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Art2AspectPackage.NODE_PATTERN: {
				...
				if (result == null) result = casePatternNamedElement(nodePattern);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Art2AspectPackage.COMPONENT_PATTERN: {
				...
				if (result == null) result = casePatternNamedElement(componentPattern);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Art2AspectPackage.PORT_TYPE_REF_PATTERN: {
				...
				if (result == null) result = casePatternNamedElement(portTypeRefPattern);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
