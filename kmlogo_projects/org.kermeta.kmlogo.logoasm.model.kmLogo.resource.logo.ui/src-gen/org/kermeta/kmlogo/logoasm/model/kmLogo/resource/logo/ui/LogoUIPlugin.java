 ...
 */
public class LogoUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui";
	...
	private static LogoUIPlugin plugin;
	...
	public static LogoUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, LogoUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, LogoUIPlugin.PLUGIN_ID, message);
		}
		final LogoUIPlugin pluginInstance = LogoUIPlugin.getDefault();
