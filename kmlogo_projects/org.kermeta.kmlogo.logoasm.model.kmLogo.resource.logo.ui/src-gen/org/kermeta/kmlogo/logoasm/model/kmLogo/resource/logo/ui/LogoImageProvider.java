...
public class LogoImageProvider {
	...
	public final static LogoImageProvider INSTANCE = new LogoImageProvider();
	...
	public org.eclipse.swt.graphics.Image getImage(String key) {
		...
		org.eclipse.jface.resource.ImageDescriptor desriptor = org.eclipse.jface.resource.ImageDescriptor.createFromURL(org.eclipse.core.runtime.FileLocator.find(org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoUIPlugin.getDefault().getBundle(), path, null));
