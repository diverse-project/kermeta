 ...
 */
public class LogoOccurrence {
	
	public final static String OCCURRENCE_ANNOTATION_ID = "org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.occurences";
	public final static String DECLARATION_ANNOTATION_ID = "org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.occurences.declaration";
	...
	private org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoTokenScanner tokenScanner;
	...
	private org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ILogoTextResource textResource;
	 ...
	 */
	public LogoOccurrence(org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ILogoTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer, org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoTokenScanner tokenScanner) {
		this.textResource = textResource;
		this.projectionViewer = sourceViewer;
		
		quotedTokenArray = new java.util.ArrayList<String>();
		String[] tokenNames = new org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.mopp.LogoMetaInformation().getTokenNames();
	 ...
	 */
	public void handleOccurrenceHighlighting(org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoBracketSet bracketSet) {
		...
		if (resource.equals(textResource)) {
			...
			while (!token.isEOF()) {
				...
				if (text.equals(tokenText)) {
					...
					addAnnotation(document, org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoPositionCategory.DEFINTION, text);
					break;
				}
				token = tokenScanner.nextToken();
			}
			...
			if (text != null && text.equals(tokenText) && tokenScanner.getTokenOffset() != defPosition) {
				...
				if (occEO != null) {
					if ((isNull && elementsAtDefinition.contains(occEO)) || !isNull && definitionElement.equals(occEO)) {
						addAnnotation(document, org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoPositionCategory.PROXY, text);
					}
				}
			}
			token = tokenScanner.nextToken();
	...
	private void addAnnotation(org.eclipse.jface.text.IDocument document, org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoPositionCategory type, String text) {
		int tokenOffset = tokenScanner.getTokenOffset();
		int tokenLength = tokenScanner.getTokenLength();
		...
		if (type == org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoPositionCategory.DEFINTION) {
	...
	private void removeAnnotations() {
		removeAnnotations(org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoOccurrence.OCCURRENCE_ANNOTATION_ID);
		removeAnnotations(org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoOccurrence.DECLARATION_ANNOTATION_ID);
	}
