 ...
 * </ul>
 */
public class LogoBracketPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	
	private static final String[] ALL_LEFT_BRACKETS = new String[] { "{", "(", "[", "<", "\"", "'", };
	private static final String[] ALL_RIGHT_BRACKETS = new String[] { "}", ")", "]", ">", "\"", "'", };
	
	private String BRACKETS_COLOR = org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR;
	...
	private String language = new org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.mopp.LogoMetaInformation().getSyntaxName();
	
	private org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoBracketSet bracketsTmp;
	
	/**
	 * Creates a preference page for bracket setting.
	 */
	public LogoBracketPreferencePage() {
		super();
		
		org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ILogoMetaInformation metaInformation = new org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.mopp.LogoMetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench) {
		setPreferenceStore(org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoUIPlugin.getDefault().getPreferenceStore());
		setDescription("Define the coloring of matching brackets.");
		
		bracketsTmp = new org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoBracketSet(null, null);
		for (String languageID : languageIDs) {
			bracketSetTemp.put(languageID, getPreferenceStore().getString(languageID + org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		}
	}
	...
	private void handleMatchingBracketsSelection() {
		...
		enableCheckbox.setSelection(getPreferenceStore().getBoolean(		org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		enableClosingInside.setSelection(false);
		matchingBracketsColorButton.setEnabled(getPreferenceStore().getBoolean(		org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		...
		initializeLanguage();
		bracketsTmp.setBrackets(getPreferenceStore().getString(language + org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		...
		bracketsList.addSelectionListener(new org.eclipse.swt.events.SelectionListener() {
			...
			public void widgetSelected(org.eclipse.swt.events.SelectionEvent e) {
				...
				for (int index : itemIndices) {
					org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ILogoBracketPair bracketPair = bracketsTmp.getBracketPair(index);
		...
		enableClosingInside.addSelectionListener(new org.eclipse.swt.events.SelectionListener() {
			...
			public void widgetSelected(org.eclipse.swt.events.SelectionEvent e) {
				...
				for (int idx : itemIndices) {
					org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ILogoBracketPair bracketPair = bracketsTmp.getBracketPair(idx);
	...
	protected void performDefaults() {
		enableCheckbox.setSelection(getPreferenceStore().getDefaultBoolean(		org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		matchingBracketsColorButton.setEnabled(enableCheckbox.getSelection());
		...
		bracketSetTemp.put(language, getPreferenceStore().getDefaultString(		language + org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		bracketsTmp.setBrackets(bracketSetTemp.get(language));
		bracketsList.setItems(bracketsTmp.getBracketArray());
		enableClosingInside.setSelection(false);
	}
	...
	private void updateActiveEditor() {
		...
		getPreferenceStore().setValue(org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX, enableCheckbox.getSelection());
		getPreferenceStore().setValue(language + org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoPreferenceConstants.EDITOR_BRACKETS_SUFFIX, bracketSetTemp.get(language));
		...
		if (editor != null && editor instanceof org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoEditor) {
			((org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoEditor) editor).invalidateTextRepresentation();
		}
	}
