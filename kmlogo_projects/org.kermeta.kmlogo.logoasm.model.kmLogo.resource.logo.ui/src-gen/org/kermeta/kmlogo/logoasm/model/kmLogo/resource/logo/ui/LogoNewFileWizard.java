...
public class LogoNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	...
	public boolean performFinish() {
		...
		try {
			...
			org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoUIPlugin.logError("Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoUIPlugin.logError("Exception while initializing new file", e);
			return false;
		}
		return true;
	}
