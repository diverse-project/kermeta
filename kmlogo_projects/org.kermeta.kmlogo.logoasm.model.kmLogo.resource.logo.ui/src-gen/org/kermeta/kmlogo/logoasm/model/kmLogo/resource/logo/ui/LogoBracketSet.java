...
public class LogoBracketSet {
	...
	private java.util.ArrayList<org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ILogoBracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ILogoBracketPair {
	 ...
	 */
	private class ClosingListener implements org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.ILogoBracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ILogoBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public LogoBracketSet(org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoEditor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.mopp.LogoMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ILogoBracketPair>();
		if (sourceViewer != null) {
			viewer = sourceViewer;
			textWidget = viewer.getTextWidget();
		}
		preferenceStore = org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoUIPlugin.getDefault().getPreferenceStore();
	 ...
	 */
	public org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ILogoBracketPair getBracketPair(String opening, String closing) {
		for (org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ILogoBracketPair bracketPair : bracketPairs) {
	...
	public org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ILogoBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ILogoBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ILogoBracketPair remove(String opening, String closing) {
		for (org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ILogoBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ILogoBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
