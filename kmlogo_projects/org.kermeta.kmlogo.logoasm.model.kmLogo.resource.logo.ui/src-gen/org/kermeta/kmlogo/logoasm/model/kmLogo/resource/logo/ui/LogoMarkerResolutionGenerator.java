...
public class LogoMarkerResolutionGenerator implements org.eclipse.ui.IMarkerResolutionGenerator {
	...
	public org.eclipse.ui.IMarkerResolution[] getResolutions(org.eclipse.core.resources.IMarker marker) {
		try {
			...
			if (resource instanceof org.eclipse.core.resources.IFile) {
				...
				rs.getLoadOptions().put(org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ILogoOptions.DISABLE_CREATING_MARKERS_FOR_PROBLEMS, "true");
				org.eclipse.emf.ecore.resource.Resource emfResource = rs.getResource(uri, true);
				if (emfResource instanceof org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.mopp.LogoResource) {
					org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.mopp.LogoResource customResource = (org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.mopp.LogoResource) emfResource;
					org.eclipse.emf.ecore.util.EcoreUtil.resolveAll(customResource);
					java.util.Collection<org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ILogoQuickFix> quickFixes = getQuickFixes(customResource, marker);
					java.util.List<org.eclipse.ui.IMarkerResolution2> resolutions = new java.util.ArrayList<org.eclipse.ui.IMarkerResolution2>();
					for (final org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ILogoQuickFix quickFix : quickFixes) {
						resolutions.add(new org.eclipse.ui.IMarkerResolution2() {
							...
							public void run(org.eclipse.core.resources.IMarker marker) {
								...
								try {
									...
									org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoUIPlugin.logError("Exception while applying quick fix", e);
								}
							}
			...
			org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoUIPlugin.logError("Exception while computing quick fix resolutions", e);
		}
		return new org.eclipse.ui.IMarkerResolution[] {};
	}
	
	public java.util.Collection<org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ILogoQuickFix> getQuickFixes(org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ILogoTextResource resource, org.eclipse.core.resources.IMarker marker) {
		...
		try {
			...
			if (quickFixContexts != null) {
				...
				for (String quickFixContext : quickFixContextParts) {
					org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ILogoQuickFix quickFix = resource.getQuickFix(quickFixContext);
					if (quickFix != null) {
