...
public class LogoEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider {
	...
	private org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.ILogoBracketHandler bracketHandler;
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
				...
				org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoUIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.EditorContext");
	}
		...
		if (loadedResource == null) {
			try {
				...
				if (demandLoadedResource instanceof org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ILogoTextResource) {
					...
					org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the LogoEditor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (Exception e) {
				org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoUIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoUIPlugin.logError("Exception in setCaret()", e);
		}
	}
	...
	public org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.ILogoBracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.ILogoBracketHandler bracketHandler) {
