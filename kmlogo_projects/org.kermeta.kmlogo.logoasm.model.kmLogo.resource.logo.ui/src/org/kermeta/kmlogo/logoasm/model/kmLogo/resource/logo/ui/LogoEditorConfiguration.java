...
public class LogoEditorConfiguration extends org.eclipse.jface.text.source.SourceViewerConfiguration {
	...
	private org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoQuickAssistAssistant quickAssistAssistant;
	...
	protected org.eclipse.jface.text.rules.ITokenScanner getScanner(String fileName) {
		return new org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoTokenScanner(theEditor.getResource(), colorManager);
	}
	...
	public org.eclipse.jface.text.quickassist.IQuickAssistAssistant getQuickAssistAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		if (quickAssistAssistant == null) {
			quickAssistAssistant = new org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoQuickAssistAssistant(theEditor);
		}
