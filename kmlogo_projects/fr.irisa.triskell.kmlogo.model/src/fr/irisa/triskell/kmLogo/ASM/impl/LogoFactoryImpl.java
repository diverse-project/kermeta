 ...
 * </copyright>
 *
 * $Id: LogoFactoryImpl.java,v 1.1 2007-05-31 17:03:56 ffleurey Exp $
 */
...
public class LogoFactoryImpl extends EFactoryImpl implements LogoFactory {
	...
	public static LogoFactory init() {
		try {
			LogoFactory theLogoFactory = (LogoFactory)EPackage.Registry.INSTANCE.getEFactory("http://kmLogo.ecore/ASM"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case LogoPackage.CONSTANT: return createConstant();
			...
			case LogoPackage.PLUS: return createPlus();
			case LogoPackage.MINUS: return createMinus();
			case LogoPackage.MULT: return createMult();
			case LogoPackage.DIV: return createDiv();
			case LogoPackage.EQUALS: return createEquals();
			case LogoPackage.GREATER: return createGreater();
			case LogoPackage.LOWER: return createLower();
			default:
