 ...
 * </copyright>
 *
 * $Id: ASMPackageImpl.java,v 1.1 2007-05-30 13:23:34 ffleurey Exp $
 */
...
import fr.irisa.triskell.kmLogo.ASM.Repeat;
import fr.irisa.triskell.kmLogo.ASM.Right;
import fr.irisa.triskell.kmLogo.ASM.While;

import fr.irisa.triskell.kmLogo.KmLogoPackage;

import fr.irisa.triskell.kmLogo.impl.KmLogoPackageImpl;
...
public class ASMPackageImpl extends EPackageImpl implements ASMPackage {
	 ...
	 * @see fr.irisa.triskell.kmLogo.ASM.ASMPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static ASMPackage init() {
		...
		ASMPackageImpl theASMPackage = (ASMPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof ASMPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new ASMPackageImpl());
	...
	public void initializePackageContents() {
		...
		initEAttribute(getConstant_IntegerValue(), theKmLogoPackage.getString(), "integerValue", null, 0, 1, Constant.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
