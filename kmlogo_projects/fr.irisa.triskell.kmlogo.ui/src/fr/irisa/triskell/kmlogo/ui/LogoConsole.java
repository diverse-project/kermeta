...
public class LogoConsole implements KermetaIOStream {
	...
	public void print(Object outputString) {
		printMessage(outputString.toString(), LogoConsole.KERMETA);
	}
	...
	public static MessageConsole getConsole() {
		if (console == null) {
			console = new MessageConsole("KM Logo Console", null, true);
