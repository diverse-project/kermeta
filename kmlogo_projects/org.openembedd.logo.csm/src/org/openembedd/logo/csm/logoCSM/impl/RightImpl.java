 ...
 * <copyright> </copyright>
 * 
 * $Id: RightImpl.java,v 1.1 2008-05-28 12:47:10 vmahe Exp $
 */
...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Right</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.openembedd.logo.csm.logoCSM.impl.RightImpl#getAngle <em>Angle</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class RightImpl extends PrimitiveImpl implements Right
{
	...
	{
		return LogoCSMPackage.Literals.RIGHT;
	}
	...
	public NotificationChain basicSetAngle(Expression newAngle, NotificationChain msgs)
	{
		...
		{
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LogoCSMPackage.RIGHT__ANGLE,
				oldAngle, newAngle);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newAngle != angle)
		{
			...
			if (angle != null)
				msgs = ((InternalEObject) angle).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- LogoCSMPackage.RIGHT__ANGLE, null, msgs);
			if (newAngle != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, LogoCSMPackage.RIGHT__ANGLE, newAngle, newAngle));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
		case LogoCSMPackage.RIGHT__ANGLE:
