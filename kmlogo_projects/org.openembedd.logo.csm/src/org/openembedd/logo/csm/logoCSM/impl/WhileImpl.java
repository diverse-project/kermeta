 ...
 * <copyright> </copyright>
 * 
 * $Id: WhileImpl.java,v 1.1 2008-05-28 12:47:10 vmahe Exp $
 */
...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>While</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.openembedd.logo.csm.logoCSM.impl.WhileImpl#getBlock <em>Block</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class WhileImpl extends ControlStructureImpl implements While
{
	...
	{
		return LogoCSMPackage.Literals.WHILE;
	}
	...
	public NotificationChain basicSetBlock(Block newBlock, NotificationChain msgs)
	{
		...
		{
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LogoCSMPackage.WHILE__BLOCK,
				oldBlock, newBlock);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newBlock != block)
		{
			...
			if (block != null)
				msgs = ((InternalEObject) block).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- LogoCSMPackage.WHILE__BLOCK, null, msgs);
			if (newBlock != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, LogoCSMPackage.WHILE__BLOCK, newBlock, newBlock));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
		case LogoCSMPackage.WHILE__BLOCK:
