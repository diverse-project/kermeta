...
import org.kermeta.kmlogo.logoasm.ui.ConvertToLogoasmK;
...
public class ConvertToLogoasm implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		ConvertToLogoasmK.run(file_uri, console);
