...
import org.openembedd.logo.csm.diagram.block.commands.RightRestoreConnectionCommand;
import org.openembedd.logo.csm.diagram.block.figures.RightFigure;
...
/**
 * The Right object controller
 * 
 * @generated
 */
public class RightEditPart extends InstructionEditPart
{
	 ...
	 * @generated
	 */
	public RightEditPart(GraphNode obj)
	{
		super(obj);
	}
	...
	protected void createEditPolicies()
	{
		...
		installEditPolicy(ModelerEditPolicyConstants.RESTORE_EDITPOLICY, new RestoreEditPolicy()
		{
			...
			{
				return new RightRestoreConnectionCommand(getHost());
			}
		});
	...
	{
		RightFigure figure = new RightFigure();
		Right model = (Right) Utils.getElement((GraphElement) this.getModel());
	...
	protected void handleModelChanged(Notification msg)
	{
		...
		if (msg.getNotifier() instanceof Right && msg.getFeatureID(Right.class) == LogoCSMPackage.RIGHT__ANGLE)
		{
