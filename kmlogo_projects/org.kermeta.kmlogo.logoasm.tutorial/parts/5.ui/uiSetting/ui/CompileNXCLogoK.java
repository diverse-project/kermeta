...
public class CompileNXCLogoK {
	...
	public static final String LOGO_COMPILER_KERMETA_CODE = "platform:/plugin/org.kermeta.kmlogo.logoasm.srcKermeta/kermeta/6.NXTCompiler/LogoNXCCompiler.kmt";
	public static void run(String file, String out, IOConsole console) throws NotRegisteredURIException, URIMalformedException, IOException {
		...
		*/
		...
		String api = ""; //Should provide the API if we fix the compiler code
		//api = FileLocator.resolve(Platform.getBundle("org.kermeta.kmlogo.logoasm.model").getEntry("/model/LogoNXC.nxc")).toString();
		...
		safeAddURLAsString(urlsSet, "file://" + FileLocator.resolve(Platform.getBundle("org.kermeta.kmlogo.logoasm.model").getEntry("/bin/")));;
		// add this plugin as a deployed plugin
		Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("org.kermeta.kmlogo.logoasm.model");
		if(bundle != null){
