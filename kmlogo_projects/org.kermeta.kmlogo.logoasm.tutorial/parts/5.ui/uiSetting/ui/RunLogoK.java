...
public class RunLogoK {
	public static final String LOGO_SIMULATOR_KERMETA_CODE = "platform:/plugin/org.kermeta.kmlogo.logoasm.srcKermeta/kermeta/5.Simulator/LogoSimulator.kmt";
...
//		Activator.internalLog.info("run FixModel");
		...
		//KermetaUnit unit = IOPlugin.getDefault().loadKermetaUnit("platform:/plugin/org.kermeta.kmlogo.model/model/LogoSimulator.kmt", new NullProgressMonitor());
		...
		*/
		...
		safeAddURLAsString(urlsSet, "file://" + FileLocator.resolve(Platform.getBundle("org.kermeta.kmlogo.logoasm.srcKermeta").getEntry("/bin/")));
		// add this plugin as a deployed plugin
		Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("org.kermeta.kmlogo.logoasm.srcKermeta");
		if(bundle != null){
