 ...
 * <copyright> </copyright>
 * 
 * $Id: LogoCSMActionBarContributor.java,v 1.1 2008-05-28 12:49:10 vmahe Exp $
 */
...
/**
 * This is the action bar contributor for the LogoCSM model editor. <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class LogoCSMActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener
{
	/**
	 ...
	 * @generated
	 */
	protected IAction				showPropertiesViewAction	= new Action(LogoCSMEditorPlugin.INSTANCE
	 ...
	 * @generated
	 */
	protected IAction				refreshViewerAction			= new Action(LogoCSMEditorPlugin.INSTANCE
	 ...
	 * @generated
	 */
	public LogoCSMActionBarContributor()
	{
	...
	{
		toolBarManager.add(new Separator("logocsm-settings"));
		toolBarManager.add(new Separator("logocsm-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager)
	{
		...
		IMenuManager submenuManager = new MenuManager(LogoCSMEditorPlugin.INSTANCE.getString("_UI_LogoCSMEditor_menu"),
			"org.openembedd.logo.csm.logoCSMMenuID");
		...
		//
		createChildMenuManager = new MenuManager(LogoCSMEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		submenuManager.insertBefore("additions", createChildMenuManager);

		// Prepare for CreateSibling item addition or removal.
		//
		createSiblingMenuManager = new MenuManager(LogoCSMEditorPlugin.INSTANCE
	...
	public void menuAboutToShow(IMenuManager menuManager)
	{
		...
		submenuManager = new MenuManager(LogoCSMEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		populateManager(submenuManager, createChildActions, null);
		menuManager.insertBefore("edit", submenuManager);

		submenuManager = new MenuManager(LogoCSMEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
