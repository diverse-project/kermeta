/*$Id : LogoEditor.java v 1.3 May 8, 2010 9:18:16 AM hrambelo Exp $
* Project : org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo
* File : 	LogoEditor.java
* License : EPL
...
//
// A text editor for 'logo' models.
//
public class LogoEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider {
	
	private org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoCodeFoldingManager codeFoldingManager;
	private org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoBackgroundParsingStrategy bgParsingStrategy = new org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoBackgroundParsingStrategy();
	private java.util.Collection<org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ILogoBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ILogoBackgroundParsingListener>();
	private org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoColorManager colorManager = new org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoColorManager();
	private org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoOutlinePage outlinePage;
	...
	private org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoPropertySheetPage propertySheetPage;
	...
	public LogoEditor() {
		...
		setSourceViewerConfiguration(new org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoEditorConfiguration(this, colorManager));
	...
	private final class MarkerUpdateListener implements org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ILogoBackgroundParsingListener {
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), LogoEditor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ILogoTextResource currentResource = getResource();
				...
				org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.mopp.LogoPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.mopp.LogoNature.activate(inputFile.getProject());
		...
		org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ILogoTextResource loadedResource = (org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ILogoTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ILogoTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ILogoTextResource) {
					setResource((org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ILogoTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but
					// some other EMF resource
					org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.mopp.LogoPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the LogoEditor.");
					//close this editor because it can not present the resource
					close(false);
				}
			} catch (java.lang.Exception e) {
				org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.mopp.LogoPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ILogoTextResource resource) {
		assert resource != null;
	...
	private java.lang.Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ILogoTextResource textResource = (org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ILogoTextResource) element.eResource();
			...
			org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ILogoTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ILogoTextToken token = lexer.getNextToken();
			...
			org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.mopp.LogoPlugin.logError("java.lang.Exception in setCaret()", e);
		}
	}
	...
	public void addBackgroundParsingListener(org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ILogoBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ILogoBackgroundParsingListener listener : bgParsingListeners) {
	...
	private void refreshMarkers(final org.eclipse.emf.ecore.resource.Resource resourceToRefresh) {
		...
		if (display != null) {
			display.asyncExec(new java.lang.Runnable() {
				public void run() {
					try {
						org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoMarkerHelper.unmark(resourceToRefresh);
						org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoMarkerHelper.mark(resourceToRefresh);
					} catch (org.eclipse.core.runtime.CoreException e) {
						org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.mopp.LogoPlugin.logError("Exception while updating markers on resource", e);
					}
				}
			});
		}
