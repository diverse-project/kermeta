/*$Id : LogoOccurrencePreferencePage.java v 1.3 May 8, 2010 9:18:16 AM hrambelo Exp $
* Project : org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo
* File : 	LogoOccurrencePreferencePage.java
* License : EPL
...
// </ul>
//
public class LogoOccurrencePreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	private void initializeValues() {
		boolean enable = getPreferenceStore().getBoolean(org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoPreferenceConstants.EDITOR_OCCURRENCE_CHECKBOX);
		enableCheckbox.setSelection(enable);
		
		defColorButton.setEnabled(enable);
		org.eclipse.swt.graphics.RGB rgb = org.eclipse.jface.preference.PreferenceConverter.getColor(getPreferenceStore(), org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoPreferenceConstants.EDITOR_DEFINITION_COLOR);
		defColorSelector.setColorValue(rgb);
		
		useColorButton.setEnabled(enable);
		rgb = org.eclipse.jface.preference.PreferenceConverter.getColor(getPreferenceStore(), org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoPreferenceConstants.EDITOR_PROXY_COLOR);
		useColorSelector.setColorValue(rgb);
	}
	
	// Set the default values for this preference page.
	protected void performDefaults() {
		boolean enable = getPreferenceStore().getDefaultBoolean(org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		enableCheckbox.setSelection(enable);
		defColorButton.setEnabled(enable);
		useColorButton.setEnabled(enable);
		defColorSelector.setColorValue(org.eclipse.jface.preference.PreferenceConverter.getDefaultColor(getPreferenceStore(), org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoPreferenceConstants.EDITOR_DEFINITION_COLOR));
		useColorSelector.setColorValue(org.eclipse.jface.preference.PreferenceConverter.getDefaultColor(getPreferenceStore(), org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoPreferenceConstants.EDITOR_PROXY_COLOR));
	}
	...
	private void updateActiveEditor() {
		getPreferenceStore().setValue(org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoPreferenceConstants.EDITOR_OCCURRENCE_CHECKBOX, enableCheckbox.getSelection());
		org.eclipse.jface.preference.PreferenceConverter.setValue(getPreferenceStore(), org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoPreferenceConstants.EDITOR_DEFINITION_COLOR, defColorSelector.getColorValue());
		org.eclipse.jface.preference.PreferenceConverter.setValue(getPreferenceStore(), org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoPreferenceConstants.EDITOR_PROXY_COLOR, useColorSelector.getColorValue());
