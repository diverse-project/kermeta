/*$Id : LogoBrowserInformationControl.java v 1.3 May 8, 2010 9:18:18 AM hrambelo Exp $
* Project : org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo
* File : 	LogoBrowserInformationControl.java
* License : EPL
...
// @since 3.2
///
public class LogoBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoDocBrowserInformationControlInput fInput;
	...
	public LogoBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	...
	public LogoBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	...
	// @since 3.4
	///
	public LogoBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoDocBrowserInformationControlInput);
		...
		fInput= (org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoDocBrowserInformationControlInput) input;
		...
		org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	...
	///
	public org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoDocBrowserInformationControlInput getInput() {
		return fInput;
	}
