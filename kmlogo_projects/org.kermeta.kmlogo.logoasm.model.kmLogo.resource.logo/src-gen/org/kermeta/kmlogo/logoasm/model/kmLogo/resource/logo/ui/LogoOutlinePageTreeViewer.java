/*$Id : LogoOutlinePageTreeViewer.java v 1.3 May 8, 2010 9:18:16 AM hrambelo Exp $
* Project : org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo
* File : 	LogoOutlinePageTreeViewer.java
* License : EPL
...
public class LogoOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	
	boolean suppressNotifications = false;
	
	public LogoOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
	}
	
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		if (selection instanceof org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoEObjectSelection) {
