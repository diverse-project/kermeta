/*$Id : LogoPlugin.java v 1.3 May 8, 2010 9:17:59 AM hrambelo Exp $
* Project : org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo
* File : 	LogoPlugin.java
* License : EPL
...
public class LogoPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo";
	...
	private static LogoPlugin plugin;
	...
	public static LogoPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, LogoPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, LogoPlugin.PLUGIN_ID, message);
		}
		final LogoPlugin pluginInstance = LogoPlugin.getDefault();
