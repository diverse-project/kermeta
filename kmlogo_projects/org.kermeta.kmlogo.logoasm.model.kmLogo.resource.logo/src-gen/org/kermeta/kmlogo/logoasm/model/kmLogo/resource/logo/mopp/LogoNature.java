/*$Id : LogoNature.java v 1.3 May 8, 2010 9:17:58 AM hrambelo Exp $
* Project : org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo
* File : 	LogoNature.java
* License : EPL
...
public class LogoNature implements org.eclipse.core.resources.IProjectNature {
	
	public static final String NATURE_ID = "org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.nature";
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.mopp.LogoBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
