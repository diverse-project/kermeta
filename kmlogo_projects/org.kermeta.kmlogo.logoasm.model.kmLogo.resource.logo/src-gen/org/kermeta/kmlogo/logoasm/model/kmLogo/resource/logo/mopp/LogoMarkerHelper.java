 ...
 * contains
 * <code>org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ILogoTextDiagnostic<
...
public class LogoMarkerHelper {
	 ...
	 */
	public static void mark(org.eclipse.emf.ecore.resource.Resource resource, final org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ILogoTextDiagnostic diagnostic) {
	...
	private static void createMarkerFromDiagnostic(org.eclipse.core.resources.IFile file, final org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ILogoTextDiagnostic diagnostic) {
		try {
			...
			if (diagnostic.getProblem().getType() == org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.LogoEProblemType.ERROR) {
			...
			java.util.Collection<org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ILogoQuickFix> quickFixes = textDiagnostic.getProblem().getQuickFixes();
			...
			if (!sourceIDs.isEmpty()) {
				marker.setAttribute(org.eclipse.core.resources.IMarker.SOURCE_ID, org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.util.LogoStringUtil.explode(sourceIDs, "|"));
			}
		} catch (org.eclipse.core.runtime.CoreException ce) {
			if (ce.getMessage().matches("Marker.*not found.")) {
				// ignore
			} else {
				org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.mopp.LogoPlugin.logError("Error marking resource:", ce);
			}
		}
	}
