/*$Id : LogoHyperlink.java v 1.3 May 8, 2010 9:18:15 AM hrambelo Exp $
* Project : org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo
* File : 	LogoHyperlink.java
* License : EPL
...
public class LogoHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	...
	public LogoHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				if (editorPart instanceof org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoEditor) {
					org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoEditor emftEditor = (org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoEditor) editorPart;
