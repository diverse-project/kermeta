/*$Id : LogoSyntaxColoringPreferencePage.java v 1.3 May 8, 2010 9:18:18 AM hrambelo Exp $
* Project : org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo
* File : 	LogoSyntaxColoringPreferencePage.java
* License : EPL
...
///
public class LogoSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoPixelConverter pixelConverter = new org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoPixelConverter(composite);
	...
	public LogoSyntaxColoringPreferencePage() {
		super();
		
		org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ILogoMetaInformation syntaxPlugin = new org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.mopp.LogoMetaInformation();
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoEditor) {
			org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoEditor emfTextEditor = (org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoEditor) editor;
