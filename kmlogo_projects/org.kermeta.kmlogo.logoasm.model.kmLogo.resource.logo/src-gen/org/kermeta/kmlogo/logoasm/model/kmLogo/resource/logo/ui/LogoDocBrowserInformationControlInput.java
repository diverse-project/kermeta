...
public class LogoDocBrowserInformationControlInput {
	
	private final LogoDocBrowserInformationControlInput fPrevious;
	private LogoDocBrowserInformationControlInput fNext;
	...
	///
	public LogoDocBrowserInformationControlInput(LogoDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	...
	public LogoDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	...
	public LogoDocBrowserInformationControlInput getNext() {
		return fNext;
	}
