/*$Id : LogoTextHover.java v 1.3 May 8, 2010 9:18:15 AM hrambelo Exp $
* Project : org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo
* File : 	LogoTextHover.java
* License : EPL
...
//
public class LogoTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2{
	...
	private org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ILogoHoverTextProvider hoverTextProvider;
	// The style sheet (css).
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoBrowserInformationControl infoControl;
		...
		//            target element
		public OpenDeclarationAction(org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoBrowserInformationControl infoControl) {
		...
		public void run() {
			org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoDocBrowserInformationControlInput infoInput = (org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoHyperlink hyperlink = new org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoBrowserInformationControl iControl = new org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(java.lang.Object newInput) {
						...
						} else if (newInput instanceof org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoDocBrowserInformationControlInput) {
							org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoDocBrowserInformationControlInput input = (org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoBrowserInformationControl.isAvailable(parent)) {
				org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoBrowserInformationControl iControl = new org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	...
	// element.
	public LogoTextHover(org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoEditor editor) {
		super();
		this.editor = editor;
		hoverTextProvider = new org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.mopp.LogoMetaInformation().getHoverTextProvider();
	}
	
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		return ((org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoDocBrowserInformationControlInput) getHoverInfo2(textViewer, hoverRegion)).getHtml();
	}
	...
	private org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ILogoTextResource textResource = editor.getResource();
	...
	private org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(declarationObject));
			}
		} else {
			org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoHTMLPrinter.insertPageProlog(buffer, 0, org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoTextHover.getStyleSheet());
			org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoHTMLPrinter.addPageEpilog(buffer);
			return new org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoDocBrowserInformationControlInput(previousInput, declarationObject, editor.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		if (css != null) {
			...
			css = org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoHTMLPrinter.convertTopLevelFont(css, fontData);
		}
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.mopp.LogoPlugin.PLUGIN_ID);
