/*$Id : LogoCodeFoldingManager.java v 1.3 May 8, 2010 9:18:18 AM hrambelo Exp $
* Project : org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo
* File : 	LogoCodeFoldingManager.java
* License : EPL
...
public class LogoCodeFoldingManager {
	
	private class FoldingUpdateListener implements org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ILogoBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoEditor) {
				org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoEditor editor = (org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoEditor) workbenchPart;
	...
	protected org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoEditor editor;
	...
	public LogoCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoEditor textEditor) {
	...
	private void addCloseListener(final org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.mopp.LogoPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ILogoTextResource textResource = (org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ILogoTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
