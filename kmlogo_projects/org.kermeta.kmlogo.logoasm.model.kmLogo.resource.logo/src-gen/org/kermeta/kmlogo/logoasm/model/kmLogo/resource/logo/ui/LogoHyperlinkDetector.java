/*$Id : LogoHyperlinkDetector.java v 1.3 May 8, 2010 9:18:18 AM hrambelo Exp $
* Project : org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo
* File : 	LogoHyperlinkDetector.java
* License : EPL
...
// hovers, is a proxy.
public class LogoHyperlinkDetector implements org.eclipse.jface.text.hyperlink.IHyperlinkDetector {
	...
	public LogoHyperlinkDetector(org.eclipse.emf.ecore.resource.Resource resource) {
		textResource = (org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ILogoTextResource) resource;
	}
	...
	public org.eclipse.jface.text.hyperlink.IHyperlink[] detectHyperlinks(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion region, boolean canShowMultipleHyperlinks) {
		...
		for (org.eclipse.emf.ecore.EObject eObject : elementsAtOffset) {
			if (eObject.eIsProxy()) {
				...
				org.eclipse.jface.text.hyperlink.IHyperlink hyperlink = new org.kermeta.kmlogo.logoasm.model.kmLogo.resource.logo.ui.LogoHyperlink(new org.eclipse.jface.text.Region(offset, length), resolvedEObject, text);
