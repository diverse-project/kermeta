 ...
 * </copyright>
 *
 * $Id: StandardPackageImpl.java,v 1.1 2008-07-02 09:43:58 ftanguy Exp $
 */
...
public class StandardPackageImpl extends EPackageImpl implements StandardPackage {
	...
	public void initializePackageContents() {
		...
		g1.getETypeArguments().add(g2);
		initEAttribute(getCollection_Values(), g1, "values", null, 0, 1, Collection.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		EOperation op = addEOperation(collectionEClass, null, "reject", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = addEOperation(voidEClass, this.getBoolean(), "isInstanceOf", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEClass(kermetaSpecialTypesAliasEClass, EObject.class, "KermetaSpecialTypesAlias", !IS_ABSTRACT, !IS_INTERFACE, !IS_GENERATED_INSTANCE_CLASS);
	...
	protected void createKermeta_1Annotations() {
		...
		addAnnotation
		  ((collectionEClass.getEOperations().get(14)).getEParameters().get(0), 
		   source, 
		   new String[] {
			 "0", "kermeta::standard::Collection::G",
