 ...
 * </copyright>
 *
 * $Id: StandardAdapterFactory.java,v 1.1 2008-07-02 09:44:12 ftanguy Exp $
 */
...
public class StandardAdapterFactory extends AdapterFactoryImpl {
	...
	protected StandardSwitch<Adapter> modelSwitch =
		new StandardSwitch<Adapter>() {
			...
			@Override
			public Adapter caseKermetaSpecialTypesAlias(EObject object) {
				return createKermetaSpecialTypesAliasAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.ecore.EObject <em>Kermeta Special Types Alias</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createKermetaSpecialTypesAliasAdapter() {
		return null;
	}
