 ...
 * </copyright>
 *
 * $Id: StructurePackageImpl.java,v 1.1 2008-07-02 09:43:43 ftanguy Exp $
 */
...
public class StructurePackageImpl extends EPackageImpl implements StructurePackage {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getOperation_IsAbstract(), theStandardPackage.getBoolean(), "isAbstract", null, 0, 1, Operation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getProperty__default(), theStandardPackage.getString(), "_default", null, 0, 1, Property.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getProperty_IsDerived(), theStandardPackage.getBoolean(), "isDerived", null, 0, 1, Property.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getProperty_IsReadOnly(), theStandardPackage.getBoolean(), "isReadOnly", null, 0, 1, Property.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getProperty_IsID(), theStandardPackage.getBoolean(), "isID", null, 0, 1, Property.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getProperty_IsSetterAbstract(), theStandardPackage.getBoolean(), "isSetterAbstract", null, 0, 1, Property.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getProperty_IsComposite(), theStandardPackage.getBoolean(), "isComposite", null, 0, 1, Property.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getProperty_IsGetterAbstract(), theStandardPackage.getBoolean(), "isGetterAbstract", null, 0, 1, Property.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		EOperation op = addEOperation(typeEClass, this.getObject(), "clone", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getObject(), "objectToClone", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = addEOperation(typeEClass, this.getObject(), "deepClone", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getObject(), "objectToClone", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = addEOperation(typeEClass, theStandardPackage.getBoolean(), "isInstance", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getObject(), "element", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = addEOperation(typeEClass, theStandardPackage.getBoolean(), "isSuperTypeOf", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getType(), "object", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = addEOperation(typeEClass, theStandardPackage.getBoolean(), "isSubTypeOf", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getType(), "object", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEClass(objectEClass, kermeta.language.structure.Object.class, "Object", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getObject_Tag(), this.getTag(), this.getTag_Object(), "tag", null, 0, -1, kermeta.language.structure.Object.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getObject_OwnedTags(), this.getTag(), null, "ownedTags", null, 0, -1, kermeta.language.structure.Object.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		op = addEOperation(objectEClass, theStandardPackage.getBoolean(), "isSet", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getProperty(), "property", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = addEOperation(objectEClass, theStandardPackage.getBoolean(), "isKindOf", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = addEOperation(objectEClass, theStandardPackage.getBoolean(), "equals", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getObject(), "element", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		addEOperation(objectEClass, theStandardPackage.getBoolean(), "isFrozen", 0, 1, IS_UNIQUE, IS_ORDERED);

		addEOperation(objectEClass, theStandardPackage.getInteger(), "hashcode", 0, 1, IS_UNIQUE, IS_ORDERED);

		addEOperation(objectEClass, null, "checkInvariants", 0, 1, IS_UNIQUE, IS_ORDERED);

		addEOperation(objectEClass, theStandardPackage.getBoolean(), "isVoid", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = addEOperation(objectEClass, theStandardPackage.getBoolean(), "isNotEqual", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getObject(), "element", 0, 1, IS_UNIQUE, IS_ORDERED);

		addEOperation(objectEClass, this.getObject(), "container", 0, 1, IS_UNIQUE, IS_ORDERED);

		addEOperation(objectEClass, theStandardPackage.getInteger(), "oid", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		addEOperation(objectEClass, thePersistencePackage.getResource(), "containingResource", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = addEOperation(objectEClass, theStandardPackage.getBoolean(), "isInstanceOf", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getType(), "type", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = addEOperation(objectEClass, this.getObject(), "asType", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		addEOperation(objectEClass, theStandardPackage.getString(), "toString", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEAttribute(getMultiplicityElement_IsOrdered(), theStandardPackage.getBoolean(), "isOrdered", null, 0, 1, MultiplicityElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMultiplicityElement_Upper(), theStandardPackage.getInteger(), "upper", null, 0, 1, MultiplicityElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMultiplicityElement_Lower(), theStandardPackage.getInteger(), "lower", null, 0, 1, MultiplicityElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMultiplicityElement_IsUnique(), theStandardPackage.getBoolean(), "isUnique", null, 0, 1, MultiplicityElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getTypeDefinition_IsAspect(), theStandardPackage.getBoolean(), "isAspect", null, 0, 1, TypeDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(namedElementEClass, NamedElement.class, "NamedElement", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getNamedElement_Name(), theStandardPackage.getString(), "name", null, 1, 1, NamedElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		addEOperation(namedElementEClass, theStandardPackage.getString(), "qualifiedName", 0, 1, IS_UNIQUE, IS_ORDERED);

		initEClass(classEClass, kermeta.language.structure.Class.class, "Class", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getClass_OwnedOperation(), this.getOperation(), null, "ownedOperation", null, 0, -1, kermeta.language.structure.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, !IS_ORDERED);
		initEReference(getClass_SuperClass(), this.getClass_(), null, "superClass", null, 0, -1, kermeta.language.structure.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, !IS_ORDERED);
		initEAttribute(getClass_IsAbstract(), theStandardPackage.getBoolean(), "isAbstract", null, 0, 1, kermeta.language.structure.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEAttribute(getClass_Name(), theStandardPackage.getString(), "name", null, 0, 1, kermeta.language.structure.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEReference(getClass_ClassDefinition(), this.getClassDefinition(), null, "classDefinition", null, 0, 1, kermeta.language.structure.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEReference(getClass_OwnedAttribute(), this.getProperty(), null, "ownedAttribute", null, 0, -1, kermeta.language.structure.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, !IS_ORDERED);

		op = addEOperation(classEClass, this.getObject(), "clone", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getObject(), "objectToClone", 0, 1, IS_UNIQUE, IS_ORDERED);

		addEOperation(classEClass, this.getObject(), "_new", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = addEOperation(classEClass, this.getObject(), "deepClone", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getObject(), "objectToClone", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = addEOperation(classEClass, theStandardPackage.getBoolean(), "equals", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getObject(), "other", 0, 1, IS_UNIQUE, IS_ORDERED);

		addEOperation(classEClass, theStandardPackage.getString(), "toString", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = addEOperation(enumerationEClass, this.getObject(), "clone", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getObject(), "objectToClone", 0, 1, IS_UNIQUE, IS_ORDERED);

		initEClass(packageEClass, kermeta.language.structure.Package.class, "Package", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPackage_NestingPackage(), this.getPackage(), this.getPackage_NestedPackage(), "nestingPackage", null, 0, 1, kermeta.language.structure.Package.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPackage_NestedPackage(), this.getPackage(), this.getPackage_NestingPackage(), "nestedPackage", null, 0, -1, kermeta.language.structure.Package.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPackage_Uri(), theStandardPackage.getString(), "uri", null, 0, 1, kermeta.language.structure.Package.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getTag_Name(), theStandardPackage.getString(), "name", null, 0, 1, Tag.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTag_Value(), theStandardPackage.getString(), "value", null, 0, 1, Tag.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getClassDefinition_IsAbstract(), theStandardPackage.getBoolean(), "isAbstract", null, 0, 1, ClassDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getClassDefinition_AllOperation(), this.getOperation(), null, "allOperation", null, 0, -1, ClassDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, !IS_ORDERED);
		initEReference(getClassDefinition_AllAttribute(), this.getProperty(), null, "allAttribute", null, 0, -1, ClassDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, !IS_ORDERED);
		...
		op = addEOperation(modelTypeEClass, theStandardPackage.getBoolean(), "isModelTypeOf", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = addEOperation(modelEClass, this.getObject(), "addCompatible", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getObject(), "objectToAdd", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = addEOperation(modelEClass, null, "addAllCompatible", 0, 1, IS_UNIQUE, IS_ORDERED);
		EGenericType g1 = createEGenericType(theStandardPackage.getCollection());
		...
		initEAttribute(getRequire_Uri(), theStandardPackage.getString(), "uri", null, 0, 1, Require.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(usingEClass, Using.class, "Using", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getUsing_QualifiedName(), theStandardPackage.getString(), "qualifiedName", null, 0, 1, Using.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(filterEClass, Filter.class, "Filter", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getFilter_QualifiedName(), theStandardPackage.getString(), "qualifiedName", null, 0, 1, Filter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createKermetaAnnotations() {
		...
		addAnnotation
		  (operationEClass, 
		   source, 
		   new String[] {
			 "documentation", "Every one knows what an operation is."
		   });		
		addAnnotation
		...
		addAnnotation
		  (getOperation_Body(), 
		   source, 
		   new String[] {
			 "documentation", "Body of the Operation, expressed as a KerMeta expression"
		   });		
		addAnnotation
		  (getOperation_Post(), 
		   source, 
		...
		addAnnotation
		  (getOperation_IsAbstract(), 
		   source, 
		   new String[] {
			 "documentation", "Boolean stating whether the Operation is abstract"
		   });		
		addAnnotation
		...
		addAnnotation
		  (getProperty_IsDerived(), 
		   source, 
		   new String[] {
			 "documentation", "If True, the value of the property is not stored but computed from other properties"
		   });		
		addAnnotation
		  (getProperty_Opposite(), 
		   source, 
		   new String[] {
			 "documentation", "Opposite Property of the Property, void if the Property has no opposite"
		   });		
		addAnnotation
		...
		addAnnotation
		  (getProperty_IsReadOnly(), 
		   source, 
		   new String[] {
			 "documentation", "Boolean stating whether the Property is read-only"
		   });		
		addAnnotation
		...
		addAnnotation
		  (getProperty_IsID(), 
		   source, 
		   new String[] {
			 "documentation", "Boolean stating whether the property allows to identify its containing Object"
		   });		
		addAnnotation
		...
		addAnnotation
		  (getProperty_IsSetterAbstract(), 
		   source, 
		   new String[] {
			 "documentation", "Boolean stating wether the setter is abstract."
		   });		
		addAnnotation
		  (getProperty_IsComposite(), 
		   source, 
		   new String[] {
			 "documentation", "Boolean stating whether the Property has a containment role"
		   });		
		addAnnotation
		  (getProperty_IsGetterAbstract(), 
		   source, 
		   new String[] {
			 "documentation", "Boolean stating wether the getter is abstract."
		   });		
		addAnnotation
		  (typeEClass, 
		   source, 
		   new String[] {
			 "documentation", "Alias to kermeta::standard::Integer"
		   });		
		addAnnotation
		  (typeEClass, 
		   source, 
		   new String[] {
			 "documentation", "Base class definition for the <b>use</b> of a type."
		   });		
		addAnnotation
		...
		addAnnotation
		  (getEnumerationLiteral_Enumeration(), 
		   source, 
		   new String[] {
			 "documentation", "Owning Enumeration"
		   });		
		addAnnotation
		  (typeVariableBindingEClass, 
		   source, 
		   new String[] {
			 "documentation", "Definition of a binding between a TypeVariable and a Type"
		   });		
		addAnnotation
		...
		addAnnotation
		  (objectEClass, 
		   source, 
		   new String[] {
			 "documentation", "Object definition: all entities of Kermeta metamodel explicitly inherit from Object"
		   });		
		addAnnotation
		...
		addAnnotation
		  (multiplicityElementEClass, 
		   source, 
		   new String[] {
			 "documentation", " Model elements with a multiplicity [lower..upper] inherit this class"
		   });		
		addAnnotation
		  (getMultiplicityElement_IsOrdered(), 
		   source, 
		   new String[] {
			 "documentation", "Boolean stating whether the element is ordered"
		   });		
		addAnnotation
		  (getMultiplicityElement_Upper(), 
		   source, 
		   new String[] {
			 "documentation", "Max cardinality of the element, \'-1\' for \'*\'"
		   });		
		addAnnotation
		...
		addAnnotation
		  (getMultiplicityElement_IsUnique(), 
		   source, 
		   new String[] {
			 "documentation", "Boolean stating whether duplicated elements are allowed"
		   });		
		addAnnotation
		...
		addAnnotation
		  (typedElementEClass, 
		   source, 
		   new String[] {
			 "documentation", "Abstraction of the notion of typed element : each element \nthat is typed inherits this class."
		   });		
		addAnnotation
		...
		addAnnotation
		  (typeDefinitionEClass, 
		   source, 
		   new String[] {
			 "documentation", "This boolean allows to tell if this Type definition is an aspect or not\nIf it is an aspect, then at runtime, its definition will be merged with the definition of another\nTypeDefinition that has exactly the same qualified name"
		   });		
		addAnnotation
		  (typeDefinitionEClass, 
		   source, 
		   new String[] {
			 "documentation", "Abstraction for type definitions (ClassDefinition, ModelTypeDefinition, DataType inherit\nthis class)"
		   });		
		addAnnotation
		  (namedElementEClass, 
		   source, 
		   new String[] {
			 "documentation", "Any element that contain a  name (example : Operation, Property) inherit this\nclass."
		   });		
		addAnnotation
		...
		addAnnotation
		  (classEClass, 
		   source, 
		   new String[] {
			 "documentation", "Returns the Attributes, References, and derived Properties owned by\nthe ClassDefinition of this Class."
		   });		
		addAnnotation
		  (classEClass.getEOperations().get(0), 
		   source, 
		   new String[] {
			 "superOperation", "kermeta::language::structure::Type"
		   });		
		addAnnotation
		...
		addAnnotation
		  (classEClass.getEOperations().get(3), 
		   source, 
		   new String[] {
		...
		addAnnotation
		  (getClass_IsAbstract(), 
		   source, 
		   new String[] {
			 "documentation", "Returns a Boolean stating whether ClassDefinition of this Class is abstract."
		   });		
		addAnnotation
		  (getClass_Name(), 
		   source, 
		...
		addAnnotation
		  (getClass_Name(), 
		   source, 
		   new String[] {
			 "documentation", "Returns the name of the ClassDefinition of this Class"
		   });		
		addAnnotation
		...
		addAnnotation
		  (dataTypeEClass, 
		   source, 
		   new String[] {
			 "documentation", "Special type definition for Enumeration, PrimitiveType"
		   });		
		addAnnotation
		  (enumerationEClass, 
		   source, 
		...
		addAnnotation
		  (packageEClass, 
		   source, 
		   new String[] {
			 "documentation", "Package in kermeta. Each kermeta model must have a root package. "
		   });		
		addAnnotation
		...
		addAnnotation
		  (getPackage_Uri(), 
		   source, 
		   new String[] {
			 "documentation", "Uri of the Package"
		   });		
		addAnnotation
		  (parameterEClass, 
		   source, 
		   new String[] {
			 "documentation", "Definition for operation parameter"
		   });		
		addAnnotation
		...
		addAnnotation
		  (tagEClass, 
		   source, 
		   new String[] {
			 "documentation", "Tag is intended to be used to add documentation on a  model element,\nor add some textual information that cannot be expressed with any\nmodel element definition."
		   });		
		addAnnotation
		  (getTag_Name(), 
		   source, 
		...
		addAnnotation
		  (getTag_Value(), 
		   source, 
		   new String[] {
			 "documentation", "String value of the Tag"
		   });		
		addAnnotation
		  (getTag_Object(), 
		   source, 
		   new String[] {
			 "documentation", "Objects to which the Tag is attached to"
		   });		
		addAnnotation
		  (constraintEClass, 
		   source, 
		   new String[] {
			 "documentation", "Constraint is part of a contract implementation in a Class definition or an operation.\nThree kinds of constraints are available : pre, post, and inv (invariant constraint)"
		   });		
		addAnnotation
		  (getConstraint_Body(), 
		   source, 
		   new String[] {
			 "documentation", "Body of the constraint, expressed as a KerMeta expression"
		   });		
		addAnnotation
		  (getConstraint_PreOwner(), 
		   source, 
		   new String[] {
			 "documentation", "Owning Operation if Constraint corresponds to pre-condition"
		   });		
		addAnnotation
		  (getConstraint_Stereotype(), 
		   source, 
		   new String[] {
			 "documentation", "Type of the Constraint (precond/postcond/inv)"
		   });		
		addAnnotation
		  (getConstraint_PostOwner(), 
		   source, 
		   new String[] {
			 "documentation", "Owning Operation if Constraint corresponds to post-condition"
		   });		
		addAnnotation
		  (getConstraint_Language(), 
		   source, 
		   new String[] {
			 "documentation", "Language in which the constraint is expressed"
		   });		
		addAnnotation
		  (getConstraint_InvOwner(), 
		   source, 
		   new String[] {
			 "documentation", "Owning ClassDefinition if Constraint corresponds to invariant"
		   });		
		addAnnotation
		  (classDefinitionEClass, 
		   source, 
		   new String[] {
			 "documentation", "The definition of a class definition :)\n <pre>class A\n{ \n  attribute s : String\n}\n  </pre> is a class definition; in :\n<pre>\nmain() : A is do end\n</pre>\nA is a <b>Class</b> : it corresponds to the <b>use</b> of the class definition of A"
		   });		
		addAnnotation
		  (getClassDefinition_OwnedOperation(), 
		   source, 
		   new String[] {
			 "documentation", "Operations owned by this ClassDefinition."
		   });		
		addAnnotation
		  (getClassDefinition_IsAbstract(), 
		   source, 
		   new String[] {
			 "documentation", "Boolean stating whether the ClassDefinition is abstract (which means that\nno instance can be allocated)"
		   });		
		addAnnotation
		  (getClassDefinition_SuperType(), 
		   source, 
		   new String[] {
			 "documentation", "Classes from which this ClassDefinition inherits."
		   });		
		addAnnotation
		  (getClassDefinition_Inv(), 
		   source, 
		   new String[] {
			 "documentation", "Invariants defined for this ClassDefinition"
		   });		
		addAnnotation
		...
		addAnnotation
		  (getClassDefinition_OwnedAttribute(), 
		   source, 
		   new String[] {
			 "documentation", "Attributes, References, and derived Properties owned by this ClassDefinition."
		   });		
		addAnnotation
		  (genericTypeDefinitionEClass, 
		   source, 
		   new String[] {
			 "documentation", "Abstracts the definition of generic type definitions (i.e. type definitions that\ncan be parameterized), namely, for ClassDefinition and ModelTypeDefinition."
		   });		
		addAnnotation
		  (getGenericTypeDefinition_TypeParameter(), 
		   source, 
		   new String[] {
			 "documentation", "Type variables defined for the GenericTypeDefinition"
		   });		
		addAnnotation
		  (parameterizedTypeEClass, 
		   source, 
		   new String[] {
			 "documentation", "Abstraction for Parameterized types, namely, Class and ModelType"
		   });		
		addAnnotation
		  (getParameterizedType_TypeParamBinding(), 
		   source, 
		   new String[] {
			 "documentation", "Bindings between type variables and provided types "
		   });		
		addAnnotation
		  (getParameterizedType_TypeDefinition(), 
		   source, 
		   new String[] {
			 "documentation", "Definition of the Type"
		   });		
		addAnnotation
		...
		addAnnotation
		  (modelTypeEClass, 
		   source, 
		   new String[] {
			 "documentation", "Type of a model, consisting of a set of included type definitions"
		   });		
		addAnnotation
		...
		addAnnotation
		  (modelEClass, 
		   source, 
		   new String[] {
			 "documentation", "Is the holder of a set of model elements (Object) that are compatible with the ModelType that has \ninstantiated this Model."
		   });		
		addAnnotation
		...
		addAnnotation
		  (modelEClass.getEOperations().get(1), 
		   source, 
		   new String[] {
		...
		addAnnotation
		  (getModelingUnit_Requires(), 
		   source, 
		   new String[] {
			 "documentation", "Set of \"require\" statements associated with this ModelingUnit. Ie. list of the other\nfiles required to run this unit"
		   });		
		addAnnotation
		  (requireEClass, 
		   source, 
		...
		addAnnotation
		  (filterEClass, 
		   source, 
		   new String[] {
			 "documentation", "Filter is the class that represent a filter on a ModelingUnit.\nthe qualifiedName represent the beginning of the matched names"
		   });		
		addAnnotation
		...
		addAnnotation
		  (productTypeEClass, 
		   source, 
		   new String[] {
			 "documentation", "Type corresponding to a set of Types\nOnly used in the context of FunctionType"
		   });		
		addAnnotation
		  (getProductType_Type(), 
		   source, 
		...
		addAnnotation
		  (voidTypeEClass, 
		   source, 
		   new String[] {
			 "documentation", "Class definition for the <pre>Void</pre> type"
		   });		
		addAnnotation
		  (typeDefinitionContainerEClass, 
		   source, 
		   new String[] {
			 "documentation", "Abstraction of the notion of containment for type definitions. Now, kermeta metamodel contains one container\nelement, that is Package. In a later release, ModelTypeDefinition will be the main container for type and\npackage definition."
		   });		
		addAnnotation
		  (getTypeDefinitionContainer_OwnedTypeDefinition(), 
		   source, 
		   new String[] {
			 "documentation", "Contained TypeDefinitions"
		   });
	}
