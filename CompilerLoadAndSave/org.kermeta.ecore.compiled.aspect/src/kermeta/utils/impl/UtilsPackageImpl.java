 ...
 * </copyright>
 *
 * $Id: UtilsPackageImpl.java,v 1.1 2008-07-02 09:44:02 ftanguy Exp $
 */
...
public class UtilsPackageImpl extends EPackageImpl implements UtilsPackage {
	...
	public void initializePackageContents() {
		...
		EOperation op = addEOperation(hashtableEClass, null, "getValue", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = addEOperation(stringBufferEClass, this.getStringBuffer(), "append", 0, 1, IS_UNIQUE, IS_ORDERED);
