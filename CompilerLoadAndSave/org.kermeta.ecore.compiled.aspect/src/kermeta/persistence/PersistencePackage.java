 ...
 * </copyright>
 *
 * $Id: PersistencePackage.java,v 1.1 2008-07-02 09:43:57 ftanguy Exp $
 */
...
public interface PersistencePackage extends EPackage {
	 ...
	 * @ordered
	 */
	int RESOURCE__REPOSITORY = StandardPackage.SET_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int RESOURCE__CONTENTS = StandardPackage.SET_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int KM_RESOURCE__VALUES = RESOURCE__VALUES;
