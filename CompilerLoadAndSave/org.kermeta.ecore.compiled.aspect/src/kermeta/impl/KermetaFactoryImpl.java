 ...
 * </copyright>
 *
 * $Id: KermetaFactoryImpl.java,v 1.1 2008-07-02 09:44:02 ftanguy Exp $
 */
...
public class KermetaFactoryImpl extends EFactoryImpl implements KermetaFactory {
	...
	public static KermetaFactory init() {
		try {
			KermetaFactory theKermetaFactory = (KermetaFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.kermeta.org/kermeta/1_2_0//kermeta"); 
