 ...
 *
 * $Id: KermetaFactoryImpl.java,v 1.1 2008-07-02 09:13:34 ftanguy Exp $
 */
...
public class KermetaFactoryImpl extends EFactoryImpl implements KermetaFactory
{
  ...
  {
		try {
			KermetaFactory theKermetaFactory = (KermetaFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.kermeta.org/kermeta/kermeta_temp_uri"); 
