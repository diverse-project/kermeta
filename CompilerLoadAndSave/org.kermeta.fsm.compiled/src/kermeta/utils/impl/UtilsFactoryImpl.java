 ...
 *
 * $Id: UtilsFactoryImpl.java,v 1.1 2008-07-02 09:13:33 ftanguy Exp $
 */
...
public class UtilsFactoryImpl extends EFactoryImpl implements UtilsFactory
{
  ...
  public static UtilsFactory init()
  {
    try
    {
      UtilsFactory theUtilsFactory = (UtilsFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.kermeta.org/kermeta/utils/kermeta_temp_uri"); 
