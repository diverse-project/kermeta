 ...
 *
 * $Id: InterpreterFactoryImpl.java,v 1.1 2008-07-02 09:13:32 ftanguy Exp $
 */
...
public class InterpreterFactoryImpl extends EFactoryImpl implements InterpreterFactory
{
  ...
  public static InterpreterFactory init()
  {
    try
    {
      InterpreterFactory theInterpreterFactory = (InterpreterFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.kermeta.org/kermeta/interpreter/kermeta_temp_uri"); 
