 ...
 *
 * $Id: ExceptionsFactoryImpl.java,v 1.1 2008-07-02 09:13:28 ftanguy Exp $
 */
...
public class ExceptionsFactoryImpl extends EFactoryImpl implements ExceptionsFactory
{
  ...
  public static ExceptionsFactory init()
  {
    try
    {
      ExceptionsFactory theExceptionsFactory = (ExceptionsFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.kermeta.org/kermeta/exceptions/kermeta_temp_uri"); 
  ...
  public EObject create(EClass eClass)
  {
    ...
    {
      case ExceptionsPackage.EXCEPTION: return createException();
      case ExceptionsPackage.RUNTIME_ERROR: return createRuntimeError();
      case ExceptionsPackage.CALL_ON_VOID_TARGET: return createCallOnVoidTarget();
      case ExceptionsPackage.TYPE_CAST_ERROR: return createTypeCastError();
      case ExceptionsPackage.NOT_IMPLEMENTED_EXCEPTION: return createNotImplementedException();
      case ExceptionsPackage.UPPER_BOUND_REACHED_ERROR: return createUpperBoundReachedError();
      case ExceptionsPackage.ABSTRACT_CLASS_INSTANTIATION_ERROR: return createAbstractClassInstantiationError();
      case ExceptionsPackage.INCOMPATIBLE_TYPE_ERROR: return createIncompatibleTypeError();
      case ExceptionsPackage.DIVISION_BY_ZERO: return createDivisionByZero();
      case ExceptionsPackage.OVERFLOW_ERROR: return createOverflowError();
      case ExceptionsPackage.VOID_OPERAND_ERROR: return createVoidOperandError();
      case ExceptionsPackage.STRING_INDEX_OUT_OF_BOUND: return createStringIndexOutOfBound();
      case ExceptionsPackage.STRING_FORMAT_EXCEPTION: return createStringFormatException();
      case ExceptionsPackage.INDEX_OUT_OF_BOUND: return createIndexOutOfBound();
      case ExceptionsPackage.EMPTY_COLLECTION: return createEmptyCollection();
      case ExceptionsPackage.ITERATOR_IS_OFF: return createIteratorIsOff();
      case ExceptionsPackage.IO_EXCEPTION: return createIOException();
      case ExceptionsPackage.FILE_NOT_FOUND_EXCEPTION: return createFileNotFoundException();
      case ExceptionsPackage.CONSTRAINT_VIOLATED_PRE: return createConstraintViolatedPre();
      case ExceptionsPackage.CONSTRAINT_VIOLATED_POST: return createConstraintViolatedPost();
      case ExceptionsPackage.CONSTRAINT_VIOLATED_INV: return createConstraintViolatedInv();
      case ExceptionsPackage.RESOURCE_LOAD_EXCEPTION: return createResourceLoadException();
      case ExceptionsPackage.RESOURCE_SAVE_EXCEPTION: return createResourceSaveException();
      case ExceptionsPackage.RESOURCE_CREATE_EXCEPTION: return createResourceCreateException();
      case ExceptionsPackage.RESOURCE_UNCONFORMITY_EXCEPTION: return createResourceUnconformityException();
      case ExceptionsPackage.DYNAMIC_EXPRESSION_EXCEPTION: return createDynamicExpressionException();
      default:
