 ...
 *
 * $Id: KunitPackage.java,v 1.1 2008-07-02 09:13:32 ftanguy Exp $
 */
...
public interface KunitPackage extends EPackage
{
   ...
   * @generated
   */
  String eNS_URI = "http://www.kermeta.org/kermeta/kunit/kermeta_temp_uri";
  ...
  /**
   * Returns the meta object for the attribute '{@link kermeta.kunit.Fallible#isStopOnFailure <em>Stop On Failure</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Stop On Failure</em>'.
   * @see kermeta.kunit.Fallible#isStopOnFailure()
   * @see #getFallible()
   * @generated
   */
  ...
  interface Literals
  {
     ...
     * @generated
     */
    EClass INVALID_TEST_CASE_NAME_EXCEPTION = eINSTANCE.getInvalidTestCaseNameException();
     ...
     * @generated
     */
    EClass INVALID_PARAMETER_EXCEPTION = eINSTANCE.getInvalidParameterException();
     ...
     * @generated
     */
    EAttribute FALLIBLE__STOP_ON_FAILURE = eINSTANCE.getFallible_StopOnFailure();
     ...
     * @generated
     */
    EAttribute TEST_CASE__TEST_METHOD_NAME = eINSTANCE.getTestCase___testMethodName();
