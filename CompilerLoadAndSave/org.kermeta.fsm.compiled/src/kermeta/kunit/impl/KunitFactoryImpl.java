 ...
 *
 * $Id: KunitFactoryImpl.java,v 1.1 2008-07-02 09:13:27 ftanguy Exp $
 */
...
public class KunitFactoryImpl extends EFactoryImpl implements KunitFactory
{
  ...
  public static KunitFactory init()
  {
    try
    {
      KunitFactory theKunitFactory = (KunitFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.kermeta.org/kermeta/kunit/kermeta_temp_uri"); 
  ...
  public EObject create(EClass eClass)
  {
    ...
    {
      case KunitPackage.INVALID_TEST_CASE_NAME_EXCEPTION: return createInvalidTestCaseNameException();
      case KunitPackage.INVALID_PARAMETER_EXCEPTION: return createInvalidParameterException();
      case KunitPackage.LOG: return createLog();
      case KunitPackage.FAILURE: return createFailure();
      case KunitPackage.ERROR: return createError();
      case KunitPackage.TEST_SUITE: return createTestSuite();
      case KunitPackage.TEST_RUNNER: return createTestRunner();
      case KunitPackage.ASSERTION_FAILED_ERROR: return createAssertionFailedError();
      case KunitPackage.ASSERT: return createAssert();
      default:
   ...
   * @generated
   */
  public ErrorKind createErrorKindFromString(EDataType eDataType, String initialValue)
  {
   ...
   * @generated
   */
  public String convertErrorKindToString(EDataType eDataType, Object instanceValue)
  {
