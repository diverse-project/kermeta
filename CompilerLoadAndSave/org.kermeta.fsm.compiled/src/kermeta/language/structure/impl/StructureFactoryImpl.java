 ...
 *
 * $Id: StructureFactoryImpl.java,v 1.2 2008-07-25 12:40:06 ftanguy Exp $
 */
...
public class StructureFactoryImpl extends EFactoryImpl implements StructureFactory
{
  ...
  {
		try {
			StructureFactory theStructureFactory = (StructureFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.kermeta.org/kermeta/language/structure/kermeta_temp_uri"); 
