 ...
 *
 * $Id: StructurePackageImpl.java,v 1.2 2008-07-25 12:40:06 ftanguy Exp $
 */
...
public class StructurePackageImpl extends EPackageImpl implements StructurePackage
{
  ...
  public void initializePackageContents()
  {
		...
		initEReference(getObject_Container(), this.getObject(), null, "container", null, 0, 1, kermeta.language.structure.Object.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getObject_Oid(), ecorePackage.getEInt(), "oid", null, 0, 1, kermeta.language.structure.Object.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		EOperation op = addEOperation(objectEClass, theStandardPackage.getBoolean(), "isSet", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = addEOperation(typeEClass, this.getObject(), "clone", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getObject(), "objectToClone", 0, 1, IS_UNIQUE, IS_ORDERED);
