 ...
 *
 * $Id: Bag.java,v 1.1 2008-07-02 09:13:29 ftanguy Exp $
 */
...
public interface Bag<G> extends Collection<G>
{
   ...
   * @generated
   */
  Sequence<G> sortedBy(EObject comparator);
   ...
   * @generated
   */
  Sequence<G> quickSort(Sequence<G> q, EObject comparator);
   ...
   * @generated
   */
  Sequence<G> concatenate(Sequence<G> less, Sequence<G> pivot, Sequence<G> greater);
