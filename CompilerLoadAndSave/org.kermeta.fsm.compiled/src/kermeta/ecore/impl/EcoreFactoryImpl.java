 ...
 *
 * $Id: EcoreFactoryImpl.java,v 1.1 2008-07-02 09:13:24 ftanguy Exp $
 */
...
public class EcoreFactoryImpl extends EFactoryImpl implements EcoreFactory
{
  ...
  public static EcoreFactory init()
  {
    try
    {
      EcoreFactory theEcoreFactory = (EcoreFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.kermeta.org/kermeta/ecore/kermeta_temp_uri"); 
