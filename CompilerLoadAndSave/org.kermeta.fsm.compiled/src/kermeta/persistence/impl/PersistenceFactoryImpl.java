 ...
 *
 * $Id: PersistenceFactoryImpl.java,v 1.1 2008-07-02 09:13:18 ftanguy Exp $
 */
...
public class PersistenceFactoryImpl extends EFactoryImpl implements PersistenceFactory
{
  ...
  public static PersistenceFactory init()
  {
    try
    {
      PersistenceFactory thePersistenceFactory = (PersistenceFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.kermeta.org/kermeta/persistence/kermeta_temp_uri"); 
   ...
   * @generated
   */
  public kermeta.persistence.EMFResource createEMFResource()
  {
   ...
   * @generated
   */
  public kermeta.persistence.EMFRepository createEMFRepository()
  {
