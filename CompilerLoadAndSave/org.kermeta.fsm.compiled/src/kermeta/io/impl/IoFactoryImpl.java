 ...
 *
 * $Id: IoFactoryImpl.java,v 1.1 2008-07-02 09:13:39 ftanguy Exp $
 */
...
public class IoFactoryImpl extends EFactoryImpl implements IoFactory
{
  ...
  public static IoFactory init()
  {
    try
    {
      IoFactory theIoFactory = (IoFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.kermeta.org/kermeta/io/kermeta_temp_uri"); 
