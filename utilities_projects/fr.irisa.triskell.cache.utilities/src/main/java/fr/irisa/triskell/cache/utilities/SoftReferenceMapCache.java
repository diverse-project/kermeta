...
/**
 * This class implement an HashMap cache using WeakReference, that means that if the garbage collector needs to free some memory
 ...
 */
public class SoftReferenceMapCache<Key, Value> extends AbstractReferenceMapCache<Key, Value> 
{ 
