...
import org.kermeta.trek.graphicaleditor.TrekImageRegistry;
 ...
 * @generated
 */
public class NewTrekDiagrams extends Wizard implements INewWizard {
	/**
	 * @generated
	 */
	...
	public void init(IWorkbench workbench, IStructuredSelection sel) {
		...
		setDefaultPageImageDescriptor(TrekImageRegistry
				.getImageDescriptor("NEW_PAGE_WZD"));
		setDialogSettings(TrekPlugin.getDefault().getDialogSettings());
		setWindowTitle("Create new Trek diagrams");
	}
		...
		if (diagPage.isPageComplete()) {
			if (diagPage.isNewModel()) {
				...
				if (createdFile != null && result) {
					...
					try {
						IDE.openEditor(TrekPlugin.getDefault().getWorkbench()
	...
	public void addPages() {
		diagPage = new TrekDiagramsPage("New Trek Graphical Editor Diagram",
				selection);
		diagPage.setTitle("Trek Diagrams");
