 ...
 ******************************************************************************/
package org.kermeta.trek.graphicaleditor.preferences;
...
/**
 * A preference page to configure all preferences of the Trek editor.
 *
 * @generated
 */
public class TrekPreferencePage extends PreferencePage implements
		IWorkbenchPreferencePage {
	/**
	 * @generated
	 */
	private IPreferenceStore ps = TrekPlugin.getDefault().getPreferenceStore();
	...
	private void createHeader(Composite parent) {
		new Label(parent, SWT.WRAP).setText("Trek editor preference page");
	}
