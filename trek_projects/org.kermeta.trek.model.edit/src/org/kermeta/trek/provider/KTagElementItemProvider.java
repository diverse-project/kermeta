...
public class KTagElementItemProvider
	 ...
	 * @generated
	 */
	public KTagElementItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/KTagElement"));
	}
	...
	public String getText(Object object) {
		String label = ((KTagElement)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_KTagElement_type") :
			getString("_UI_KTagElement_type") + " " + label;
	}
