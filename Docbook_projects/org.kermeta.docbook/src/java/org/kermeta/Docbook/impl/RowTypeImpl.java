 ...
 * <ul>
 *   <li>{@link org.kermeta.Docbook.impl.RowTypeImpl#getEntry <em>Entry</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RowTypeImpl extends EObjectImpl implements RowType {
	...
	protected EClass eStaticClass() {
		return DocbookPackage.Literals.ROW_TYPE;
	}
	...
	public EList<EntryType> getEntry() {
		if (entry == null) {
			entry = new EObjectContainmentEList<EntryType>(EntryType.class, this, DocbookPackage.ROW_TYPE__ENTRY);
		}
		return entry;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DocbookPackage.ROW_TYPE__ENTRY:
