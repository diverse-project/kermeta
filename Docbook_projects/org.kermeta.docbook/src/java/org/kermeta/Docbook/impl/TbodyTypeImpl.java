 ...
 * <ul>
 *   <li>{@link org.kermeta.Docbook.impl.TbodyTypeImpl#getRow <em>Row</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TbodyTypeImpl extends EObjectImpl implements TbodyType {
	...
	protected EClass eStaticClass() {
		return DocbookPackage.Literals.TBODY_TYPE;
	}
	...
	public EList<RowType> getRow() {
		if (row == null) {
			row = new EObjectContainmentEList<RowType>(RowType.class, this, DocbookPackage.TBODY_TYPE__ROW);
		}
		return row;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DocbookPackage.TBODY_TYPE__ROW:
