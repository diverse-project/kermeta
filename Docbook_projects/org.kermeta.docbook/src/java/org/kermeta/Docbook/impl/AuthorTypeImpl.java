 ...
 * <ul>
 *   <li>{@link org.kermeta.Docbook.impl.AuthorTypeImpl#getFirstname <em>Firstname</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AuthorTypeImpl extends EObjectImpl implements AuthorType {
	...
	public EList<String> getFirstname() {
		if (firstname == null) {
			firstname = new EDataTypeEList<String>(String.class, this, DocbookPackage.AUTHOR_TYPE__FIRSTNAME);
		}
		return firstname;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DocbookPackage.AUTHOR_TYPE__FIRSTNAME:
				return getFirstname();
		}
