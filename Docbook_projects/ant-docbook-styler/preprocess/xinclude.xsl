...
<!-- transformation retreived from http://www.dpawson.co.uk/xsl/sect2/include.html
	http://www.dpawson.co.uk/xsl/sect2/sect21.html
	http://www.dpawson.co.uk/xsl/sect2/xinclude.html
-->
<xsl:stylesheet 
...
<!-- DVK 
<xsl:template name="savedoc">
  <xsl:document href="c:/truc.xml">
		<hello></hello>
  </xsl:document>
</xsl:template>
-->
