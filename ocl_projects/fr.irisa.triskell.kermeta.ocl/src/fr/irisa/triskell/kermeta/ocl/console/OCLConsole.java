...
public class OCLConsole implements KermetaIOStream {
	...
	public void print(Object outputString) {
		printMessage(outputString.toString(), OCLConsole.KERMETA);
	}
	...
	public static MessageConsole getConsole() {
		if (console == null) {
			console = new MessageConsole("ISTeCQ Console", null, true);
