...
public class OCLParse implements IObjectActionDelegate {

	protected StructuredSelection currentSelection;
    protected IFile oclfile;
	...
	public void run(IAction action) {
		...
		OCLParseWizard wizard =  new OCLParseWizard();
    	wizard.defaultOutputExtension = "kmt";
    	...
    	wizDialog.setTitle("Transform OCL to Kermeta");
    	wizDialog.open();
	}
