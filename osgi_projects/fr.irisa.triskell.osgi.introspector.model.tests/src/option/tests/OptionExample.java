 ...
 * </copyright>
 *
 * $Id: OptionExample.java,v 1.1 2008-08-22 12:40:02 edaubert Exp $
 */
...
/**
 * <!-- begin-user-doc --> A sample utility for the '<em><b>option</b></em>'
...
public class OptionExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.option"));
				AttributEntry root = OptionFactory.eINSTANCE.createAttributEntry();
