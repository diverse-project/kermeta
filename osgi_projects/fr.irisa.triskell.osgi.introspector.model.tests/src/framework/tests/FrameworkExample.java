 ...
 * </copyright>
 *
 * $Id: FrameworkExample.java,v 1.1 2008-08-22 12:40:06 edaubert Exp $
 */
...
/**
 * <!-- begin-user-doc --> A sample utility for the '<em><b>framework</b></em>'
...
public class FrameworkExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.framework"));
				Framework root = FrameworkFactory.eINSTANCE.createFramework();
