...
public final class AUniqueNameWildcard extends PUniqueNameWildcard {
	...
	public AUniqueNameWildcard(@SuppressWarnings("hiding")
	PUniqueNameWildcardCommons _uniqueNameWildcardCommons_,
			@SuppressWarnings("hiding")
			List<PUniqueNameWildcardSuffix> _uniqueNameWildcardSuffix_) {
		// Constructor
	...
	public String toString() {
		return "" + toString(this._uniqueNameWildcardCommons_)
	...
	Node newChild) {
		...
		for (ListIterator<PUniqueNameWildcardSuffix> i = this._uniqueNameWildcardSuffix_
