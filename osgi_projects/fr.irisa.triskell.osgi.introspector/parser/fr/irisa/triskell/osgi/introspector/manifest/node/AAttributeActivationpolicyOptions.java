...
public final class AAttributeActivationpolicyOptions extends
		PActivationpolicyOptions {
	private PParameter _parameter_;

	public AAttributeActivationpolicyOptions() {
		// Constructor
	}

	public AAttributeActivationpolicyOptions(@SuppressWarnings("hiding")
	...
	@Override
	public Object clone() {
		return new AAttributeActivationpolicyOptions(
				cloneNode(this._parameter_));
	}

	public void apply(Switch sw) {
		((Analysis) sw).caseAAttributeActivationpolicyOptions(this);
	}
