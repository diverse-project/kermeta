...
public final class AOsnameOs2OsnameValue extends POsnameValue {
	...
	public AOsnameOs2OsnameValue(@SuppressWarnings("hiding")
	TOsnameOs2 _osnameOs2_) {
		// Constructor
	...
	@Override
	public Object clone() {
		return new AOsnameOs2OsnameValue(cloneNode(this._osnameOs2_));
	}
	...
	public String toString() {
		return "" + toString(this._osnameOs2_);
	}
