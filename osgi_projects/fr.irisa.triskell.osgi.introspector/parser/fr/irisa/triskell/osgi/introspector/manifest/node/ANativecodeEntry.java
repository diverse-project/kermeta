...
public final class ANativecodeEntry extends PNativecodeEntry {
	...
	public ANativecodeEntry(@SuppressWarnings("hiding")
	PTarget _target_, @SuppressWarnings("hiding")
	List<PNativecodeEntryValue> _nativecodeEntryValue_,
			@SuppressWarnings("hiding")
			List<PNativecodeParameter> _nativecodeParameter_) {
		// Constructor
		setTarget(_target_);
	...
	@Override
	public Object clone() {
		return new ANativecodeEntry(cloneNode(this._target_),
	...
	Node newChild) {
		...
		for (ListIterator<PNativecodeEntryValue> i = this._nativecodeEntryValue_
		...
		for (ListIterator<PNativecodeParameter> i = this._nativecodeParameter_
				.listIterator(); i.hasNext();) {
			if (i.next() == oldChild) {
				if (newChild != null) {
