...
public final class ANativecodeAttributeNativecodeParameter extends
		PNativecodeParameter {
	private PParameter _parameter_;

	public ANativecodeAttributeNativecodeParameter() {
		// Constructor
	}

	public ANativecodeAttributeNativecodeParameter(@SuppressWarnings("hiding")
	...
	@Override
	public Object clone() {
		return new ANativecodeAttributeNativecodeParameter(
				cloneNode(this._parameter_));
	}

	public void apply(Switch sw) {
		((Analysis) sw).caseANativecodeAttributeNativecodeParameter(this);
	}
