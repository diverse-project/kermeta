...
public final class AUnquotedStringStringEntryValue extends PStringEntryValue {
	private TUnquotedString _unquotedString_;

	public AUnquotedStringStringEntryValue() {
		// Constructor
	}

	public AUnquotedStringStringEntryValue(@SuppressWarnings("hiding")
	...
	@Override
	public Object clone() {
		return new AUnquotedStringStringEntryValue(
				cloneNode(this._unquotedString_));
	}

	public void apply(Switch sw) {
		((Analysis) sw).caseAUnquotedStringStringEntryValue(this);
	}
