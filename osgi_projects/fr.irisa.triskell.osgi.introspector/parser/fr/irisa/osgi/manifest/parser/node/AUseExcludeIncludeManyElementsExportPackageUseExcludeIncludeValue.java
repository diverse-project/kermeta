...
public final class AUseExcludeIncludeManyElementsExportPackageUseExcludeIncludeValue extends PExportPackageUseExcludeIncludeValue
{
    ...
    public AUseExcludeIncludeManyElementsExportPackageUseExcludeIncludeValue(
        ...
        @SuppressWarnings("hiding") PUniqueNameWildcard _uniqueNameWildcard_,
        @SuppressWarnings("hiding") List<PExportPackageUseExcludeIncludeIdentifier> _exportPackageUseExcludeIncludeIdentifier_,
    ...
    {
        ((Analysis) sw).caseAUseExcludeIncludeManyElementsExportPackageUseExcludeIncludeValue(this);
    }
    ...
    public void setExportPackageUseExcludeIncludeIdentifier(List<PExportPackageUseExcludeIncludeIdentifier> list)
    {
    ...
    void replaceChild(@SuppressWarnings("unused") Node oldChild, @SuppressWarnings("unused") Node newChild)
    {
        ...
        for(ListIterator<PExportPackageUseExcludeIncludeIdentifier> i = this._exportPackageUseExcludeIncludeIdentifier_.listIterator(); i.hasNext();)
        {
            if(i.next() == oldChild)
            {
                if(newChild != null)
