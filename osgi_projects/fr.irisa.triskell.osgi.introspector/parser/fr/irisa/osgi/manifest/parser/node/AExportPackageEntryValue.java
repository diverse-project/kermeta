...
public final class AExportPackageEntryValue extends PExportPackageEntryValue
{
    ...
    public AExportPackageEntryValue(
        ...
        @SuppressWarnings("hiding") List<PExportPackageParameter> _exportPackageParameter_)
    {
        // Constructor
    ...
    public Object clone()
    {
        return new AExportPackageEntryValue(
    ...
    void replaceChild(@SuppressWarnings("unused") Node oldChild, @SuppressWarnings("unused") Node newChild)
    {
        ...
        for(ListIterator<PExportPackageParameter> i = this._exportPackageParameter_.listIterator(); i.hasNext();)
        {
            if(i.next() == oldChild)
            {
                if(newChild != null)
