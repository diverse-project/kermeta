...
public final class AQuotedUrl extends PQuotedUrl {
	...
	public AQuotedUrl(@SuppressWarnings("hiding")
	TQuote _leftquote_, @SuppressWarnings("hiding")
	PUnquotedUrl _unquotedUrl_, @SuppressWarnings("hiding")
	TQuote _rightquote_) {
		// Constructor
	...
	@Override
	public Object clone() {
		return new AQuotedUrl(cloneNode(this._leftquote_),
				cloneNode(this._unquotedUrl_), cloneNode(this._rightquote_));
	}
	...
	public String toString() {
		return "" + toString(this._leftquote_) + toString(this._unquotedUrl_)
