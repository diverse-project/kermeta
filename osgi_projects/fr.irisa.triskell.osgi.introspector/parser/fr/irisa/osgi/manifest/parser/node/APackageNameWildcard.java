...
public final class APackageNameWildcard extends PPackageNameWildcard {
	private PUniqueNameWildcard _uniqueNameWildcard_;

	public APackageNameWildcard() {
		// Constructor
	}

	public APackageNameWildcard(@SuppressWarnings("hiding")
	...
	@Override
	public Object clone() {
		return new APackageNameWildcard(cloneNode(this._uniqueNameWildcard_));
	}

	public void apply(Switch sw) {
		((Analysis) sw).caseAPackageNameWildcard(this);
	}
