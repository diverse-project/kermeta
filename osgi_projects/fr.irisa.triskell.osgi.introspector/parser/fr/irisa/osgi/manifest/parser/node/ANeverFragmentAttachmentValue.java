...
public final class ANeverFragmentAttachmentValue extends PFragmentAttachmentValue
{
    ...
    public ANeverFragmentAttachmentValue(
        @SuppressWarnings("hiding") TNever _never_)
    {
        // Constructor
        setNever(_never_);
    ...
    public Object clone()
    {
        return new ANeverFragmentAttachmentValue(
