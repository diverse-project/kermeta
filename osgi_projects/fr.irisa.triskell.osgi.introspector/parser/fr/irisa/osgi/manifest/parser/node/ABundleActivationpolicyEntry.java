...
public final class ABundleActivationpolicyEntry extends PBundleActivationpolicyEntry
{
    ...
    public ABundleActivationpolicyEntry(
        @SuppressWarnings("hiding") TBundleActivationpolicy _bundleActivationpolicy_,
        @SuppressWarnings("hiding") PBundleActivationpolicyEntryValue _bundleActivationpolicyEntryValue_)
    {
        // Constructor
    ...
    public void setBundleActivationpolicyEntryValue(PBundleActivationpolicyEntryValue node)
    {
    ...
    {
        return ""
            + toString(this._bundleActivationpolicy_)
