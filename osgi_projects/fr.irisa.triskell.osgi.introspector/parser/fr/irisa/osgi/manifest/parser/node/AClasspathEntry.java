...
public final class AClasspathEntry extends PClasspathEntry
{
    ...
    public AClasspathEntry(
        ...
        @SuppressWarnings("hiding") List<PClasspathEntryValue> _classpathEntryValue_,
    ...
    void replaceChild(@SuppressWarnings("unused") Node oldChild, @SuppressWarnings("unused") Node newChild)
    {
        ...
        for(ListIterator<PClasspathEntryValue> i = this._classpathEntryValue_.listIterator(); i.hasNext();)
        {
            if(i.next() == oldChild)
            {
                if(newChild != null)
