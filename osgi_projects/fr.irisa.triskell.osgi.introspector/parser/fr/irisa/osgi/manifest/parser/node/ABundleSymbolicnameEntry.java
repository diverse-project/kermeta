...
public final class ABundleSymbolicnameEntry extends PBundleSymbolicnameEntry
{
    ...
    public ABundleSymbolicnameEntry(
        @SuppressWarnings("hiding") TBundleSymbolicname _bundleSymbolicname_,
        @SuppressWarnings("hiding") PUniqueName _uniqueName_,
        @SuppressWarnings("hiding") List<PSymbolicnameOption> _symbolicnameOption_)
    {
        // Constructor
    ...
    {
        return ""
            + toString(this._bundleSymbolicname_)
    ...
    void replaceChild(@SuppressWarnings("unused") Node oldChild, @SuppressWarnings("unused") Node newChild)
    {
        ...
        for(ListIterator<PSymbolicnameOption> i = this._symbolicnameOption_.listIterator(); i.hasNext();)
        {
            if(i.next() == oldChild)
            {
                if(newChild != null)
