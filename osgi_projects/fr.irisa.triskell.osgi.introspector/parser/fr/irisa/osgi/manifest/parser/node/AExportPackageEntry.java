...
public final class AExportPackageEntry extends PExportPackageEntry {
	...
	public AExportPackageEntry(@SuppressWarnings("hiding")
	TExportPackage _exportPackage_, @SuppressWarnings("hiding")
	PExportPackageEntryValue1 _exportPackageEntryValue1_) {
		// Constructor
	...
	@Override
	public Object clone() {
		return new AExportPackageEntry(cloneNode(this._exportPackage_),
	...
	public String toString() {
		return "" + toString(this._exportPackage_)
