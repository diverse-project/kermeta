...
public final class AFragmentHostAttributeFragmentHostParameter extends PFragmentHostParameter
{
    private PParameter _parameter_;

    public AFragmentHostAttributeFragmentHostParameter()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AFragmentHostAttributeFragmentHostParameter(
            cloneNode(this._parameter_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAFragmentHostAttributeFragmentHostParameter(this);
    }
