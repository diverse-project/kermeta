...
public final class ASelectionFilterValue extends PSelectionFilterValue {
	...
	public ASelectionFilterValue(@SuppressWarnings("hiding")
	PStringEntryValue _first_, @SuppressWarnings("hiding")
	PBooleanComparator _booleanComparator_, @SuppressWarnings("hiding")
	PStringEntryValue _next_) {
		// Constructor
		setFirst(_first_);
	...
	@Override
	public Object clone() {
		return new ASelectionFilterValue(cloneNode(this._first_),
				cloneNode(this._booleanComparator_), cloneNode(this._next_));
	}
	...
	public String toString() {
		return "" + toString(this._first_) + toString(this._booleanComparator_)
