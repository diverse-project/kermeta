...
public final class ARequireBundleSymbolicname extends PRequireBundleSymbolicname
{
    ...
    public ARequireBundleSymbolicname(
        ...
        @SuppressWarnings("hiding") List<PRequireBundleOptions> _requireBundleOptions_)
    {
        // Constructor
    ...
    public Object clone()
    {
        return new ARequireBundleSymbolicname(
    ...
    void replaceChild(@SuppressWarnings("unused") Node oldChild, @SuppressWarnings("unused") Node newChild)
    {
        ...
        for(ListIterator<PRequireBundleOptions> i = this._requireBundleOptions_.listIterator(); i.hasNext();)
        {
            if(i.next() == oldChild)
            {
                if(newChild != null)
