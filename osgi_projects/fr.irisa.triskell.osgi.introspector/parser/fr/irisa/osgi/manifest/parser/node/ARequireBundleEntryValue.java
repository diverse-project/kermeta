...
public final class ARequireBundleEntryValue extends PRequireBundleEntryValue
{
    ...
    public ARequireBundleEntryValue(
        ...
        @SuppressWarnings("hiding") List<PRequireBundleValue> _requireBundleValue_)
    {
        // Constructor
    ...
    void replaceChild(@SuppressWarnings("unused") Node oldChild, @SuppressWarnings("unused") Node newChild)
    {
        ...
        for(ListIterator<PRequireBundleValue> i = this._requireBundleValue_.listIterator(); i.hasNext();)
        {
            if(i.next() == oldChild)
            {
                if(newChild != null)
