...
public final class ASimpleEntryValue extends PSimpleEntryValue
{
    ...
    public ASimpleEntryValue(
        @SuppressWarnings("hiding") POtherEntryValue _otherEntryValue_,
        @SuppressWarnings("hiding") List<POtherEntryValueNext> _otherEntryValueNext_)
    {
        // Constructor
    ...
    {
        return ""
            + toString(this._otherEntryValue_)
    ...
    void replaceChild(@SuppressWarnings("unused") Node oldChild, @SuppressWarnings("unused") Node newChild)
    {
        ...
        for(ListIterator<POtherEntryValueNext> i = this._otherEntryValueNext_.listIterator(); i.hasNext();)
        {
            if(i.next() == oldChild)
            {
                if(newChild != null)
