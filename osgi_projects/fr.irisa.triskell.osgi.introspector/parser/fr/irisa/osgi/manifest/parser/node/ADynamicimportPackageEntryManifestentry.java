...
public final class ADynamicimportPackageEntryManifestentry extends PManifestentry
{
    ...
    public ADynamicimportPackageEntryManifestentry(
        @SuppressWarnings("hiding") PDynamicimportPackageEntry _dynamicimportPackageEntry_)
    {
        // Constructor
    ...
    {
        return ""
            + toString(this._dynamicimportPackageEntry_);
    }
