...
public final class ABundleUpdatelocationEntryManifestentry extends PManifestentry
{
    ...
    public ABundleUpdatelocationEntryManifestentry(
        @SuppressWarnings("hiding") PBundleUpdatelocationEntry _bundleUpdatelocationEntry_)
    {
        // Constructor
    ...
    {
        return ""
            + toString(this._bundleUpdatelocationEntry_);
    }
