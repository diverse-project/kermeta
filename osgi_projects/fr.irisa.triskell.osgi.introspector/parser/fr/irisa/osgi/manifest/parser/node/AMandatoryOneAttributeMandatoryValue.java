...
public final class AMandatoryOneAttributeMandatoryValue extends PMandatoryValue {
	private TUnquotedString _unquotedString_;

	public AMandatoryOneAttributeMandatoryValue() {
		// Constructor
	}

	public AMandatoryOneAttributeMandatoryValue(@SuppressWarnings("hiding")
	...
	@Override
	public Object clone() {
		return new AMandatoryOneAttributeMandatoryValue(
				cloneNode(this._unquotedString_));
	}

	public void apply(Switch sw) {
		((Analysis) sw).caseAMandatoryOneAttributeMandatoryValue(this);
	}
