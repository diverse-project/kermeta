...
public final class AResolutionDirectiveRequireBundleDirective extends PRequireBundleDirective
{
    private TResolution _resolution_;
    private PResolutionValue _resolutionValue_;

    public AResolutionDirectiveRequireBundleDirective()
    {
        // Constructor
    }

    public AResolutionDirectiveRequireBundleDirective(
        @SuppressWarnings("hiding") TResolution _resolution_,
        @SuppressWarnings("hiding") PResolutionValue _resolutionValue_)
    {
        // Constructor
    ...
    public Object clone()
    {
        return new AResolutionDirectiveRequireBundleDirective(
            cloneNode(this._resolution_),
            cloneNode(this._resolutionValue_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAResolutionDirectiveRequireBundleDirective(this);
    }
