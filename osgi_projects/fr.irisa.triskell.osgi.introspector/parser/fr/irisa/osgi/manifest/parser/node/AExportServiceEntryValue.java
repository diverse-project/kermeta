...
public final class AExportServiceEntryValue extends PExportServiceEntryValue
{
    ...
    public AExportServiceEntryValue()
    {
        // Constructor
    }
    ...
    public AExportServiceEntryValue(
        ...
        @SuppressWarnings("hiding") List<PServiceValue> _serviceValue_)
    {
        // Constructor
    ...
    public Object clone()
    {
        return new AExportServiceEntryValue(
            cloneNode(this._uniqueName_),
            cloneList(this._parameter_),
            cloneList(this._serviceValue_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAExportServiceEntryValue(this);
    }
    ...
    void replaceChild(@SuppressWarnings("unused") Node oldChild, @SuppressWarnings("unused") Node newChild)
    {
        ...
        for(ListIterator<PServiceValue> i = this._serviceValue_.listIterator(); i.hasNext();)
        {
            if(i.next() == oldChild)
            {
                if(newChild != null)
