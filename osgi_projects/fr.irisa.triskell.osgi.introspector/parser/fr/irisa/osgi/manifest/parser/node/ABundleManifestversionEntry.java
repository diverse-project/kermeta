...
public final class ABundleManifestversionEntry extends PBundleManifestversionEntry
{
    ...
    public ABundleManifestversionEntry(
        @SuppressWarnings("hiding") TBundleManifestversion _bundleManifestversion_,
        @SuppressWarnings("hiding") TManifestversion _manifestversion_,
    ...
    public Object clone()
    {
        return new ABundleManifestversionEntry(
            ...
            cloneNode(this._manifestversion_),
    ...
    {
        return ""
            + toString(this._bundleManifestversion_)
            + toString(this._manifestversion_)
