...
public final class ASymbolicnameAttributeSymbolicnameOption extends
		PSymbolicnameOption {
	private PParameter _parameter_;

	public ASymbolicnameAttributeSymbolicnameOption() {
		// Constructor
	}

	public ASymbolicnameAttributeSymbolicnameOption(@SuppressWarnings("hiding")
	...
	@Override
	public Object clone() {
		return new ASymbolicnameAttributeSymbolicnameOption(
				cloneNode(this._parameter_));
	}

	public void apply(Switch sw) {
		((Analysis) sw).caseASymbolicnameAttributeSymbolicnameOption(this);
	}
