...
public final class AFragmentAttachmentSymbolicnameDirective extends PSymbolicnameDirective
{
    ...
    public AFragmentAttachmentSymbolicnameDirective(
        @SuppressWarnings("hiding") TFragmentAttachment _fragmentAttachment_,
        @SuppressWarnings("hiding") PFragmentAttachmentValue _fragmentAttachmentValue_)
    {
        // Constructor
    ...
    {
        return ""
            + toString(this._fragmentAttachment_)
