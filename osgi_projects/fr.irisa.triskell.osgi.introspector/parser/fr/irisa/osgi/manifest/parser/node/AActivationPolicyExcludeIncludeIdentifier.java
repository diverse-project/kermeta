...
public final class AActivationPolicyExcludeIncludeIdentifier extends
		PActivationPolicyExcludeIncludeIdentifier {
	...
	public Object clone() {
		return new AActivationPolicyExcludeIncludeIdentifier(
				cloneNode(this._comma_), cloneNode(this._packageName_));
	}
	...
	public String toString() {
		return "" + toString(this._comma_) + toString(this._packageName_);
	}
