...
public final class ABundleRequiredexecutionenvironmentEntryManifestentry extends PManifestentry
{
    ...
    public ABundleRequiredexecutionenvironmentEntryManifestentry(
        @SuppressWarnings("hiding") PBundleRequiredexecutionenvironmentEntry _bundleRequiredexecutionenvironmentEntry_)
    {
        // Constructor
    ...
    {
        ((Analysis) sw).caseABundleRequiredexecutionenvironmentEntryManifestentry(this);
    }
    ...
    public void setBundleRequiredexecutionenvironmentEntry(PBundleRequiredexecutionenvironmentEntry node)
    {
    ...
    {
        return ""
            + toString(this._bundleRequiredexecutionenvironmentEntry_);
    }
