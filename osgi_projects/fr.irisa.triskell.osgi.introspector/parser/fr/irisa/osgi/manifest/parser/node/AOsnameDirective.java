...
public final class AOsnameDirective extends POsnameDirective
{
    ...
    public AOsnameDirective(
        @SuppressWarnings("hiding") TOsname _osname_,
        @SuppressWarnings("hiding") POsnameValue _osnameValue_)
    {
        // Constructor
        setOsname(_osname_);
    ...
    public Object clone()
    {
        return new AOsnameDirective(
            cloneNode(this._osname_),
    ...
    {
        return ""
            + toString(this._osname_)
            + toString(this._osnameValue_);
    }
