...
public final class ABundleActivationpolicyEntryManifestentry extends PManifestentry
{
    ...
    public ABundleActivationpolicyEntryManifestentry(
        @SuppressWarnings("hiding") PBundleActivationpolicyEntry _bundleActivationpolicyEntry_)
    {
        // Constructor
    ...
    {
        return ""
            + toString(this._bundleActivationpolicyEntry_);
    }
