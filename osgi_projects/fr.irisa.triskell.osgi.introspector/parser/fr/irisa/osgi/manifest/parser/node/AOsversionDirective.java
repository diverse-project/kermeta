...
public final class AOsversionDirective extends POsversionDirective
{
    ...
    public AOsversionDirective(
        @SuppressWarnings("hiding") TOsversion _osversion_,
        @SuppressWarnings("hiding") PVersionRange _versionRange_)
    {
        // Constructor
    ...
    public Object clone()
    {
        return new AOsversionDirective(
            cloneNode(this._osversion_),
    ...
    {
        return ""
            + toString(this._osversion_)
            + toString(this._versionRange_);
    }
