...
public final class ABundleDocurlEntry extends PBundleDocurlEntry
{
    ...
    public ABundleDocurlEntry(
        @SuppressWarnings("hiding") TBundleDocurl _bundleDocurl_,
        @SuppressWarnings("hiding") PUrlValue _urlValue_,
    ...
    public Object clone()
    {
        return new ABundleDocurlEntry(
            cloneNode(this._bundleDocurl_),
            cloneNode(this._urlValue_),
    ...
    {
        return ""
            + toString(this._bundleDocurl_)
            + toString(this._urlValue_)
