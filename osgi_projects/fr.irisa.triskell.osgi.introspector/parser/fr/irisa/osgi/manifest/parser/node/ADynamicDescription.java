...
public final class ADynamicDescription extends PDynamicDescription
{
    ...
    public ADynamicDescription(
        @SuppressWarnings("hiding") PPackageNameWildcard _packageNameWildcard_,
        @SuppressWarnings("hiding") List<PDynamicimportPackageNames> _dynamicimportPackageNames_,
    ...
    public Object clone()
    {
        return new ADynamicDescription(
    ...
    public void setDynamicimportPackageNames(List<PDynamicimportPackageNames> list)
    {
    ...
    void replaceChild(@SuppressWarnings("unused") Node oldChild, @SuppressWarnings("unused") Node newChild)
    {
        ...
        for(ListIterator<PDynamicimportPackageNames> i = this._dynamicimportPackageNames_.listIterator(); i.hasNext();)
        {
            if(i.next() == oldChild)
            {
                if(newChild != null)
