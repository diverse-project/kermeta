...
public final class ABundleContactaddressEntry extends PBundleContactaddressEntry
{
    ...
    public ABundleContactaddressEntry(
        @SuppressWarnings("hiding") TBundleContactaddress _bundleContactaddress_,
    ...
    {
        return ""
            + toString(this._bundleContactaddress_)
