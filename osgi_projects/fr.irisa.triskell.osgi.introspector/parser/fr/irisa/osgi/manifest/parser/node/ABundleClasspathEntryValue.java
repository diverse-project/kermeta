...
public final class ABundleClasspathEntryValue extends PBundleClasspathEntryValue
{
    ...
    public ABundleClasspathEntryValue(
        @SuppressWarnings("hiding") PClasspathEntry _classpathEntry_,
        @SuppressWarnings("hiding") List<PClasspathValue> _classpathValue_)
    {
        // Constructor
    ...
    public Object clone()
    {
        return new ABundleClasspathEntryValue(
    ...
    {
        return ""
            + toString(this._classpathEntry_)
    ...
    void replaceChild(@SuppressWarnings("unused") Node oldChild, @SuppressWarnings("unused") Node newChild)
    {
        ...
        for(ListIterator<PClasspathValue> i = this._classpathValue_.listIterator(); i.hasNext();)
        {
            if(i.next() == oldChild)
            {
                if(newChild != null)
