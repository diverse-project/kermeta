...
public final class AExtensionBootclasspathExtensionValue extends PExtensionValue
{
    ...
    public AExtensionBootclasspathExtensionValue(
        @SuppressWarnings("hiding") TExtensionBootclasspath _extensionBootclasspath_)
    {
        // Constructor
    ...
    {
        return ""
            + toString(this._extensionBootclasspath_);
    }
