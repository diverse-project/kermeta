...
public final class ABundleUpdatelocationEntry extends PBundleUpdatelocationEntry
{
    ...
    public ABundleUpdatelocationEntry(
        @SuppressWarnings("hiding") TBundleUpdatelocation _bundleUpdatelocation_,
    ...
    {
        return ""
            + toString(this._bundleUpdatelocation_)
