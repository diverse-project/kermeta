...
public final class ASingletonSymbolicnameDirective extends PSymbolicnameDirective
{
    ...
    public ASingletonSymbolicnameDirective(
        @SuppressWarnings("hiding") TSingleton _singleton_,
    ...
    public Object clone()
    {
        return new ASingletonSymbolicnameDirective(
            cloneNode(this._singleton_),
