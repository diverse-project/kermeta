...
public final class AUniqueName extends PUniqueName
{
    ...
    public AUniqueName(
        ...
        @SuppressWarnings("hiding") List<PUniqueNameSuffix> _uniqueNameSuffix_)
    {
        // Constructor
    ...
    void replaceChild(@SuppressWarnings("unused") Node oldChild, @SuppressWarnings("unused") Node newChild)
    {
        ...
        for(ListIterator<PUniqueNameSuffix> i = this._uniqueNameSuffix_.listIterator(); i.hasNext();)
        {
            if(i.next() == oldChild)
            {
                if(newChild != null)
