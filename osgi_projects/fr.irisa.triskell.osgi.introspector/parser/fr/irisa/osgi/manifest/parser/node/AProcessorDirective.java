...
public final class AProcessorDirective extends PProcessorDirective
{
    ...
    public AProcessorDirective(
        @SuppressWarnings("hiding") TProcessor _processor_,
        @SuppressWarnings("hiding") PProcessorValue _processorValue_)
    {
        // Constructor
    ...
    public Object clone()
    {
        return new AProcessorDirective(
            cloneNode(this._processor_),
