...
public final class ABundleActivationpolicyEntryValue extends PBundleActivationpolicyEntryValue
{
    ...
    public ABundleActivationpolicyEntryValue(
        @SuppressWarnings("hiding") PActivationpolicyValue _activationpolicyValue_,
        @SuppressWarnings("hiding") List<PActivationpolicyOptions> _activationpolicyOptions_)
    {
        // Constructor
    ...
    {
        return ""
            + toString(this._activationpolicyValue_)
    ...
    void replaceChild(@SuppressWarnings("unused") Node oldChild, @SuppressWarnings("unused") Node newChild)
    {
        ...
        for(ListIterator<PActivationpolicyOptions> i = this._activationpolicyOptions_.listIterator(); i.hasNext();)
        {
            if(i.next() == oldChild)
            {
                if(newChild != null)
