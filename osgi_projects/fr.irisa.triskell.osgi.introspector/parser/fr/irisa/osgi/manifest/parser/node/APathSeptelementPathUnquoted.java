...
public final class APathSeptelementPathUnquoted extends PPathUnquoted {
	...
	public APathSeptelementPathUnquoted(@SuppressWarnings("hiding")
	TDot _first_, @SuppressWarnings("hiding")
	TDot _second_, @SuppressWarnings("hiding")
	TPathSep _pathSep_, @SuppressWarnings("hiding")
	PPathElement _pathElement_, @SuppressWarnings("hiding")
	List<PPathSuffix> _pathSuffix_) {
		// Constructor
		setFirst(_first_);
	...
	@Override
	public Object clone() {
		return new APathSeptelementPathUnquoted(cloneNode(this._first_),
				cloneNode(this._second_), cloneNode(this._pathSep_),
				cloneNode(this._pathElement_), cloneList(this._pathSuffix_));
	}
	...
	public String toString() {
		return "" + toString(this._first_) + toString(this._second_)
				+ toString(this._pathSep_) + toString(this._pathElement_)
	...
	Node newChild) {
		...
		for (ListIterator<PPathSuffix> i = this._pathSuffix_.listIterator(); i
				.hasNext();) {
			if (i.next() == oldChild) {
				if (newChild != null) {
