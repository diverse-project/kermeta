...
public final class ADynamicimportPackageEntryValue extends PDynamicimportPackageEntryValue
{
    ...
    public ADynamicimportPackageEntryValue(
        @SuppressWarnings("hiding") PDynamicDescription _dynamicDescription_,
        @SuppressWarnings("hiding") List<PDynamicimportPackageValue> _dynamicimportPackageValue_)
    {
        // Constructor
    ...
    public void setDynamicimportPackageValue(List<PDynamicimportPackageValue> list)
    {
    ...
    void replaceChild(@SuppressWarnings("unused") Node oldChild, @SuppressWarnings("unused") Node newChild)
    {
        ...
        for(ListIterator<PDynamicimportPackageValue> i = this._dynamicimportPackageValue_.listIterator(); i.hasNext();)
        {
            if(i.next() == oldChild)
            {
                if(newChild != null)
