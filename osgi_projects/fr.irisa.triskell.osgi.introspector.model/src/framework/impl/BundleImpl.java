 ...
 * </copyright>
 *
 * $Id: BundleImpl.java,v 1.1 2008-07-30 14:08:05 edaubert Exp $
 */
...
public class BundleImpl extends EObjectImpl implements Bundle {
	...
	public EList<Bundle> getFragments() {
		if (fragments == null) {
			fragments = new EObjectResolvingEList<Bundle>(Bundle.class, this,
					FrameworkPackage.BUNDLE__FRAGMENTS);
		}
		return fragments;
	}
	...
	public void setLocation(String newLocation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					FrameworkPackage.BUNDLE__LOCATION, oldLocation, location));
	}
	...
	public NotificationChain basicSetManifest(MANIFEST newManifest,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, FrameworkPackage.BUNDLE__MANIFEST,
	...
	public void setManifest(MANIFEST newManifest) {
		if (newManifest != manifest) {
			...
			if (manifest != null)
				msgs = ((InternalEObject) manifest)
						.eInverseRemove(this, EOPPOSITE_FEATURE_BASE
								- FrameworkPackage.BUNDLE__MANIFEST, null, msgs);
			if (newManifest != null)
				msgs = ((InternalEObject) newManifest)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					FrameworkPackage.BUNDLE__MANIFEST, newManifest, newManifest));
	}
	...
	public void setSymbolicName(String newSymbolicName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					FrameworkPackage.BUNDLE__SYMBOLIC_NAME, oldSymbolicName,
					symbolicName));
	}
	...
	public NotificationChain basicSetFolder(Folder newFolder,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, FrameworkPackage.BUNDLE__FOLDER,
					oldFolder, newFolder);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setFolder(Folder newFolder) {
		if (newFolder != folder) {
			NotificationChain msgs = null;
			if (folder != null)
				msgs = ((InternalEObject) folder).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- FrameworkPackage.BUNDLE__FOLDER, null, msgs);
			if (newFolder != null)
				msgs = ((InternalEObject) newFolder).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE
								- FrameworkPackage.BUNDLE__FOLDER, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					FrameworkPackage.BUNDLE__FOLDER, newFolder, newFolder));
	}
	...
	public NotificationChain basicSetPackage(jar.Package newPackage,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, FrameworkPackage.BUNDLE__PACKAGE,
		...
		if (newPackage != package_) {
			...
			if (package_ != null)
				msgs = ((InternalEObject) package_).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- FrameworkPackage.BUNDLE__PACKAGE, null, msgs);
			if (newPackage != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					FrameworkPackage.BUNDLE__PACKAGE, newPackage, newPackage));
	}
