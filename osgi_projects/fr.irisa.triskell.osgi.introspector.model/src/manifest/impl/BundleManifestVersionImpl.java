 ...
 * </copyright>
 *
 * $Id: BundleManifestVersionImpl.java,v 1.2 2008-07-31 13:43:53 edaubert Exp $
 */
...
public class BundleManifestVersionImpl extends MANIFESTEntryImpl implements
	...
	public void setManifestVersion(MANIFESTVersionEnum newManifestVersion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ManifestPackage.BUNDLE_MANIFEST_VERSION__MANIFEST_VERSION, oldManifestVersion, manifestVersion));
	}
