 ...
 * </copyright>
 *
 * $Id: RequireBundleImpl.java,v 1.1 2008-07-30 14:08:02 edaubert Exp $
 */
...
public class RequireBundleImpl extends MANIFESTEntryImpl implements
	...
	public EList<RequireBundleDirective> getDirectives() {
		if (directives == null) {
			directives = new EObjectContainmentEList<RequireBundleDirective>(
					RequireBundleDirective.class, this,
					ManifestPackage.REQUIRE_BUNDLE__DIRECTIVES);
		}
		return directives;
	}
	...
	public void setResolved(boolean newResolved) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ManifestPackage.REQUIRE_BUNDLE__RESOLVED, oldResolved,
					resolved));
	}
	...
	public void setBundle(String newBundle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ManifestPackage.REQUIRE_BUNDLE__BUNDLE, oldBundle, bundle));
	}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case ManifestPackage.REQUIRE_BUNDLE__DIRECTIVES:
			...
			getDirectives().addAll(
					(Collection<? extends RequireBundleDirective>) newValue);
			return;
		case ManifestPackage.REQUIRE_BUNDLE__RESOLVED:
