 ...
 * </copyright>
 *
 * $Id: ImportPackageImpl.java,v 1.1 2008-07-30 14:08:02 edaubert Exp $
 */
...
public class ImportPackageImpl extends MANIFESTEntryImpl implements
	...
	public EList<String> getPackages() {
		if (packages == null) {
			packages = new EDataTypeUniqueEList<String>(String.class, this,
					ManifestPackage.IMPORT_PACKAGE__PACKAGES);
		}
		return packages;
	}
	...
	public NotificationChain basicSetDirectives(
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					ManifestPackage.IMPORT_PACKAGE__DIRECTIVES, oldDirectives,
					newDirectives);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setDirectives(ImportPackageDirective newDirectives) {
		if (newDirectives != directives) {
			...
			if (directives != null)
				msgs = ((InternalEObject) directives).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- ManifestPackage.IMPORT_PACKAGE__DIRECTIVES,
						null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					ManifestPackage.IMPORT_PACKAGE__DIRECTIVES, newDirectives,
					newDirectives));
	}
	...
	public void setResolved(boolean newResolved) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ManifestPackage.IMPORT_PACKAGE__RESOLVED, oldResolved,
					resolved));
	}
