...
public class FragmentHostImpl extends MANIFESTEntryImpl implements FragmentHost {
	...
	/**
	 * The default value of the '{@link #isResolved() <em>Resolved</em>}'
	...
	/**
	 * The cached value of the '{@link #isResolved() <em>Resolved</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isResolved()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getBundle() <em>Bundle</em>}'
	...
	public NotificationChain basicSetDirectives(
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					ManifestPackage.FRAGMENT_HOST__DIRECTIVES, oldDirectives,
					newDirectives);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setDirectives(FragmentHostDirective newDirectives) {
		if (newDirectives != directives) {
			...
			if (directives != null)
				msgs = ((InternalEObject) directives).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- ManifestPackage.FRAGMENT_HOST__DIRECTIVES,
						null, msgs);
			if (newDirectives != null)
				msgs = ((InternalEObject) newDirectives).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE
								- ManifestPackage.FRAGMENT_HOST__DIRECTIVES,
						null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					ManifestPackage.FRAGMENT_HOST__DIRECTIVES, newDirectives,
					newDirectives));
	}
	...
	public void setResolved(boolean newResolved) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ManifestPackage.FRAGMENT_HOST__RESOLVED, oldResolved,
					resolved));
	}
			...
			if (bundle != oldBundle) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ManifestPackage.FRAGMENT_HOST__BUNDLE, oldBundle,
							bundle));
			}
		}
		return bundle;
	...
	public void setBundle(Bundle newBundle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ManifestPackage.FRAGMENT_HOST__BUNDLE, oldBundle, bundle));
	}
