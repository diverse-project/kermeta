 ...
 * </copyright>
 *
 * $Id: MANIFESTEntryImpl.java,v 1.1 2008-07-30 14:08:02 edaubert Exp $
 */
...
public class MANIFESTEntryImpl extends EObjectImpl implements MANIFESTEntry {
	/**
	 * The default value of the '{@link #getEntryName() <em>Entry Name</em>}'
	...
	/**
	 * The cached value of the '{@link #getEntryName() <em>Entry Name</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getEntryName()
	 * @generated
	...
	public void setEntryName(String newEntryName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ManifestPackage.MANIFEST_ENTRY__ENTRY_NAME, oldEntryName,
					entryName));
	}
	...
	public EList<AttributEntry> getOptions() {
		if (options == null) {
			options = new EObjectContainmentEList<AttributEntry>(
					AttributEntry.class, this,
					ManifestPackage.MANIFEST_ENTRY__OPTIONS);
		}
		return options;
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case ManifestPackage.MANIFEST_ENTRY__ENTRY_NAME:
			return ENTRY_NAME_EDEFAULT == null ? entryName != null
					: !ENTRY_NAME_EDEFAULT.equals(entryName);
		case ManifestPackage.MANIFEST_ENTRY__OPTIONS:
