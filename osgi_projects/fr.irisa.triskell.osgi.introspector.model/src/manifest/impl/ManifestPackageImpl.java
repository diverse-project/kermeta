 ...
 * </copyright>
 *
 * $Id: ManifestPackageImpl.java,v 1.1 2008-07-30 14:08:02 edaubert Exp $
 */
...
public class ManifestPackageImpl extends EPackageImpl implements
	...
	public static ManifestPackage init() {
		if (isInited)
			return (ManifestPackage) EPackage.Registry.INSTANCE
		...
		ManifestPackageImpl theManifestPackage = (ManifestPackageImpl) (EPackage.Registry.INSTANCE
				.getEPackage(eNS_URI) instanceof ManifestPackageImpl ? EPackage.Registry.INSTANCE
				.getEPackage(eNS_URI)
	...
	public EAttribute getSimpleMANIFESTEntry_Value() {
		return (EAttribute) simpleMANIFESTEntryEClass.getEStructuralFeatures()
				.get(0);
	}
	...
	public EAttribute getBundleSymbolicName_SymbolicName() {
		return (EAttribute) bundleSymbolicNameEClass.getEStructuralFeatures()
				.get(0);
	}
	...
	public EReference getBundleSymbolicName_Directives() {
		return (EReference) bundleSymbolicNameEClass.getEStructuralFeatures()
				.get(1);
	}
	...
	public EAttribute getURLMANIFESTEntry_Url() {
		return (EAttribute) urlmanifestEntryEClass.getEStructuralFeatures()
				.get(0);
	}
	...
	public EReference getBundleActivator_Activator() {
		return (EReference) bundleActivatorEClass.getEStructuralFeatures().get(
				0);
	}
	 ...
	 * @generated
	 */
	public EReference getBundleClassPath_Entries() {
		return (EReference) bundleClassPathEClass.getEStructuralFeatures().get(
				0);
	}
	...
	public EAttribute getBundleNativeCode_Optional() {
		return (EAttribute) bundleNativeCodeEClass.getEStructuralFeatures()
				.get(0);
	}
	...
	public EReference getBundleNativeCode_Directives() {
		return (EReference) bundleNativeCodeEClass.getEStructuralFeatures()
				.get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getBundleNativeCode_File() {
		return (EReference) bundleNativeCodeEClass.getEStructuralFeatures()
				.get(2);
	}
	...
	public EAttribute getBundleActivationPolicy_Policy() {
		return (EAttribute) bundleActivationPolicyEClass
	...
	public EReference getBundleActivationPolicy_Directives() {
		return (EReference) bundleActivationPolicyEClass
	...
	public EAttribute getDynamicImportPackage_Packages() {
		return (EAttribute) dynamicImportPackageEClass.getEStructuralFeatures()
				.get(0);
	}
	...
	public EAttribute getBundleRequiredExecutionEnvironment_Profile() {
		return (EAttribute) bundleRequiredExecutionEnvironmentEClass
				.getEStructuralFeatures().get(0);
	}
	...
	public EAttribute getSimpleManifestEntryManyValues_Values() {
		return (EAttribute) simpleManifestEntryManyValuesEClass
				.getEStructuralFeatures().get(0);
	}
	...
	public EAttribute getBundleManifestVersion_ManifestVersion() {
		return (EAttribute) bundleManifestVersionEClass
				.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		createEReference(manifestEClass,
				MANIFEST__BUNDLE_REQUIRED_EXECUTION_ENVIRONMENTS);
		...
		createEAttribute(simpleMANIFESTEntryEClass,
				SIMPLE_MANIFEST_ENTRY__VALUE);

		bundleNameEClass = createEClass(BUNDLE_NAME);

		bundleSymbolicNameEClass = createEClass(BUNDLE_SYMBOLIC_NAME);
		createEAttribute(bundleSymbolicNameEClass,
				BUNDLE_SYMBOLIC_NAME__SYMBOLIC_NAME);
		createEReference(bundleSymbolicNameEClass,
				BUNDLE_SYMBOLIC_NAME__DIRECTIVES);
		...
		createEAttribute(bundleActivationPolicyEClass,
				BUNDLE_ACTIVATION_POLICY__POLICY);
		createEReference(bundleActivationPolicyEClass,
				BUNDLE_ACTIVATION_POLICY__DIRECTIVES);
		...
		createEAttribute(dynamicImportPackageEClass,
				DYNAMIC_IMPORT_PACKAGE__PACKAGES);

		bundleRequiredExecutionEnvironmentEClass = createEClass(BUNDLE_REQUIRED_EXECUTION_ENVIRONMENT);
		createEAttribute(bundleRequiredExecutionEnvironmentEClass,
				BUNDLE_REQUIRED_EXECUTION_ENVIRONMENT__PROFILE);
		createEAttribute(bundleRequiredExecutionEnvironmentEClass,
				BUNDLE_REQUIRED_EXECUTION_ENVIRONMENT__CONFIGURATION);

		simpleManifestEntryManyValuesEClass = createEClass(SIMPLE_MANIFEST_ENTRY_MANY_VALUES);
		createEAttribute(simpleManifestEntryManyValuesEClass,
				SIMPLE_MANIFEST_ENTRY_MANY_VALUES__VALUES);

		bundleManifestVersionEClass = createEClass(BUNDLE_MANIFEST_VERSION);
		createEAttribute(bundleManifestVersionEClass,
				BUNDLE_MANIFEST_VERSION__MANIFEST_VERSION);
	...
	public void initializePackageContents() {
		...
		JarPackage theJarPackage = (JarPackage) EPackage.Registry.INSTANCE
				.getEPackage(JarPackage.eNS_URI);
		OptionPackage theOptionPackage = (OptionPackage) EPackage.Registry.INSTANCE
				.getEPackage(OptionPackage.eNS_URI);
		...
		bundleDescriptionEClass.getESuperTypes().add(
				this.getSimpleMANIFESTEntry());
		bundleLocalizationEClass.getESuperTypes().add(
				this.getSimpleMANIFESTEntry());
		bundleVendorEClass.getESuperTypes().add(this.getSimpleMANIFESTEntry());
		bundleContactAddressEClass.getESuperTypes().add(
				this.getSimpleMANIFESTEntry());
		bundleCopyrightEClass.getESuperTypes().add(
				this.getSimpleMANIFESTEntry());
		bundleCategoryEClass.getESuperTypes().add(
				this.getSimpleManifestEntryManyValues());
		...
		bundleUpdateLocationEClass.getESuperTypes().add(
				this.getURLMANIFESTEntry());
		...
		bundleActivationPolicyEClass.getESuperTypes().add(
				this.getMANIFESTEntry());
		fragmentHostEClass.getESuperTypes().add(this.getMANIFESTEntry());
		dynamicImportPackageEClass.getESuperTypes()
				.add(this.getMANIFESTEntry());
		bundleRequiredExecutionEnvironmentEClass.getESuperTypes().add(
				this.getMANIFESTEntry());
		simpleManifestEntryManyValuesEClass.getESuperTypes().add(
				this.getMANIFESTEntry());
		bundleManifestVersionEClass.getESuperTypes().add(
				this.getMANIFESTEntry());

		// Initialize classes and features; add operations and parameters
		initEClass(serviceEClass, Service.class, "Service", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getService_Interface(), theJarPackage.getClass_(), null,
				"interface", null, 1, 1, Service.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(versionEClass, Version.class, "Version", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getVersion_Major(), this.getint(), "major", null, 1, 1,
				Version.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getVersion_Minor(), this.getint(), "minor", null, 0, 1,
				Version.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getVersion_Micro(), this.getint(), "micro", null, 0, 1,
				Version.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getVersion_Qualifier(), this.getString(), "qualifier",
				"", 0, 1, Version.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);

		initEClass(manifestEClass, manifest.MANIFEST.class, "MANIFEST",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getMANIFEST_BundleClassPaths(), this
				.getBundleClassPath(), null, "bundleClassPaths", null, 0, -1,
				manifest.MANIFEST.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getMANIFEST_BundleNativeCodes(), this
				.getBundleNativeCode(), null, "bundleNativeCodes", null, 0, -1,
				manifest.MANIFEST.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getMANIFEST_BundleVersion(), this.getBundleVersion(),
				null, "bundleVersion", null, 0, 1, manifest.MANIFEST.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getMANIFEST_BundleRequiredExecutionEnvironments(), this
				.getBundleRequiredExecutionEnvironment(), null,
				"bundleRequiredExecutionEnvironments", null, 0, -1,
				manifest.MANIFEST.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getMANIFEST_BundleActivationPolicy(), this
				.getBundleActivationPolicy(), null, "bundleActivationPolicy",
				null, 0, 1, manifest.MANIFEST.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getMANIFEST_BundleActivator(),
				this.getBundleActivator(), null, "bundleActivator", null, 0, 1,
				manifest.MANIFEST.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getMANIFEST_RequireBundles(), this.getRequireBundle(),
				null, "requireBundles", null, 0, -1, manifest.MANIFEST.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getMANIFEST_ImportServices(), this.getImportService(),
				null, "importServices", null, 0, -1, manifest.MANIFEST.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getMANIFEST_ExportServices(), this.getExportService(),
				null, "exportServices", null, 0, -1, manifest.MANIFEST.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getMANIFEST_BundleSymbolicName(), this
				.getBundleSymbolicName(), null, "bundleSymbolicName", null, 1,
				1, manifest.MANIFEST.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getMANIFEST_BundleVendor(), this.getBundleVendor(),
				null, "bundleVendor", null, 0, 1, manifest.MANIFEST.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getMANIFEST_BundleCopyright(),
				this.getBundleCopyright(), null, "bundleCopyright", null, 0, 1,
				manifest.MANIFEST.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getMANIFEST_BundleContactAddress(), this
				.getBundleContactAddress(), null, "bundleContactAddress", null,
				0, 1, manifest.MANIFEST.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getMANIFEST_BundleDescription(), this
				.getBundleDescription(), null, "bundleDescription", null, 0, 1,
				manifest.MANIFEST.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getMANIFEST_BundleName(), this.getBundleName(), null,
				"bundleName", null, 0, 1, manifest.MANIFEST.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getMANIFEST_BundleCategory(), this.getBundleCategory(),
				null, "bundleCategory", null, 0, 1, manifest.MANIFEST.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getMANIFEST_BundleUpdateLocation(), this
				.getBundleUpdateLocation(), null, "bundleUpdateLocation", null,
				0, 1, manifest.MANIFEST.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getMANIFEST_BundleDocURL(), this.getBundleDocURL(),
				null, "BundleDocURL", null, 0, 1, manifest.MANIFEST.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getMANIFEST_ImportPackages(), this.getImportPackage(),
				null, "importPackages", null, 0, -1, manifest.MANIFEST.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getMANIFEST_BundleLocalization(), this
				.getBundleLocalization(), null, "bundleLocalization", null, 0,
				1, manifest.MANIFEST.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getMANIFEST_FragmentHost(), this.getFragmentHost(),
				null, "fragmentHost", null, 0, 1, manifest.MANIFEST.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getMANIFEST_DynamicImportPackages(), this
				.getDynamicImportPackage(), null, "dynamicImportPackages",
				null, 0, -1, manifest.MANIFEST.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getMANIFEST_ExportPackages(), this.getExportPackage(),
				null, "exportPackages", null, 0, -1, manifest.MANIFEST.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getMANIFEST_UnknownEntries(), this
				.getSimpleManifestEntryManyValues(), null, "unknownEntries",
				null, 0, -1, manifest.MANIFEST.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMANIFEST_NativeCodeOptional(), this.getboolean(),
				"NativeCodeOptional", null, 0, 1, manifest.MANIFEST.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
				!IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getMANIFEST_BundleManifestVersion(), this
				.getBundleManifestVersion(), null, "bundleManifestVersion",
				null, 0, 1, manifest.MANIFEST.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(manifestEntryEClass, MANIFESTEntry.class, "MANIFESTEntry",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getMANIFESTEntry_EntryName(), this.getString(),
				"entryName", null, 1, 1, MANIFESTEntry.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEReference(getMANIFESTEntry_Options(), theOptionPackage
				.getAttributEntry(), null, "options", null, 0, -1,
				MANIFESTEntry.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(simpleMANIFESTEntryEClass, SimpleMANIFESTEntry.class,
				"SimpleMANIFESTEntry", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getSimpleMANIFESTEntry_Value(), this.getString(),
				"value", null, 1, 1, SimpleMANIFESTEntry.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		initEClass(bundleNameEClass, BundleName.class, "BundleName",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(bundleSymbolicNameEClass, BundleSymbolicName.class,
				"BundleSymbolicName", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getBundleSymbolicName_SymbolicName(),
				theFrameworkPackage.getString(), "symbolicName", null, 1, 1,
				BundleSymbolicName.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getBundleSymbolicName_Directives(), theOptionPackage
				.getSymbolicNameDirective(), null, "directives", null, 0, 2,
				BundleSymbolicName.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(bundleDescriptionEClass, BundleDescription.class,
				"BundleDescription", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);

		initEClass(bundleLocalizationEClass, BundleLocalization.class,
				"BundleLocalization", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);

		initEClass(bundleVendorEClass, BundleVendor.class, "BundleVendor",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(bundleContactAddressEClass, BundleContactAddress.class,
				"BundleContactAddress", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);

		initEClass(bundleCopyrightEClass, BundleCopyright.class,
				"BundleCopyright", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);

		initEClass(bundleCategoryEClass, BundleCategory.class,
				"BundleCategory", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);

		initEClass(urlmanifestEntryEClass, URLMANIFESTEntry.class,
				"URLMANIFESTEntry", IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getURLMANIFESTEntry_Url(), this.getURL(), "url", null,
				1, 1, URLMANIFESTEntry.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);

		initEClass(bundleDocURLEClass, BundleDocURL.class, "BundleDocURL",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(bundleUpdateLocationEClass, BundleUpdateLocation.class,
				"BundleUpdateLocation", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);

		initEClass(bundleVersionEClass, BundleVersion.class, "BundleVersion",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getBundleVersion_Version(), this.getVersion(), null,
				"version", null, 1, 1, BundleVersion.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(bundleActivatorEClass, BundleActivator.class,
				"BundleActivator", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getBundleActivator_Activator(), theJarPackage
				.getClass_(), null, "activator", null, 1, 1,
				BundleActivator.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(bundleClassPathEClass, BundleClassPath.class,
				"BundleClassPath", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getBundleClassPath_Entries(), theJarPackage
				.getSystemEntry(), null, "entries", null, 1, -1,
				BundleClassPath.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(bundleNativeCodeEClass, BundleNativeCode.class,
				"BundleNativeCode", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getBundleNativeCode_Optional(), this.getboolean(),
				"optional", null, 0, 1, BundleNativeCode.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEReference(getBundleNativeCode_Directives(), theOptionPackage
				.getNativeCodeDirective(), null, "directives", null, 1, -1,
				BundleNativeCode.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBundleNativeCode_File(), theJarPackage.getFile(),
				null, "file", null, 1, -1, BundleNativeCode.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);

		initEClass(requireBundleEClass, RequireBundle.class, "RequireBundle",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getRequireBundle_Directives(), theOptionPackage
				.getRequireBundleDirective(), null, "directives", null, 0, 2,
				RequireBundle.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRequireBundle_Resolved(), this.getboolean(),
				"resolved", null, 1, 1, RequireBundle.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getRequireBundle_Bundle(), theFrameworkPackage
				.getString(), "bundle", null, 1, 1, RequireBundle.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
				!IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(importServiceEClass, ImportService.class, "ImportService",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getImportService_Resolve(), this.getboolean(),
				"resolve", null, 1, 1, ImportService.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getImportService_Service(), theFrameworkPackage
				.getString(), "service", null, 1, 1, ImportService.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
				!IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(exportServiceEClass, ExportService.class, "ExportService",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getExportService_Service(), this.getService(), null,
				"service", null, 1, 1, ExportService.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(importPackageEClass, ImportPackage.class, "ImportPackage",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getImportPackage_Directives(), theOptionPackage
				.getImportPackageDirective(), null, "directives", null, 0, 1,
				ImportPackage.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getImportPackage_Resolved(), this.getboolean(),
				"resolved", null, 1, 1, ImportPackage.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getImportPackage_Packages(), theFrameworkPackage
				.getString(), "packages", null, 1, -1, ImportPackage.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
				!IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(exportPackageEClass, ExportPackage.class, "ExportPackage",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getExportPackage_Packages(), theJarPackage.getPackage(),
				null, "packages", null, 1, -1, ExportPackage.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getExportPackage_Directives(), theOptionPackage
				.getExportPackageDirective(), null, "directives", null, 0, -1,
				ExportPackage.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(bundleActivationPolicyEClass, BundleActivationPolicy.class,
				"BundleActivationPolicy", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getBundleActivationPolicy_Policy(),
				this.getPolicyEnum(), "policy", null, 1, 1,
				BundleActivationPolicy.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getBundleActivationPolicy_Directives(), theOptionPackage
				.getActivationPolicyDirective(), null, "directives", null, 0,
				-1, BundleActivationPolicy.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(fragmentHostEClass, FragmentHost.class, "FragmentHost",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getFragmentHost_Directives(), theOptionPackage
				.getFragmentHostDirective(), null, "directives", null, 0, 1,
				FragmentHost.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getFragmentHost_Resolved(), this.getboolean(),
				"resolved", null, 1, 1, FragmentHost.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEReference(getFragmentHost_Bundle(), theFrameworkPackage
				.getBundle(), null, "bundle", null, 1, 1, FragmentHost.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);

		initEClass(dynamicImportPackageEClass, DynamicImportPackage.class,
				"DynamicImportPackage", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getDynamicImportPackage_Packages(), this.getString(),
				"packages", null, 1, -1, DynamicImportPackage.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
				!IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(bundleRequiredExecutionEnvironmentEClass,
				BundleRequiredExecutionEnvironment.class,
				"BundleRequiredExecutionEnvironment", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getBundleRequiredExecutionEnvironment_Profile(), this
				.getString(), "profile", null, 1, 1,
				BundleRequiredExecutionEnvironment.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getBundleRequiredExecutionEnvironment_Configuration(),
				this.getString(), "configuration", null, 0, 1,
				BundleRequiredExecutionEnvironment.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		initEClass(simpleManifestEntryManyValuesEClass,
				SimpleManifestEntryManyValues.class,
				"SimpleManifestEntryManyValues", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getSimpleManifestEntryManyValues_Values(), this
				.getString(), "values", null, 1, -1,
				SimpleManifestEntryManyValues.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		initEClass(bundleManifestVersionEClass, BundleManifestVersion.class,
				"BundleManifestVersion", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getBundleManifestVersion_ManifestVersion(), this
				.getMANIFESTVersionEnum(), "manifestVersion", null, 1, 1,
				BundleManifestVersion.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);

		// Initialize enums and add enum literals
		initEEnum(manifestVersionEnumEEnum, MANIFESTVersionEnum.class,
				"MANIFESTVersionEnum");
		addEEnumLiteral(manifestVersionEnumEEnum,
				MANIFESTVersionEnum.MORE_THAN1_3);
		addEEnumLiteral(manifestVersionEnumEEnum,
				MANIFESTVersionEnum.LESS_THAN1_3);
