 ...
 * </copyright>
 *
 * $Id: RequireBundle.java,v 1.1 2008-07-30 14:08:02 edaubert Exp $
 */
package manifest;
...
public interface RequireBundle extends MANIFESTEntry {
	 ...
	 * {@link option.RequireBundleDirective}. <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Sets the value of the '{@link manifest.RequireBundle#isResolved <em>Resolved</em>}'
	...
	/**
	 * Sets the value of the '{@link manifest.RequireBundle#getBundle <em>Bundle</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
