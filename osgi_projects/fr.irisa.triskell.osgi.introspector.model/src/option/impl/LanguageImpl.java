 ...
 * </copyright>
 *
 * $Id: LanguageImpl.java,v 1.1 2008-07-30 14:08:01 edaubert Exp $
 */
package option.impl;
...
public class LanguageImpl extends NativeCodeDirectiveImpl implements Language {
	/**
	 * The default value of the '{@link #getIsoCode() <em>Iso Code</em>}'
	...
	/**
	 * The cached value of the '{@link #getIsoCode() <em>Iso Code</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getIsoCode()
	 * @generated
	...
	public void setIsoCode(ISOCodeLanguage newIsoCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OptionPackage.LANGUAGE__ISO_CODE, oldIsoCode, isoCode));
	}
