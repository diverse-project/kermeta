 ...
 * </copyright>
 *
 * $Id: OsVersionImpl.java,v 1.2 2008-07-31 13:43:53 edaubert Exp $
 */
package option.impl;
...
public class OsVersionImpl extends NativeCodeDirectiveImpl implements OsVersion {
	/**
	 * The cached value of the '{@link #getMinVersion() <em>Min Version</em>}' containment reference.
	...
	/**
	 * The cached value of the '{@link #getMaxVersion() <em>Max Version</em>}' containment reference.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @see #getMaxVersion()
	 * @generated
	 * @ordered
	...
	/**
	 * The default value of the '{@link #isMinNotInclude() <em>Min Not Include</em>}' attribute.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @see #isMinNotInclude()
	 * @generated
	 * @ordered
	...
	/**
	 * The cached value of the '{@link #isMinNotInclude() <em>Min Not Include</em>}' attribute.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @see #isMinNotInclude()
	 * @generated
	 * @ordered
	...
	/**
	 * The default value of the '{@link #isMaxNotInclude() <em>Max Not Include</em>}' attribute.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @see #isMaxNotInclude()
	 * @generated
	 * @ordered
	...
	/**
	 * The cached value of the '{@link #isMaxNotInclude() <em>Max Not Include</em>}' attribute.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @see #isMaxNotInclude()
	 * @generated
	 * @ordered
	...
	public NotificationChain basicSetMinVersion(Version newMinVersion,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OptionPackage.OS_VERSION__MIN_VERSION, oldMinVersion, newMinVersion);
	...
	public void setMinVersion(Version newMinVersion) {
		if (newMinVersion != minVersion) {
			...
			if (minVersion != null)
				msgs = ((InternalEObject)minVersion).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OptionPackage.OS_VERSION__MIN_VERSION, null, msgs);
			if (newMinVersion != null)
				msgs = ((InternalEObject)newMinVersion).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OptionPackage.OS_VERSION__MIN_VERSION, null, msgs);
			msgs = basicSetMinVersion(newMinVersion, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OptionPackage.OS_VERSION__MIN_VERSION, newMinVersion, newMinVersion));
	}
	...
	public NotificationChain basicSetMaxVersion(Version newMaxVersion,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OptionPackage.OS_VERSION__MAX_VERSION, oldMaxVersion, newMaxVersion);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setMaxVersion(Version newMaxVersion) {
		if (newMaxVersion != maxVersion) {
			NotificationChain msgs = null;
			if (maxVersion != null)
				msgs = ((InternalEObject)maxVersion).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OptionPackage.OS_VERSION__MAX_VERSION, null, msgs);
			if (newMaxVersion != null)
				msgs = ((InternalEObject)newMaxVersion).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OptionPackage.OS_VERSION__MAX_VERSION, null, msgs);
			msgs = basicSetMaxVersion(newMaxVersion, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OptionPackage.OS_VERSION__MAX_VERSION, newMaxVersion, newMaxVersion));
	}
	...
	public void setMinNotInclude(boolean newMinNotInclude) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OptionPackage.OS_VERSION__MIN_NOT_INCLUDE, oldMinNotInclude, minNotInclude));
	}
	...
	public void setMaxNotInclude(boolean newMaxNotInclude) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OptionPackage.OS_VERSION__MAX_NOT_INCLUDE, oldMaxNotInclude, maxNotInclude));
	}
