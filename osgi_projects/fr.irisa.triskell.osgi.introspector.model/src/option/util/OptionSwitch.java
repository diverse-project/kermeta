...
public class OptionSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case OptionPackage.DIRECTIVE_ENTRY: {
			...
			if (result == null)
				result = caseParameterEntry(directiveEntry);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case OptionPackage.ATTRIBUT_ENTRY: {
			...
			if (result == null)
				result = caseParameterEntry(attributEntry);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case OptionPackage.OS_NAME: {
			...
			if (result == null)
				result = caseNativeCodeDirective(osName);
			if (result == null)
				result = caseDirectiveEntry(osName);
			if (result == null)
				result = caseParameterEntry(osName);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case OptionPackage.NATIVE_CODE_DIRECTIVE: {
			...
			if (result == null)
				result = caseDirectiveEntry(nativeCodeDirective);
			if (result == null)
				result = caseParameterEntry(nativeCodeDirective);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case OptionPackage.OS_VERSION: {
			...
			if (result == null)
				result = caseNativeCodeDirective(osVersion);
			if (result == null)
				result = caseDirectiveEntry(osVersion);
			if (result == null)
				result = caseParameterEntry(osVersion);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case OptionPackage.EXCLUDE_PACKAGES: {
			...
			if (result == null)
				result = caseActivationPolicyDirective(excludePackages);
			if (result == null)
				result = caseDirectiveEntry(excludePackages);
			if (result == null)
				result = caseExportPackageDirective(excludePackages);
			if (result == null)
				result = caseParameterEntry(excludePackages);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case OptionPackage.PROCESSOR: {
			...
			if (result == null)
				result = caseNativeCodeDirective(processor);
			if (result == null)
				result = caseDirectiveEntry(processor);
			if (result == null)
				result = caseParameterEntry(processor);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case OptionPackage.INCLUDE_PACKAGES: {
			...
			if (result == null)
				result = caseActivationPolicyDirective(includePackages);
			if (result == null)
				result = caseDirectiveEntry(includePackages);
			if (result == null)
				result = caseExportPackageDirective(includePackages);
			if (result == null)
				result = caseParameterEntry(includePackages);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case OptionPackage.USES: {
			...
			if (result == null)
				result = caseExportPackageDirective(uses);
			if (result == null)
				result = caseDirectiveEntry(uses);
			if (result == null)
				result = caseParameterEntry(uses);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case OptionPackage.EXTENSION: {
			...
			if (result == null)
				result = caseFragmentHostDirective(extension);
			if (result == null)
				result = caseDirectiveEntry(extension);
			if (result == null)
				result = caseParameterEntry(extension);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case OptionPackage.MANDATORY: {
			...
			if (result == null)
				result = caseExportPackageDirective(mandatory);
			if (result == null)
				result = caseDirectiveEntry(mandatory);
			if (result == null)
				result = caseParameterEntry(mandatory);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case OptionPackage.LANGUAGE: {
			...
			if (result == null)
				result = caseNativeCodeDirective(language);
			if (result == null)
				result = caseDirectiveEntry(language);
			if (result == null)
				result = caseParameterEntry(language);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case OptionPackage.VISIBILITY: {
			...
			if (result == null)
				result = caseRequireBundleDirective(visibility);
			if (result == null)
				result = caseDirectiveEntry(visibility);
			if (result == null)
				result = caseParameterEntry(visibility);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case OptionPackage.SINGLETON: {
			...
			if (result == null)
				result = caseSymbolicNameDirective(singleton);
			if (result == null)
				result = caseDirectiveEntry(singleton);
			if (result == null)
				result = caseParameterEntry(singleton);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case OptionPackage.RESOLUTION: {
			...
			if (result == null)
				result = caseImportPackageDirective(resolution);
			if (result == null)
				result = caseRequireBundleDirective(resolution);
			if (result == null)
				result = caseDirectiveEntry(resolution);
			if (result == null)
				result = caseParameterEntry(resolution);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case OptionPackage.FRAGMENT_ATTACHMENT: {
			...
			if (result == null)
				result = caseSymbolicNameDirective(fragmentAttachment);
			if (result == null)
				result = caseDirectiveEntry(fragmentAttachment);
			if (result == null)
				result = caseParameterEntry(fragmentAttachment);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case OptionPackage.SELECTION_FILTER: {
			...
			if (result == null)
				result = caseNativeCodeDirective(selectionFilter);
			if (result == null)
				result = caseDirectiveEntry(selectionFilter);
			if (result == null)
				result = caseParameterEntry(selectionFilter);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case OptionPackage.REQUIRE_BUNDLE_DIRECTIVE: {
			...
			if (result == null)
				result = caseDirectiveEntry(requireBundleDirective);
			if (result == null)
				result = caseParameterEntry(requireBundleDirective);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case OptionPackage.FRAGMENT_HOST_DIRECTIVE: {
			...
			if (result == null)
				result = caseDirectiveEntry(fragmentHostDirective);
			if (result == null)
				result = caseParameterEntry(fragmentHostDirective);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case OptionPackage.SYMBOLIC_NAME_DIRECTIVE: {
			...
			if (result == null)
				result = caseDirectiveEntry(symbolicNameDirective);
			if (result == null)
				result = caseParameterEntry(symbolicNameDirective);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case OptionPackage.EXPORT_PACKAGE_DIRECTIVE: {
			...
			if (result == null)
				result = caseDirectiveEntry(exportPackageDirective);
			if (result == null)
				result = caseParameterEntry(exportPackageDirective);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case OptionPackage.IMPORT_PACKAGE_DIRECTIVE: {
			...
			if (result == null)
				result = caseRequireBundleDirective(importPackageDirective);
			if (result == null)
				result = caseDirectiveEntry(importPackageDirective);
			if (result == null)
				result = caseParameterEntry(importPackageDirective);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case OptionPackage.ACTIVATION_POLICY_DIRECTIVE: {
			...
			if (result == null)
				result = caseDirectiveEntry(activationPolicyDirective);
			if (result == null)
				result = caseExportPackageDirective(activationPolicyDirective);
			if (result == null)
				result = caseParameterEntry(activationPolicyDirective);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case OptionPackage.INCLUDE_CLASSES: {
			...
			if (result == null)
				result = caseExportPackageDirective(includeClasses);
			if (result == null)
				result = caseDirectiveEntry(includeClasses);
			if (result == null)
				result = caseParameterEntry(includeClasses);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case OptionPackage.EXCLUDE_CLASSES: {
			...
			if (result == null)
				result = caseExportPackageDirective(excludeClasses);
			if (result == null)
				result = caseDirectiveEntry(excludeClasses);
			if (result == null)
				result = caseParameterEntry(excludeClasses);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
