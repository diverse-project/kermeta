...
public class JarPackageImpl extends EPackageImpl implements JarPackage {
	...
	public void initializePackageContents() {
		...
		initEReference(getFolder_Entries(), this.getSystemEntry(), null, "entries", null, 0, -1, Folder.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
