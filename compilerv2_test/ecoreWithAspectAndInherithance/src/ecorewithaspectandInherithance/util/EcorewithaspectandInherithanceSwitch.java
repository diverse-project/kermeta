 ...
 * @generated
 */
public class EcorewithaspectandInherithanceSwitch<T> {
	/**
	 ...
	 * @generated
	 */
	public EcorewithaspectandInherithanceSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case EcorewithaspectandInherithancePackage.A: {
				A a = (A)theEObject;
				T result = caseA(a);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EcorewithaspectandInherithancePackage.B: {
				B b = (B)theEObject;
				T result = caseB(b);
...
} //EcorewithaspectandInherithanceSwitch
