...
public class KExecMain {
	...
	public static void run(String op, String fileURI, String tgtURI, IOConsole console, String DIVA_KERMETA_CODE, String entryPoint) throws NotRegisteredURIException, IOException, URIMalformedException  {
