 ...
 * </copyright>
 *
 * $Id: TraceabilityFactoryImpl.java,v 1.1 2007-05-03 07:40:06 dvojtise Exp $
 */
...
public class TraceabilityFactoryImpl extends EFactoryImpl implements TraceabilityFactory {
	...
	public static TraceabilityFactory init() {
		try {
			TraceabilityFactory theTraceabilityFactory = (TraceabilityFactory)EPackage.Registry.INSTANCE.getEFactory("http://traceability"); 
