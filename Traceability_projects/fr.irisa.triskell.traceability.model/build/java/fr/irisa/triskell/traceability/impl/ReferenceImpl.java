 ...
 * </copyright>
 *
 * $Id: ReferenceImpl.java,v 1.1 2007-05-03 07:40:06 dvojtise Exp $
 */
 ...
 * <ul>
 *   <li>{@link fr.irisa.triskell.traceability.impl.ReferenceImpl#getTargetTraces <em>Target Traces</em>}</li>
 *   <li>{@link fr.irisa.triskell.traceability.impl.ReferenceImpl#getSourceTraces <em>Source Traces</em>}</li>
 *   <li>{@link fr.irisa.triskell.traceability.impl.ReferenceImpl#getTraceMdl <em>Trace Mdl</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class ReferenceImpl extends EObjectImpl implements Reference {
	 ...
	 * @ordered
	 */
	protected EList targetTraces = null;
	 ...
	 * @ordered
	 */
	protected EList sourceTraces = null;
	 ...
	 * @generated
	 */
	public EList getTargetTraces() {
		if (targetTraces == null) {
			targetTraces = new EObjectWithInverseResolvingEList.ManyInverse(Trace.class, this, TraceabilityPackage.REFERENCE__TARGET_TRACES, TraceabilityPackage.TRACE__SOURCE_REFERENCES);
		}
		return targetTraces;
	}
	 ...
	 * @generated
	 */
	public EList getSourceTraces() {
		if (sourceTraces == null) {
			sourceTraces = new EObjectWithInverseResolvingEList.ManyInverse(Trace.class, this, TraceabilityPackage.REFERENCE__SOURCE_TRACES, TraceabilityPackage.TRACE__TARGET_REFERENCES);
		}
		return sourceTraces;
	}
	...
	public void setTraceMdl(TraceModel newTraceMdl) {
		if (newTraceMdl != eInternalContainer() || (eContainerFeatureID != TraceabilityPackage.REFERENCE__TRACE_MDL && newTraceMdl != null)) {
			...
			if (newTraceMdl != null)
				msgs = ((InternalEObject)newTraceMdl).eInverseAdd(this, TraceabilityPackage.TRACE_MODEL__REFERENCES, TraceModel.class, msgs);
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TraceabilityPackage.REFERENCE__TARGET_TRACES:
				return ((InternalEList)getTargetTraces()).basicAdd(otherEnd, msgs);
			case TraceabilityPackage.REFERENCE__SOURCE_TRACES:
				return ((InternalEList)getSourceTraces()).basicAdd(otherEnd, msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TraceabilityPackage.REFERENCE__TARGET_TRACES:
				return ((InternalEList)getTargetTraces()).basicRemove(otherEnd, msgs);
			case TraceabilityPackage.REFERENCE__SOURCE_TRACES:
				return ((InternalEList)getSourceTraces()).basicRemove(otherEnd, msgs);
			case TraceabilityPackage.REFERENCE__TRACE_MDL:
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID) {
			case TraceabilityPackage.REFERENCE__TRACE_MDL:
				return eInternalContainer().eInverseRemove(this, TraceabilityPackage.TRACE_MODEL__REFERENCES, TraceModel.class, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case TraceabilityPackage.REFERENCE__TARGET_TRACES:
				...
				getTargetTraces().addAll((Collection)newValue);
				return;
			case TraceabilityPackage.REFERENCE__SOURCE_TRACES:
				getSourceTraces().clear();
				getSourceTraces().addAll((Collection)newValue);
				return;
			case TraceabilityPackage.REFERENCE__TRACE_MDL:
