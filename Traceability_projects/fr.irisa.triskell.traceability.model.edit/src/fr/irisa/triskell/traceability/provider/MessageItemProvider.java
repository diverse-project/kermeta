 ...
 * </copyright>
 *
 * $Id: MessageItemProvider.java,v 1.4 2007-07-31 12:34:23 dtouzet Exp $
 */
...
/**
 * This is the item provider adapter for a {@link fr.irisa.triskell.traceability.Message} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TraceabilityPackage.Literals.MESSAGE__TYPE,
				 true,
				 false,
				 false,
	...
	protected void addValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Message_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Message_value_feature", "_UI_Message_type"),
				 TraceabilityPackage.Literals.MESSAGE__VALUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addLanguagePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Message_language_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Message_language_feature", "_UI_Message_type"),
				 TraceabilityPackage.Literals.MESSAGE__LANGUAGE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
