 ...
 * <ul>
 *   <li>{@link org.kermeta.alf.xtext.alf.ClassificationClause#getClassifyFromClause <em>Classify From Clause</em>}</li>
 *   <li>{@link org.kermeta.alf.xtext.alf.ClassificationClause#getClassifyToClause <em>Classify To Clause</em>}</li>
 *   <li>{@link org.kermeta.alf.xtext.alf.ClassificationClause#getReclassyAllClause <em>Reclassy All Clause</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.kermeta.alf.xtext.alf.AlfPackage#getClassificationClause()
 * @model
 * @generated
 */
public interface ClassificationClause extends EObject
{
   ...
   * @see org.kermeta.alf.xtext.alf.AlfPackage#getClassificationClause_ClassifyFromClause()
  ...
  /**
   * Sets the value of the '{@link org.kermeta.alf.xtext.alf.ClassificationClause#getClassifyFromClause <em>Classify From Clause</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.kermeta.alf.xtext.alf.AlfPackage#getClassificationClause_ClassifyToClause()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.kermeta.alf.xtext.alf.ClassificationClause#getClassifyToClause <em>Classify To Clause</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.kermeta.alf.xtext.alf.AlfPackage#getClassificationClause_ReclassyAllClause()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.kermeta.alf.xtext.alf.ClassificationClause#getReclassyAllClause <em>Reclassy All Clause</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
