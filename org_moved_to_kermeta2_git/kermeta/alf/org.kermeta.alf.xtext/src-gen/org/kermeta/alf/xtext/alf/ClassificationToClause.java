 ...
 * <ul>
 *   <li>{@link org.kermeta.alf.xtext.alf.ClassificationToClause#getQualifiedNameList <em>Qualified Name List</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.kermeta.alf.xtext.alf.AlfPackage#getClassificationToClause()
 * @model
 * @generated
 */
public interface ClassificationToClause extends EObject
{
   ...
   * @see org.kermeta.alf.xtext.alf.AlfPackage#getClassificationToClause_QualifiedNameList()
  ...
  /**
   * Sets the value of the '{@link org.kermeta.alf.xtext.alf.ClassificationToClause#getQualifiedNameList <em>Qualified Name List</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
