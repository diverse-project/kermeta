...
trait MultiplicityElementAspect extends group.org.kermeta.language.sample.callEcoreSample.org.kermeta.language.structure.TypedElementAspect with `_root_`.org.kermeta.language.structure.MultiplicityElement{
