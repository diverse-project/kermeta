...
trait OperationAspect extends group.org.kermeta.language.sample.callEcoreSample.org.kermeta.language.structure.MultiplicityElementAspect with group.org.kermeta.language.sample.callEcoreSample.org.kermeta.language.structure.AbstractOperationAspect with `_root_`.org.kermeta.language.structure.Operation{
