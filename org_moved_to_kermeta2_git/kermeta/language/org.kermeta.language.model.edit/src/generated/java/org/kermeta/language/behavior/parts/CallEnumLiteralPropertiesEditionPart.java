 ...
 * 
 */
public interface CallEnumLiteralPropertiesEditionPart {
	...
	/**
	 * @return the staticEnumLiteral
	 * 
	 */
	public EObject getStaticEnumLiteral();

	/**
	 * Init the staticEnumLiteral
	 * @param settings the combo setting
	 */
	public void initStaticEnumLiteral(EObjectFlatComboSettings settings);

	/**
	 * Defines a new staticEnumLiteral
	 * @param newValue the new staticEnumLiteral to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the staticEnumLiteral edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
