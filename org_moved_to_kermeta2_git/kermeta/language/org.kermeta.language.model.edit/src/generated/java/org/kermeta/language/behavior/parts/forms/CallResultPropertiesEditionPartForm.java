 ...
 * 
 */
public class CallResultPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, CallResultPropertiesEditionPart {
	 ...
	 * 
	 */
	public CallResultPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(BehaviorMessages.CallResultPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createKTagReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.kTag.setHelpText(propertiesEditionComponent.getHelpContent(BehaviorViewsRepository.CallResult.Properties.kTag, BehaviorViewsRepository.FORM_KIND));
		this.kTag.createControls(parent, widgetFactory);
		this.kTag.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CallResultPropertiesEditionPartForm.this, BehaviorViewsRepository.CallResult.Properties.kTag, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"kTag", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CallResultPropertiesEditionPartForm.this, BehaviorViewsRepository.CallResult.Properties.kTag,
	...
	protected void moveKTag(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CallResultPropertiesEditionPartForm.this, BehaviorViewsRepository.CallResult.Properties.kTag, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		kTag.refresh();
	}
	...
	protected void removeFromKTag(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CallResultPropertiesEditionPartForm.this, BehaviorViewsRepository.CallResult.Properties.kTag, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		kTag.refresh();
	}
	...
	protected Composite createKTypeFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, BehaviorMessages.CallResultPropertiesEditionPart_KTypeLabel, propertiesEditionComponent.isRequired(BehaviorViewsRepository.CallResult.Properties.kType, BehaviorViewsRepository.FORM_KIND));
		kType = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(BehaviorViewsRepository.CallResult.Properties.kType, BehaviorViewsRepository.FORM_KIND));
		...
		kType.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CallResultPropertiesEditionPartForm.this, BehaviorViewsRepository.CallResult.Properties.kType, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getKType()));
			}

		});
		kType.setID(BehaviorViewsRepository.CallResult.Properties.kType);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(BehaviorViewsRepository.CallResult.Properties.kType, BehaviorViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createStaticTypeFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, BehaviorMessages.CallResultPropertiesEditionPart_StaticTypeLabel, propertiesEditionComponent.isRequired(BehaviorViewsRepository.CallResult.Properties.staticType, BehaviorViewsRepository.FORM_KIND));
		staticType = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(BehaviorViewsRepository.CallResult.Properties.staticType, BehaviorViewsRepository.FORM_KIND));
		...
		staticType.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CallResultPropertiesEditionPartForm.this, BehaviorViewsRepository.CallResult.Properties.staticType, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getStaticType()));
			}

		});
		staticType.setID(BehaviorViewsRepository.CallResult.Properties.staticType);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(BehaviorViewsRepository.CallResult.Properties.staticType, BehaviorViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, BehaviorMessages.CallResultPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(BehaviorViewsRepository.CallResult.Properties.name, BehaviorViewsRepository.FORM_KIND));
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CallResultPropertiesEditionPartForm.this, BehaviorViewsRepository.CallResult.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(BehaviorViewsRepository.CallResult.Properties.name, BehaviorViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createStaticTypeVariableBindingsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.staticTypeVariableBindings.setHelpText(propertiesEditionComponent.getHelpContent(BehaviorViewsRepository.CallResult.Properties.staticTypeVariableBindings, BehaviorViewsRepository.FORM_KIND));
		...
		this.staticTypeVariableBindings.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CallResultPropertiesEditionPartForm.this, BehaviorViewsRepository.CallResult.Properties.staticTypeVariableBindings, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addStaticTypeVariableBindings() {
		...
		"staticTypeVariableBindings", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CallResultPropertiesEditionPartForm.this, BehaviorViewsRepository.CallResult.Properties.staticTypeVariableBindings,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveStaticTypeVariableBindings(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CallResultPropertiesEditionPartForm.this, BehaviorViewsRepository.CallResult.Properties.staticTypeVariableBindings, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		staticTypeVariableBindings.refresh();
	}
	...
	protected void removeFromStaticTypeVariableBindings(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CallResultPropertiesEditionPartForm.this, BehaviorViewsRepository.CallResult.Properties.staticTypeVariableBindings, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		staticTypeVariableBindings.refresh();
	}
	...
	protected Composite createIsAtpreCheckbox(FormToolkit widgetFactory, Composite parent) {
		isAtpre = widgetFactory.createButton(parent, BehaviorMessages.CallResultPropertiesEditionPart_IsAtpreLabel, SWT.CHECK);
		isAtpre.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CallResultPropertiesEditionPartForm.this, BehaviorViewsRepository.CallResult.Properties.isAtpre, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(isAtpre.getSelection())));
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(BehaviorViewsRepository.CallResult.Properties.isAtpre, BehaviorViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
