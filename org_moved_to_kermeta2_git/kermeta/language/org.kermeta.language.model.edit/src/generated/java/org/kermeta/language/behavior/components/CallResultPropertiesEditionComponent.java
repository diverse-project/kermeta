 ...
 * 
 */
public class CallResultPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public CallResultPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject callResult, String editing_mode) {
		super(editingContext, callResult, editing_mode);
		parts = new String[] { BASE_PART };
		repositoryKey = BehaviorViewsRepository.class;
		partKey = BehaviorViewsRepository.CallResult.class;
	}
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			final CallResult callResult = (CallResult)elt;
			final CallResultPropertiesEditionPart basePart = (CallResultPropertiesEditionPart)editingPart;
			// init values
			if (isAccessible(BehaviorViewsRepository.CallResult.Properties.kTag)) {
				kTagSettings = new ReferencesTableSettings(callResult, StructurePackage.eINSTANCE.getKermetaModelElement_KTag());
				basePart.initKTag(kTagSettings);
			}
			if (isAccessible(BehaviorViewsRepository.CallResult.Properties.kType)) {
				// init part
				kTypeSettings = new EObjectFlatComboSettings(callResult, StructurePackage.eINSTANCE.getKermetaModelElement_KType());
				basePart.initKType(kTypeSettings);
				// set the button mode
				basePart.setKTypeButtonMode(ButtonsModeEnum.BROWSE);
			}
			if (isAccessible(BehaviorViewsRepository.CallResult.Properties.staticType)) {
				// init part
				staticTypeSettings = new EObjectFlatComboSettings(callResult, BehaviorPackage.eINSTANCE.getExpression_StaticType());
				basePart.initStaticType(staticTypeSettings);
				// set the button mode
				basePart.setStaticTypeButtonMode(ButtonsModeEnum.BROWSE);
			}
			if (callResult.getName() != null && isAccessible(BehaviorViewsRepository.CallResult.Properties.name))
				basePart.setName(EEFConverterUtil.convertToString(StructurePackage.eINSTANCE.getString(), callResult.getName()));
			
			if (isAccessible(BehaviorViewsRepository.CallResult.Properties.staticTypeVariableBindings)) {
				staticTypeVariableBindingsSettings = new ReferencesTableSettings(callResult, BehaviorPackage.eINSTANCE.getCallExpression_StaticTypeVariableBindings());
				basePart.initStaticTypeVariableBindings(staticTypeVariableBindingsSettings);
			}
			if (isAccessible(BehaviorViewsRepository.CallResult.Properties.isAtpre)) {
				basePart.setIsAtpre(callResult.getIsAtpre());
			}
			// init filters
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		if (editorKey == BehaviorViewsRepository.CallResult.Properties.kTag) {
			return StructurePackage.eINSTANCE.getKermetaModelElement_KTag();
		}
		if (editorKey == BehaviorViewsRepository.CallResult.Properties.kType) {
			return StructurePackage.eINSTANCE.getKermetaModelElement_KType();
		}
		if (editorKey == BehaviorViewsRepository.CallResult.Properties.staticType) {
			return BehaviorPackage.eINSTANCE.getExpression_StaticType();
		}
		if (editorKey == BehaviorViewsRepository.CallResult.Properties.name) {
			return BehaviorPackage.eINSTANCE.getCallExpression_Name();
		}
		if (editorKey == BehaviorViewsRepository.CallResult.Properties.staticTypeVariableBindings) {
			return BehaviorPackage.eINSTANCE.getCallExpression_StaticTypeVariableBindings();
		}
		if (editorKey == BehaviorViewsRepository.CallResult.Properties.isAtpre) {
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		CallResult callResult = (CallResult)semanticObject;
		if (BehaviorViewsRepository.CallResult.Properties.kTag == event.getAffectedEditor()) {
		...
		if (BehaviorViewsRepository.CallResult.Properties.kType == event.getAffectedEditor()) {
		...
		if (BehaviorViewsRepository.CallResult.Properties.staticType == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.SET) {
		...
		if (BehaviorViewsRepository.CallResult.Properties.name == event.getAffectedEditor()) {
			callResult.setName((java.lang.String)EEFConverterUtil.createFromString(StructurePackage.eINSTANCE.getString(), (String)event.getNewValue()));
		}
		if (BehaviorViewsRepository.CallResult.Properties.staticTypeVariableBindings == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (BehaviorViewsRepository.CallResult.Properties.isAtpre == event.getAffectedEditor()) {
			callResult.setIsAtpre((Boolean)event.getNewValue());
		}
	}
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {
			CallResultPropertiesEditionPart basePart = (CallResultPropertiesEditionPart)editingPart;
			if (StructurePackage.eINSTANCE.getKermetaModelElement_KTag().equals(msg.getFeature())  && isAccessible(BehaviorViewsRepository.CallResult.Properties.kTag))
				basePart.updateKTag();
			if (StructurePackage.eINSTANCE.getKermetaModelElement_KType().equals(msg.getFeature()) && basePart != null && isAccessible(BehaviorViewsRepository.CallResult.Properties.kType))
				basePart.setKType((EObject)msg.getNewValue());
			if (BehaviorPackage.eINSTANCE.getExpression_StaticType().equals(msg.getFeature()) && basePart != null && isAccessible(BehaviorViewsRepository.CallResult.Properties.staticType))
				basePart.setStaticType((EObject)msg.getNewValue());
			if (BehaviorPackage.eINSTANCE.getCallExpression_Name().equals(msg.getFeature()) && basePart != null && isAccessible(BehaviorViewsRepository.CallResult.Properties.name)) {
			...
			if (BehaviorPackage.eINSTANCE.getCallExpression_StaticTypeVariableBindings().equals(msg.getFeature())  && isAccessible(BehaviorViewsRepository.CallResult.Properties.staticTypeVariableBindings))
				basePart.updateStaticTypeVariableBindings();
			if (BehaviorPackage.eINSTANCE.getCallVariable_IsAtpre().equals(msg.getFeature()) && basePart != null && isAccessible(BehaviorViewsRepository.CallResult.Properties.isAtpre))
	...
	public boolean isRequired(Object key, int kind) {
		return key == BehaviorViewsRepository.CallResult.Properties.kType || key == BehaviorViewsRepository.CallResult.Properties.isAtpre;
	}
