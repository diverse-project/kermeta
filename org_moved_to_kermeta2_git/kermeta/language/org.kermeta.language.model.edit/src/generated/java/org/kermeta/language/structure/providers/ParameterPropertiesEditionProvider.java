...
import org.kermeta.language.structure.components.ParameterPropertiesEditionComponent;
...
public class ParameterPropertiesEditionProvider extends PropertiesEditingProviderImpl {
	...
	public boolean provides(PropertiesEditingContext editingContext) {
		return (editingContext.getEObject() instanceof Parameter) 
					&& (StructurePackage.eINSTANCE.getParameter() == editingContext.getEObject().eClass());
	}
