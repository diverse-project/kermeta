 ...
 * 
 */
public interface CallSuperOperationPropertiesEditionPart {
	...
	/**
	 * Init the staticOperation
	 * @param settings the combo setting
	 */
	public void initStaticOperation(EObjectFlatComboSettings settings);

	/**
	 * Defines a new staticOperation
	 * @param newValue the new staticOperation to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the staticOperation edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
