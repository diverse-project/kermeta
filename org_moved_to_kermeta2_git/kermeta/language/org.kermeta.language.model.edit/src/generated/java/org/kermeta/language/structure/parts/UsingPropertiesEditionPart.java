 ...
 * 
 */
public interface UsingPropertiesEditionPart {
	...
	/**
	 * @return the fromQName
	 * 
	 */
	public String getFromQName();

	/**
	 * Defines a new fromQName
	 * @param newValue the new fromQName to set
	 * 
	 */
	...
	/**
	 * Defines a new toName
	 * @param newValue the new toName to set
	 * 
	 */
