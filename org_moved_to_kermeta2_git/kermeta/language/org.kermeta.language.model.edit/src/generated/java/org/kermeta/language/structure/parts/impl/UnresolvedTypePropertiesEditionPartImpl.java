 ...
 * 
 */
public class UnresolvedTypePropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, UnresolvedTypePropertiesEditionPart {
	 ...
	 * 
	 */
	public UnresolvedTypePropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
		...
		composer = new PartComposer(unresolvedTypeStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == StructureViewsRepository.UnresolvedType.Properties.typeIdentifier) {
					return createTypeIdentifierText(parent);
				}
				return parent;
			}
		};
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(StructureMessages.UnresolvedTypePropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createKTagAdvancedReferencesTable(Composite parent) {
		...
		this.kTag.setHelpText(propertiesEditionComponent.getHelpContent(StructureViewsRepository.UnresolvedType.Properties.kTag, StructureViewsRepository.SWT_KIND));
		this.kTag.createControls(parent);
		this.kTag.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(UnresolvedTypePropertiesEditionPartImpl.this, StructureViewsRepository.UnresolvedType.Properties.kTag, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"kTag", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(UnresolvedTypePropertiesEditionPartImpl.this, StructureViewsRepository.UnresolvedType.Properties.kTag,
	...
	protected void moveKTag(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(UnresolvedTypePropertiesEditionPartImpl.this, StructureViewsRepository.UnresolvedType.Properties.kTag, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		kTag.refresh();
	}
	...
	protected void removeFromKTag(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(UnresolvedTypePropertiesEditionPartImpl.this, StructureViewsRepository.UnresolvedType.Properties.kTag, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		kTag.refresh();
	}
	...
	protected Composite createKTypeFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, StructureMessages.UnresolvedTypePropertiesEditionPart_KTypeLabel, propertiesEditionComponent.isRequired(StructureViewsRepository.UnresolvedType.Properties.kType, StructureViewsRepository.SWT_KIND));
		kType = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(StructureViewsRepository.UnresolvedType.Properties.kType, StructureViewsRepository.SWT_KIND));
		...
		kType.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(UnresolvedTypePropertiesEditionPartImpl.this, StructureViewsRepository.UnresolvedType.Properties.kType, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getKType()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(StructureViewsRepository.UnresolvedType.Properties.kType, StructureViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createTypeContainerFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, StructureMessages.UnresolvedTypePropertiesEditionPart_TypeContainerLabel, propertiesEditionComponent.isRequired(StructureViewsRepository.UnresolvedType.Properties.typeContainer, StructureViewsRepository.SWT_KIND));
		typeContainer = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(StructureViewsRepository.UnresolvedType.Properties.typeContainer, StructureViewsRepository.SWT_KIND));
		...
		typeContainer.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(UnresolvedTypePropertiesEditionPartImpl.this, StructureViewsRepository.UnresolvedType.Properties.typeContainer, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getTypeContainer()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(StructureViewsRepository.UnresolvedType.Properties.typeContainer, StructureViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createGenericsAdvancedReferencesTable(Composite parent) {
		...
		this.generics.setHelpText(propertiesEditionComponent.getHelpContent(StructureViewsRepository.UnresolvedType.Properties.generics, StructureViewsRepository.SWT_KIND));
		this.generics.createControls(parent);
		this.generics.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(UnresolvedTypePropertiesEditionPartImpl.this, StructureViewsRepository.UnresolvedType.Properties.generics, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addGenerics() {
		...
		"generics", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(UnresolvedTypePropertiesEditionPartImpl.this, StructureViewsRepository.UnresolvedType.Properties.generics,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
				generics.refresh();
			}
	...
	protected void moveGenerics(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(UnresolvedTypePropertiesEditionPartImpl.this, StructureViewsRepository.UnresolvedType.Properties.generics, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		generics.refresh();
	}
	...
	protected void removeFromGenerics(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(UnresolvedTypePropertiesEditionPartImpl.this, StructureViewsRepository.UnresolvedType.Properties.generics, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		generics.refresh();
	}
	...
	protected Composite createTypeIdentifierText(Composite parent) {
		SWTUtils.createPartLabel(parent, StructureMessages.UnresolvedTypePropertiesEditionPart_TypeIdentifierLabel, propertiesEditionComponent.isRequired(StructureViewsRepository.UnresolvedType.Properties.typeIdentifier, StructureViewsRepository.SWT_KIND));
		typeIdentifier = new Text(parent, SWT.BORDER);
		...
		typeIdentifier.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(UnresolvedTypePropertiesEditionPartImpl.this, StructureViewsRepository.UnresolvedType.Properties.typeIdentifier, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, typeIdentifier.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(StructureViewsRepository.UnresolvedType.Properties.typeIdentifier, StructureViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
