 ...
 * 
 */
public class TypeMappingPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, TypeMappingPropertiesEditionPart {
	 ...
	 * 
	 */
	public TypeMappingPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
		...
		composer = new PartComposer(typeMappingStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == StructureViewsRepository.TypeMapping.Properties.targetType) {
					return createTargetTypeFlatComboViewer(parent);
				}
				if (key == StructureViewsRepository.TypeMapping.Properties.sourceType) {
					return createSourceTypeFlatComboViewer(parent);
				}
				return parent;
			}
		};
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(StructureMessages.TypeMappingPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createKTagAdvancedReferencesTable(Composite parent) {
		...
		this.kTag.setHelpText(propertiesEditionComponent.getHelpContent(StructureViewsRepository.TypeMapping.Properties.kTag, StructureViewsRepository.SWT_KIND));
		this.kTag.createControls(parent);
		this.kTag.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TypeMappingPropertiesEditionPartImpl.this, StructureViewsRepository.TypeMapping.Properties.kTag, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"kTag", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TypeMappingPropertiesEditionPartImpl.this, StructureViewsRepository.TypeMapping.Properties.kTag,
	...
	protected void moveKTag(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TypeMappingPropertiesEditionPartImpl.this, StructureViewsRepository.TypeMapping.Properties.kTag, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		kTag.refresh();
	}
	...
	protected void removeFromKTag(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TypeMappingPropertiesEditionPartImpl.this, StructureViewsRepository.TypeMapping.Properties.kTag, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		kTag.refresh();
	}
	...
	protected Composite createKTypeFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, StructureMessages.TypeMappingPropertiesEditionPart_KTypeLabel, propertiesEditionComponent.isRequired(StructureViewsRepository.TypeMapping.Properties.kType, StructureViewsRepository.SWT_KIND));
		kType = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(StructureViewsRepository.TypeMapping.Properties.kType, StructureViewsRepository.SWT_KIND));
		...
		kType.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TypeMappingPropertiesEditionPartImpl.this, StructureViewsRepository.TypeMapping.Properties.kType, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getKType()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(StructureViewsRepository.TypeMapping.Properties.kType, StructureViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	 ...
	 * 
	 */
	protected Composite createTargetTypeFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, StructureMessages.TypeMappingPropertiesEditionPart_TargetTypeLabel, propertiesEditionComponent.isRequired(StructureViewsRepository.TypeMapping.Properties.targetType, StructureViewsRepository.SWT_KIND));
		targetType = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(StructureViewsRepository.TypeMapping.Properties.targetType, StructureViewsRepository.SWT_KIND));
		...
		targetType.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TypeMappingPropertiesEditionPartImpl.this, StructureViewsRepository.TypeMapping.Properties.targetType, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getTargetType()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(StructureViewsRepository.TypeMapping.Properties.targetType, StructureViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	 ...
	 * 
	 */
	protected Composite createSourceTypeFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, StructureMessages.TypeMappingPropertiesEditionPart_SourceTypeLabel, propertiesEditionComponent.isRequired(StructureViewsRepository.TypeMapping.Properties.sourceType, StructureViewsRepository.SWT_KIND));
		sourceType = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(StructureViewsRepository.TypeMapping.Properties.sourceType, StructureViewsRepository.SWT_KIND));
		...
		sourceType.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TypeMappingPropertiesEditionPartImpl.this, StructureViewsRepository.TypeMapping.Properties.sourceType, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getSourceType()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(StructureViewsRepository.TypeMapping.Properties.sourceType, StructureViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
