 ...
 * 
 */
public class ClassDefinitionPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, ClassDefinitionPropertiesEditionPart {
	 ...
	 * 
	 */
	public ClassDefinitionPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(StructureMessages.ClassDefinitionPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createKTagAdvancedReferencesTable(Composite parent) {
		...
		this.kTag.setHelpText(propertiesEditionComponent.getHelpContent(StructureViewsRepository.ClassDefinition.Properties.kTag, StructureViewsRepository.SWT_KIND));
		this.kTag.createControls(parent);
		this.kTag.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ClassDefinitionPropertiesEditionPartImpl.this, StructureViewsRepository.ClassDefinition.Properties.kTag, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"kTag", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ClassDefinitionPropertiesEditionPartImpl.this, StructureViewsRepository.ClassDefinition.Properties.kTag,
	...
	protected void moveKTag(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ClassDefinitionPropertiesEditionPartImpl.this, StructureViewsRepository.ClassDefinition.Properties.kTag, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		kTag.refresh();
	}
	...
	protected void removeFromKTag(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ClassDefinitionPropertiesEditionPartImpl.this, StructureViewsRepository.ClassDefinition.Properties.kTag, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		kTag.refresh();
	}
	...
	protected Composite createKTypeFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, StructureMessages.ClassDefinitionPropertiesEditionPart_KTypeLabel, propertiesEditionComponent.isRequired(StructureViewsRepository.ClassDefinition.Properties.kType, StructureViewsRepository.SWT_KIND));
		kType = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(StructureViewsRepository.ClassDefinition.Properties.kType, StructureViewsRepository.SWT_KIND));
		...
		kType.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ClassDefinitionPropertiesEditionPartImpl.this, StructureViewsRepository.ClassDefinition.Properties.kType, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getKType()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(StructureViewsRepository.ClassDefinition.Properties.kType, StructureViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, StructureMessages.ClassDefinitionPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(StructureViewsRepository.ClassDefinition.Properties.name, StructureViewsRepository.SWT_KIND));
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ClassDefinitionPropertiesEditionPartImpl.this, StructureViewsRepository.ClassDefinition.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(StructureViewsRepository.ClassDefinition.Properties.name, StructureViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createSuperTypeAdvancedReferencesTable(Composite parent) {
		...
		this.superType.setHelpText(propertiesEditionComponent.getHelpContent(StructureViewsRepository.ClassDefinition.Properties.superType, StructureViewsRepository.SWT_KIND));
		this.superType.createControls(parent);
		this.superType.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ClassDefinitionPropertiesEditionPartImpl.this, StructureViewsRepository.ClassDefinition.Properties.superType, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addSuperType() {
		...
		"superType", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ClassDefinitionPropertiesEditionPartImpl.this, StructureViewsRepository.ClassDefinition.Properties.superType,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
				superType.refresh();
			}
	...
	protected void moveSuperType(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ClassDefinitionPropertiesEditionPartImpl.this, StructureViewsRepository.ClassDefinition.Properties.superType, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		superType.refresh();
	}
	...
	protected void removeFromSuperType(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ClassDefinitionPropertiesEditionPartImpl.this, StructureViewsRepository.ClassDefinition.Properties.superType, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		superType.refresh();
	}
	...
	protected Composite createIsAspectCheckbox(Composite parent) {
		...
		isAspect.setText(StructureMessages.ClassDefinitionPropertiesEditionPart_IsAspectLabel);
		isAspect.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ClassDefinitionPropertiesEditionPartImpl.this, StructureViewsRepository.ClassDefinition.Properties.isAspect, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(isAspect.getSelection())));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(StructureViewsRepository.ClassDefinition.Properties.isAspect, StructureViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createTypeParameterAdvancedReferencesTable(Composite parent) {
		...
		this.typeParameter.setHelpText(propertiesEditionComponent.getHelpContent(StructureViewsRepository.ClassDefinition.Properties.typeParameter, StructureViewsRepository.SWT_KIND));
		this.typeParameter.createControls(parent);
		this.typeParameter.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ClassDefinitionPropertiesEditionPartImpl.this, StructureViewsRepository.ClassDefinition.Properties.typeParameter, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addTypeParameter() {
		...
		"typeParameter", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ClassDefinitionPropertiesEditionPartImpl.this, StructureViewsRepository.ClassDefinition.Properties.typeParameter,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveTypeParameter(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ClassDefinitionPropertiesEditionPartImpl.this, StructureViewsRepository.ClassDefinition.Properties.typeParameter, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		typeParameter.refresh();
	}
	...
	protected void removeFromTypeParameter(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ClassDefinitionPropertiesEditionPartImpl.this, StructureViewsRepository.ClassDefinition.Properties.typeParameter, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		typeParameter.refresh();
	}
	...
	protected Composite createIsAbstractCheckbox(Composite parent) {
		...
		isAbstract.setText(StructureMessages.ClassDefinitionPropertiesEditionPart_IsAbstractLabel);
		isAbstract.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ClassDefinitionPropertiesEditionPartImpl.this, StructureViewsRepository.ClassDefinition.Properties.isAbstract, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(isAbstract.getSelection())));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(StructureViewsRepository.ClassDefinition.Properties.isAbstract, StructureViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createIsSingletonCheckbox(Composite parent) {
		...
		isSingleton.setText(StructureMessages.ClassDefinitionPropertiesEditionPart_IsSingletonLabel);
		isSingleton.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ClassDefinitionPropertiesEditionPartImpl.this, StructureViewsRepository.ClassDefinition.Properties.isSingleton, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(isSingleton.getSelection())));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(StructureViewsRepository.ClassDefinition.Properties.isSingleton, StructureViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
