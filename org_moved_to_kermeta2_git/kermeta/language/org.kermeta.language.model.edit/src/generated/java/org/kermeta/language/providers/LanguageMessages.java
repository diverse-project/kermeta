...
*/
package org.kermeta.language.providers;
 ...
 * 
 */
public class LanguageMessages extends NLS {
	
	private static final String BUNDLE_NAME = "org.kermeta.language.providers.languageMessages"; //$NON-NLS-1$
	...
	static {
		...
		NLS.initializeMessages(BUNDLE_NAME, LanguageMessages.class);
	}
