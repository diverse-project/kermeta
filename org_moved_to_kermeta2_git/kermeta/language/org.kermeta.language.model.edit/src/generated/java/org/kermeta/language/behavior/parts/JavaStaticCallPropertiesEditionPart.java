 ...
 * 
 */
public interface JavaStaticCallPropertiesEditionPart {
	...
	/**
	 * Defines a new jclass
	 * @param newValue the new jclass to set
	 * 
	 */
	...
	/**
	 * Defines a new jmethod
	 * @param newValue the new jmethod to set
	 * 
	 */
