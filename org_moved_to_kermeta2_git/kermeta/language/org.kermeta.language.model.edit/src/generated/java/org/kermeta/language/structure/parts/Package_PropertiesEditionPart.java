...
public interface Package_PropertiesEditionPart {
	...
	/**
	 * @return the nestingPackage
	 * 
	 */
	public EObject getNestingPackage();

	/**
	 * Init the nestingPackage
	 * @param settings the combo setting
	 */
	public void initNestingPackage(EObjectFlatComboSettings settings);

	/**
	 * Defines a new nestingPackage
	 * @param newValue the new nestingPackage to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the nestingPackage edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
