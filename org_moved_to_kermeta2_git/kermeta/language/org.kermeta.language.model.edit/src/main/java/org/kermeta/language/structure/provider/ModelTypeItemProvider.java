		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ModelType_typeDefinition_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ModelType_typeDefinition_feature", "_UI_ModelType_type"),
				 StructurePackage.Literals.MODEL_TYPE__TYPE_DEFINITION,
				 true,
				 false,
				 true,
				 null,
