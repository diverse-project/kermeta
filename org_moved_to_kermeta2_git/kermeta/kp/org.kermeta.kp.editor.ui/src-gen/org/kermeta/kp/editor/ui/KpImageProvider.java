...
public class KpImageProvider {
	...
	public final static KpImageProvider INSTANCE = new KpImageProvider();
	...
	public org.eclipse.swt.graphics.Image getImage(String key) {
		...
		org.eclipse.jface.resource.ImageDescriptor descriptor = org.eclipse.jface.resource.ImageDescriptor.createFromURL(org.eclipse.core.runtime.FileLocator.find(org.kermeta.kp.editor.ui.KpUIPlugin.getDefault().getBundle(), path, null));
		if (org.eclipse.jface.resource.ImageDescriptor.getMissingImageDescriptor().equals(descriptor) || descriptor == null) {
			...
			try {
				...
				org.kermeta.kp.editor.ui.KpUIPlugin.logError("IconProvider can't load image (URL is malformed).", mue);
			}
		}
