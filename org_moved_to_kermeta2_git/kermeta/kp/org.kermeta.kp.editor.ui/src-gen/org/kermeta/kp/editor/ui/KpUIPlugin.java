 ...
 */
public class KpUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "org.kermeta.kp.editor.ui";
	public static final String EDITOR_ID = "org.kermeta.kp.editor.ui.KpEditor";
	...
	private static KpUIPlugin plugin;
	...
	public static KpUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, KpUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, KpUIPlugin.PLUGIN_ID, message);
		}
		final KpUIPlugin pluginInstance = KpUIPlugin.getDefault();
