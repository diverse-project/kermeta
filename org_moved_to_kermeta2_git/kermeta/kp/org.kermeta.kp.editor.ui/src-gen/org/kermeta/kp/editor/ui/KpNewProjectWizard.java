 ...
 */
public class KpNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new org.kermeta.kp.editor.mopp.KpMetaInformation().getSyntaxName() + " Project";
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("org.kermeta.kp.editor.ui");
							...
							String natureID = org.kermeta.kp.editor.mopp.KpNature.NATURE_ID;
							...
							for (String builderID : org.kermeta.kp.editor.mopp.KpNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								org.kermeta.kp.editor.mopp.KpMetaInformation info = new org.kermeta.kp.editor.mopp.KpMetaInformation();
