...
public class KpHighlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	 ...
	 */
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, org.kermeta.kp.editor.IKpBackgroundParsingListener {
	 ...
	 * @param editor
	 */
	public KpHighlighting(org.kermeta.kp.editor.IKpTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, org.kermeta.kp.editor.ui.KpColorManager colorManager, org.kermeta.kp.editor.ui.KpEditor editor) {
		...
		occurrence = new org.kermeta.kp.editor.ui.KpOccurrence(textResource, sourceviewer, scanner);
		bracketSet = new org.kermeta.kp.editor.ui.KpBracketSet(editor, sourceviewer);
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(org.kermeta.kp.editor.ui.KpPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, org.kermeta.kp.editor.ui.KpPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
	...
	private void setBracketHighlighting(org.eclipse.jface.text.IDocument document) {
		...
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, org.kermeta.kp.editor.ui.KpPositionCategory.BRACKET.toString());
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, org.kermeta.kp.editor.ui.KpPositionCategory.BRACKET.toString());
	}
	...
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(org.kermeta.kp.editor.ui.KpPositionCategory.BRACKET.toString())) {
		...
		display.syncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new org.kermeta.kp.editor.ui.KpEObjectSelection(selectedEObject, false));
				}
			}
		});
	}
