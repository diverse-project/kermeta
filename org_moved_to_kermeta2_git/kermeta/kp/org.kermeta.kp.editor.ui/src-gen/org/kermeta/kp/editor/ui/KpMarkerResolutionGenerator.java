...
public class KpMarkerResolutionGenerator implements org.eclipse.ui.IMarkerResolutionGenerator {
	...
	public org.eclipse.ui.IMarkerResolution[] getResolutions(org.eclipse.core.resources.IMarker marker) {
		try {
			...
			if (resource instanceof org.eclipse.core.resources.IFile) {
				...
				rs.getLoadOptions().put(org.kermeta.kp.editor.IKpOptions.DISABLE_CREATING_MARKERS_FOR_PROBLEMS, "true");
				org.eclipse.emf.ecore.resource.Resource emfResource = rs.getResource(uri, true);
				if (emfResource instanceof org.kermeta.kp.editor.mopp.KpResource) {
					org.kermeta.kp.editor.mopp.KpResource customResource = (org.kermeta.kp.editor.mopp.KpResource) emfResource;
					org.eclipse.emf.ecore.util.EcoreUtil.resolveAll(customResource);
					java.util.Collection<org.kermeta.kp.editor.IKpQuickFix> quickFixes = getQuickFixes(customResource, marker);
					java.util.List<org.eclipse.ui.IMarkerResolution2> resolutions = new java.util.ArrayList<org.eclipse.ui.IMarkerResolution2>();
					for (final org.kermeta.kp.editor.IKpQuickFix quickFix : quickFixes) {
						resolutions.add(new org.eclipse.ui.IMarkerResolution2() {
							...
							public void run(org.eclipse.core.resources.IMarker marker) {
								...
								try {
									...
									org.kermeta.kp.editor.ui.KpUIPlugin.logError("Exception while applying quick fix", e);
								}
							}
			...
			org.kermeta.kp.editor.ui.KpUIPlugin.logError("Exception while computing quick fix resolutions", e);
		}
		return new org.eclipse.ui.IMarkerResolution[] {};
	}
	
	public java.util.Collection<org.kermeta.kp.editor.IKpQuickFix> getQuickFixes(org.kermeta.kp.editor.IKpTextResource resource, org.eclipse.core.resources.IMarker marker) {
		...
		try {
			...
			if (quickFixContexts != null) {
				...
				for (String quickFixContext : quickFixContextParts) {
					org.kermeta.kp.editor.IKpQuickFix quickFix = resource.getQuickFix(quickFixContext);
					if (quickFix != null) {
