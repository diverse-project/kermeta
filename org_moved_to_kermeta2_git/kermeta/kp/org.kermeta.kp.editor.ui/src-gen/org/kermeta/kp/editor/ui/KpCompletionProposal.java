 ...
 */
public class KpCompletionProposal implements java.lang.Comparable<KpCompletionProposal> {
	...
	public KpCompletionProposal(String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container) {
		super();
	...
	public KpCompletionProposal(String insertString, String prefix, boolean startsWithPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image) {
		this(insertString, prefix, startsWithPrefix, structuralFeature, container);
		this.image = image;
	}
	
	public KpCompletionProposal(String insertString, String prefix, boolean startsWithPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image, String displayString) {
	...
	public boolean equals(Object object) {
		if (object instanceof KpCompletionProposal) {
			KpCompletionProposal other = (KpCompletionProposal) object;
	...
	public int compareTo(KpCompletionProposal object) {
		if (object instanceof KpCompletionProposal) {
			KpCompletionProposal other = (KpCompletionProposal) object;
