 ...
 */
public class KpNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public KpNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new kp file");
