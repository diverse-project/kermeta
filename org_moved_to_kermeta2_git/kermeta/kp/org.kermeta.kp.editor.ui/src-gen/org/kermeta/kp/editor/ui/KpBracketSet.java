...
public class KpBracketSet {
	...
	private java.util.ArrayList<org.kermeta.kp.editor.IKpBracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements org.kermeta.kp.editor.IKpBracketPair {
	 ...
	 */
	private class ClosingListener implements org.kermeta.kp.editor.ui.IKpBracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				org.kermeta.kp.editor.IKpBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public KpBracketSet(org.kermeta.kp.editor.ui.KpEditor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new org.kermeta.kp.editor.mopp.KpMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<org.kermeta.kp.editor.IKpBracketPair>();
	 ...
	 */
	public org.kermeta.kp.editor.IKpBracketPair getBracketPair(String opening, String closing) {
		for (org.kermeta.kp.editor.IKpBracketPair bracketPair : bracketPairs) {
	...
	public org.kermeta.kp.editor.IKpBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(org.kermeta.kp.editor.IKpBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + org.kermeta.kp.editor.ui.KpPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public org.kermeta.kp.editor.IKpBracketPair remove(String opening, String closing) {
		for (org.kermeta.kp.editor.IKpBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<org.kermeta.kp.editor.IKpBracketPair>();
	 ...
	 */
	private void addListeners(org.kermeta.kp.editor.ui.KpEditor editor) {
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, org.kermeta.kp.editor.ui.KpPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, org.kermeta.kp.editor.ui.KpPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
