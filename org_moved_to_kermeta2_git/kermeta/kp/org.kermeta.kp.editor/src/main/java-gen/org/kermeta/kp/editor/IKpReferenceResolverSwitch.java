...
/**
 * A IKpReferenceResolverSwitch holds references to multiple other reference
 * resolvers and delegates requests to the appropriate resolver.
 */
public interface IKpReferenceResolverSwitch extends org.kermeta.kp.editor.IKpConfigurable {
