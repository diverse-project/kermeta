 ...
 * <ul>
 *   <li>{@link fr.tm.elibel.smartqvt.qvt.essentialocl.impl.TupleLiteralExpImpl#getPart <em>Part</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TupleLiteralExpImpl extends LiteralExpImpl implements TupleLiteralExp {
	...
	public EList getPart() {
		if (part == null) {
			part = new EObjectContainmentWithInverseEList(TupleLiteralPart.class, this, EssentialoclPackage.TUPLE_LITERAL_EXP__PART, EssentialoclPackage.TUPLE_LITERAL_PART__TUPLE_LITERAL_EXP);
		}
		return part;
	}
