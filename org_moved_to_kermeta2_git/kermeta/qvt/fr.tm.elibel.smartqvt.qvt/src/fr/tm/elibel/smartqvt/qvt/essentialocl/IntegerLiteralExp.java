 ...
 * <ul>
 *   <li>{@link fr.tm.elibel.smartqvt.qvt.essentialocl.IntegerLiteralExp#getIntegerSymbol <em>Integer Symbol</em>}</li>
 * </ul>
 * </p>
 *
 * @see fr.tm.elibel.smartqvt.qvt.essentialocl.EssentialoclPackage#getIntegerLiteralExp()
 * @model
 * @generated
 */
public interface IntegerLiteralExp extends NumericLiteralExp {
	 ...
	 * @see fr.tm.elibel.smartqvt.qvt.essentialocl.EssentialoclPackage#getIntegerLiteralExp_IntegerSymbol()
	 * @model dataType="fr.tm.elibel.smartqvt.qvt.primitivetypes.Integer"
	 * @generated
	 */
	Integer getIntegerSymbol();

	/**
	 * Sets the value of the '{@link fr.tm.elibel.smartqvt.qvt.essentialocl.IntegerLiteralExp#getIntegerSymbol <em>Integer Symbol</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
