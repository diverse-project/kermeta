 ...
 * <ul>
 *   <li>{@link fr.tm.elibel.smartqvt.qvt.emof.impl.CommentImpl#getAnnotatedElement <em>Annotated Element</em>}</li>
 *   <li>{@link fr.tm.elibel.smartqvt.qvt.emof.impl.CommentImpl#getBody <em>Body</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CommentImpl extends ElementImpl implements Comment {
	...
	public EList getAnnotatedElement() {
		if (annotatedElement == null) {
			annotatedElement = new EObjectResolvingEList(NamedElement.class, this, EmofPackage.COMMENT__ANNOTATED_ELEMENT);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case EmofPackage.COMMENT__ANNOTATED_ELEMENT:
				...
				getAnnotatedElement().addAll((Collection)newValue);
				return;
			case EmofPackage.COMMENT__BODY:
