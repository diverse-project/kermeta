 ...
 * <ul>
 *   <li>{@link fr.tm.elibel.smartqvt.qvt.qvtrelation.impl.RelationDomainImpl#getDefaultAssignment <em>Default Assignment</em>}</li>
 *   <li>{@link fr.tm.elibel.smartqvt.qvt.qvtrelation.impl.RelationDomainImpl#getPattern <em>Pattern</em>}</li>
 *   <li>{@link fr.tm.elibel.smartqvt.qvt.qvtrelation.impl.RelationDomainImpl#getRootVariable <em>Root Variable</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RelationDomainImpl extends DomainImpl implements RelationDomain {
	 ...
	 * @ordered
	 */
	protected EList defaultAssignment;
	 ...
	 * @generated
	 */
	public EList getDefaultAssignment() {
		if (defaultAssignment == null) {
			defaultAssignment = new EObjectContainmentEList(RelationDomainAssignment.class, this, QvtrelationPackage.RELATION_DOMAIN__DEFAULT_ASSIGNMENT);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case QvtrelationPackage.RELATION_DOMAIN__DEFAULT_ASSIGNMENT:
				...
				getDefaultAssignment().addAll((Collection)newValue);
				return;
			case QvtrelationPackage.RELATION_DOMAIN__PATTERN:
