 ...
 *   <li>{@link org.kermeta.diagnostic.ConstraintDiagnostic#isIsWarning <em>Is Warning</em>}</li>
 * </ul>
 * </p>
 *
...
public interface ConstraintDiagnostic extends EObject {
	...
	/**
	 * Returns the value of the '<em><b>Is Warning</b></em>' attribute.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Is Warning</em>' attribute isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Is Warning</em>' attribute.
	 * @see #setIsWarning(boolean)
	 * @see org.kermeta.diagnostic.DiagnosticPackage#getConstraintDiagnostic_IsWarning()
	 * @model required="true"
	 * @generated
	 */
	boolean isIsWarning();
	...
	/**
	 * Sets the value of the '{@link org.kermeta.diagnostic.ConstraintDiagnostic#isIsWarning <em>Is Warning</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Is Warning</em>' attribute.
	 * @see #isIsWarning()
	 * @generated
	 */
	void setIsWarning(boolean value);
