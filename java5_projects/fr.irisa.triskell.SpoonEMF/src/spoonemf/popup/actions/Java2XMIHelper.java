...
public class Java2XMIHelper {
	...
	public static void main(String[] args) {
		...
		l.add("/home/barais/workspaces/workspace_demo_kermeta/spring/src/");
		//Java2XMIHelper.eInstance.processJavaFolder(l , "test.java5");
		Java2XMIHelper.eInstance.processXMIFiles("/home/barais/workspaces/workspace_demo_kermeta/spring/src/output",  "test.java5");
	}
	...
	public void printJavaFiles(){
		...
		System.out.println("beginning saving java code1");
...
//			if (p.getSimpleName().equals("test"))
	...
	class specScanner extends CtScanner {
		...
		public void enter(spoon.reflect.declaration.CtElement element) {
			super.enter(element);
			if (!resource.getContents().contains(element) && element instanceof CtClass)
				//resource.
