 ...
 * </copyright>
 *
 * $Id: DeclarationSwitch.java,v 1.1 2007-04-05 12:52:10 barais Exp $
 */
package emf.spoon.reflect.declaration.util;

import emf.spoon.reflect.declaration.*;
...
public class DeclarationSwitch {
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case DeclarationPackage.CT_ANNOTATION_ELEMENT_VALUE: {
				CtAnnotationElementValue ctAnnotationElementValue = (CtAnnotationElementValue)theEObject;
				Object result = caseCtAnnotationElementValue(ctAnnotationElementValue);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpretting the object as an instance of '<em>Ct Annotation Element Value</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpretting the object as an instance of '<em>Ct Annotation Element Value</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public Object caseCtAnnotationElementValue(CtAnnotationElementValue object) {
		return null;
	}
