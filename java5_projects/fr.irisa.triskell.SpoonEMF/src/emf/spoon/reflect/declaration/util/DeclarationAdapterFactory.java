 ...
 * </copyright>
 *
 * $Id: DeclarationAdapterFactory.java,v 1.1 2007-04-05 12:52:10 barais Exp $
 */
...
public class DeclarationAdapterFactory extends AdapterFactoryImpl {
	...
	protected DeclarationSwitch modelSwitch =
		new DeclarationSwitch() {
			...
			public Object caseCtAnnotationElementValue(CtAnnotationElementValue object) {
				return createCtAnnotationElementValueAdapter();
			} 
	...
	/**
	 * Creates a new adapter for an object of class '{@link emf.spoon.reflect.declaration.CtAnnotationElementValue <em>Ct Annotation Element Value</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
