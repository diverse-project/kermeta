 ...
 * </copyright>
 *
 * $Id: CtPackageImpl.java,v 1.1 2007-04-05 12:52:09 barais Exp $
 */
...
public abstract class CtPackageImpl extends CtNamedElementImpl implements CtPackage {
	...
	/**
	 * The cached value of the '{@link #getDeclaringPackage() <em>Declaring Package</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getDeclaringPackage()
	 * @generated
	 * @ordered
	 */
	protected CtPackage declaringPackage = null;
	...
	public NotificationChain basicSetDeclaringPackage(CtPackage newDeclaringPackage, NotificationChain msgs) {
		CtPackage oldDeclaringPackage = declaringPackage;
		declaringPackage = newDeclaringPackage;
		if (eNotificationRequired()) {
		...
		switch (featureID) {
			...
			case DeclarationPackage.CT_PACKAGE__DECLARING_PACKAGE:
				if (declaringPackage != null)
					msgs = ((InternalEObject)declaringPackage).eInverseRemove(this, DeclarationPackage.CT_PACKAGE__PACKAGES, CtPackage.class, msgs);
