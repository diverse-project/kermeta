 ...
 * </copyright>
 *
 * $Id: DeclarationPackageImpl.java,v 1.1 2007-04-05 12:52:09 barais Exp $
 */
...
public class DeclarationPackageImpl extends EPackageImpl implements DeclarationPackage {
	...
	public EAttribute getCtElement_DocComment() {
		return (EAttribute)ctElementEClass.getEStructuralFeatures().get(1);
	}
	...
	public EReference getCtElement_Parent() {
		return (EReference)ctElementEClass.getEStructuralFeatures().get(2);
	}
