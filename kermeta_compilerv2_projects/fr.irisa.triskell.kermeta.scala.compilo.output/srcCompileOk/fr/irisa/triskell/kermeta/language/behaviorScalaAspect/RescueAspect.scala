...
trait RescueAspect extends fr.irisa.triskell.kermeta.language.structureScalaAspect.ObjectAspect with fr.irisa.triskell.kermeta.language.structureScalaAspect.aspect.ObjectAspect with fr.irisa.triskell.scala.generated.fw.ImplicitConversion with fr.irisa.triskell.kermeta.language.behavior.Rescue{
...
def ScalaexceptionName : java.lang.String={this.getExceptionName()}
def ScalaexceptionName_=(arg : java.lang.String)={this.setExceptionName(arg)}
