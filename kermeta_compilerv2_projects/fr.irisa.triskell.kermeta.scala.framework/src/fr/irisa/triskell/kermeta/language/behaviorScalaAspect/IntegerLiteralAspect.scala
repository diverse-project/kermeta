...
trait IntegerLiteralAspect extends fr.irisa.triskell.kermeta.language.behaviorScalaAspect.LiteralAspect with fr.irisa.triskell.kermeta.scala.framework.language.structure.ObjectAspect with fr.irisa.triskell.scala.generated.fw.ImplicitConversion with fr.irisa.triskell.kermeta.language.behavior.IntegerLiteral{
