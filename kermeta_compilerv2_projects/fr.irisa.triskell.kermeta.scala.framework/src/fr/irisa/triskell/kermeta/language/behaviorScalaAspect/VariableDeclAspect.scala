...
trait VariableDeclAspect extends fr.irisa.triskell.kermeta.language.behaviorScalaAspect.ExpressionAspect with fr.irisa.triskell.kermeta.scala.framework.language.structure.ObjectAspect with fr.irisa.triskell.scala.generated.fw.ImplicitConversion with fr.irisa.triskell.kermeta.language.behavior.VariableDecl{
...
def Scalaidentifier : java.lang.Object={this.getIdentifier()}
def Scalaidentifier_=(arg : java.lang.Object)={this.setIdentifier(arg)}
}
