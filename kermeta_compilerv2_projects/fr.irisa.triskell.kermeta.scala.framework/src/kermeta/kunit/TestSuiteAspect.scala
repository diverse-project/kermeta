...
var tests :  java.util.List[kermeta.kunit.Test]= _
...
this.getTests().addAll(arg)
   ...
   def addAllTestCasesFrom(testCaseClass : fr.irisa.triskell.kermeta.language.structure.Class):kermeta.kunit.TestSuite = {
var result : kermeta.kunit.TestSuite = null.asInstanceOf[kermeta.kunit.TestSuite]; 
{


testCaseClass.getOwnedOperation.select({o=>{
...
t.run()
 ...
 return result
   ...
   def addAllTestCasesFromAspects(testCaseClass : fr.irisa.triskell.kermeta.language.structure.Class, anAspect : fr.irisa.triskell.kermeta.language.structure.ClassDefinition):Void = {
