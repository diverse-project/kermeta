 ...
 * </copyright>
 *
 * $Id: StringLiteralImpl.java,v 1.1 2006-05-04 15:40:07 jmottu Exp $
 */
...
public class StringLiteralImpl extends LiteralImpl implements StringLiteral {
	...
	protected EClass eStaticClass() {
		return BehaviorPackage.eINSTANCE.getStringLiteral();
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				case BehaviorPackage.STRING_LITERAL__TAG:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case BehaviorPackage.STRING_LITERAL__CONTAINED_TYPE:
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case BehaviorPackage.STRING_LITERAL__STATIC_TYPE:
