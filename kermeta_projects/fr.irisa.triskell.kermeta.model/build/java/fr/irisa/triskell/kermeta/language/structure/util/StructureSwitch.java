 ...
 * </copyright>
 *
 * $Id: StructureSwitch.java,v 1.9 2007-07-11 14:41:56 cfaucher Exp $
 */
...
public class StructureSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case StructurePackage.VIRTUAL_TYPE_CONTAINER: {
				...
				T result = caseVirtualTypeContainer(virtualTypeContainer);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseClass(fr.irisa.triskell.kermeta.language.structure.Class object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseObject(fr.irisa.triskell.kermeta.language.structure.Object object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T casePackage(fr.irisa.triskell.kermeta.language.structure.Package object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Virtual Type Container</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Virtual Type Container</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseVirtualTypeContainer(VirtualTypeContainer object) {
		return null;
	}
