 ...
 * </copyright>
 *
 * $Id: CallValueImpl.java,v 1.1 2006-05-04 15:40:07 jmottu Exp $
 */
...
public class CallValueImpl extends CallExpressionImpl implements CallValue {
	...
	protected EClass eStaticClass() {
		return BehaviorPackage.eINSTANCE.getCallValue();
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				case BehaviorPackage.CALL_VALUE__TAG:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case BehaviorPackage.CALL_VALUE__CONTAINED_TYPE:
					return ((InternalEList)getContainedType()).basicRemove(otherEnd, msgs);
				case BehaviorPackage.CALL_VALUE__PARAMETERS:
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case BehaviorPackage.CALL_VALUE__STATIC_TYPE:
				if (resolve) return getStaticType();
				return basicGetStaticType();
			case BehaviorPackage.CALL_VALUE__PARAMETERS:
				return getParameters();
			case BehaviorPackage.CALL_VALUE__NAME:
				return getName();
			case BehaviorPackage.CALL_VALUE__STATIC_TYPE_VARIABLE_BINDINGS:
