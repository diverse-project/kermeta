/* $Id: KM2Ecore.java,v 1.1 2007-10-17 08:56:19 cfaucher Exp $
...
public class KM2Ecore {
	...
	public Object exportPackage(Package root_package) {
		root_pname = NamedElementHelper.getMangledQualifiedName(root_package, NamedElementHelper.simplePointSeparator);
	...
	public boolean isPrimitiveEcoreType(Type type){
		...
		if(type instanceof fr.irisa.triskell.kermeta.language.structure.Class){
			...
			type_def_name = NamedElementHelper.getMangledQualifiedName(fClass.getTypeDefinition(), NamedElementHelper.simplePointSeparator);
