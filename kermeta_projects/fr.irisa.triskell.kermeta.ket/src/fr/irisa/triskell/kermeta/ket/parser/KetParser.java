 ...
 *
 */
public class KetParser implements JETParseEventListener2, IJETParser
{
  ...
  private static final String JET__DIRECTIVE = "ket"; //$NON-NLS-1$
  /**
  ...
  public KetParser(ITemplateResolver templateResolver, ITagLibraryResolver tagLibraryResolver, Map predefinedLibraryMap)
  {
  ...
  private JETParser configureParser(JETReader reader)
  {
    ...
    directive.getDirectives().add("ket"); //$NON-NLS-1$
