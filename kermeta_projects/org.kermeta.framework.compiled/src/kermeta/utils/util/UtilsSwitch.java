 ...
 *
 * $Id: UtilsSwitch.java,v 1.1 2008-06-24 14:23:29 cfaucher Exp $
 */
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      case UtilsPackage.STRING_BUFFER:
      {
        ...
        if (result == null) result = caseObject(stringBuffer);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case UtilsPackage.HASHTABLE:
      {
        @SuppressWarnings("unchecked") Hashtable<?, ?> hashtable = (Hashtable<?, ?>)theEObject;
        T result = caseHashtable(hashtable);
        if (result == null) result = caseObject(hashtable);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case UtilsPackage.STACK:
      {
        @SuppressWarnings("unchecked") Stack<?> stack = (Stack<?>)theEObject;
        T result = caseStack(stack);
        if (result == null) result = caseSequence(stack);
        if (result == null) result = caseBag(stack);
        if (result == null) result = caseOrderedCollection(stack);
        if (result == null) result = caseCollection(stack);
        if (result == null) result = caseObject(stack);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
