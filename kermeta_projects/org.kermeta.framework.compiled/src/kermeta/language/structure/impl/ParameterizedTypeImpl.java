 ...
 *
 * $Id: ParameterizedTypeImpl.java,v 1.1 2008-06-24 14:23:40 cfaucher Exp $
 */
...
public abstract class ParameterizedTypeImpl extends TypeImpl implements ParameterizedType
{
  ...
  public EList<TypeVariableBinding> getTypeParamBinding()
  {
    ...
    {
      typeParamBinding = new EObjectContainmentEList<TypeVariableBinding>(TypeVariableBinding.class, this, StructurePackage.PARAMETERIZED_TYPE__TYPE_PARAM_BINDING);
    }
  ...
  public EList<TypeVariableBinding> getVirtualTypeBinding()
  {
    ...
    {
      virtualTypeBinding = new EObjectContainmentEList<TypeVariableBinding>(TypeVariableBinding.class, this, StructurePackage.PARAMETERIZED_TYPE__VIRTUAL_TYPE_BINDING);
    }
