 ...
 *
 * $Id: ModelingUnitImpl.java,v 1.1 2008-06-24 14:23:40 cfaucher Exp $
 */
...
public class ModelingUnitImpl extends ObjectImpl implements ModelingUnit
{
  ...
  public EList<Using> getUsings()
  {
    if (usings == null)
    {
      usings = new EObjectContainmentEList<Using>(Using.class, this, StructurePackage.MODELING_UNIT__USINGS);
    }
    return usings;
  }
  ...
  public EList<kermeta.language.structure.Package> getPackages()
  {
    if (packages == null)
    {
      packages = new EObjectContainmentEList<kermeta.language.structure.Package>(kermeta.language.structure.Package.class, this, StructurePackage.MODELING_UNIT__PACKAGES);
    }
    return packages;
  }
  ...
  public EList<Filter> getIncludeFilters()
  {
    ...
    {
      includeFilters = new EObjectContainmentEList<Filter>(Filter.class, this, StructurePackage.MODELING_UNIT__INCLUDE_FILTERS);
    }
  ...
  public EList<Filter> getExcludeFilters()
  {
    ...
    {
      excludeFilters = new EObjectContainmentEList<Filter>(Filter.class, this, StructurePackage.MODELING_UNIT__EXCLUDE_FILTERS);
    }
