 ...
 *
 * $Id: TagImpl.java,v 1.1 2008-06-24 14:23:40 cfaucher Exp $
 */
...
public class TagImpl extends ObjectImpl implements Tag
{
  ...
  public EList<kermeta.language.structure.Object> getObject()
  {
    if (object == null)
    {
      object = new EObjectWithInverseResolvingEList.ManyInverse<kermeta.language.structure.Object>(kermeta.language.structure.Object.class, this, StructurePackage.TAG__OBJECT, StructurePackage.OBJECT__TAG);
    }
    return object;
  }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case StructurePackage.TAG__OBJECT:
        getObject().clear();
        getObject().addAll((Collection<? extends kermeta.language.structure.Object>)newValue);
        return;
    }
