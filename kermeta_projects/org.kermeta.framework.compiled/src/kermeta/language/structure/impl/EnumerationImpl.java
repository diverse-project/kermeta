 ...
 *
 * $Id: EnumerationImpl.java,v 1.1 2008-06-24 14:23:40 cfaucher Exp $
 */
...
public class EnumerationImpl extends DataTypeImpl implements Enumeration
{
  ...
  public EList<EnumerationLiteral> getOwnedLiteral()
  {
    ...
    {
      ownedLiteral = new EObjectContainmentWithInverseEList<EnumerationLiteral>(EnumerationLiteral.class, this, StructurePackage.ENUMERATION__OWNED_LITERAL, StructurePackage.ENUMERATION_LITERAL__ENUMERATION);
    }
    return ownedLiteral;
  }
