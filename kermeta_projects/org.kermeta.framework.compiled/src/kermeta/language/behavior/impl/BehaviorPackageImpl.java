 ...
 * </copyright>
 *
 * $Id: BehaviorPackageImpl.java,v 1.2 2008-08-19 13:22:59 cfaucher Exp $
 */
...
public class BehaviorPackageImpl extends EPackageImpl implements
	...
	public void initializePackageContents() {
		...
		initEAttribute(getCallVariable_IsAtpre(), theStandardPackage
				.getJavaBoolean(), "isAtpre", null, 0, 1, CallVariable.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
				!IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getCallFeature_IsAtpre(), theStandardPackage
				.getJavaBoolean(), "isAtpre", null, 0, 1, CallFeature.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
				!IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getAssignment_IsCast(), theStandardPackage
				.getJavaBoolean(), "isCast", null, 0, 1, Assignment.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
				!IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getBooleanLiteral_Value(), theStandardPackage
				.getJavaBoolean(), "value", null, 0, 1, BooleanLiteral.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
				!IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
