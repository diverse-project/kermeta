 ...
 *
 * $Id: BehaviorPackage.java,v 1.1 2008-06-24 14:23:30 cfaucher Exp $
 */
...
public interface BehaviorPackage extends EPackage
{
   ...
   * @generated
   */
  BehaviorPackage eINSTANCE = kermeta.language.behavior.impl.BehaviorPackageImpl.init();
  ...
  /**
   * Returns the meta object for the attribute '{@link kermeta.language.behavior.CallVariable#isIsAtpre <em>Is Atpre</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Is Atpre</em>'.
   * @see kermeta.language.behavior.CallVariable#isIsAtpre()
   * @see #getCallVariable()
   * @generated
   */
  ...
  /**
   * Returns the meta object for the attribute '{@link kermeta.language.behavior.CallFeature#isIsAtpre <em>Is Atpre</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Is Atpre</em>'.
   * @see kermeta.language.behavior.CallFeature#isIsAtpre()
   * @see #getCallFeature()
   * @generated
   */
  ...
  /**
   * Returns the meta object for the attribute '{@link kermeta.language.behavior.Assignment#isIsCast <em>Is Cast</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Is Cast</em>'.
   * @see kermeta.language.behavior.Assignment#isIsCast()
   * @see #getAssignment()
   * @generated
   */
  ...
  /**
   * Returns the meta object for the attribute '{@link kermeta.language.behavior.BooleanLiteral#isValue <em>Value</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Value</em>'.
   * @see kermeta.language.behavior.BooleanLiteral#isValue()
