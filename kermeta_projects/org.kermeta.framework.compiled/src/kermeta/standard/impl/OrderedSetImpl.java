 ...
 * </copyright>
 *
 * $Id: OrderedSetImpl.java,v 1.2 2008-08-19 13:23:03 cfaucher Exp $
 */
...
public class OrderedSetImpl<G> extends SetImpl<G> implements OrderedSet<G> {
	...
	public void addAt(Integer index, G element) {
		...
		idIfCond_217 = kermeta.standard.helper.BooleanWrapper.not(this
				.contains(element));
	...
	public G at(Integer index) {
		...
		idIfCond_218 = kermeta.standard.helper.BooleanWrapper.and(
	...
	public OrderedSet<G> subSet(Integer min, Integer max) {
		...
		if (idIfCond_220) {
			...
			while (!idLoopCond_221) {
				idLoopCond_221 = kermeta.standard.helper.IntegerWrapper.equals(
						i, min);
				;
				if (idLoopCond_221) {
				} else {
			...
			while (!idLoopCond_222) {
				idLoopCond_222 = kermeta.standard.helper.IntegerWrapper.equals(
