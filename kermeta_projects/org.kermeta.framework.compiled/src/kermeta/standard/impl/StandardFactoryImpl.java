 ...
 * </copyright>
 *
 * $Id: StandardFactoryImpl.java,v 1.2 2008-08-19 13:23:03 cfaucher Exp $
 */
...
public class StandardFactoryImpl extends EFactoryImpl implements
	...
	public static StandardFactory init() {
		try {
			StandardFactory theStandardFactory = (StandardFactory) EPackage.Registry.INSTANCE
					.getEFactory("http://www.kermeta.org/kermeta/standard/kermeta_temp_uri");
	 ...
	 * @generated
	 */
	public ArrayList<?> createKermetaProperty_Collection_valuesFromString(
