 ...
 * </copyright>
 *
 * $Id: StandardPackageImpl.java,v 1.2 2008-08-19 13:23:03 cfaucher Exp $
 */
...
public class StandardPackageImpl extends EPackageImpl implements
	...
	public void initializePackageContents() {
		...
		initEDataType(unlimitedNaturalEDataType, Object.class,
				...
				!IS_GENERATED_INSTANCE_CLASS);
		initEDataType(kermetaProperty_Collection_valuesEDataType,
				ArrayList.class, "KermetaProperty_Collection_values",
				IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
	...
	protected void createKermetaAnnotations() {
		...
		addAnnotation(this, source, new String[] { "ecoreUri",
				"http://www.kermeta.org/kermeta/standard" });
		addAnnotation(
				this,
				source,
				new String[] {
		...
		addAnnotation(
				...
				new String[] { "EMF_needProperty",
						"name=values isUnique=false isOrdered=false javaClass=java.util.ArrayList" });
		addAnnotation(
	...
	protected void createKermeta_1Annotations() {
		...
		addAnnotation(collectionEClass.getEOperations().get(0), source,
