...
public class BooleanWrapper {
	...
	java.lang.Boolean self
		...
		if (idIfCond_62) {
			...
			while (!idLoopCond_63) {
				idLoopCond_63 = it_ft13.isOff();
				;
				if (idLoopCond_63) {
				} else {

					//Beginning of the Inlining of the lambda expression: func
					kermeta.language.structure.Property subObj = it_ft13.next();

					java.lang.Boolean idIfCond_64 = false;
					idIfCond_64 = subObj.getIsComposite();
					...
					if (idIfCond_64) {
						...
						if (idIfCond_65) {
							...
							kermeta.standard.Iterator<kermeta.language.structure.Object> it_ft14 = subObjInstances
									.iterator();
							java.lang.Boolean idLoopCond_66 = false;
							while (!idLoopCond_66) {
								idLoopCond_66 = it_ft14.isOff();
								;
								if (idLoopCond_66) {
								} else {

									//Beginning of the Inlining of the lambda expression: func
									kermeta.language.structure.Object aSubObjInstances = it_ft14
											.next();
