 ...
 * </copyright>
 *
 * $Id: DynamicExpressionImpl.java,v 1.2 2008-08-19 13:23:00 cfaucher Exp $
 */
...
public class DynamicExpressionImpl extends ObjectImpl implements
	...
	public Boolean parse(String expression) {
		...
		idIfCond_231 = kermeta.standard.helper.BooleanWrapper.or(
		...
		if (idIfCond_232) {
			...
			kermeta.standard.Iterator<kermeta.interpreter.KermetaError> it_ft37 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil
					.<kermeta.interpreter.KermetaError> convertAsOrderedSet(
			...
			while (!idLoopCond_233) {
				...
				if (idLoopCond_233) {
					...
					kermeta.standard.helper.StringWrapper.append(
							e.getMessage(),
	...
	public kermeta.language.structure.Object evalString(String body,
		...
		idIfCond_234 = kermeta.standard.helper.BooleanWrapper.not(this
				.parse(body));
