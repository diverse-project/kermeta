 ...
 *
 * $Id: InterpreterPackageImpl.java,v 1.1 2008-06-24 14:23:31 cfaucher Exp $
 */
...
public class InterpreterPackageImpl extends EPackageImpl implements InterpreterPackage
{
  ...
  public static InterpreterPackage init()
  {
    ...
    InterpreterPackageImpl theInterpreterPackage = (InterpreterPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof InterpreterPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new InterpreterPackageImpl());
  ...
  {
    return (EReference)dynamicExpressionEClass.getEStructuralFeatures().get(0);
  }
  ...
  {
    return (EReference)dynamicExpressionEClass.getEStructuralFeatures().get(1);
  }
  ...
  {
    return (EReference)dynamicExpressionEClass.getEStructuralFeatures().get(2);
  }
  ...
  {
    return (EReference)dynamicExpressionEClass.getEStructuralFeatures().get(3);
  }
  ...
  public void createPackageContents()
  {
    ...
    createEReference(dynamicExpressionEClass, DYNAMIC_EXPRESSION__EXPRESSION);
    createEReference(dynamicExpressionEClass, DYNAMIC_EXPRESSION__ERRORS);
    createEReference(dynamicExpressionEClass, DYNAMIC_EXPRESSION__FORMAL_PARAMETERS);
    createEReference(dynamicExpressionEClass, DYNAMIC_EXPRESSION__SELF_CLASS);
  ...
  public void initializePackageContents()
  {
    ...
    dynamicExpressionEClass.getESuperTypes().add(theStructurePackage.getObject());
    kermetaErrorEClass.getESuperTypes().add(theStructurePackage.getObject());
    ...
    initEClass(dynamicExpressionEClass, DynamicExpression.class, "DynamicExpression", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getDynamicExpression_Expression(), theBehaviorPackage.getExpression(), null, "expression", null, 0, 1, DynamicExpression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getDynamicExpression_Errors(), this.getKermetaError(), null, "errors", null, 0, -1, DynamicExpression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    EGenericType g1 = createEGenericType(theUtilsPackage.getHashtable());
    EGenericType g2 = createEGenericType(theStandardPackage.getString());
    g1.getETypeArguments().add(g2);
    g2 = createEGenericType(theStructurePackage.getType());
    g1.getETypeArguments().add(g2);
    initEReference(getDynamicExpression_FormalParameters(), g1, null, "formalParameters", null, 0, 1, DynamicExpression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getDynamicExpression_SelfClass(), theStructurePackage.getClassDefinition(), null, "selfClass", null, 0, 1, DynamicExpression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    addEOperation(dynamicExpressionEClass, theStandardPackage.getVoid(), "initializeDefaults", 0, 1, IS_UNIQUE, !IS_ORDERED);

    EOperation op = addEOperation(dynamicExpressionEClass, theStructurePackage.getObject(), "execute", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, theStructurePackage.getObject(), "selfObj", 0, 1, IS_UNIQUE, IS_ORDERED);
    g1 = createEGenericType(theUtilsPackage.getHashtable());
    g2 = createEGenericType(theStandardPackage.getString());
    g1.getETypeArguments().add(g2);
    g2 = createEGenericType(theStructurePackage.getObject());
    g1.getETypeArguments().add(g2);
    addEParameter(op, g1, "actualParams", 0, 1, IS_UNIQUE, IS_ORDERED);

    op = addEOperation(dynamicExpressionEClass, theStandardPackage.getBoolean(), "parse", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, theStandardPackage.getString(), "expression", 0, 1, IS_UNIQUE, IS_ORDERED);

    op = addEOperation(dynamicExpressionEClass, theStructurePackage.getObject(), "evalString", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, theStandardPackage.getString(), "body", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, theStructurePackage.getObject(), "selfObj", 0, 1, IS_UNIQUE, IS_ORDERED);
    g1 = createEGenericType(theUtilsPackage.getHashtable());
    g2 = createEGenericType(theStandardPackage.getString());
    g1.getETypeArguments().add(g2);
    ...
    initEClass(kermetaErrorEClass, KermetaError.class, "KermetaError", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getKermetaError_Message(), theStandardPackage.getString(), "message", null, 0, 1, KermetaError.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(parseErrorEClass, ParseError.class, "ParseError", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
