 ...
 *
 * $Id: ErrorKind.java,v 1.1 2008-06-24 14:23:16 cfaucher Exp $
 */
...
public enum ErrorKind implements Enumerator
{
   ...
   * @generated
   */
  private static final ErrorKind[] VALUES_ARRAY =
    new ErrorKind[]
    {
      SET_UP_ERROR,
      TEST_ERROR,
   ...
   * @generated
   */
  public static final List<ErrorKind> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
  ...
  public static ErrorKind get(int value)
  {
    switch (value)
    {
      case SET_UP_ERROR_VALUE: return SET_UP_ERROR;
      case TEST_ERROR_VALUE: return TEST_ERROR;
      case TEAR_DOWN_ERROR_VALUE: return TEAR_DOWN_ERROR;
    }
    return null;
  }
