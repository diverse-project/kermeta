 ...
 *
 * $Id: KunitSwitch.java,v 1.1 2008-06-24 14:23:45 cfaucher Exp $
 */
...
public class KunitSwitch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      case KunitPackage.INVALID_TEST_CASE_NAME_EXCEPTION:
      {
        ...
        if (result == null) result = caseException(invalidTestCaseNameException);
        if (result == null) result = caseObject(invalidTestCaseNameException);
      ...
      case KunitPackage.INVALID_PARAMETER_EXCEPTION:
      {
        ...
        if (result == null) result = caseException(invalidParameterException);
        if (result == null) result = caseObject(invalidParameterException);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case KunitPackage.FALLIBLE:
      {
        ...
        if (result == null) result = caseAbstractFallible(fallible);
        if (result == null) result = caseObject(fallible);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case KunitPackage.LOG:
      {
        ...
        if (result == null) result = caseObject(log);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case KunitPackage.FAILURE:
      {
        ...
        if (result == null) result = caseObject(failure);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case KunitPackage.ERROR:
      {
        ...
        if (result == null) result = caseObject(error);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case KunitPackage.TEST:
      {
        ...
        if (result == null) result = caseObject(test);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case KunitPackage.TEST_SUITE:
      {
        ...
        if (result == null) result = caseObject(testSuite);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case KunitPackage.TEST_CASE:
      {
        ...
        if (result == null) result = caseFallible(testCase);
        if (result == null) result = caseObject(testCase);
        if (result == null) result = caseAbstractFallible(testCase);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case KunitPackage.TEST_RUNNER:
      {
        ...
        if (result == null) result = caseObject(testRunner);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case KunitPackage.ABSTRACT_FALLIBLE:
      {
        ...
        if (result == null) result = caseObject(abstractFallible);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case KunitPackage.ASSERTION_FAILED_ERROR:
      {
        ...
        if (result == null) result = caseException(assertionFailedError);
        if (result == null) result = caseObject(assertionFailedError);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case KunitPackage.ASSERT:
      {
        ...
        if (result == null) result = caseAbstractFallible(assert_);
        if (result == null) result = caseObject(assert_);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
   ...
   * @generated
   */
  public T caseInvalidTestCaseNameException(InvalidTestCaseNameException object)
  {
    return null;
  }
