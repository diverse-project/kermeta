 ...
 *
 * $Id: KunitPackageImpl.java,v 1.1 2008-06-24 14:23:35 cfaucher Exp $
 */
...
public class KunitPackageImpl extends EPackageImpl implements KunitPackage
{
  ...
  {
    if (isInited) return (KunitPackage)EPackage.Registry.INSTANCE.getEPackage(KunitPackage.eNS_URI);

    // Obtain or create and register package
    KunitPackageImpl theKunitPackage = (KunitPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof KunitPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new KunitPackageImpl());
  ...
  public void initializePackageContents()
  {
    ...
    invalidTestCaseNameExceptionEClass.getESuperTypes().add(theExceptionsPackage.getException());
    invalidParameterExceptionEClass.getESuperTypes().add(theExceptionsPackage.getException());
    ...
    abstractFallibleEClass.getESuperTypes().add(theStructurePackage.getObject());
    assertionFailedErrorEClass.getESuperTypes().add(theExceptionsPackage.getException());
    assertEClass.getESuperTypes().add(this.getAbstractFallible());

    // Initialize classes and features; add operations and parameters
    initEClass(invalidTestCaseNameExceptionEClass, InvalidTestCaseNameException.class, "InvalidTestCaseNameException", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    ...
    initEAttribute(getFallible_StopOnFailure(), theStandardPackage.getBoolean(), "stopOnFailure", null, 0, 1, Fallible.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getFallible_Rank(), theStandardPackage.getInteger(), "rank", null, 0, 1, Fallible.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    EOperation op = addEOperation(fallibleEClass, null, "assertTrue", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, theStandardPackage.getBoolean(), "condition", 0, 1, IS_UNIQUE, IS_ORDERED);

    addEOperation(fallibleEClass, this.getLog(), "getLog", 0, 1, IS_UNIQUE, IS_ORDERED);

    op = addEOperation(fallibleEClass, null, "assertFalseWithMsg", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, theStandardPackage.getBoolean(), "condition", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, theStandardPackage.getString(), "message", 0, 1, IS_UNIQUE, IS_ORDERED);

    op = addEOperation(fallibleEClass, null, "fail", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, theStandardPackage.getString(), "msg", 0, 1, IS_UNIQUE, IS_ORDERED);

    op = addEOperation(fallibleEClass, null, "assertEqual", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, theStandardPackage.getString(), "expected", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, theStandardPackage.getString(), "actual", 0, 1, IS_UNIQUE, IS_ORDERED);

    op = addEOperation(fallibleEClass, null, "assertFalse", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, theStandardPackage.getBoolean(), "condition", 0, 1, IS_UNIQUE, IS_ORDERED);

    op = addEOperation(fallibleEClass, null, "assertTrueWithMsg", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, theStandardPackage.getBoolean(), "condition", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, theStandardPackage.getString(), "message", 0, 1, IS_UNIQUE, IS_ORDERED);

    op = addEOperation(fallibleEClass, null, "_assert", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, theStandardPackage.getBoolean(), "condition", 0, 1, IS_UNIQUE, IS_ORDERED);

    addEOperation(fallibleEClass, theStandardPackage.getInteger(), "number", 0, 1, IS_UNIQUE, IS_ORDERED);

    op = addEOperation(fallibleEClass, null, "assertWithMsg", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, theStandardPackage.getBoolean(), "condition", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, theStandardPackage.getString(), "msg", 0, 1, IS_UNIQUE, IS_ORDERED);

    addEOperation(fallibleEClass, theStandardPackage.getBoolean(), "mustStop", 0, 1, IS_UNIQUE, IS_ORDERED);

    initEClass(logEClass, Log.class, "Log", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getLog_Failures(), this.getFailure(), null, "failures", null, 0, -1, Log.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getLog_Runtests(), theStandardPackage.getInteger(), "runtests", null, 0, 1, Log.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getLog_HarnessErrors(), this.getError(), null, "harnessErrors", null, 0, -1, Log.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    op = addEOperation(logEClass, null, "addSetUpError", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, this.getFallible(), "test", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, theExceptionsPackage.getException(), "e", 0, 1, IS_UNIQUE, IS_ORDERED);

    op = addEOperation(logEClass, null, "addTestError", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, this.getFallible(), "test", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, theExceptionsPackage.getException(), "e", 0, 1, IS_UNIQUE, IS_ORDERED);

    op = addEOperation(logEClass, null, "addFailure", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, this.getFallible(), "test", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, theStandardPackage.getString(), "msg", 0, 1, IS_UNIQUE, IS_ORDERED);

    op = addEOperation(logEClass, null, "addTearDownError", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, this.getFallible(), "test", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, theExceptionsPackage.getException(), "e", 0, 1, IS_UNIQUE, IS_ORDERED);

    addEOperation(logEClass, null, "newAttempt", 0, 1, IS_UNIQUE, IS_ORDERED);

    initEClass(failureEClass, Failure.class, "Failure", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getFailure_Message(), theStandardPackage.getString(), "message", null, 0, 1, Failure.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getFailure_Failure(), this.getFallible(), null, "failure", null, 0, 1, Failure.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    addEOperation(failureEClass, theStandardPackage.getString(), "toString", 0, 1, IS_UNIQUE, IS_ORDERED);

    op = addEOperation(failureEClass, this.getFailure(), "initFrom", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, this.getFallible(), "fallible", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, theStandardPackage.getString(), "msg", 0, 1, IS_UNIQUE, IS_ORDERED);

    initEClass(errorEClass, kermeta.kunit.Error.class, "Error", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getError_Error(), this.getFallible(), null, "error", null, 0, 1, kermeta.kunit.Error.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getError_Exception(), theExceptionsPackage.getException(), null, "exception", null, 0, 1, kermeta.kunit.Error.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getError_Kind(), this.getErrorKind(), "kind", null, 0, 1, kermeta.kunit.Error.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    addEOperation(errorEClass, this.getError(), "makeTearDown", 0, 1, IS_UNIQUE, IS_ORDERED);

    addEOperation(errorEClass, this.getError(), "makeSetUp", 0, 1, IS_UNIQUE, IS_ORDERED);

    addEOperation(errorEClass, theStandardPackage.getString(), "toString", 0, 1, IS_UNIQUE, IS_ORDERED);

    op = addEOperation(errorEClass, this.getError(), "initFrom", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, this.getFallible(), "error", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, theExceptionsPackage.getException(), "e", 0, 1, IS_UNIQUE, IS_ORDERED);

    initEClass(testEClass, Test.class, "Test", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getTest_Log(), this.getLog(), null, "log", null, 0, 1, Test.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    op = addEOperation(testEClass, null, "setLog", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, this.getLog(), "log", 0, 1, IS_UNIQUE, IS_ORDERED);

    addEOperation(testEClass, null, "run", 0, 1, IS_UNIQUE, IS_ORDERED);

    addEOperation(testEClass, this.getLog(), "initLog", 0, 1, IS_UNIQUE, IS_ORDERED);
    ...
    op = addEOperation(testSuiteEClass, this.getTestSuite(), "addAllTestCasesFrom", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, theStructurePackage.getClass_(), "testCaseClass", 0, 1, IS_UNIQUE, IS_ORDERED);

    addEOperation(testSuiteEClass, theStandardPackage.getVoid(), "run", 0, 1, IS_UNIQUE, !IS_ORDERED);

    op = addEOperation(testSuiteEClass, null, "addAllTestCasesFromAspects", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, theStructurePackage.getClass_(), "testCaseClass", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, theStructurePackage.getClassDefinition(), "anAspect", 0, 1, IS_UNIQUE, IS_ORDERED);

    initEClass(testCaseEClass, TestCase.class, "TestCase", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getTestCase___testMethodName(), theStandardPackage.getString(), "__testMethodName", null, 0, 1, TestCase.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    addEOperation(testCaseEClass, null, "setUp", 0, 1, IS_UNIQUE, IS_ORDERED);

    addEOperation(testCaseEClass, null, "raiseIfHasFailures", 0, 1, IS_UNIQUE, IS_ORDERED);

    addEOperation(testCaseEClass, this.getLog(), "getLog", 0, 1, IS_UNIQUE, IS_ORDERED);

    op = addEOperation(testCaseEClass, this.getTestCase(), "setTestMethodName", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, theStandardPackage.getString(), "name", 0, 1, IS_UNIQUE, IS_ORDERED);

    addEOperation(testCaseEClass, theStandardPackage.getString(), "getTestMethodName", 0, 1, IS_UNIQUE, IS_ORDERED);

    addEOperation(testCaseEClass, theStandardPackage.getString(), "toString", 0, 1, IS_UNIQUE, IS_ORDERED);

    addEOperation(testCaseEClass, theStandardPackage.getVoid(), "run", 0, 1, IS_UNIQUE, !IS_ORDERED);

    addEOperation(testCaseEClass, null, "tearDown", 0, 1, IS_UNIQUE, IS_ORDERED);

    initEClass(testRunnerEClass, TestRunner.class, "TestRunner", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getTestRunner_Log(), this.getLog(), null, "log", null, 0, 1, TestRunner.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    op = addEOperation(testRunnerEClass, null, "runTest", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, this.getTest(), "test", 0, 1, IS_UNIQUE, IS_ORDERED);

    addEOperation(testRunnerEClass, theStandardPackage.getVoid(), "printTestResult", 0, 1, IS_UNIQUE, !IS_ORDERED);

    op = addEOperation(testRunnerEClass, null, "run", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, theStructurePackage.getClass_(), "testCaseClass", 0, 1, IS_UNIQUE, IS_ORDERED);

    initEClass(abstractFallibleEClass, AbstractFallible.class, "AbstractFallible", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    op = addEOperation(abstractFallibleEClass, null, "assertTrue", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, theStandardPackage.getBoolean(), "condition", 0, 1, IS_UNIQUE, IS_ORDERED);

    op = addEOperation(abstractFallibleEClass, theStandardPackage.getString(), "distil", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, theStandardPackage.getString(), "s", 0, 1, IS_UNIQUE, IS_ORDERED);

    op = addEOperation(abstractFallibleEClass, null, "assertFalseWithMsg", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, theStandardPackage.getBoolean(), "condition", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, theStandardPackage.getString(), "message", 0, 1, IS_UNIQUE, IS_ORDERED);

    op = addEOperation(abstractFallibleEClass, null, "fail", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, theStandardPackage.getString(), "msg", 0, 1, IS_UNIQUE, IS_ORDERED);

    op = addEOperation(abstractFallibleEClass, null, "assertEqual", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, theStandardPackage.getString(), "expected", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, theStandardPackage.getString(), "actual", 0, 1, IS_UNIQUE, IS_ORDERED);

    op = addEOperation(abstractFallibleEClass, null, "assertFalse", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, theStandardPackage.getBoolean(), "condition", 0, 1, IS_UNIQUE, IS_ORDERED);

    op = addEOperation(abstractFallibleEClass, null, "assertTrueWithMsg", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, theStandardPackage.getBoolean(), "condition", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, theStandardPackage.getString(), "message", 0, 1, IS_UNIQUE, IS_ORDERED);

    op = addEOperation(abstractFallibleEClass, null, "_assert", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, theStandardPackage.getBoolean(), "condition", 0, 1, IS_UNIQUE, IS_ORDERED);

    op = addEOperation(abstractFallibleEClass, null, "assertSimilar", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, theStandardPackage.getString(), "expected", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, theStandardPackage.getString(), "actual", 0, 1, IS_UNIQUE, IS_ORDERED);

    op = addEOperation(abstractFallibleEClass, null, "assertWithMsg", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, theStandardPackage.getBoolean(), "condition", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, theStandardPackage.getString(), "msg", 0, 1, IS_UNIQUE, IS_ORDERED);

    initEClass(assertionFailedErrorEClass, AssertionFailedError.class, "AssertionFailedError", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(assertEClass, Assert.class, "Assert", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    op = addEOperation(assertEClass, null, "assertTrue", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, theStandardPackage.getBoolean(), "condition", 0, 1, IS_UNIQUE, IS_ORDERED);

    op = addEOperation(assertEClass, null, "assertFalseWithMsg", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, theStandardPackage.getBoolean(), "condition", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, theStandardPackage.getString(), "msg", 0, 1, IS_UNIQUE, IS_ORDERED);

    op = addEOperation(assertEClass, null, "fail", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, theStandardPackage.getString(), "msg", 0, 1, IS_UNIQUE, IS_ORDERED);

    op = addEOperation(assertEClass, null, "assertEqual", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, theStandardPackage.getString(), "expected", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, theStandardPackage.getString(), "actual", 0, 1, IS_UNIQUE, IS_ORDERED);

    op = addEOperation(assertEClass, null, "assertFalse", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, theStandardPackage.getBoolean(), "condition", 0, 1, IS_UNIQUE, IS_ORDERED);

    op = addEOperation(assertEClass, null, "assertTrueWithMsg", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, theStandardPackage.getBoolean(), "condition", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, theStandardPackage.getString(), "msg", 0, 1, IS_UNIQUE, IS_ORDERED);

    op = addEOperation(assertEClass, null, "_assert", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, theStandardPackage.getBoolean(), "condition", 0, 1, IS_UNIQUE, IS_ORDERED);

    op = addEOperation(assertEClass, null, "assertWithMsg", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, theStandardPackage.getBoolean(), "condition", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, theStandardPackage.getString(), "msg", 0, 1, IS_UNIQUE, IS_ORDERED);
  ...
  protected void createKermetaAnnotations()
  {
    ...
    addAnnotation
      (fallibleEClass.getEOperations().get(0), 
       ...
       new String[] 
       {
       "superOperation", "kermeta::kunit::AbstractFallible"
       });		
    addAnnotation
      (fallibleEClass.getEOperations().get(1), 
       source, 
       new String[] 
       {
       "isAbstract", "true"
    ...
    addAnnotation
      (logEClass.getEOperations().get(1), 
       source, 
       new String[] 
       {
    ...
    addAnnotation
      (logEClass.getEOperations().get(4), 
       source, 
       new String[] 
       {
    ...
    addAnnotation
      (failureEClass.getEOperations().get(1), 
       source, 
       new String[] 
       {
    ...
    addAnnotation
      (testEClass.getEOperations().get(2), 
       source, 
       new String[] 
       {
    ...
    addAnnotation
      (testSuiteEClass.getEOperations().get(1), 
       ...
       new String[] 
       {
       "superOperation", "kermeta::kunit::Test"
       });		
    addAnnotation
    ...
    addAnnotation
      (testCaseEClass.getEOperations().get(2), 
       source, 
       new String[] 
       {
       "documentation", "/**\r\n\t * accessor on the log\r\n\t */"
    ...
    addAnnotation
      (testCaseEClass.getEOperations().get(2), 
       ...
       new String[] 
       {
       "superOperation", "kermeta::kunit::Fallible"
       });		
    addAnnotation
    ...
    addAnnotation
      (testCaseEClass.getEOperations().get(4), 
       source, 
       new String[] 
       {
    ...
    addAnnotation
      (abstractFallibleEClass.getEOperations().get(0), 
       ...
       new String[] 
       {
       "documentation", "/** process the given condition and react if it is not satisfied */"
       });		
    addAnnotation
    ...
    addAnnotation
      (abstractFallibleEClass.getEOperations().get(3), 
       source, 
       new String[] 
       {
       "isAbstract", "true"
    ...
    addAnnotation
      (abstractFallibleEClass.getEOperations().get(3), 
       ...
       new String[] 
       {
       "documentation", "/** to be used if a failure reaction is needed */"
       });		
    addAnnotation
    ...
    addAnnotation
      (abstractFallibleEClass.getEOperations().get(4), 
       ...
       new String[] 
       {
       "documentation", "/** process the two given string and react if they are not equal */"
       });		
    addAnnotation
    ...
    addAnnotation
      (abstractFallibleEClass.getEOperations().get(5), 
       ...
       new String[] 
       {
       "documentation", "/** process the given condition and react if it is satisfied */"
       });		
    addAnnotation
    ...
    addAnnotation
      (assertionFailedErrorEClass, 
       ...
       new String[] 
       {
       "documentation", "/** AssertionViolatedException are raised when assertions are violated */"
       });		
    addAnnotation
      (assertEClass.getEOperations().get(0), 
       ...
       new String[] 
       {
       "documentation", "/** will fail if condition is false */"
       });		
    addAnnotation
      (assertEClass.getEOperations().get(0), 
       source, 
    ...
    addAnnotation
      (assertEClass.getEOperations().get(1), 
       source, 
       new String[] 
       {
       "documentation", "/** will fail if condition is true */"
       });		
    addAnnotation
      (assertEClass.getEOperations().get(1), 
       source, 
    ...
    addAnnotation
      (assertEClass.getEOperations().get(2), 
       ...
       new String[] 
       {
       "documentation", "/** raise a AssertionViolatedException with the provided message */"
       });		
    addAnnotation
      (assertEClass.getEOperations().get(2), 
       source, 
    ...
    addAnnotation
      (assertEClass.getEOperations().get(3), 
       ...
       new String[] 
       {
       "documentation", "/** Will fail if the two strings are not identical */"
       });		
    addAnnotation
      (assertEClass.getEOperations().get(3), 
       source, 
    ...
    addAnnotation
      (assertEClass.getEOperations().get(4), 
       source, 
       new String[] 
       {
       "documentation", "/** will fail if condition is true */"
    ...
    addAnnotation
      (assertEClass.getEOperations().get(5), 
       source, 
       new String[] 
       {
       "documentation", "/** will fail if condition is false */"
    ...
    addAnnotation
      (assertEClass.getEOperations().get(6), 
       source, 
       new String[] 
       {
       "documentation", "/** Fails if condition is false */"
       });		
    addAnnotation
      (assertEClass.getEOperations().get(6), 
       source, 
    ...
    addAnnotation
      (assertEClass.getEOperations().get(7), 
       source, 
       new String[] 
       {
       "documentation", "/** will fail if condition is false */"
