 ...
 *
 * $Id: LogImpl.java,v 1.1 2008-06-24 14:23:35 cfaucher Exp $
 */
...
public class LogImpl extends ObjectImpl implements Log
{
   ...
   * @ordered
   */
  protected static final int RUNTESTS_EDEFAULT = 0;
   ...
   * @ordered
   */
  protected int runtests = RUNTESTS_EDEFAULT;
  ...
  public EList<Failure> getFailures()
  {
    if (failures == null)
    {
      failures = new EObjectResolvingEList<Failure>(Failure.class, this, KunitPackage.LOG__FAILURES);
    }
    return failures;
  }
  ...
  public EList<kermeta.kunit.Error> getErrors()
  {
    if (errors == null)
    {
      errors = new EObjectResolvingEList<kermeta.kunit.Error>(kermeta.kunit.Error.class, this, KunitPackage.LOG__ERRORS);
    }
    return errors;
  }
   ...
   * @generated
   */
  public void setRuntests(int newRuntests)
  {
    int oldRuntests = runtests;
    runtests = newRuntests;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KunitPackage.LOG__RUNTESTS, oldRuntests, runtests));
  }
  ...
  public EList<kermeta.kunit.Error> getHarnessErrors()
  {
    ...
    {
      harnessErrors = new EObjectResolvingEList<kermeta.kunit.Error>(kermeta.kunit.Error.class, this, KunitPackage.LOG__HARNESS_ERRORS);
    }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case KunitPackage.LOG__RUNTESTS:
        return new Integer(getRuntests());
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case KunitPackage.LOG__ERRORS:
        getErrors().clear();
        getErrors().addAll((Collection<? extends kermeta.kunit.Error>)newValue);
        return;
      case KunitPackage.LOG__RUNTESTS:
        setRuntests(((Integer)newValue).intValue());
        return;
      case KunitPackage.LOG__HARNESS_ERRORS:
        getHarnessErrors().clear();
        getHarnessErrors().addAll((Collection<? extends kermeta.kunit.Error>)newValue);
        return;
    }
  ...
  public boolean eIsSet(int featureID)
  {
    switch (featureID)
    {
      ...
      case KunitPackage.LOG__RUNTESTS:
        return runtests != RUNTESTS_EDEFAULT;
      case KunitPackage.LOG__HARNESS_ERRORS:
