 ...
 * </copyright>
 *
 * $Id: TestCaseImpl.java,v 1.2 2008-08-19 13:23:02 cfaucher Exp $
 */
...
public abstract class TestCaseImpl extends TestImpl implements TestCase {
	 ...
	 * @ordered
	 */
	protected static final Boolean STOP_ON_FAILURE_EDEFAULT = null;
	...
	public void raiseIfHasFailures() {
		...
		if (idIfCond_43) {
			...
			kermeta.standard.Iterator<kermeta.kunit.Failure> it_ft7 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil
					.<kermeta.kunit.Failure> convertAsOrderedSet(
		...
		if (idIfCond_45) {
			...
			kermeta.standard.Iterator<kermeta.kunit.Error> it_ft8 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil
					.<kermeta.kunit.Error> convertAsOrderedSet(
	...
	public void _assert(Boolean condition) {
		...
		idIfCond_21 = kermeta.standard.helper.BooleanWrapper.not(condition);
	...
	public void assertWithMsg(Boolean condition, String msg) {
		...
		idIfCond_24 = kermeta.standard.helper.BooleanWrapper.not(condition);
