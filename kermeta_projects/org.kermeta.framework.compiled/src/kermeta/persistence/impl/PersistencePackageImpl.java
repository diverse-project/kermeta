 ...
 * </copyright>
 *
 * $Id: PersistencePackageImpl.java,v 1.2 2008-08-19 13:23:01 cfaucher Exp $
 */
...
public class PersistencePackageImpl extends EPackageImpl implements
	...
	public void createPackageContents() {
		...
		createEAttribute(emfRepositoryEClass,
				EMF_REPOSITORY__IGNORE_LOAD_ERRORS);
	}
	...
	public void initializePackageContents() {
		...
		initEReference(getResource_DependentResources(), this.getResource(),
				null, "dependentResources", null, 0, -1, Resource.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED,
				!IS_ORDERED);
		initEReference(getResource_Contents(), theStructurePackage.getObject(),
				null, "contents", null, 0, -1, Resource.class, !IS_TRANSIENT,
		...
		initEAttribute(getResource_IsReadOnly(), theStandardPackage
				.getJavaBoolean(), "isReadOnly", null, 0, 1, Resource.class,
		...
		addEOperation(resourceEClass, null, "loadWithoutChecking", 0, 1,
		...
		addEOperation(emfResourceEClass, null, "loadWithoutChecking", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		...
		initEAttribute(getEMFRepository_UseInterpreterInternalResources(),
				...
				"useInterpreterInternalResources", null, 0, 1,
				EMFRepository.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getEMFRepository_IgnoreLoadErrors(), theStandardPackage
				.getJavaBoolean(), "ignoreLoadErrors", null, 0, 1,
				EMFRepository.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
	...
	protected void createKermetaAnnotations() {
		...
		addAnnotation(this, source, new String[] { "ecoreUri",
				"http://www.kermeta.org/kermeta/persistence" });
		addAnnotation(
				this,
				source,
				new String[] {
		...
		addAnnotation(resourceEClass.getEOperations().get(1), source,
				new String[] { "isAbstract", "true" });
		addAnnotation(
		...
		addAnnotation(resourceEClass.getEOperations().get(4), source,
				new String[] { "isAbstract", "true" });
		addAnnotation(
		...
		addAnnotation(
				resourceEClass.getEOperations().get(6),
				source,
				new String[] {
						"documentation",
		...
		addAnnotation(getResource_DependentResources(), source, new String[] {
				"isReadOnly", "true" });
		addAnnotation(
		...
		addAnnotation(getResource_Contents(), source, new String[] {
				"isReadOnly", "true" });
		addAnnotation(
		...
		addAnnotation(
				getEMFRepository_IgnoreLoadErrors(),
				source,
				new String[] {
						"documentation",
