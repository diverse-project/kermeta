 ...
 *
 * $Id: ExceptionImpl.java,v 1.1 2008-06-24 14:23:33 cfaucher Exp $
 */
 ...
 * @generated
 */
public class ExceptionImpl extends ObjectImpl implements kermeta.exceptions.Exception
{
  /**
  ...
  public void setMessage(String newMessage)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ExceptionsPackage.EXCEPTION__MESSAGE, oldMessage, message));
  }
   ...
   * @generated
   */
  public NotificationChain basicSetNestedException(kermeta.exceptions.Exception newNestedException, NotificationChain msgs)
  {
    kermeta.exceptions.Exception oldNestedException = nestedException;
    nestedException = newNestedException;
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ExceptionsPackage.EXCEPTION__NESTED_EXCEPTION, oldNestedException, newNestedException);
   ...
   * @generated
   */
  public void setNestedException(kermeta.exceptions.Exception newNestedException)
  {
    if (newNestedException != nestedException)
    {
      NotificationChain msgs = null;
      if (nestedException != null)
        msgs = ((InternalEObject)nestedException).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ExceptionsPackage.EXCEPTION__NESTED_EXCEPTION, null, msgs);
      if (newNestedException != null)
        msgs = ((InternalEObject)newNestedException).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ExceptionsPackage.EXCEPTION__NESTED_EXCEPTION, null, msgs);
      msgs = basicSetNestedException(newNestedException, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ExceptionsPackage.EXCEPTION__NESTED_EXCEPTION, newNestedException, newNestedException));
  }
  ...
  public void setStackTrace(String newStackTrace)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ExceptionsPackage.EXCEPTION__STACK_TRACE, oldStackTrace, stackTrace));
  }
