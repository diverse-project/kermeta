 ...
 *
 * $Id: ExceptionsFactoryImpl.java,v 1.1 2008-06-24 14:23:32 cfaucher Exp $
 */
...
public class ExceptionsFactoryImpl extends EFactoryImpl implements ExceptionsFactory
{
  ...
  public static ExceptionsFactory init()
  {
    try
    {
      ExceptionsFactory theExceptionsFactory = (ExceptionsFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.kermeta.org/kermeta/exceptions"); 
