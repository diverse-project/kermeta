 ...
 *
 * $Id: ExceptionsAdapterFactory.java,v 1.1 2008-06-24 14:23:43 cfaucher Exp $
 */
...
public class ExceptionsAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected ExceptionsSwitch<Adapter> modelSwitch =
    new ExceptionsSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter caseNotImplementedException(NotImplementedException object)
      {
      ...
      @Override
      public Adapter caseAbstractClassInstantiationError(AbstractClassInstantiationError object)
      {
      ...
      @Override
      public Adapter caseResourceCreateException(ResourceCreateException object)
      {
        return createResourceCreateExceptionAdapter();
      }
      @Override
      public Adapter caseResourceUnconformityException(ResourceUnconformityException object)
      {
        return createResourceUnconformityExceptionAdapter();
      }
      @Override
      public Adapter caseDynamicExpressionException(DynamicExpressionException object)
      {
