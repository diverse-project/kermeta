 ...
 *
 * $Id: ExceptionsSwitch.java,v 1.1 2008-06-24 14:23:43 cfaucher Exp $
 */
...
public class ExceptionsSwitch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      case ExceptionsPackage.EXCEPTION:
      {
        ...
        if (result == null) result = caseObject(exception);
      ...
      case ExceptionsPackage.RUNTIME_ERROR:
      {
        ...
        if (result == null) result = caseException(runtimeError);
        if (result == null) result = caseObject(runtimeError);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ExceptionsPackage.CALL_ON_VOID_TARGET:
      {
        ...
        if (result == null) result = caseRuntimeError(callOnVoidTarget);
        if (result == null) result = caseException(callOnVoidTarget);
        if (result == null) result = caseObject(callOnVoidTarget);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ExceptionsPackage.TYPE_CAST_ERROR:
      {
        ...
        if (result == null) result = caseRuntimeError(typeCastError);
        if (result == null) result = caseException(typeCastError);
        if (result == null) result = caseObject(typeCastError);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ExceptionsPackage.NOT_IMPLEMENTED_EXCEPTION:
      {
        ...
        if (result == null) result = caseRuntimeError(notImplementedException);
        if (result == null) result = caseException(notImplementedException);
        if (result == null) result = caseObject(notImplementedException);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ExceptionsPackage.UPPER_BOUND_REACHED_ERROR:
      {
        ...
        if (result == null) result = caseRuntimeError(upperBoundReachedError);
        if (result == null) result = caseException(upperBoundReachedError);
        if (result == null) result = caseObject(upperBoundReachedError);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ExceptionsPackage.ABSTRACT_CLASS_INSTANTIATION_ERROR:
      {
        ...
        if (result == null) result = caseRuntimeError(abstractClassInstantiationError);
        if (result == null) result = caseException(abstractClassInstantiationError);
        if (result == null) result = caseObject(abstractClassInstantiationError);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ExceptionsPackage.INCOMPATIBLE_TYPE_ERROR:
      {
        ...
        if (result == null) result = caseRuntimeError(incompatibleTypeError);
        if (result == null) result = caseException(incompatibleTypeError);
        if (result == null) result = caseObject(incompatibleTypeError);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ExceptionsPackage.DIVISION_BY_ZERO:
      {
        ...
        if (result == null) result = caseException(divisionByZero);
        if (result == null) result = caseObject(divisionByZero);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ExceptionsPackage.OVERFLOW_ERROR:
      {
        ...
        if (result == null) result = caseException(overflowError);
        if (result == null) result = caseObject(overflowError);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ExceptionsPackage.VOID_OPERAND_ERROR:
      {
        ...
        if (result == null) result = caseException(voidOperandError);
        if (result == null) result = caseObject(voidOperandError);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ExceptionsPackage.STRING_INDEX_OUT_OF_BOUND:
      {
        ...
        if (result == null) result = caseException(stringIndexOutOfBound);
        if (result == null) result = caseObject(stringIndexOutOfBound);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ExceptionsPackage.STRING_FORMAT_EXCEPTION:
      {
        ...
        if (result == null) result = caseException(stringFormatException);
        if (result == null) result = caseObject(stringFormatException);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ExceptionsPackage.INDEX_OUT_OF_BOUND:
      {
        ...
        if (result == null) result = caseException(indexOutOfBound);
        if (result == null) result = caseObject(indexOutOfBound);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ExceptionsPackage.EMPTY_COLLECTION:
      {
        ...
        if (result == null) result = caseException(emptyCollection);
        if (result == null) result = caseObject(emptyCollection);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ExceptionsPackage.ITERATOR_IS_OFF:
      {
        ...
        if (result == null) result = caseException(iteratorIsOff);
        if (result == null) result = caseObject(iteratorIsOff);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ExceptionsPackage.IO_EXCEPTION:
      {
        ...
        if (result == null) result = caseException(ioException);
        if (result == null) result = caseObject(ioException);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ExceptionsPackage.FILE_NOT_FOUND_EXCEPTION:
      {
        ...
        if (result == null) result = caseIOException(fileNotFoundException);
        if (result == null) result = caseException(fileNotFoundException);
        if (result == null) result = caseObject(fileNotFoundException);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ExceptionsPackage.CONSTRAINT_VIOLATED_PRE:
      {
        ...
        if (result == null) result = caseException(constraintViolatedPre);
        if (result == null) result = caseObject(constraintViolatedPre);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ExceptionsPackage.CONSTRAINT_VIOLATED_POST:
      {
        ...
        if (result == null) result = caseException(constraintViolatedPost);
        if (result == null) result = caseObject(constraintViolatedPost);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ExceptionsPackage.CONSTRAINT_VIOLATED_INV:
      {
        ...
        if (result == null) result = caseException(constraintViolatedInv);
        if (result == null) result = caseObject(constraintViolatedInv);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ExceptionsPackage.RESOURCE_LOAD_EXCEPTION:
      {
        ...
        if (result == null) result = caseException(resourceLoadException);
        if (result == null) result = caseObject(resourceLoadException);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ExceptionsPackage.RESOURCE_SAVE_EXCEPTION:
      {
        ...
        if (result == null) result = caseException(resourceSaveException);
        if (result == null) result = caseObject(resourceSaveException);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ExceptionsPackage.RESOURCE_CREATE_EXCEPTION:
      {
        ...
        if (result == null) result = caseException(resourceCreateException);
        if (result == null) result = caseObject(resourceCreateException);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ExceptionsPackage.RESOURCE_UNCONFORMITY_EXCEPTION:
      {
        ...
        if (result == null) result = caseException(resourceUnconformityException);
        if (result == null) result = caseObject(resourceUnconformityException);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ExceptionsPackage.DYNAMIC_EXPRESSION_EXCEPTION:
      {
        ...
        if (result == null) result = caseException(dynamicExpressionException);
        if (result == null) result = caseObject(dynamicExpressionException);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
   ...
   * @generated
   */
  public T caseAbstractClassInstantiationError(AbstractClassInstantiationError object)
  {
    return null;
  }
   ...
   * @generated
   */
  public T caseResourceUnconformityException(ResourceUnconformityException object)
  {
    return null;
  }
