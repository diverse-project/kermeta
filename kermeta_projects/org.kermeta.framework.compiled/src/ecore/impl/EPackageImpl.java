 ...
 *
 * $Id: EPackageImpl.java,v 1.1 2008-06-24 14:23:19 cfaucher Exp $
 */
package ecore.impl;
...
public class EPackageImpl extends ENamedElementImpl implements EPackage
{
   ...
   * @generated
   */
  public NotificationChain basicSetESuperPackage(EPackage newESuperPackage, NotificationChain msgs)
  {
    msgs = eBasicSetContainer((InternalEObject)newESuperPackage, EcorePackage.EPACKAGE__ESUPER_PACKAGE, msgs);
    return msgs;
  }
  ...
  {
    if (newESuperPackage != eInternalContainer() || (eContainerFeatureID != EcorePackage.EPACKAGE__ESUPER_PACKAGE && newESuperPackage != null))
    {
      ...
      if (newESuperPackage != null)
        msgs = ((InternalEObject)newESuperPackage).eInverseAdd(this, EcorePackage.EPACKAGE__ESUBPACKAGES, EPackage.class, msgs);
      msgs = basicSetESuperPackage(newESuperPackage, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EcorePackage.EPACKAGE__ESUPER_PACKAGE, newESuperPackage, newESuperPackage));
  }
  ...
  public EFactory getEFactoryInstance()
  {
    if (eFactoryInstance != null && eFactoryInstance.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, EcorePackage.EPACKAGE__EFACTORY_INSTANCE, oldEFactoryInstance, eFactoryInstance));
      }
    }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case EcorePackage.EPACKAGE__EFACTORY_INSTANCE:
        if (resolve) return getEFactoryInstance();
