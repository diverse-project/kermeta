 ...
 *
 * $Id: EEnumLiteralImpl.java,v 1.1 2008-06-24 14:23:19 cfaucher Exp $
 */
package ecore.impl;
...
public class EEnumLiteralImpl extends ENamedElementImpl implements EEnumLiteral
{
  ...
  {
    msgs = eBasicSetContainer((InternalEObject)newEEnum, EcorePackage.EENUM_LITERAL__EENUM, msgs);
    return msgs;
  }
  ...
  {
    if (newEEnum != eInternalContainer() || (eContainerFeatureID != EcorePackage.EENUM_LITERAL__EENUM && newEEnum != null))
    {
      ...
      if (newEEnum != null)
        msgs = ((InternalEObject)newEEnum).eInverseAdd(this, EcorePackage.EENUM__ELITERALS, EEnum.class, msgs);
      msgs = basicSetEEnum(newEEnum, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EcorePackage.EENUM_LITERAL__EENUM, newEEnum, newEEnum));
  }
