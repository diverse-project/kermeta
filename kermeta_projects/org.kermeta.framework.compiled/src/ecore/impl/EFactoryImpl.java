 ...
 *
 * $Id: EFactoryImpl.java,v 1.1 2008-06-24 14:23:19 cfaucher Exp $
 */
package ecore.impl;
    ...
    if (ePackage != null && ePackage.eIsProxy())
    {
      ...
      if (ePackage != oldEPackage)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, EcorePackage.EFACTORY__EPACKAGE, oldEPackage, ePackage));
      }
    }
    return ePackage;
  }
