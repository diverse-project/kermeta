 ...
 *
 * $Id: ETypedElementImpl.java,v 1.1 2008-06-24 14:23:19 cfaucher Exp $
 */
package ecore.impl;
...
public abstract class ETypedElementImpl extends ENamedElementImpl implements ETypedElement
{
  ...
  public void setMany(boolean newMany)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EcorePackage.ETYPED_ELEMENT__MANY, oldMany, many));
  }
  ...
  public void setRequired(boolean newRequired)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EcorePackage.ETYPED_ELEMENT__REQUIRED, oldRequired, required));
  }
  ...
  public void setEGenericType(EGenericType newEGenericType)
  {
    if (newEGenericType != eGenericType)
    {
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, EcorePackage.ETYPED_ELEMENT__EGENERIC_TYPE, newEGenericType, newEGenericType));
  }
