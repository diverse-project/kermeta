 ...
 *
 * $Id: EReferenceImpl.java,v 1.1 2008-06-24 14:23:19 cfaucher Exp $
 */
package ecore.impl;
...
public class EReferenceImpl extends EStructuralFeatureImpl implements EReference
{
    ...
    if (eReferenceType != null && eReferenceType.eIsProxy())
    {
      ...
      if (eReferenceType != oldEReferenceType)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, EcorePackage.EREFERENCE__EREFERENCE_TYPE, oldEReferenceType, eReferenceType));
      }
    }
  ...
  public void setEReferenceType(EClass newEReferenceType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EcorePackage.EREFERENCE__EREFERENCE_TYPE, oldEReferenceType, eReferenceType));
  }
  ...
  public void setContainer(boolean newContainer)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EcorePackage.EREFERENCE__CONTAINER, oldContainer, container));
  }
