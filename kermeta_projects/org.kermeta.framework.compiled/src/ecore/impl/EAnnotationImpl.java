 ...
 *
 * $Id: EAnnotationImpl.java,v 1.1 2008-06-24 14:23:19 cfaucher Exp $
 */
package ecore.impl;
...
public class EAnnotationImpl extends EModelElementImpl implements EAnnotation
{
  ...
  public EList<EStringToStringMapEntry> getDetails()
  {
    if (details == null)
    {
      details = new EObjectContainmentEList<EStringToStringMapEntry>(EStringToStringMapEntry.class, this, EcorePackage.EANNOTATION__DETAILS);
    }
    return details;
  }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case EcorePackage.EANNOTATION__DETAILS:
        getDetails().clear();
        getDetails().addAll((Collection<? extends EStringToStringMapEntry>)newValue);
        return;
      case EcorePackage.EANNOTATION__SOURCE:
