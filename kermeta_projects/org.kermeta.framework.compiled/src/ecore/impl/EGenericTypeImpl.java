 ...
 *
 * $Id: EGenericTypeImpl.java,v 1.1 2008-06-24 14:23:19 cfaucher Exp $
 */
package ecore.impl;
...
public class EGenericTypeImpl extends EObjectImpl implements EGenericType
{
  ...
  public void setERawType(EClassifier newERawType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EcorePackage.EGENERIC_TYPE__ERAW_TYPE, oldERawType, eRawType));
  }
  ...
  public ETypeParameter getETypeParameter()
  {
    if (eTypeParameter != null && eTypeParameter.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, EcorePackage.EGENERIC_TYPE__ETYPE_PARAMETER, oldETypeParameter, eTypeParameter));
      }
    }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case EcorePackage.EGENERIC_TYPE__ETYPE_PARAMETER:
        if (resolve) return getETypeParameter();
