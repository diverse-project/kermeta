 ...
 *
 * $Id: EParameterImpl.java,v 1.1 2008-06-24 14:23:19 cfaucher Exp $
 */
package ecore.impl;
...
public class EParameterImpl extends ETypedElementImpl implements EParameter
{
  ...
  {
    msgs = eBasicSetContainer((InternalEObject)newEOperation, EcorePackage.EPARAMETER__EOPERATION, msgs);
    return msgs;
  }
  ...
  {
    if (newEOperation != eInternalContainer() || (eContainerFeatureID != EcorePackage.EPARAMETER__EOPERATION && newEOperation != null))
    {
      ...
      if (newEOperation != null)
        msgs = ((InternalEObject)newEOperation).eInverseAdd(this, EcorePackage.EOPERATION__EPARAMETERS, EOperation.class, msgs);
      msgs = basicSetEOperation(newEOperation, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EcorePackage.EPARAMETER__EOPERATION, newEOperation, newEOperation));
  }
