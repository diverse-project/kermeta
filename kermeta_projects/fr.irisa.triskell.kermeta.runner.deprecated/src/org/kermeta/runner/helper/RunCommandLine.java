/* $Id: RunCommandLine.java,v 1.2 2008-02-14 07:13:07 uid21732 Exp $
 ...
 *        <desription.text> 
 */
package org.kermeta.runner.helper;
...
public class RunCommandLine {
	...
	public void init() throws NotRegisteredURIException, URIMalformedException, IOException
	{
        ...
        KermetaUnit unitToExecute = RunnerHelper.getKermetaUnitToExecute(unitURI);
	    theInterpreter = new KermetaInterpreter(unitToExecute, null);
