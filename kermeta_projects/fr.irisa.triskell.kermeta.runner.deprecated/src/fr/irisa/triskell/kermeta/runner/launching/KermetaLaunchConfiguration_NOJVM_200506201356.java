/* $Id: KermetaLaunchConfiguration_NOJVM_200506201356.java,v 1.1 2005-06-23 14:37:20 zdrey Exp $
 ...
 * 
 */
public class KermetaLaunchConfiguration_NOJVM_200506201356 implements ILaunchConfigurationDelegate 
{
    /*
     * 
     * STATIC FIELDS
    ...
    public KermetaLaunchConfiguration_NOJVM_200506201356()
    {
        super();
    ...
    private static void runKermeta(String fileNameString, String classQualifiedNameString, String operationString)
    {
        ...
        try
        {
    	    ...
    	    System.err.println("Total memory before interpreter : "+ Runtime.getRuntime().freeMemory());
    	   
            KermetaInterpreter interpreter = new KermetaInterpreter(uri);
            System.err.println("Total memory new interpreter : "+ Runtime.getRuntime().freeMemory());
