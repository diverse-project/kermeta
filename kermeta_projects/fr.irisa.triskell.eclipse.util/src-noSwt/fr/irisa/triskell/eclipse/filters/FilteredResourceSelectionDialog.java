 ...
 *******************************************************************************/
package fr.irisa.triskell.eclipse.filters;
...
public class FilteredResourceSelectionDialog /*extends SelectionDialog */{
   ...
   // private CheckboxTreeAndListGroup selectionGroup;
     ...
     */
    public FilteredResourceSelectionDialog(/*Shell parentShell, */IAdaptable rootElement,
            String message, String extension) {
      /*  super(parentShell);
        this.requiredFileExtension=extension;
     ...
     */
    protected void /*Control */createDialogArea(/*Composite parent*/) {
        // page group
     ...
     */
    private void /*ITreeContentProvider*/ getResourceProvider(final int resourceType) {
                    ...
                    for (int i = 0; i < members.length; i++) {
                        ...
                        if ((members[i].getType() & resourceType) > 0) {
                        	...
                        	if (members[i].getType()==IResource.FILE) {
                        		// We need to filter on the file extension
                        		if ( ((IFile)members[i]).getFileExtension().equals(requiredFileExtension)) {
