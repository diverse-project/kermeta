...
public void testloader_tests_UML2() throws Exception {
testloader_testsFile("test/loader_tests","UML2.ecore" );
}

public void testloader_tests_puzzle() throws Exception {
testloader_testsFile("test/loader_tests","puzzle.ecore" );
}

public void testloader_tests_automata() throws Exception {
testloader_testsFile("test/loader_tests","automata.ecore" );
}
...
/*** END GENERATED TESTS ***/
	...
	/**
	 * Transform the kmt file given by file into an ecore file, and reversely
	 */
	public void testloader_testsFile(String dir, String file) throws Exception {
