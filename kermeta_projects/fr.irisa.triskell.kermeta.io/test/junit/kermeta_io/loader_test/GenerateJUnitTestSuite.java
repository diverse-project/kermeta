...
public class GenerateJUnitTestSuite {
	...
	protected static String[] folders = {"test/loader_tests"} ;
	protected static String[] filetypes = {"ecore"};
	...
	protected static String junitfile = "test/junit/kermeta_io/loader_test/JunitTestSuite.java";
