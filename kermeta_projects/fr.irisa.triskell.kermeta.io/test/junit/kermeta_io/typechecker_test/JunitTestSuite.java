/* $Id: JunitTestSuite.java,v 1.31 2007-09-04 08:15:59 ftanguy Exp $
...
testvalidFile("test/typechecher_tests/valid","001_simpleUML_MM_behavior.kmt" );
}
...
/*** END GENERATED TESTS ***/
	...
	public void testinvalidFile(String dir, String file) throws Exception {
		...
		KermetaUnit kermetaUnit = IOPlugin.getDefault().loadKermetaUnit( "platform:/plugin/fr.irisa.triskell.kermeta.io/" + dir + "/" + file);
