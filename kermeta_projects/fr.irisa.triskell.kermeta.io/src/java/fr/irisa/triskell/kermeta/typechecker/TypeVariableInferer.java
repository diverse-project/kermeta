/* $Id: TypeVariableInferer.java,v 1.13 2006-03-03 15:22:18 dvojtise Exp $
...
public class TypeVariableInferer extends KermetaOptimizedVisitor {
	 ...
	 * @return A hashtable <Variable : TypeVariable, ActualType : fr.irisa.triskell.kermeta.language.structure.Type> or null if the provided does not match the generic type
	 */
	...
	public static void inferTypeVariableTypes(fr.irisa.triskell.kermeta.language.structure.Type generic, fr.irisa.triskell.kermeta.language.structure.Type provided, Hashtable result) {
	    provided = TypeCheckerContext.getCanonicalType(provided);
		generic = TypeCheckerContext.getCanonicalType(generic);
		TypeVariableInferer visitor = new TypeVariableInferer(provided, result);
	 ...
	 * Constructor
	 */
	public TypeVariableInferer(fr.irisa.triskell.kermeta.language.structure.Type provided, Hashtable result) {
		super();
