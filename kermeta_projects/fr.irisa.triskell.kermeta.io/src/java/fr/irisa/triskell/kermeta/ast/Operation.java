...
public class Operation extends ClassMemberDecl  {
	...
	private Postcondition _postcondition;
	...
	public int getChildCount() {
		...
		if (_precondition != null) count++;
		if (_operationBody != null) count++;
		if (_postcondition != null) count++;
	...
	public ASTNode getChild(int index) {
		...
		if ((_precondition != null) && (++count == index)) return _precondition;
		if ((_operationBody != null) && (++count == index)) return _operationBody;
		if ((_postcondition != null) && (++count == index)) return _postcondition;
	...
	public Operation(
		...
		if (precondition != null) {
			...
			if (_precondition._parent != null) throw new RuntimeException();
			_precondition._parent = this;
		}
		...
		if (postcondition != null) {
			...
			if (_postcondition._parent != null) throw new RuntimeException();
			_postcondition._parent = this;
		}
