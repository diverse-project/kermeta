...
public class Operation extends ClassMemberDecl  {
	...
	private KermetaTokenNode _select_KW;
	private KermetaTokenNode _superSelection;
	...
	public KermetaTokenNode getSelect_KW() {
		return _select_KW;
	}
	public KermetaTokenNode getSuperSelection() {
	...
	public ASTNode getChild(int index) {
		...
		if ((_select_KW != null) && (++count == index)) return _select_KW;
	...
	public Operation(
		...
		if (select_KW != null) {
			_select_KW = new KermetaTokenNode(select_KW);
			if (_select_KW._parent != null) throw new RuntimeException();
			_select_KW._parent = this;
		}
		if (superSelection != null) {
			_superSelection = new KermetaTokenNode(superSelection);
