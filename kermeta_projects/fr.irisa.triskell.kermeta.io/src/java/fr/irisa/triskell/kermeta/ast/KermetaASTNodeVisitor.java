...
public class KermetaASTNodeVisitor {
	 ...
	 * before (optionally) visiting the children of the node.
	 * This <code>beginVisit</code> method is the specific one called for nodes
	 * of type <code>Preconditions</code>
	 * This may be overridden to provide special behavior at that point in processing.
	 * 
	 * @param preconditions the node currently being visited
	 * @return true to visit the children of the node, false to prevent visiting the children of the node
	 */
	public boolean beginVisit(Preconditions preconditions) {
		return beginVisit((KermetaASTNode)preconditions);
	}
	 ...
	 * @param preconditions the node currently being visited
	 */
	public void endVisit(Preconditions preconditions) {
		endVisit((KermetaASTNode)preconditions);
	}
	/**
	 * This is called, for each node being visited, just after <code>preVisit</code> and
	 * before (optionally) visiting the children of the node.
	 * This <code>beginVisit</code> method is the specific one called for nodes
	 * of type <code>Postconditions</code>
	 * This may be overridden to provide special behavior at that point in processing.
	 * 
	 * @param postconditions the node currently being visited
	 * @return true to visit the children of the node, false to prevent visiting the children of the node
	 */
	public boolean beginVisit(Postconditions postconditions) {
		return beginVisit((KermetaASTNode)postconditions);
	}
	 ...
	 * @param postconditions the node currently being visited
	 */
	public void endVisit(Postconditions postconditions) {
		endVisit((KermetaASTNode)postconditions);
	}
	/**
	 * This is called, for each node being visited, just after <code>preVisit</code> and
	 * before (optionally) visiting the children of the node.
	...
	public boolean beginVisit(Precondition precondition) {
		return beginVisit((KermetaASTNode)precondition);
	}
	...
	public void endVisit(Precondition precondition) {
		endVisit((KermetaASTNode)precondition);
	}
	/**
	 * This is called, for each node being visited, just after <code>preVisit</code> and
	 * before (optionally) visiting the children of the node.
	...
	public boolean beginVisit(Postcondition postcondition) {
		return beginVisit((KermetaASTNode)postcondition);
	}
	...
	public void endVisit(Postcondition postcondition) {
		endVisit((KermetaASTNode)postcondition);
	}
	/**
	 * This is called, for each node being visited, just after <code>preVisit</code> and
	 * before (optionally) visiting the children of the node.
