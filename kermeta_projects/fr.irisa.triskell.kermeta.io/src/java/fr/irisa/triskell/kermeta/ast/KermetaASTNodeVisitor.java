...
public class KermetaASTNodeVisitor {
	...
	public boolean beginVisit(Annotation annotation) {
		return beginVisit((ClassMemberDecl)annotation);
	}
	...
	public void endVisit(Annotation annotation) {
		endVisit((ClassMemberDecl)annotation);
	}
	/**
	 * This is called, for each node being visited, just after <code>preVisit</code> and
	 * before (optionally) visiting the children of the node.
	 ...
	 * before (optionally) visiting the children of the node.
	 * This <code>beginVisit</code> method is the specific one called for nodes
	 * of type <code>SingleLineComment</code>
	 * This may be overridden to provide special behavior at that point in processing.
	 * 
	 * @param singleLineComment the node currently being visited
	 * @return true to visit the children of the node, false to prevent visiting the children of the node
	 */
	public boolean beginVisit(SingleLineComment singleLineComment) {
		return beginVisit((Annotation)singleLineComment);
	}
	 ...
	 * @param singleLineComment the node currently being visited
	 */
	public void endVisit(SingleLineComment singleLineComment) {
		endVisit((Annotation)singleLineComment);
	}
	/**
	 * This is called, for each node being visited, just after <code>preVisit</code> and
	 * before (optionally) visiting the children of the node.
	 * This <code>beginVisit</code> method is the specific one called for nodes
	 * of type <code>MultiLineComment</code>
	 * This may be overridden to provide special behavior at that point in processing.
	 * 
	 * @param multiLineComment the node currently being visited
	 * @return true to visit the children of the node, false to prevent visiting the children of the node
	 */
	public boolean beginVisit(MultiLineComment multiLineComment) {
		return beginVisit((Annotation)multiLineComment);
	}
	 ...
	 * @param multiLineComment the node currently being visited
	 */
	public void endVisit(MultiLineComment multiLineComment) {
		endVisit((Annotation)multiLineComment);
	}
	/**
	 * This is called, for each node being visited, just after <code>preVisit</code> and
	 * before (optionally) visiting the children of the node.
	 ...
	 * before (optionally) visiting the children of the node.
	 * This <code>beginVisit</code> method is the specific one called for nodes
	 * of type <code>Selftype</code>
	 * This may be overridden to provide special behavior at that point in processing.
	 * 
	 * @param selftype the node currently being visited
	 * @return true to visit the children of the node, false to prevent visiting the children of the node
	 */
	public boolean beginVisit(Selftype selftype) {
		return beginVisit((Type)selftype);
	}
	 ...
	 * @param selftype the node currently being visited
	 */
	public void endVisit(Selftype selftype) {
		endVisit((Type)selftype);
	}
	/**
	 * This is called, for each node being visited, just after <code>preVisit</code> and
	 * before (optionally) visiting the children of the node.
	 ...
	 * before (optionally) visiting the children of the node.
	 * This <code>beginVisit</code> method is the specific one called for nodes
	 * of type <code>PropertyBody</code>
	 * This may be overridden to provide special behavior at that point in processing.
	 * 
	 * @param propertyBody the node currently being visited
	 * @return true to visit the children of the node, false to prevent visiting the children of the node
	 */
	public boolean beginVisit(PropertyBody propertyBody) {
		return beginVisit((KermetaASTNode)propertyBody);
	}
	 ...
	 * @param propertyBody the node currently being visited
	 */
	public void endVisit(PropertyBody propertyBody) {
		endVisit((KermetaASTNode)propertyBody);
	}
	/**
	 * This is called, for each node being visited, just after <code>preVisit</code> and
	 * before (optionally) visiting the children of the node.
	...
	public boolean beginVisit(CallPostfix callPostfix) {
		return beginVisit((Postfix)callPostfix);
	}
	...
	public boolean beginVisit(LambdaPostfix lambdaPostfix) {
		return beginVisit((Postfix)lambdaPostfix);
	}
	...
	public void endVisit(LambdaPostfix lambdaPostfix) {
		endVisit((Postfix)lambdaPostfix);
	}
	/**
	 * This is called, for each node being visited, just after <code>preVisit</code> and
	 * before (optionally) visiting the children of the node.
