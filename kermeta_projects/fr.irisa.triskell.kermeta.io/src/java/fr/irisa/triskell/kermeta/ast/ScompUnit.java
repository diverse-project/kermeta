...
public class ScompUnit extends CompUnit  {
	...
	private Annotations _postUnitAnnotations;
	...
	public Annotations getPostUnitAnnotations() {
		return _postUnitAnnotations;
	}
	...
	public int getChildCount() {
		int count = 0;
		if (_postUnitAnnotations != null) count++;
	...
	public ASTNode getChild(int index) {
		int count = -1;
		if ((_postUnitAnnotations != null) && (++count == index)) return _postUnitAnnotations;
	...
	public ScompUnit(
		...
		if (postUnitAnnotations != null) {
			_postUnitAnnotations = postUnitAnnotations;
			if (_postUnitAnnotations._parent != null) throw new RuntimeException();
			_postUnitAnnotations._parent = this;
		}
		if (packageDecl != null) {
