...
public class KmtAst2KMStructure extends KermetaASTNodeVisitor {
	...
	public KmtAst2KMStructure(KermetaUnit kermetaUnit) {
		this.kermetaUnit = kermetaUnit;
	}
	public void generateStructure(CompUnit ast) {
		ast.accept(this);
	}
