...
public class BodiesAndOppositesSetter extends KermetaASTNodeVisitor {

	private KermetaUnit kermetaUnit;
	
	private LoadingContext context;
	
	public BodiesAndOppositesSetter(KermetaUnit keremtaUnit, LoadingContext loadingContext) {
		this.kermetaUnit = keremtaUnit;
		this.context = loadingContext;
	}

	public void performAction(CompUnit ast) {
		ast.accept(this);
	}
