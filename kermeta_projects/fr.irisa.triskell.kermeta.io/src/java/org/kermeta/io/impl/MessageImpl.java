 ...
 * <ul>
 *   <li>{@link org.kermeta.io.impl.MessageImpl#getValue <em>Value</em>}</li>
 *   <li>{@link org.kermeta.io.impl.MessageImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class MessageImpl extends EObjectImpl implements Message {
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IoPackage.MESSAGE__VALUE, oldValue, value));
	}
	...
	public void setTarget(Object newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IoPackage.MESSAGE__TARGET, oldTarget, target));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IoPackage.MESSAGE__VALUE:
				return getValue();
			case IoPackage.MESSAGE__TARGET:
				return getTarget();
		}
