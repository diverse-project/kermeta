/* $Id: InterpreterTestCase.java,v 1.1 2006-07-18 11:27:35 zdrey Exp $
...
public class InterpreterTestCase extends TestCase {
    ...
    public void test25Hello() {
        ...
        for (int i=0; i<25; i++) {
            ...
            KermetaInterpreter inter = new KermetaInterpreter("test/kmt_testcases/013_testString.main.kmt");
            inter.launch();
