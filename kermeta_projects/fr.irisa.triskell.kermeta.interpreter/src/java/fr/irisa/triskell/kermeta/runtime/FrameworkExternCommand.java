/** $Id: FrameworkExternCommand.java,v 1.19 2007-07-06 15:45:23 dtouzet Exp $ 
...
commands.put("fr__irisa__triskell__kermeta__runtime__language__Class_hasSubType_2", new fr__irisa__triskell__kermeta__runtime__language__Class_hasSubType_2Comd());
...
class fr__irisa__triskell__kermeta__runtime__language__Class_hasSubType_2Comd extends FrameworkExternCommand {
	public RuntimeObject execute(RuntimeObject[] params) {
		return (RuntimeObject)fr.irisa.triskell.kermeta.runtime.language.Class.hasSubType(params[0], params[1]);
	}
}
