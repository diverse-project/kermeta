/** $Id: FrameworkExternCommand.java,v 1.31 2008-06-24 14:47:39 cfaucher Exp $ 
...
commands.put("fr__irisa__triskell__kermeta__runtime__basetypes__StdIO_errorln_1", new fr__irisa__triskell__kermeta__runtime__basetypes__StdIO_errorln_1Comd());
commands.put("fr__irisa__triskell__kermeta__runtime__basetypes__StdIO_error_1", new fr__irisa__triskell__kermeta__runtime__basetypes__StdIO_error_1Comd());
...
commands.put("fr__irisa__triskell__kermeta__runtime__basetypes__StringBuffer_length_1", new fr__irisa__triskell__kermeta__runtime__basetypes__StringBuffer_length_1Comd());
...
class fr__irisa__triskell__kermeta__runtime__basetypes__StdIO_errorln_1Comd extends FrameworkExternCommand {
	public RuntimeObject execute(RuntimeObject[] params) {
		return (RuntimeObject)fr.irisa.triskell.kermeta.runtime.basetypes.StdIO.errorln(params[0]);
	}
}

class fr__irisa__triskell__kermeta__runtime__basetypes__StdIO_error_1Comd extends FrameworkExternCommand {
	public RuntimeObject execute(RuntimeObject[] params) {
		return (RuntimeObject)fr.irisa.triskell.kermeta.runtime.basetypes.StdIO.error(params[0]);
	}
}
...
class fr__irisa__triskell__kermeta__runtime__basetypes__StringBuffer_length_1Comd extends FrameworkExternCommand {
	public RuntimeObject execute(RuntimeObject[] params) {
		return (RuntimeObject)fr.irisa.triskell.kermeta.runtime.basetypes.StringBuffer.length(params[0]);
	}
}
