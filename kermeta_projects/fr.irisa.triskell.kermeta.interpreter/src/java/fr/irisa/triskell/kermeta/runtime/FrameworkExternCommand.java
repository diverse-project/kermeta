/** $Id: FrameworkExternCommand.java,v 1.3 2006-09-20 13:38:26 dvojtise Exp $ 
...
commands.put("fr__irisa__triskell__kermeta__runtime__basetypes__Resource_save_5", new fr__irisa__triskell__kermeta__runtime__basetypes__Resource_save_5Comd());
...
class fr__irisa__triskell__kermeta__runtime__basetypes__Resource_save_5Comd extends FrameworkExternCommand {
	public RuntimeObject execute(RuntimeObject[] params) {
		return (RuntimeObject)fr.irisa.triskell.kermeta.runtime.basetypes.Resource.save(params[0], params[1], params[2], params[3], params[4]);
	}
}
