/** $Id: FrameworkExternCommand.java,v 1.17 2007-06-20 13:03:21 dtouzet Exp $ 
...
commands.put("fr__irisa__triskell__kermeta__runtime__basetypes__Resource_load_5", new fr__irisa__triskell__kermeta__runtime__basetypes__Resource_load_5Comd());
...
class fr__irisa__triskell__kermeta__runtime__basetypes__Resource_load_5Comd extends FrameworkExternCommand {
	public RuntimeObject execute(RuntimeObject[] params) {
		return (RuntimeObject)fr.irisa.triskell.kermeta.runtime.basetypes.Resource.load(params[0], params[1], params[2], params[3], params[4]);
	}
}
