/** $Id: FrameworkExternCommand.java,v 1.7 2006-12-13 07:53:51 dvojtise Exp $ 
...
commands.put("fr__irisa__triskell__kermeta__runtime__language__Model_addAllCompatible_2", new fr__irisa__triskell__kermeta__runtime__language__Model_addAllCompatible_2Comd());
...
class fr__irisa__triskell__kermeta__runtime__language__Model_addAllCompatible_2Comd extends FrameworkExternCommand {
	public RuntimeObject execute(RuntimeObject[] params) {
		return (RuntimeObject)fr.irisa.triskell.kermeta.runtime.language.Model.addAllCompatible(params[0], params[1]);
	}
}
