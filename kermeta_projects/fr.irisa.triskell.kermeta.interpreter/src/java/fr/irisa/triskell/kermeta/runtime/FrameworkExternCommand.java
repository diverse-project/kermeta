/** $Id: FrameworkExternCommand.java,v 1.24 2007-12-12 18:06:27 cfaucher Exp $ 
...
commands.put("fr__irisa__triskell__kermeta__runtime__basetypes__Resource_compare_2", new fr__irisa__triskell__kermeta__runtime__basetypes__Resource_compare_2Comd());
commands.put("fr__irisa__triskell__kermeta__runtime__basetypes__Resource_getMatch_3", new fr__irisa__triskell__kermeta__runtime__basetypes__Resource_getMatch_3Comd());
commands.put("fr__irisa__triskell__kermeta__runtime__basetypes__Resource_getDiff_3", new fr__irisa__triskell__kermeta__runtime__basetypes__Resource_getDiff_3Comd());
...
commands.put("fr__irisa__triskell__kermeta__runtime__io__SimpleFileIO_getAbsolutePathFolder_1", new fr__irisa__triskell__kermeta__runtime__io__SimpleFileIO_getAbsolutePathFolder_1Comd());
...
class fr__irisa__triskell__kermeta__runtime__basetypes__Resource_compare_2Comd extends FrameworkExternCommand {
	public RuntimeObject execute(RuntimeObject[] params) {
		return (RuntimeObject)fr.irisa.triskell.kermeta.runtime.basetypes.Resource.compare(params[0], params[1]);
	}
}

class fr__irisa__triskell__kermeta__runtime__basetypes__Resource_getMatch_3Comd extends FrameworkExternCommand {
	public RuntimeObject execute(RuntimeObject[] params) {
		return (RuntimeObject)fr.irisa.triskell.kermeta.runtime.basetypes.Resource.getMatch(params[0], params[1], params[2]);
	}
}

class fr__irisa__triskell__kermeta__runtime__basetypes__Resource_getDiff_3Comd extends FrameworkExternCommand {
	public RuntimeObject execute(RuntimeObject[] params) {
		return (RuntimeObject)fr.irisa.triskell.kermeta.runtime.basetypes.Resource.getDiff(params[0], params[1], params[2]);
	}
}
...
class fr__irisa__triskell__kermeta__runtime__io__SimpleFileIO_getAbsolutePathFolder_1Comd extends FrameworkExternCommand {
	public RuntimeObject execute(RuntimeObject[] params) {
		return (RuntimeObject)fr.irisa.triskell.kermeta.runtime.io.SimpleFileIO.getAbsolutePathFolder(params[0]);
	}
}
