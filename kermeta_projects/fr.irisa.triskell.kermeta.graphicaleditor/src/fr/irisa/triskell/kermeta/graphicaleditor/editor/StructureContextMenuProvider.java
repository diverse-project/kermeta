 ...
 */
public class StructureContextMenuProvider extends ModelerContextMenuProvider
{
    /**
     ...
     */
    public StructureContextMenuProvider(EditPartViewer viewer, ActionRegistry registry)
    {
    ...
    public void buildContextMenu(IMenuManager manager)
    {
        ...
        action = getActionRegistry().getAction(StructureActionConstants.DELETE_INHERITANCE_EDGE);
        if (action.isEnabled())
