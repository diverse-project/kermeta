 ...
 * File      : FOperationParameterViewer.java
 * License   : EPL
 ...
 * 
 */
public class FOperationParameterViewer
{
    ...
    public FOperationDataStructure getData() {
        ...
        public Object getValue(Object element, String property) {
            ...
            switch (index) {
                case 0:  
                    ...
                    break;
                case 1 :
                    FType type = _dataStructure.getType(element);
                    if (type != null) {
        ...
        public void modify(Object element, String property, Object value){
            ...
            switch (index) {
                case 0:  
                    ...
                    break;
                case 1 :
					_dataStructure.setType(item.getData(),(FType)_types.get(((Integer) value).intValue()));
                    break;
                default :
                    break;  
            }
