/*******************************************************************************
 * $Id: KmPreferencePage.java,v 1.1 2007-02-06 17:45:46 cfaucher Exp $
 * License: EPL
 * Copyright: IRISA / INRIA / Universite de Rennes 1
 ******************************************************************************/
package fr.irisa.triskell.kermeta.graphicaleditor.preferences;
...
/**
 * A preference page to configure all preferences of the Km editor.
 *
 * @generated
 */
public class KmPreferencePage extends PreferencePage implements
		IWorkbenchPreferencePage {
	/**
	 * @generated
	 */
	private IPreferenceStore ps = KmPlugin.getDefault().getPreferenceStore();
	...
	private void createHeader(Composite parent) {
		new Label(parent, SWT.WRAP).setText("Km editor preference page");
	}
