...
/**
 * A preference page to configure all preferences of the Structure editor.<br>
 *
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 *
 * @generated
 */
public class StructurePreferencePage extends PreferencePage implements
		IWorkbenchPreferencePage {
	private IPreferenceStore ps = StructurePlugin.getDefault()
			.getPreferenceStore();
	...
	private void createHeader(Composite parent) {
		new Label(parent, SWT.WRAP).setText("Structure editor preference page");
	}
