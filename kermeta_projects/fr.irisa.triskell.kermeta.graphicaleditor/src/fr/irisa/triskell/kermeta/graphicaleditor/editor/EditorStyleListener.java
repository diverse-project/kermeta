/* $Id: EditorStyleListener.java,v 1.4 2006-10-11 08:54:06 cfaucher Exp $
...
/**
 * This class performs the syntax highlighting and styling for Kermeta mini editor in graphical editor
 * Thanks to http://java.codefetch.com.
 */
public class EditorStyleListener implements LineStyleListener {
  // Colors
   ...
   */
  public EditorStyleListener(SyntaxData syntaxData) {
