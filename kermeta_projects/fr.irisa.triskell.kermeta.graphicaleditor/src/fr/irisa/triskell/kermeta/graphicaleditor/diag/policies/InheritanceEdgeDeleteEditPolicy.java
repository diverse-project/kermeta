...
import fr.irisa.triskell.kermeta.graphicaleditor.diag.commands.InheritanceEdgeDeleteCommand;
...
public class InheritanceEdgeDeleteEditPolicy extends AbstractEditPolicy
{
    ...
    {
        if (StructureRequestConstants.REQ_DELETE_INHERITANCE_EDGE.equals(request.getType()))
        {
    ...
    {
        return StructureRequestConstants.REQ_DELETE_INHERITANCE_EDGE.equals(req.getType());
    }
