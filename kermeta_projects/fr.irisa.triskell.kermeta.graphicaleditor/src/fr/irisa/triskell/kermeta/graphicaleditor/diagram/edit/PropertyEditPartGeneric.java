 ...
 * @generated NOT
 */
public class PropertyEditPartGeneric extends AbstractGraphicalEditPart {
 
	protected PropertyEditPartCommonInterface adaptee; 
	
	/**
	 * Constructor.
	 * Element specialization can be [EMF]GraphNode or [EMF]GraphEdge
	 */
	public PropertyEditPartGeneric(GraphElement element) {
		super();
		setModel(element);
