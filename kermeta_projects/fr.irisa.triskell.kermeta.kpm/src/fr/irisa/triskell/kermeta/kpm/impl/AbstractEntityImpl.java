 ...
 * <ul>
 *   <li>{@link fr.irisa.triskell.kermeta.kpm.impl.AbstractEntityImpl#getExpression <em>Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public abstract class AbstractEntityImpl extends EObjectImpl implements AbstractEntity {
	/**
	...
	public NotificationChain basicSetExpression(SimpleExpression newExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, KpmPackage.ABSTRACT_ENTITY__EXPRESSION, oldExpression, newExpression);
	...
	public void setExpression(SimpleExpression newExpression) {
		if (newExpression != expression) {
			...
			if (expression != null)
				msgs = ((InternalEObject)expression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - KpmPackage.ABSTRACT_ENTITY__EXPRESSION, null, msgs);
			if (newExpression != null)
				msgs = ((InternalEObject)newExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - KpmPackage.ABSTRACT_ENTITY__EXPRESSION, null, msgs);
			msgs = basicSetExpression(newExpression, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KpmPackage.ABSTRACT_ENTITY__EXPRESSION, newExpression, newExpression));
	}
