...
/**
 * This is the item provider adapter for a {@link fr.irisa.triskell.kermeta.kpm.Usage} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Usage_usedUnit_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Usage_usedUnit_feature", "_UI_Usage_type"),
				 KpmPackage.Literals.USAGE__USED_UNIT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Usage_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Usage_type_feature", "_UI_Usage_type"),
				 KpmPackage.Literals.USAGE__TYPE,
				 true,
				 false,
				 false,
