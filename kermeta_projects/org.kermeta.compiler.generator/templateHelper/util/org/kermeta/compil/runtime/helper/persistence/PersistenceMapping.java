	...
	static public void initialize(Configuration configuration) {
		...
		for ( Persistence p : configuration.getPersistenceEntries() ) {
			for ( Entry e : p.getEntries() ) {
				if ( e.getKey().equals(KCompilerConstants._BASE_CLASS_NAME_) )
					baseClassName = e.getValue();
				else if ( e.getKey().equals(KCompilerConstants._GENERATED_CLASS_NAME_) )
					generatedClassName = e.getValue();
				else if ( e.getKey().equals(KCompilerConstants._URI_) )
					uri = e.getValue();
				else if ( e.getKey().equals(KCompilerConstants._FILE_EXTENSION_) )
					fileExtension = e.getValue();
				else if ( e.getKey().equals(KCompilerConstants._FACTORY_CLASS_NAME) )
