...
public class EcoreMerge2EcoreWizard extends Wizard {
	...
	public void addPages() {
		...
		IFile kmtfile = IDEWorkbenchPlugin.getPluginWorkspace().getRoot()
				.getFile(
	...
	protected void initTraces() {
		...
		u = new URIConverterImpl().normalize(u);
		// traceFile =
		// IDEWorkbenchPlugin.getPluginWorkspace().getRoot().getFile(traceFile.getFullPath().removeFileExtension().addFileExtension("traceability"));
