...
/**
 * This is a copy of ContainerSelectionGroup, a class of eclipse plugin.
 * We copied it in order to be able to access its private methods/attributes, that
 * we didn't want to rewrite.
 * Workbench-level composite for choosing a container.
 */
public class CustomContainerSelectionGroup extends Composite {
     ...
     */
    public CustomContainerSelectionGroup(Composite parent, Listener listener,
