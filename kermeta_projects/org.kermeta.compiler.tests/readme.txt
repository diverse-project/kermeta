$Id: readme.txt,v 1.1 2007-12-11 20:13:33 cfaucher Exp $
...
The final result is a generated document (*.html, *.pdf... (for the moment only in html)) that is summarized and described
...
1. edit summary and progress files for each use cases,
2. generate the Trek Use Kase Models,
3. generate the docbook file,
4. generate the html-single file.
