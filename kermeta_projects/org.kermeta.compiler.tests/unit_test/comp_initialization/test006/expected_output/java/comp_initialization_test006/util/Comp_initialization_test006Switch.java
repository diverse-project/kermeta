 ...
 *
 * $Id: Comp_initialization_test006Switch.java,v 1.2 2009-02-17 13:41:04 cfaucher Exp $
 */
 ...
 * @generated
 */
public class Comp_initialization_test006Switch<T>
{
  /**
   ...
   * @generated
   */
  public Comp_initialization_test006Switch()
  {
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      case Comp_initialization_test006Package.MAIN:
      {
      ...
      case Comp_initialization_test006Package.A:
      {
        A a = (A)theEObject;
        T result = caseA(a);
        if (result == null) result = defaultCase(theEObject);
...
} //Comp_initialization_test006Switch
