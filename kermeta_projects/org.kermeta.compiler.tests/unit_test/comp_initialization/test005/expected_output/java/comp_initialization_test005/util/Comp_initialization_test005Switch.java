 ...
 *
 * $Id: Comp_initialization_test005Switch.java,v 1.2 2009-02-17 13:40:52 cfaucher Exp $
 */
 ...
 * @generated
 */
public class Comp_initialization_test005Switch<T>
{
  /**
   ...
   * @generated
   */
  public Comp_initialization_test005Switch()
  {
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      case Comp_initialization_test005Package.MAIN:
      {
      ...
      case Comp_initialization_test005Package.A:
      {
        A a = (A)theEObject;
        T result = caseA(a);
        if (result == null) result = defaultCase(theEObject);
...
} //Comp_initialization_test005Switch
