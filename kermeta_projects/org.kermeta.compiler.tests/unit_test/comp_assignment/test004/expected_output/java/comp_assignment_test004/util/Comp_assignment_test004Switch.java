 ...
 *
 * $Id: Comp_assignment_test004Switch.java,v 1.2 2009-02-17 13:41:00 cfaucher Exp $
 */
 ...
 * @generated
 */
public class Comp_assignment_test004Switch<T>
{
  /**
   ...
   * @generated
   */
  public Comp_assignment_test004Switch()
  {
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      case Comp_assignment_test004Package.MAIN:
      {
      ...
      case Comp_assignment_test004Package.A:
      {
        A a = (A)theEObject;
        T result = caseA(a);
        if (result == null) result = defaultCase(theEObject);
      ...
      case Comp_assignment_test004Package.B:
      {
        B b = (B)theEObject;
        T result = caseB(b);
        if (result == null) result = defaultCase(theEObject);
