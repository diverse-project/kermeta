 ...
 *
 * $Id: Comp_callResult_test003Switch.java,v 1.2 2009-02-17 13:40:52 cfaucher Exp $
 */
 ...
 * @generated
 */
public class Comp_callResult_test003Switch<T>
{
  /**
   ...
   * @generated
   */
  public Comp_callResult_test003Switch()
  {
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      case Comp_callResult_test003Package.MAIN:
      {
      ...
      case Comp_callResult_test003Package.A:
      {
        A a = (A)theEObject;
        T result = caseA(a);
        if (result == null) result = defaultCase(theEObject);
