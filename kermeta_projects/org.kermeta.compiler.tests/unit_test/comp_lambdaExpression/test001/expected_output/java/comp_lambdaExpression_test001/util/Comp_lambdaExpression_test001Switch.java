 ...
 *
 * $Id: Comp_lambdaExpression_test001Switch.java,v 1.1 2007-11-19 13:16:55 cfaucher Exp $
 */
 ...
 * @generated
 */
public class Comp_lambdaExpression_test001Switch<T>
{
  /**
   ...
   * @generated
   */
  public Comp_lambdaExpression_test001Switch()
  {
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      case Comp_lambdaExpression_test001Package.MAIN:
      {
      ...
      case Comp_lambdaExpression_test001Package.A:
      {
        A a = (A)theEObject;
        T result = caseA(a);
        if (result == null) result = defaultCase(theEObject);
...
} //Comp_lambdaExpression_test001Switch
