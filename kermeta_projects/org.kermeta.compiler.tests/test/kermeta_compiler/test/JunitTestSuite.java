...
public class JunitTestSuite extends TestSuite {
    ...
    private void initialize() {
    	...
    	org.kermeta.slf4j.eclipse.Activator.getDefault().configureLog4JLogger(modelPluginPath + "kermeta_log4j_configuration.xml");
...
/*** END GENERATED TESTS ***/
	...
	public void testWithFile(String dir, String file)  {
		...
		addTest( new CompiledRunJunitFactory(TestPlugin.PLUGIN_TESTS_PATH, TestPlugin.PLUGIN_ID).addTestsForUnit(uri) );
	}
