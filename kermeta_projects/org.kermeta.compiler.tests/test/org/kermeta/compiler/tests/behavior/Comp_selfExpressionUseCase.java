...
/*$Id: Comp_selfExpressionUseCase.java,v 1.5 2008-06-16 13:34:53 cfaucher Exp $
...
public class Comp_selfExpressionUseCase {
     ...
     * 
     */
	private String use_case = "comp_selfExpression";
	/*
     * 
	...
	private String test_case_comp_selfExpression_test001 = "test001";
	
	private String input_comp_selfExpression_test001 = "";
	
	private String output_comp_selfExpression_test001 = "";
	
	private String expected_output_comp_selfExpression_test001 = "";
	
	@Before public void setParams_comp_selfExpression_test001() {
		String prefix = "comp_selfExpression/test001";
		input_comp_selfExpression_test001 = Constants.SOURCE_PATH + prefix + "/" + KCompilerConstants.INPUT_FOLDER + "/kermeta/" + use_case + "_" + test_case_comp_selfExpression_test001 + ".km";
		output_comp_selfExpression_test001 = Constants.SOURCE_PATH + prefix + "/" + KCompilerConstants.OUTPUT_FOLDER + "/" + use_case + "_" + test_case_comp_selfExpression_test001 + ".ecore";
		expected_output_comp_selfExpression_test001 = Constants.SOURCE_PATH + prefix + "/" + KCompilerConstants.EXPECTED_OUTPUT_FOLDER +"/ecore/" + use_case + "_" + test_case_comp_selfExpression_test001 + ".ecore";
	}
	
	@Test public void comp_package_test_comp_selfExpression_test001() {
		run(input_comp_selfExpression_test001, output_comp_selfExpression_test001, expected_output_comp_selfExpression_test001);
	}
	/*
	 * 
