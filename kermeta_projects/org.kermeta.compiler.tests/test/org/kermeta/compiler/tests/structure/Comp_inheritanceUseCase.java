...
/*$Id: Comp_inheritanceUseCase.java,v 1.8 2008-06-16 13:34:54 cfaucher Exp $
...
public class Comp_inheritanceUseCase {
     ...
     * 
     */
	private String use_case = "comp_inheritance";
	/*
     * 
	...
	private String test_case_comp_inheritance_test001 = "test001";
	
	private String input_comp_inheritance_test001 = "";
	
	private String output_comp_inheritance_test001 = "";
	
	private String expected_output_comp_inheritance_test001 = "";
	
	@Before public void setParams_comp_inheritance_test001() {
		String prefix = "comp_inheritance/test001";
		input_comp_inheritance_test001 = Constants.SOURCE_PATH + prefix + "/" + KCompilerConstants.INPUT_FOLDER + "/kermeta/" + use_case + "_" + test_case_comp_inheritance_test001 + ".km";
		output_comp_inheritance_test001 = Constants.SOURCE_PATH + prefix + "/" + KCompilerConstants.OUTPUT_FOLDER + "/" + use_case + "_" + test_case_comp_inheritance_test001 + ".ecore";
		expected_output_comp_inheritance_test001 = Constants.SOURCE_PATH + prefix + "/" + KCompilerConstants.EXPECTED_OUTPUT_FOLDER +"/ecore/" + use_case + "_" + test_case_comp_inheritance_test001 + ".ecore";
	}
	
	@Test public void comp_package_test_comp_inheritance_test001() {
		run(input_comp_inheritance_test001, output_comp_inheritance_test001, expected_output_comp_inheritance_test001);
	}

	private String test_case_comp_inheritance_test002 = "test002";
	
	private String input_comp_inheritance_test002 = "";
	
	private String output_comp_inheritance_test002 = "";
	
	private String expected_output_comp_inheritance_test002 = "";
	
	@Before public void setParams_comp_inheritance_test002() {
		String prefix = "comp_inheritance/test002";
		input_comp_inheritance_test002 = Constants.SOURCE_PATH + prefix + "/" + KCompilerConstants.INPUT_FOLDER + "/kermeta/" + use_case + "_" + test_case_comp_inheritance_test002 + ".km";
		output_comp_inheritance_test002 = Constants.SOURCE_PATH + prefix + "/" + KCompilerConstants.OUTPUT_FOLDER + "/" + use_case + "_" + test_case_comp_inheritance_test002 + ".ecore";
		expected_output_comp_inheritance_test002 = Constants.SOURCE_PATH + prefix + "/" + KCompilerConstants.EXPECTED_OUTPUT_FOLDER +"/ecore/" + use_case + "_" + test_case_comp_inheritance_test002 + ".ecore";
	}
	
	@Test public void comp_package_test_comp_inheritance_test002() {
		run(input_comp_inheritance_test002, output_comp_inheritance_test002, expected_output_comp_inheritance_test002);
	}

	private String test_case_comp_inheritance_test003 = "test003";
	
	private String input_comp_inheritance_test003 = "";
	
	private String output_comp_inheritance_test003 = "";
	
	private String expected_output_comp_inheritance_test003 = "";
	
	@Before public void setParams_comp_inheritance_test003() {
		String prefix = "comp_inheritance/test003";
		input_comp_inheritance_test003 = Constants.SOURCE_PATH + prefix + "/" + KCompilerConstants.INPUT_FOLDER + "/kermeta/" + use_case + "_" + test_case_comp_inheritance_test003 + ".km";
		output_comp_inheritance_test003 = Constants.SOURCE_PATH + prefix + "/" + KCompilerConstants.OUTPUT_FOLDER + "/" + use_case + "_" + test_case_comp_inheritance_test003 + ".ecore";
		expected_output_comp_inheritance_test003 = Constants.SOURCE_PATH + prefix + "/" + KCompilerConstants.EXPECTED_OUTPUT_FOLDER +"/ecore/" + use_case + "_" + test_case_comp_inheritance_test003 + ".ecore";
	}
	...
	private String test_case_comp_inheritance_test006 = "test006";
	
	private String input_comp_inheritance_test006 = "";
	
	private String output_comp_inheritance_test006 = "";
	
	private String expected_output_comp_inheritance_test006 = "";
	
	@Before public void setParams_comp_inheritance_test006() {
		String prefix = "comp_inheritance/test006";
		input_comp_inheritance_test006 = Constants.SOURCE_PATH + prefix + "/" + KCompilerConstants.INPUT_FOLDER + "/kermeta/" + use_case + "_" + test_case_comp_inheritance_test006 + ".km";
		output_comp_inheritance_test006 = Constants.SOURCE_PATH + prefix + "/" + KCompilerConstants.OUTPUT_FOLDER + "/" + use_case + "_" + test_case_comp_inheritance_test006 + ".ecore";
		expected_output_comp_inheritance_test006 = Constants.SOURCE_PATH + prefix + "/" + KCompilerConstants.EXPECTED_OUTPUT_FOLDER +"/ecore/" + use_case + "_" + test_case_comp_inheritance_test006 + ".ecore";
	}
	
	@Test public void comp_package_test_comp_inheritance_test006() {
		run(input_comp_inheritance_test006, output_comp_inheritance_test006, expected_output_comp_inheritance_test006);
	}
	/*
	 * 
