...
/*$Id: Comp_classDefinitionUseCase.java,v 1.8 2008-06-16 13:34:54 cfaucher Exp $
...
public class Comp_classDefinitionUseCase {
     ...
     * 
     */
	private String use_case = "comp_classDefinition";
	/*
     * 
	...
	private String test_case_comp_classDefinition_test001 = "test001";
	
	private String input_comp_classDefinition_test001 = "";
	
	private String output_comp_classDefinition_test001 = "";
	...
	@Test public void comp_package_test_comp_classDefinition_test001() {
		run(input_comp_classDefinition_test001, output_comp_classDefinition_test001, expected_output_comp_classDefinition_test001);
	}

	private String test_case_comp_opposite_test001 = "test001";
	
	private String input_comp_opposite_test001 = "";
	
	private String output_comp_opposite_test001 = "";
	
	private String expected_output_comp_opposite_test001 = "";
	
	@Before public void setParams_comp_opposite_test001() {
		String prefix = "comp_opposite/test001";
		input_comp_opposite_test001 = Constants.SOURCE_PATH + prefix + "/" + KCompilerConstants.INPUT_FOLDER + "/kermeta/" + use_case + "_" + test_case_comp_opposite_test001 + ".km";
		output_comp_opposite_test001 = Constants.SOURCE_PATH + prefix + "/" + KCompilerConstants.OUTPUT_FOLDER + "/" + use_case + "_" + test_case_comp_opposite_test001 + ".ecore";
		expected_output_comp_opposite_test001 = Constants.SOURCE_PATH + prefix + "/" + KCompilerConstants.EXPECTED_OUTPUT_FOLDER +"/ecore/" + use_case + "_" + test_case_comp_opposite_test001 + ".ecore";
	}
	
	@Test public void comp_package_test_comp_opposite_test001() {
		run(input_comp_opposite_test001, output_comp_opposite_test001, expected_output_comp_opposite_test001);
	}

	private String test_case_comp_opposite_test002 = "test002";
	
	private String input_comp_opposite_test002 = "";
	
	private String output_comp_opposite_test002 = "";
	
	private String expected_output_comp_opposite_test002 = "";
	
	@Before public void setParams_comp_opposite_test002() {
		String prefix = "comp_opposite/test002";
		input_comp_opposite_test002 = Constants.SOURCE_PATH + prefix + "/" + KCompilerConstants.INPUT_FOLDER + "/kermeta/" + use_case + "_" + test_case_comp_opposite_test002 + ".km";
		output_comp_opposite_test002 = Constants.SOURCE_PATH + prefix + "/" + KCompilerConstants.OUTPUT_FOLDER + "/" + use_case + "_" + test_case_comp_opposite_test002 + ".ecore";
		expected_output_comp_opposite_test002 = Constants.SOURCE_PATH + prefix + "/" + KCompilerConstants.EXPECTED_OUTPUT_FOLDER +"/ecore/" + use_case + "_" + test_case_comp_opposite_test002 + ".ecore";
	}
	
	@Test public void comp_package_test_comp_opposite_test002() {
		run(input_comp_opposite_test002, output_comp_opposite_test002, expected_output_comp_opposite_test002);
	}
