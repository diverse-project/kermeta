 ...
 *
 * $Id: JavaAdapterFactory.java,v 1.12 2009-02-23 15:26:55 cfaucher Exp $
 */
...
public class JavaAdapterFactory extends AdapterFactoryImpl {
	...
	protected JavaSwitch<Adapter> modelSwitch = new JavaSwitch<Adapter>() {
		@Override
		public Adapter caseIdentifierHelper(IdentifierHelper object) {
			return createIdentifierHelperAdapter();
		}
	...
	/**
	 * Creates a new adapter for an object of class '{@link km2ecore.helper.java.IdentifierHelper <em>Identifier Helper</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createIdentifierHelperAdapter() {
		return null;
	}
