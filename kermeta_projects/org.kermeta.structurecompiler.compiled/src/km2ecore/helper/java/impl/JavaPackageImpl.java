 ...
 *
 * $Id: JavaPackageImpl.java,v 1.11 2009-02-10 17:51:55 cfaucher Exp $
 */
...
import km2ecore.helper.java.JavaFactory;
...
public class JavaPackageImpl extends EPackageImpl implements JavaPackage {
	 ...
	 * @generated
	 */
	private EClass identifierHelperEClass = null;
	 ...
	 * @see km2ecore.helper.java.JavaPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static JavaPackage init() {
		...
		JavaPackageImpl theJavaPackage = (JavaPackageImpl) (EPackage.Registry.INSTANCE
				.getEPackage(eNS_URI) instanceof JavaPackageImpl ? EPackage.Registry.INSTANCE
				.getEPackage(eNS_URI)
				: new JavaPackageImpl());
	 ...
	 * @generated
	 */
	public EClass getIdentifierHelper() {
		return identifierHelperEClass;
	}
	...
	public void createPackageContents() {
		...
		identifierHelperEClass = createEClass(IDENTIFIER_HELPER);
	}
	...
	public void initializePackageContents() {
		...
		identifierHelperEClass.getESuperTypes().add(
				theStructurePackage.getObject());

		// Initialize classes and features; add operations and parameters
		initEClass(identifierHelperEClass, IdentifierHelper.class,
				"IdentifierHelper", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);

		EOperation op = addEOperation(identifierHelperEClass,
				theStandardPackage.getJavaString(), "getMangledIdentifier", 0,
				1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, theStandardPackage.getJavaString(), "id", 0, 1,
	...
	protected void createKermetaAnnotations() {
		...
		addAnnotation(this, source, new String[] { "ecoreUri",
				"http://www.kermeta.org/km2ecore/helper/java" });
		addAnnotation(
				identifierHelperEClass.getEOperations().get(0),
				source,
