 ...
 * </copyright>
 *
 * $Id: KM2EcoreContextImpl.java,v 1.4 2008-10-08 14:37:47 cfaucher Exp $
 */
...
public class KM2EcoreContextImpl extends ObjectImpl implements KM2EcoreContext {
	...
	public String printLbdExpSuffix() {
		...
		idIfCond_1001 = kermeta.standard.helper.BooleanWrapper.and(this
	...
	public String getResultLastStatementType() {
		...
		idIfCond_1002 = kermeta.standard.helper.IntegerWrapper.isGreater(this
	...
	public void popResultLastStatementStack() {
		...
		idIfCond_1003 = kermeta.standard.helper.IntegerWrapper.isGreater(this
				.getResultLastStatementStack().size(), 0);
	...
	public String printFtSuffix() {
		...
		idIfCond_1004 = kermeta.standard.helper.BooleanWrapper.and(this
				.getFtSuffixActivation(),
				kermeta.standard.helper.IntegerWrapper.isGreater(this
						.getFtSuffix().size(), 0));
	...
	public String getResultLastStatementId() {
		...
		idIfCond_1005 = kermeta.standard.helper.IntegerWrapper.isGreater(this
				.getResultLastStatementStack().size(), 0);
