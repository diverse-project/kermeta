 ...
 * </copyright>
 *
 * $Id: KM2EcoreContextImpl.java,v 1.9 2008-11-27 15:50:06 cfaucher Exp $
 */
...
public class KM2EcoreContextImpl extends ObjectImpl implements KM2EcoreContext {
	...
	public String printLbdExpSuffix() {
		...
		idIfCond_1055 = kermeta.standard.helper.BooleanWrapper.and(this
	...
	public String getResultLastStatementType() {
		...
		idIfCond_1056 = kermeta.standard.helper.IntegerWrapper.isGreater(this
	...
	public void popResultLastStatementStack() {
		...
		idIfCond_1057 = kermeta.standard.helper.IntegerWrapper.isGreater(this
				.getResultLastStatementStack().size(), 0);
	...
	public String printFtSuffix() {
		...
		idIfCond_1058 = kermeta.standard.helper.BooleanWrapper.and(this
				.getFtSuffixActivation(),
				kermeta.standard.helper.IntegerWrapper.isGreater(this
						.getFtSuffix().size(), 0));
	...
	public String getResultLastStatementId() {
		...
		idIfCond_1059 = kermeta.standard.helper.IntegerWrapper.isGreater(this
				.getResultLastStatementStack().size(), 0);
	...
	public void initialize(String modelInput, String traceInput) {
		...
		idIfCond_1060 = kermeta.standard.helper.BooleanWrapper
				.and(
