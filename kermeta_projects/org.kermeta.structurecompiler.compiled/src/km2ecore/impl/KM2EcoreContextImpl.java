 ...
 * </copyright>
 *
 * $Id: KM2EcoreContextImpl.java,v 1.6 2008-10-28 13:18:21 cfaucher Exp $
 */
...
public class KM2EcoreContextImpl extends ObjectImpl implements KM2EcoreContext {
	...
	public String printLbdExpSuffix() {
		...
		idIfCond_1054 = kermeta.standard.helper.BooleanWrapper.and(this
	...
	public String getResultLastStatementType() {
		...
		idIfCond_1055 = kermeta.standard.helper.IntegerWrapper.isGreater(this
	...
	public String printFtSuffix() {
		...
		idIfCond_1057 = kermeta.standard.helper.BooleanWrapper.and(this
				.getFtSuffixActivation(),
				kermeta.standard.helper.IntegerWrapper.isGreater(this
						.getFtSuffix().size(), 0));
