...
public class Km2ecorePackageImpl extends EPackageImpl implements
	 ...
	 * 
	 * <p>This method is used to initialize {@link Km2ecorePackage#eINSTANCE} when that field is accessed.
	...
	public static Km2ecorePackage init() {
		...
		Km2ecorePackageImpl theKm2ecorePackage = (Km2ecorePackageImpl) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof Km2ecorePackageImpl ? EPackage.Registry.INSTANCE
				.get(eNS_URI)
		...
		EPackage.Registry.INSTANCE.put(Km2ecorePackage.eNS_URI,
				theKm2ecorePackage);
	 ...
	 * @generated
	 */
	public EAttribute getKM2EcoreContext_JAVA_INSTANCE_EXECUTION_CONTEXT() {
	 ...
	 * @generated
	 */
	public EReference getKM2EcoreContext_Current_param_ft() {
		return (EReference) km2EcoreContextEClass.getEStructuralFeatures().get(
				20);
	}
	 ...
	 * @generated
	 */
	public EAttribute getKM2EcoreContext_OBJECT_UTIL_CLASS() {
		return (EAttribute) km2EcoreContextEClass.getEStructuralFeatures().get(
				26);
	}
	 ...
	 * @generated
	 */
	public EAttribute getKM2EcoreContext_AfterLbdExpActivation() {
		return (EAttribute) km2EcoreContextEClass.getEStructuralFeatures().get(
				41);
	}
	 ...
	 * @generated
	 */
	public EAttribute getKM2EcoreContext_KERMETA_SEPARATOR() {
		return (EAttribute) km2EcoreContextEClass.getEStructuralFeatures().get(
				48);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(km2EcoreContextEClass,
				KM2_ECORE_CONTEXT__JAVA_INSTANCE_EXECUTION_CONTEXT);
		...
		createEAttribute(km2EcoreContextEClass,
				KM2_ECORE_CONTEXT__OBJECT_UTIL_CLASS);
		createEAttribute(km2EcoreContextEClass,
		...
		createEAttribute(km2EcoreContextEClass,
				KM2_ECORE_CONTEXT__KERMETA_SEPARATOR);
		createEAttribute(km2EcoreContextEClass,
	...
	public void initializePackageContents() {
		...
		km2ecore.helper.ecore.EcorePackage theEcorePackage_2 = (km2ecore.helper.ecore.EcorePackage) EPackage.Registry.INSTANCE
				.getEPackage(km2ecore.helper.ecore.EcorePackage.eNS_URI);
		...
		// Add subpackages
		getESubpackages().add(theEcorePackage_2);
		...
		initEAttribute(getKM2EcoreContext_JAVA_INSTANCE_EXECUTION_CONTEXT(),
				theStandardPackage.getJavaString(),
				"JAVA_INSTANCE_EXECUTION_CONTEXT", null, 1, 1,
		...
		g1.getETypeArguments().add(g2);
		EGenericType g3 = createEGenericType(theStructurePackage.getType());
		g2.getETypeArguments().add(g3);
		g3 = createEGenericType(theStructurePackage.getType());
		g2.getETypeArguments().add(g3);
		...
		g2 = createEGenericType(theStandardPackage.getJavaString());
		g1.getETypeArguments().add(g2);
		initEReference(getKM2EcoreContext_Current_param_ft(), g1, null,
				"current_param_ft", null, 0, 1, KM2EcoreContext.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		...
		initEAttribute(getKM2EcoreContext_FtReturnType(), theStandardPackage
				...
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getKM2EcoreContext_OBJECT_UTIL_CLASS(),
				theStandardPackage.getJavaString(), "OBJECT_UTIL_CLASS", null,
				1, 1, KM2EcoreContext.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		...
		initEAttribute(
				...
				theStandardPackage.getJavaString(),
				"RETURN_EXPRESSION_TO_REPLACE_SPECIAL", null, 1, 1,
				KM2EcoreContext.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		...
		initEAttribute(getKM2EcoreContext_JAVA_CLASS_EXCEPTION_SWITCHER(),
				...
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getKM2EcoreContext_AfterLbdExpActivation(),
				theStandardPackage.getJavaBoolean(), "afterLbdExpActivation",
				"false", 1, 1, KM2EcoreContext.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getKM2EcoreContext_SELF_EXPRESSION_TO_REPLACE(),
				...
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getKM2EcoreContext_KERMETA_SEPARATOR(),
				theStandardPackage.getJavaString(), "KERMETA_SEPARATOR", null,
				1, 1, KM2EcoreContext.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		...
		addEOperation(km2EcoreContextEClass,
				theStandardPackage.getJavaString(), "printLbdExpSuffix", 0, 1,
				IS_UNIQUE, IS_ORDERED);
	...
	protected void createKermetaAnnotations() {
		...
		addAnnotation(
				km2EcoreContextEClass.getEOperations().get(9),
				source,
				new String[] {
						"documentation",
		...
		addAnnotation(getKM2EcoreContext_Current_valueType(), source,
				new String[] { "documentation", "/********/" });
		addAnnotation(getKM2EcoreContext_FtSuffix(), source, new String[] {
				"documentation",
