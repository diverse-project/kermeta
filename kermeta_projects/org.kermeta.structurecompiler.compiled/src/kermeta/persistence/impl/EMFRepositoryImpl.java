 ...
 * </copyright>
 *
 * $Id: EMFRepositoryImpl.java,v 1.1 2008-09-04 15:40:39 cfaucher Exp $
 */
...
public class EMFRepositoryImpl extends RepositoryImpl implements EMFRepository {
	...
	public Resource createResource(String uri, String mm_uri) {
		...
		result_ft150 = ((kermeta.standard.Sequence<java.lang.String>) org.kermeta.compil.runtime.helper.language.ClassUtil
				.newObject("kermeta.standard.Sequence<java.lang.String>"));

		{

			kermeta.standard.Iterator<kermeta.persistence.Resource> it_ft150 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil
		...
		idIfCond_694 = kermeta.standard.helper.BooleanWrapper.not(result_ft150
				.contains(uri));
