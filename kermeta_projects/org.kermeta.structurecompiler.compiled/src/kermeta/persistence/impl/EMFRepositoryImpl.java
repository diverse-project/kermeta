 ...
 * </copyright>
 *
 * $Id: EMFRepositoryImpl.java,v 1.5 2008-10-16 13:18:07 cfaucher Exp $
 */
...
public class EMFRepositoryImpl extends RepositoryImpl implements EMFRepository {
	...
	public Resource createResource(String uri, String mm_uri) {
		...
		result_ft227 = ((kermeta.standard.Sequence<java.lang.String>) org.kermeta.compil.runtime.helper.language.ClassUtil
				.newObject("kermeta.standard.Sequence<java.lang.String>"));

		{

			kermeta.standard.Iterator<kermeta.persistence.Resource> it_ft227 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil
		...
		idIfCond_998 = kermeta.standard.helper.BooleanWrapper.not(result_ft227
				.contains(uri));
