 ...
 * </copyright>
 *
 * $Id: Resource.java,v 1.7 2008-10-29 08:29:22 cfaucher Exp $
 */
...
public interface Resource extends Set<kermeta.language.structure.Object> {
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='\nkermeta.standard.Set<kermeta.persistence.DanglingDiagnostic> result = null;\n\n\tresult = ((kermeta.standard.Set<kermeta.persistence.DanglingDiagnostic>) org.kermeta.compil.runtime.helper.language.ClassUtil.newObject(\"kermeta.standard.Set<kermeta.persistence.DanglingDiagnostic>\"));\n\n\t//BIft:each\n\n\t\n{\n\n\tkermeta.standard.Iterator<kermeta.language.structure.Object> it_ft211 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil.<kermeta.language.structure.Object>convertAsSet(this.getterContents()).iterator();\n\tjava.lang.Boolean idLoopCond_941 = false;\n\twhile( !idLoopCond_941 ) {\n\tidLoopCond_941 = it_ft211.isOff();\n\tif ( idLoopCond_941 ) {\n\t} else {\n\n\t//BIle:func\nkermeta.language.structure.Object containedObj_lbdExp211 = it_ft211.next();\n\n\tkermeta.language.structure.ClassDefinition classDef = null;\n\n\tclassDef = (kermeta.language.structure.ClassDefinition) org.kermeta.compil.runtime.helper.language.ObjectUtil.getMetaClassSwitcher(containedObj_lbdExp211).getTypeDefinition();\n\n\tjava.lang.Boolean idIfCond_942 = false;\n\tidIfCond_942 = kermeta.standard.helper.BooleanWrapper.not(org.kermeta.compil.runtime.helper.language.ObjectUtil.isVoidSwitcher(classDef));\n\n\tif( idIfCond_942 ) {\n\n\t//BIft:each\n\n\t\n{\n\n\tkermeta.standard.Iterator<kermeta.language.structure.Property> it_ft212 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil.<kermeta.language.structure.Property>convertAsSet(classDef.getterAllAttribute()).iterator();\n\tjava.lang.Boolean idLoopCond_943 = false;\n\twhile( !idLoopCond_943 ) {\n\tidLoopCond_943 = it_ft212.isOff();\n\tif ( idLoopCond_943 ) {\n\t} else {\n\n\t//BIle:func\nkermeta.language.structure.Property prop_lbdExp212 = it_ft212.next();\n\n\tjava.lang.Boolean idIfCond_944 = false;\n\tidIfCond_944 = kermeta.standard.helper.BooleanWrapper.not(prop_lbdExp212.getIsDerived());\n\n\tif( idIfCond_944 ) {\n\n\tjava.lang.Boolean idIfCond_945 = false;\n\tidIfCond_945 = kermeta.standard.helper.BooleanWrapper.or(kermeta.standard.helper.IntegerWrapper.isGreater(prop_lbdExp212.getUpper(), 1), kermeta.standard.helper.IntegerWrapper.equals(prop_lbdExp212.getUpper(), kermeta.standard.helper.IntegerWrapper.uminus(1)));\n\n\tif( idIfCond_945 ) {\n\n\tkermeta.standard.Collection<kermeta.language.structure.Object> referencedObjs = null;\n\n\treferencedObjs = (kermeta.standard.Collection<kermeta.language.structure.Object>) org.kermeta.compil.runtime.helper.language.ObjectUtil.getSwitcher(containedObj_lbdExp211, prop_lbdExp212);\n\n\tjava.lang.Boolean idIfCond_946 = false;\n\tidIfCond_946 = kermeta.standard.helper.BooleanWrapper.not(org.kermeta.compil.runtime.helper.language.ObjectUtil.isVoidSwitcher(referencedObjs));\n\n\tif( idIfCond_946 ) {\n\n\t//BIft:each\n\n\t\n{\n\n\tkermeta.standard.Iterator<kermeta.language.structure.Object> it_ft213 = referencedObjs.iterator();\n\tjava.lang.Boolean idLoopCond_947 = false;\n\twhile( !idLoopCond_947 ) {\n\tidLoopCond_947 = it_ft213.isOff();\n\tif ( idLoopCond_947 ) {\n\t} else {\n\n\t//BIle:func\nkermeta.language.structure.Object referencedObj_lbdExp213 = it_ft213.next();\n\n\t//BIft:exists\n\njava.lang.Boolean result_ft214 = null;\n\n\tjava.lang.Boolean test_ft214 = false;\n\n\t\n{\n\n\tkermeta.standard.Iterator<kermeta.persistence.Resource> it_ft214 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil.<kermeta.persistence.Resource>convertAsSet(this.getRepository().getResources()).iterator();\n\tjava.lang.Boolean idLoopCond_949 = false;\n\twhile( !idLoopCond_949 ) {\n\tidLoopCond_949 = kermeta.standard.helper.BooleanWrapper.or(it_ft214.isOff(), org.kermeta.compil.runtime.helper.language.ObjectUtil.isNotEqualSwitcher(test_ft214, false));\n\tif ( idLoopCond_949 ) {\n\t} else {\n\njava.lang.Boolean result_lambda_ft214 = null;\n//BIle:func\nkermeta.persistence.Resource res2_lbdExp214 = it_ft214.next();\n\n\tresult_lambda_ft214 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil.<kermeta.language.structure.Object>convertAsSet(res2_lbdExp214.getterContents()).contains(referencedObj_lbdExp213);\n//EIle:func\n\n\ttest_ft214 = kermeta.standard.helper.BooleanWrapper.or(test_ft214, result_lambda_ft214);\n}\n\t}\n}\n\n\n\tresult_ft214 = test_ft214;\n//EIft:exists\njava.lang.Boolean idIfCond_948 = false;\n\tidIfCond_948 = kermeta.standard.helper.BooleanWrapper.and(kermeta.standard.helper.BooleanWrapper.not(result_ft214), kermeta.standard.helper.BooleanWrapper.not(kermeta.standard.helper.BooleanWrapper.or(kermeta.standard.helper.BooleanWrapper.or(org.kermeta.compil.runtime.helper.language.ObjectUtil.isKindOfSwitcher(referencedObj_lbdExp213, org.kermeta.compil.runtime.ExecutionContext.getInstance().getMetaClass(\"java.lang.String\")), org.kermeta.compil.runtime.helper.language.ObjectUtil.isKindOfSwitcher(referencedObj_lbdExp213, org.kermeta.compil.runtime.ExecutionContext.getInstance().getMetaClass(\"java.lang.Integer\"))), org.kermeta.compil.runtime.helper.language.ObjectUtil.isKindOfSwitcher(referencedObj_lbdExp213, org.kermeta.compil.runtime.ExecutionContext.getInstance().getMetaClass(\"java.lang.Boolean\")))));\n\n\tif( idIfCond_948 ) {\n\n\tkermeta.persistence.DanglingDiagnostic diagnostic = ((kermeta.persistence.DanglingDiagnostic) org.kermeta.compil.runtime.helper.language.ClassUtil.newObject(\"kermeta.persistence.DanglingDiagnostic\"));\n\n\tdiagnostic.setDanglingElement(referencedObj_lbdExp213);\n\n\tdiagnostic.setReferencingElement(containedObj_lbdExp211);\n\n\tdiagnostic.setReferencingProperty(prop_lbdExp212);\n\n\tresult.add(diagnostic);\n}\n\n//EIle:func\n\n}\n\t}\n}\n\n//EIft:each\n\n}\n\n}\n else {\n\n\tkermeta.language.structure.Object referencedObj = null;\n\n\treferencedObj = org.kermeta.compil.runtime.helper.language.ObjectUtil.getSwitcher(containedObj_lbdExp211, prop_lbdExp212);\n\n\tjava.lang.Boolean idIfCond_950 = false;\n\tidIfCond_950 = kermeta.standard.helper.BooleanWrapper.not(org.kermeta.compil.runtime.helper.language.ObjectUtil.isVoidSwitcher(referencedObj));\n\n\tif( idIfCond_950 ) {\n\n\t//BIft:exists\n\njava.lang.Boolean result_ft215 = null;\n\n\tjava.lang.Boolean test_ft215 = false;\n\n\t\n{\n\n\tkermeta.standard.Iterator<kermeta.persistence.Resource> it_ft215 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil.<kermeta.persistence.Resource>convertAsSet(this.getRepository().getResources()).iterator();\n\tjava.lang.Boolean idLoopCond_952 = false;\n\twhile( !idLoopCond_952 ) {\n\tidLoopCond_952 = kermeta.standard.helper.BooleanWrapper.or(it_ft215.isOff(), org.kermeta.compil.runtime.helper.language.ObjectUtil.isNotEqualSwitcher(test_ft215, false));\n\tif ( idLoopCond_952 ) {\n\t} else {\n\njava.lang.Boolean result_lambda_ft215 = null;\n//BIle:func\nkermeta.persistence.Resource res2_lbdExp215 = it_ft215.next();\n\n\tresult_lambda_ft215 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil.<kermeta.language.structure.Object>convertAsSet(res2_lbdExp215.getterContents()).contains(referencedObj);\n//EIle:func\n\n\ttest_ft215 = kermeta.standard.helper.BooleanWrapper.or(test_ft215, result_lambda_ft215);\n}\n\t}\n}\n\n\n\tresult_ft215 = test_ft215;\n//EIft:exists\njava.lang.Boolean idIfCond_951 = false;\n\tidIfCond_951 = kermeta.standard.helper.BooleanWrapper.and(kermeta.standard.helper.BooleanWrapper.not(result_ft215), kermeta.standard.helper.BooleanWrapper.not(kermeta.standard.helper.BooleanWrapper.or(kermeta.standard.helper.BooleanWrapper.or(org.kermeta.compil.runtime.helper.language.ObjectUtil.isKindOfSwitcher(referencedObj, org.kermeta.compil.runtime.ExecutionContext.getInstance().getMetaClass(\"java.lang.String\")), org.kermeta.compil.runtime.helper.language.ObjectUtil.isKindOfSwitcher(referencedObj, org.kermeta.compil.runtime.ExecutionContext.getInstance().getMetaClass(\"java.lang.Integer\"))), org.kermeta.compil.runtime.helper.language.ObjectUtil.isKindOfSwitcher(referencedObj, org.kermeta.compil.runtime.ExecutionContext.getInstance().getMetaClass(\"java.lang.Boolean\")))));\n\n\tif( idIfCond_951 ) {\n\n\tkermeta.persistence.DanglingDiagnostic diagnostic = ((kermeta.persistence.DanglingDiagnostic) org.kermeta.compil.runtime.helper.language.ClassUtil.newObject(\"kermeta.persistence.DanglingDiagnostic\"));\n\n\tdiagnostic.setDanglingElement(referencedObj);\n\n\tdiagnostic.setReferencingElement(containedObj_lbdExp211);\n\n\tdiagnostic.setReferencingProperty(prop_lbdExp212);\n\n\tresult.add(diagnostic);\n}\n\n}\n\n}\n\n}\n\n//EIle:func\n\n}\n\t}\n}\n\n//EIft:each\n\n}\n\n//EIle:func\n\n}\n\t}\n}\n\n//EIft:each\n\n\nreturn result;\n'"
	 * @generated
	 */
