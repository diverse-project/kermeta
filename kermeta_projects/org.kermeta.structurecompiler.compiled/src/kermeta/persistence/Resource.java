 ...
 * </copyright>
 *
 * $Id: Resource.java,v 1.6 2008-10-28 13:18:26 cfaucher Exp $
 */
...
public interface Resource extends Set<kermeta.language.structure.Object> {
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='\nkermeta.standard.Set<kermeta.persistence.DanglingDiagnostic> result = null;\n\n\tresult = ((kermeta.standard.Set<kermeta.persistence.DanglingDiagnostic>) org.kermeta.compil.runtime.helper.language.ClassUtil.newObject(\"kermeta.standard.Set<kermeta.persistence.DanglingDiagnostic>\"));\n\n\t//BIft:each\n\n\t\n{\n\n\tkermeta.standard.Iterator<kermeta.language.structure.Object> it_ft199 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil.<kermeta.language.structure.Object>convertAsSet(this.getterContents()).iterator();\n\tjava.lang.Boolean idLoopCond_902 = false;\n\twhile( !idLoopCond_902 ) {\n\tidLoopCond_902 = it_ft199.isOff();\n\tif ( idLoopCond_902 ) {\n\t} else {\n\n\t//BIle:func\nkermeta.language.structure.Object containedObj_lbdExp199 = it_ft199.next();\n\n\tkermeta.language.structure.ClassDefinition classDef = null;\n\n\tclassDef = (kermeta.language.structure.ClassDefinition) org.kermeta.compil.runtime.helper.language.ObjectUtil.getMetaClassSwitcher(containedObj_lbdExp199).getTypeDefinition();\n\n\tjava.lang.Boolean idIfCond_903 = false;\n\tidIfCond_903 = kermeta.standard.helper.BooleanWrapper.not(org.kermeta.compil.runtime.helper.language.ObjectUtil.isVoidSwitcher(classDef));\n\n\tif( idIfCond_903 ) {\n\n\t//BIft:each\n\n\t\n{\n\n\tkermeta.standard.Iterator<kermeta.language.structure.Property> it_ft200 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil.<kermeta.language.structure.Property>convertAsSet(classDef.getterAllAttribute()).iterator();\n\tjava.lang.Boolean idLoopCond_904 = false;\n\twhile( !idLoopCond_904 ) {\n\tidLoopCond_904 = it_ft200.isOff();\n\tif ( idLoopCond_904 ) {\n\t} else {\n\n\t//BIle:func\nkermeta.language.structure.Property prop_lbdExp200 = it_ft200.next();\n\n\tjava.lang.Boolean idIfCond_905 = false;\n\tidIfCond_905 = kermeta.standard.helper.BooleanWrapper.not(prop_lbdExp200.getIsDerived());\n\n\tif( idIfCond_905 ) {\n\n\tjava.lang.Boolean idIfCond_906 = false;\n\tidIfCond_906 = kermeta.standard.helper.BooleanWrapper.or(kermeta.standard.helper.IntegerWrapper.isGreater(prop_lbdExp200.getUpper(), 1), kermeta.standard.helper.IntegerWrapper.equals(prop_lbdExp200.getUpper(), kermeta.standard.helper.IntegerWrapper.uminus(1)));\n\n\tif( idIfCond_906 ) {\n\n\tkermeta.standard.Collection<kermeta.language.structure.Object> referencedObjs = null;\n\n\treferencedObjs = (kermeta.standard.Collection<kermeta.language.structure.Object>) org.kermeta.compil.runtime.helper.language.ObjectUtil.getSwitcher(containedObj_lbdExp199, prop_lbdExp200);\n\n\tjava.lang.Boolean idIfCond_907 = false;\n\tidIfCond_907 = kermeta.standard.helper.BooleanWrapper.not(org.kermeta.compil.runtime.helper.language.ObjectUtil.isVoidSwitcher(referencedObjs));\n\n\tif( idIfCond_907 ) {\n\n\t//BIft:each\n\n\t\n{\n\n\tkermeta.standard.Iterator<kermeta.language.structure.Object> it_ft201 = referencedObjs.iterator();\n\tjava.lang.Boolean idLoopCond_908 = false;\n\twhile( !idLoopCond_908 ) {\n\tidLoopCond_908 = it_ft201.isOff();\n\tif ( idLoopCond_908 ) {\n\t} else {\n\n\t//BIle:func\nkermeta.language.structure.Object referencedObj_lbdExp201 = it_ft201.next();\n\n\t//BIft:exists\n\njava.lang.Boolean result_ft202 = null;\n\n\tjava.lang.Boolean test_ft202 = false;\n\n\t\n{\n\n\tkermeta.standard.Iterator<kermeta.persistence.Resource> it_ft202 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil.<kermeta.persistence.Resource>convertAsSet(this.getRepository().getResources()).iterator();\n\tjava.lang.Boolean idLoopCond_910 = false;\n\twhile( !idLoopCond_910 ) {\n\tidLoopCond_910 = kermeta.standard.helper.BooleanWrapper.or(it_ft202.isOff(), org.kermeta.compil.runtime.helper.language.ObjectUtil.isNotEqualSwitcher(test_ft202, false));\n\tif ( idLoopCond_910 ) {\n\t} else {\n\njava.lang.Boolean result_lambda_ft202 = null;\n//BIle:func\nkermeta.persistence.Resource res2_lbdExp202 = it_ft202.next();\n\n\tresult_lambda_ft202 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil.<kermeta.language.structure.Object>convertAsSet(res2_lbdExp202.getterContents()).contains(referencedObj_lbdExp201);\n//EIle:func\n\n\ttest_ft202 = kermeta.standard.helper.BooleanWrapper.or(test_ft202, result_lambda_ft202);\n}\n\t}\n}\n\n\n\tresult_ft202 = test_ft202;\n//EIft:exists\njava.lang.Boolean idIfCond_909 = false;\n\tidIfCond_909 = kermeta.standard.helper.BooleanWrapper.and(kermeta.standard.helper.BooleanWrapper.not(result_ft202), kermeta.standard.helper.BooleanWrapper.not(kermeta.standard.helper.BooleanWrapper.or(kermeta.standard.helper.BooleanWrapper.or(org.kermeta.compil.runtime.helper.language.ObjectUtil.isKindOfSwitcher(referencedObj_lbdExp201, org.kermeta.compil.runtime.ExecutionContext.getInstance().getMetaClass(\"java.lang.String\")), org.kermeta.compil.runtime.helper.language.ObjectUtil.isKindOfSwitcher(referencedObj_lbdExp201, org.kermeta.compil.runtime.ExecutionContext.getInstance().getMetaClass(\"java.lang.Integer\"))), org.kermeta.compil.runtime.helper.language.ObjectUtil.isKindOfSwitcher(referencedObj_lbdExp201, org.kermeta.compil.runtime.ExecutionContext.getInstance().getMetaClass(\"java.lang.Boolean\")))));\n\n\tif( idIfCond_909 ) {\n\n\tkermeta.persistence.DanglingDiagnostic diagnostic = ((kermeta.persistence.DanglingDiagnostic) org.kermeta.compil.runtime.helper.language.ClassUtil.newObject(\"kermeta.persistence.DanglingDiagnostic\"));\n\n\tdiagnostic.setDanglingElement(referencedObj_lbdExp201);\n\n\tdiagnostic.setReferencingElement(containedObj_lbdExp199);\n\n\tdiagnostic.setReferencingProperty(prop_lbdExp200);\n\n\tresult.add(diagnostic);\n}\n\n//EIle:func\n\n}\n\t}\n}\n\n//EIft:each\n\n}\n\n}\n else {\n\n\tkermeta.language.structure.Object referencedObj = null;\n\n\treferencedObj = org.kermeta.compil.runtime.helper.language.ObjectUtil.getSwitcher(containedObj_lbdExp199, prop_lbdExp200);\n\n\tjava.lang.Boolean idIfCond_911 = false;\n\tidIfCond_911 = kermeta.standard.helper.BooleanWrapper.not(org.kermeta.compil.runtime.helper.language.ObjectUtil.isVoidSwitcher(referencedObj));\n\n\tif( idIfCond_911 ) {\n\n\t//BIft:exists\n\njava.lang.Boolean result_ft203 = null;\n\n\tjava.lang.Boolean test_ft203 = false;\n\n\t\n{\n\n\tkermeta.standard.Iterator<kermeta.persistence.Resource> it_ft203 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil.<kermeta.persistence.Resource>convertAsSet(this.getRepository().getResources()).iterator();\n\tjava.lang.Boolean idLoopCond_913 = false;\n\twhile( !idLoopCond_913 ) {\n\tidLoopCond_913 = kermeta.standard.helper.BooleanWrapper.or(it_ft203.isOff(), org.kermeta.compil.runtime.helper.language.ObjectUtil.isNotEqualSwitcher(test_ft203, false));\n\tif ( idLoopCond_913 ) {\n\t} else {\n\njava.lang.Boolean result_lambda_ft203 = null;\n//BIle:func\nkermeta.persistence.Resource res2_lbdExp203 = it_ft203.next();\n\n\tresult_lambda_ft203 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil.<kermeta.language.structure.Object>convertAsSet(res2_lbdExp203.getterContents()).contains(referencedObj);\n//EIle:func\n\n\ttest_ft203 = kermeta.standard.helper.BooleanWrapper.or(test_ft203, result_lambda_ft203);\n}\n\t}\n}\n\n\n\tresult_ft203 = test_ft203;\n//EIft:exists\njava.lang.Boolean idIfCond_912 = false;\n\tidIfCond_912 = kermeta.standard.helper.BooleanWrapper.and(kermeta.standard.helper.BooleanWrapper.not(result_ft203), kermeta.standard.helper.BooleanWrapper.not(kermeta.standard.helper.BooleanWrapper.or(kermeta.standard.helper.BooleanWrapper.or(org.kermeta.compil.runtime.helper.language.ObjectUtil.isKindOfSwitcher(referencedObj, org.kermeta.compil.runtime.ExecutionContext.getInstance().getMetaClass(\"java.lang.String\")), org.kermeta.compil.runtime.helper.language.ObjectUtil.isKindOfSwitcher(referencedObj, org.kermeta.compil.runtime.ExecutionContext.getInstance().getMetaClass(\"java.lang.Integer\"))), org.kermeta.compil.runtime.helper.language.ObjectUtil.isKindOfSwitcher(referencedObj, org.kermeta.compil.runtime.ExecutionContext.getInstance().getMetaClass(\"java.lang.Boolean\")))));\n\n\tif( idIfCond_912 ) {\n\n\tkermeta.persistence.DanglingDiagnostic diagnostic = ((kermeta.persistence.DanglingDiagnostic) org.kermeta.compil.runtime.helper.language.ClassUtil.newObject(\"kermeta.persistence.DanglingDiagnostic\"));\n\n\tdiagnostic.setDanglingElement(referencedObj);\n\n\tdiagnostic.setReferencingElement(containedObj_lbdExp199);\n\n\tdiagnostic.setReferencingProperty(prop_lbdExp200);\n\n\tresult.add(diagnostic);\n}\n\n}\n\n}\n\n}\n\n//EIle:func\n\n}\n\t}\n}\n\n//EIft:each\n\n}\n\n//EIle:func\n\n}\n\t}\n}\n\n//EIft:each\n\n\nreturn result;\n'"
	 * @generated
	 */
