 ...
 *
 * $Id: Resource.java,v 1.11 2009-02-10 17:51:57 cfaucher Exp $
 */
...
public interface Resource extends Set<kermeta.language.structure.Object> {
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='\nkermeta.standard.Set<kermeta.persistence.DanglingDiagnostic> result = null;\n\n\tresult = ((kermeta.standard.Set<kermeta.persistence.DanglingDiagnostic>) org.kermeta.compil.runtime.helper.language.ClassUtil.newObject(kermeta.standard.StandardPackage.eINSTANCE.getSet()));\n\n\t//BIft:each\n\n\t\n{\n\n\tkermeta.standard.Iterator<kermeta.language.structure.Object> it_ft232 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil.<kermeta.language.structure.Object>convertAsSet(this.getterContents()).iterator();\n\tjava.lang.Boolean idLoopCond_1045 = false;\n\twhile( !idLoopCond_1045 ) {\n\tidLoopCond_1045 = it_ft232.isOff();\n\tif ( idLoopCond_1045 ) {\n\t} else {\n\n\t//BIle:func\nkermeta.language.structure.Object containedObj_lbdExp232 = it_ft232.next();\n\n\tkermeta.language.structure.ClassDefinition classDef = null;\n\n\tclassDef = (kermeta.language.structure.ClassDefinition) org.kermeta.compil.runtime.helper.language.ObjectUtil.asTypeOrVoid(org.kermeta.compil.runtime.helper.language.ObjectUtil.getMetaClassSwitcher(containedObj_lbdExp232).getTypeDefinition(), \"kermeta.language.structure.ClassDefinition\");\n\n\tjava.lang.Boolean idIfCond_1046 = false;\n\tidIfCond_1046 = kermeta.standard.helper.BooleanWrapper.not(org.kermeta.compil.runtime.helper.language.ObjectUtil.isVoidSwitcher(classDef));\n\n\tif( idIfCond_1046 ) {\n\n\t//BIft:each\n\n\t\n{\n\n\tkermeta.standard.Iterator<kermeta.language.structure.Property> it_ft233 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil.<kermeta.language.structure.Property>convertAsSet(classDef.getterAllAttribute()).iterator();\n\tjava.lang.Boolean idLoopCond_1047 = false;\n\twhile( !idLoopCond_1047 ) {\n\tidLoopCond_1047 = it_ft233.isOff();\n\tif ( idLoopCond_1047 ) {\n\t} else {\n\n\t//BIle:func\nkermeta.language.structure.Property prop_lbdExp233 = it_ft233.next();\n\n\tjava.lang.Boolean idIfCond_1048 = false;\n\tidIfCond_1048 = kermeta.standard.helper.BooleanWrapper.not(prop_lbdExp233.getIsDerived());\n\n\tif( idIfCond_1048 ) {\n\n\tjava.lang.Boolean idIfCond_1049 = false;\n\tidIfCond_1049 = kermeta.standard.helper.BooleanWrapper.or(kermeta.standard.helper.IntegerWrapper.isGreater(prop_lbdExp233.getUpper(), 1), kermeta.standard.helper.IntegerWrapper.equals(prop_lbdExp233.getUpper(), kermeta.standard.helper.IntegerWrapper.uminus(1)));\n\n\tif( idIfCond_1049 ) {\n\n\tkermeta.standard.Collection<kermeta.language.structure.Object> referencedObjs = null;\n\n\treferencedObjs = (kermeta.standard.Collection<kermeta.language.structure.Object>) org.kermeta.compil.runtime.helper.language.ObjectUtil.asTypeOrVoid(org.kermeta.compil.runtime.helper.language.ObjectUtil.getSwitcher(containedObj_lbdExp232, prop_lbdExp233), \"kermeta.standard.Collection<kermeta.language.structure.Object>\");\n\n\tjava.lang.Boolean idIfCond_1050 = false;\n\tidIfCond_1050 = kermeta.standard.helper.BooleanWrapper.not(org.kermeta.compil.runtime.helper.language.ObjectUtil.isVoidSwitcher(referencedObjs));\n\n\tif( idIfCond_1050 ) {\n\n\t//BIft:each\n\n\t\n{\n\n\tkermeta.standard.Iterator<kermeta.language.structure.Object> it_ft234 = referencedObjs.iterator();\n\tjava.lang.Boolean idLoopCond_1051 = false;\n\twhile( !idLoopCond_1051 ) {\n\tidLoopCond_1051 = it_ft234.isOff();\n\tif ( idLoopCond_1051 ) {\n\t} else {\n\n\t//BIle:func\nkermeta.language.structure.Object referencedObj_lbdExp234 = it_ft234.next();\n\n\t//BIft:exists\n\njava.lang.Boolean result_ft235 = null;\n\n\tjava.lang.Boolean test_ft235 = false;\n\n\t\n{\n\n\tkermeta.standard.Iterator<kermeta.persistence.Resource> it_ft235 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil.<kermeta.persistence.Resource>convertAsSet(this.getRepository().getResources()).iterator();\n\tjava.lang.Boolean idLoopCond_1053 = false;\n\twhile( !idLoopCond_1053 ) {\n\tidLoopCond_1053 = kermeta.standard.helper.BooleanWrapper.or(it_ft235.isOff(), org.kermeta.compil.runtime.helper.language.ObjectUtil.isNotEqualSwitcher(test_ft235, false));\n\tif ( idLoopCond_1053 ) {\n\t} else {\n\njava.lang.Boolean result_lambda_ft235 = null;\n//BIle:func\nkermeta.persistence.Resource res2_lbdExp235 = it_ft235.next();\n\n\tresult_lambda_ft235 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil.<kermeta.language.structure.Object>convertAsSet(res2_lbdExp235.getterContents()).contains(referencedObj_lbdExp234);\n//EIle:func\n\n\ttest_ft235 = kermeta.standard.helper.BooleanWrapper.or(test_ft235, result_lambda_ft235);\n}\n\t}\n}\n\n\n\tresult_ft235 = test_ft235;\n//EIft:exists\njava.lang.Boolean idIfCond_1052 = false;\n\tidIfCond_1052 = kermeta.standard.helper.BooleanWrapper.and(kermeta.standard.helper.BooleanWrapper.not(result_ft235), kermeta.standard.helper.BooleanWrapper.not(kermeta.standard.helper.BooleanWrapper.or(kermeta.standard.helper.BooleanWrapper.or(org.kermeta.compil.runtime.helper.language.ObjectUtil.isKindOfSwitcher(referencedObj_lbdExp234, org.kermeta.compil.runtime.ExecutionContext.getInstance().getMetaClass(\"java.lang.String\")), org.kermeta.compil.runtime.helper.language.ObjectUtil.isKindOfSwitcher(referencedObj_lbdExp234, org.kermeta.compil.runtime.ExecutionContext.getInstance().getMetaClass(\"java.lang.Integer\"))), org.kermeta.compil.runtime.helper.language.ObjectUtil.isKindOfSwitcher(referencedObj_lbdExp234, org.kermeta.compil.runtime.ExecutionContext.getInstance().getMetaClass(\"java.lang.Boolean\")))));\n\n\tif( idIfCond_1052 ) {\n\n\tkermeta.persistence.DanglingDiagnostic diagnostic = ((kermeta.persistence.DanglingDiagnostic) org.kermeta.compil.runtime.helper.language.ClassUtil.newObject(kermeta.persistence.PersistencePackage.eINSTANCE.getDanglingDiagnostic()));\n\n\tdiagnostic.setDanglingElement(referencedObj_lbdExp234);\n\n\tdiagnostic.setReferencingElement(containedObj_lbdExp232);\n\n\tdiagnostic.setReferencingProperty(prop_lbdExp233);\n\n\tresult.add(diagnostic);\n}\n\n//EIle:func\n\n}\n\t}\n}\n\n//EIft:each\n\n}\n\n}\n else {\n\n\tkermeta.language.structure.Object referencedObj = null;\n\n\treferencedObj = org.kermeta.compil.runtime.helper.language.ObjectUtil.getSwitcher(containedObj_lbdExp232, prop_lbdExp233);\n\n\tjava.lang.Boolean idIfCond_1054 = false;\n\tidIfCond_1054 = kermeta.standard.helper.BooleanWrapper.not(org.kermeta.compil.runtime.helper.language.ObjectUtil.isVoidSwitcher(referencedObj));\n\n\tif( idIfCond_1054 ) {\n\n\t//BIft:exists\n\njava.lang.Boolean result_ft236 = null;\n\n\tjava.lang.Boolean test_ft236 = false;\n\n\t\n{\n\n\tkermeta.standard.Iterator<kermeta.persistence.Resource> it_ft236 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil.<kermeta.persistence.Resource>convertAsSet(this.getRepository().getResources()).iterator();\n\tjava.lang.Boolean idLoopCond_1056 = false;\n\twhile( !idLoopCond_1056 ) {\n\tidLoopCond_1056 = kermeta.standard.helper.BooleanWrapper.or(it_ft236.isOff(), org.kermeta.compil.runtime.helper.language.ObjectUtil.isNotEqualSwitcher(test_ft236, false));\n\tif ( idLoopCond_1056 ) {\n\t} else {\n\njava.lang.Boolean result_lambda_ft236 = null;\n//BIle:func\nkermeta.persistence.Resource res2_lbdExp236 = it_ft236.next();\n\n\tresult_lambda_ft236 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil.<kermeta.language.structure.Object>convertAsSet(res2_lbdExp236.getterContents()).contains(referencedObj);\n//EIle:func\n\n\ttest_ft236 = kermeta.standard.helper.BooleanWrapper.or(test_ft236, result_lambda_ft236);\n}\n\t}\n}\n\n\n\tresult_ft236 = test_ft236;\n//EIft:exists\njava.lang.Boolean idIfCond_1055 = false;\n\tidIfCond_1055 = kermeta.standard.helper.BooleanWrapper.and(kermeta.standard.helper.BooleanWrapper.not(result_ft236), kermeta.standard.helper.BooleanWrapper.not(kermeta.standard.helper.BooleanWrapper.or(kermeta.standard.helper.BooleanWrapper.or(org.kermeta.compil.runtime.helper.language.ObjectUtil.isKindOfSwitcher(referencedObj, org.kermeta.compil.runtime.ExecutionContext.getInstance().getMetaClass(\"java.lang.String\")), org.kermeta.compil.runtime.helper.language.ObjectUtil.isKindOfSwitcher(referencedObj, org.kermeta.compil.runtime.ExecutionContext.getInstance().getMetaClass(\"java.lang.Integer\"))), org.kermeta.compil.runtime.helper.language.ObjectUtil.isKindOfSwitcher(referencedObj, org.kermeta.compil.runtime.ExecutionContext.getInstance().getMetaClass(\"java.lang.Boolean\")))));\n\n\tif( idIfCond_1055 ) {\n\n\tkermeta.persistence.DanglingDiagnostic diagnostic = ((kermeta.persistence.DanglingDiagnostic) org.kermeta.compil.runtime.helper.language.ClassUtil.newObject(kermeta.persistence.PersistencePackage.eINSTANCE.getDanglingDiagnostic()));\n\n\tdiagnostic.setDanglingElement(referencedObj);\n\n\tdiagnostic.setReferencingElement(containedObj_lbdExp232);\n\n\tdiagnostic.setReferencingProperty(prop_lbdExp233);\n\n\tresult.add(diagnostic);\n}\n\n}\n\n}\n\n}\n\n//EIle:func\n\n}\n\t}\n}\n\n//EIft:each\n\n}\n\n//EIle:func\n\n}\n\t}\n}\n\n//EIft:each\n\n\nreturn result;\n'"
	 * @generated
	 */
	 ...
	 * <!-- end-user-doc -->
	 * @model ordered="false"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='\nkermeta.standard.Set<kermeta.language.structure.Object> result = null;\n\n\tkermeta.standard.Set<kermeta.language.structure.Object> res = ((kermeta.standard.Set<kermeta.language.structure.Object>) org.kermeta.compil.runtime.helper.language.ClassUtil.newObject(kermeta.standard.StandardPackage.eINSTANCE.getSet()));\n\n\tres.addAll(this);\n\n\tkermeta.standard.Set<kermeta.language.structure.Object> coll = null;\n\n\t//BIft:each\n\n\t\n{\n\n\tkermeta.standard.Iterator<kermeta.language.structure.Object> it_ft231 = this.iterator();\n\tjava.lang.Boolean idLoopCond_1044 = false;\n\twhile( !idLoopCond_1044 ) {\n\tidLoopCond_1044 = it_ft231.isOff();\n\tif ( idLoopCond_1044 ) {\n\t} else {\n\n\t//BIle:func\nkermeta.language.structure.Object e_lbdExp231 = it_ft231.next();\n\n\tcoll = (kermeta.standard.Set<kermeta.language.structure.Object>) org.kermeta.compil.runtime.helper.language.ObjectUtil.asTypeOrVoid(org.kermeta.compil.runtime.helper.language.ObjectUtil.getAllContainedObjects(e_lbdExp231), \"kermeta.standard.Set<kermeta.language.structure.Object>\");\n\n\tres.addAll(coll);\n//EIle:func\n\n}\n\t}\n}\n\n//EIft:each\n\n\n\tresult = res;\n\nreturn org.kermeta.compil.runtime.helper.basetypes.CollectionUtil.convertAsEList(result);\n'"
	 * @generated
	 */
