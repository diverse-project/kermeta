 ...
 * </copyright>
 *
 * $Id: Resource.java,v 1.4 2008-10-08 14:37:53 cfaucher Exp $
 */
...
public interface Resource extends Set<kermeta.language.structure.Object> {
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='\nkermeta.standard.Set<kermeta.persistence.DanglingDiagnostic> result = null;\n\n\tresult = ((kermeta.standard.Set<kermeta.persistence.DanglingDiagnostic>) org.kermeta.compil.runtime.helper.language.ClassUtil.newObject(\"kermeta.standard.Set<kermeta.persistence.DanglingDiagnostic>\"));\n\n\t//BIft:each\n\n\t\n{\n\n\tkermeta.standard.Iterator<kermeta.language.structure.Object> it_ft205 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil.<kermeta.language.structure.Object>convertAsSet(this.getterContents()).iterator();\n\tjava.lang.Boolean idLoopCond_920 = false;\n\twhile( !idLoopCond_920 ) {\n\tidLoopCond_920 = it_ft205.isOff();\n\tif ( idLoopCond_920 ) {\n\t} else {\n\n\t//BIle:func\nkermeta.language.structure.Object containedObj_lbdExp205 = it_ft205.next();\n\n\tkermeta.language.structure.ClassDefinition classDef = null;\n\n\tclassDef = (kermeta.language.structure.ClassDefinition) org.kermeta.compil.runtime.helper.language.ObjectUtil.getMetaClass(containedObj_lbdExp205).getTypeDefinition();\n\n\tjava.lang.Boolean idIfCond_921 = false;\n\tidIfCond_921 = kermeta.standard.helper.BooleanWrapper.not(org.kermeta.compil.runtime.helper.language.ObjectUtil.isVoid(classDef));\n\n\tif( idIfCond_921 ) {\n\n\t//BIft:each\n\n\t\n{\n\n\tkermeta.standard.Iterator<kermeta.language.structure.Property> it_ft206 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil.<kermeta.language.structure.Property>convertAsSet(classDef.getterAllAttribute()).iterator();\n\tjava.lang.Boolean idLoopCond_922 = false;\n\twhile( !idLoopCond_922 ) {\n\tidLoopCond_922 = it_ft206.isOff();\n\tif ( idLoopCond_922 ) {\n\t} else {\n\n\t//BIle:func\nkermeta.language.structure.Property prop_lbdExp206 = it_ft206.next();\n\n\tjava.lang.Boolean idIfCond_923 = false;\n\tidIfCond_923 = kermeta.standard.helper.BooleanWrapper.not(prop_lbdExp206.getIsDerived());\n\n\tif( idIfCond_923 ) {\n\n\tjava.lang.Boolean idIfCond_924 = false;\n\tidIfCond_924 = kermeta.standard.helper.BooleanWrapper.or(kermeta.standard.helper.IntegerWrapper.isGreater(prop_lbdExp206.getUpper(), 1), kermeta.standard.helper.IntegerWrapper.equals(prop_lbdExp206.getUpper(), kermeta.standard.helper.IntegerWrapper.uminus(1)));\n\n\tif( idIfCond_924 ) {\n\n\tkermeta.standard.Collection<kermeta.language.structure.Object> referencedObjs = null;\n\n\treferencedObjs = (kermeta.standard.Collection<kermeta.language.structure.Object>) org.kermeta.compil.runtime.helper.language.ObjectUtil.get(containedObj_lbdExp205, prop_lbdExp206);\n\n\tjava.lang.Boolean idIfCond_925 = false;\n\tidIfCond_925 = kermeta.standard.helper.BooleanWrapper.not(org.kermeta.compil.runtime.helper.language.ObjectUtil.isVoid(referencedObjs));\n\n\tif( idIfCond_925 ) {\n\n\t//BIft:each\n\n\t\n{\n\n\tkermeta.standard.Iterator<kermeta.language.structure.Object> it_ft207 = referencedObjs.iterator();\n\tjava.lang.Boolean idLoopCond_926 = false;\n\twhile( !idLoopCond_926 ) {\n\tidLoopCond_926 = it_ft207.isOff();\n\tif ( idLoopCond_926 ) {\n\t} else {\n\n\t//BIle:func\nkermeta.language.structure.Object referencedObj_lbdExp207 = it_ft207.next();\n\n\t//BIft:exists\n\njava.lang.Boolean result_ft208 = null;\n\n\tjava.lang.Boolean test_ft208 = false;\n\n\t\n{\n\n\tkermeta.standard.Iterator<kermeta.persistence.Resource> it_ft208 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil.<kermeta.persistence.Resource>convertAsSet(this.getRepository().getResources()).iterator();\n\tjava.lang.Boolean idLoopCond_928 = false;\n\twhile( !idLoopCond_928 ) {\n\tidLoopCond_928 = kermeta.standard.helper.BooleanWrapper.or(it_ft208.isOff(), org.kermeta.compil.runtime.helper.language.ObjectUtil.isNotEqual(test_ft208, false));\n\tif ( idLoopCond_928 ) {\n\t} else {\n\njava.lang.Boolean result_lambda_ft208 = null;\n//BIle:func\nkermeta.persistence.Resource res2_lbdExp208 = it_ft208.next();\n\n\tresult_lambda_ft208 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil.<kermeta.language.structure.Object>convertAsSet(res2_lbdExp208.getterContents()).contains(referencedObj_lbdExp207);\n//EIle:func\n\n\ttest_ft208 = kermeta.standard.helper.BooleanWrapper.or(test_ft208, result_lambda_ft208);\n}\n\t}\n}\n\n\n\tresult_ft208 = test_ft208;\n//EIft:exists\njava.lang.Boolean idIfCond_927 = false;\n\tidIfCond_927 = kermeta.standard.helper.BooleanWrapper.and(kermeta.standard.helper.BooleanWrapper.not(result_ft208), kermeta.standard.helper.BooleanWrapper.not(kermeta.standard.helper.BooleanWrapper.or(kermeta.standard.helper.BooleanWrapper.or(org.kermeta.compil.runtime.helper.language.ObjectUtil.isKindOf(referencedObj_lbdExp207, org.kermeta.compil.runtime.ExecutionContext.getInstance().getMetaClass(\"java.lang.String\")), org.kermeta.compil.runtime.helper.language.ObjectUtil.isKindOf(referencedObj_lbdExp207, org.kermeta.compil.runtime.ExecutionContext.getInstance().getMetaClass(\"java.lang.Integer\"))), org.kermeta.compil.runtime.helper.language.ObjectUtil.isKindOf(referencedObj_lbdExp207, org.kermeta.compil.runtime.ExecutionContext.getInstance().getMetaClass(\"java.lang.Boolean\")))));\n\n\tif( idIfCond_927 ) {\n\n\tkermeta.persistence.DanglingDiagnostic diagnostic = ((kermeta.persistence.DanglingDiagnostic) org.kermeta.compil.runtime.helper.language.ClassUtil.newObject(\"kermeta.persistence.DanglingDiagnostic\"));\n\n\tdiagnostic.setDanglingElement(referencedObj_lbdExp207);\n\n\tdiagnostic.setReferencingElement(containedObj_lbdExp205);\n\n\tdiagnostic.setReferencingProperty(prop_lbdExp206);\n\n\tresult.add(diagnostic);\n}\n\n//EIle:func\n\n}\n\t}\n}\n\n//EIft:each\n\n}\n\n}\n else {\n\n\tkermeta.language.structure.Object referencedObj = null;\n\n\treferencedObj = org.kermeta.compil.runtime.helper.language.ObjectUtil.get(containedObj_lbdExp205, prop_lbdExp206);\n\n\tjava.lang.Boolean idIfCond_929 = false;\n\tidIfCond_929 = kermeta.standard.helper.BooleanWrapper.not(org.kermeta.compil.runtime.helper.language.ObjectUtil.isVoid(referencedObj));\n\n\tif( idIfCond_929 ) {\n\n\t//BIft:exists\n\njava.lang.Boolean result_ft209 = null;\n\n\tjava.lang.Boolean test_ft209 = false;\n\n\t\n{\n\n\tkermeta.standard.Iterator<kermeta.persistence.Resource> it_ft209 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil.<kermeta.persistence.Resource>convertAsSet(this.getRepository().getResources()).iterator();\n\tjava.lang.Boolean idLoopCond_931 = false;\n\twhile( !idLoopCond_931 ) {\n\tidLoopCond_931 = kermeta.standard.helper.BooleanWrapper.or(it_ft209.isOff(), org.kermeta.compil.runtime.helper.language.ObjectUtil.isNotEqual(test_ft209, false));\n\tif ( idLoopCond_931 ) {\n\t} else {\n\njava.lang.Boolean result_lambda_ft209 = null;\n//BIle:func\nkermeta.persistence.Resource res2_lbdExp209 = it_ft209.next();\n\n\tresult_lambda_ft209 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil.<kermeta.language.structure.Object>convertAsSet(res2_lbdExp209.getterContents()).contains(referencedObj);\n//EIle:func\n\n\ttest_ft209 = kermeta.standard.helper.BooleanWrapper.or(test_ft209, result_lambda_ft209);\n}\n\t}\n}\n\n\n\tresult_ft209 = test_ft209;\n//EIft:exists\njava.lang.Boolean idIfCond_930 = false;\n\tidIfCond_930 = kermeta.standard.helper.BooleanWrapper.and(kermeta.standard.helper.BooleanWrapper.not(result_ft209), kermeta.standard.helper.BooleanWrapper.not(kermeta.standard.helper.BooleanWrapper.or(kermeta.standard.helper.BooleanWrapper.or(org.kermeta.compil.runtime.helper.language.ObjectUtil.isKindOf(referencedObj, org.kermeta.compil.runtime.ExecutionContext.getInstance().getMetaClass(\"java.lang.String\")), org.kermeta.compil.runtime.helper.language.ObjectUtil.isKindOf(referencedObj, org.kermeta.compil.runtime.ExecutionContext.getInstance().getMetaClass(\"java.lang.Integer\"))), org.kermeta.compil.runtime.helper.language.ObjectUtil.isKindOf(referencedObj, org.kermeta.compil.runtime.ExecutionContext.getInstance().getMetaClass(\"java.lang.Boolean\")))));\n\n\tif( idIfCond_930 ) {\n\n\tkermeta.persistence.DanglingDiagnostic diagnostic = ((kermeta.persistence.DanglingDiagnostic) org.kermeta.compil.runtime.helper.language.ClassUtil.newObject(\"kermeta.persistence.DanglingDiagnostic\"));\n\n\tdiagnostic.setDanglingElement(referencedObj);\n\n\tdiagnostic.setReferencingElement(containedObj_lbdExp205);\n\n\tdiagnostic.setReferencingProperty(prop_lbdExp206);\n\n\tresult.add(diagnostic);\n}\n\n}\n\n}\n\n}\n\n//EIle:func\n\n}\n\t}\n}\n\n//EIft:each\n\n}\n\n//EIle:func\n\n}\n\t}\n}\n\n//EIft:each\n\n\nreturn result;\n'"
	 * @generated
	 */
