...
public class OrderedCollectionSuper {
	...
	kermeta.standard.OrderedCollection self, java.lang.Integer index, G element
		...
		idIfCond_1142 = kermeta.standard.helper.BooleanWrapper.or(
	...
	kermeta.standard.OrderedCollection self,
		...
		if (idIfCond_1143) {
			...
			idIfCond_1144 = org.kermeta.compil.runtime.helper.language.TypeUtil
					.isInstanceSwitcher(
			...
			if (idIfCond_1144) {
				...
				idIfCond_1145 = kermeta.standard.helper.IntegerWrapper.equals(
				...
				if (idIfCond_1145) {
					...
					while (!idLoopCond_1146) {
						...
						if (idLoopCond_1146) {
							...
							idIfCond_1147 = kermeta.standard.helper.BooleanWrapper
									.not(org.kermeta.compil.runtime.helper.language.ObjectUtil
											.equalsSwitcher(
													selfIterator.next(),
