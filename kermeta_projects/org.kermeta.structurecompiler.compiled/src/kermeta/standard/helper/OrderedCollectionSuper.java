...
public class OrderedCollectionSuper {
	...
	kermeta.standard.OrderedCollection self, java.lang.Integer index, G element
		...
		idIfCond_936 = kermeta.standard.helper.BooleanWrapper.or(
	...
	kermeta.standard.OrderedCollection self,
		...
		if (idIfCond_937) {
			...
			idIfCond_938 = org.kermeta.compil.runtime.helper.language.TypeUtil
			...
			if (idIfCond_938) {
				...
				idIfCond_939 = kermeta.standard.helper.IntegerWrapper.equals(
				...
				if (idIfCond_939) {
					...
					while (!idLoopCond_940) {
						idLoopCond_940 = kermeta.standard.helper.BooleanWrapper
