...
public class OrderedCollectionSuper {
	...
	kermeta.standard.OrderedCollection self, java.lang.Integer index, G element
		...
		idIfCond_1108 = kermeta.standard.helper.BooleanWrapper.or(
	...
	kermeta.standard.OrderedCollection self,
		...
		if (idIfCond_1109) {
			...
			idIfCond_1110 = org.kermeta.compil.runtime.helper.language.TypeUtil
					.isInstanceSwitcher(
			...
			if (idIfCond_1110) {
				...
				idIfCond_1111 = kermeta.standard.helper.IntegerWrapper.equals(
				...
				if (idIfCond_1111) {
					...
					while (!idLoopCond_1112) {
						...
						if (idLoopCond_1112) {
							...
							idIfCond_1113 = kermeta.standard.helper.BooleanWrapper
									.not(org.kermeta.compil.runtime.helper.language.ObjectUtil
											.equalsSwitcher(
													selfIterator.next(),
