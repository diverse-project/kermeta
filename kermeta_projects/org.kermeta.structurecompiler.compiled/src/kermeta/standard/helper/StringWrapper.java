...
public class StringWrapper {
	...
	java.lang.String self
...

		{
			...
			kermeta.standard.Iterator<java.lang.String> it_ft166 = set_infos
					.iterator();
			java.lang.Boolean idLoopCond_704 = false;
			while (!idLoopCond_704) {
				idLoopCond_704 = it_ft166.isOff();
				if (idLoopCond_704) {
				} else {

					//BIle:func
					java.lang.String i_lbdExp166 = it_ft166.next();
					...
					idIfCond_705 = kermeta.standard.helper.IntegerWrapper
  ...
  
{
  ...
  kermeta.standard.Iterator<java.lang.String> it_ft167 = set_str.iterator();
  java.lang.Boolean idLoopCond_711 = false;
  while( !idLoopCond_711 ) {
  idLoopCond_711 = it_ft167.isOff();
  if ( idLoopCond_711 ) {
  } else {

  //BIle:func
java.lang.String seg_lbdExp167 = it_ft167.next();

  java.lang.Boolean idIfCond_712 = false;
  idIfCond_712 = kermeta.standard.helper.IntegerWrapper.isLower(inc_seg, kermeta.standard.helper.IntegerWrapper.minus(set_str.size(), 1));

  if( idIfCond_712 ) {

  result = kermeta.standard.helper.StringWrapper.plus(kermeta.standard.helper.StringWrapper.plus(result, seg_lbdExp167), ".");
}
...
return result;
	...
	java.lang.String self, km2ecore.KM2EcoreContext context
		...
		idIfCond_713 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil
	...
	java.lang.String self, java.lang.Integer index
		...
		idIfCond_715 = kermeta.standard.helper.BooleanWrapper.or(
					...
					if (idLoopCond_720) {
...

						{
							...
							while (!idLoopCond_722) {
								idLoopCond_722 = kermeta.standard.helper.BooleanWrapper
										.or(
												it_ft169.isOff(),
												org.kermeta.compil.runtime.helper.language.ObjectUtil
														.isNotEqual(test_ft169,
																false));
								if (idLoopCond_722) {
								} else {
						...
						if (idIfCond_721) {
							...
							if (idIfCond_723) {
								...
								idIfCond_726 = kermeta.standard.helper.IntegerWrapper
...

								{
									...
									while (!idLoopCond_732) {
										...
										if (idLoopCond_732) {
											...
											org.kermeta.compil.runtime.helper.language.ObjectUtil
													.checkAllInvariants(aSubObjInstances_lbdExp172);
											//EIle:func
