		...
		if (idIfCond_906) {
...

			{
				...
				while (!idLoopCond_907) {
					idLoopCond_907 = it_ft199.isOff();
					if (idLoopCond_907) {
					} else {

						//BIle:func
						kermeta.language.structure.Property prop_lbdExp199 = it_ft199
								.next();

						java.lang.Boolean idIfCond_908 = false;
						idIfCond_908 = kermeta.standard.helper.BooleanWrapper
								.and(prop_lbdExp199.getIsComposite(),
						...
						if (idIfCond_908) {
							...
							if (idIfCond_909) {
...

								{
									...
									kermeta.standard.Iterator<kermeta.language.structure.Type> it_ft200 = ((kermeta.language.structure.ClassDefinition) org.kermeta.compil.runtime.helper.language.ObjectUtil
											.asTypeSwitcher(
													org.kermeta.compil.runtime.helper.language.ObjectUtil
									...
									while (!idLoopCond_911) {
										idLoopCond_911 = kermeta.standard.helper.BooleanWrapper
												.or(
														it_ft200.isOff(),
														org.kermeta.compil.runtime.helper.language.ObjectUtil
																.isNotEqualSwitcher(
										...
										if (idLoopCond_911) {
											...
											//BIle:func
											kermeta.language.structure.Type t_lbdExp200 = it_ft200
													.next();
								...
								if (idIfCond_910) {
...

									{
										...
										kermeta.standard.Iterator<kermeta.language.structure.Object> it_ft201 = subObjInstances
												.iterator();
										java.lang.Boolean idLoopCond_913 = false;
										while (!idLoopCond_913) {
											idLoopCond_913 = it_ft201.isOff();
											if (idLoopCond_913) {
											} else {

												//BIle:func
												kermeta.language.structure.Object aSubObjInstances_lbdExp201 = it_ft201
														.next();

												org.kermeta.compil.runtime.helper.language.ObjectUtil
														.checkAllInvariantsSwitcher(aSubObjInstances_lbdExp201);
												//EIle:func
	...
	java.lang.Character self, kermeta.language.structure.Property property,
		...
		if (idIfCond_914) {
			...
			if (idIfCond_916) {
				...
				//BIle:right
				/*This variable should be never used*/kermeta.language.structure.Object e_lbdExp202 = null;

				result_ft202 = org.kermeta.compil.runtime.helper.language.ObjectUtil
					...
					if (idLoopCond_918) {
						...
						if (idIfCond_919) {
							...
							if (idIfCond_921) {
								...
								idIfCond_924 = kermeta.standard.helper.IntegerWrapper
