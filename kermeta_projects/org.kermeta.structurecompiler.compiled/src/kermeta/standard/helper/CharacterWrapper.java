...
public class CharacterWrapper {
	...
	java.lang.Character self
		...
		idIfCond_895 = org.kermeta.compil.runtime.helper.language.ObjectUtil
							...
							if (idIfCond_898) {
...

								{
									...
									while (!idLoopCond_900) {
										idLoopCond_900 = kermeta.standard.helper.BooleanWrapper
												.or(
														it_ft197.isOff(),
														org.kermeta.compil.runtime.helper.language.ObjectUtil
																.isNotEqualSwitcher(
	...
	java.lang.Character self, kermeta.language.structure.Property property,
		...
		if (idIfCond_903) {
			...
			if (idIfCond_905) {
				...
				//BIle:right
				/*This variable should be never used*/kermeta.language.structure.Object e_lbdExp199 = null;
		...
		if (idIfCond_906) {
...

			{
				...
				while (!idLoopCond_907) {
					idLoopCond_907 = it_ft200.isOff();
					if (idLoopCond_907) {
					} else {

						//BIle:func
						kermeta.language.structure.Property p_lbdExp200 = it_ft200
								.next();
...

						{
							...
							kermeta.standard.Iterator<kermeta.language.structure.Tag> it_ft201 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil
									.<kermeta.language.structure.Tag> convertAsOrderedSet(
											p_lbdExp200.getTag()).iterator();
							...
							while (!idLoopCond_909) {
								...
								if (idLoopCond_909) {
									...
									//BIle:func
									kermeta.language.structure.Tag t_lbdExp201 = it_ft201
											.next();

									result_lambda_ft201 = kermeta.standard.helper.StringWrapper
											.equals(t_lbdExp201.getName(),
													"ecore.isTransient");
									//EIle:func

									test_ft201 = kermeta.standard.helper.BooleanWrapper
											.or(test_ft201, result_lambda_ft201);
								}
							}
						}
						...
						idIfCond_908 = kermeta.standard.helper.BooleanWrapper
								.and(
										kermeta.standard.helper.BooleanWrapper
												.not(result_ft201),
										kermeta.standard.helper.BooleanWrapper
												.not(p_lbdExp200.getIsDerived()));

						if (idIfCond_908) {

							kermeta.language.structure.Object v = org.kermeta.compil.runtime.helper.language.ObjectUtil
									.getSwitcher(self, p_lbdExp200);
							...
							if (idIfCond_911) {
								...
								//BIle:right
								/*This variable should be never used*/kermeta.language.structure.Object f_lbdExp202 = null;
							...
							if (idIfCond_910) {
								...
								idIfCond_914 = kermeta.standard.helper.BooleanWrapper
										.and(
												kermeta.standard.helper.IntegerWrapper
														.equals(p_lbdExp200
																.getLower(), 1),
