...
public interface Bag<G> extends Collection<G> {
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='\n\tG elem = null;\n//BIft:detect\n\nG result_ft175 = null;\n\n\tG elem_ft175 = null;\n\n\tresult_ft175 = null;\n\n\t\n{\n\n\tkermeta.standard.Iterator<G> it_ft175 = this.iterator();\n\tjava.lang.Boolean idLoopCond_778 = false;\n\twhile( !idLoopCond_778 ) {\n\tidLoopCond_778 = kermeta.standard.helper.BooleanWrapper.or(it_ft175.isOff(), org.kermeta.compil.runtime.helper.language.ObjectUtil.isNotEqualSwitcher(result_ft175, null));\n\tif ( idLoopCond_778 ) {\n\t} else {\n\n\telem_ft175 = it_ft175.next();\n\n\tjava.lang.Boolean idIfCond_779 = false;\n//BIle:detector\nG e_lbdExp175 = elem_ft175;\n\n\tidIfCond_779 = org.kermeta.compil.runtime.helper.language.ObjectUtil.equalsSwitcher(e_lbdExp175, element);\n//EIle:detector\n\n\n\tif( idIfCond_779 ) {\n\n\tresult_ft175 = elem_ft175;\n}\n\n}\n\t}\n}\n\n\n//CE\nelem = result_ft175;\n//EIft:detect\n;\n\n\tjava.lang.Boolean idIfCond_780 = false;\n\tidIfCond_780 = org.kermeta.compil.runtime.helper.language.ObjectUtil.isNotEqualSwitcher(elem, null);\n\n\tif( idIfCond_780 ) {\n\n\torg.kermeta.compil.runtime.helper.basetypes.CollectionUtil.remove(this, elem);\n}\n\n'"
	 * @generated
	 */
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='\n\tG elem = null;\n//BIft:detect\n\nG result_ft176 = null;\n\n\tG elem_ft176 = null;\n\n\tresult_ft176 = null;\n\n\t\n{\n\n\tkermeta.standard.Iterator<G> it_ft176 = this.iterator();\n\tjava.lang.Boolean idLoopCond_781 = false;\n\twhile( !idLoopCond_781 ) {\n\tidLoopCond_781 = kermeta.standard.helper.BooleanWrapper.or(it_ft176.isOff(), org.kermeta.compil.runtime.helper.language.ObjectUtil.isNotEqualSwitcher(result_ft176, null));\n\tif ( idLoopCond_781 ) {\n\t} else {\n\n\telem_ft176 = it_ft176.next();\n\n\tjava.lang.Boolean idIfCond_782 = false;\n//BIle:detector\nG e_lbdExp176 = elem_ft176;\n\n\tidIfCond_782 = kermeta.standard.helper.IntegerWrapper.equals(org.kermeta.compil.runtime.helper.language.ObjectUtil.oidSwitcher(e_lbdExp176), elementOid);\n//EIle:detector\n\n\n\tif( idIfCond_782 ) {\n\n\tresult_ft176 = elem_ft176;\n}\n\n}\n\t}\n}\n\n\n//CE\nelem = result_ft176;\n//EIft:detect\n;\n\n\tjava.lang.Boolean idIfCond_783 = false;\n\tidIfCond_783 = org.kermeta.compil.runtime.helper.language.ObjectUtil.isNotEqualSwitcher(elem, null);\n\n\tif( idIfCond_783 ) {\n\n\torg.kermeta.compil.runtime.helper.basetypes.CollectionUtil.remove(this, elem);\n}\n\n\n//PostConditions Checking\n{\nif( org.kermeta.compil.runtime.ExecutionContext.getInstance().mustBeChecked( \"post__13711517__doesntContainsElementAnymore\" ) ) {\njava.lang.Boolean result_post = false;\n\n\t//BIft:exists\n\njava.lang.Boolean result_ft177 = null;\n\n\tjava.lang.Boolean test_ft177 = false;\n\n\t\n{\n\n\tkermeta.standard.Iterator<G> it_ft177 = this.iterator();\n\tjava.lang.Boolean idLoopCond_784 = false;\n\twhile( !idLoopCond_784 ) {\n\tidLoopCond_784 = kermeta.standard.helper.BooleanWrapper.or(it_ft177.isOff(), org.kermeta.compil.runtime.helper.language.ObjectUtil.isNotEqualSwitcher(test_ft177, false));\n\tif ( idLoopCond_784 ) {\n\t} else {\n\njava.lang.Boolean result_lambda_ft177 = null;\n//BIle:func\nG e_lbdExp177 = it_ft177.next();\n\n\tresult_lambda_ft177 = kermeta.standard.helper.IntegerWrapper.equals(org.kermeta.compil.runtime.helper.language.ObjectUtil.oidSwitcher(e_lbdExp177), elementOid);\n//EIle:func\n\n\ttest_ft177 = kermeta.standard.helper.BooleanWrapper.or(test_ft177, result_lambda_ft177);\n}\n\t}\n}\n\n\n\tresult_ft177 = test_ft177;\n//EIft:exists\nresult_post = kermeta.standard.helper.BooleanWrapper.not(result_ft177);\nif( !result_post ) {\nkermeta.exceptions.ConstraintViolatedPost exp = kermeta.exceptions.ExceptionsFactory.eINSTANCE.createConstraintViolatedPost();\nthrow new org.kermeta.compil.runtime.helper.error.KRuntimeError(exp);\n}\n}\n}'"
	 * @generated
	 */
