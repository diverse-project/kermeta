 ...
 * </copyright>
 *
 * $Id: Set.java,v 1.10 2009-01-21 09:15:57 cfaucher Exp $
 */
...
public interface Set<G> extends Collection<G> {
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='\n\tG elem = null;\n//BIft:detect\n\nG result_ft159 = null;\n\n\tG elem_ft159 = null;\n\n\tresult_ft159 = null;\n\n\t\n{\n\n\tkermeta.standard.Iterator<G> it_ft159 = this.iterator();\n\tjava.lang.Boolean idLoopCond_707 = false;\n\twhile( !idLoopCond_707 ) {\n\tidLoopCond_707 = kermeta.standard.helper.BooleanWrapper.or(it_ft159.isOff(), org.kermeta.compil.runtime.helper.language.ObjectUtil.isNotEqualSwitcher(result_ft159, null));\n\tif ( idLoopCond_707 ) {\n\t} else {\n\n\telem_ft159 = it_ft159.next();\n\n\tjava.lang.Boolean idIfCond_708 = false;\n//BIle:detector\nG e_lbdExp159 = elem_ft159;\n\n\tidIfCond_708 = org.kermeta.compil.runtime.helper.language.ObjectUtil.equalsSwitcher(e_lbdExp159, element);\n//EIle:detector\n\n\n\tif( idIfCond_708 ) {\n\n\tresult_ft159 = elem_ft159;\n}\n\n}\n\t}\n}\n\n\n//CE\nelem = result_ft159;\n//EIft:detect\n\n\n\tjava.lang.Boolean idIfCond_709 = false;\n\tidIfCond_709 = org.kermeta.compil.runtime.helper.language.ObjectUtil.isNotEqualSwitcher(elem, null);\n\n\tif( idIfCond_709 ) {\n\n\torg.kermeta.compil.runtime.helper.basetypes.CollectionUtil.remove(this, elem);\n}\n\n'"
	 * @generated
	 */
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='\njava.lang.Boolean result = null;\n\n\tjava.lang.Boolean isEqual = false;\n\n\tjava.lang.Boolean idIfCond_710 = false;\n\tidIfCond_710 = kermeta.standard.helper.BooleanWrapper.not(org.kermeta.compil.runtime.helper.language.ObjectUtil.isVoidSwitcher(element));\n\n\tif( idIfCond_710 ) {\n\n\tjava.lang.Boolean idIfCond_711 = false;\n\tidIfCond_711 = org.kermeta.compil.runtime.helper.language.TypeUtil.isInstanceSwitcher(org.kermeta.compil.runtime.ExecutionContext.getInstance().getMetaClass(\"kermeta.standard.Collection<G>\"), element);\n\n\tif( idIfCond_711 ) {\n\n\tkermeta.standard.Collection<G> collection = null;\n\n\tcollection = (kermeta.standard.Collection<G>) org.kermeta.compil.runtime.helper.language.ObjectUtil.asTypeOrVoid(element, \"kermeta.standard.Collection<G>\");\n\n\tjava.lang.Boolean idIfCond_712 = false;\n\tidIfCond_712 = kermeta.standard.helper.IntegerWrapper.equals(this.size(), collection.size());\n\n\tif( idIfCond_712 ) {\n\n\tG elem = null;\n\n\tjava.lang.Boolean ok = true;\n\n\t\n{\n\n\tkermeta.standard.Iterator<G> it = this.iterator();\n\tjava.lang.Boolean idLoopCond_713 = false;\n\twhile( !idLoopCond_713 ) {\n\tidLoopCond_713 = kermeta.standard.helper.BooleanWrapper.or(it.isOff(), kermeta.standard.helper.BooleanWrapper.not(ok));\n\tif ( idLoopCond_713 ) {\n\t} else {\n\n\telem = it.next();\n\n\tjava.lang.Boolean idIfCond_714 = false;\n\tidIfCond_714 = kermeta.standard.helper.BooleanWrapper.not(collection.contains(elem));\n\n\tif( idIfCond_714 ) {\n\n\tok = false;\n}\n\n}\n\t}\n}\n\n\n\tisEqual = ok;\n}\n\n}\n\n}\n\n\n\tresult = isEqual;\n\nreturn result;\n'"
	 * @generated
	 */
	 ...
	 *        annotation="kermeta superOperation='kermeta::standard::Collection'"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='\n\tjava.lang.Boolean idIfCond_715 = false;\n\tidIfCond_715 = kermeta.standard.helper.BooleanWrapper.not(this.contains(element));\n\n\tif( idIfCond_715 ) {\n\n\tsuper.add(element);\n}\n\n'"
	 * @generated
	 */
	void add(G element);
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='\nkermeta.standard.Set<kermeta.language.structure.Object> result = null;\n\n\tkermeta.standard.Set<kermeta.language.structure.Object> res = ((kermeta.standard.Set<kermeta.language.structure.Object>) org.kermeta.compil.runtime.helper.language.ClassUtil.newObject(kermeta.standard.StandardPackage.eINSTANCE.getSet()));\n\n\tjava.lang.Boolean idIfCond_716 = false;\n\tidIfCond_716 = org.kermeta.compil.runtime.helper.language.ObjectUtil.isKindOfSwitcher(org.kermeta.compil.runtime.ExecutionContext.getInstance().getMetaClass(\"G\"), org.kermeta.compil.runtime.ExecutionContext.getInstance().getMetaClass(\"kermeta.standard.Collection<kermeta.language.structure.Object>\"));\n\n\tif( idIfCond_716 ) {\n\n\tkermeta.standard.Collection<kermeta.language.structure.Object> col = null;\n\n\tkermeta.language.structure.Object o = null;\n\n\t//BIft:each\n\n\t\n{\n\n\tkermeta.standard.Iterator<G> it_ft160 = this.iterator();\n\tjava.lang.Boolean idLoopCond_717 = false;\n\twhile( !idLoopCond_717 ) {\n\tidLoopCond_717 = it_ft160.isOff();\n\tif ( idLoopCond_717 ) {\n\t} else {\n\n\t//BIle:func\nG e_lbdExp160 = it_ft160.next();\n\n\tcol = (kermeta.standard.Collection<kermeta.language.structure.Object>) org.kermeta.compil.runtime.helper.language.ObjectUtil.asTypeOrVoid(e_lbdExp160, \"kermeta.standard.Collection<kermeta.language.structure.Object>\");\n\n\tres.addAll(col);\n//EIle:func\n\n}\n\t}\n}\n\n//EIft:each\n\n}\n\n\n\tresult = res;\n\nreturn result;\n'"
	 * @generated
	 */
