 ...
 * </copyright>
 *
 * $Id: Set.java,v 1.8 2008-11-07 08:53:25 cfaucher Exp $
 */
...
public interface Set<G> extends Collection<G> {
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='\n\tG elem = null;\n//BIft:detect\n\nG result_ft190 = null;\n\n\tG elem_ft190 = null;\n\n\tresult_ft190 = null;\n\n\t\n{\n\n\tkermeta.standard.Iterator<G> it_ft190 = this.iterator();\n\tjava.lang.Boolean idLoopCond_849 = false;\n\twhile( !idLoopCond_849 ) {\n\tidLoopCond_849 = kermeta.standard.helper.BooleanWrapper.or(it_ft190.isOff(), org.kermeta.compil.runtime.helper.language.ObjectUtil.isNotEqualSwitcher(result_ft190, null));\n\tif ( idLoopCond_849 ) {\n\t} else {\n\n\telem_ft190 = it_ft190.next();\n\n\tjava.lang.Boolean idIfCond_850 = false;\n//BIle:detector\nG e_lbdExp190 = elem_ft190;\n\n\tidIfCond_850 = org.kermeta.compil.runtime.helper.language.ObjectUtil.equalsSwitcher(e_lbdExp190, element);\n//EIle:detector\n\n\n\tif( idIfCond_850 ) {\n\n\tresult_ft190 = elem_ft190;\n}\n\n}\n\t}\n}\n\n\n//CE\nelem = result_ft190;\n//EIft:detect\n\n\n\tjava.lang.Boolean idIfCond_851 = false;\n\tidIfCond_851 = org.kermeta.compil.runtime.helper.language.ObjectUtil.isNotEqualSwitcher(elem, null);\n\n\tif( idIfCond_851 ) {\n\n\torg.kermeta.compil.runtime.helper.basetypes.CollectionUtil.remove(this, elem);\n}\n\n'"
	 * @generated
	 */
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='\njava.lang.Boolean result = null;\n\n\tjava.lang.Boolean isEqual = false;\n\n\tjava.lang.Boolean idIfCond_852 = false;\n\tidIfCond_852 = kermeta.standard.helper.BooleanWrapper.not(org.kermeta.compil.runtime.helper.language.ObjectUtil.isVoidSwitcher(element));\n\n\tif( idIfCond_852 ) {\n\n\tjava.lang.Boolean idIfCond_853 = false;\n\tidIfCond_853 = org.kermeta.compil.runtime.helper.language.TypeUtil.isInstanceSwitcher(org.kermeta.compil.runtime.ExecutionContext.getInstance().getMetaClass(\"kermeta.standard.Collection<G>\"), element);\n\n\tif( idIfCond_853 ) {\n\n\tkermeta.standard.Collection<G> collection = null;\n\n\tcollection = (kermeta.standard.Collection<G>) org.kermeta.compil.runtime.ExecutionContext.getInstance().<kermeta.standard.Collection<G>>asTypeOrVoid(element);\n\n\tjava.lang.Boolean idIfCond_854 = false;\n\tidIfCond_854 = kermeta.standard.helper.IntegerWrapper.equals(this.size(), collection.size());\n\n\tif( idIfCond_854 ) {\n\n\tG elem = null;\n\n\tjava.lang.Boolean ok = true;\n\n\t\n{\n\n\tkermeta.standard.Iterator<G> it = this.iterator();\n\tjava.lang.Boolean idLoopCond_855 = false;\n\twhile( !idLoopCond_855 ) {\n\tidLoopCond_855 = kermeta.standard.helper.BooleanWrapper.or(it.isOff(), kermeta.standard.helper.BooleanWrapper.not(ok));\n\tif ( idLoopCond_855 ) {\n\t} else {\n\n\telem = it.next();\n\n\tjava.lang.Boolean idIfCond_856 = false;\n\tidIfCond_856 = kermeta.standard.helper.BooleanWrapper.not(collection.contains(elem));\n\n\tif( idIfCond_856 ) {\n\n\tok = false;\n}\n\n}\n\t}\n}\n\n\n\tisEqual = ok;\n}\n\n}\n\n}\n\n\n\tresult = isEqual;\n\nreturn result;\n'"
	 * @generated
	 */
	 ...
	 *        annotation="kermeta superOperation='kermeta::standard::Collection'"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='\n\tjava.lang.Boolean idIfCond_857 = false;\n\tidIfCond_857 = kermeta.standard.helper.BooleanWrapper.not(this.contains(element));\n\n\tif( idIfCond_857 ) {\n\n\tsuper.add(element);\n}\n\n'"
	 * @generated
	 */
	void add(G element);
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='\nkermeta.standard.Set<kermeta.language.structure.Object> result = null;\n\n\tkermeta.standard.Set<kermeta.language.structure.Object> res = ((kermeta.standard.Set<kermeta.language.structure.Object>) org.kermeta.compil.runtime.helper.language.ClassUtil.newObject(\"kermeta.standard.Set<kermeta.language.structure.Object>\"));\n\n\tjava.lang.Boolean idIfCond_858 = false;\n\tidIfCond_858 = org.kermeta.compil.runtime.helper.language.ObjectUtil.isKindOfSwitcher(org.kermeta.compil.runtime.ExecutionContext.getInstance().getMetaClass(\"G\"), org.kermeta.compil.runtime.ExecutionContext.getInstance().getMetaClass(\"kermeta.standard.Collection<kermeta.language.structure.Object>\"));\n\n\tif( idIfCond_858 ) {\n\n\tkermeta.standard.Collection<kermeta.language.structure.Object> col = null;\n\n\tkermeta.language.structure.Object o = null;\n\n\t//BIft:each\n\n\t\n{\n\n\tkermeta.standard.Iterator<G> it_ft191 = this.iterator();\n\tjava.lang.Boolean idLoopCond_859 = false;\n\twhile( !idLoopCond_859 ) {\n\tidLoopCond_859 = it_ft191.isOff();\n\tif ( idLoopCond_859 ) {\n\t} else {\n\n\t//BIle:func\nG e_lbdExp191 = it_ft191.next();\n\n\tcol = (kermeta.standard.Collection<kermeta.language.structure.Object>) org.kermeta.compil.runtime.ExecutionContext.getInstance().<kermeta.standard.Collection<kermeta.language.structure.Object>>asTypeOrVoid(e_lbdExp191);\n\n\tres.addAll(col);\n//EIle:func\n\n}\n\t}\n}\n\n//EIft:each\n\n}\n\n\n\tresult = res;\n\nreturn result;\n'"
	 * @generated
	 */
