 ...
 *
 * $Id: CompilerPackageImpl.java,v 1.12 2009-02-23 15:27:04 cfaucher Exp $
 */
...
public class CompilerPackageImpl extends EPackageImpl implements
	...
	public void initializePackageContents() {
		...
		op = addEOperation(mainEClass, null, "saveSingleEcore", 0, 1,
	...
	protected void createKermetaAnnotations() {
		...
		addAnnotation(mainEClass.getEOperations().get(8), source,
				new String[] { "documentation",
						"/*****************************************/" });
		addAnnotation(mainEClass.getEOperations().get(8), source,
				new String[] { "documentation",
		...
		addAnnotation(mainEClass.getEOperations().get(8), source,
				new String[] { "documentation",
						"/*****************************************/" });
		addAnnotation(
				mainEClass.getEOperations().get(9),
				source,
				new String[] { "documentation",
