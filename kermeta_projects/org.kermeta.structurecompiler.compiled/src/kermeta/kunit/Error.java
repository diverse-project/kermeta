 ...
 * </copyright>
 *
 * $Id: Error.java,v 1.5 2008-10-16 13:18:04 cfaucher Exp $
 */
...
public interface Error extends kermeta.language.structure.Object {
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='\njava.lang.String result = null;\n\n\tjava.lang.Boolean idIfCond_1019 = false;\n\tidIfCond_1019 = org.kermeta.compil.runtime.helper.language.ObjectUtil.equals(this.getKind(), kermeta.kunit.ErrorKind.getByName(\"testError\"));\n\n\tif( idIfCond_1019 ) {\n\n\tresult = org.kermeta.compil.runtime.helper.language.ObjectUtil.toString(this.getError());\n}\n else {\n\n\tresult = kermeta.standard.helper.StringWrapper.plus(org.kermeta.compil.runtime.helper.language.ObjectUtil.getMetaClass(this.getError()).getterName(), \".\");\n\n\tjava.lang.Boolean idIfCond_1020 = false;\n\tidIfCond_1020 = org.kermeta.compil.runtime.helper.language.ObjectUtil.equals(this.getKind(), kermeta.kunit.ErrorKind.getByName(\"setUpError\"));\n\n\tif( idIfCond_1020 ) {\n\n\tresult = kermeta.standard.helper.StringWrapper.plus(result, \"setUp()\");\n}\n else {\n\n\tresult = kermeta.standard.helper.StringWrapper.plus(result, \"tearDown()\");\n}\n\n}\n\n\n\tresult = kermeta.standard.helper.StringWrapper.plus(kermeta.standard.helper.StringWrapper.plus(result, \" raised \"), org.kermeta.compil.runtime.helper.language.ObjectUtil.getMetaClass(this.getException()).getterName());\n\n\tjava.lang.Boolean idIfCond_1021 = false;\n\tidIfCond_1021 = org.kermeta.compil.runtime.helper.language.ObjectUtil.isNotEqual(this.getException().getMessage(), null);\n\n\tif( idIfCond_1021 ) {\n\n\tresult = kermeta.standard.helper.StringWrapper.plus(kermeta.standard.helper.StringWrapper.plus(result, \"\\n    Caused by: \"), this.getException().getMessage());\n}\n else {\n\n\tresult = kermeta.standard.helper.StringWrapper.plus(result, \"\\n    (no message)\");\n}\n\n\n\tjava.lang.Boolean idIfCond_1022 = false;\n\tidIfCond_1022 = org.kermeta.compil.runtime.helper.language.ObjectUtil.isNotEqual(this.getException().getStackTrace(), null);\n\n\tif( idIfCond_1022 ) {\n\n\tresult = kermeta.standard.helper.StringWrapper.plus(kermeta.standard.helper.StringWrapper.plus(result, \"\\n    Stack Trace:\\n\"), this.getException().getStackTrace());\n}\n else {\n\n\tresult = kermeta.standard.helper.StringWrapper.plus(result, \"\\n    (no stack trace)\");\n}\n\n\nreturn result;\n'"
	 * @generated
	 */
	String toString();
