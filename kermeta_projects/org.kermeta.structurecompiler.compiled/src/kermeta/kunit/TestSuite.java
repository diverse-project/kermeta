 ...
 *
 * $Id: TestSuite.java,v 1.11 2009-02-10 17:51:54 cfaucher Exp $
 */
...
public interface TestSuite extends Test {
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='\n\t//BIft:each\n\n\t\n{\n\n\tkermeta.standard.Iterator<kermeta.kunit.Test> it_ft247 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil.<kermeta.kunit.Test>convertAsOrderedSet(this.getTests()).iterator();\n\tjava.lang.Boolean idLoopCond_1118 = false;\n\twhile( !idLoopCond_1118 ) {\n\tidLoopCond_1118 = it_ft247.isOff();\n\tif ( idLoopCond_1118 ) {\n\t} else {\n\n\t//BIle:func\nkermeta.kunit.Test t_lbdExp247 = it_ft247.next();\n\n\tt_lbdExp247.setLogKermeta(this.getLog());\n\n\tt_lbdExp247.run();\n//EIle:func\n\n}\n\t}\n}\n\n//EIft:each\n\n'"
	 * @generated
	 */
	void run();
	 ...
	 * <!-- end-user-doc -->
	 * @model annotation="kermeta documentation='/**\r\n\t  * to be written #####################################################\r\n\t  \052/'"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='\n\t//BIft:select\n\nkermeta.standard.Sequence<kermeta.language.structure.Operation> result_ft249 = null;\n\n\tkermeta.language.structure.Operation elem_ft249 = null;\n\n\tresult_ft249 = ((kermeta.standard.Sequence<kermeta.language.structure.Operation>) org.kermeta.compil.runtime.helper.language.ClassUtil.newObject(kermeta.standard.StandardPackage.eINSTANCE.getSequence()));\n\n\t\n{\n\n\tkermeta.standard.Iterator<kermeta.language.structure.Operation> it_ft249 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil.<kermeta.language.structure.Operation>convertAsOrderedSet(anAspect.getOwnedOperation()).iterator();\n\tjava.lang.Boolean idLoopCond_1120 = false;\n\twhile( !idLoopCond_1120 ) {\n\tidLoopCond_1120 = it_ft249.isOff();\n\tif ( idLoopCond_1120 ) {\n\t} else {\n\n\telem_ft249 = it_ft249.next();\n\n\tjava.lang.Boolean idIfCond_1121 = false;\n//BIle:selector\nkermeta.language.structure.Operation o_lbdExp249 = elem_ft249;\n\n\tjava.lang.Boolean idIfCond_1122 = false;\n\tidIfCond_1122 = kermeta.standard.helper.IntegerWrapper.isGreaterOrEqual(kermeta.standard.helper.StringWrapper.size(o_lbdExp249.getName()), 4);\n\n\tif( idIfCond_1122 ) {\n\n\tidIfCond_1121 = kermeta.standard.helper.StringWrapper.equals(kermeta.standard.helper.StringWrapper.substring(o_lbdExp249.getName(), 0, 4), \"test\");\n}\n else {\n\n\tidIfCond_1121 = false;\n}\n\n//EIle:selector\n\n\n\tif( idIfCond_1121 ) {\n\n\tresult_ft249.add(elem_ft249);\n}\n\n}\n\t}\n}\n\n//EIft:select\n//BIft:each\n\n\t\n{\n\n\tkermeta.standard.Iterator<kermeta.language.structure.Operation> it_ft248 = result_ft249.iterator();\n\tjava.lang.Boolean idLoopCond_1119 = false;\n\twhile( !idLoopCond_1119 ) {\n\tidLoopCond_1119 = it_ft248.isOff();\n\tif ( idLoopCond_1119 ) {\n\t} else {\n\n\t//BIle:func\nkermeta.language.structure.Operation o_lbdExp248 = it_ft248.next();\n\n\tkermeta.kunit.TestCase testCase = null;\n\n\ttestCase = (kermeta.kunit.TestCase) org.kermeta.compil.runtime.helper.language.ObjectUtil.asTypeOrVoid(testCaseClass._new(), \"kermeta.kunit.TestCase\");\n\n\ttestCase.setTestMethodName(o_lbdExp248.getName());\n\n\torg.kermeta.compil.runtime.helper.basetypes.CollectionUtil.<kermeta.kunit.Test>convertAsOrderedSet(this.getTests()).add(testCase);\n//EIle:func\n\n}\n\t}\n}\n\n//EIft:each\n\n'"
	 * @generated
	 */
