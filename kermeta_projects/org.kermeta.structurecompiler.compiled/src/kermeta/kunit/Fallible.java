 ...
 * </copyright>
 *
 * $Id: Fallible.java,v 1.7 2008-10-29 08:29:18 cfaucher Exp $
 */
...
public interface Fallible extends AbstractFallible {
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='\njava.lang.Boolean result = null;\n\n\tjava.lang.Boolean idIfCond_998 = false;\n\tidIfCond_998 = org.kermeta.compil.runtime.helper.language.ObjectUtil.isVoidSwitcher(this.getStopOnFailure());\n\n\tif( idIfCond_998 ) {\n\n\tthis.setStopOnFailure(true);\n}\n\n\n\tresult = this.getStopOnFailure();\n\nreturn result;\n'"
	 * @generated
	 */
	Boolean mustStop();
