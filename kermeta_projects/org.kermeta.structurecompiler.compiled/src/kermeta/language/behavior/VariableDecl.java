...
public interface VariableDecl extends Expression {
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='\njava.lang.Boolean result = null;\n\n\tresult = false;\n\n\tjava.lang.Boolean idIfCond_405 = false;\n\tidIfCond_405 = org.kermeta.compil.runtime.helper.language.ObjectUtil.isInstanceOfSwitcher(this.getInitialization(), org.kermeta.compil.runtime.ExecutionContext.getInstance().getMetaClass(\"kermeta.language.behavior.Literal\"));\n\n\tif( idIfCond_405 ) {\n\n\tjava.lang.Boolean idIfCond_406 = false;\n\tidIfCond_406 = ((kermeta.language.behavior.Literal) org.kermeta.compil.runtime.helper.language.ObjectUtil.asTypeSwitcher(this.getInitialization(), org.kermeta.compil.runtime.ExecutionContext.getInstance().getMetaClass(\"kermeta.language.behavior.Literal\"))).getStaticType().isValueType();\n\n\tif( idIfCond_406 ) {\n\n\tjava.lang.String left_type = this.getStaticType().getTypeQName();\n\n\tjava.lang.Boolean idIfCond_407 = false;\n\tidIfCond_407 = kermeta.standard.helper.StringWrapper.equals(left_type, \"kermeta::language::structure::Object\");\n\n\tif( idIfCond_407 ) {\n\n\tjava.lang.Boolean idIfCond_408 = false;\n\tidIfCond_408 = this.getInitialization().getStaticType().isValueType();\n\n\tif( idIfCond_408 ) {\n\n\tresult = true;\n}\n\n}\n\n}\n\n}\n\n\nreturn result;\n'"
	 * @generated
	 */
