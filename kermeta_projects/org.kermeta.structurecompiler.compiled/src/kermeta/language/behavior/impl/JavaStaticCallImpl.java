 ...
 * </copyright>
 *
 * $Id: JavaStaticCallImpl.java,v 1.6 2008-10-28 13:18:16 cfaucher Exp $
 */
...
public class JavaStaticCallImpl extends ExpressionImpl implements
	...
	public String createBehaviorJava(KM2EcoreContext context) {
		...
		if (idIfCond_618) {
			...
			idIfCond_619 = kermeta.standard.helper.IntegerWrapper.isLower(
		...
		if (idIfCond_620) {
			...
			idIfCond_621 = ((kermeta.language.structure.ClassDefinition) org.kermeta.compil.runtime.helper.language.ObjectUtil
					.asTypeSwitcher(
							this
