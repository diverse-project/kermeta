 ...
 * </copyright>
 *
 * $Id: Conditional.java,v 1.4 2008-10-08 14:37:19 cfaucher Exp $
 */
...
public interface Conditional extends Expression {
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='\njava.lang.Boolean result = null;\n\n\tresult = false;\n\n\tjava.lang.Boolean idIfCond_692 = false;\n\tidIfCond_692 = org.kermeta.compil.runtime.helper.language.ObjectUtil.isInstanceOf(this.getCondition(), org.kermeta.compil.runtime.ExecutionContext.getInstance().getMetaClass(\"kermeta.language.behavior.CallFeature\"));\n\n\tif( idIfCond_692 ) {\n\n\tjava.lang.Boolean idIfCond_693 = false;\n\tidIfCond_693 = ((kermeta.language.behavior.CallFeature) org.kermeta.compil.runtime.helper.language.ObjectUtil.asType(this.getCondition(), org.kermeta.compil.runtime.ExecutionContext.getInstance().getMetaClass(\"kermeta.language.behavior.CallFeature\"))).callsFunctionType();\n\n\tif( idIfCond_693 ) {\n\n\tresult = true;\n}\n\n}\n\n\nreturn result;\n'"
	 * @generated
	 */
