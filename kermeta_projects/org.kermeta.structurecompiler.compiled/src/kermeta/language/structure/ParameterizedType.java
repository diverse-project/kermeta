 ...
 * </copyright>
 *
 * $Id: ParameterizedType.java,v 1.3 2008-09-22 14:47:40 cfaucher Exp $
 */
...
public interface ParameterizedType extends Type {
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='\njava.lang.String result = null;\n\n\tjava.lang.Boolean idIfCond_726 = false;\n\tidIfCond_726 = org.kermeta.compil.runtime.helper.language.ObjectUtil.isNotEqual(this.getTypeDefinition().getEMFInstanceClassName(), \"\");\n\n\tif( idIfCond_726 ) {\n\n\tresult = this.getTypeDefinition().getEMFInstanceClassName();\n}\n else {\n\n\tresult = kermeta.standard.helper.StringWrapper.replace(this.getTypeQName(), \"::\", \".\");\n}\n\n\n\tjava.lang.String str_tpb = \"\";\n\n\tjava.lang.Integer i = 0;\n\n\tjava.lang.Integer i_ = 0;\n\n\t//BIft:each\n\n\t\n{\n\n\tkermeta.standard.Iterator<kermeta.language.structure.TypeVariableBinding> it_ft153 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil.<kermeta.language.structure.TypeVariableBinding>convertAsOrderedSet(this.getTypeParamBinding()).iterator();\n\tjava.lang.Boolean idLoopCond_727 = false;\n\twhile( !idLoopCond_727 ) {\n\tidLoopCond_727 = it_ft153.isOff();\n\tif ( idLoopCond_727 ) {\n\t} else {\n\n\t//BIle:func\nkermeta.language.structure.TypeVariableBinding tpb_lbdExp153 = it_ft153.next();\n\n\tjava.lang.Boolean idIfCond_728 = false;\n\tidIfCond_728 = kermeta.standard.helper.IntegerWrapper.isGreaterOrEqual(i, 1);\n\n\tif( idIfCond_728 ) {\n\n\tstr_tpb = kermeta.standard.helper.StringWrapper.plus(str_tpb, \", \");\n}\n\n\n\tjava.lang.Boolean idIfCond_729 = false;\n\tidIfCond_729 = org.kermeta.compil.runtime.helper.language.ObjectUtil.isVoid(tpb_lbdExp153.getType());\n\n\tif( idIfCond_729 ) {\n\n\torg.kermeta.compil.runtime.helper.io.StdIOUtil.writeln(kermeta.standard.helper.StringWrapper.plus(\"tpb.type.isVoid(): \", org.kermeta.compil.runtime.helper.language.ObjectUtil.toString(this)));\n}\n\n\n\tjava.lang.Boolean idIfCond_730 = false;\n\tidIfCond_730 = kermeta.standard.helper.BooleanWrapper.not(context.getFtSuffixActivation());\n\n\tif( idIfCond_730 ) {\n\n\tjava.lang.Boolean idIfCond_731 = false;\n\tidIfCond_731 = kermeta.standard.helper.BooleanWrapper.not(org.kermeta.compil.runtime.helper.language.ObjectUtil.isVoid(tpb_lbdExp153.getType()));\n\n\tif( idIfCond_731 ) {\n\n\tstr_tpb = kermeta.standard.helper.StringWrapper.plus(str_tpb, tpb_lbdExp153.getType().createBehaviorJava(context));\n}\n\n}\n else {\n\n\tkermeta.language.structure.Type type_from_map = context.getFtMapTypeStack().peek().getValue(tpb_lbdExp153.getType());\n\n\tjava.lang.Boolean idIfCond_732 = false;\n\tidIfCond_732 = kermeta.standard.helper.BooleanWrapper.not(org.kermeta.compil.runtime.helper.language.ObjectUtil.isVoid(type_from_map));\n\n\tif( idIfCond_732 ) {\n\n\tcontext.setFtSuffixActivation(false);\n\n\tstr_tpb = kermeta.standard.helper.StringWrapper.plus(str_tpb, type_from_map.createBehaviorJava(context));\n\n\tcontext.setFtSuffixActivation(true);\n}\n else {\n\n\tcontext.setFtSuffixActivation(false);\n\n\tstr_tpb = kermeta.standard.helper.StringWrapper.plus(str_tpb, context.getFtProductTypeStack().peek().getTypeByIndex(i).createBehaviorJava(context));\n\n\tcontext.setFtSuffixActivation(true);\n}\n\n}\n\n\n\ti = kermeta.standard.helper.IntegerWrapper.plus(i, 1);\n//EIle:func\n\n}\n\t}\n}\n\n//EIft:each\n\n\n\tjava.lang.Boolean idIfCond_733 = false;\n\tidIfCond_733 = org.kermeta.compil.runtime.helper.language.ObjectUtil.isNotEqual(str_tpb, \"\");\n\n\tif( idIfCond_733 ) {\n\n\tresult = kermeta.standard.helper.StringWrapper.plus(kermeta.standard.helper.StringWrapper.plus(kermeta.standard.helper.StringWrapper.plus(result, \"<\"), str_tpb), \">\");\n}\n\n\n\tresult = kermeta.standard.helper.StringWrapper.plus(result, \"\");\n\nreturn result;\n'"
	 * @generated
	 */
