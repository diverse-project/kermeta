 ...
 * </copyright>
 *
 * $Id: Package.java,v 1.3 2008-09-22 14:47:40 cfaucher Exp $
 */
...
public interface Package extends Traceability<EPackage>, NamedElement,
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='\n\tecore.EPackage ecorePackage = this.createEcoreModelElement(context);\n\n\tkermeta.language.structure.Package p = this.getNestingPackage();\n\n\tjava.lang.Boolean idIfCond_700 = false;\n\tidIfCond_700 = org.kermeta.compil.runtime.helper.language.ObjectUtil.isNotEqual(p, null);\n\n\tif( idIfCond_700 ) {\n\n\torg.kermeta.compil.runtime.helper.basetypes.CollectionUtil.<ecore.EPackage>convertAsOrderedSet(p.getEcoreModelElement().getESubpackages()).add(ecorePackage);\n}\n\n\n\tthis.setEcoreModelElement(ecorePackage);\n\n\t//BIft:eachOwnedElement\n\n\tkermeta.language.structure.Package pack_ft141 = this;\n\n\t//BIft:each\n\n\t\n{\n\n\tkermeta.standard.Iterator<kermeta.language.structure.Tag> it_ft142 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil.<kermeta.language.structure.Tag>convertAsOrderedSet(pack_ft141.getOwnedTags()).iterator();\n\tjava.lang.Boolean idLoopCond_701 = false;\n\twhile( !idLoopCond_701 ) {\n\tidLoopCond_701 = it_ft142.isOff();\n\tif ( idLoopCond_701 ) {\n\t} else {\n\n\t//BIle:func\nkermeta.language.structure.Tag o_lbdExp142 = it_ft142.next();\n\n\t//BIle:func\nkermeta.language.structure.Tag cd_lbdExp141 = o_lbdExp142;\n\n\tjava.lang.Boolean idIfCond_702 = false;\n\tidIfCond_702 = kermeta.standard.helper.StringWrapper.equals(cd_lbdExp141.getDeprecated(), \"\");\n\n\tif( idIfCond_702 ) {\n\n\tcd_lbdExp141.applyPass1(context);\n}\n\n//EIle:func\n\n//EIle:func\n\n}\n\t}\n}\n\n//EIft:each\n\n\n\t//BIft:each\n\n\t\n{\n\n\tkermeta.standard.Iterator<kermeta.language.structure.TypeDefinition> it_ft143 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil.<kermeta.language.structure.TypeDefinition>convertAsOrderedSet(pack_ft141.getOwnedTypeDefinition()).iterator();\n\tjava.lang.Boolean idLoopCond_703 = false;\n\twhile( !idLoopCond_703 ) {\n\tidLoopCond_703 = it_ft143.isOff();\n\tif ( idLoopCond_703 ) {\n\t} else {\n\n\t//BIle:func\nkermeta.language.structure.TypeDefinition o_lbdExp143 = it_ft143.next();\n\n\t//BIle:func\nkermeta.language.structure.TypeDefinition cd_lbdExp141 = o_lbdExp143;\n\n\tjava.lang.Boolean idIfCond_704 = false;\n\tidIfCond_704 = kermeta.standard.helper.StringWrapper.equals(cd_lbdExp141.getDeprecated(), \"\");\n\n\tif( idIfCond_704 ) {\n\n\tcd_lbdExp141.applyPass1(context);\n}\n\n//EIle:func\n\n//EIle:func\n\n}\n\t}\n}\n\n//EIft:each\n\n\n\t//BIft:each\n\n\t\n{\n\n\tkermeta.standard.Iterator<kermeta.language.structure.Package> it_ft144 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil.<kermeta.language.structure.Package>convertAsOrderedSet(pack_ft141.getNestedPackage()).iterator();\n\tjava.lang.Boolean idLoopCond_705 = false;\n\twhile( !idLoopCond_705 ) {\n\tidLoopCond_705 = it_ft144.isOff();\n\tif ( idLoopCond_705 ) {\n\t} else {\n\n\t//BIle:func\nkermeta.language.structure.Package p_lbdExp144 = it_ft144.next();\n\n\t//BIle:func\nkermeta.language.structure.Package cd_lbdExp141 = p_lbdExp144;\n\n\tjava.lang.Boolean idIfCond_706 = false;\n\tidIfCond_706 = kermeta.standard.helper.StringWrapper.equals(cd_lbdExp141.getDeprecated(), \"\");\n\n\tif( idIfCond_706 ) {\n\n\tcd_lbdExp141.applyPass1(context);\n}\n\n//EIle:func\n\n//EIle:func\n\n}\n\t}\n}\n\n//EIft:each\n\n//EIft:eachOwnedElement\n\n'"
	 * @generated
	 */
	 ...
	 * <!-- end-user-doc -->
	 * @model annotation="kermeta superOperation='kermeta::language::structure::Object'"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='\n\t//BIft:eachOwnedElement\n\n\tkermeta.language.structure.Package pack_ft146 = this;\n\n\t//BIft:each\n\n\t\n{\n\n\tkermeta.standard.Iterator<kermeta.language.structure.Tag> it_ft147 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil.<kermeta.language.structure.Tag>convertAsOrderedSet(pack_ft146.getOwnedTags()).iterator();\n\tjava.lang.Boolean idLoopCond_709 = false;\n\twhile( !idLoopCond_709 ) {\n\tidLoopCond_709 = it_ft147.isOff();\n\tif ( idLoopCond_709 ) {\n\t} else {\n\n\t//BIle:func\nkermeta.language.structure.Tag o_lbdExp147 = it_ft147.next();\n\n\t//BIle:func\nkermeta.language.structure.Tag p_lbdExp146 = o_lbdExp147;\n\n\tp_lbdExp146.applyPass2BehaviorJava(context);\n//EIle:func\n\n//EIle:func\n\n}\n\t}\n}\n\n//EIft:each\n\n\n\t//BIft:each\n\n\t\n{\n\n\tkermeta.standard.Iterator<kermeta.language.structure.TypeDefinition> it_ft148 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil.<kermeta.language.structure.TypeDefinition>convertAsOrderedSet(pack_ft146.getOwnedTypeDefinition()).iterator();\n\tjava.lang.Boolean idLoopCond_710 = false;\n\twhile( !idLoopCond_710 ) {\n\tidLoopCond_710 = it_ft148.isOff();\n\tif ( idLoopCond_710 ) {\n\t} else {\n\n\t//BIle:func\nkermeta.language.structure.TypeDefinition o_lbdExp148 = it_ft148.next();\n\n\t//BIle:func\nkermeta.language.structure.TypeDefinition p_lbdExp146 = o_lbdExp148;\n\n\tp_lbdExp146.applyPass2BehaviorJava(context);\n//EIle:func\n\n//EIle:func\n\n}\n\t}\n}\n\n//EIft:each\n\n\n\t//BIft:each\n\n\t\n{\n\n\tkermeta.standard.Iterator<kermeta.language.structure.Package> it_ft149 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil.<kermeta.language.structure.Package>convertAsOrderedSet(pack_ft146.getNestedPackage()).iterator();\n\tjava.lang.Boolean idLoopCond_711 = false;\n\twhile( !idLoopCond_711 ) {\n\tidLoopCond_711 = it_ft149.isOff();\n\tif ( idLoopCond_711 ) {\n\t} else {\n\n\t//BIle:func\nkermeta.language.structure.Package p_lbdExp149 = it_ft149.next();\n\n\t//BIle:func\nkermeta.language.structure.Package p_lbdExp146 = p_lbdExp149;\n\n\tp_lbdExp146.applyPass2BehaviorJava(context);\n//EIle:func\n\n//EIle:func\n\n}\n\t}\n}\n\n//EIft:each\n\n//EIft:eachOwnedElement\n\n'"
	 * @generated
	 */
