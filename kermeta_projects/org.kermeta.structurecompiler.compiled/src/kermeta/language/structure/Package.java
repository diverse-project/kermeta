 ...
 *
 * $Id: Package.java,v 1.12 2009-02-10 17:51:52 cfaucher Exp $
 */
...
public interface Package extends Traceability<EPackage>, NamedElement,
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='\n\tecore.EPackage ecorePackage = this.createEcoreModelElement(context);\n\n\tkermeta.language.structure.Package p = this.getNestingPackage();\n\n\tjava.lang.Boolean idIfCond_696 = false;\n\tidIfCond_696 = org.kermeta.compil.runtime.helper.language.ObjectUtil.isNotEqualSwitcher(p, null);\n\n\tif( idIfCond_696 ) {\n\n\torg.kermeta.compil.runtime.helper.basetypes.CollectionUtil.<ecore.EPackage>convertAsOrderedSet(p.getEcoreModelElement().getESubpackages()).add(ecorePackage);\n}\n\n\n\tthis.setEcoreModelElement(ecorePackage);\n\n\t//BIft:eachOwnedElement\n\n\tkermeta.language.structure.Package pack_ft143 = this;\n\n\t//BIft:each\n\n\t\n{\n\n\tkermeta.standard.Iterator<kermeta.language.structure.Tag> it_ft144 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil.<kermeta.language.structure.Tag>convertAsOrderedSet(pack_ft143.getOwnedTags()).iterator();\n\tjava.lang.Boolean idLoopCond_697 = false;\n\twhile( !idLoopCond_697 ) {\n\tidLoopCond_697 = it_ft144.isOff();\n\tif ( idLoopCond_697 ) {\n\t} else {\n\n\t//BIle:func\nkermeta.language.structure.Tag o_lbdExp144 = it_ft144.next();\n\n\t//BIle:func\nkermeta.language.structure.Tag cd_lbdExp143 = o_lbdExp144;\n\n\tjava.lang.Boolean idIfCond_698 = false;\n\tidIfCond_698 = kermeta.standard.helper.StringWrapper.equals(cd_lbdExp143.getDeprecated(), \"\");\n\n\tif( idIfCond_698 ) {\n\n\tcd_lbdExp143.applyPass1(context);\n}\n\n//EIle:func\n\n//EIle:func\n\n}\n\t}\n}\n\n//EIft:each\n\n\n\t//BIft:each\n\n\t\n{\n\n\tkermeta.standard.Iterator<kermeta.language.structure.TypeDefinition> it_ft145 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil.<kermeta.language.structure.TypeDefinition>convertAsOrderedSet(pack_ft143.getOwnedTypeDefinition()).iterator();\n\tjava.lang.Boolean idLoopCond_699 = false;\n\twhile( !idLoopCond_699 ) {\n\tidLoopCond_699 = it_ft145.isOff();\n\tif ( idLoopCond_699 ) {\n\t} else {\n\n\t//BIle:func\nkermeta.language.structure.TypeDefinition o_lbdExp145 = it_ft145.next();\n\n\t//BIle:func\nkermeta.language.structure.TypeDefinition cd_lbdExp143 = o_lbdExp145;\n\n\tjava.lang.Boolean idIfCond_700 = false;\n\tidIfCond_700 = kermeta.standard.helper.StringWrapper.equals(cd_lbdExp143.getDeprecated(), \"\");\n\n\tif( idIfCond_700 ) {\n\n\tcd_lbdExp143.applyPass1(context);\n}\n\n//EIle:func\n\n//EIle:func\n\n}\n\t}\n}\n\n//EIft:each\n\n\n\t//BIft:each\n\n\t\n{\n\n\tkermeta.standard.Iterator<kermeta.language.structure.Package> it_ft146 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil.<kermeta.language.structure.Package>convertAsOrderedSet(pack_ft143.getNestedPackage()).iterator();\n\tjava.lang.Boolean idLoopCond_701 = false;\n\twhile( !idLoopCond_701 ) {\n\tidLoopCond_701 = it_ft146.isOff();\n\tif ( idLoopCond_701 ) {\n\t} else {\n\n\t//BIle:func\nkermeta.language.structure.Package p_lbdExp146 = it_ft146.next();\n\n\t//BIle:func\nkermeta.language.structure.Package cd_lbdExp143 = p_lbdExp146;\n\n\tjava.lang.Boolean idIfCond_702 = false;\n\tidIfCond_702 = kermeta.standard.helper.StringWrapper.equals(cd_lbdExp143.getDeprecated(), \"\");\n\n\tif( idIfCond_702 ) {\n\n\tcd_lbdExp143.applyPass1(context);\n}\n\n//EIle:func\n\n//EIle:func\n\n}\n\t}\n}\n\n//EIft:each\n\n//EIft:eachOwnedElement\n\n'"
	 * @generated
	 */
	 ...
	 * <!-- end-user-doc -->
	 * @model annotation="kermeta superOperation='kermeta::language::structure::Object'"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='\n\t//BIft:eachOwnedElement\n\n\tkermeta.language.structure.Package pack_ft148 = this;\n\n\t//BIft:each\n\n\t\n{\n\n\tkermeta.standard.Iterator<kermeta.language.structure.Tag> it_ft149 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil.<kermeta.language.structure.Tag>convertAsOrderedSet(pack_ft148.getOwnedTags()).iterator();\n\tjava.lang.Boolean idLoopCond_705 = false;\n\twhile( !idLoopCond_705 ) {\n\tidLoopCond_705 = it_ft149.isOff();\n\tif ( idLoopCond_705 ) {\n\t} else {\n\n\t//BIle:func\nkermeta.language.structure.Tag o_lbdExp149 = it_ft149.next();\n\n\t//BIle:func\nkermeta.language.structure.Tag p_lbdExp148 = o_lbdExp149;\n\n\tp_lbdExp148.applyPass2BehaviorJava(context);\n//EIle:func\n\n//EIle:func\n\n}\n\t}\n}\n\n//EIft:each\n\n\n\t//BIft:each\n\n\t\n{\n\n\tkermeta.standard.Iterator<kermeta.language.structure.TypeDefinition> it_ft150 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil.<kermeta.language.structure.TypeDefinition>convertAsOrderedSet(pack_ft148.getOwnedTypeDefinition()).iterator();\n\tjava.lang.Boolean idLoopCond_706 = false;\n\twhile( !idLoopCond_706 ) {\n\tidLoopCond_706 = it_ft150.isOff();\n\tif ( idLoopCond_706 ) {\n\t} else {\n\n\t//BIle:func\nkermeta.language.structure.TypeDefinition o_lbdExp150 = it_ft150.next();\n\n\t//BIle:func\nkermeta.language.structure.TypeDefinition p_lbdExp148 = o_lbdExp150;\n\n\tp_lbdExp148.applyPass2BehaviorJava(context);\n//EIle:func\n\n//EIle:func\n\n}\n\t}\n}\n\n//EIft:each\n\n\n\t//BIft:each\n\n\t\n{\n\n\tkermeta.standard.Iterator<kermeta.language.structure.Package> it_ft151 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil.<kermeta.language.structure.Package>convertAsOrderedSet(pack_ft148.getNestedPackage()).iterator();\n\tjava.lang.Boolean idLoopCond_707 = false;\n\twhile( !idLoopCond_707 ) {\n\tidLoopCond_707 = it_ft151.isOff();\n\tif ( idLoopCond_707 ) {\n\t} else {\n\n\t//BIle:func\nkermeta.language.structure.Package p_lbdExp151 = it_ft151.next();\n\n\t//BIle:func\nkermeta.language.structure.Package p_lbdExp148 = p_lbdExp151;\n\n\tp_lbdExp148.applyPass2BehaviorJava(context);\n//EIle:func\n\n//EIle:func\n\n}\n\t}\n}\n\n//EIft:each\n\n//EIft:eachOwnedElement\n\n'"
	 * @generated
	 */
