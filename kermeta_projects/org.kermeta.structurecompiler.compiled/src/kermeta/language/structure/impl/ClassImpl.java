 ...
 * </copyright>
 *
 * $Id: ClassImpl.java,v 1.6 2008-10-28 13:18:10 cfaucher Exp $
 */
...
public class ClassImpl extends ParameterizedTypeImpl implements
	...
	public Set<Property> allAttributes() {
		...
		result_ft95 = ((kermeta.standard.Sequence<kermeta.language.structure.Property>) org.kermeta.compil.runtime.helper.language.ClassUtil
...

		{
			...
			kermeta.standard.Iterator<kermeta.language.structure.Class> it_ft96 = this
			...
			while (!idLoopCond_230) {
				...
				if (idLoopCond_230) {
					...
					//BIle:func
					kermeta.language.structure.Class s_lbdExp96 = it_ft96
							.next();
...

					{
						...
						kermeta.standard.Iterator<kermeta.language.structure.Property> it_ft97 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil
								.<kermeta.language.structure.Property> convertAsOrderedSet(
										s_lbdExp96.getterOwnedAttribute())
								.iterator();
		...
		while (!idLoopCond_233) {
			...
			if (idLoopCond_233) {
...

				{
					...
					kermeta.standard.Iterator<kermeta.language.structure.Class> it_ft98 = superClasses
							.iterator();
					...
					while (!idLoopCond_234) {
						...
						if (idLoopCond_234) {
							...
							temp
									.addAll(org.kermeta.compil.runtime.helper.basetypes.CollectionUtil
											.<kermeta.language.structure.Class> convertAsSet(s_lbdExp98
													.getterSuperClass()));
							//EIle:func
	...
	public void setLinks(KM2EcoreContext context) {
...

		{
			...
			kermeta.standard.Iterator<kermeta.language.structure.TypeVariableBinding> it_ft99 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil
			...
			while (!idLoopCond_235) {
				...
				if (idLoopCond_235) {
					...
					//BIle:func
					kermeta.language.structure.TypeVariableBinding tpb_lbdExp99 = it_ft99
							.next();
					...
					if (idIfCond_236) {
						...
						if (idIfCond_238) {
							...
							if (idIfCond_239) {
								...
								kermeta.language.structure.ClassDefinition cd = tpb_lbdExp99
										.getType().getClassFromPrimitiveType()
										.getClassDefinitionAsTyped();

								java.lang.Boolean idIfCond_240 = false;
								idIfCond_240 = tpb_lbdExp99.getType()
										.isEDataType();
	...
	public EList<kermeta.language.structure.Class> getterSuperClass() {
...

		{
			...
			kermeta.standard.Iterator<kermeta.language.structure.Type> it_ft94 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil
			...
			while (!idLoopCond_226) {
				...
				if (idLoopCond_226) {
					...
					//BIle:func
					kermeta.language.structure.Type elem_lbdExp94 = it_ft94
							.next();

					java.lang.Boolean idIfCond_227 = false;
					idIfCond_227 = org.kermeta.compil.runtime.helper.language.TypeUtil
							.isInstanceSwitcher(
									org.kermeta.compil.runtime.ExecutionContext
											.getInstance()
											.getMetaClass(
