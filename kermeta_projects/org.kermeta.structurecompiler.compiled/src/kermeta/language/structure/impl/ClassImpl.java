 ...
 * </copyright>
 *
 * $Id: ClassImpl.java,v 1.7 2008-10-29 08:29:11 cfaucher Exp $
 */
...

				{
					...
					while (!idLoopCond_306) {
						...
						if (idLoopCond_306) {
							...
							temp
									.addAll(org.kermeta.compil.runtime.helper.basetypes.CollectionUtil
											.<kermeta.language.structure.Class> convertAsSet(s_lbdExp111
													.getterSuperClass()));
							//EIle:func
					...
					if (idIfCond_308) {
						...
						if (idIfCond_310) {
							...
							if (idIfCond_311) {
								...
								idIfCond_312 = tpb_lbdExp112.getType()
										.isEDataType();
...

		{
			...
			while (!idLoopCond_298) {
				...
				if (idLoopCond_298) {
					...
					idIfCond_299 = org.kermeta.compil.runtime.helper.language.TypeUtil
							.isInstanceSwitcher(
									org.kermeta.compil.runtime.ExecutionContext
											.getInstance()
											.getMetaClass(
