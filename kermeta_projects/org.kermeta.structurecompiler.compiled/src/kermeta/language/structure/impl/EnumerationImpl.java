 ...
 * </copyright>
 *
 * $Id: EnumerationImpl.java,v 1.4 2008-10-08 14:37:29 cfaucher Exp $
 */
...
public class EnumerationImpl extends TraceabilityImpl<EEnum> implements
	...
	public void applyPass1(KM2EcoreContext context) {
...

		{
			...
			kermeta.standard.Iterator<kermeta.language.structure.Tag> it_ft122 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil
			...
			while (!idLoopCond_362) {
				...
				if (idLoopCond_362) {
					...
					//BIle:func
					kermeta.language.structure.Tag o_lbdExp122 = it_ft122
							.next();
...

		{
			...
			kermeta.standard.Iterator<kermeta.language.structure.EnumerationLiteral> it_ft123 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil
			...
			while (!idLoopCond_363) {
				...
				if (idLoopCond_363) {
					...
					//BIle:func
					kermeta.language.structure.EnumerationLiteral l_lbdExp123 = it_ft123
							.next();
