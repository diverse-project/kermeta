...
public class EnumerationImpl extends TraceabilityImpl<EEnum> implements
	...
	public void applyPass1(KM2EcoreContext context) {
...

		{
			...
			kermeta.standard.Iterator<kermeta.language.structure.EnumerationLiteral> it_ft42 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil
			...
			while (!idLoopCond_80) {
				...
				if (idLoopCond_80) {
					...
					//BIle:func
					kermeta.language.structure.EnumerationLiteral l_lbdExp42 = it_ft42
							.next();
