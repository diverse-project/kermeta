 ...
 * </copyright>
 *
 * $Id: EnumerationImpl.java,v 1.3 2008-09-22 14:47:35 cfaucher Exp $
 */
...
public class EnumerationImpl extends TraceabilityImpl<EEnum> implements
	...
	public void applyPass1(KM2EcoreContext context) {
...

		{
			...
			kermeta.standard.Iterator<kermeta.language.structure.Tag> it_ft135 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil
			...
			while (!idLoopCond_679) {
				...
				if (idLoopCond_679) {
					...
					//BIle:func
					kermeta.language.structure.Tag o_lbdExp135 = it_ft135
							.next();
...

		{
			...
			kermeta.standard.Iterator<kermeta.language.structure.EnumerationLiteral> it_ft136 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil
			...
			while (!idLoopCond_680) {
				...
				if (idLoopCond_680) {
					...
					//BIle:func
					kermeta.language.structure.EnumerationLiteral l_lbdExp136 = it_ft136
							.next();
