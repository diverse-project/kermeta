 ...
 * </copyright>
 *
 * $Id: EnumerationImpl.java,v 1.10 2009-01-21 09:15:51 cfaucher Exp $
 */
...
public class EnumerationImpl extends DataTypeImpl implements Enumeration {
	...
	public void applyPass1(KM2EcoreContext context) {
...

		{
			...
			kermeta.standard.Iterator<kermeta.language.structure.EnumerationLiteral> it_ft49 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil
			...
			while (!idLoopCond_103) {
				...
				if (idLoopCond_103) {
					...
					//BIle:func
					kermeta.language.structure.EnumerationLiteral l_lbdExp49 = it_ft49
							.next();
