...
public class StructurePackageImpl extends EPackageImpl implements
	...
	public void initializePackageContents() {
		...
		EGenericType g2 = createEGenericType(theEcorePackage.getEAnnotation());
		...
		primitiveTypeEClass.getEGenericSuperTypes().add(g1);
		g1 = createEGenericType(this.getTraceability());
		g2 = createEGenericType(theEcorePackage.getEDataType());
		g1.getETypeArguments().add(g2);
		primitiveTypeEClass.getEGenericSuperTypes().add(g1);
		...
		g1 = createEGenericType(this.getTraceability());
		g2 = createEGenericType(theEcorePackage.getETypeParameter());
		g1.getETypeArguments().add(g2);
		objectTypeVariableEClass.getEGenericSuperTypes().add(g1);
		g1 = createEGenericType(this.getDataType());
		enumerationEClass.getEGenericSuperTypes().add(g1);
		g1 = createEGenericType(this.getTraceability());
		g2 = createEGenericType(theEcorePackage.getEEnum());
		g1.getETypeArguments().add(g2);
		enumerationEClass.getEGenericSuperTypes().add(g1);
		g1 = createEGenericType(this.getTypeContainer());
		...
		functionTypeEClass.getEGenericSuperTypes().add(g1);
		g1 = createEGenericType(this.getTraceability());
		g2 = createEGenericType(theEcorePackage.getEAnnotation());
		g1.getETypeArguments().add(g2);
		functionTypeEClass.getEGenericSuperTypes().add(g1);
		...
		g1 = createEGenericType(this.getTraceability());
		g2 = createEGenericType(theEcorePackage.getEGenericType());
		g1.getETypeArguments().add(g2);
		...
		initEReference(getModelingUnit_EcorePackages(), theEcorePackage
		...
		initEReference(getModelingUnit_Requires(), this.getRequire(), null,
				...
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getModelingUnit_EntryPoints(), theEcorePackage
		...
		op = addEOperation(modelingUnitEClass,
				theEcorePackage.getEClassifier(),
				"getEClassifierByQualifiedName", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, theStandardPackage.getJavaString(), "qname", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		...
		op = addEOperation(modelingUnitEClass,
				theEcorePackage.getEAnnotation(), "createEcoreModelElement", 0,
				1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, theKm2ecorePackage.getKM2EcoreContext(), "context",
				0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = addEOperation(propertyEClass, theEcorePackage
		...
		op = addEOperation(operationEClass, theEcorePackage.getEOperation(),
		...
		op = addEOperation(primitiveTypeEClass, theEcorePackage.getEDataType(),
				"createEcoreModelElement", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, theKm2ecorePackage.getKM2EcoreContext(), "context",
				0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = addEOperation(objectTypeVariableEClass, theEcorePackage
		...
		op = addEOperation(enumerationEClass, theEcorePackage.getEEnum(),
				"createEcoreModelElement", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, theKm2ecorePackage.getKM2EcoreContext(), "context",
				0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = addEOperation(constraintEClass, theEcorePackage.getEAnnotation(),
				"createEcoreModelElement", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, theKm2ecorePackage.getKM2EcoreContext(), "context",
				0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = addEOperation(enumerationLiteralEClass, theEcorePackage
		...
		op = addEOperation(packageEClass, theEcorePackage.getEPackage(),
				"createEcoreModelElement", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, theKm2ecorePackage.getKM2EcoreContext(), "context",
				0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = addEOperation(parameterEClass, theEcorePackage.getEParameter(),
				"createEcoreModelElement", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, theKm2ecorePackage.getKM2EcoreContext(), "context",
				0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = addEOperation(tagEClass, theEcorePackage.getEAnnotation(),
				"createEcoreModelElement", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, theKm2ecorePackage.getKM2EcoreContext(), "context",
				0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEReference(getClassDefinition_SubClassDefinitions(), this
				...
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getClassDefinition_EcoreDataType(), theEcorePackage
		...
		op = addEOperation(classDefinitionEClass, theEcorePackage.getEClass(),
				"createEcoreModelElement", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, theKm2ecorePackage.getKM2EcoreContext(), "context",
				0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = addEOperation(requireEClass, theEcorePackage.getEAnnotation(),
				"createEcoreModelElement", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, theKm2ecorePackage.getKM2EcoreContext(), "context",
				0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = addEOperation(usingEClass, theEcorePackage.getEAnnotation(),
				"createEcoreModelElement", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, theKm2ecorePackage.getKM2EcoreContext(), "context",
				0, 1, IS_UNIQUE, IS_ORDERED);
		...
		addEParameter(op, this.getTypedElement(), "element", 0, 1, IS_UNIQUE,
				IS_ORDERED);
		addEParameter(op, theEcorePackage.getETypedElement(),
	...
	protected void createKermetaAnnotations() {
		...
		addAnnotation(modelingUnitEClass.getEOperations().get(11), source,
				new String[] { "superOperation",
						"kermeta::language::structure::Object" });
		addAnnotation(
				modelingUnitEClass.getEOperations().get(12),
				source,
				new String[] {
						"documentation",
		...
		addAnnotation(
				classDefinitionEClass.getEOperations().get(9),
				source,
				new String[] {
						"documentation",
