 ...
 * </copyright>
 *
 * $Id: StructurePackageImpl.java,v 1.1 2008-09-04 15:40:29 cfaucher Exp $
 */
...
public class StructurePackageImpl extends EPackageImpl implements
	...
	public void initializePackageContents() {
		...
		op = addEOperation(traceabilityEClass, null,
				"getEcoreModelElementTrace", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(traceabilityEClass_X);
		initEOperation(op, g1);
	...
	protected void createKermetaAnnotations() {
		...
		addAnnotation(classDefinitionEClass.getEOperations().get(2), source,
				new String[] { "superOperation",
						"kermeta::language::structure::Object" });
		addAnnotation(classDefinitionEClass.getEOperations().get(5), source,
				new String[] { "superOperation",
						"kermeta::language::structure::Object" });
