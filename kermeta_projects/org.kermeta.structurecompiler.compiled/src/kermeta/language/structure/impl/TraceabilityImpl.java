 ...
 *
 * $Id: TraceabilityImpl.java,v 1.11 2009-02-10 17:51:44 cfaucher Exp $
 */
 ...
 * <ul>
 *   <li>{@link kermeta.language.structure.impl.TraceabilityImpl#getEcoreModelElement <em>Ecore Model Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class TraceabilityImpl<X> extends ObjectImpl implements Traceability<X> {
	/**
	...
	public X getEcoreModelElement() {
		if (ecoreModelElement != null
			...
			ecoreModelElement = (X) eResolveProxy(oldEcoreModelElement);
	 ...
	 * @generated
	 */
	public X basicGetEcoreModelElement() {
		return ecoreModelElement;
	}
	 ...
	 * @generated
	 */
	public void setEcoreModelElement(X newEcoreModelElement) {
		X oldEcoreModelElement = ecoreModelElement;
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
		case StructurePackage.TRACEABILITY__ECORE_MODEL_ELEMENT:
			setEcoreModelElement((X) newValue);
			return;
		}
