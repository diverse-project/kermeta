 ...
 *
 * $Id: PrimitiveTypeImpl.java,v 1.11 2009-02-10 17:51:45 cfaucher Exp $
 */
...
public class PrimitiveTypeImpl extends TraceabilityImpl<EDataType> implements
	...
	public String createBehaviorJava(KM2EcoreContext context) {
		...
		idIfCond_656 = kermeta.standard.helper.BooleanWrapper.and(
	...
	public void applyPass1(KM2EcoreContext context) {
...

		{
			...
			kermeta.standard.Iterator<kermeta.language.structure.Tag> it_ft136 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil
			...
			while (!idLoopCond_658) {
				...
				if (idLoopCond_658) {
					...
					//BIle:func
					kermeta.language.structure.Tag o_lbdExp136 = it_ft136
							.next();
	...
	public EDataType createEcoreModelElement(KM2EcoreContext context) {
		...
		if (idIfCond_659) {
			...
			idIfCond_660 = kermeta.standard.helper.IntegerWrapper.isGreater(
					etps.size(), 0);
			...
			if (idIfCond_660) {
...

				{
					...
					kermeta.standard.Iterator<java.lang.String> it_ft137 = etps
							.iterator();
					...
					while (!idLoopCond_661) {
						...
						if (idLoopCond_661) {
							...
							idIfCond_662 = org.kermeta.compil.runtime.helper.language.ObjectUtil
									.isNotEqualSwitcher(etp_lbdExp137, "");
		...
		idIfCond_663 = kermeta.standard.helper.BooleanWrapper.and(
				org.kermeta.compil.runtime.helper.language.ObjectUtil
		...
		idIfCond_664 = kermeta.standard.helper.StringWrapper.equals(
				eModelElement.getInstanceClassName(), "");
