 ...
 * </copyright>
 *
 * $Id: PrimitiveTypeImpl.java,v 1.10 2009-01-21 09:15:51 cfaucher Exp $
 */
...
public class PrimitiveTypeImpl extends DataTypeImpl implements PrimitiveType {
	...
	public String createBehaviorJava(KM2EcoreContext context) {
		...
		idIfCond_322 = kermeta.standard.helper.BooleanWrapper.and(
	...
	public void applyPass1(KM2EcoreContext context) {
...

		{
			...
			kermeta.standard.Iterator<kermeta.language.structure.Tag> it_ft112 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil
			...
			while (!idLoopCond_324) {
				...
				if (idLoopCond_324) {
					...
					//BIle:func
					kermeta.language.structure.Tag o_lbdExp112 = it_ft112
							.next();
	...
	public EDataType createEcoreModelElement(KM2EcoreContext context) {
		...
		if (idIfCond_325) {
			...
			idIfCond_326 = kermeta.standard.helper.IntegerWrapper.isGreater(
					etps.size(), 0);
			...
			if (idIfCond_326) {
...

				{
					...
					kermeta.standard.Iterator<java.lang.String> it_ft113 = etps
							.iterator();
					...
					while (!idLoopCond_327) {
						...
						if (idLoopCond_327) {
							...
							idIfCond_328 = org.kermeta.compil.runtime.helper.language.ObjectUtil
									.isNotEqualSwitcher(etp_lbdExp113, "");
		...
		idIfCond_329 = kermeta.standard.helper.BooleanWrapper.and(
				org.kermeta.compil.runtime.helper.language.ObjectUtil
		...
		idIfCond_330 = kermeta.standard.helper.StringWrapper.equals(
				eModelElement.getInstanceClassName(), "");
