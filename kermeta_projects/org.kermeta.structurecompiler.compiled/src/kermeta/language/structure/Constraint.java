 ...
 *
 * $Id: Constraint.java,v 1.11 2009-02-10 17:51:52 cfaucher Exp $
 */
...
public interface Constraint extends Traceability<EAnnotation>, NamedElement {
	 ...
	 * <!-- end-user-doc -->
	 * @model annotation="kermeta superOperation='kermeta::language::structure::Object'"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='\n\tjava.lang.Boolean idIfCond_695 = false;\n\tidIfCond_695 = org.kermeta.compil.runtime.helper.language.ObjectUtil.equalsSwitcher(this.getStereotype(), kermeta.language.structure.ConstraintType.getByName(\"inv\"));\n\n\tif( idIfCond_695 ) {\n\n\tthis.setSimkForInvariant(context);\n}\n\n'"
	 * @generated
	 */
