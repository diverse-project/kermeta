...
public interface Constraint extends NamedElement, Traceability<EAnnotation> {
	 ...
	 * <!-- end-user-doc -->
	 * @model annotation="kermeta superOperation='kermeta::language::structure::Object'"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='\n\tjava.lang.Boolean idIfCond_557 = false;\n\tidIfCond_557 = org.kermeta.compil.runtime.helper.language.ObjectUtil.equalsSwitcher(this.getStereotype(), kermeta.language.structure.ConstraintType.getByName(\"inv\"));\n\n\tif( idIfCond_557 ) {\n\n\tthis.setSimkForInvariant(context);\n}\n\n'"
	 * @generated
	 */
