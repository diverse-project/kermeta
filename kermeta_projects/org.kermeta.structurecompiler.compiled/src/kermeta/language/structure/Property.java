 ...
 * </copyright>
 *
 * $Id: Property.java,v 1.3 2008-09-22 14:47:40 cfaucher Exp $
 */
...
public interface Property extends Traceability<EStructuralFeature>,
	 ...
	 * <!-- end-user-doc -->
	 * @model dataType="kermeta.standard.JavaString"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='\njava.lang.String result = null;\n\n\tresult = \"\";\n\n\tjava.lang.Boolean idIfCond_687 = false;\n\tidIfCond_687 = this.getIsDerived();\n\n\tif( idIfCond_687 ) {\n\n\tresult = \"getter\";\n}\n else {\n\n\tjava.lang.Boolean isBoolean = false;\n\n\tjava.lang.Boolean idIfCond_688 = false;\n\tidIfCond_688 = kermeta.standard.helper.BooleanWrapper.not(org.kermeta.compil.runtime.helper.language.ObjectUtil.isVoid(this.getEcoreModelElement()));\n\n\tif( idIfCond_688 ) {\n\n\tjava.lang.Boolean idIfCond_689 = false;\n\tidIfCond_689 = org.kermeta.compil.runtime.helper.language.ObjectUtil.isInstanceOf(this.getEcoreModelElement(), org.kermeta.compil.runtime.ExecutionContext.getInstance().getMetaClass(\"ecore.EAttribute\"));\n\n\tif( idIfCond_689 ) {\n\n\tjava.lang.Boolean idIfCond_690 = false;\n\tidIfCond_690 = kermeta.standard.helper.StringWrapper.equals(this.getType().getEMFEDataTypeInstanceClassName(), \"boolean\");\n\n\tif( idIfCond_690 ) {\n\n\tisBoolean = true;\n}\n\n}\n\n}\n\n\n\tjava.lang.Boolean idIfCond_691 = false;\n\tidIfCond_691 = isBoolean;\n\n\tif( idIfCond_691 ) {\n\n\tresult = \"is\";\n}\n else {\n\n\tresult = \"get\";\n}\n\n}\n\n\n\tresult = kermeta.standard.helper.StringWrapper.plus(result, kermeta.standard.helper.StringWrapper.capName(this.getFinalName()));\n\nreturn result;\n'"
	 * @generated
	 */
