 ...
 * </copyright>
 *
 * $Id: PrimitiveType.java,v 1.7 2008-10-29 08:29:17 cfaucher Exp $
 */
...
public interface PrimitiveType extends Traceability<EDataType>, DataType,
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='\njava.lang.String result = null;\n\n\tresult = \"\";\n\n\tjava.lang.Boolean idIfCond_64 = false;\n\tidIfCond_64 = kermeta.standard.helper.BooleanWrapper.and(kermeta.standard.helper.BooleanWrapper.not(this.isValueType()), this.isEDataType());\n\n\tif( idIfCond_64 ) {\n\n\tresult = this.getEMFEDataTypeInstanceClassName();\n}\n\n\n\tjava.lang.Boolean idIfCond_65 = false;\n\tidIfCond_65 = kermeta.standard.helper.StringWrapper.equals(result, \"\");\n\n\tif( idIfCond_65 ) {\n\n\tresult = this.getInstanceType().createBehaviorJava(context);\n}\n\n\nreturn result;\n'"
	 * @generated
	 */
