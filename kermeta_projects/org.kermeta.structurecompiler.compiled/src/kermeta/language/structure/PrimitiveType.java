 ...
 * </copyright>
 *
 * $Id: PrimitiveType.java,v 1.4 2008-10-08 14:37:43 cfaucher Exp $
 */
...
public interface PrimitiveType extends Traceability<EDataType>, DataType,
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='\njava.lang.String result = null;\n\n\tresult = \"\";\n\n\tjava.lang.Boolean idIfCond_385 = false;\n\tidIfCond_385 = kermeta.standard.helper.BooleanWrapper.and(kermeta.standard.helper.BooleanWrapper.not(this.isValueType()), this.isEDataType());\n\n\tif( idIfCond_385 ) {\n\n\tresult = this.getEMFEDataTypeInstanceClassName();\n}\n\n\n\tjava.lang.Boolean idIfCond_386 = false;\n\tidIfCond_386 = kermeta.standard.helper.StringWrapper.equals(result, \"\");\n\n\tif( idIfCond_386 ) {\n\n\tresult = this.getInstanceType().createBehaviorJava(context);\n}\n\n\nreturn result;\n'"
	 * @generated
	 */
