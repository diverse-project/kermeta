 ...
 *
 * $Id: PrimitiveType.java,v 1.11 2009-02-10 17:51:53 cfaucher Exp $
 */
...
public interface PrimitiveType extends Traceability<EDataType>, DataType,
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='\njava.lang.String result = null;\n\n\tresult = \"\";\n\n\tjava.lang.Boolean idIfCond_656 = false;\n\tidIfCond_656 = kermeta.standard.helper.BooleanWrapper.and(kermeta.standard.helper.BooleanWrapper.not(this.isValueType()), this.isEDataType());\n\n\tif( idIfCond_656 ) {\n\n\tresult = this.getEMFEDataTypeInstanceClassName();\n}\n\n\n\tjava.lang.Boolean idIfCond_657 = false;\n\tidIfCond_657 = kermeta.standard.helper.StringWrapper.equals(result, \"\");\n\n\tif( idIfCond_657 ) {\n\n\tresult = this.getInstanceType().createBehaviorJava(context);\n}\n\n\nreturn result;\n'"
	 * @generated
	 */
