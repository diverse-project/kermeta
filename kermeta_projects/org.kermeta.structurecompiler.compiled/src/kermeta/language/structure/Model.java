 ...
 * </copyright>
 *
 * $Id: Model.java,v 1.8 2008-11-07 08:53:39 cfaucher Exp $
 */
...
public interface Model extends kermeta.language.structure.Object {
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='\nkermeta.standard.Collection<kermeta.language.structure.Object> result = null;\n\n\tresult = ((kermeta.standard.Set<kermeta.language.structure.Object>) org.kermeta.compil.runtime.helper.language.ClassUtil.newObject(\"kermeta.standard.Set<kermeta.language.structure.Object>\"));\n\n\t//BIft:each\n\n\t\n{\n\n\tkermeta.standard.Iterator<kermeta.language.structure.Object> it_ft126 = objectsToAdd.iterator();\n\tjava.lang.Boolean idLoopCond_405 = false;\n\twhile( !idLoopCond_405 ) {\n\tidLoopCond_405 = it_ft126.isOff();\n\tif ( idLoopCond_405 ) {\n\t} else {\n\n\t//BIle:func\nkermeta.language.structure.Object obj_lbdExp126 = it_ft126.next();\n\n\tkermeta.language.structure.Object addedObject = this.addCompatible(obj_lbdExp126);\n\n\tjava.lang.Boolean idIfCond_406 = false;\n\tidIfCond_406 = kermeta.standard.helper.BooleanWrapper.not(org.kermeta.compil.runtime.helper.language.ObjectUtil.isVoidSwitcher(addedObject));\n\n\tif( idIfCond_406 ) {\n\n\tresult.add(obj_lbdExp126);\n}\n\n//EIle:func\n\n}\n\t}\n}\n\n//EIft:each\n\n\nreturn result;\n'"
	 * @generated
	 */
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='\nkermeta.standard.Set<kermeta.language.structure.Object> result = null;\n\n\t//BIft:select\n\nkermeta.standard.Sequence<kermeta.language.structure.Object> result_ft127 = null;\n\n\tkermeta.language.structure.Object elem_ft127 = null;\n\n\tresult_ft127 = ((kermeta.standard.Sequence<kermeta.language.structure.Object>) org.kermeta.compil.runtime.helper.language.ClassUtil.newObject(\"kermeta.standard.Sequence<kermeta.language.structure.Object>\"));\n\n\t\n{\n\n\tkermeta.standard.Iterator<kermeta.language.structure.Object> it_ft127 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil.<kermeta.language.structure.Object>convertAsOrderedSet(this.getContents()).iterator();\n\tjava.lang.Boolean idLoopCond_407 = false;\n\twhile( !idLoopCond_407 ) {\n\tidLoopCond_407 = it_ft127.isOff();\n\tif ( idLoopCond_407 ) {\n\t} else {\n\n\telem_ft127 = it_ft127.next();\n\n\tjava.lang.Boolean idIfCond_408 = false;\n//BIle:selector\nkermeta.language.structure.Object o_lbdExp127 = elem_ft127;\n\n\tidIfCond_408 = org.kermeta.compil.runtime.helper.language.TypeUtil.isInstanceSwitcher(typeName, o_lbdExp127);\n//EIle:selector\n\n\n\tif( idIfCond_408 ) {\n\n\tresult_ft127.add(elem_ft127);\n}\n\n}\n\t}\n}\n\n//EIft:select\nresult = result_ft127.asSet();\n\nreturn result;\n'"
	 * @generated
	 */
