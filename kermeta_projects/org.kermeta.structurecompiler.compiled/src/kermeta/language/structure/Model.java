 ...
 * </copyright>
 *
 * $Id: Model.java,v 1.5 2008-10-16 13:17:59 cfaucher Exp $
 */
...
public interface Model extends kermeta.language.structure.Object {
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='\nkermeta.standard.Set<kermeta.language.structure.Object> result = null;\n\n\t//BIft:select\n\nkermeta.standard.Sequence<kermeta.language.structure.Object> result_ft124 = null;\n\n\tkermeta.language.structure.Object elem_ft124 = null;\n\n\tresult_ft124 = ((kermeta.standard.Sequence<kermeta.language.structure.Object>) org.kermeta.compil.runtime.helper.language.ClassUtil.newObject(\"kermeta.standard.Sequence<kermeta.language.structure.Object>\"));\n\n\t\n{\n\n\tkermeta.standard.Iterator<kermeta.language.structure.Object> it_ft124 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil.<kermeta.language.structure.Object>convertAsOrderedSet(this.getContents()).iterator();\n\tjava.lang.Boolean idLoopCond_397 = false;\n\twhile( !idLoopCond_397 ) {\n\tidLoopCond_397 = it_ft124.isOff();\n\tif ( idLoopCond_397 ) {\n\t} else {\n\n\telem_ft124 = it_ft124.next();\n\n\tjava.lang.Boolean idIfCond_398 = false;\n//BIle:selector\nkermeta.language.structure.Object o_lbdExp124 = elem_ft124;\n\n\tidIfCond_398 = org.kermeta.compil.runtime.helper.language.TypeUtil.isInstance(typeName, o_lbdExp124);\n//EIle:selector\n\n\n\tif( idIfCond_398 ) {\n\n\tresult_ft124.add(elem_ft124);\n}\n\n}\n\t}\n}\n\n//EIft:select\nresult = result_ft124.asSet();\n\nreturn result;\n'"
	 * @generated
	 */
