 ...
 * </copyright>
 *
 * $Id: Model.java,v 1.6 2008-10-28 13:18:19 cfaucher Exp $
 */
...
public interface Model extends kermeta.language.structure.Object {
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='\nkermeta.standard.Set<kermeta.language.structure.Object> result = null;\n\n\t//BIft:select\n\nkermeta.standard.Sequence<kermeta.language.structure.Object> result_ft116 = null;\n\n\tkermeta.language.structure.Object elem_ft116 = null;\n\n\tresult_ft116 = ((kermeta.standard.Sequence<kermeta.language.structure.Object>) org.kermeta.compil.runtime.helper.language.ClassUtil.newObject(\"kermeta.standard.Sequence<kermeta.language.structure.Object>\"));\n\n\t\n{\n\n\tkermeta.standard.Iterator<kermeta.language.structure.Object> it_ft116 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil.<kermeta.language.structure.Object>convertAsOrderedSet(this.getContents()).iterator();\n\tjava.lang.Boolean idLoopCond_353 = false;\n\twhile( !idLoopCond_353 ) {\n\tidLoopCond_353 = it_ft116.isOff();\n\tif ( idLoopCond_353 ) {\n\t} else {\n\n\telem_ft116 = it_ft116.next();\n\n\tjava.lang.Boolean idIfCond_354 = false;\n//BIle:selector\nkermeta.language.structure.Object o_lbdExp116 = elem_ft116;\n\n\tidIfCond_354 = org.kermeta.compil.runtime.helper.language.TypeUtil.isInstanceSwitcher(typeName, o_lbdExp116);\n//EIle:selector\n\n\n\tif( idIfCond_354 ) {\n\n\tresult_ft116.add(elem_ft116);\n}\n\n}\n\t}\n}\n\n//EIft:select\nresult = result_ft116.asSet();\n\nreturn result;\n'"
	 * @generated
	 */
