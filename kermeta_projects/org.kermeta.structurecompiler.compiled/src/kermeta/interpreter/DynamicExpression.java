 ...
 * </copyright>
 *
 * $Id: DynamicExpression.java,v 1.4 2008-10-08 14:37:45 cfaucher Exp $
 */
...
public interface DynamicExpression extends kermeta.language.structure.Object {
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='\njava.lang.Boolean result = null;\n\n\torg.kermeta.compil.runtime.helper.basetypes.CollectionUtil.<kermeta.interpreter.KermetaError>convertAsOrderedSet(this.getErrors()).clear();\n\n\tjava.lang.Boolean idIfCond_907 = false;\n\tidIfCond_907 = kermeta.standard.helper.BooleanWrapper.or(org.kermeta.compil.runtime.helper.language.ObjectUtil.equals(this.getFormalParameters(), null), org.kermeta.compil.runtime.helper.language.ObjectUtil.equals(this.getSelfClass(), null));\n\n\tif( idIfCond_907 ) {\n\n\tkermeta.exceptions.DynamicExpressionException e = ((kermeta.exceptions.DynamicExpressionException) org.kermeta.compil.runtime.helper.language.ClassUtil.newObject(\"kermeta.exceptions.DynamicExpressionException\"));\n\n\te.setMessage(\"parse precondition - formalParameters or selfType is void\");\n\n\t\nif (true)\n\tthrow new org.kermeta.compil.runtime.helper.error.KRuntimeError( e );\n\n}\n\n\n\tresult = (java.lang.Boolean) org.kermeta.compil.runtime.helper.language.DynamicExpressionUtil.parse(this, expression);\n\n\tjava.lang.Boolean idIfCond_908 = false;\n\tidIfCond_908 = org.kermeta.compil.runtime.helper.language.ObjectUtil.isNotEqual(org.kermeta.compil.runtime.helper.basetypes.CollectionUtil.<kermeta.interpreter.KermetaError>convertAsOrderedSet(this.getErrors()).size(), 0);\n\n\tif( idIfCond_908 ) {\n\n\tkermeta.exceptions.DynamicExpressionException e = ((kermeta.exceptions.DynamicExpressionException) org.kermeta.compil.runtime.helper.language.ClassUtil.newObject(\"kermeta.exceptions.DynamicExpressionException\"));\n\n\te.setMessage(\"parse result - expression contains errors\");\n\n\t//BIft:each\n\n\t\n{\n\n\tkermeta.standard.Iterator<kermeta.interpreter.KermetaError> it_ft203 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil.<kermeta.interpreter.KermetaError>convertAsOrderedSet(this.getErrors()).iterator();\n\tjava.lang.Boolean idLoopCond_909 = false;\n\twhile( !idLoopCond_909 ) {\n\tidLoopCond_909 = it_ft203.isOff();\n\tif ( idLoopCond_909 ) {\n\t} else {\n\n\t//BIle:func\nkermeta.interpreter.KermetaError error_lbdExp203 = it_ft203.next();\n\n\tkermeta.standard.helper.StringWrapper.append(e.getMessage(), kermeta.standard.helper.StringWrapper.plus(\"\\n\", error_lbdExp203.getMessage()));\n//EIle:func\n\n}\n\t}\n}\n\n//EIft:each\n\n\n\t\nif (true)\n\tthrow new org.kermeta.compil.runtime.helper.error.KRuntimeError( e );\n\n}\n\n\nreturn result;\n'"
	 * @generated
	 */
