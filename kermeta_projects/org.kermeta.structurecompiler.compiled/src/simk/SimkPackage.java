 ...
 * </copyright>
 *
 * $Id: SimkPackage.java,v 1.2 2008-09-11 12:35:01 cfaucher Exp $
 */
package simk;
...
public interface SimkPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int STATIC_METHOD__SM_CONTEXT = SM_NAMED_ELEMENT_FEATURE_COUNT + 5;
	 ...
	 * @ordered
	 */
	int STATIC_METHOD__USAGES = SM_NAMED_ELEMENT_FEATURE_COUNT + 7;
	 ...
	 * @ordered
	 */
	int SM_CONTEXT__SM_CLASS = StructurePackage.OBJECT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int SM_CONTEXT__STATIC_METHODS = StructurePackage.OBJECT_FEATURE_COUNT + 2;
