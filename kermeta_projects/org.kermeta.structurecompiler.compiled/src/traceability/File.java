...
public interface File extends kermeta.language.structure.Object {
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='\ntraceability.File result = null;\n\n\ttraceability.File file = null;\n//BIft:detect\n\ntraceability.File result_ft274 = null;\n\n\ttraceability.File elem_ft274 = null;\n\n\tresult_ft274 = null;\n\n\t\n{\n\n\tkermeta.standard.Iterator<traceability.File> it_ft274 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil.<traceability.File>convertAsOrderedSet(traceModel.getFiles()).iterator();\n\tjava.lang.Boolean idLoopCond_1193 = false;\n\twhile( !idLoopCond_1193 ) {\n\tidLoopCond_1193 = kermeta.standard.helper.BooleanWrapper.or(it_ft274.isOff(), org.kermeta.compil.runtime.helper.language.ObjectUtil.isNotEqualSwitcher(result_ft274, null));\n\tif ( idLoopCond_1193 ) {\n\t} else {\n\n\telem_ft274 = it_ft274.next();\n\n\tjava.lang.Boolean idIfCond_1194 = false;\n//BIle:detector\ntraceability.File f_lbdExp274 = elem_ft274;\n\n\tidIfCond_1194 = kermeta.standard.helper.StringWrapper.equals(f_lbdExp274.getUri(), uri_toFind);\n//EIle:detector\n\n\n\tif( idIfCond_1194 ) {\n\n\tresult_ft274 = elem_ft274;\n}\n\n}\n\t}\n}\n\n\n//CE\nfile = result_ft274;\n//EIft:detect\n;\n\n\tjava.lang.Boolean idIfCond_1195 = false;\n\tidIfCond_1195 = org.kermeta.compil.runtime.helper.language.ObjectUtil.isVoidSwitcher(file);\n\n\tif( idIfCond_1195 ) {\n\n\tfile = ((traceability.File) org.kermeta.compil.runtime.helper.language.ClassUtil.newObject(traceability.TraceabilityPackage.eINSTANCE.getFile()));\n\n\tfile.setUri(uri_toFind);\n\n\torg.kermeta.compil.runtime.helper.basetypes.CollectionUtil.<traceability.File>convertAsOrderedSet(traceModel.getFiles()).add(file);\n\n\tfile.setId(org.kermeta.compil.runtime.helper.basetypes.CollectionUtil.<traceability.File>convertAsOrderedSet(traceModel.getFiles()).size());\n}\n\n\n\tresult = file;\n\nreturn result;\n'"
	 * @generated
	 */
