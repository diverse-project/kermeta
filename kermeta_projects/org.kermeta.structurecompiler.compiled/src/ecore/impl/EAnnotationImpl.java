 ...
 * </copyright>
 *
 * $Id: EAnnotationImpl.java,v 1.10 2008-11-27 15:49:51 cfaucher Exp $
 */
package ecore.impl;
...
public class EAnnotationImpl extends EModelElementImpl implements EAnnotation {
	...
	public EList<EObject> getReferences() {
		if (references == null) {
			references = new EObjectResolvingEList<EObject>(EObject.class,
					this, EcorePackage.EANNOTATION__REFERENCES);
		}
		return references;
	}
	...
	public EList<EObject> getContents() {
		if (contents == null) {
			contents = new EObjectContainmentEList.Resolving<EObject>(
					EObject.class, this, EcorePackage.EANNOTATION__CONTENTS);
		}
		return contents;
	}
	...
	public NotificationChain basicSetEModelElement(
		...
		msgs = eBasicSetContainer((InternalEObject) newEModelElement,
				EcorePackage.EANNOTATION__EMODEL_ELEMENT, msgs);
		return msgs;
	}
	...
	public void setEModelElement(EModelElement newEModelElement) {
		if (newEModelElement != eInternalContainer()
			...
			if (newEModelElement != null)
				msgs = ((InternalEObject) newEModelElement).eInverseAdd(this,
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					EcorePackage.EANNOTATION__EMODEL_ELEMENT, newEModelElement,
					newEModelElement));
	}
	...
	public boolean eIsSet(int featureID) {
		...
		case EcorePackage.EANNOTATION__EMODEL_ELEMENT:
			return basicGetEModelElement() != null;
		}
