 ...
 * </copyright>
 *
 * $Id: EEnumLiteralImpl.java,v 1.10 2008-11-27 15:49:51 cfaucher Exp $
 */
package ecore.impl;
...
public class EEnumLiteralImpl extends ENamedElementImpl implements EEnumLiteral {
	...
	public void setValue(int newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					EcorePackage.EENUM_LITERAL__VALUE, oldValue, value));
	}
	...
	public void setInstance(Enumerator newInstance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					EcorePackage.EENUM_LITERAL__INSTANCE, oldInstance, instance));
	}
	...
	public void setLiteral(String newLiteral) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					EcorePackage.EENUM_LITERAL__LITERAL, oldLiteral, literal));
	}
