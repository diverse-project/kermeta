 ...
 * </copyright>
 *
 * $Id: EOperationImpl.java,v 1.10 2008-11-27 15:49:51 cfaucher Exp $
 */
package ecore.impl;
...
public class EOperationImpl extends ETypedElementImpl implements EOperation {
	...
	public EList<EParameter> getEParameters() {
		if (eParameters == null) {
			eParameters = new EObjectContainmentWithInverseEList.Resolving<EParameter>(
					EParameter.class, this,
					EcorePackage.EOPERATION__EPARAMETERS,
					EcorePackage.EPARAMETER__EOPERATION);
		}
		return eParameters;
	}
	...
	public EList<EClassifier> getEExceptions() {
		if (eExceptions == null) {
			eExceptions = new EObjectResolvingEList<EClassifier>(
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		case EcorePackage.EOPERATION__EGENERIC_EXCEPTIONS:
			return ((InternalEList<?>) getEGenericExceptions()).basicRemove(
					otherEnd, msgs);
		case EcorePackage.EOPERATION__EPARAMETERS:
			return ((InternalEList<?>) getEParameters()).basicRemove(otherEnd,
					msgs);
	...
	public void eSet(int featureID, Object newValue) {
		...
		case EcorePackage.EOPERATION__EPARAMETERS:
			...
			getEParameters()
					.addAll((Collection<? extends EParameter>) newValue);
			return;
		case EcorePackage.EOPERATION__ETYPE_PARAMETERS:
