 ...
 * @generated
 */
public class LinkSetterForTypedElement__mustForceVoidTypeLink__Runner {
	...
	public static void main(String[] args) {
		...
		kermeta.language.structure.LinkSetterForTypedElement anExec = (kermeta.language.structure.LinkSetterForTypedElement) org.kermeta.compil.runtime.helper.language.ClassUtil
				.newObject(kermeta.language.structure.StructurePackage.eINSTANCE
						.getLinkSetterForTypedElement());
		anExec.mustForceVoidTypeLink();
