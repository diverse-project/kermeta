 ...
 *
 */
public class AddContentToModelType extends KermetaASTNodeVisitor implements ILoadingAction, IKMTLoadingAction {
	...
	public boolean beginVisit(ClassDecl classDecl) {
		if ( classDecl.getTypeVarDecllst() != null ) {
			context.current_class = (ClassDefinition) kermetaUnit.getModelElementByNode(classDecl);
	...
	public boolean beginVisit(TypeVarDecl typeVarDecl) {
		...
		if (superdef instanceof ModelType) {
			...
			fr.irisa.triskell.kermeta.language.structure.Type supertype = KMT2KMTypeBuilder.process(context, bsuper, kermetaUnit, null);
