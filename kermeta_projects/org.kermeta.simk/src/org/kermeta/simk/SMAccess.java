/**
 * $Id: SMAccess.java,v 1.1 2008-09-25 08:50:45 cfaucher Exp $
 ...
 * <!-- end-user-doc -->
 * @see org.kermeta.simk.SimkPackage#getSMAccess()
 * @model
 * @generated
 */
public enum SMAccess implements Enumerator {
	 ...
	 * @generated
	 */
	private static final SMAccess[] VALUES_ARRAY =
		new SMAccess[] {
			PRIVATE,
			PROTECTED,
			PUBLIC,
	 ...
	 * @generated
	 */
	public static final List<SMAccess> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
