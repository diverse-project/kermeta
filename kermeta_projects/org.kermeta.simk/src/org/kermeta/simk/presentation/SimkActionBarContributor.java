/**
 * $Id: SimkActionBarContributor.java,v 1.1 2007-11-30 13:36:47 cfaucher Exp $
...
/**
 * This is the action bar contributor for the Simk model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SimkActionBarContributor
	...
	protected IAction showPropertiesViewAction =
		new Action(SimkEditPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
			@Override
			public void run() {
				try {
	...
	protected IAction refreshViewerAction =
		new Action(SimkEditPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
			@Override
	 ...
	 * @generated
	 */
	public SimkActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("simk-settings"));
		toolBarManager.add(new Separator("simk-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(SimkEditPlugin.INSTANCE.getString("_UI_SimkEditor_menu"), "org.kermeta.simkMenuID");
		...
		//
		createChildMenuManager = new MenuManager(SimkEditPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		submenuManager.insertBefore("additions", createChildMenuManager);

		// Prepare for CreateSibling item addition or removal.
		//
		createSiblingMenuManager = new MenuManager(SimkEditPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
	...
	public void menuAboutToShow(IMenuManager menuManager) {
		...
		submenuManager = new MenuManager(SimkEditPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		populateManager(submenuManager, createChildSubmenuActions, null);
		populateManager(submenuManager, createChildActions, null);
		menuManager.insertBefore("edit", submenuManager);

		submenuManager = new MenuManager(SimkEditPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
