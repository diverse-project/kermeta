 ...
 * @generated
 */
public class KruntimeconfigurationPackageImpl extends EPackageImpl implements KruntimeconfigurationPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see org.kermeta.kruntimeconfiguration.KruntimeconfigurationPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private KruntimeconfigurationPackageImpl() {
		super(eNS_URI, KruntimeconfigurationFactory.eINSTANCE);
	}
	 ...
	 * @generated
	 */
	public static KruntimeconfigurationPackage init() {
		if (isInited) return (KruntimeconfigurationPackage)EPackage.Registry.INSTANCE.getEPackage(KruntimeconfigurationPackage.eNS_URI);

		// Obtain or create and register package
		KruntimeconfigurationPackageImpl theKruntimeconfigurationPackage = (KruntimeconfigurationPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof KruntimeconfigurationPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new KruntimeconfigurationPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theKruntimeconfigurationPackage.createPackageContents();

		// Initialize created meta-data
		theKruntimeconfigurationPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theKruntimeconfigurationPackage.freeze();

		return theKruntimeconfigurationPackage;
	}
...
} //KruntimeconfigurationPackageImpl
