 ...
 * implementation Jose Alfredo Serrano (Anyware Technologies) - updated API
 ******************************************************************************/
...
import org.topcased.tabbedproperties.internal.sections.listeners.PropertiesAdapterImpl;
...
/**
 * An abstract implementation of a section in a tab in the tabbed property sheet page for a tree editor. Clients specializing this class may implement the create widgets, setFormData and hooklisteners
 * rather than overriding the create controls.
 * 
 * Creation 5 avr. 2006
 * 
 * @author jlescot
...
public abstract class AbstractTabbedPropertySection extends AbstractPropertySection
{
    ...
    /**
     * Section composite. This composite can be return if client desire to implement other widgets in relation with the list represented by this instance.
     */
    ...
    {
        /**
         * @see org.topcased.tabbedproperties.internal.sections.listeners.PropertiesAdapterImpl#safeNotifyChanged(org.eclipse.emf.common.notify.Notification)
         */
     ...
     * 
     * @param toolBarManager the toolBarManager to display buttons on the toolBar
     * @param menuManager the Menu manager to display menus
     * @param statLineManager the status line manager to show messages
     */
    ...
    /**
     * Get the standard label width when labels for sections line up on the left hand side of the composite. We line up to a fixed position, but if a string is wider than the fixed position, then we
     * use that widest string.
     * 
     ...
     * supporting {@link org.eclipse.emf.edit.ui.action.CommandAction}.
     * 
    ...
    /**
     * Manages a self-contained set of interrelated EMF models and the {@link Command}s that modify them. The models are maintained in the form of a {@link ResourceSet}. Commands that modify the
    ...
    /**
     * Section widgets should be created inside this method. To set the layout data please implement the {@link #setSectionData(Composite)} If widgets has listeners implement the
     * {@link #hookListeners()}.
     * 
    ...
    /**
     * This method should be implemente to set layout data to the widgets created at {@link #createWidgets(Composite)}. This improves visibility
     * 
     * @param composite Sometimes widgets will be set formDatas and postion will depenend on parent composite.
     */
    ...
    /**
     * Widgets created at {@link #createWidgets(Composite)} may listen platform events. Set them here in order to improve visibility
     */
