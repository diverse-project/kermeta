...
import org.kermeta.prototyper.editor.composite.TableObjectManager;
import org.kermeta.prototyper.editor.composite.CellModifier;
import org.topcased.tabbedproperties.providers.TabbedPropertiesLabelProvider;

/**
 * This widget contains a TableViewer representing the Parameters of an Operation. Ther are two Buttons (one for adding a new Parameter, the other for deleting the current selected Parameter)
 * 
...
public class TableViewerComposite extends Composite
{
    ...
    /**
     * InnerClass that acts as a proxy for the TableObjectManager providing content for the Table. It implements the IEObjectModifyListener interface since it must register changeListeners with the
     * TableObjectManager
     */
     ...
     * @param colNames the name of the different columns of the table
    ...
    {
        executeButton = widgetFactory.createButton(comp, "Execute the selected operation", SWT.NONE);
     ...
     * 
     * @param comp The composite where buttons are going to be created
     */
    ...
    protected void hookButtonListeners()
    {
        ...
        {
            executeButton.addSelectionListener(addListener);
        }
    }
     ...
     * 
     * @param eObject EObject to be represented
     ...
     * 
     * When the given parameter is null, it will set a default label provider, in particular when the table viewer is going to display multifeature Attributes. In order to display multifeature
     * references, client may pass a AdapterFactoryLabelProvider.
     * 
     ...
     * 
     * @param editingDomain Manages a self-contained set of interrelated EMF models and the {@link Command}s that modify them.
     */
     ...
     * 
     * @param newColumnNames Array containing the column names
     */
    public void setColumnNames(String[] newColumnNames)
    {
        columnNames = (String[]) newColumnNames.clone();
    }
    ...
    /**
     * @return Returns the list of buttons added if any, otherwise buttons list is null;
     */
    ...
    public void setAddListener(SelectionListener listener)
    {
        ...
        executeButton.removeSelectionListener(oldListener);
        executeButton.addSelectionListener(addListener);
    }
     ...
     * 
     * @param data the new item that was selected
     */
