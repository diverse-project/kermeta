...
/**
 * Class that manages model changements. This manager supports four basic types such as boolean, string, int and
 * enumerations.
 * 
...
public class TableObjectManager
{
     ...
     * 
     * @param eObject Object to manage
     * @param structuralFeature Structural Feature to edit. Actually this may be a List type
     */
     ...
     * 
     * @param oldValue old value in order to get its place
     * @param newValue new value to insert that the olds value place
     */
    ...
    /**
     * Get the Feature type of the EObject feature of the manager This class manages list. The return type will be
     * certainly a EList/List type
     * 
     * @return feature type
     */
    public List< ? > eGet()
    ...
    /**
     * Computes the EStructuralFeature type. When the type is an enumeration this function will initialize the literals
     * array
     * 
     * @see EcorePackage#EBOOLEAN , EcorePackage#ESTRING , EcorePackage#EINT or EcorePackage#EEnum
     * @see #BOOL
     * @see #INT
     * @see #STR
     * @see #ENUM
    ...
    /**
     * Return the new List of elements that have been specified in the FeatureEditorDialog.
     * 
     * @return List
     */
