...
public class ArtAdapterFactory extends AdapterFactoryImpl {
	...
	protected ArtSwitch<Adapter> modelSwitch =
		new ArtSwitch<Adapter>() {
			...
			@Override
			public Adapter caseSystem(art.System object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link art.System <em>System</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link art.DataType <em>Data Type</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
