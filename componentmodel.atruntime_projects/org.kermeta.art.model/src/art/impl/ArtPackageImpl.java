...
public class ArtPackageImpl extends EPackageImpl implements ArtPackage {
	...
	public void initializePackageContents() {
		...
		DistribPackage theDistribPackage = (DistribPackage)EPackage.Registry.INSTANCE.getEPackage(DistribPackage.eNS_URI);
		...
		getESubpackages().add(theDistribPackage);
		...
		initEReference(getSystem_Nodes(), theDistribPackage.getNode(), null, "nodes", null, 0, -1, art.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
