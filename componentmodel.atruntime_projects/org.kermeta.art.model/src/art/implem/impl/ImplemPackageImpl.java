...
public class ImplemPackageImpl extends EPackageImpl implements ImplemPackage {
	...
	public void initializePackageContents() {
		...
		componentImplementationEClass.getESuperTypes().add(theArtPackage.getAspectModelElement());
		...
		typeImplementationEClass.getESuperTypes().add(theArtPackage.getAspectModelElement());
