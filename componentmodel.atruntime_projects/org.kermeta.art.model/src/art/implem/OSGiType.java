 ...
 * <ul>
 *   <li>{@link art.implem.OSGiType#getGenerateInstanceBundle <em>Generate Instance Bundle</em>}</li>
 * </ul>
 * </p>
 *
 * @see art.implem.ImplemPackage#getOSGiType()
 * @model
 * @generated
 */
public interface OSGiType extends TypeImplementation {
	 ...
	 * @see art.implem.ImplemPackage#getOSGiType_GenerateInstanceBundle()
	 * @model default="true" dataType="art.Boolean" required="true"
	 * @generated
	 */
	Boolean getGenerateInstanceBundle();

	/**
	 * Sets the value of the '{@link art.implem.OSGiType#getGenerateInstanceBundle <em>Generate Instance Bundle</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
