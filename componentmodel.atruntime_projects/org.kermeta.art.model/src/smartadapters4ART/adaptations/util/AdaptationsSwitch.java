...
public class AdaptationsSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case AdaptationsPackage.SETRUNTIME_NODE: {
				SetruntimeNode setruntimeNode = (SetruntimeNode)theEObject;
				T result = caseSetruntimeNode(setruntimeNode);
				if (result == null) result = caseSetAdaptation(setruntimeNode);
				if (result == null) result = caseAdaptation(setruntimeNode);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Setruntime Node</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Setruntime Node</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSetruntimeNode(SetruntimeNode object) {
		return null;
	}
