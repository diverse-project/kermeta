 ...
 * <ul>
 *   <li>{@link smartadapters4ART.adaptations.impl.SetruntimeinstanceCompositeInstanceImpl#getCompositeInstanceToSet <em>Composite Instance To Set</em>}</li>
 *   <li>{@link smartadapters4ART.adaptations.impl.SetruntimeinstanceCompositeInstanceImpl#getRefsubComponent <em>Refsub Component</em>}</li>
 *   <li>{@link smartadapters4ART.adaptations.impl.SetruntimeinstanceCompositeInstanceImpl#getRefdelegation <em>Refdelegation</em>}</li>
 *   <li>{@link smartadapters4ART.adaptations.impl.SetruntimeinstanceCompositeInstanceImpl#getReftype <em>Reftype</em>}</li>
 *   <li>{@link smartadapters4ART.adaptations.impl.SetruntimeinstanceCompositeInstanceImpl#getRefstate <em>Refstate</em>}</li>
 *   <li>{@link smartadapters4ART.adaptations.impl.SetruntimeinstanceCompositeInstanceImpl#getRefsuperComponent <em>Refsuper Component</em>}</li>
 *   <li>{@link smartadapters4ART.adaptations.impl.SetruntimeinstanceCompositeInstanceImpl#getRefattribute <em>Refattribute</em>}</li>
 *   <li>{@link smartadapters4ART.adaptations.impl.SetruntimeinstanceCompositeInstanceImpl#getRefbinding <em>Refbinding</em>}</li>
 *   <li>{@link smartadapters4ART.adaptations.impl.SetruntimeinstanceCompositeInstanceImpl#getRefname <em>Refname</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
