 ...
 * <ul>
 *   <li>{@link smartadapters4ART.adaptations.impl.SetruntimeSystemImpl#getSystemToSet <em>System To Set</em>}</li>
 *   <li>{@link smartadapters4ART.adaptations.impl.SetruntimeSystemImpl#getRefroot <em>Refroot</em>}</li>
 *   <li>{@link smartadapters4ART.adaptations.impl.SetruntimeSystemImpl#getRefservices <em>Refservices</em>}</li>
 *   <li>{@link smartadapters4ART.adaptations.impl.SetruntimeSystemImpl#getReftypes <em>Reftypes</em>}</li>
 *   <li>{@link smartadapters4ART.adaptations.impl.SetruntimeSystemImpl#getRefdataTypes <em>Refdata Types</em>}</li>
 *   <li>{@link smartadapters4ART.adaptations.impl.SetruntimeSystemImpl#getRefname <em>Refname</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SetruntimeSystemImpl extends SetAdaptationImpl implements SetruntimeSystem {
	 ...
	 * @ordered
	 */
	protected art_relaxed.System systemToSet;
	 ...
	 * @generated
	 */
	public art_relaxed.System getSystemToSet() {
		if (systemToSet != null && systemToSet.eIsProxy()) {
			InternalEObject oldSystemToSet = (InternalEObject)systemToSet;
			systemToSet = (art_relaxed.System)eResolveProxy(oldSystemToSet);
	 ...
	 * @generated
	 */
	public art_relaxed.System basicGetSystemToSet() {
		return systemToSet;
	}
	 ...
	 * @generated
	 */
	public void setSystemToSet(art_relaxed.System newSystemToSet) {
		art_relaxed.System oldSystemToSet = systemToSet;
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case AdaptationsPackage.SETRUNTIME_SYSTEM__SYSTEM_TO_SET:
				setSystemToSet((art_relaxed.System)newValue);
				return;
			case AdaptationsPackage.SETRUNTIME_SYSTEM__REFROOT:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case AdaptationsPackage.SETRUNTIME_SYSTEM__SYSTEM_TO_SET:
				setSystemToSet((art_relaxed.System)null);
				return;
			case AdaptationsPackage.SETRUNTIME_SYSTEM__REFROOT:
