...
public class AdaptationsFactoryImpl extends EFactoryImpl implements AdaptationsFactory {
	...
	public static AdaptationsFactory init() {
		try {
			AdaptationsFactory theAdaptationsFactory = (AdaptationsFactory)EPackage.Registry.INSTANCE.getEFactory("http://SmartAdapters4ART/adaptations"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case AdaptationsPackage.SETRUNTIME_NODE: return createSetruntimeNode();
	 ...
	 * @generated
	 */
	public SetruntimeNode createSetruntimeNode() {
		SetruntimeNodeImpl setruntimeNode = new SetruntimeNodeImpl();
		return setruntimeNode;
	}
