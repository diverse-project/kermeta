 ...
 * <!-- end-user-doc -->
 * @see art_relaxed.Art_relaxedPackage
 * @generated
 */
public class Art_relaxedSwitch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static Art_relaxedPackage modelPackage;
	 ...
	 * @generated
	 */
	public Art_relaxedSwitch() {
		if (modelPackage == null) {
			modelPackage = Art_relaxedPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Art_relaxedPackage.NAMED_ELEMENT: {
				NamedElement namedElement = (NamedElement)theEObject;
				T result = caseNamedElement(namedElement);
				if (result == null) result = caseAspectModelElement(namedElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Art_relaxedPackage.MODEL_ELEMENT: {
				ModelElement modelElement = (ModelElement)theEObject;
				T result = caseModelElement(modelElement);
				if (result == null) result = caseNamedElement(modelElement);
				if (result == null) result = caseAspectModelElement(modelElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Art_relaxedPackage.SYSTEM: {
				art_relaxed.System system = (art_relaxed.System)theEObject;
				T result = caseSystem(system);
				if (result == null) result = caseModelElement(system);
				if (result == null) result = caseNamedElement(system);
				if (result == null) result = caseAspectModelElement(system);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Art_relaxedPackage.DATA_TYPE: {
				DataType dataType = (DataType)theEObject;
				T result = caseDataType(dataType);
				if (result == null) result = caseModelElement(dataType);
				if (result == null) result = caseNamedElement(dataType);
				if (result == null) result = caseAspectModelElement(dataType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Art_relaxedPackage.TYPED_ELEMENT: {
				TypedElement typedElement = (TypedElement)theEObject;
				T result = caseTypedElement(typedElement);
				if (result == null) result = caseModelElement(typedElement);
				if (result == null) result = caseNamedElement(typedElement);
				if (result == null) result = caseAspectModelElement(typedElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Art_relaxedPackage.CARDINALITY_ELEMENT: {
				...
				if (result == null) result = caseAspectModelElement(cardinalityElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Art_relaxedPackage.ASPECT_MODEL_ELEMENT: {
	 ...
	 * @generated
	 */
	public T caseSystem(art_relaxed.System object) {
		return null;
	}
