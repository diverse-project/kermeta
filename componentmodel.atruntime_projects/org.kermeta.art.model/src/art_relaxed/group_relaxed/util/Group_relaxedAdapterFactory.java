 ...
 * @generated
 */
public class Group_relaxedAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	public Group_relaxedAdapterFactory() {
	 ...
	 * @generated
	 */
	protected Group_relaxedSwitch<Adapter> modelSwitch =
		new Group_relaxedSwitch<Adapter>() {
			@Override
			...
			@Override
			public Adapter caseInstanceGroup(InstanceGroup object) {
				return createInstanceGroupAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link art_relaxed.group_relaxed.Group <em>Group</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link art_relaxed.group_relaxed.TypeGroup <em>Type Group</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link art_relaxed.group_relaxed.InstanceGroup <em>Instance Group</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createInstanceGroupAdapter() {
		return null;
	}
