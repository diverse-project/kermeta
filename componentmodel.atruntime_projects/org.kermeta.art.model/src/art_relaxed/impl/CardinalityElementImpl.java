 ...
 * <ul>
 *   <li>{@link art_relaxed.impl.CardinalityElementImpl#getLower <em>Lower</em>}</li>
 *   <li>{@link art_relaxed.impl.CardinalityElementImpl#getUpper <em>Upper</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class CardinalityElementImpl extends ModelElementImpl implements CardinalityElement {
	...
	protected EClass eStaticClass() {
		return Art_relaxedPackage.Literals.CARDINALITY_ELEMENT;
	}
	...
	public void setLower(Integer newLower) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Art_relaxedPackage.CARDINALITY_ELEMENT__LOWER, oldLower, lower));
	}
	...
	public void setUpper(Integer newUpper) {
		...
		upper = newUpper;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Art_relaxedPackage.CARDINALITY_ELEMENT__UPPER, oldUpper, upper));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Art_relaxedPackage.CARDINALITY_ELEMENT__LOWER:
				return getLower();
			case Art_relaxedPackage.CARDINALITY_ELEMENT__UPPER:
				return getUpper();
		}
