 ...
 * <ul>
 *   <li>{@link art_relaxed.implem_relaxed.impl.FractalComponentImpl#getControllerDesc <em>Controller Desc</em>}</li>
 *   <li>{@link art_relaxed.implem_relaxed.impl.FractalComponentImpl#getContentDesc <em>Content Desc</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FractalComponentImpl extends ComponentImplementationImpl implements FractalComponent {
	...
	protected EClass eStaticClass() {
		return Implem_relaxedPackage.Literals.FRACTAL_COMPONENT;
	}
	...
	public void setControllerDesc(String newControllerDesc) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Implem_relaxedPackage.FRACTAL_COMPONENT__CONTROLLER_DESC, oldControllerDesc, controllerDesc));
	}
	...
	public void setContentDesc(String newContentDesc) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Implem_relaxedPackage.FRACTAL_COMPONENT__CONTENT_DESC, oldContentDesc, contentDesc));
	}
