 ...
 * @generated
 */
public class Type_relaxedSwitch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Type_relaxedPackage.COMPONENT_TYPE: {
				...
				if (result == null) result = caseAspectModelElement(componentType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Type_relaxedPackage.PRIMITIVE_TYPE: {
			...
			case Type_relaxedPackage.COMPOSITE_TYPE: {
				...
				if (result == null) result = caseAspectModelElement(compositeType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Type_relaxedPackage.SERVICE: {
				Service service = (Service)theEObject;
				T result = caseService(service);
				if (result == null) result = caseModelElement(service);
				if (result == null) result = caseNamedElement(service);
				if (result == null) result = caseAspectModelElement(service);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Type_relaxedPackage.OPERATION: {
				Operation operation = (Operation)theEObject;
				T result = caseOperation(operation);
				if (result == null) result = caseModelElement(operation);
				if (result == null) result = caseNamedElement(operation);
				if (result == null) result = caseAspectModelElement(operation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Type_relaxedPackage.PARAMETER: {
			...
			case Type_relaxedPackage.FUNCTIONAL_SERVICE: {
				...
				if (result == null) result = caseAspectModelElement(functionalService);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Type_relaxedPackage.CONTROL_SERVICE: {
				...
				if (result == null) result = caseAspectModelElement(controlService);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Type_relaxedPackage.ABSTRACT_PORT: {
				...
				if (result == null) result = caseAspectModelElement(abstractPort);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Type_relaxedPackage.PORT: {
			...
			case Type_relaxedPackage.PORT_COLLECTION: {
				...
				if (result == null) result = caseAspectModelElement(portCollection);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Type_relaxedPackage.PORT_ID: {
				PortId portId = (PortId)theEObject;
				T result = casePortId(portId);
				if (result == null) result = caseNamedElement(portId);
				if (result == null) result = caseAspectModelElement(portId);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Type_relaxedPackage.ATTRIBUTE: {
				Attribute attribute = (Attribute)theEObject;
				T result = caseAttribute(attribute);
				if (result == null) result = caseTypedElement(attribute);
				if (result == null) result = caseModelElement(attribute);
				if (result == null) result = caseNamedElement(attribute);
				if (result == null) result = caseAspectModelElement(attribute);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Type_relaxedPackage.BASIC_ATTRIBUTE: {
				...
				if (result == null) result = caseAspectModelElement(basicAttribute);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Type_relaxedPackage.DICTIONARY: {
			...
			case Type_relaxedPackage.DICTIONARY_DEFAULT_VALUE: {
				...
				if (result == null) result = caseAspectModelElement(dictionaryDefaultValue);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
