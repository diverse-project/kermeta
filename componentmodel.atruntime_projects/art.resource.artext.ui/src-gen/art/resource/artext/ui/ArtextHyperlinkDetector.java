 ...
 * hovers, is a proxy.
 */
public class ArtextHyperlinkDetector implements org.eclipse.jface.text.hyperlink.IHyperlinkDetector {
	 ...
	 */
	public ArtextHyperlinkDetector(org.eclipse.emf.ecore.resource.Resource resource) {
		textResource = (art.resource.artext.IArtextTextResource) resource;
	}
	...
	public org.eclipse.jface.text.hyperlink.IHyperlink[] detectHyperlinks(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion region, boolean canShowMultipleHyperlinks) {
		...
		for (org.eclipse.emf.ecore.EObject eObject : elementsAtOffset) {
			if (eObject.eIsProxy()) {
				...
				org.eclipse.jface.text.hyperlink.IHyperlink hyperlink = new art.resource.artext.ui.ArtextHyperlink(new org.eclipse.jface.text.Region(offset, length), resolvedEObject, text);
