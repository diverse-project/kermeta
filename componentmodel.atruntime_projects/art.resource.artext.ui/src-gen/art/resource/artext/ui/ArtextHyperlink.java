 ...
 */
public class ArtextHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public ArtextHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				if (editorPart instanceof art.resource.artext.ui.ArtextEditor) {
					art.resource.artext.ui.ArtextEditor emftEditor = (art.resource.artext.ui.ArtextEditor) editorPart;
