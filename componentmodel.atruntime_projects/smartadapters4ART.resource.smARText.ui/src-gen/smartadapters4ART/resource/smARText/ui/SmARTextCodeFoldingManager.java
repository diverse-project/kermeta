...
public class SmARTextCodeFoldingManager {
	...
	private class FoldingUpdateListener implements smartadapters4ART.resource.smARText.ISmARTextBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(smartadapters4ART.resource.smARText.ui.SmARTextEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof smartadapters4ART.resource.smARText.ui.SmARTextEditor) {
				smartadapters4ART.resource.smARText.ui.SmARTextEditor editor = (smartadapters4ART.resource.smARText.ui.SmARTextEditor) workbenchPart;
	...
	protected smartadapters4ART.resource.smARText.ui.SmARTextEditor editor;
	 ...
	 */
	public SmARTextCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,smartadapters4ART.resource.smARText.ui.SmARTextEditor textEditor) {
	...
	private void addCloseListener(final smartadapters4ART.resource.smARText.ui.SmARTextEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			smartadapters4ART.resource.smARText.ui.SmARTextUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		smartadapters4ART.resource.smARText.ISmARTextTextResource textResource = (smartadapters4ART.resource.smARText.ISmARTextTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
