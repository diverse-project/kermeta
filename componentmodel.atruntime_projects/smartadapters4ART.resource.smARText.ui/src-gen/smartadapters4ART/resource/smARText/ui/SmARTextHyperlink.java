	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				if (editorPart instanceof smartadapters4ART.resource.smARText.ui.SmARTextEditor) {
					smartadapters4ART.resource.smARText.ui.SmARTextEditor emftEditor = (smartadapters4ART.resource.smARText.ui.SmARTextEditor) editorPart;
