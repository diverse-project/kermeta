...
public class SmARTextHyperlinkDetector implements org.eclipse.jface.text.hyperlink.IHyperlinkDetector {
	...
	public SmARTextHyperlinkDetector(org.eclipse.emf.ecore.resource.Resource resource) {
		textResource = (smartadapters4ART.resource.smARText.ISmARTextTextResource) resource;
	}
	...
	public org.eclipse.jface.text.hyperlink.IHyperlink[] detectHyperlinks(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion region, boolean canShowMultipleHyperlinks) {
		...
		for (org.eclipse.emf.ecore.EObject eObject : elementsAtOffset) {
			if (eObject.eIsProxy()) {
				...
				org.eclipse.jface.text.hyperlink.IHyperlink hyperlink = new smartadapters4ART.resource.smARText.ui.SmARTextHyperlink(new org.eclipse.jface.text.Region(offset, length), resolvedEObject, text);
