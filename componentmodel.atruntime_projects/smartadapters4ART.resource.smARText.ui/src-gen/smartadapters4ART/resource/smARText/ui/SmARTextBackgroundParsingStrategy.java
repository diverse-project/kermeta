...
public class SmARTextBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final smartadapters4ART.resource.smARText.ISmARTextTextResource resource, final smartadapters4ART.resource.smARText.ui.SmARTextEditor editor) {
		if (resource == null) {
			return;
		}
