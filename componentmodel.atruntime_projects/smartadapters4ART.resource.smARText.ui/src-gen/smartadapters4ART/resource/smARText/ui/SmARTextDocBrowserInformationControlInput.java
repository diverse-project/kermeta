 ...
 * olInput</code>.
 */
public class SmARTextDocBrowserInformationControlInput {
	
	private final SmARTextDocBrowserInformationControlInput fPrevious;
	private SmARTextDocBrowserInformationControlInput fNext;
	 ...
	 */
	public SmARTextDocBrowserInformationControlInput(SmARTextDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public SmARTextDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public SmARTextDocBrowserInformationControlInput getNext() {
		return fNext;
	}
