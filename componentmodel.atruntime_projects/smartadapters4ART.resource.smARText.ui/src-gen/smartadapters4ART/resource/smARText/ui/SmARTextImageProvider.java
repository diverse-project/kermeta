 ...
 */
public class SmARTextImageProvider {
	
	public final static SmARTextImageProvider INSTANCE = new SmARTextImageProvider();
	...
	public org.eclipse.swt.graphics.Image getImage(String key) {
		...
		org.eclipse.jface.resource.ImageDescriptor desriptor = org.eclipse.jface.resource.ImageDescriptor.createFromURL(org.eclipse.core.runtime.FileLocator.find(smartadapters4ART.resource.smARText.ui.SmARTextUIPlugin.getDefault().getBundle(), path, null));
