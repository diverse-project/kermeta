...
public class SmARTextEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider {
	...
	private smartadapters4ART.resource.smARText.ui.SmARTextHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private smartadapters4ART.resource.smARText.ui.SmARTextCodeFoldingManager codeFoldingManager;
	private smartadapters4ART.resource.smARText.ui.SmARTextBackgroundParsingStrategy bgParsingStrategy = new smartadapters4ART.resource.smARText.ui.SmARTextBackgroundParsingStrategy();
	private java.util.Collection<smartadapters4ART.resource.smARText.ISmARTextBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<smartadapters4ART.resource.smARText.ISmARTextBackgroundParsingListener>();
	private smartadapters4ART.resource.smARText.ui.SmARTextColorManager colorManager = new smartadapters4ART.resource.smARText.ui.SmARTextColorManager();
	private smartadapters4ART.resource.smARText.ui.SmARTextOutlinePage outlinePage;
	...
	private smartadapters4ART.resource.smARText.ui.SmARTextPropertySheetPage propertySheetPage;
	...
	private smartadapters4ART.resource.smARText.ui.ISmARTextBracketHandler bracketHandler;
	
	public SmARTextEditor() {
		super();
		setSourceViewerConfiguration(new smartadapters4ART.resource.smARText.ui.SmARTextEditorConfiguration(this, colorManager));
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								smartadapters4ART.resource.smARText.ISmARTextTextResource currentResource = getResource();
				...
				smartadapters4ART.resource.smARText.ui.SmARTextUIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("smartadapters4ART.resource.smARText.EditorContext");
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new smartadapters4ART.resource.smARText.ui.SmARTextHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new smartadapters4ART.resource.smARText.ui.SmARTextCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		smartadapters4ART.resource.smARText.mopp.SmARTextNature.activate(inputFile.getProject());
		...
		smartadapters4ART.resource.smARText.ISmARTextTextResource loadedResource = (smartadapters4ART.resource.smARText.ISmARTextTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				smartadapters4ART.resource.smARText.ISmARTextTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof smartadapters4ART.resource.smARText.ISmARTextTextResource) {
					setResource((smartadapters4ART.resource.smARText.ISmARTextTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but some other EMF resource
					smartadapters4ART.resource.smARText.ui.SmARTextUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the SmARTextEditor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (Exception e) {
				smartadapters4ART.resource.smARText.ui.SmARTextUIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(smartadapters4ART.resource.smARText.ISmARTextTextResource resource) {
		assert resource != null;
	...
	private Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new smartadapters4ART.resource.smARText.ui.SmARTextOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new smartadapters4ART.resource.smARText.ui.SmARTextPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			smartadapters4ART.resource.smARText.ISmARTextTextResource textResource = (smartadapters4ART.resource.smARText.ISmARTextTextResource) element.eResource();
			...
			smartadapters4ART.resource.smARText.ISmARTextTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				smartadapters4ART.resource.smARText.ISmARTextTextToken token = lexer.getNextToken();
			...
			smartadapters4ART.resource.smARText.ui.SmARTextUIPlugin.logError("Exception in setCaret()", e);
		}
	}
	...
	public void addBackgroundParsingListener(smartadapters4ART.resource.smARText.ISmARTextBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (smartadapters4ART.resource.smARText.ISmARTextBackgroundParsingListener listener : bgParsingListeners) {
			listener.parsingCompleted(getResource());
		}
	}
	
	public smartadapters4ART.resource.smARText.ui.ISmARTextBracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(smartadapters4ART.resource.smARText.ui.ISmARTextBracketHandler bracketHandler) {
