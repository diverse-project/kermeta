 ...
 */
public class SmARTextUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "smartadapters4ART.resource.smARText.ui";
	...
	private static SmARTextUIPlugin plugin;
	
	public SmARTextUIPlugin() {
		super();
	}
	...
	public static SmARTextUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, SmARTextUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, SmARTextUIPlugin.PLUGIN_ID, message);
		}
		final SmARTextUIPlugin pluginInstance = SmARTextUIPlugin.getDefault();
