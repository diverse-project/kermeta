...
public class SmARTextNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	...
	private smartadapters4ART.resource.smARText.ui.SmARTextNewFileWizardPage page;
	...
	public void addPages() {
		page = new smartadapters4ART.resource.smARText.ui.SmARTextNewFileWizardPage(selection, getFileExtension());
		addPage(page);
	}
	...
	public boolean performFinish() {
		...
		try {
			...
			smartadapters4ART.resource.smARText.ui.SmARTextUIPlugin.logError("Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			smartadapters4ART.resource.smARText.ui.SmARTextUIPlugin.logError("Exception while initializing new file", e);
			return false;
		}
		return true;
	}
	...
	private java.io.InputStream openContentStream() {
		return new java.io.ByteArrayInputStream(new smartadapters4ART.resource.smARText.mopp.SmARTextMetaInformation().getNewFileContentProvider().getNewFileContent(newName).getBytes());
	}
	...
	public String getFileExtension() {
		return new smartadapters4ART.resource.smARText.mopp.SmARTextMetaInformation().getSyntaxName();
	}
