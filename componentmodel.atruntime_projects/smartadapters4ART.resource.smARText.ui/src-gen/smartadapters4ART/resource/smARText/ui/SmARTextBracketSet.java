 ...
 */
public class SmARTextBracketSet {
	...
	private java.util.ArrayList<smartadapters4ART.resource.smARText.ISmARTextBracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements smartadapters4ART.resource.smARText.ISmARTextBracketPair {
	 ...
	 */
	private class ClosingListener implements smartadapters4ART.resource.smARText.ui.ISmARTextBracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				smartadapters4ART.resource.smARText.ISmARTextBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public SmARTextBracketSet(smartadapters4ART.resource.smARText.ui.SmARTextEditor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new smartadapters4ART.resource.smARText.mopp.SmARTextMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<smartadapters4ART.resource.smARText.ISmARTextBracketPair>();
	 ...
	 */
	public smartadapters4ART.resource.smARText.ISmARTextBracketPair getBracketPair(String opening, String closing) {
		for (smartadapters4ART.resource.smARText.ISmARTextBracketPair bracketPair : bracketPairs) {
	...
	public smartadapters4ART.resource.smARText.ISmARTextBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(smartadapters4ART.resource.smARText.ISmARTextBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + smartadapters4ART.resource.smARText.ui.SmARTextPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public smartadapters4ART.resource.smARText.ISmARTextBracketPair remove(String opening, String closing) {
		for (smartadapters4ART.resource.smARText.ISmARTextBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<smartadapters4ART.resource.smARText.ISmARTextBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, smartadapters4ART.resource.smARText.ui.SmARTextPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, smartadapters4ART.resource.smARText.ui.SmARTextPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
