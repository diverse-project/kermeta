 ...
 */
public class SmARTextNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public SmARTextNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new smARText file");
