...
public class SmARTextTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2{
	...
	private smartadapters4ART.resource.smARText.ISmARTextHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final smartadapters4ART.resource.smARText.ui.SmARTextBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(smartadapters4ART.resource.smARText.ui.SmARTextBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			smartadapters4ART.resource.smARText.ui.SmARTextDocBrowserInformationControlInput infoInput = (smartadapters4ART.resource.smARText.ui.SmARTextDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					smartadapters4ART.resource.smARText.ui.SmARTextHyperlink hyperlink = new smartadapters4ART.resource.smARText.ui.SmARTextHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (smartadapters4ART.resource.smARText.ui.SmARTextBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				smartadapters4ART.resource.smARText.ui.SmARTextBrowserInformationControl iControl = new smartadapters4ART.resource.smARText.ui.SmARTextBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof smartadapters4ART.resource.smARText.ui.SmARTextDocBrowserInformationControlInput) {
							smartadapters4ART.resource.smARText.ui.SmARTextDocBrowserInformationControlInput input = (smartadapters4ART.resource.smARText.ui.SmARTextDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (smartadapters4ART.resource.smARText.ui.SmARTextBrowserInformationControl.isAvailable(parent)) {
				smartadapters4ART.resource.smARText.ui.SmARTextBrowserInformationControl iControl = new smartadapters4ART.resource.smARText.ui.SmARTextBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public SmARTextTextHover(smartadapters4ART.resource.smARText.ui.SmARTextEditor editor) {
		super();
		this.editor = editor;
		hoverTextProvider = new smartadapters4ART.resource.smARText.ui.SmARTextUIMetaInformation().getHoverTextProvider();
	}
	
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		return ((smartadapters4ART.resource.smARText.ui.SmARTextDocBrowserInformationControlInput) getHoverInfo2(textViewer, hoverRegion)).getHtml();
	}
	...
	private smartadapters4ART.resource.smARText.ui.SmARTextDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		smartadapters4ART.resource.smARText.ISmARTextTextResource textResource = editor.getResource();
	 ...
	 */
	private smartadapters4ART.resource.smARText.ui.SmARTextDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, smartadapters4ART.resource.smARText.ui.SmARTextDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				smartadapters4ART.resource.smARText.ui.SmARTextHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(declarationObject));
			}
		} else {
			smartadapters4ART.resource.smARText.ui.SmARTextHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			smartadapters4ART.resource.smARText.ui.SmARTextHTMLPrinter.insertPageProlog(buffer, 0, smartadapters4ART.resource.smARText.ui.SmARTextTextHover.getStyleSheet());
			smartadapters4ART.resource.smARText.ui.SmARTextHTMLPrinter.addPageEpilog(buffer);
			return new smartadapters4ART.resource.smARText.ui.SmARTextDocBrowserInformationControlInput(previousInput, declarationObject, editor.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		if (css != null) {
			...
			css = smartadapters4ART.resource.smARText.ui.SmARTextHTMLPrinter.convertTopLevelFont(css, fontData);
		}
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(smartadapters4ART.resource.smARText.ui.SmARTextUIPlugin.PLUGIN_ID);
