...
public class SmARTextBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private smartadapters4ART.resource.smARText.ui.SmARTextDocBrowserInformationControlInput fInput;
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof smartadapters4ART.resource.smARText.ui.SmARTextDocBrowserInformationControlInput);
		...
		fInput= (smartadapters4ART.resource.smARText.ui.SmARTextDocBrowserInformationControlInput) input;
		...
		smartadapters4ART.resource.smARText.ui.SmARTextHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = smartadapters4ART.resource.smARText.ui.SmARTextHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public smartadapters4ART.resource.smARText.ui.SmARTextDocBrowserInformationControlInput getInput() {
		return fInput;
	}
