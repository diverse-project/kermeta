...
public class SmARTextSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = smartadapters4ART.resource.smARText.ui.SmARTextSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, smartadapters4ART.resource.smARText.ui.SmARTextSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = smartadapters4ART.resource.smARText.ui.SmARTextSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, smartadapters4ART.resource.smARText.ui.SmARTextSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = smartadapters4ART.resource.smARText.ui.SmARTextSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, smartadapters4ART.resource.smARText.ui.SmARTextSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = smartadapters4ART.resource.smARText.ui.SmARTextSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, smartadapters4ART.resource.smARText.ui.SmARTextSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = smartadapters4ART.resource.smARText.ui.SmARTextSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, smartadapters4ART.resource.smARText.ui.SmARTextSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = smartadapters4ART.resource.smARText.ui.SmARTextSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, smartadapters4ART.resource.smARText.ui.SmARTextSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		smartadapters4ART.resource.smARText.ui.SmARTextPixelConverter pixelConverter = new smartadapters4ART.resource.smARText.ui.SmARTextPixelConverter(composite);
	...
	public SmARTextSyntaxColoringPreferencePage() {
		...
		smartadapters4ART.resource.smARText.ISmARTextMetaInformation syntaxPlugin = new smartadapters4ART.resource.smARText.mopp.SmARTextMetaInformation();
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof smartadapters4ART.resource.smARText.ui.SmARTextEditor) {
			smartadapters4ART.resource.smARText.ui.SmARTextEditor emfTextEditor = (smartadapters4ART.resource.smARText.ui.SmARTextEditor) editor;
