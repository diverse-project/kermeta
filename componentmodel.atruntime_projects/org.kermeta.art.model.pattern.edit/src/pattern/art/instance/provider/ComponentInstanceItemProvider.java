...
/**
 * This is the item provider adapter for a {@link pattern.art.instance.ComponentInstance} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ComponentInstanceItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 InstancePackage.Literals.COMPONENT_INSTANCE__STATE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(InstancePackage.Literals.COMPONENT_INSTANCE__ATTRIBUTE);
			childrenFeatures.add(InstancePackage.Literals.COMPONENT_INSTANCE__BINDING);
			childrenFeatures.add(InstancePackage.Literals.COMPONENT_INSTANCE__IMPLEM);
		}
