...
import pattern.art.provider.CardinalityElementItemProvider;
...
/**
 * This is the item provider adapter for a {@link pattern.art.type.Port} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TypePackage.Literals.ABSTRACT_PORT__SERVICE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TypePackage.Literals.ABSTRACT_PORT__ROLE,
				 true,
				 false,
				 false,
