...
public class ArtEditorConfiguration extends org.eclipse.jface.text.source.SourceViewerConfiguration {
	
	private art.resource.art.ui.ArtColorManager colorManager;
	private art.resource.art.ui.ArtEditor theEditor;
	...
	// @param colorManager
	///
	public ArtEditorConfiguration(art.resource.art.ui.ArtEditor editor, art.resource.art.ui.ArtColorManager colorManager) {
	...
	public org.eclipse.jface.text.contentassist.IContentAssistant getContentAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		assistant.setContentAssistProcessor(new art.resource.art.ui.ArtCompletionProcessor(theEditor), org.eclipse.jface.text.IDocument.DEFAULT_CONTENT_TYPE);
	...
	public org.eclipse.jface.text.ITextHover getTextHover(org.eclipse.jface.text.source.ISourceViewer sourceViewer, String contentType) {
		return new art.resource.art.ui.ArtTextHover(theEditor);
	}
	...
	public org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] getHyperlinkDetectors(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		return new org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] { new art.resource.art.ui.ArtHyperlinkDetector(theEditor.getResource()) };
	}
