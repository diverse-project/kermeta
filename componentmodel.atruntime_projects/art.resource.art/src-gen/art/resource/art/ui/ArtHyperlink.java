...
public class ArtHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	...
	public ArtHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				if (editorPart instanceof art.resource.art.ui.ArtEditor) {
					art.resource.art.ui.ArtEditor emftEditor = (art.resource.art.ui.ArtEditor) editorPart;
