...
//
public class ArtPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	
	public void init(org.eclipse.ui.IWorkbench workbench) {
		setPreferenceStore(art.resource.art.mopp.ArtPlugin.getDefault().getPreferenceStore());
		setDescription(" Art Text Editor Preferences");
	}
