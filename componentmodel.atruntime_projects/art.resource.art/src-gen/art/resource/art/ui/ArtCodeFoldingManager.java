...
public class ArtCodeFoldingManager {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(art.resource.art.ui.ArtEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof art.resource.art.ui.ArtEditor) {
				art.resource.art.ui.ArtEditor editor = (art.resource.art.ui.ArtEditor) workbenchPart;
	...
	protected void calculatePositions() {
		art.resource.art.IArtTextResource textResource = (art.resource.art.IArtTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
