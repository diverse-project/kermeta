...
public class ArtEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider {
	...
	private art.resource.art.ui.ArtOutlinePage outlinePage;
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), ArtEditor.this);
		}
	}
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								art.resource.art.IArtTextResource currentResource = getResource();
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new art.resource.art.ui.ArtHighlighting(getResource(), viewer, colorManager, this);
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		art.resource.art.IArtTextResource loadedResource = (art.resource.art.IArtTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				art.resource.art.IArtTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof art.resource.art.IArtTextResource) {
					setResource((art.resource.art.IArtTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but
					// some other EMF resource
					art.resource.art.mopp.ArtPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the ArtEditor.");
	...
	private void setResource(art.resource.art.IArtTextResource resource) {
		assert resource != null;
	...
	private java.lang.Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new art.resource.art.ui.ArtOutlinePage(this);
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			art.resource.art.IArtTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
	...
	private void refreshMarkers(final org.eclipse.emf.ecore.resource.Resource resourceToRefresh) {
		...
		if (display != null) {
			display.asyncExec(new java.lang.Runnable() {
				public void run() {
					try {
						art.resource.art.ui.ArtMarkerHelper.unmark(resourceToRefresh);
						art.resource.art.ui.ArtMarkerHelper.mark(resourceToRefresh);
