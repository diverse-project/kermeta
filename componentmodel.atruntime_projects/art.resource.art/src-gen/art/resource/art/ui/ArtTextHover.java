...
//
public class ArtTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2{
	...
	private art.resource.art.IArtHoverTextProvider hoverTextProvider;
	// The style sheet (css).
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final art.resource.art.ui.ArtBrowserInformationControl infoControl;
		...
		//            target element
		public OpenDeclarationAction(art.resource.art.ui.ArtBrowserInformationControl infoControl) {
		...
		public void run() {
			art.resource.art.ui.ArtDocBrowserInformationControlInput infoInput = (art.resource.art.ui.ArtDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					art.resource.art.ui.ArtHyperlink hyperlink = new art.resource.art.ui.ArtHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (art.resource.art.ui.ArtBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				art.resource.art.ui.ArtBrowserInformationControl iControl = new art.resource.art.ui.ArtBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(java.lang.Object newInput) {
						...
						} else if (newInput instanceof art.resource.art.ui.ArtDocBrowserInformationControlInput) {
							art.resource.art.ui.ArtDocBrowserInformationControlInput input = (art.resource.art.ui.ArtDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (art.resource.art.ui.ArtBrowserInformationControl.isAvailable(parent)) {
				art.resource.art.ui.ArtBrowserInformationControl iControl = new art.resource.art.ui.ArtBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	...
	// element.
	public ArtTextHover(art.resource.art.ui.ArtEditor editor) {
		super();
		this.editor = editor;
		hoverTextProvider = new art.resource.art.mopp.ArtMetaInformation().getHoverTextProvider();
	}
	
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		return ((art.resource.art.ui.ArtDocBrowserInformationControlInput) getHoverInfo2(textViewer, hoverRegion)).getHtml();
	}
	...
	private art.resource.art.ui.ArtDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		art.resource.art.IArtTextResource textResource = editor.getResource();
	...
	private art.resource.art.ui.ArtDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, art.resource.art.ui.ArtDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				art.resource.art.ui.ArtHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(declarationObject));
			}
		} else {
			art.resource.art.ui.ArtHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			art.resource.art.ui.ArtHTMLPrinter.insertPageProlog(buffer, 0, art.resource.art.ui.ArtTextHover.getStyleSheet());
			art.resource.art.ui.ArtHTMLPrinter.addPageEpilog(buffer);
			return new art.resource.art.ui.ArtDocBrowserInformationControlInput(previousInput, declarationObject, editor.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		if (css != null) {
			...
			css = art.resource.art.ui.ArtHTMLPrinter.convertTopLevelFont(css, fontData);
		}
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(art.resource.art.mopp.ArtPlugin.PLUGIN_ID);
