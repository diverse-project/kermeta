...
public class ArtDocBrowserInformationControlInput {
	
	private final ArtDocBrowserInformationControlInput fPrevious;
	private ArtDocBrowserInformationControlInput fNext;
	...
	///
	public ArtDocBrowserInformationControlInput(ArtDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	...
	public ArtDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	...
	public ArtDocBrowserInformationControlInput getNext() {
		return fNext;
	}
