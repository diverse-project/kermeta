...
public class ArtBackgroundParsingStrategy {
	...
	// a delay.
	public void parse(org.eclipse.jface.text.DocumentEvent event, final art.resource.art.IArtTextResource resource, final art.resource.art.ui.ArtEditor editor) {
		if (resource == null) {
			return;
		}
