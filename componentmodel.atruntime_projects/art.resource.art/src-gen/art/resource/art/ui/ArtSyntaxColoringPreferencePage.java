...
///
public class ArtSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = art.resource.art.ui.ArtSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, art.resource.art.ui.ArtSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = art.resource.art.ui.ArtSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, art.resource.art.ui.ArtSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = art.resource.art.ui.ArtSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, art.resource.art.ui.ArtSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = art.resource.art.ui.ArtSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, art.resource.art.ui.ArtSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = art.resource.art.ui.ArtSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, art.resource.art.ui.ArtSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = art.resource.art.ui.ArtSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, art.resource.art.ui.ArtSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		art.resource.art.ui.ArtPixelConverter pixelConverter = new art.resource.art.ui.ArtPixelConverter(composite);
	...
	public ArtSyntaxColoringPreferencePage() {
		super();
		
		art.resource.art.IArtMetaInformation syntaxPlugin = new art.resource.art.mopp.ArtMetaInformation();
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof art.resource.art.ui.ArtEditor) {
			art.resource.art.ui.ArtEditor emfTextEditor = (art.resource.art.ui.ArtEditor) editor;
