...
//
public interface IArtReferenceResolver<ContainerType extends org.eclipse.emf.ecore.EObject, ReferenceType extends org.eclipse.emf.ecore.EObject> extends art.resource.art.IArtConfigurable {
	...
	public void resolve(String identifier, ContainerType container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, art.resource.art.IArtReferenceResolveResult<ReferenceType> result);
