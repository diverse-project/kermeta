...
public interface IArtMetaInformation {
	...
	// @param encoding
	// @return
	public art.resource.art.IArtTextParser createParser(java.io.InputStream inputStream, String encoding);
	...
	public art.resource.art.IArtTokenStyle getDefaultTokenStyle(String tokenName);
