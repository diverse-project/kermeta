...
public class ArtReferenceResolverSwitch implements art.resource.art.IArtReferenceResolverSwitch {
	...
	protected art.resource.art.analysis.AbstractPortServiceReferenceResolver abstractPortServiceReferenceResolver = new art.resource.art.analysis.AbstractPortServiceReferenceResolver();
	...
	public art.resource.art.analysis.AbstractPortServiceReferenceResolver getAbstractPortServiceReferenceResolver() {
	...
	public void resolveFuzzy(java.lang.String identifier, org.eclipse.emf.ecore.EObject container, org.eclipse.emf.ecore.EReference reference, int position, art.resource.art.IArtReferenceResolveResult<org.eclipse.emf.ecore.EObject> result) {
		if (container == null) {
			return;
		}
		...
		if (art.instance.InstancePackage.eINSTANCE.getTransmissionBinding().isInstance(container)) {
			ArtFuzzyResolveResult<art.type.AbstractPort> frr = new ArtFuzzyResolveResult<art.type.AbstractPort>(result);
			org.eclipse.emf.ecore.EStructuralFeature feature = container.eClass().getEStructuralFeature(reference.getName());
			if (feature instanceof org.eclipse.emf.ecore.EReference) {
