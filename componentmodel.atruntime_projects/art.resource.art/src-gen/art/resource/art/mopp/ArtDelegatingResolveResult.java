...
//
public class ArtDelegatingResolveResult<ReferenceType> implements art.resource.art.IArtReferenceResolveResult<ReferenceType> {
	
	private art.resource.art.IArtReferenceResolveResult<ReferenceType> delegate;
	
	public ArtDelegatingResolveResult(art.resource.art.IArtReferenceResolveResult<ReferenceType> delegate) {
