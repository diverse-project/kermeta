...
public class ArtPrinter implements art.resource.art.IArtTextPrinter {
	...
	protected void doPrint(org.eclipse.emf.ecore.EObject element, java.io.PrintWriter out, java.lang.String globaltab) {
		...
		if (element instanceof art.implem.OSGiPort) {
			print_art_implem_OSGiPort((art.implem.OSGiPort) element, globaltab, out);
			return;
		}
	...
	public void print_art_type_Port(art.type.Port element, java.lang.String outertab, java.io.PrintWriter out) {
		...
		temp = element.eGet(element.eClass().getEStructuralFeature(art.type.TypePackage.PORT__IMPLEM));
		printCountingMap.put("implem", temp == null ? 0 : 1);
		// print collected hidden tokens
		int count;
		java.io.StringWriter sWriter = null;
	...
	public void print_art_type_Port_1(art.type.Port element, java.lang.String outertab, java.io.PrintWriter out, java.util.Map<java.lang.String, java.lang.Integer> printCountingMap){
		java.lang.String localtab = outertab;
		int count;
		//////////////DEFINITION PART BEGINS (LineBreak):
		localtab += "	";
		...
		count = printCountingMap.get("implem");
		if (count > 0) {
			Object o = element.eGet(element.eClass().getEStructuralFeature(art.type.TypePackage.PORT__IMPLEM));
			if (o != null) {
				doPrint((org.eclipse.emf.ecore.EObject) o, out, localtab);
			}
			printCountingMap.put("implem", count - 1);
	...
	public void print_art_implem_OSGiPort(art.implem.OSGiPort element, java.lang.String outertab, java.io.PrintWriter out) {
		java.util.Map<java.lang.String, java.lang.Integer> printCountingMap = new java.util.HashMap<java.lang.String, java.lang.Integer>(1);
		java.lang.Object temp;
		temp = element.eGet(element.eClass().getEStructuralFeature(art.implem.ImplemPackage.OS_GI_PORT__SERVICE_ID));
		printCountingMap.put("serviceId", temp == null ? 0 : 1);
		// print collected hidden tokens
		int count;
		//////////////DEFINITION PART BEGINS (CsString):
		out.print("OSGiPort");
		...
		out.print(" ");
		//////////////DEFINITION PART BEGINS (PlaceholderUsingSpecifiedToken):
		count = printCountingMap.get("serviceId");
		if (count > 0) {
			Object o = element.eGet(element.eClass().getEStructuralFeature(art.implem.ImplemPackage.OS_GI_PORT__SERVICE_ID));
			if (o != null) {
				art.resource.art.IArtTokenResolver resolver = tokenResolverFactory.createTokenResolver("STRING_LITERAL");
				resolver.setOptions(getOptions());
				out.print(resolver.deResolve((java.lang.Object) o, element.eClass().getEStructuralFeature(art.implem.ImplemPackage.OS_GI_PORT__SERVICE_ID), element));
			}
