...
public class SmARTextHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	...
	public SmARTextHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				if (editorPart instanceof org.smartadapters.core.resource.smARText.ui.SmARTextEditor) {
					org.smartadapters.core.resource.smARText.ui.SmARTextEditor emftEditor = (org.smartadapters.core.resource.smARText.ui.SmARTextEditor) editorPart;
