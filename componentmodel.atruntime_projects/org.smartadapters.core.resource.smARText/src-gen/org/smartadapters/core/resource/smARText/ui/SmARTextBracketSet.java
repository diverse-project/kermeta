...
public class SmARTextBracketSet {
	...
	private java.util.ArrayList<org.smartadapters.core.resource.smARText.ISmARTextBracketPair> bracketPairs;
	...
	private class BracketPair implements org.smartadapters.core.resource.smARText.ISmARTextBracketPair {
	...
	private class ClosingListener implements org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				org.smartadapters.core.resource.smARText.ISmARTextBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	...
	public SmARTextBracketSet(org.eclipse.jface.text.source.ISourceViewer sourceViewer, String extension) {
		languageID = extension;
		this.bracketPairs = new java.util.ArrayList<org.smartadapters.core.resource.smARText.ISmARTextBracketPair>();
	...
	public org.smartadapters.core.resource.smARText.ISmARTextBracketPair getBracketPair(String opening, String closing) {
		for (org.smartadapters.core.resource.smARText.ISmARTextBracketPair bracketPair : bracketPairs) {
	...
	public org.smartadapters.core.resource.smARText.ISmARTextBracketPair getBracketPair(int index) {
		try {
	...
	public boolean setClosingEnabledInside(org.smartadapters.core.resource.smARText.ISmARTextBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + org.smartadapters.core.resource.smARText.ui.SmARTextPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	...
	public org.smartadapters.core.resource.smARText.ISmARTextBracketPair remove(String opening, String closing) {
		for (org.smartadapters.core.resource.smARText.ISmARTextBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<org.smartadapters.core.resource.smARText.ISmARTextBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, org.smartadapters.core.resource.smARText.ui.SmARTextPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, org.smartadapters.core.resource.smARText.ui.SmARTextPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
