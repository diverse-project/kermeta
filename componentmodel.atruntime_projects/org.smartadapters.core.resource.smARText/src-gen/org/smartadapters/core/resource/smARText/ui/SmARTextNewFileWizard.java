...
public class SmARTextNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	
	private String categoryId = null;
	private org.smartadapters.core.resource.smARText.ui.SmARTextNewFileWizardPage page;
	private org.eclipse.jface.viewers.ISelection selection;
	private String newName = null;
	
	public SmARTextNewFileWizard() {
		super();
	...
	public void addPages() {
		page = new org.smartadapters.core.resource.smARText.ui.SmARTextNewFileWizardPage(selection, getFileExtension());
		addPage(page);
	}
	...
	public boolean performFinish() {
		...
		try {
			...
			org.smartadapters.core.resource.smARText.mopp.SmARTextPlugin.logError("java.lang.Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			org.smartadapters.core.resource.smARText.mopp.SmARTextPlugin.logError("java.lang.Exception while initializing new file", e);
			return false;
		}
		return true;
	}
	...
	private java.io.InputStream openContentStream() {
		return new java.io.ByteArrayInputStream(new org.smartadapters.core.resource.smARText.mopp.SmARTextMetaInformation().getNewFileContentProvider().getNewFileContent(newName).getBytes());
	}
	...
	public java.lang.String getFileExtension() {
		return new org.smartadapters.core.resource.smARText.mopp.SmARTextMetaInformation().getSyntaxName();
	}
	
	public org.smartadapters.core.resource.smARText.ISmARTextMetaInformation getMetaInformation() {
