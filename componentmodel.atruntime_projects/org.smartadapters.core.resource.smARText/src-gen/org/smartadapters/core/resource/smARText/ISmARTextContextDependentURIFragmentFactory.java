...
// An interface for factories to create instances of org.smartadapters.core.resource.smARText.ISmARTextContextDependentURIFragment.
//
// @param <ContainerType> the type of the class containing the reference to be resolved
// @param <ReferenceType> the type of the reference to be resolved
//
public interface ISmARTextContextDependentURIFragmentFactory<ContainerType extends org.eclipse.emf.ecore.EObject, ReferenceType extends org.eclipse.emf.ecore.EObject> {
	
	// Create a new instance of the org.smartadapters.core.resource.smARText.ISmARTextContextDependentURIFragment interface.
	//
