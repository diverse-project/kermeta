...
public class SmARTextTextToken implements org.smartadapters.core.resource.smARText.ISmARTextTextToken {
	
	private final org.smartadapters.core.resource.smARText.ISmARTextMetaInformation metaInformation = new org.smartadapters.core.resource.smARText.mopp.SmARTextMetaInformation();
	private final org.antlr.runtime.Token antlrToken;
	
	public SmARTextTextToken(org.antlr.runtime.Token antlrToken) {
		super();
