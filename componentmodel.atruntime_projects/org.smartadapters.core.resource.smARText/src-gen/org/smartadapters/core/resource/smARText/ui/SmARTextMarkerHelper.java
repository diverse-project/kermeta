...
// If a resource contains <code>org.smartadapters.core.resource.smARText.ISmARTextTextDiagnostic</code>s it uses the more precise information of
// this extended diagnostic type.
public class SmARTextMarkerHelper {
	
	public static final String MARKER_TYPE = org.smartadapters.core.resource.smARText.mopp.SmARTextPlugin.PLUGIN_ID + ".problem";
	...
	private static void createMarkersFromDiagnostics(org.eclipse.emf.ecore.resource.Resource resource, org.eclipse.core.resources.IFile file, java.util.List<org.eclipse.emf.ecore.resource.Resource.Diagnostic> diagnostics, int markerSeverity) throws org.eclipse.core.runtime.CoreException {
		...
		for (org.eclipse.emf.ecore.resource.Resource.Diagnostic diagnostic : diagnostics) {
			try {
				...
				if (diagnostic instanceof org.smartadapters.core.resource.smARText.ISmARTextTextDiagnostic) {
					org.smartadapters.core.resource.smARText.ISmARTextTextDiagnostic textDiagnostic = (org.smartadapters.core.resource.smARText.ISmARTextTextDiagnostic) diagnostic;
	...
	public static void unmark(org.eclipse.emf.ecore.resource.Resource resource) throws org.eclipse.core.runtime.CoreException {
		org.eclipse.core.resources.IFile file = (org.eclipse.core.resources.IFile) org.eclipse.core.resources.ResourcesPlugin.getWorkspace().getRoot().findMember(resource.getURI().toPlatformString(true));
		if (file != null) {
			file.deleteMarkers(org.smartadapters.core.resource.smARText.ui.SmARTextMarkerHelper.MARKER_TYPE, false, org.eclipse.core.resources.IResource.DEPTH_ZERO);
		}
	}
}
