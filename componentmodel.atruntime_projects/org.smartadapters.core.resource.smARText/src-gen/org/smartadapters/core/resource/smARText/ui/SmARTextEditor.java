...
//
// A text editor for 'smARText' models.
//
public class SmARTextEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider {
	
	private org.smartadapters.core.resource.smARText.ui.SmARTextHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private org.smartadapters.core.resource.smARText.ui.SmARTextCodeFoldingManager codeFoldingManager;
	private org.smartadapters.core.resource.smARText.ui.SmARTextBackgroundParsingStrategy bgParsingStrategy = new org.smartadapters.core.resource.smARText.ui.SmARTextBackgroundParsingStrategy();
	private java.util.Collection<org.smartadapters.core.resource.smARText.ISmARTextBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<org.smartadapters.core.resource.smARText.ISmARTextBackgroundParsingListener>();
	private org.smartadapters.core.resource.smARText.ui.SmARTextColorManager colorManager = new org.smartadapters.core.resource.smARText.ui.SmARTextColorManager();
	private org.smartadapters.core.resource.smARText.ui.SmARTextOutlinePage outlinePage;
	...
	private org.smartadapters.core.resource.smARText.ui.SmARTextPropertySheetPage propertySheetPage;
	...
	public SmARTextEditor() {
		super();
		setDocumentProvider(new org.eclipse.ui.editors.text.FileDocumentProvider());
		setSourceViewerConfiguration(new org.smartadapters.core.resource.smARText.ui.SmARTextEditorConfiguration(this, colorManager));
	...
	private final class MarkerUpdateListener implements org.smartadapters.core.resource.smARText.ISmARTextBackgroundParsingListener {
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), SmARTextEditor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								org.smartadapters.core.resource.smARText.ISmARTextTextResource currentResource = getResource();
				...
				org.smartadapters.core.resource.smARText.mopp.SmARTextPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new org.smartadapters.core.resource.smARText.ui.SmARTextHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new org.smartadapters.core.resource.smARText.ui.SmARTextCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		org.smartadapters.core.resource.smARText.mopp.SmARTextNature.activate(inputFile.getProject());
		...
		org.smartadapters.core.resource.smARText.ISmARTextTextResource loadedResource = (org.smartadapters.core.resource.smARText.ISmARTextTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				org.smartadapters.core.resource.smARText.ISmARTextTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof org.smartadapters.core.resource.smARText.ISmARTextTextResource) {
					setResource((org.smartadapters.core.resource.smARText.ISmARTextTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but
					// some other EMF resource
					org.smartadapters.core.resource.smARText.mopp.SmARTextPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the SmARTextEditor.");
					//close this editor because it can not present the resource
					close(false);
				}
			} catch (java.lang.Exception e) {
				org.smartadapters.core.resource.smARText.mopp.SmARTextPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(org.smartadapters.core.resource.smARText.ISmARTextTextResource resource) {
		assert resource != null;
	...
	private java.lang.Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new org.smartadapters.core.resource.smARText.ui.SmARTextOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new org.smartadapters.core.resource.smARText.ui.SmARTextPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			org.smartadapters.core.resource.smARText.ISmARTextTextResource textResource = (org.smartadapters.core.resource.smARText.ISmARTextTextResource) element.eResource();
			org.smartadapters.core.resource.smARText.ISmARTextLocationMap locationMap = textResource.getLocationMap();
			int destination = locationMap.getCharStart(element);
			int length = locationMap.getCharEnd(element) + 1 - destination;
			
			org.smartadapters.core.resource.smARText.ISmARTextTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				org.smartadapters.core.resource.smARText.ISmARTextTextToken token = lexer.getNextToken();
			...
			org.smartadapters.core.resource.smARText.mopp.SmARTextPlugin.logError("java.lang.Exception in setCaret()", e);
		}
	}
	...
	public void addBackgroundParsingListener(org.smartadapters.core.resource.smARText.ISmARTextBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (org.smartadapters.core.resource.smARText.ISmARTextBackgroundParsingListener listener : bgParsingListeners) {
	...
	private void refreshMarkers(final org.eclipse.emf.ecore.resource.Resource resourceToRefresh) {
		...
		if (display != null) {
			display.asyncExec(new java.lang.Runnable() {
				public void run() {
					try {
						org.smartadapters.core.resource.smARText.ui.SmARTextMarkerHelper.unmark(resourceToRefresh);
						org.smartadapters.core.resource.smARText.ui.SmARTextMarkerHelper.mark(resourceToRefresh);
					} catch (org.eclipse.core.runtime.CoreException e) {
						org.smartadapters.core.resource.smARText.mopp.SmARTextPlugin.logError("Exception while updating markers on resource", e);
					}
				}
			});
		}
