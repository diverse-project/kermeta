...
public class SmARTextBackgroundParsingStrategy {
	...
	// a delay.
	public void parse(org.eclipse.jface.text.DocumentEvent event, final org.smartadapters.core.resource.smARText.ISmARTextTextResource resource, final org.smartadapters.core.resource.smARText.ui.SmARTextEditor editor) {
		if (resource == null) {
			return;
		}
