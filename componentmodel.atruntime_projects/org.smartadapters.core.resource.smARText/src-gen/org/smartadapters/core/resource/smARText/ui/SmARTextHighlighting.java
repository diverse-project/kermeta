...
public class SmARTextHighlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	...
	private final static org.smartadapters.core.resource.smARText.ui.SmARTextPositionHelper positionHelper = new org.smartadapters.core.resource.smARText.ui.SmARTextPositionHelper();
	private boolean isHighlightBrackets = true;
	private boolean isHighlightOccurrences = true;
	private org.smartadapters.core.resource.smARText.ui.SmARTextTokenScanner scanner;
	...
	private org.smartadapters.core.resource.smARText.ui.SmARTextOccurrence occurrence;
	private org.smartadapters.core.resource.smARText.ui.SmARTextBracketSet bracketSet;
	...
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, org.smartadapters.core.resource.smARText.ISmARTextBackgroundParsingListener {
	...
	public SmARTextHighlighting(org.smartadapters.core.resource.smARText.ISmARTextTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, org.smartadapters.core.resource.smARText.ui.SmARTextColorManager colorManager, org.smartadapters.core.resource.smARText.ui.SmARTextEditor editor) {
		this.display = org.eclipse.swt.widgets.Display.getCurrent();
		sourceviewer.getSelectionProvider();
		preferenceStore = org.smartadapters.core.resource.smARText.mopp.SmARTextPlugin.getDefault().getPreferenceStore();
		textWidget = sourceviewer.getTextWidget();
		projectionViewer = sourceviewer;
		scanner = new org.smartadapters.core.resource.smARText.ui.SmARTextTokenScanner(colorManager);
		occurrence = new org.smartadapters.core.resource.smARText.ui.SmARTextOccurrence(textResource, sourceviewer, scanner);
		bracketSet = new org.smartadapters.core.resource.smARText.ui.SmARTextBracketSet(sourceviewer, "smARText");
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(org.smartadapters.core.resource.smARText.ui.SmARTextPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		isHighlightOccurrences = preferenceStore.getBoolean(org.smartadapters.core.resource.smARText.ui.SmARTextPreferenceConstants.EDITOR_OCCURRENCE_CHECKBOX);
		definitionColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, org.smartadapters.core.resource.smARText.ui.SmARTextPreferenceConstants.EDITOR_DEFINITION_COLOR));
		proxyColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, org.smartadapters.core.resource.smARText.ui.SmARTextPreferenceConstants.EDITOR_PROXY_COLOR));
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, org.smartadapters.core.resource.smARText.ui.SmARTextPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		black = colorManager.getColor(new org.eclipse.swt.graphics.RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(org.smartadapters.core.resource.smARText.ui.SmARTextEditor editor) {
	...
	private void setHighlighting() {
		...
		if (occurrence.isPositionsChanged()) {
			...
			org.smartadapters.core.resource.smARText.ui.SmARTextPositionCategory.DEFINTION.toString());
			setCategoryHighlighting(document,
			org.smartadapters.core.resource.smARText.ui.SmARTextPositionCategory.PROXY.toString());
		}
		setCategoryHighlighting(document, org.smartadapters.core.resource.smARText.ui.SmARTextPositionCategory.BRACKET.toString());
	}
	...
	private void setCategoryHighlighting(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(org.smartadapters.core.resource.smARText.ui.SmARTextPositionCategory.PROXY.toString())) {
		...
		for (org.eclipse.jface.text.Position position : positions) {
			...
			if (tmpPosition != null) {
				if (category.equals(org.smartadapters.core.resource.smARText.ui.SmARTextPositionCategory.DEFINTION.toString())) {
				...
				if (category.equals(org.smartadapters.core.resource.smARText.ui.SmARTextPositionCategory.BRACKET.toString())) {
					styleRange = getStyleRangeAtPosition(tmpPosition);
	...
	private void removeHighlighting() {
		org.eclipse.jface.text.IDocument document = projectionViewer.getDocument();
		removeHighlightingCategory(document, org.smartadapters.core.resource.smARText.ui.SmARTextPositionCategory.BRACKET.toString());
		if (occurrence.isToRemoveHighlighting()) {
			removeHighlightingCategory(document, org.smartadapters.core.resource.smARText.ui.SmARTextPositionCategory.DEFINTION.toString());
			removeHighlightingCategory(document, org.smartadapters.core.resource.smARText.ui.SmARTextPositionCategory.PROXY.toString());
			lastStyleRange = null;
		}
	}
	...
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, category);
		boolean isOccurrence = (category.equals(org.smartadapters.core.resource.smARText.ui.SmARTextPositionCategory.DEFINTION.toString()) || category.equals(org.smartadapters.core.resource.smARText.ui.SmARTextPositionCategory.PROXY.toString())) && lastStyleRange != null;
		if (category.equals(org.smartadapters.core.resource.smARText.ui.SmARTextPositionCategory.BRACKET.toString())) {
		...
		display.syncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new org.smartadapters.core.resource.smARText.ui.SmARTextEObjectSelection(selectedEObject, false));
				}
			}
		});
	}
	...
	private void handleContentOutlineSelection(org.eclipse.jface.viewers.ISelection selection) {
		if (!selection.isEmpty()) {
			...
			if (selectedElement instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (resource instanceof org.smartadapters.core.resource.smARText.ISmARTextTextResource) {
