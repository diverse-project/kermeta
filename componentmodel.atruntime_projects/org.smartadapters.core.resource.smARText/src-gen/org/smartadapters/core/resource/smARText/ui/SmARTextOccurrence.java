...
public class SmARTextOccurrence {
	...
	private org.smartadapters.core.resource.smARText.ui.SmARTextTokenScanner tokenScanner;
	...
	private org.smartadapters.core.resource.smARText.ISmARTextTextResource textResource;
	...
	//
	public SmARTextOccurrence(org.smartadapters.core.resource.smARText.ISmARTextTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer, org.smartadapters.core.resource.smARText.ui.SmARTextTokenScanner tokenScanner) {
		this.textResource = textResource;
		this.projectionViewer = sourceViewer;
		
		quotedTokenArray = new java.util.ArrayList<String>();
		String[] tokenNames = new org.smartadapters.core.resource.smARText.mopp.SmARTextMetaInformation().getTokenNames();
	...
	public void handleOccurrenceHighlighting(org.smartadapters.core.resource.smARText.ui.SmARTextBracketSet bracketSet) {
		...
		if (resource.equals(textResource)) {
			...
			while (!token.isEOF()) {
				...
				if (text.equals(tokenText)) {
					...
					addPosition(document, org.smartadapters.core.resource.smARText.ui.SmARTextPositionCategory.DEFINTION.toString());
					break;
				}
				token = tokenScanner.nextToken();
			}
			...
			if (text != null && text.equals(tokenText) && tokenScanner.getTokenOffset() != defPosition) {
				...
				if (occEO != null) {
					if ((isNull && elementsAtDefinition.contains(occEO)) || !isNull && definitionElement.equals(occEO)) {
						addPosition(document, org.smartadapters.core.resource.smARText.ui.SmARTextPositionCategory.PROXY.toString());
					}
				}
			}
			token = tokenScanner.nextToken();
