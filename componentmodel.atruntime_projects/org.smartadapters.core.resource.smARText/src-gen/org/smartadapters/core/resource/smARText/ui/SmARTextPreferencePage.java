...
//
public class SmARTextPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	
	public void init(org.eclipse.ui.IWorkbench workbench) {
		setPreferenceStore(org.smartadapters.core.resource.smARText.mopp.SmARTextPlugin.getDefault().getPreferenceStore());
		setDescription(" SmARText Text Editor Preferences");
	}
