...
// </ul>
//
public class SmARTextBracketPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	
	private static final String[] ALL_LEFT_BRACKETS = new String[] { "{", "(", "[", "<", "\"", "'", };
	private static final String[] ALL_RIGHT_BRACKETS = new String[] { "}", ")", "]", ">", "\"", "'", };
	
	private String BRACKETS_COLOR = org.smartadapters.core.resource.smARText.ui.SmARTextPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR;
	...
	private String language = new org.smartadapters.core.resource.smARText.mopp.SmARTextMetaInformation().getSyntaxName();
	
	private org.smartadapters.core.resource.smARText.ui.SmARTextBracketSet bracketsTmp;
	
	//
	// Creates a preference page for bracket setting.
	//
	public SmARTextBracketPreferencePage() {
		super();
		
		org.smartadapters.core.resource.smARText.ISmARTextMetaInformation metaInformation = new org.smartadapters.core.resource.smARText.mopp.SmARTextMetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench) {
		setPreferenceStore(org.smartadapters.core.resource.smARText.mopp.SmARTextPlugin.getDefault().getPreferenceStore());
		setDescription("Define the coloring of matching brackets.");
		
		bracketsTmp = new org.smartadapters.core.resource.smARText.ui.SmARTextBracketSet(null, null);
		for (String languageID : languageIDs) {
			bracketSetTemp.put(languageID, getPreferenceStore().getString(languageID + org.smartadapters.core.resource.smARText.ui.SmARTextPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		}
	}
	...
	private void handleMatchingBracketsSelection() {
		...
		enableCheckbox.setSelection(getPreferenceStore().getBoolean(		org.smartadapters.core.resource.smARText.ui.SmARTextPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		enableClosingInside.setSelection(false);
		matchingBracketsColorButton.setEnabled(getPreferenceStore().getBoolean(		org.smartadapters.core.resource.smARText.ui.SmARTextPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		...
		initializeLanguage();
		bracketsTmp.setBrackets(getPreferenceStore().getString(language + org.smartadapters.core.resource.smARText.ui.SmARTextPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		...
		bracketsList.addSelectionListener(new org.eclipse.swt.events.SelectionListener() {
			...
			public void widgetSelected(org.eclipse.swt.events.SelectionEvent e) {
				...
				for (int index : itemIndices) {
					org.smartadapters.core.resource.smARText.ISmARTextBracketPair bracketPair = bracketsTmp.getBracketPair(index);
		...
		enableClosingInside.addSelectionListener(new org.eclipse.swt.events.SelectionListener() {
			...
			public void widgetSelected(org.eclipse.swt.events.SelectionEvent e) {
				...
				for (int idx : itemIndices) {
					org.smartadapters.core.resource.smARText.ISmARTextBracketPair bracketPair = bracketsTmp.getBracketPair(idx);
	...
	protected void performDefaults() {
		enableCheckbox.setSelection(getPreferenceStore().getDefaultBoolean(		org.smartadapters.core.resource.smARText.ui.SmARTextPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		matchingBracketsColorButton.setEnabled(enableCheckbox.getSelection());
		...
		bracketSetTemp.put(language, getPreferenceStore().getDefaultString(		language + org.smartadapters.core.resource.smARText.ui.SmARTextPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		bracketsTmp.setBrackets(bracketSetTemp.get(language));
		bracketsList.setItems(bracketsTmp.getBracketArray());
		enableClosingInside.setSelection(false);
	}
	...
	private void updateActiveEditor() {
		...
		getPreferenceStore().setValue(org.smartadapters.core.resource.smARText.ui.SmARTextPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX, enableCheckbox.getSelection());
		getPreferenceStore().setValue(language + org.smartadapters.core.resource.smARText.ui.SmARTextPreferenceConstants.EDITOR_BRACKETS_SUFFIX, bracketSetTemp.get(language));
		...
		if (editor != null && editor instanceof org.smartadapters.core.resource.smARText.ui.SmARTextEditor) {
			((org.smartadapters.core.resource.smARText.ui.SmARTextEditor) editor).invalidateTextRepresentation();
		}
	}
