...
//
public class SmARTextTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2{
	...
	private org.smartadapters.core.resource.smARText.ISmARTextHoverTextProvider hoverTextProvider;
	// The style sheet (css).
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final org.smartadapters.core.resource.smARText.ui.SmARTextBrowserInformationControl infoControl;
		...
		//            target element
		public OpenDeclarationAction(org.smartadapters.core.resource.smARText.ui.SmARTextBrowserInformationControl infoControl) {
		...
		public void run() {
			org.smartadapters.core.resource.smARText.ui.SmARTextDocBrowserInformationControlInput infoInput = (org.smartadapters.core.resource.smARText.ui.SmARTextDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					org.smartadapters.core.resource.smARText.ui.SmARTextHyperlink hyperlink = new org.smartadapters.core.resource.smARText.ui.SmARTextHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (org.smartadapters.core.resource.smARText.ui.SmARTextBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				org.smartadapters.core.resource.smARText.ui.SmARTextBrowserInformationControl iControl = new org.smartadapters.core.resource.smARText.ui.SmARTextBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(java.lang.Object newInput) {
						...
						} else if (newInput instanceof org.smartadapters.core.resource.smARText.ui.SmARTextDocBrowserInformationControlInput) {
							org.smartadapters.core.resource.smARText.ui.SmARTextDocBrowserInformationControlInput input = (org.smartadapters.core.resource.smARText.ui.SmARTextDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (org.smartadapters.core.resource.smARText.ui.SmARTextBrowserInformationControl.isAvailable(parent)) {
				org.smartadapters.core.resource.smARText.ui.SmARTextBrowserInformationControl iControl = new org.smartadapters.core.resource.smARText.ui.SmARTextBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	...
	// element.
	public SmARTextTextHover(org.smartadapters.core.resource.smARText.ui.SmARTextEditor editor) {
		super();
		this.editor = editor;
		hoverTextProvider = new org.smartadapters.core.resource.smARText.mopp.SmARTextMetaInformation().getHoverTextProvider();
	}
	
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		return ((org.smartadapters.core.resource.smARText.ui.SmARTextDocBrowserInformationControlInput) getHoverInfo2(textViewer, hoverRegion)).getHtml();
	}
	...
	private org.smartadapters.core.resource.smARText.ui.SmARTextDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		org.smartadapters.core.resource.smARText.ISmARTextTextResource textResource = editor.getResource();
	...
	private org.smartadapters.core.resource.smARText.ui.SmARTextDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, org.smartadapters.core.resource.smARText.ui.SmARTextDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				org.smartadapters.core.resource.smARText.ui.SmARTextHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(declarationObject));
			}
		} else {
			org.smartadapters.core.resource.smARText.ui.SmARTextHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			org.smartadapters.core.resource.smARText.ui.SmARTextHTMLPrinter.insertPageProlog(buffer, 0, org.smartadapters.core.resource.smARText.ui.SmARTextTextHover.getStyleSheet());
			org.smartadapters.core.resource.smARText.ui.SmARTextHTMLPrinter.addPageEpilog(buffer);
			return new org.smartadapters.core.resource.smARText.ui.SmARTextDocBrowserInformationControlInput(previousInput, declarationObject, editor.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		if (css != null) {
			...
			css = org.smartadapters.core.resource.smARText.ui.SmARTextHTMLPrinter.convertTopLevelFont(css, fontData);
		}
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(org.smartadapters.core.resource.smARText.mopp.SmARTextPlugin.PLUGIN_ID);
