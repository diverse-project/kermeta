...
public interface ISmARTextMetaInformation {
	...
	// @param encoding
	// @return
	public org.smartadapters.core.resource.smARText.ISmARTextTextParser createParser(java.io.InputStream inputStream, String encoding);
	...
	public org.smartadapters.core.resource.smARText.ISmARTextTokenStyle getDefaultTokenStyle(String tokenName);
