...
public class SmARTextCodeFoldingManager {
	
	private class FoldingUpdateListener implements org.smartadapters.core.resource.smARText.ISmARTextBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(org.smartadapters.core.resource.smARText.ui.SmARTextEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof org.smartadapters.core.resource.smARText.ui.SmARTextEditor) {
				org.smartadapters.core.resource.smARText.ui.SmARTextEditor editor = (org.smartadapters.core.resource.smARText.ui.SmARTextEditor) workbenchPart;
	...
	protected org.smartadapters.core.resource.smARText.ui.SmARTextEditor editor;
	...
	public SmARTextCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,org.smartadapters.core.resource.smARText.ui.SmARTextEditor textEditor) {
	...
	private void addCloseListener(final org.smartadapters.core.resource.smARText.ui.SmARTextEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			org.smartadapters.core.resource.smARText.mopp.SmARTextPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		org.smartadapters.core.resource.smARText.ISmARTextTextResource textResource = (org.smartadapters.core.resource.smARText.ISmARTextTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
