...
public class SmARTextTextResourceUtil {
	...
	public static org.smartadapters.core.resource.smARText.mopp.SmARTextResource getResource(org.eclipse.core.resources.IFile file) {
		...
		return (org.smartadapters.core.resource.smARText.mopp.SmARTextResource) csResource;
	}
	
	public static org.smartadapters.core.resource.smARText.mopp.SmARTextResource getResource(java.io.File file) {
		return getResource(file, null);
	}
	
	public static org.smartadapters.core.resource.smARText.mopp.SmARTextResource getResource(java.io.File file, java.util.Map<?,?> options) {
		org.eclipse.emf.ecore.resource.ResourceSet rs = new org.eclipse.emf.ecore.resource.impl.ResourceSetImpl();
		if (options != null) {
