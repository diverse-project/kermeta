...
// @since 3.2
///
public class SmARTextBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private org.smartadapters.core.resource.smARText.ui.SmARTextDocBrowserInformationControlInput fInput;
	...
	public SmARTextBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	...
	public SmARTextBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	...
	// @since 3.4
	///
	public SmARTextBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof org.smartadapters.core.resource.smARText.ui.SmARTextDocBrowserInformationControlInput);
		...
		fInput= (org.smartadapters.core.resource.smARText.ui.SmARTextDocBrowserInformationControlInput) input;
		...
		org.smartadapters.core.resource.smARText.ui.SmARTextHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = org.smartadapters.core.resource.smARText.ui.SmARTextHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	...
	///
	public org.smartadapters.core.resource.smARText.ui.SmARTextDocBrowserInformationControlInput getInput() {
		return fInput;
	}
