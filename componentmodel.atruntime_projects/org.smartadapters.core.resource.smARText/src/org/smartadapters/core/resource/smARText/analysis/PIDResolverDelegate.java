...
public class PIDResolverDelegate<ContainerType extends org.eclipse.emf.ecore.EObject, ReferenceType extends org.eclipse.emf.ecore.EObject> {
	...
	protected void resolve(java.lang.String identifier, ContainerType container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, org.smartadapters.core.resource.smARText.ISmARTextReferenceResolveResult<ReferenceType> result) {
		try {
			org.eclipse.emf.ecore.EClass type = reference.getEReferenceType();
			org.eclipse.emf.ecore.EObject root = org.smartadapters.core.resource.smARText.util.SmARTextEObjectUtil.findRootContainer(container);
	...
	private boolean checkElement(org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.EClass type, java.lang.String identifier, boolean resolveFuzzy, org.smartadapters.core.resource.smARText.ISmARTextReferenceResolveResult<ReferenceType> result) {
		if (element.eIsProxy()) {
			return true;
		}
	...
	protected java.lang.String produceDeResolveErrorMessage(org.eclipse.emf.ecore.EObject refObject, org.eclipse.emf.ecore.EObject container, org.eclipse.emf.ecore.EReference reference, org.smartadapters.core.resource.smARText.ISmARTextTextResource resource) {
	...
	private java.lang.String getName(ReferenceType element) {
		...
		if(element.eIsProxy()) {
			...
			if (fragment != null && fragment.startsWith(org.smartadapters.core.resource.smARText.ISmARTextContextDependentURIFragment.INTERNAL_URI_FRAGMENT_PREFIX)) {
				fragment = fragment.substring(org.smartadapters.core.resource.smARText.ISmARTextContextDependentURIFragment.INTERNAL_URI_FRAGMENT_PREFIX.length());
