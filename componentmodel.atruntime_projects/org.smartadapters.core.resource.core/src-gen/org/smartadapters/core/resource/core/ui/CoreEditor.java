...
//
// A text editor for 'core' models.
//
public class CoreEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider {
	
	private org.smartadapters.core.resource.core.ui.CoreHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private org.smartadapters.core.resource.core.ui.CoreCodeFoldingManager codeFoldingManager;
	private org.smartadapters.core.resource.core.ui.CoreBackgroundParsingStrategy bgParsingStrategy = new org.smartadapters.core.resource.core.ui.CoreBackgroundParsingStrategy();
	private java.util.Collection<org.smartadapters.core.resource.core.ICoreBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<org.smartadapters.core.resource.core.ICoreBackgroundParsingListener>();
	private org.smartadapters.core.resource.core.ui.CoreColorManager colorManager = new org.smartadapters.core.resource.core.ui.CoreColorManager();
	private org.smartadapters.core.resource.core.ui.CoreOutlinePage outlinePage;
	private org.smartadapters.core.resource.core.ICoreTextResource resource;
	private org.eclipse.core.resources.IResourceChangeListener resourceChangeListener = new ModelResourceChangeListener();
	private org.smartadapters.core.resource.core.ui.CorePropertySheetPage propertySheetPage;
	...
	public CoreEditor() {
		...
		setSourceViewerConfiguration(new org.smartadapters.core.resource.core.ui.CoreEditorConfiguration(this, colorManager));
	...
	private final class MarkerUpdateListener implements org.smartadapters.core.resource.core.ICoreBackgroundParsingListener {
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), CoreEditor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								org.smartadapters.core.resource.core.ICoreTextResource currentResource = getResource();
				...
				org.smartadapters.core.resource.core.mopp.CorePlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new org.smartadapters.core.resource.core.ui.CoreHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new org.smartadapters.core.resource.core.ui.CoreCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		org.smartadapters.core.resource.core.mopp.CoreNature.activate(inputFile.getProject());
		...
		org.smartadapters.core.resource.core.ICoreTextResource loadedResource = (org.smartadapters.core.resource.core.ICoreTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				org.smartadapters.core.resource.core.ICoreTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof org.smartadapters.core.resource.core.ICoreTextResource) {
					setResource((org.smartadapters.core.resource.core.ICoreTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but
					// some other EMF resource
					org.smartadapters.core.resource.core.mopp.CorePlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the CoreEditor.");
					//close this editor because it can not present the resource
					close(false);
				}
			} catch (java.lang.Exception e) {
				org.smartadapters.core.resource.core.mopp.CorePlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	public org.smartadapters.core.resource.core.ICoreTextResource getResource() {
		assert resource != null;
		return resource;
	}
	
	private void setResource(org.smartadapters.core.resource.core.ICoreTextResource resource) {
		assert resource != null;
	...
	private java.lang.Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new org.smartadapters.core.resource.core.ui.CoreOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new org.smartadapters.core.resource.core.ui.CorePropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			org.smartadapters.core.resource.core.ICoreTextResource textResource = (org.smartadapters.core.resource.core.ICoreTextResource) element.eResource();
			...
			org.smartadapters.core.resource.core.ICoreTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				org.smartadapters.core.resource.core.ICoreTextToken token = lexer.getNextToken();
			...
			org.smartadapters.core.resource.core.mopp.CorePlugin.logError("java.lang.Exception in setCaret()", e);
		}
	}
	...
	public void addBackgroundParsingListener(org.smartadapters.core.resource.core.ICoreBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (org.smartadapters.core.resource.core.ICoreBackgroundParsingListener listener : bgParsingListeners) {
	...
	private void refreshMarkers(final org.eclipse.emf.ecore.resource.Resource resourceToRefresh) {
		...
		if (display != null) {
			display.asyncExec(new java.lang.Runnable() {
				public void run() {
					try {
						org.smartadapters.core.resource.core.ui.CoreMarkerHelper.unmark(resourceToRefresh);
						org.smartadapters.core.resource.core.ui.CoreMarkerHelper.mark(resourceToRefresh);
					} catch (org.eclipse.core.runtime.CoreException e) {
						org.smartadapters.core.resource.core.mopp.CorePlugin.logError("Exception while updating markers on resource", e);
					}
				}
			});
		}
