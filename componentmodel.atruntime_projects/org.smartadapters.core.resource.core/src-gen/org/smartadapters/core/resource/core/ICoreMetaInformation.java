...
public interface ICoreMetaInformation {
	...
	// @param encoding
	// @return
	public org.smartadapters.core.resource.core.ICoreTextParser createParser(java.io.InputStream inputStream, String encoding);
	...
	public org.smartadapters.core.resource.core.ICoreTokenStyle getDefaultTokenStyle(String tokenName);
