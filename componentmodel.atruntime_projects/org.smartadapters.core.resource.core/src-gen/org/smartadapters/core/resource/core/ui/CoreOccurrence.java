...
public class CoreOccurrence {
	...
	private org.smartadapters.core.resource.core.ui.CoreTokenScanner tokenScanner;
	...
	//
	public CoreOccurrence(org.smartadapters.core.resource.core.ICoreTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer, org.smartadapters.core.resource.core.ui.CoreTokenScanner tokenScanner) {
		this.textResource = textResource;
		this.projectionViewer = sourceViewer;
		
		quotedTokenArray = new java.util.ArrayList<String>();
		String[] tokenNames = new org.smartadapters.core.resource.core.mopp.CoreMetaInformation().getTokenNames();
	...
	public void handleOccurrenceHighlighting(org.smartadapters.core.resource.core.ui.CoreBracketSet bracketSet) {
		...
		if (resource.equals(textResource)) {
			...
			while (!token.isEOF()) {
				...
				if (text.equals(tokenText)) {
					...
					addPosition(document, org.smartadapters.core.resource.core.ui.CorePositionCategory.DEFINTION.toString());
					break;
				}
				token = tokenScanner.nextToken();
			}
			...
			if (text != null && text.equals(tokenText) && tokenScanner.getTokenOffset() != defPosition) {
				...
				if (occEO != null) {
					if ((isNull && elementsAtDefinition.contains(occEO)) || !isNull && definitionElement.equals(occEO)) {
						addPosition(document, org.smartadapters.core.resource.core.ui.CorePositionCategory.PROXY.toString());
					}
				}
			}
			token = tokenScanner.nextToken();
