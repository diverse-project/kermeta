...
public class CoreNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	
	private String categoryId = null;
	private org.smartadapters.core.resource.core.ui.CoreNewFileWizardPage page;
	private org.eclipse.jface.viewers.ISelection selection;
	private String newName = null;
	
	public CoreNewFileWizard() {
		super();
	...
	public void addPages() {
		page = new org.smartadapters.core.resource.core.ui.CoreNewFileWizardPage(selection, getFileExtension());
		addPage(page);
	}
	...
	public boolean performFinish() {
		...
		try {
			...
			org.smartadapters.core.resource.core.mopp.CorePlugin.logError("java.lang.Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			org.smartadapters.core.resource.core.mopp.CorePlugin.logError("java.lang.Exception while initializing new file", e);
			return false;
		}
		return true;
	}
	...
	private java.io.InputStream openContentStream() {
		return new java.io.ByteArrayInputStream(new org.smartadapters.core.resource.core.mopp.CoreMetaInformation().getNewFileContentProvider().getNewFileContent(newName).getBytes());
	}
	...
	public java.lang.String getFileExtension() {
		return new org.smartadapters.core.resource.core.mopp.CoreMetaInformation().getSyntaxName();
	}
