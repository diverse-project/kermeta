...
//
public class CorePreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	
	public void init(org.eclipse.ui.IWorkbench workbench) {
		setPreferenceStore(org.smartadapters.core.resource.core.mopp.CorePlugin.getDefault().getPreferenceStore());
		setDescription(" Core Text Editor Preferences");
	}
