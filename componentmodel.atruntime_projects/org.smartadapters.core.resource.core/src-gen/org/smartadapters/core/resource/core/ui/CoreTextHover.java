...
//
public class CoreTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2{
	...
	private org.smartadapters.core.resource.core.ICoreHoverTextProvider hoverTextProvider;
	// The style sheet (css).
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final org.smartadapters.core.resource.core.ui.CoreBrowserInformationControl infoControl;
		...
		//            target element
		public OpenDeclarationAction(org.smartadapters.core.resource.core.ui.CoreBrowserInformationControl infoControl) {
		...
		public void run() {
			org.smartadapters.core.resource.core.ui.CoreDocBrowserInformationControlInput infoInput = (org.smartadapters.core.resource.core.ui.CoreDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					org.smartadapters.core.resource.core.ui.CoreHyperlink hyperlink = new org.smartadapters.core.resource.core.ui.CoreHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (org.smartadapters.core.resource.core.ui.CoreBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				org.smartadapters.core.resource.core.ui.CoreBrowserInformationControl iControl = new org.smartadapters.core.resource.core.ui.CoreBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(java.lang.Object newInput) {
						...
						} else if (newInput instanceof org.smartadapters.core.resource.core.ui.CoreDocBrowserInformationControlInput) {
							org.smartadapters.core.resource.core.ui.CoreDocBrowserInformationControlInput input = (org.smartadapters.core.resource.core.ui.CoreDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (org.smartadapters.core.resource.core.ui.CoreBrowserInformationControl.isAvailable(parent)) {
				org.smartadapters.core.resource.core.ui.CoreBrowserInformationControl iControl = new org.smartadapters.core.resource.core.ui.CoreBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	...
	// element.
	public CoreTextHover(org.smartadapters.core.resource.core.ui.CoreEditor editor) {
		super();
		this.editor = editor;
		hoverTextProvider = new org.smartadapters.core.resource.core.mopp.CoreMetaInformation().getHoverTextProvider();
	}
	
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		return ((org.smartadapters.core.resource.core.ui.CoreDocBrowserInformationControlInput) getHoverInfo2(textViewer, hoverRegion)).getHtml();
	}
	...
	private org.smartadapters.core.resource.core.ui.CoreDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		org.smartadapters.core.resource.core.ICoreTextResource textResource = editor.getResource();
	...
	private org.smartadapters.core.resource.core.ui.CoreDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, org.smartadapters.core.resource.core.ui.CoreDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				org.smartadapters.core.resource.core.ui.CoreHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(declarationObject));
			}
		} else {
			org.smartadapters.core.resource.core.ui.CoreHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			org.smartadapters.core.resource.core.ui.CoreHTMLPrinter.insertPageProlog(buffer, 0, org.smartadapters.core.resource.core.ui.CoreTextHover.getStyleSheet());
			org.smartadapters.core.resource.core.ui.CoreHTMLPrinter.addPageEpilog(buffer);
			return new org.smartadapters.core.resource.core.ui.CoreDocBrowserInformationControlInput(previousInput, declarationObject, editor.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		if (css != null) {
			...
			css = org.smartadapters.core.resource.core.ui.CoreHTMLPrinter.convertTopLevelFont(css, fontData);
		}
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(org.smartadapters.core.resource.core.mopp.CorePlugin.PLUGIN_ID);
