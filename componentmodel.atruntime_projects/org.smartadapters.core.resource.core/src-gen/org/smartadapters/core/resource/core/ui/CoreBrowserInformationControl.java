...
// @since 3.2
///
public class CoreBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private org.smartadapters.core.resource.core.ui.CoreDocBrowserInformationControlInput fInput;
	...
	public CoreBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	...
	public CoreBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	...
	// @since 3.4
	///
	public CoreBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof org.smartadapters.core.resource.core.ui.CoreDocBrowserInformationControlInput);
		...
		fInput= (org.smartadapters.core.resource.core.ui.CoreDocBrowserInformationControlInput) input;
		...
		org.smartadapters.core.resource.core.ui.CoreHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = org.smartadapters.core.resource.core.ui.CoreHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	...
	///
	public org.smartadapters.core.resource.core.ui.CoreDocBrowserInformationControlInput getInput() {
		return fInput;
	}
