...
public class CoreBackgroundParsingStrategy {
	...
	// a delay.
	public void parse(org.eclipse.jface.text.DocumentEvent event, final org.smartadapters.core.resource.core.ICoreTextResource resource, final org.smartadapters.core.resource.core.ui.CoreEditor editor) {
		if (resource == null) {
			return;
		}
