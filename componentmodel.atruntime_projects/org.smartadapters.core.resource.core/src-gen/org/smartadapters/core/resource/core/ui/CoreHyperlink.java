...
public class CoreHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	...
	public CoreHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				if (editorPart instanceof org.smartadapters.core.resource.core.ui.CoreEditor) {
					org.smartadapters.core.resource.core.ui.CoreEditor emftEditor = (org.smartadapters.core.resource.core.ui.CoreEditor) editorPart;
