...
public class CoreCodeFoldingManager {
	
	private class FoldingUpdateListener implements org.smartadapters.core.resource.core.ICoreBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(org.smartadapters.core.resource.core.ui.CoreEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof org.smartadapters.core.resource.core.ui.CoreEditor) {
				org.smartadapters.core.resource.core.ui.CoreEditor editor = (org.smartadapters.core.resource.core.ui.CoreEditor) workbenchPart;
	...
	protected org.smartadapters.core.resource.core.ui.CoreEditor editor;
	...
	public CoreCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,org.smartadapters.core.resource.core.ui.CoreEditor textEditor) {
	...
	private void addCloseListener(final org.smartadapters.core.resource.core.ui.CoreEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			org.smartadapters.core.resource.core.mopp.CorePlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		org.smartadapters.core.resource.core.ICoreTextResource textResource = (org.smartadapters.core.resource.core.ICoreTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
