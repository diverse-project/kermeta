...
// models.
//
public class CoreMinimalModelHelper {
	
	private final static org.smartadapters.core.resource.core.util.CoreEClassUtil eClassUtil = new org.smartadapters.core.resource.core.util.CoreEClassUtil();
			...
			if (feature instanceof org.eclipse.emf.ecore.EReference) {
				...
				if (type instanceof org.eclipse.emf.ecore.EClass) {
					...
					for (int i = 0; i < lowerBound; i++) {
						...
						if (reference.isContainment()) {
							...
							String initialValue = "#some" + org.smartadapters.core.resource.core.util.CoreStringUtil.capitalize(typeClass.getName());
						...
						if (value instanceof java.util.List<?>) {
							java.util.List<org.eclipse.emf.ecore.EObject> list = org.smartadapters.core.resource.core.util.CoreListUtil.castListUnchecked(value);
							list.add(subModel);
						} else {
				...
				if ("EString".equals(attribute.getEType().getName())) {
					...
					if(attribute.getName().equals("name") && name != null) {
						...
						initialValue = "some" + org.smartadapters.core.resource.core.util.CoreStringUtil.capitalize(attribute.getName());
					}
					java.lang.Object value = root.eGet(attribute);
					if (value instanceof java.util.List<?>) {
						java.util.List<String> list = org.smartadapters.core.resource.core.util.CoreListUtil.castListUnchecked(value);
