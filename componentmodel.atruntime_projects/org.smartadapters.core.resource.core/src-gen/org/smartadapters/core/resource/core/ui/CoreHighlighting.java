...
public class CoreHighlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	...
	private final static org.smartadapters.core.resource.core.ui.CorePositionHelper positionHelper = new org.smartadapters.core.resource.core.ui.CorePositionHelper();
	private boolean isHighlightBrackets = true;
	private boolean isHighlightOccurrences = true;
	private org.smartadapters.core.resource.core.ui.CoreTokenScanner scanner;
	...
	private org.smartadapters.core.resource.core.ui.CoreOccurrence occurrence;
	private org.smartadapters.core.resource.core.ui.CoreBracketSet bracketSet;
	...
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, org.smartadapters.core.resource.core.ICoreBackgroundParsingListener {
	...
	public CoreHighlighting(org.smartadapters.core.resource.core.ICoreTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, org.smartadapters.core.resource.core.ui.CoreColorManager colorManager, org.smartadapters.core.resource.core.ui.CoreEditor editor) {
		this.display = org.eclipse.swt.widgets.Display.getCurrent();
		sourceviewer.getSelectionProvider();
		preferenceStore = org.smartadapters.core.resource.core.mopp.CorePlugin.getDefault().getPreferenceStore();
		textWidget = sourceviewer.getTextWidget();
		projectionViewer = sourceviewer;
		scanner = new org.smartadapters.core.resource.core.ui.CoreTokenScanner(colorManager);
		occurrence = new org.smartadapters.core.resource.core.ui.CoreOccurrence(textResource, sourceviewer, scanner);
		bracketSet = new org.smartadapters.core.resource.core.ui.CoreBracketSet(sourceviewer, "core");
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(org.smartadapters.core.resource.core.ui.CorePreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		isHighlightOccurrences = preferenceStore.getBoolean(org.smartadapters.core.resource.core.ui.CorePreferenceConstants.EDITOR_OCCURRENCE_CHECKBOX);
		definitionColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, org.smartadapters.core.resource.core.ui.CorePreferenceConstants.EDITOR_DEFINITION_COLOR));
		proxyColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, org.smartadapters.core.resource.core.ui.CorePreferenceConstants.EDITOR_PROXY_COLOR));
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, org.smartadapters.core.resource.core.ui.CorePreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		black = colorManager.getColor(new org.eclipse.swt.graphics.RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(org.smartadapters.core.resource.core.ui.CoreEditor editor) {
	...
	private void setHighlighting() {
		...
		if (occurrence.isPositionsChanged()) {
			...
			org.smartadapters.core.resource.core.ui.CorePositionCategory.DEFINTION.toString());
			setCategoryHighlighting(document,
			org.smartadapters.core.resource.core.ui.CorePositionCategory.PROXY.toString());
		}
		setCategoryHighlighting(document, org.smartadapters.core.resource.core.ui.CorePositionCategory.BRACKET.toString());
	}
	...
	private void setCategoryHighlighting(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(org.smartadapters.core.resource.core.ui.CorePositionCategory.PROXY.toString())) {
		...
		for (org.eclipse.jface.text.Position position : positions) {
			...
			if (tmpPosition != null) {
				if (category.equals(org.smartadapters.core.resource.core.ui.CorePositionCategory.DEFINTION.toString())) {
				...
				if (category.equals(org.smartadapters.core.resource.core.ui.CorePositionCategory.BRACKET.toString())) {
					styleRange = getStyleRangeAtPosition(tmpPosition);
	...
	private void removeHighlighting() {
		org.eclipse.jface.text.IDocument document = projectionViewer.getDocument();
		removeHighlightingCategory(document, org.smartadapters.core.resource.core.ui.CorePositionCategory.BRACKET.toString());
		if (occurrence.isToRemoveHighlighting()) {
			removeHighlightingCategory(document, org.smartadapters.core.resource.core.ui.CorePositionCategory.DEFINTION.toString());
			removeHighlightingCategory(document, org.smartadapters.core.resource.core.ui.CorePositionCategory.PROXY.toString());
			lastStyleRange = null;
		}
	}
	...
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, category);
		boolean isOccurrence = (category.equals(org.smartadapters.core.resource.core.ui.CorePositionCategory.DEFINTION.toString()) || category.equals(org.smartadapters.core.resource.core.ui.CorePositionCategory.PROXY.toString())) && lastStyleRange != null;
		if (category.equals(org.smartadapters.core.resource.core.ui.CorePositionCategory.BRACKET.toString())) {
		...
		display.syncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new org.smartadapters.core.resource.core.ui.CoreEObjectSelection(selectedEObject, false));
				}
			}
		});
	}
	...
	private void handleContentOutlineSelection(org.eclipse.jface.viewers.ISelection selection) {
		if (!selection.isEmpty()) {
			...
			if (selectedElement instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (resource instanceof org.smartadapters.core.resource.core.ICoreTextResource) {
