...
public class CoreDocBrowserInformationControlInput {
	
	private final CoreDocBrowserInformationControlInput fPrevious;
	private CoreDocBrowserInformationControlInput fNext;
	...
	///
	public CoreDocBrowserInformationControlInput(CoreDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	...
	public CoreDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	...
	public CoreDocBrowserInformationControlInput getNext() {
		return fNext;
	}
