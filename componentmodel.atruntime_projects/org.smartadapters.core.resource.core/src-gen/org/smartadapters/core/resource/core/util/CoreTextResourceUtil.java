...
public class CoreTextResourceUtil {
	
	public static org.smartadapters.core.resource.core.mopp.CoreResource getResource(org.eclipse.core.resources.IFile file) {
		...
		return (org.smartadapters.core.resource.core.mopp.CoreResource) csResource;
	}
	
	public static org.smartadapters.core.resource.core.mopp.CoreResource getResource(java.io.File file) {
		return getResource(file, null);
	}
	
	public static org.smartadapters.core.resource.core.mopp.CoreResource getResource(java.io.File file, java.util.Map<?,?> options) {
		org.eclipse.emf.ecore.resource.ResourceSet rs = new org.eclipse.emf.ecore.resource.impl.ResourceSetImpl();
		if (options != null) {
