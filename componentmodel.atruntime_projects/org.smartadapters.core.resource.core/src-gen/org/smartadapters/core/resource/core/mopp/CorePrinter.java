...
public class CorePrinter implements org.smartadapters.core.resource.core.ICoreTextPrinter {
	
	protected final static java.lang.String NEW_LINE = java.lang.System.getProperties().getProperty("line.separator");
	protected org.smartadapters.core.resource.core.ICoreTokenResolverFactory tokenResolverFactory = new org.smartadapters.core.resource.core.mopp.CoreTokenResolverFactory();
	...
	public CorePrinter(java.io.OutputStream outputStream, org.smartadapters.core.resource.core.ICoreTextResource resource) {
		super();
	...
	protected org.smartadapters.core.resource.core.mopp.CoreReferenceResolverSwitch getReferenceResolverSwitch() {
		return (org.smartadapters.core.resource.core.mopp.CoreReferenceResolverSwitch) new org.smartadapters.core.resource.core.mopp.CoreMetaInformation().getReferenceResolverSwitch();
	}
	
	protected void addWarningToResource(final java.lang.String errorMessage, org.eclipse.emf.ecore.EObject cause) {
		org.smartadapters.core.resource.core.ICoreTextResource resource = getResource();
		if (resource == null) {
			// the resource can be null if the printer is used stand alone
			return;
		}
		resource.addProblem(new org.smartadapters.core.resource.core.mopp.CoreProblem(errorMessage, org.smartadapters.core.resource.core.CoreEProblemType.ERROR), cause);
	}
	...
	public void print_pattern_art_instance_PrimitiveInstance_3(pattern.art.instance.PrimitiveInstance element, java.lang.String outertab, java.io.PrintWriter out, java.util.Map<java.lang.String, java.lang.Integer> printCountingMap){
		...
		if (count > 0) {
			...
			if (o != null) {
				org.smartadapters.core.resource.core.ICoreTokenResolver resolver = tokenResolverFactory.createTokenResolver("T_INSTANCE_STATE");
				resolver.setOptions(getOptions());
	...
	public void print_pattern_art_type_Port(pattern.art.type.Port element, java.lang.String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.smartadapters.core.resource.core.ICoreTokenResolver resolver = tokenResolverFactory.createTokenResolver("T_PORT_KIND");
				resolver.setOptions(getOptions());
	...
	public void print_pattern_art_type_Port_0(pattern.art.type.Port element, java.lang.String outertab, java.io.PrintWriter out, java.util.Map<java.lang.String, java.lang.Integer> printCountingMap){
		...
		if (count > 0) {
			...
			if (o != null) {
				org.smartadapters.core.resource.core.ICoreTokenResolver resolver = tokenResolverFactory.createTokenResolver("T_OPTIONAL");
				resolver.setOptions(getOptions());
	...
	public void print_pattern_art_type_Port_4(pattern.art.type.Port element, java.lang.String outertab, java.io.PrintWriter out, java.util.Map<java.lang.String, java.lang.Integer> printCountingMap){
		...
		if (count > 0) {
			...
			if (o != null) {
				org.smartadapters.core.resource.core.ICoreTokenResolver resolver = tokenResolverFactory.createTokenResolver("MULTIPLICITY");
				resolver.setOptions(getOptions());
	...
	public void print_pattern_art_implem_OSGiType(pattern.art.implem.OSGiType element, java.lang.String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.smartadapters.core.resource.core.ICoreTokenResolver resolver = tokenResolverFactory.createTokenResolver("T_IMPLEM");
				resolver.setOptions(getOptions());
	...
	public void print_patternframework_PModel(patternframework.PModel element, java.lang.String outertab, java.io.PrintWriter out) {
		...
		out.print("{");
		//////////////DEFINITION PART BEGINS (CompoundDefinition):
		print_patternframework_PModel_0(element, localtab, out, printCountingMap);
		//////////////DEFINITION PART BEGINS (LineBreak):
		out.println();
		out.print(localtab);
		//////////////DEFINITION PART BEGINS (CsString):
		...
		out1 = new java.io.PrintWriter(sWriter);
		printCountingMap1 = new java.util.HashMap<java.lang.String, java.lang.Integer>(printCountingMap);
		print_patternframework_PModel_1(element, localtab, out1, printCountingMap1);
		if (printCountingMap.equals(printCountingMap1)) {
			out1.close();
		} else {
			out1.flush();
	...
	public void print_patternframework_PModel_1(patternframework.PModel element, java.lang.String outertab, java.io.PrintWriter out, java.util.Map<java.lang.String, java.lang.Integer> printCountingMap){
		java.lang.String localtab = outertab;
		int count;
		boolean iterate = true;
		java.io.StringWriter sWriter = null;
		...
		while (iterate) {
			...
			out1 = new java.io.PrintWriter(sWriter);
			printCountingMap1 = new java.util.HashMap<java.lang.String, java.lang.Integer>(printCountingMap);
			print_patternframework_PModel_1_0(element, localtab, out1, printCountingMap1);
			if (printCountingMap.equals(printCountingMap1)) {
				iterate = false;
				out1.close();
			} else {
	...
	public void print_patternframework_PModel_1_0(patternframework.PModel element, java.lang.String outertab, java.io.PrintWriter out, java.util.Map<java.lang.String, java.lang.Integer> printCountingMap){
		java.lang.String localtab = outertab;
		int count;
		//////////////DEFINITION PART BEGINS (CsString):
		out.print(",");
