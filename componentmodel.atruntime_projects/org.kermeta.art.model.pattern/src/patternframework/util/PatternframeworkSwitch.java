 ...
 * @generated
 */
public class PatternframeworkSwitch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PatternframeworkPackage.MODEL_PATTERN: {
				ModelPattern modelPattern = (ModelPattern)theEObject;
				T result = caseModelPattern(modelPattern);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PatternframeworkPackage.PMODEL: {
				PModel pModel = (PModel)theEObject;
				T result = casePModel(pModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PatternframeworkPackage.POBJECT: {
				PObject pObject = (PObject)theEObject;
				T result = casePObject(pObject);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PatternframeworkPackage.PCONSTRAINT: {
				PConstraint pConstraint = (PConstraint)theEObject;
				T result = casePConstraint(pConstraint);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PatternframeworkPackage.PROLE: {
				PRole pRole = (PRole)theEObject;
				T result = casePRole(pRole);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>PModel</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>PModel</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePModel(PModel object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T casePRole(PRole object) {
		return null;
	}
