...
public class ArtSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ArtPackage.MODEL_ELEMENT: {
				...
				if (result == null) result = casePObject(modelElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ArtPackage.SYSTEM: {
				...
				if (result == null) result = casePObject(system);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ArtPackage.DATA_TYPE: {
				...
				if (result == null) result = casePObject(dataType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ArtPackage.TYPED_ELEMENT: {
				...
				if (result == null) result = casePObject(typedElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ArtPackage.CARDINALITY_ELEMENT: {
				...
				if (result == null) result = casePObject(cardinalityElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseSystem(pattern.art.System object) {
		return null;
	}
