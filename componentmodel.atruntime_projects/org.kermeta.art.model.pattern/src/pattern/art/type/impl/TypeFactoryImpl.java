...
public class TypeFactoryImpl extends EFactoryImpl implements TypeFactory {
	...
	public static TypeFactory init() {
		try {
			TypeFactory theTypeFactory = (TypeFactory)EPackage.Registry.INSTANCE.getEFactory("http://art/pattern/art/type"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case TypePackage.SERVICE: return createService();
			...
			case TypePackage.ABSTRACT_PORT: return createAbstractPort();
