 ...
 * <ul>
 *   <li>{@link pattern.art.type.Port#getIsOptional <em>Is Optional</em>}</li>
 * </ul>
 * </p>
 *
 * @see pattern.art.type.TypePackage#getPort()
 * @model
 * @generated
 */
public interface Port extends CardinalityElement, AbstractPort {
	 ...
	 * @see pattern.art.type.TypePackage#getPort_IsOptional()
	 * @model default="false" dataType="pattern.art.Boolean"
	 * @generated
	 */
	Boolean getIsOptional();

	/**
	 * Sets the value of the '{@link pattern.art.type.Port#getIsOptional <em>Is Optional</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
