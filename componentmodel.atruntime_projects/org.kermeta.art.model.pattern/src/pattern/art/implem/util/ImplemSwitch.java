	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ImplemPackage.COMPONENT_IMPLEMENTATION: {
				...
				if (result == null) result = casePObject(componentImplementation);
			...
			case ImplemPackage.FRACTAL_COMPONENT: {
				...
				if (result == null) result = casePObject(fractalComponent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ImplemPackage.OS_GI_COMPONENT: {
				...
				if (result == null) result = casePObject(osGiComponent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ImplemPackage.TYPE_IMPLEMENTATION: {
				...
				if (result == null) result = casePObject(typeImplementation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ImplemPackage.OS_GI_TYPE: {
				...
				if (result == null) result = casePObject(osGiType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
