 ...
 * <ul>
 *   <li>{@link pattern.art.instance.impl.ComponentInstanceImpl#getType <em>Type</em>}</li>
 *   <li>{@link pattern.art.instance.impl.ComponentInstanceImpl#getState <em>State</em>}</li>
 *   <li>{@link pattern.art.instance.impl.ComponentInstanceImpl#getSuperComponent <em>Super Component</em>}</li>
 *   <li>{@link pattern.art.instance.impl.ComponentInstanceImpl#getAttribute <em>Attribute</em>}</li>
 *   <li>{@link pattern.art.instance.impl.ComponentInstanceImpl#getBinding <em>Binding</em>}</li>
 *   <li>{@link pattern.art.instance.impl.ComponentInstanceImpl#getImplem <em>Implem</em>}</li>
 *   <li>{@link pattern.art.instance.impl.ComponentInstanceImpl#getGroups <em>Groups</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ComponentInstanceImpl extends ModelElementImpl implements ComponentInstance {
	/**
