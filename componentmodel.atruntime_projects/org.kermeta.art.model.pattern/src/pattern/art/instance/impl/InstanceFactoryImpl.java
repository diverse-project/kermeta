...
public class InstanceFactoryImpl extends EFactoryImpl implements InstanceFactory {
	...
	public static InstanceFactory init() {
		try {
			InstanceFactory theInstanceFactory = (InstanceFactory)EPackage.Registry.INSTANCE.getEFactory("http://art/pattern/art/instance"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case InstancePackage.BINDING: return createBinding();
			...
			case InstancePackage.ATTRIBUTE_INSTANCE: return createAttributeInstance();
