 ...
 * <ul>
 *   <li>{@link art.implem.impl.FractalComponentImpl#getControllerDesc <em>Controller Desc</em>}</li>
 *   <li>{@link art.implem.impl.FractalComponentImpl#getContentDesc <em>Content Desc</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class FractalComponentImpl extends ComponentImplementationImpl implements
		FractalComponent {
	/**
	...
	public void setControllerDesc(String newControllerDesc) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ImplemPackage.FRACTAL_COMPONENT__CONTROLLER_DESC,
					oldControllerDesc, controllerDesc));
	}
	...
	public void setContentDesc(String newContentDesc) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ImplemPackage.FRACTAL_COMPONENT__CONTENT_DESC,
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case ImplemPackage.FRACTAL_COMPONENT__CONTROLLER_DESC:
			return CONTROLLER_DESC_EDEFAULT == null ? controllerDesc != null
					: !CONTROLLER_DESC_EDEFAULT.equals(controllerDesc);
		case ImplemPackage.FRACTAL_COMPONENT__CONTENT_DESC:
			return CONTENT_DESC_EDEFAULT == null ? contentDesc != null
					: !CONTENT_DESC_EDEFAULT.equals(contentDesc);
		}
