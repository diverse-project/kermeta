 ...
 * @generated
 */
public class OSGiComponentImpl extends ComponentImplementationImpl implements
		OSGiComponent {
	/**
	...
	public void setImplementingClass(String newImplementingClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ImplemPackage.OS_GI_COMPONENT__IMPLEMENTING_CLASS,
					oldImplementingClass, implementingClass));
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case ImplemPackage.OS_GI_COMPONENT__IMPLEMENTING_CLASS:
			return IMPLEMENTING_CLASS_EDEFAULT == null ? implementingClass != null
					: !IMPLEMENTING_CLASS_EDEFAULT.equals(implementingClass);
		}
