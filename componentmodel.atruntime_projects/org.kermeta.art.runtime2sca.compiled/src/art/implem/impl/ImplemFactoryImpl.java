...
public class ImplemFactoryImpl extends EFactoryImpl implements ImplemFactory {
	...
	public static ImplemFactory init() {
		try {
			ImplemFactory theImplemFactory = (ImplemFactory) EPackage.Registry.INSTANCE
					.getEFactory("http://art/implem/kermeta_temp_uri");
	...
	public EObject create(EClass eClass) {
		...
		case ImplemPackage.FRACTAL_COMPONENT:
			return createFractalComponent();
		case ImplemPackage.OS_GI_COMPONENT:
			return createOSGiComponent();
		case ImplemPackage.PORT_IMPLEMENTATION:
			return createPortImplementation();
		case ImplemPackage.OS_GI_PORT:
			return createOSGiPort();
		default:
