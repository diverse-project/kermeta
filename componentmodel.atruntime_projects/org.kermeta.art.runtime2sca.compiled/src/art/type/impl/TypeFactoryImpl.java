...
public class TypeFactoryImpl extends EFactoryImpl implements TypeFactory {
	...
	public static TypeFactory init() {
		try {
			TypeFactory theTypeFactory = (TypeFactory) EPackage.Registry.INSTANCE
					.getEFactory("http://art/type/kermeta_temp_uri");
	...
	public EObject create(EClass eClass) {
		...
		case TypePackage.FUNCTIONAL_SERVICE:
			return createFunctionalService();
	 ...
	 * @generated
	 */
	public PortRole createPortRoleFromString(EDataType eDataType,
			String initialValue) {
	 ...
	 * @generated
	 */
	public String convertPortRoleToString(EDataType eDataType,
