 ...
 * <ul>
 *   <li>{@link art.type.impl.PrimitiveTypeImpl#getBinding <em>Binding</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PrimitiveTypeImpl extends ComponentTypeImpl implements
		PrimitiveType {
	/**
	...
	public EList<TransmissionBinding> getBinding() {
		if (binding == null) {
			binding = new EObjectContainmentEList.Resolving<TransmissionBinding>(
					...
					TypePackage.PRIMITIVE_TYPE__BINDING);
		}
		return binding;
	}
