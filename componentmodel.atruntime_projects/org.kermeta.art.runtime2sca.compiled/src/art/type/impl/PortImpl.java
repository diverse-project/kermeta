...
public class PortImpl extends CardinalityElementImpl implements Port {
			...
			if (service != oldService) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							TypePackage.PORT__SERVICE, oldService, service));
			}
		}
		return service;
	}
	...
	public void setRole(String newRole) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					TypePackage.PORT__ROLE, oldRole, role));
	}
	 ...
	 * @generated
	 */
	public PortImplementation basicGetImplem() {
		return implem;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetImplem(PortImplementation newImplem,
			NotificationChain msgs) {
		PortImplementation oldImplem = implem;
		implem = newImplem;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, TypePackage.PORT__IMPLEM, oldImplem,
					newImplem);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setImplem(PortImplementation newImplem) {
		if (newImplem != implem) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					TypePackage.PORT__IMPLEM, newImplem, newImplem));
	}
	...
	public void setIsOptional(Boolean newIsOptional) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					TypePackage.PORT__IS_OPTIONAL, oldIsOptional, isOptional));
	}
