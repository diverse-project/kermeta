 ...
 * @generated
 */
public abstract class ComponentTypeImpl extends ModelElementImpl implements
		ComponentType {
	/**
	...
	public EList<Port> getPort() {
		if (port == null) {
			port = new EObjectContainmentEList.Resolving<Port>(Port.class,
					this, TypePackage.COMPONENT_TYPE__PORT);
		}
		return port;
	}
	...
	public EList<Attribute> getAttribute() {
		if (attribute == null) {
			attribute = new EObjectContainmentEList.Resolving<Attribute>(
					Attribute.class, this,
					TypePackage.COMPONENT_TYPE__ATTRIBUTE);
		}
		return attribute;
	}
