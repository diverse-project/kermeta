 ...
 * <ul>
 *   <li>{@link art.type.impl.OperationImpl#getInput <em>Input</em>}</li>
 *   <li>{@link art.type.impl.OperationImpl#getOutput <em>Output</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OperationImpl extends ModelElementImpl implements Operation {
	...
	public EList<Parameter> getInput() {
		if (input == null) {
			input = new EObjectContainmentEList.Resolving<Parameter>(
					Parameter.class, this, TypePackage.OPERATION__INPUT);
		}
		return input;
	}
	...
	public EList<Parameter> getOutput() {
		if (output == null) {
			output = new EObjectContainmentEList.Resolving<Parameter>(
					Parameter.class, this, TypePackage.OPERATION__OUTPUT);
		}
		return output;
	}
