...
public class TypeSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case TypePackage.COMPONENT_TYPE: {
			...
			if (result == null)
				result = caseModelElement(componentType);
			if (result == null)
				result = caseAddElement(componentType);
			if (result == null)
				result = caseRemoveElement(componentType);
			if (result == null)
				result = caseNamedElement(componentType);
			if (result == null)
				result = caseObject(componentType);
			if (result == null)
		...
		case TypePackage.PRIMITIVE_TYPE: {
			...
			if (result == null)
				result = caseComponentType(primitiveType);
			if (result == null)
				result = caseModelElement(primitiveType);
			if (result == null)
				result = caseAddElement(primitiveType);
			if (result == null)
				result = caseRemoveElement(primitiveType);
			if (result == null)
		...
		case TypePackage.COMPOSITE_TYPE: {
			...
			if (result == null)
				result = caseComponentType(compositeType);
			if (result == null)
				result = caseModelElement(compositeType);
			if (result == null)
				result = caseAddElement(compositeType);
			if (result == null)
				result = caseRemoveElement(compositeType);
			if (result == null)
				result = caseNamedElement(compositeType);
			if (result == null)
				result = caseObject(compositeType);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case TypePackage.SERVICE: {
			...
			if (result == null)
				result = caseModelElement(service);
			if (result == null)
				result = caseAddElement(service);
			if (result == null)
				result = caseRemoveElement(service);
			if (result == null)
				result = caseNamedElement(service);
			if (result == null)
				result = caseObject(service);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case TypePackage.FUNCTIONAL_SERVICE: {
			...
			if (result == null)
				result = caseService(functionalService);
			if (result == null)
				result = caseModelElement(functionalService);
			if (result == null)
				result = caseAddElement(functionalService);
			if (result == null)
				result = caseRemoveElement(functionalService);
			if (result == null)
				result = caseNamedElement(functionalService);
			if (result == null)
				result = caseObject(functionalService);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case TypePackage.CONTROL_SERVICE: {
			...
			if (result == null)
				result = caseService(controlService);
			if (result == null)
				result = caseModelElement(controlService);
			if (result == null)
				result = caseAddElement(controlService);
			if (result == null)
				result = caseRemoveElement(controlService);
			if (result == null)
				result = caseNamedElement(controlService);
			if (result == null)
				result = caseObject(controlService);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case TypePackage.PORT: {
			...
			if (result == null)
				result = caseCardinalityElement(port);
			if (result == null)
				result = caseModelElement(port);
			if (result == null)
