 ...
 * @model kind="package"
 *        annotation="kermeta ecoreUri='http://art/type'"
...
public interface TypePackage extends EPackage {
	 ...
	 * @generated
	 */
	String eNS_URI = "http://art/type/kermeta_temp_uri";
	 ...
	 * @ordered
	 */
	int COMPONENT_TYPE__TAG = ArtPackage.MODEL_ELEMENT__TAG;
	 ...
	 * @ordered
	 */
	int COMPONENT_TYPE__OWNED_TAGS = ArtPackage.MODEL_ELEMENT__OWNED_TAGS;
	 ...
	 * @ordered
	 */
	int COMPONENT_TYPE__OID = ArtPackage.MODEL_ELEMENT__OID;
	 ...
	 * @ordered
	 */
	int COMPONENT_TYPE__INTERNAL_CONTAINING_RESOURCE = ArtPackage.MODEL_ELEMENT__INTERNAL_CONTAINING_RESOURCE;
	 ...
	 * @ordered
	 */
	int PRIMITIVE_TYPE__TAG = COMPONENT_TYPE__TAG;
	 ...
	 * @ordered
	 */
	int PRIMITIVE_TYPE__OWNED_TAGS = COMPONENT_TYPE__OWNED_TAGS;
	 ...
	 * @ordered
	 */
	int PRIMITIVE_TYPE__OID = COMPONENT_TYPE__OID;
	 ...
	 * @ordered
	 */
	int PRIMITIVE_TYPE__INTERNAL_CONTAINING_RESOURCE = COMPONENT_TYPE__INTERNAL_CONTAINING_RESOURCE;
	 ...
	 * @ordered
	 */
	int COMPOSITE_TYPE__TAG = COMPONENT_TYPE__TAG;
	 ...
	 * @ordered
	 */
	int COMPOSITE_TYPE__OWNED_TAGS = COMPONENT_TYPE__OWNED_TAGS;
	 ...
	 * @ordered
	 */
	int COMPOSITE_TYPE__OID = COMPONENT_TYPE__OID;
	 ...
	 * @ordered
	 */
	int COMPOSITE_TYPE__INTERNAL_CONTAINING_RESOURCE = COMPONENT_TYPE__INTERNAL_CONTAINING_RESOURCE;
	 ...
	 * @ordered
	 */
	int COMPOSITE_TYPE__DELEGATION = COMPONENT_TYPE_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int COMPOSITE_TYPE__SUB_TYPES = COMPONENT_TYPE_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int SERVICE__TAG = ArtPackage.MODEL_ELEMENT__TAG;
	 ...
	 * @ordered
	 */
	int SERVICE__OWNED_TAGS = ArtPackage.MODEL_ELEMENT__OWNED_TAGS;
	 ...
	 * @ordered
	 */
	int SERVICE__OID = ArtPackage.MODEL_ELEMENT__OID;
	 ...
	 * @ordered
	 */
	int SERVICE__INTERNAL_CONTAINING_RESOURCE = ArtPackage.MODEL_ELEMENT__INTERNAL_CONTAINING_RESOURCE;
	 ...
	 * @ordered
	 */
	int OPERATION__TAG = ArtPackage.MODEL_ELEMENT__TAG;
	 ...
	 * @ordered
	 */
	int OPERATION__OWNED_TAGS = ArtPackage.MODEL_ELEMENT__OWNED_TAGS;
	 ...
	 * @ordered
	 */
	int OPERATION__OID = ArtPackage.MODEL_ELEMENT__OID;
	 ...
	 * @ordered
	 */
	int OPERATION__INTERNAL_CONTAINING_RESOURCE = ArtPackage.MODEL_ELEMENT__INTERNAL_CONTAINING_RESOURCE;
	 ...
	 * @ordered
	 */
	int PARAMETER__TAG = ArtPackage.TYPED_ELEMENT__TAG;
	 ...
	 * @ordered
	 */
	int PARAMETER__OWNED_TAGS = ArtPackage.TYPED_ELEMENT__OWNED_TAGS;
	 ...
	 * @ordered
	 */
	int PARAMETER__OID = ArtPackage.TYPED_ELEMENT__OID;
	 ...
	 * @ordered
	 */
	int PARAMETER__INTERNAL_CONTAINING_RESOURCE = ArtPackage.TYPED_ELEMENT__INTERNAL_CONTAINING_RESOURCE;
	 ...
	 * @ordered
	 */
	int FUNCTIONAL_SERVICE__TAG = SERVICE__TAG;
	 ...
	 * @ordered
	 */
	int FUNCTIONAL_SERVICE__OWNED_TAGS = SERVICE__OWNED_TAGS;
	 ...
	 * @ordered
	 */
	int FUNCTIONAL_SERVICE__OID = SERVICE__OID;
	 ...
	 * @ordered
	 */
	int FUNCTIONAL_SERVICE__INTERNAL_CONTAINING_RESOURCE = SERVICE__INTERNAL_CONTAINING_RESOURCE;
	 ...
	 * @ordered
	 */
	int CONTROL_SERVICE__TAG = SERVICE__TAG;
	 ...
	 * @ordered
	 */
	int CONTROL_SERVICE__OWNED_TAGS = SERVICE__OWNED_TAGS;
	 ...
	 * @ordered
	 */
	int CONTROL_SERVICE__OID = SERVICE__OID;
	 ...
	 * @ordered
	 */
	int CONTROL_SERVICE__INTERNAL_CONTAINING_RESOURCE = SERVICE__INTERNAL_CONTAINING_RESOURCE;
	 ...
	 * @ordered
	 */
	int PORT__TAG = ArtPackage.CARDINALITY_ELEMENT__TAG;
	 ...
	 * @ordered
	 */
	int PORT__OWNED_TAGS = ArtPackage.CARDINALITY_ELEMENT__OWNED_TAGS;
	 ...
	 * @ordered
	 */
	int PORT__OID = ArtPackage.CARDINALITY_ELEMENT__OID;
	 ...
	 * @ordered
	 */
	int PORT__INTERNAL_CONTAINING_RESOURCE = ArtPackage.CARDINALITY_ELEMENT__INTERNAL_CONTAINING_RESOURCE;
	 ...
	 * @ordered
	 */
	int ATTRIBUTE__TAG = ArtPackage.TYPED_ELEMENT__TAG;
	 ...
	 * @ordered
	 */
	int ATTRIBUTE__OWNED_TAGS = ArtPackage.TYPED_ELEMENT__OWNED_TAGS;
	 ...
	 * @ordered
	 */
	int ATTRIBUTE__OID = ArtPackage.TYPED_ELEMENT__OID;
	 ...
	 * @ordered
	 */
	int ATTRIBUTE__INTERNAL_CONTAINING_RESOURCE = ArtPackage.TYPED_ELEMENT__INTERNAL_CONTAINING_RESOURCE;
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EReference COMPONENT_TYPE__ATTRIBUTE = eINSTANCE
		 ...
		 * @generated
		 */
		EReference PRIMITIVE_TYPE__BINDING = eINSTANCE
				.getPrimitiveType_Binding();
		 ...
		 * @generated
		 */
		EReference COMPOSITE_TYPE__DELEGATION = eINSTANCE
				.getCompositeType_Delegation();
		 ...
		 * @generated
		 */
		EReference COMPOSITE_TYPE__SUB_TYPES = eINSTANCE
				.getCompositeType_SubTypes();
