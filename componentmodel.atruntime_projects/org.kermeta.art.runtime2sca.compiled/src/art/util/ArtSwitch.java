...
public class ArtSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case ArtPackage.MODEL_ELEMENT: {
			...
			if (result == null)
				result = caseObject(modelElement);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case ArtPackage.TYPED_ELEMENT: {
			...
			if (result == null)
				result = caseModelElement(typedElement);
			if (result == null)
		...
		case ArtPackage.REMOVE_ELEMENT: {
			...
			if (result == null)
				result = caseObject(removeElement);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ArtPackage.UPDATE_ELEMENT: {
			...
			if (result == null)
				result = caseObject(updateElement);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ArtPackage.CARDINALITY_ELEMENT: {
			...
			if (result == null)
				result = caseModelElement(cardinalityElement);
			if (result == null)
				result = caseNamedElement(cardinalityElement);
			if (result == null)
				result = caseObject(cardinalityElement);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
