 ...
 * @generated
 */
public class ValuedAttributeImpl extends UpdateElementImpl implements
		ValuedAttribute {
	/**
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					InstancePackage.VALUED_ATTRIBUTE__VALUE, oldValue, value));
	}
			...
			if (attribute != oldAttribute) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							InstancePackage.VALUED_ATTRIBUTE__ATTRIBUTE,
	...
	public void setAttribute(Attribute newAttribute) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					InstancePackage.VALUED_ATTRIBUTE__ATTRIBUTE, oldAttribute,
					attribute));
	}
