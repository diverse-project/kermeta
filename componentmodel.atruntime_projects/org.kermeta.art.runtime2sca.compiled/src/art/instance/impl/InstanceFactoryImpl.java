...
public class InstanceFactoryImpl extends EFactoryImpl implements
	...
	public static InstanceFactory init() {
		try {
			InstanceFactory theInstanceFactory = (InstanceFactory) EPackage.Registry.INSTANCE
					.getEFactory("http://art/instance/kermeta_temp_uri");
	...
	public EObject create(EClass eClass) {
		...
		case InstancePackage.VALUED_ATTRIBUTE:
			return createValuedAttribute();
		case InstancePackage.TRANSMISSION_BINDING:
			return createTransmissionBinding();
	 ...
	 * @generated
	 */
	public InstanceState createInstanceStateFromString(EDataType eDataType,
			String initialValue) {
	 ...
	 * @generated
	 */
	public String convertInstanceStateToString(EDataType eDataType,
