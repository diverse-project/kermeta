 ...
 * @generated
 */
public class DelegationBindingImpl extends BindingImpl implements
		DelegationBinding {
	/**
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							InstancePackage.DELEGATION_BINDING__SOURCE,
							oldSource, source));
			}
		}
		return source;
	...
	public void setSource(Port newSource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					InstancePackage.DELEGATION_BINDING__SOURCE, oldSource,
					source));
	}
	...
	public Port getExported() {
		if (exported != null && exported.eIsProxy()) {
			...
			if (exported != oldExported) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							InstancePackage.DELEGATION_BINDING__EXPORTED,
	...
	public void setExported(Port newExported) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					InstancePackage.DELEGATION_BINDING__EXPORTED, oldExported,
					exported));
	}
