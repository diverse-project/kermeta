 ...
 * @model kind="package"
 *        annotation="kermeta ecoreUri='http://art/instance'"
...
public interface InstancePackage extends EPackage {
	 ...
	 * @generated
	 */
	String eNS_URI = "http://art/instance/kermeta_temp_uri";
	 ...
	 * @ordered
	 */
	int COMPONENT_INSTANCE__TAG = ArtPackage.MODEL_ELEMENT__TAG;
	 ...
	 * @ordered
	 */
	int COMPONENT_INSTANCE__OWNED_TAGS = ArtPackage.MODEL_ELEMENT__OWNED_TAGS;
	 ...
	 * @ordered
	 */
	int COMPONENT_INSTANCE__OID = ArtPackage.MODEL_ELEMENT__OID;
	 ...
	 * @ordered
	 */
	int COMPONENT_INSTANCE__INTERNAL_CONTAINING_RESOURCE = ArtPackage.MODEL_ELEMENT__INTERNAL_CONTAINING_RESOURCE;
	 ...
	 * @ordered
	 */
	int COMPONENT_INSTANCE__STATE = ArtPackage.MODEL_ELEMENT_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int COMPONENT_INSTANCE__ATTRIBUTE = ArtPackage.MODEL_ELEMENT_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int PRIMITIVE_INSTANCE__TAG = COMPONENT_INSTANCE__TAG;
	 ...
	 * @ordered
	 */
	int PRIMITIVE_INSTANCE__OWNED_TAGS = COMPONENT_INSTANCE__OWNED_TAGS;
	 ...
	 * @ordered
	 */
	int PRIMITIVE_INSTANCE__OID = COMPONENT_INSTANCE__OID;
	 ...
	 * @ordered
	 */
	int PRIMITIVE_INSTANCE__INTERNAL_CONTAINING_RESOURCE = COMPONENT_INSTANCE__INTERNAL_CONTAINING_RESOURCE;
	 ...
	 * @ordered
	 */
	int COMPOSITE_INSTANCE__TAG = COMPONENT_INSTANCE__TAG;
	 ...
	 * @ordered
	 */
	int COMPOSITE_INSTANCE__OWNED_TAGS = COMPONENT_INSTANCE__OWNED_TAGS;
	 ...
	 * @ordered
	 */
	int COMPOSITE_INSTANCE__OID = COMPONENT_INSTANCE__OID;
	 ...
	 * @ordered
	 */
	int COMPOSITE_INSTANCE__INTERNAL_CONTAINING_RESOURCE = COMPONENT_INSTANCE__INTERNAL_CONTAINING_RESOURCE;
	 ...
	 * @ordered
	 */
	int VALUED_ATTRIBUTE__TAG = ArtPackage.UPDATE_ELEMENT__TAG;
	 ...
	 * @ordered
	 */
	int VALUED_ATTRIBUTE__OWNED_TAGS = ArtPackage.UPDATE_ELEMENT__OWNED_TAGS;
	 ...
	 * @ordered
	 */
	int VALUED_ATTRIBUTE__OID = ArtPackage.UPDATE_ELEMENT__OID;
	 ...
	 * @ordered
	 */
	int VALUED_ATTRIBUTE__INTERNAL_CONTAINING_RESOURCE = ArtPackage.UPDATE_ELEMENT__INTERNAL_CONTAINING_RESOURCE;
	 ...
	 * @ordered
	 */
	int VALUED_ATTRIBUTE__VALUE = ArtPackage.UPDATE_ELEMENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int VALUED_ATTRIBUTE__ATTRIBUTE = ArtPackage.UPDATE_ELEMENT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int BINDING__TAG = ArtPackage.ADD_ELEMENT__TAG;
	 ...
	 * @ordered
	 */
	int BINDING__OWNED_TAGS = ArtPackage.ADD_ELEMENT__OWNED_TAGS;
	 ...
	 * @ordered
	 */
	int BINDING__OID = ArtPackage.ADD_ELEMENT__OID;
	 ...
	 * @ordered
	 */
	int BINDING__INTERNAL_CONTAINING_RESOURCE = ArtPackage.ADD_ELEMENT__INTERNAL_CONTAINING_RESOURCE;
	 ...
	 * @ordered
	 */
	int TRANSMISSION_BINDING__TAG = BINDING__TAG;
	 ...
	 * @ordered
	 */
	int TRANSMISSION_BINDING__OWNED_TAGS = BINDING__OWNED_TAGS;
	 ...
	 * @ordered
	 */
	int TRANSMISSION_BINDING__OID = BINDING__OID;
	 ...
	 * @ordered
	 */
	int TRANSMISSION_BINDING__INTERNAL_CONTAINING_RESOURCE = BINDING__INTERNAL_CONTAINING_RESOURCE;
	 ...
	 * @ordered
	 */
	int TRANSMISSION_BINDING__SERVER = BINDING_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int TRANSMISSION_BINDING__CLIENT = BINDING_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int DELEGATION_BINDING__TAG = BINDING__TAG;
	 ...
	 * @ordered
	 */
	int DELEGATION_BINDING__OWNED_TAGS = BINDING__OWNED_TAGS;
	 ...
	 * @ordered
	 */
	int DELEGATION_BINDING__OID = BINDING__OID;
	 ...
	 * @ordered
	 */
	int DELEGATION_BINDING__INTERNAL_CONTAINING_RESOURCE = BINDING__INTERNAL_CONTAINING_RESOURCE;
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EReference COMPONENT_INSTANCE__BINDING = eINSTANCE
		 ...
		 * @generated
		 */
		EAttribute COMPONENT_INSTANCE__STATE = eINSTANCE
				.getComponentInstance_State();
		 ...
		 * @generated
		 */
		EReference COMPONENT_INSTANCE__ATTRIBUTE = eINSTANCE
				.getComponentInstance_Attribute();
		 ...
		 * @generated
		 */
		EReference COMPONENT_INSTANCE__IMPLEM = eINSTANCE
				.getComponentInstance_Implem();
		 ...
		 * @generated
		 */
		EReference COMPOSITE_INSTANCE__SUB_COMPONENT = eINSTANCE
				.getCompositeInstance_SubComponent();
		 ...
		 * @generated
		 */
		EReference COMPOSITE_INSTANCE__DELEGATION = eINSTANCE
				.getCompositeInstance_Delegation();
		 ...
		 * @generated
		 */
		EAttribute VALUED_ATTRIBUTE__VALUE = eINSTANCE
				.getValuedAttribute_Value();
		 ...
		 * @generated
		 */
		EReference VALUED_ATTRIBUTE__ATTRIBUTE = eINSTANCE
				.getValuedAttribute_Attribute();
		 ...
		 * @generated
		 */
		EReference BINDING__SERVER_INSTANCE = eINSTANCE
				.getBinding_ServerInstance();
		 ...
		 * @generated
		 */
		EReference TRANSMISSION_BINDING__SERVER = eINSTANCE
				.getTransmissionBinding_Server();
		 ...
		 * @generated
		 */
		EReference TRANSMISSION_BINDING__CLIENT = eINSTANCE
				.getTransmissionBinding_Client();
		 ...
		 * @generated
		 */
		EReference DELEGATION_BINDING__SOURCE = eINSTANCE
				.getDelegationBinding_Source();
		 ...
		 * @generated
		 */
		EReference DELEGATION_BINDING__EXPORTED = eINSTANCE
				.getDelegationBinding_Exported();
