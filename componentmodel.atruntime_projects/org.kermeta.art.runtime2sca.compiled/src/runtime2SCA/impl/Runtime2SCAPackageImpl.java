...
import runtime2SCA.Runtime2SCAFactory;
 ...
 * @generated
 */
public class Runtime2SCAPackageImpl extends EPackageImpl implements
		Runtime2SCAPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see runtime2SCA.Runtime2SCAPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Runtime2SCAPackageImpl() {
		super(eNS_URI, Runtime2SCAFactory.eINSTANCE);
	}
	 ...
	 * @generated
	 */
	public static Runtime2SCAPackage init() {
		if (isInited)
			return (Runtime2SCAPackage) EPackage.Registry.INSTANCE
		...
		Runtime2SCAPackageImpl theRuntime2SCAPackage = (Runtime2SCAPackageImpl) (EPackage.Registry.INSTANCE
				.getEPackage(eNS_URI) instanceof Runtime2SCAPackageImpl ? EPackage.Registry.INSTANCE
				.getEPackage(eNS_URI)
				: new Runtime2SCAPackageImpl());
		...
		theRuntime2SCAPackage.freeze();

		return theRuntime2SCAPackage;
	}
	 ...
	 * @generated
	 */
	public Runtime2SCAFactory getRuntime2SCAFactory() {
		return (Runtime2SCAFactory) getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		EOperation op = addEOperation(mainEClass, theArtPackage.getSystem(),
				"loadModel", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, thePersistencePackage.getEMFRepository(),
				"repository", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, theStandardPackage.getJavaString(), "model", 0, 1,
				IS_UNIQUE, IS_ORDERED);

		op = addEOperation(mainEClass, null, "mainWithParameter", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, theStandardPackage.getJavaString(), "modelURI", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, theStandardPackage.getJavaString(), "file", 0, 1,
				IS_UNIQUE, IS_ORDERED);
	...
	protected void createKermetaAnnotations() {
		...
		addAnnotation(this, source, new String[] { "ecoreUri",
				"http://www.kermeta.org/runtime2SCA" });
		addAnnotation(
				mainEClass.getEOperations().get(1),
				source,
				new String[] {
						"main",
						"platform:/resource/SmartAdapters/examples/serviceDiscovery/model/woven/DAModel.art C:/Documents and Settings/bmorin/workspace/SCA_example/src/test.composite" });
		addAnnotation(mainEClass.getEOperations().get(2), source, new String[] {
				"main", "" });
	}

} //Runtime2SCAPackageImpl
