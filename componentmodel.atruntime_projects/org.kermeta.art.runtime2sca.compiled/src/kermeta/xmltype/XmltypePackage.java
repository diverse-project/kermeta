...
public interface XmltypePackage extends EPackage {
	 ...
	 * @ordered
	 */
	int QNAME__TAG = StandardPackage.STRING__TAG;
	 ...
	 * @ordered
	 */
	int QNAME__OWNED_TAGS = StandardPackage.STRING__OWNED_TAGS;
	 ...
	 * @ordered
	 */
	int QNAME__OID = StandardPackage.STRING__OID;
	 ...
	 * @ordered
	 */
	int QNAME__INTERNAL_CONTAINING_RESOURCE = StandardPackage.STRING__INTERNAL_CONTAINING_RESOURCE;
	 ...
	 * @ordered
	 */
	int QNAME__VALUE = StandardPackage.STRING__VALUE;
	 ...
	 * @ordered
	 */
	int QNAME_FEATURE_COUNT = StandardPackage.STRING_FEATURE_COUNT + 0;
