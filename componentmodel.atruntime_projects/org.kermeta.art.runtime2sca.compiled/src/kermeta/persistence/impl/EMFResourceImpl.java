...
public class EMFResourceImpl extends ResourceImpl implements EMFResource {
	...
	public void load() {
		...
		idIfCond_334 = kermeta.standard.helper.IntegerWrapper.equals(this
				.size(), 0);
	...
	public void add(kermeta.language.structure.Object instance) {
		...
		result_ft81 = ((kermeta.standard.Sequence<kermeta.persistence.Resource>) org.kermeta.compil.runtime.helper.language.ClassUtil
				.newObject(kermeta.standard.StandardPackage.eINSTANCE
						.getSequence()));

		{

			kermeta.standard.Iterator<kermeta.persistence.Resource> it_ft81 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil
...

		{
			...
			kermeta.standard.Iterator<kermeta.persistence.Resource> it_ft80 = result_ft81
					.iterator();
