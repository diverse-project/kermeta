...
public class EMFRepositoryImpl extends RepositoryImpl implements EMFRepository {
	...
	public Resource createResource(String uri, String mm_uri) {
		...
		result_ft82 = ((kermeta.standard.Sequence<java.lang.String>) org.kermeta.compil.runtime.helper.language.ClassUtil
		...
		idIfCond_334 = kermeta.standard.helper.BooleanWrapper.not(result_ft82
				.contains(uri));
