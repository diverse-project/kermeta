...
public interface Set<G> extends Collection<G> {
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='\n\tjava.lang.Boolean idIfCond_163 = false;\n\tidIfCond_163 = kermeta.standard.helper.BooleanWrapper.not(this.contains(element));\n\n\tif( idIfCond_163 ) {\n\n\tsuper.add(element);\n}\n\n'"
	 * @generated
	 */
	void add(G element);
	 ...
	 *        annotation="kermeta superOperation='kermeta::standard::Collection'"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='\n\tG elem = null;\n//BIft:detect\n\nG result_ft41 = null;\n\n\tG elem_ft41 = null;\n\n\tresult_ft41 = null;\n\n\t\n{\n\n\tkermeta.standard.Iterator<G> it_ft41 = this.iterator();\n\tjava.lang.Boolean idLoopCond_168 = false;\n\twhile( !idLoopCond_168 ) {\n\tidLoopCond_168 = kermeta.standard.helper.BooleanWrapper.or(it_ft41.isOff(), org.kermeta.compil.runtime.helper.language.ObjectUtil.isNotEqualSwitcher(result_ft41, null));\n\tif ( idLoopCond_168 ) {\n\t} else {\n\n\telem_ft41 = it_ft41.next();\n\n\tjava.lang.Boolean idIfCond_169 = false;\n//BIle:detector\nG e_lbdExp41 = elem_ft41;\n\n\tidIfCond_169 = org.kermeta.compil.runtime.helper.language.ObjectUtil.equalsSwitcher(e_lbdExp41, element);\n//EIle:detector\n\n\n\tif( idIfCond_169 ) {\n\n\tresult_ft41 = elem_ft41;\n}\n\n}\n\t}\n}\n\n\n//CE\nelem = result_ft41;\n//EIft:detect\n;\n\n\tjava.lang.Boolean idIfCond_170 = false;\n\tidIfCond_170 = org.kermeta.compil.runtime.helper.language.ObjectUtil.isNotEqualSwitcher(elem, null);\n\n\tif( idIfCond_170 ) {\n\n\torg.kermeta.compil.runtime.helper.basetypes.CollectionUtil.remove(this, elem);\n}\n\n'"
	 * @generated
	 */
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='\njava.lang.Boolean result = null;\n\n\tjava.lang.Boolean isEqual = false;\n\n\tjava.lang.Boolean idIfCond_171 = false;\n\tidIfCond_171 = kermeta.standard.helper.BooleanWrapper.not(org.kermeta.compil.runtime.helper.language.ObjectUtil.isVoidSwitcher(element));\n\n\tif( idIfCond_171 ) {\n\n\tjava.lang.Boolean idIfCond_172 = false;\n\tidIfCond_172 = org.kermeta.compil.runtime.helper.language.TypeUtil.isInstanceSwitcher(org.kermeta.compil.runtime.ExecutionContext.getInstance().getMetaClass(\"kermeta.standard.Collection<G>\"), element);\n\n\tif( idIfCond_172 ) {\n\n\tkermeta.standard.Collection<G> collection = null;\n\n\tcollection = (kermeta.standard.Collection<G>) org.kermeta.compil.runtime.helper.language.ObjectUtil.asTypeOrVoid(element, \"kermeta.standard.Collection<G>\");\n\n\tjava.lang.Boolean idIfCond_173 = false;\n\tidIfCond_173 = kermeta.standard.helper.IntegerWrapper.equals(this.size(), collection.size());\n\n\tif( idIfCond_173 ) {\n\n\tG elem = null;\n\n\tjava.lang.Boolean ok = true;\n\n\t\n{\n\n\tkermeta.standard.Iterator<G> it = this.iterator();\n\tjava.lang.Boolean idLoopCond_174 = false;\n\twhile( !idLoopCond_174 ) {\n\tidLoopCond_174 = kermeta.standard.helper.BooleanWrapper.or(it.isOff(), kermeta.standard.helper.BooleanWrapper.not(ok));\n\tif ( idLoopCond_174 ) {\n\t} else {\n\n\telem = it.next();\n\n\tjava.lang.Boolean idIfCond_175 = false;\n\tidIfCond_175 = kermeta.standard.helper.BooleanWrapper.not(collection.contains(elem));\n\n\tif( idIfCond_175 ) {\n\n\tok = false;\n}\n\n}\n\t}\n}\n\n\n\tisEqual = ok;\n}\n\n}\n\n}\n\n\n\tresult = isEqual;\n\nreturn result;\n'"
	 * @generated
	 */
