					...
					if (idLoopCond_118) {
						...
						if (idIfCond_119) {
							...
							if (idIfCond_121) {
								...
								idIfCond_124 = kermeta.standard.helper.IntegerWrapper
						...
						if (idIfCond_128) {
							...
							if (idIfCond_129) {
...

								{
									...
									kermeta.standard.Iterator<kermeta.language.structure.Type> it_ft32 = ((kermeta.language.structure.ClassDefinition) org.kermeta.compil.runtime.helper.language.ObjectUtil
											.asTypeSwitcher(
													org.kermeta.compil.runtime.helper.language.ObjectUtil
									...
									while (!idLoopCond_131) {
										idLoopCond_131 = kermeta.standard.helper.BooleanWrapper
												.or(
														it_ft32.isOff(),
														org.kermeta.compil.runtime.helper.language.ObjectUtil
																.isNotEqualSwitcher(
										...
										if (idLoopCond_131) {
											...
											//BIle:func
											kermeta.language.structure.Type t_lbdExp32 = it_ft32
													.next();
								...
								if (idIfCond_130) {
...

									{
										...
										kermeta.standard.Iterator<kermeta.language.structure.Object> it_ft33 = subObjInstances
												.iterator();
										...
										while (!idLoopCond_133) {
											...
											if (idLoopCond_133) {
												...
												//BIle:func
												kermeta.language.structure.Object aSubObjInstances_lbdExp33 = it_ft33
														.next();

												org.kermeta.compil.runtime.helper.language.ObjectUtil
														.checkAllInvariantsSwitcher(aSubObjInstances_lbdExp33);
												//EIle:func
