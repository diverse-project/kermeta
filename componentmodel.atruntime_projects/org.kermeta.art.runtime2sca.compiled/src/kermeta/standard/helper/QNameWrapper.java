		...
		if (idIfCond_227) {
...

			{
				...
				while (!idLoopCond_228) {
					idLoopCond_228 = it_ft48.isOff();
					if (idLoopCond_228) {
					} else {

						//BIle:func
						kermeta.language.structure.Property p_lbdExp48 = it_ft48
								.next();
...

						{
							...
							while (!idLoopCond_230) {
								...
								if (idLoopCond_230) {
									...
									//BIle:func
									kermeta.language.structure.Tag t_lbdExp49 = it_ft49
											.next();

									result_lambda_ft49 = kermeta.standard.helper.StringWrapper
											.equals(t_lbdExp49.getName(),
													"ecore.isTransient");
									//EIle:func

									test_ft49 = kermeta.standard.helper.BooleanWrapper
											.or(test_ft49, result_lambda_ft49);
								}
							}
						}
						...
						idIfCond_229 = kermeta.standard.helper.BooleanWrapper
								.and(kermeta.standard.helper.BooleanWrapper
										...
										kermeta.standard.helper.BooleanWrapper
												.not(p_lbdExp48.getIsDerived()));

						if (idIfCond_229) {

							kermeta.language.structure.Object v = org.kermeta.compil.runtime.helper.language.ObjectUtil
									.getSwitcher(self, p_lbdExp48);
							...
							if (idIfCond_232) {
								...
								result_ft50 = org.kermeta.compil.runtime.helper.language.ObjectUtil
							...
							if (idIfCond_231) {
								...
								idIfCond_234 = kermeta.standard.helper.IntegerWrapper
										.isLower(c.size(), p_lbdExp48
												.getLower());
		...
		if (idIfCond_236) {
...

			{
				...
				while (!idLoopCond_237) {
					idLoopCond_237 = it_ft51.isOff();
					if (idLoopCond_237) {
					} else {

						//BIle:func
						kermeta.language.structure.Property prop_lbdExp51 = it_ft51
								.next();

						java.lang.Boolean idIfCond_238 = false;
						idIfCond_238 = kermeta.standard.helper.BooleanWrapper
								.and(prop_lbdExp51.getIsComposite(),
										kermeta.standard.helper.BooleanWrapper
												.not(prop_lbdExp51
														.getIsDerived()));
						...
						if (idIfCond_238) {
							...
							if (idIfCond_239) {
...

								{
									...
									kermeta.standard.Iterator<kermeta.language.structure.Type> it_ft52 = ((kermeta.language.structure.ClassDefinition) org.kermeta.compil.runtime.helper.language.ObjectUtil
											.asTypeSwitcher(
													org.kermeta.compil.runtime.helper.language.ObjectUtil
															.getMetaClassSwitcher(
																	org.kermeta.compil.runtime.helper.language.ObjectUtil
									...
									while (!idLoopCond_241) {
										...
										if (idLoopCond_241) {
											...
											//BIle:func
											kermeta.language.structure.Type t_lbdExp52 = it_ft52
													.next();
											...
											if (idIfCond_242) {
												...
												result_lambda_ft52 = kermeta.standard.helper.StringWrapper
														.equals(
											...
											test_ft52 = kermeta.standard.helper.BooleanWrapper
													.or(test_ft52,
															result_lambda_ft52);
										}
									}
								...
								if (idIfCond_240) {
...

									{
										...
										kermeta.standard.Iterator<kermeta.language.structure.Object> it_ft53 = subObjInstances
												.iterator();
										java.lang.Boolean idLoopCond_243 = false;
										while (!idLoopCond_243) {
											idLoopCond_243 = it_ft53.isOff();
											if (idLoopCond_243) {
											} else {

												//BIle:func
												kermeta.language.structure.Object aSubObjInstances_lbdExp53 = it_ft53
														.next();

												org.kermeta.compil.runtime.helper.language.ObjectUtil
														.checkAllInvariantsSwitcher(aSubObjInstances_lbdExp53);
												//EIle:func
