	...
	java.lang.String self, kermeta.language.structure.Property property,
		...
		if (idIfCond_42) {
			...
			if (idIfCond_44) {
				...
				//BIle:right
				/*This variable should be never used*/kermeta.language.structure.Object e_lbdExp16 = null;
	...
	java.lang.String self
		...
		if (idIfCond_45) {
...

			{
				...
				while (!idLoopCond_46) {
					idLoopCond_46 = it_ft17.isOff();
					if (idLoopCond_46) {
					} else {

						//BIle:func
						kermeta.language.structure.Property p_lbdExp17 = it_ft17
								.next();
...

						{
							...
							kermeta.standard.Iterator<kermeta.language.structure.Tag> it_ft18 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil
									.<kermeta.language.structure.Tag> convertAsOrderedSet(
											p_lbdExp17.getTag()).iterator();
							...
							while (!idLoopCond_48) {
								...
								if (idLoopCond_48) {
									...
									//BIle:func
									kermeta.language.structure.Tag t_lbdExp18 = it_ft18
											.next();

									result_lambda_ft18 = kermeta.standard.helper.StringWrapper
											.equals(t_lbdExp18.getName(),
													"ecore.isTransient");
									//EIle:func

									test_ft18 = kermeta.standard.helper.BooleanWrapper
											.or(test_ft18, result_lambda_ft18);
								}
							}
						}
						...
						idIfCond_47 = kermeta.standard.helper.BooleanWrapper
								.and(kermeta.standard.helper.BooleanWrapper
										...
										kermeta.standard.helper.BooleanWrapper
												.not(p_lbdExp17.getIsDerived()));

						if (idIfCond_47) {

							kermeta.language.structure.Object v = org.kermeta.compil.runtime.helper.language.ObjectUtil
									.getSwitcher(self, p_lbdExp17);
							...
							if (idIfCond_50) {
								...
								//BIle:right
								/*This variable should be never used*/kermeta.language.structure.Object f_lbdExp19 = null;
							...
							if (idIfCond_49) {
								...
								idIfCond_52 = kermeta.standard.helper.IntegerWrapper
										.isLower(c.size(), p_lbdExp17
												.getLower());
	...
	java.lang.String self
		...
		if (idIfCond_54) {
...

			{
				...
				while (!idLoopCond_55) {
					idLoopCond_55 = it_ft20.isOff();
					if (idLoopCond_55) {
					} else {

						//BIle:func
						kermeta.language.structure.Property prop_lbdExp20 = it_ft20
								.next();

						java.lang.Boolean idIfCond_56 = false;
						idIfCond_56 = kermeta.standard.helper.BooleanWrapper
								.and(prop_lbdExp20.getIsComposite(),
										kermeta.standard.helper.BooleanWrapper
												.not(prop_lbdExp20
														.getIsDerived()));
						...
						if (idIfCond_56) {
							...
							if (idIfCond_57) {
...

								{
									...
									kermeta.standard.Iterator<kermeta.language.structure.Type> it_ft21 = ((kermeta.language.structure.ClassDefinition) org.kermeta.compil.runtime.helper.language.ObjectUtil
											.asTypeSwitcher(
													org.kermeta.compil.runtime.helper.language.ObjectUtil
															.getMetaClassSwitcher(
																	org.kermeta.compil.runtime.helper.language.ObjectUtil
									...
									while (!idLoopCond_59) {
										...
										if (idLoopCond_59) {
											...
											//BIle:func
											kermeta.language.structure.Type t_lbdExp21 = it_ft21
													.next();
											...
											if (idIfCond_60) {
												...
												result_lambda_ft21 = kermeta.standard.helper.StringWrapper
														.equals(
												...
												result_lambda_ft21 = false;
											}

											//EIle:func

											test_ft21 = kermeta.standard.helper.BooleanWrapper
													.or(test_ft21,
															result_lambda_ft21);
										}
									}
								...
								if (idIfCond_58) {
...

									{
										...
										kermeta.standard.Iterator<kermeta.language.structure.Object> it_ft22 = subObjInstances
												.iterator();
										java.lang.Boolean idLoopCond_61 = false;
										while (!idLoopCond_61) {
											idLoopCond_61 = it_ft22.isOff();
											if (idLoopCond_61) {
											} else {

												//BIle:func
												kermeta.language.structure.Object aSubObjInstances_lbdExp22 = it_ft22
														.next();

												org.kermeta.compil.runtime.helper.language.ObjectUtil
														.checkAllInvariantsSwitcher(aSubObjInstances_lbdExp22);
												//EIle:func
