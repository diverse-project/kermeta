...
public interface Bag<G> extends Collection<G> {
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='\n\tG elem = null;\n//BIft:detect\n\nG result_ft44 = null;\n\n\tG elem_ft44 = null;\n\n\tresult_ft44 = null;\n\n\t\n{\n\n\tkermeta.standard.Iterator<G> it_ft44 = this.iterator();\n\tjava.lang.Boolean idLoopCond_190 = false;\n\twhile( !idLoopCond_190 ) {\n\tidLoopCond_190 = kermeta.standard.helper.BooleanWrapper.or(it_ft44.isOff(), org.kermeta.compil.runtime.helper.language.ObjectUtil.isNotEqualSwitcher(result_ft44, null));\n\tif ( idLoopCond_190 ) {\n\t} else {\n\n\telem_ft44 = it_ft44.next();\n\n\tjava.lang.Boolean idIfCond_191 = false;\n//BIle:detector\nG e_lbdExp44 = elem_ft44;\n\n\tidIfCond_191 = org.kermeta.compil.runtime.helper.language.ObjectUtil.equalsSwitcher(e_lbdExp44, element);\n//EIle:detector\n\n\n\tif( idIfCond_191 ) {\n\n\tresult_ft44 = elem_ft44;\n}\n\n}\n\t}\n}\n\n\n//CE\nelem = result_ft44;\n//EIft:detect\n;\n\n\tjava.lang.Boolean idIfCond_192 = false;\n\tidIfCond_192 = org.kermeta.compil.runtime.helper.language.ObjectUtil.isNotEqualSwitcher(elem, null);\n\n\tif( idIfCond_192 ) {\n\n\torg.kermeta.compil.runtime.helper.basetypes.CollectionUtil.remove(this, elem);\n}\n\n'"
	 * @generated
	 */
