...
public class DynamicExpressionImpl extends ObjectImpl implements
	...
	public Boolean parse(String expression) {
		...
		idIfCond_357 = kermeta.standard.helper.BooleanWrapper.or(
		...
		if (idIfCond_358) {
...

			{
				...
				kermeta.standard.Iterator<kermeta.interpreter.KermetaError> it_ft87 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil
						.<kermeta.interpreter.KermetaError> convertAsOrderedSet(
				...
				while (!idLoopCond_359) {
					...
					if (idLoopCond_359) {
						...
						//BIle:func
						kermeta.interpreter.KermetaError error_lbdExp87 = it_ft87
								.next();
	...
	public kermeta.language.structure.Object evalString(String body,
		...
		idIfCond_360 = kermeta.standard.helper.BooleanWrapper.not(this
				.parse(body));
