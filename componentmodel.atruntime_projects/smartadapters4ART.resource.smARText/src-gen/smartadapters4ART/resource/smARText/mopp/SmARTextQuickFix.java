...
public abstract class SmARTextQuickFix implements smartadapters4ART.resource.smARText.ISmARTextQuickFix {
	...
	public SmARTextQuickFix(String displayString, String imageKey, org.eclipse.emf.ecore.EObject contextObject) {
		this(displayString, imageKey, java.util.Collections.singleton(contextObject), contextObject.eResource());
	}
	
	public SmARTextQuickFix(String displayString, String imageKey, java.util.Collection<org.eclipse.emf.ecore.EObject> contextObjects) {
		this(displayString, imageKey, contextObjects, contextObjects.iterator().next().eResource());
	}
	
	public SmARTextQuickFix(String displayString, String imageKey, java.util.Collection<org.eclipse.emf.ecore.EObject> contextObjects, org.eclipse.emf.ecore.resource.Resource resource) {
		super();
	...
	public String apply(String currentText) {
		...
		try {
			...
			smartadapters4ART.resource.smARText.mopp.SmARTextPlugin.logError("Exception while applying quick fix", e);
		}
		return null;
	}
