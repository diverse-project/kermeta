...
public class SmARTextNature implements org.eclipse.core.resources.IProjectNature {
	...
	public static final String NATURE_ID = "smartadapters4ART.resource.smARText.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {smartadapters4ART.resource.smARText.mopp.SmARTextBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(smartadapters4ART.resource.smARText.mopp.SmARTextBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
