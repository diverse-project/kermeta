...
public class SmARTextExpectedTerminal {
	...
	private smartadapters4ART.resource.smARText.ISmARTextExpectedElement terminal;
	...
	public SmARTextExpectedTerminal(smartadapters4ART.resource.smARText.ISmARTextExpectedElement terminal, int followSetID, org.eclipse.emf.ecore.EStructuralFeature... containmentTrace) {
		super();
	...
	public smartadapters4ART.resource.smARText.ISmARTextExpectedElement getTerminal() {
		return terminal;
	}
