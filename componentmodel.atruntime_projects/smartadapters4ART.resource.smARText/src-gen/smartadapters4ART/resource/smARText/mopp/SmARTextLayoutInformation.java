...
public class SmARTextLayoutInformation {
	
	private final smartadapters4ART.resource.smARText.grammar.SmARTextSyntaxElement syntaxElement;
	...
	public SmARTextLayoutInformation(smartadapters4ART.resource.smARText.grammar.SmARTextSyntaxElement syntaxElement, Object object, int startOffset, String hiddenTokenText, String visibleTokenText) {
		super();
	...
	public smartadapters4ART.resource.smARText.grammar.SmARTextSyntaxElement getSyntaxElement() {
