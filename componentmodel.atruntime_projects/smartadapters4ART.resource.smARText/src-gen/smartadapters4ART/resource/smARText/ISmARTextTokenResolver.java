 ...
 * instance of SmARTextDefaultTokenResolver which performs a standard conversion
 * based on the EMF type conversion. This includes conversion of registered
 * EDataTypes.
 * 
 * @see smartadapters4ART.resource.smARText.analysis.SmARTextDefaultTokenResolver
 */
public interface ISmARTextTokenResolver extends smartadapters4ART.resource.smARText.ISmARTextConfigurable {
	 ...
	 * errors
	 */
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, smartadapters4ART.resource.smARText.ISmARTextTokenResolveResult result);
