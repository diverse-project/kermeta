 ...
 * resolver
 */
public interface ISmARTextReferenceResolver<ContainerType extends org.eclipse.emf.ecore.EObject, ReferenceType extends org.eclipse.emf.ecore.EObject> extends smartadapters4ART.resource.smARText.ISmARTextConfigurable {
	 ...
	 * operation.
	 */
	public void resolve(String identifier, ContainerType container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, smartadapters4ART.resource.smARText.ISmARTextReferenceResolveResult<ReferenceType> result);
