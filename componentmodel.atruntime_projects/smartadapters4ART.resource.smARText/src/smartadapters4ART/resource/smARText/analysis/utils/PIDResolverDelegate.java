package smartadapters4ART.resource.smARText.analysis.utils;

import smartadapters4ART.resource.smARText.ISmARTextContextDependentURIFragment;
import smartadapters4ART.resource.smARText.ISmARTextReferenceResolveResult;
import smartadapters4ART.resource.smARText.ISmARTextTextResource;
import smartadapters4ART.resource.smARText.util.SmARTextEObjectUtil;


public class PIDResolverDelegate<ContainerType extends org.eclipse.emf.ecore.EObject, ReferenceType extends org.eclipse.emf.ecore.EObject> {
	
	public final static java.lang.String NAME_FEATURE = "pid";
	...
	public void resolve(java.lang.String identifier, ContainerType container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, ISmARTextReferenceResolveResult<ReferenceType> result) {
		try {
			org.eclipse.emf.ecore.EClass type = reference.getEReferenceType();
			org.eclipse.emf.ecore.EObject root = SmARTextEObjectUtil.findRootContainer(container);
	...
	private boolean checkElement(org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.EClass type, java.lang.String identifier, boolean resolveFuzzy, ISmARTextReferenceResolveResult<ReferenceType> result) {
		if (element.eIsProxy()) {
			return true;
		}
	...
	protected java.lang.String produceDeResolveErrorMessage(org.eclipse.emf.ecore.EObject refObject, org.eclipse.emf.ecore.EObject container, org.eclipse.emf.ecore.EReference reference, ISmARTextTextResource resource) {
		...
		if (nameAttr instanceof org.eclipse.emf.ecore.EAttribute) {
			...
			for (org.eclipse.emf.ecore.EOperation o : element.eClass().getEAllOperations()) {
				if (o.getName().toLowerCase().endsWith(NAME_FEATURE) && o.getEParameters().size() == 0 ) {
					java.lang.String result = (java.lang.String) SmARTextEObjectUtil.invokeOperation(element, o);
	...
	private java.lang.String getName(ReferenceType element) {
		...
		if(element.eIsProxy()) {
			...
			if (fragment != null && fragment.startsWith(ISmARTextContextDependentURIFragment.INTERNAL_URI_FRAGMENT_PREFIX)) {
				fragment = fragment.substring(ISmARTextContextDependentURIFragment.INTERNAL_URI_FRAGMENT_PREFIX.length());
