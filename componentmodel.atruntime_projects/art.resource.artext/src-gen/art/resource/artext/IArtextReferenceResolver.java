 ...
 * resolver
 */
public interface IArtextReferenceResolver<ContainerType extends org.eclipse.emf.ecore.EObject, ReferenceType extends org.eclipse.emf.ecore.EObject> extends art.resource.artext.IArtextConfigurable {
	 ...
	 * operation.
	 */
	public void resolve(String identifier, ContainerType container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, art.resource.artext.IArtextReferenceResolveResult<ReferenceType> result);
