...
public class ArtextEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider {
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
				...
				art.resource.artext.mopp.ArtextPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
		...
		if (loadedResource == null) {
			try {
				...
				if (demandLoadedResource instanceof art.resource.artext.IArtextTextResource) {
					...
					art.resource.artext.mopp.ArtextPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the ArtextEditor.");
					//close this editor because it can not present the resource
					close(false);
				}
			} catch (java.lang.Exception e) {
				art.resource.artext.mopp.ArtextPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			art.resource.artext.mopp.ArtextPlugin.logError("java.lang.Exception in setCaret()", e);
		}
	}
			...
			display.asyncExec(new java.lang.Runnable() {
				public void run() {
					try {
						...
						art.resource.artext.mopp.ArtextPlugin.logError("Exception while updating markers on resource", e);
					}
				}
			});
		}
