...
public class ArtextCodeFoldingManager {
	...
	private java.io.File getCodeFoldingStateFile(String uriString) {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(art.resource.artext.mopp.ArtextPlugin.PLUGIN_ID);
	...
	private String makeMD5(String text) {
		...
		try {
			...
			art.resource.artext.mopp.ArtextPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
		}
		String swap = "";
		String byteStr = "";
