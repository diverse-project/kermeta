...
public class AbstractArtextInterpreter<ResultType, ContextType> {
	...
	public ResultType interprete(org.eclipse.emf.ecore.EObject object, ContextType context) {
		...
		if (object instanceof art.AspectModelElement) {
			result = interprete_art_AspectModelElement((art.AspectModelElement) object, context);
		}
		if (result != null) {
			return result;
		}
	...
	public ResultType interprete_art_AspectModelElement(art.AspectModelElement object, ContextType context) {
		return null;
	}
