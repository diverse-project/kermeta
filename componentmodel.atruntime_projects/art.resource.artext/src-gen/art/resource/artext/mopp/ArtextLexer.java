...
public class ArtextLexer extends Lexer {
        ...
        try {
            ...
            switch (alt10) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // Artext.g:6340:12: ( ( '0' .. '9' )+ )
                    {
                    // Artext.g:6340:12: ( ( '0' .. '9' )+ )
                    // Artext.g:6340:13: ( '0' .. '9' )+
                    {
                    // Artext.g:6340:13: ( '0' .. '9' )+
                    int cnt9=0;
                    loop9:
    ...
    public final void mTEXT() throws RecognitionException {
        try {
            int _type = TEXT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Artext.g:6342:5: ( ( 'A' .. 'Z' | 'a' .. 'z' | '_' ) ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | '_' | '-' )* ( '.' ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | '_' | '-' )+ )* )
            // Artext.g:6343:2: ( 'A' .. 'Z' | 'a' .. 'z' | '_' ) ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | '_' | '-' )* ( '.' ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | '_' | '-' )+ )*
            {
            ...
            // Artext.g:6343:30: ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | '_' | '-' )*
            loop11:
            do {
                int alt11=2;
            ...
            // Artext.g:6343:77: ( '.' ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | '_' | '-' )+ )*
            loop13:
            do {
                int alt13=2;
                ...
                switch (alt13) {
            	case 1 :
            	    // Artext.g:6343:78: '.' ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | '_' | '-' )+
            	    {
            	    match('.'); 
            	    // Artext.g:6343:81: ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | '_' | '-' )+
            	    int cnt12=0;
            	    loop12:
            	    do {
            	        int alt12=2;
