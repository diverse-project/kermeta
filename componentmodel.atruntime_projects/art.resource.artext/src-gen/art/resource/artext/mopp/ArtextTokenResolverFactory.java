...
public class ArtextTokenResolverFactory implements art.resource.artext.IArtextTokenResolverFactory {
	...
	public ArtextTokenResolverFactory() {
		tokenName2TokenResolver = new java.util.HashMap<java.lang.String, art.resource.artext.IArtextTokenResolver>();
		featureName2CollectInTokenResolver = new java.util.HashMap<java.lang.String, art.resource.artext.IArtextTokenResolver>();
		...
		registerTokenResolver("T_OPTIONAL", new art.resource.artext.analysis.ArtextT_OPTIONALTokenResolver());
