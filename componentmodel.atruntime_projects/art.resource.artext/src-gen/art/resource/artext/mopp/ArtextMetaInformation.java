...
public class ArtextMetaInformation implements art.resource.artext.IArtextMetaInformation {
	...
	public art.resource.artext.IArtextTextPrinter createPrinter(java.io.OutputStream outputStream, art.resource.artext.IArtextTextResource resource) {
		return new art.resource.artext.mopp.ArtextPrinter(outputStream, resource);
	}
	...
	public art.resource.artext.IArtextHoverTextProvider getHoverTextProvider() {
		return new art.resource.artext.mopp.ArtextHoverTextProvider();
	}
	...
	public org.eclipse.jface.text.rules.ITokenScanner createTokenScanner(art.resource.artext.ui.ArtextColorManager colorManager) {
	...
	public art.resource.artext.mopp.ArtextCodeCompletionHelper createCodeCompletionHelper() {
		return new art.resource.artext.mopp.ArtextCodeCompletionHelper();
	}
