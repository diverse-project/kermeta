...
public class ArtextPrinter implements art.resource.artext.IArtextTextPrinter {
	...
	public void print_art_distrib_Node(art.distrib.Node element, java.lang.String outertab, java.io.PrintWriter out) {
		java.lang.String localtab = outertab;
		// The printCountingMap contains a mapping from feature names to the number of
		// remaining elements that still need to be printed. The map is initialized with
		// the number of elements stored in each structural feature. For lists this is the
		...
		if (count > 0) {
			...
			if (o != null) {
				art.resource.artext.IArtextTokenResolver resolver = tokenResolverFactory.createTokenResolver("TEXT");
				resolver.setOptions(getOptions());
				out.print(resolver.deResolve((java.lang.Object) o, element.eClass().getEStructuralFeature(art.distrib.DistribPackage.NODE__NAME), element));
			}
			printCountingMap.put("name", count - 1);
		}
		// DEFINITION PART BEGINS (CompoundDefinition)
	...
	public void print_art_distrib_Node_0(art.distrib.Node element, java.lang.String outertab, java.io.PrintWriter out, java.util.Map<java.lang.String, java.lang.Integer> printCountingMap){
		int count;
		// DEFINITION PART BEGINS (CsString)
		out.print("uri");
		// DEFINITION PART BEGINS (WhiteSpaces)
		...
		if (count > 0) {
			...
			if (o != null) {
				...
				resolver.setOptions(getOptions());
				out.print(resolver.deResolve((java.lang.Object) o, element.eClass().getEStructuralFeature(art.distrib.DistribPackage.NODE__URI), element));
			}
	...
	public void print_art_type_Port_0(art.type.Port element, java.lang.String outertab, java.io.PrintWriter out, java.util.Map<java.lang.String, java.lang.Integer> printCountingMap){
		...
		if (count > 0) {
			...
			if (o != null) {
				art.resource.artext.IArtextTokenResolver resolver = tokenResolverFactory.createTokenResolver("STRING_LITERAL");
				resolver.setOptions(getOptions());
				out.print(resolver.deResolve((java.lang.Object) o, element.eClass().getEStructuralFeature(art.type.TypePackage.PORT__PROTOCOL), element));
			}
	...
	public void print_art_type_Port_1(art.type.Port element, java.lang.String outertab, java.io.PrintWriter out, java.util.Map<java.lang.String, java.lang.Integer> printCountingMap){
		...
		if (count > 0) {
			...
			if (o != null) {
				art.resource.artext.IArtextTokenResolver resolver = tokenResolverFactory.createTokenResolver("STRING_LITERAL");
				resolver.setOptions(getOptions());
				out.print(resolver.deResolve((java.lang.Object) o, element.eClass().getEStructuralFeature(art.type.TypePackage.PORT__URI), element));
			}
			printCountingMap.put("uri", count - 1);
		}
	}
