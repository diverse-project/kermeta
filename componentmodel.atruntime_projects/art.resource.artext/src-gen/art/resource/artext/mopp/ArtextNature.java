...
public class ArtextNature implements org.eclipse.core.resources.IProjectNature {
	
	public static final String NATURE_ID = "art.resource.artext.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {art.resource.artext.mopp.ArtextBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(art.resource.artext.mopp.ArtextBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
