...
/**
 * This is the item provider adapter for a {@link org.smartadapters.core.cloneAdaptation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class cloneAdaptationItemProvider
	 ...
	 * @generated
	 */
	public cloneAdaptationItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		uniqueType labelValue = ((cloneAdaptation)object).getIsUnique();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_cloneAdaptation_type") :
			getString("_UI_cloneAdaptation_type") + " " + label;
	}
