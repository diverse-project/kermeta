...
/**
 * This is the item provider adapter for a {@link art_relaxed.instance_relaxed.Binding} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Binding_serverInstance_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Binding_serverInstance_feature", "_UI_Binding_type"),
				 Instance_relaxedPackage.Literals.BINDING__SERVER_INSTANCE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Instance_relaxedPackage.Literals.BINDING__ID,
				 true,
				 false,
				 false,
