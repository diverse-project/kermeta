...
/**
 * This is the item provider adapter for a {@link art_relaxed.instance_relaxed.DelegationBinding} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Instance_relaxedPackage.Literals.DELEGATION_BINDING__SOURCE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Instance_relaxedPackage.Literals.DELEGATION_BINDING__EXPORTED,
				 true,
				 false,
				 true,
				 null,
