...
/**
 * This is the item provider adapter for a {@link art_relaxed.type_relaxed.ComponentType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ComponentTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Type_relaxedPackage.Literals.COMPONENT_TYPE__GROUPS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Type_relaxedPackage.Literals.COMPONENT_TYPE__PORT);
			childrenFeatures.add(Type_relaxedPackage.Literals.COMPONENT_TYPE__ATTRIBUTE);
			childrenFeatures.add(Type_relaxedPackage.Literals.COMPONENT_TYPE__IMPLEM);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Type_relaxedPackage.Literals.COMPONENT_TYPE__PORT,
		...
		newChildDescriptors.add
			(createChildParameter
				(Type_relaxedPackage.Literals.COMPONENT_TYPE__ATTRIBUTE,
		...
		newChildDescriptors.add
			(createChildParameter
				(Type_relaxedPackage.Literals.COMPONENT_TYPE__IMPLEM,
