...
/**
 * This is the item provider adapter for a {@link art_relaxed.type_relaxed.Service} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ServiceItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Type_relaxedPackage.Literals.SERVICE__OPERATION);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Service.class)) {
			case Type_relaxedPackage.SERVICE__OPERATION:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Type_relaxedPackage.Literals.SERVICE__OPERATION,
