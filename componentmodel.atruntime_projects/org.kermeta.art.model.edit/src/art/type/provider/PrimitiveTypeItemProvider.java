...
/**
 * This is the item provider adapter for a {@link art.type.PrimitiveType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PrimitiveTypeItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TypePackage.Literals.PRIMITIVE_TYPE__BINDING);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PrimitiveType.class)) {
			case TypePackage.PRIMITIVE_TYPE__BINDING:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TypePackage.Literals.PRIMITIVE_TYPE__BINDING,
