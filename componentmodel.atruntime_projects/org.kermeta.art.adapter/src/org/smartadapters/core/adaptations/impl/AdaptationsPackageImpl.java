...
public class AdaptationsPackageImpl extends EPackageImpl implements AdaptationsPackage {
	...
	public void initializePackageContents() {
		...
		initEReference(getSetruntimeinstanceTransmissionBinding_Refclient(), theTypePackage.getAbstractPort(), null, "refclient", null, 0, 1, SetruntimeinstanceTransmissionBinding.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSetruntimeinstanceTransmissionBinding_Refserver(), theTypePackage.getAbstractPort(), null, "refserver", null, 0, 1, SetruntimeinstanceTransmissionBinding.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
