...
public interface AdaptationsPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int SETRUNTIMEINSTANCE_COMPONENT_INSTANCE__REFNAME = CorePackage.SET_ADAPTATION_FEATURE_COUNT + 6;
	 ...
	 * @ordered
	 */
	int SETRUNTIMEINSTANCE_COMPONENT_INSTANCE_FEATURE_COUNT = CorePackage.SET_ADAPTATION_FEATURE_COUNT + 7;
	 ...
	 * @ordered
	 */
	int SETRUNTIMEINSTANCE_PRIMITIVE_INSTANCE__REFNAME = CorePackage.SET_ADAPTATION_FEATURE_COUNT + 6;
	 ...
	 * @ordered
	 */
	int SETRUNTIMEINSTANCE_PRIMITIVE_INSTANCE_FEATURE_COUNT = CorePackage.SET_ADAPTATION_FEATURE_COUNT + 7;
	 ...
	 * @ordered
	 */
	int SETRUNTIMEINSTANCE_COMPOSITE_INSTANCE__REFNAME = CorePackage.SET_ADAPTATION_FEATURE_COUNT + 8;
	 ...
	 * @ordered
	 */
	int SETRUNTIMEINSTANCE_COMPOSITE_INSTANCE_FEATURE_COUNT = CorePackage.SET_ADAPTATION_FEATURE_COUNT + 9;
