...
public class KomposePropertyTesterJava
{
  ...
  protected final String TEXT_3 = "\";" + NL + "\t" + NL + "\tpublic boolean test(Object receiver, String property, Object[] args," + NL + "\t\t\tObject expectedValue) {" + NL + "\t\tIFile komposeModel = (IFile) receiver;" + NL + "\t\tBufferedReader br = null;" + NL + "\t\tString composerDefinition = \"\";" + NL + "\t\tString composerMetamodel = \"\";" + NL + "\t\ttry {" + NL + "\t\t\tbr = new BufferedReader(new InputStreamReader(komposeModel.getContents()));" + NL + "\t\t\tbr.readLine();" + NL + "\t\t\tcomposerDefinition = br.readLine();" + NL + "\t\t\tString[] chunks = composerDefinition.split(\" \");" + NL + "\t\t\tfor (int i = 0; i < chunks.length; i++) {" + NL + "\t\t\t\tif (chunks[i].startsWith(\"metamodel\")){" + NL + "\t\t\t\t\tcomposerMetamodel = chunks[i].substring(chunks[i].indexOf(\"=\")+2, chunks[i].lastIndexOf(\"\\\"\"));" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t} catch (CoreException e) {" + NL + "\t\t\tSystem.out.println(\"KOMPOSE-ERROR: Impossible to open selected file\");" + NL + "\t\t\te.printStackTrace();" + NL + "\t\t} catch (IOException e) {" + NL + "\t\t\tSystem.out.println(\"KOMPOSE-ERROR: Impossible to read selected file\");" + NL + "\t\t\te.printStackTrace();" + NL + "\t\t}" + NL + "\t\tif (composerMetamodel.equals(METAMODEL))" + NL + "\t\t\treturn true;" + NL + "\t\telse" + NL + "\t\t\treturn false;" + NL + "\t}" + NL + "}";
