...
public class KomposePropertyTesterJava
{
  ...
  protected final String TEXT_3 = "\";" + NL + "\t" + NL + "\t@Override" + NL + "\tpublic boolean test(Object receiver, String property, Object[] args," + NL + "\t\t\tObject expectedValue) {" + NL + "\t\tIFile komposeModel = (IFile) receiver;" + NL + "\t\tBufferedReader br = null;" + NL + "\t\tString composerDefinition = \"\";" + NL + "\t\tString composerMetamodel = \"\";" + NL + "\t\tString composerMetamodelTmp = \"\";" + NL + "\t\ttry {" + NL + "\t\t\tbr = new BufferedReader(new InputStreamReader(komposeModel.getContents()));" + NL + "\t\t\tbr.readLine();" + NL + "\t\t\tcomposerDefinition = br.readLine();" + NL + "\t\t\tcomposerMetamodelTmp = composerDefinition.substring(composerDefinition.indexOf(\"metamodelName\"), composerDefinition.indexOf(\">\"));" + NL + "\t\t\tcomposerMetamodel = composerMetamodel.substring(composerMetamodelTmp.indexOf(\"=\")+2, composerMetamodelTmp.length()-1);" + NL + "\t\t} catch (CoreException e) {" + NL + "\t\t\tSystem.out.println(\"KOMPOSE-ERROR: Impossible to open selected file\");" + NL + "\t\t\te.printStackTrace();" + NL + "\t\t} catch (IOException e) {" + NL + "\t\t\tSystem.out.println(\"KOMPOSE-ERROR: Impossible to read selected file\");" + NL + "\t\t\te.printStackTrace();" + NL + "\t\t}" + NL + "\t\tif (composerMetamodel.equals(METAMODEL))" + NL + "\t\t\treturn true;" + NL + "\t\telse" + NL + "\t\t\treturn false;" + NL + "\t}" + NL + "}";
