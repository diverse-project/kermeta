 ...
 * 
 */
package org.kermeta.kompose.specialization.art.popup.action;
...
public class Composer implements IObjectActionDelegate, Runnable {
	...
	public void run() {
		...
		try {	
			String spath="platform:/plugin/org.kermeta.kompose.specialization.art/kermeta/artComposer.kmt";
			...
			interpreter.setEntryPoint("art::Main", "main");
