...
/*$Id: MergeEcoreWizard.java,v 1.1.1.1 2008-11-17 15:44:02 mclavreu Exp $
		...
		UIJob job = new UIJob("Komposing Ecore") {
			...
			public IStatus runInUIThread(IProgressMonitor monitor) {
				...
				try {
					...
					Interpreter interpreter = new Interpreter("platform:/plugin/org.kermeta.kompose.ui.experimental.ecore/src/org/kermeta/kompose/ui/experimental/ecore/Ecore2.km", InterpreterMode.RUN, options);
