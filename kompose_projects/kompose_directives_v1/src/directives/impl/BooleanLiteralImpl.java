 ...
 * <ul>
 *   <li>{@link directives.impl.BooleanLiteralImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BooleanLiteralImpl extends LiteralImpl implements BooleanLiteral {
	...
	protected EClass eStaticClass() {
		return DirectivesPackage.Literals.BOOLEAN_LITERAL;
	}
	...
	public void setValue(Boolean newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DirectivesPackage.BOOLEAN_LITERAL__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DirectivesPackage.BOOLEAN_LITERAL__VALUE:
				return getValue();
		}
