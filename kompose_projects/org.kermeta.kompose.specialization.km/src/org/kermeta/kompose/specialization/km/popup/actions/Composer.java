package org.kermeta.kompose.specialization.km.popup.actions;
...
public class Composer implements IObjectActionDelegate, Runnable {
	...
	public void run() {
		System.out.println("Run Kompose KM");
		try {
			String spath="platform:/plugin/org.kermeta.kompose.specialization.km/kermeta/KmComposer.kmt";
			...
			interpreter.setEntryPoint("kermeta::language::structure::Main", "main");
