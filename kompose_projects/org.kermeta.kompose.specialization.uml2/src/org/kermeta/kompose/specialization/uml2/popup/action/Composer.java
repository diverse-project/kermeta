 ...
 * 
 */
package org.kermeta.kompose.specialization.uml2.popup.action;
...
public class Composer implements IObjectActionDelegate, Runnable {
	...
	public void run() {
		...
		try {	
			String spath="platform:/plugin/org.kermeta.kompose.specialization.uml2/kermeta/umlComposer.kmt";
			...
			interpreter.setEntryPoint("uml::Main", "main");
