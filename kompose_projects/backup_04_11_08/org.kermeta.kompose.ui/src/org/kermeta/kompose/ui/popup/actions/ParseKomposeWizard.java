...
import kompose.parser.DirectiveLexer;
import kompose.parser.DirectiveParser;
...
public class ParseKomposeWizard extends Wizard {
	...
	public boolean performFinish() {
		...
		try {
			DirectiveLexer lexer = new DirectiveLexer(inputFile.getContents());
			...
			if (parser.errors.isEmpty()) {
				...
				for(String msg : parser.errors) KomposeConsole.printlnMessage( msg, KomposeConsole.ERROR);
			}
