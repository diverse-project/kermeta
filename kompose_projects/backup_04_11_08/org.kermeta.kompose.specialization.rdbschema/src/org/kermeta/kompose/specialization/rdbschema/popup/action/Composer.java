 ...
 * 
 */
package org.kermeta.kompose.specialization.rdbschema.popup.action;
	...
	public void run() {
		...
		System.out.println("Run Kompose Ecore");
			...
			try {
				...
				String spath="platform:/plugin/org.kermeta.kompose.specialization.rdbschema/kermeta/rdbschemaComposer.kmt";
				...
				interpreter.setEntryPoint("rdbschema::Main", "main");
