 ...
 * 
 */
package org.kermeta.kompose.specialization.fm.popup.action;
...
public class Composer implements IObjectActionDelegate, Runnable {
	...
	public void selectionChanged(IAction action, ISelection selection) {
		...
		{
			// the selection should be a single *.kompose file
	...
	public void run() {
		...
		try {	
			String spath="platform:/plugin/org.kermeta.kompose.specialization.fm/kermeta/FMComposer.kmt";
			...
			interpreter.setEntryPoint("featureDiagram::Main", "main");
