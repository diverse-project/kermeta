		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AdaptationBinding_target_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AdaptationBinding_target_feature", "_UI_AdaptationBinding_type"),
				 StructurePackage.Literals.ADAPTATION_BINDING__TARGET,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addSourcePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AdaptationBinding_source_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AdaptationBinding_source_feature", "_UI_AdaptationBinding_type"),
				 StructurePackage.Literals.ADAPTATION_BINDING__SOURCE,
				 true,
				 false,
				 true,
				 null,
