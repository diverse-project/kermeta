...
/**
 * This is the item provider adapter for a {@link org.kermeta.language.behavior.CallVariable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CallVariableItemProvider
	 ...
	 * @generated
	 */
	public CallVariableItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((CallVariable)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_CallVariable_type") :
			getString("_UI_CallVariable_type") + " " + label;
	}
