 ...
 * 
 */
public interface ProductTypePropertiesEditionPart {
	...
	/**
	 * Init the type
	 * @param settings settings for the type ReferencesTable 
	 */
	public void initType(ReferencesTableSettings settings);

	/**
	 * Update the type
	 * @param newValue the type to update
	 * 
	 */
	...
	/**
	 * @return true if the given element is contained inside the type table
	 * 
	 */
