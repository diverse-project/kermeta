 ...
 * 
 */
public interface UnresolvedCallPropertiesEditionPart {
	...
	/**
	 * Init the targetParent
	 * @param settings the combo setting
	 */
	public void initTargetParent(EObjectFlatComboSettings settings);

	/**
	 * Defines a new targetParent
	 * @param newValue the new targetParent to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the targetParent edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return the isCalledWithParenthesis
	 * 
	 */
	public Boolean getIsCalledWithParenthesis();

	/**
	 * Defines a new isCalledWithParenthesis
	 * @param newValue the new isCalledWithParenthesis to set
	 * 
	 */
