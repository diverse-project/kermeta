 ...
 * 
 */
public interface CallPropertyPropertiesEditionPart {
	...
	/**
	 * Defines a new isAtpre
	 * @param newValue the new isAtpre to set
	 * 
	 */
	...
	/**
	 * Init the staticProperty
	 * @param settings the combo setting
	 */
	public void initStaticProperty(EObjectFlatComboSettings settings);

	/**
	 * Defines a new staticProperty
	 * @param newValue the new staticProperty to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the staticProperty edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
