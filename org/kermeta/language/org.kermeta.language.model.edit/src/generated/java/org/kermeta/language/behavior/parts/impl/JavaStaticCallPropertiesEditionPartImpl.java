 ...
 * 
 */
public class JavaStaticCallPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, JavaStaticCallPropertiesEditionPart {
	 ...
	 * 
	 */
	public JavaStaticCallPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(BehaviorMessages.JavaStaticCallPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createKTagAdvancedReferencesTable(Composite parent) {
		...
		this.kTag.setHelpText(propertiesEditionComponent.getHelpContent(BehaviorViewsRepository.JavaStaticCall.Properties.kTag, BehaviorViewsRepository.SWT_KIND));
		this.kTag.createControls(parent);
		this.kTag.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(JavaStaticCallPropertiesEditionPartImpl.this, BehaviorViewsRepository.JavaStaticCall.Properties.kTag, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"kTag", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(JavaStaticCallPropertiesEditionPartImpl.this, BehaviorViewsRepository.JavaStaticCall.Properties.kTag,
	...
	protected void moveKTag(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(JavaStaticCallPropertiesEditionPartImpl.this, BehaviorViewsRepository.JavaStaticCall.Properties.kTag, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		kTag.refresh();
	}
	...
	protected void removeFromKTag(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(JavaStaticCallPropertiesEditionPartImpl.this, BehaviorViewsRepository.JavaStaticCall.Properties.kTag, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		kTag.refresh();
	}
	...
	protected Composite createKTypeFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, BehaviorMessages.JavaStaticCallPropertiesEditionPart_KTypeLabel, propertiesEditionComponent.isRequired(BehaviorViewsRepository.JavaStaticCall.Properties.kType, BehaviorViewsRepository.SWT_KIND));
		kType = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(BehaviorViewsRepository.JavaStaticCall.Properties.kType, BehaviorViewsRepository.SWT_KIND));
		...
		kType.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(JavaStaticCallPropertiesEditionPartImpl.this, BehaviorViewsRepository.JavaStaticCall.Properties.kType, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getKType()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(BehaviorViewsRepository.JavaStaticCall.Properties.kType, BehaviorViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createStaticTypeFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, BehaviorMessages.JavaStaticCallPropertiesEditionPart_StaticTypeLabel, propertiesEditionComponent.isRequired(BehaviorViewsRepository.JavaStaticCall.Properties.staticType, BehaviorViewsRepository.SWT_KIND));
		staticType = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(BehaviorViewsRepository.JavaStaticCall.Properties.staticType, BehaviorViewsRepository.SWT_KIND));
		...
		staticType.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(JavaStaticCallPropertiesEditionPartImpl.this, BehaviorViewsRepository.JavaStaticCall.Properties.staticType, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getStaticType()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(BehaviorViewsRepository.JavaStaticCall.Properties.staticType, BehaviorViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createJclassText(Composite parent) {
		SWTUtils.createPartLabel(parent, BehaviorMessages.JavaStaticCallPropertiesEditionPart_JclassLabel, propertiesEditionComponent.isRequired(BehaviorViewsRepository.JavaStaticCall.Properties.jclass, BehaviorViewsRepository.SWT_KIND));
		jclass = new Text(parent, SWT.BORDER);
		...
		jclass.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(JavaStaticCallPropertiesEditionPartImpl.this, BehaviorViewsRepository.JavaStaticCall.Properties.jclass, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, jclass.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(BehaviorViewsRepository.JavaStaticCall.Properties.jclass, BehaviorViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createJmethodText(Composite parent) {
		SWTUtils.createPartLabel(parent, BehaviorMessages.JavaStaticCallPropertiesEditionPart_JmethodLabel, propertiesEditionComponent.isRequired(BehaviorViewsRepository.JavaStaticCall.Properties.jmethod, BehaviorViewsRepository.SWT_KIND));
		jmethod = new Text(parent, SWT.BORDER);
		...
		jmethod.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(JavaStaticCallPropertiesEditionPartImpl.this, BehaviorViewsRepository.JavaStaticCall.Properties.jmethod, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, jmethod.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(BehaviorViewsRepository.JavaStaticCall.Properties.jmethod, BehaviorViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
