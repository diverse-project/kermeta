 ...
 * 
 */
public class TypeVariableBindingPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, TypeVariableBindingPropertiesEditionPart {
	 ...
	 * 
	 */
	public TypeVariableBindingPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(StructureMessages.TypeVariableBindingPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createKTagAdvancedReferencesTable(Composite parent) {
		...
		this.kTag.setHelpText(propertiesEditionComponent.getHelpContent(StructureViewsRepository.TypeVariableBinding.Properties.kTag, StructureViewsRepository.SWT_KIND));
		this.kTag.createControls(parent);
		this.kTag.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TypeVariableBindingPropertiesEditionPartImpl.this, StructureViewsRepository.TypeVariableBinding.Properties.kTag, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"kTag", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TypeVariableBindingPropertiesEditionPartImpl.this, StructureViewsRepository.TypeVariableBinding.Properties.kTag,
	...
	protected void moveKTag(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TypeVariableBindingPropertiesEditionPartImpl.this, StructureViewsRepository.TypeVariableBinding.Properties.kTag, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		kTag.refresh();
	}
	...
	protected void removeFromKTag(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TypeVariableBindingPropertiesEditionPartImpl.this, StructureViewsRepository.TypeVariableBinding.Properties.kTag, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		kTag.refresh();
	}
	...
	protected Composite createKTypeFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, StructureMessages.TypeVariableBindingPropertiesEditionPart_KTypeLabel, propertiesEditionComponent.isRequired(StructureViewsRepository.TypeVariableBinding.Properties.kType, StructureViewsRepository.SWT_KIND));
		kType = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(StructureViewsRepository.TypeVariableBinding.Properties.kType, StructureViewsRepository.SWT_KIND));
		...
		kType.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TypeVariableBindingPropertiesEditionPartImpl.this, StructureViewsRepository.TypeVariableBinding.Properties.kType, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getKType()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(StructureViewsRepository.TypeVariableBinding.Properties.kType, StructureViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createVariableFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, StructureMessages.TypeVariableBindingPropertiesEditionPart_VariableLabel, propertiesEditionComponent.isRequired(StructureViewsRepository.TypeVariableBinding.Properties.variable, StructureViewsRepository.SWT_KIND));
		variable = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(StructureViewsRepository.TypeVariableBinding.Properties.variable, StructureViewsRepository.SWT_KIND));
		...
		variable.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TypeVariableBindingPropertiesEditionPartImpl.this, StructureViewsRepository.TypeVariableBinding.Properties.variable, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getVariable()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(StructureViewsRepository.TypeVariableBinding.Properties.variable, StructureViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createTypeFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, StructureMessages.TypeVariableBindingPropertiesEditionPart_TypeLabel, propertiesEditionComponent.isRequired(StructureViewsRepository.TypeVariableBinding.Properties.type, StructureViewsRepository.SWT_KIND));
		type = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(StructureViewsRepository.TypeVariableBinding.Properties.type, StructureViewsRepository.SWT_KIND));
		type.setLabelProvider(new AdapterFactoryLabelProvider(adapterFactory));

		type.addSelectionChangedListener(new ISelectionChangedListener() {

			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TypeVariableBindingPropertiesEditionPartImpl.this, StructureViewsRepository.TypeVariableBinding.Properties.type, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getType()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(StructureViewsRepository.TypeVariableBinding.Properties.type, StructureViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
