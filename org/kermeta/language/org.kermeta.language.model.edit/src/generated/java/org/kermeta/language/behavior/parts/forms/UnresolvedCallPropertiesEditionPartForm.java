 ...
 * 
 */
public class UnresolvedCallPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, UnresolvedCallPropertiesEditionPart {
	 ...
	 * 
	 */
	public UnresolvedCallPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
		...
		composer = new PartComposer(unresolvedCallStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == BehaviorViewsRepository.UnresolvedCall.Properties.targetParent) {
					return createTargetParentFlatComboViewer(parent, widgetFactory);
				}
				...
				if (key == BehaviorViewsRepository.UnresolvedCall.Properties.isCalledWithParenthesis) {
					return createIsCalledWithParenthesisCheckbox(widgetFactory, parent);
				}
				return parent;
			}
		};
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(BehaviorMessages.UnresolvedCallPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createKTagReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.kTag.setHelpText(propertiesEditionComponent.getHelpContent(BehaviorViewsRepository.UnresolvedCall.Properties.kTag, BehaviorViewsRepository.FORM_KIND));
		this.kTag.createControls(parent, widgetFactory);
		this.kTag.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(UnresolvedCallPropertiesEditionPartForm.this, BehaviorViewsRepository.UnresolvedCall.Properties.kTag, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"kTag", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(UnresolvedCallPropertiesEditionPartForm.this, BehaviorViewsRepository.UnresolvedCall.Properties.kTag,
	...
	protected void moveKTag(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(UnresolvedCallPropertiesEditionPartForm.this, BehaviorViewsRepository.UnresolvedCall.Properties.kTag, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		kTag.refresh();
	}
	...
	protected void removeFromKTag(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(UnresolvedCallPropertiesEditionPartForm.this, BehaviorViewsRepository.UnresolvedCall.Properties.kTag, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		kTag.refresh();
	}
	...
	protected Composite createKTypeFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, BehaviorMessages.UnresolvedCallPropertiesEditionPart_KTypeLabel, propertiesEditionComponent.isRequired(BehaviorViewsRepository.UnresolvedCall.Properties.kType, BehaviorViewsRepository.FORM_KIND));
		kType = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(BehaviorViewsRepository.UnresolvedCall.Properties.kType, BehaviorViewsRepository.FORM_KIND));
		...
		kType.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(UnresolvedCallPropertiesEditionPartForm.this, BehaviorViewsRepository.UnresolvedCall.Properties.kType, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getKType()));
			}

		});
		kType.setID(BehaviorViewsRepository.UnresolvedCall.Properties.kType);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(BehaviorViewsRepository.UnresolvedCall.Properties.kType, BehaviorViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createStaticTypeFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, BehaviorMessages.UnresolvedCallPropertiesEditionPart_StaticTypeLabel, propertiesEditionComponent.isRequired(BehaviorViewsRepository.UnresolvedCall.Properties.staticType, BehaviorViewsRepository.FORM_KIND));
		staticType = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(BehaviorViewsRepository.UnresolvedCall.Properties.staticType, BehaviorViewsRepository.FORM_KIND));
		...
		staticType.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(UnresolvedCallPropertiesEditionPartForm.this, BehaviorViewsRepository.UnresolvedCall.Properties.staticType, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getStaticType()));
			}

		});
		staticType.setID(BehaviorViewsRepository.UnresolvedCall.Properties.staticType);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(BehaviorViewsRepository.UnresolvedCall.Properties.staticType, BehaviorViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, BehaviorMessages.UnresolvedCallPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(BehaviorViewsRepository.UnresolvedCall.Properties.name, BehaviorViewsRepository.FORM_KIND));
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(UnresolvedCallPropertiesEditionPartForm.this, BehaviorViewsRepository.UnresolvedCall.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(BehaviorViewsRepository.UnresolvedCall.Properties.name, BehaviorViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createStaticTypeVariableBindingsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.staticTypeVariableBindings.setHelpText(propertiesEditionComponent.getHelpContent(BehaviorViewsRepository.UnresolvedCall.Properties.staticTypeVariableBindings, BehaviorViewsRepository.FORM_KIND));
		...
		this.staticTypeVariableBindings.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(UnresolvedCallPropertiesEditionPartForm.this, BehaviorViewsRepository.UnresolvedCall.Properties.staticTypeVariableBindings, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addStaticTypeVariableBindings() {
		...
		"staticTypeVariableBindings", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(UnresolvedCallPropertiesEditionPartForm.this, BehaviorViewsRepository.UnresolvedCall.Properties.staticTypeVariableBindings,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveStaticTypeVariableBindings(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(UnresolvedCallPropertiesEditionPartForm.this, BehaviorViewsRepository.UnresolvedCall.Properties.staticTypeVariableBindings, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		staticTypeVariableBindings.refresh();
	}
	...
	protected void removeFromStaticTypeVariableBindings(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(UnresolvedCallPropertiesEditionPartForm.this, BehaviorViewsRepository.UnresolvedCall.Properties.staticTypeVariableBindings, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		staticTypeVariableBindings.refresh();
	}
	...
	protected Composite createIsAtpreCheckbox(FormToolkit widgetFactory, Composite parent) {
		isAtpre = widgetFactory.createButton(parent, BehaviorMessages.UnresolvedCallPropertiesEditionPart_IsAtpreLabel, SWT.CHECK);
		isAtpre.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(UnresolvedCallPropertiesEditionPartForm.this, BehaviorViewsRepository.UnresolvedCall.Properties.isAtpre, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(isAtpre.getSelection())));
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(BehaviorViewsRepository.UnresolvedCall.Properties.isAtpre, BehaviorViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	 ...
	 * 
	 */
	protected Composite createTargetParentFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, BehaviorMessages.UnresolvedCallPropertiesEditionPart_TargetParentLabel, propertiesEditionComponent.isRequired(BehaviorViewsRepository.UnresolvedCall.Properties.targetParent, BehaviorViewsRepository.FORM_KIND));
		targetParent = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(BehaviorViewsRepository.UnresolvedCall.Properties.targetParent, BehaviorViewsRepository.FORM_KIND));
		widgetFactory.adapt(targetParent);
		...
		targetParent.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(UnresolvedCallPropertiesEditionPartForm.this, BehaviorViewsRepository.UnresolvedCall.Properties.targetParent, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getTargetParent()));
			}

		});
		targetParent.setID(BehaviorViewsRepository.UnresolvedCall.Properties.targetParent);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(BehaviorViewsRepository.UnresolvedCall.Properties.targetParent, BehaviorViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createGenericsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.generics.setHelpText(propertiesEditionComponent.getHelpContent(BehaviorViewsRepository.UnresolvedCall.Properties.generics, BehaviorViewsRepository.FORM_KIND));
		this.generics.createControls(parent, widgetFactory);
		this.generics.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(UnresolvedCallPropertiesEditionPartForm.this, BehaviorViewsRepository.UnresolvedCall.Properties.generics, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addGenerics() {
		...
		"generics", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(UnresolvedCallPropertiesEditionPartForm.this, BehaviorViewsRepository.UnresolvedCall.Properties.generics,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
				generics.refresh();
			}
	...
	protected void moveGenerics(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(UnresolvedCallPropertiesEditionPartForm.this, BehaviorViewsRepository.UnresolvedCall.Properties.generics, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		generics.refresh();
	}
	...
	protected void removeFromGenerics(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(UnresolvedCallPropertiesEditionPartForm.this, BehaviorViewsRepository.UnresolvedCall.Properties.generics, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		generics.refresh();
	}
	...
	protected Composite createIsCalledWithParenthesisCheckbox(FormToolkit widgetFactory, Composite parent) {
		isCalledWithParenthesis = widgetFactory.createButton(parent, BehaviorMessages.UnresolvedCallPropertiesEditionPart_IsCalledWithParenthesisLabel, SWT.CHECK);
		isCalledWithParenthesis.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(UnresolvedCallPropertiesEditionPartForm.this, BehaviorViewsRepository.UnresolvedCall.Properties.isCalledWithParenthesis, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(isCalledWithParenthesis.getSelection())));
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(BehaviorViewsRepository.UnresolvedCall.Properties.isCalledWithParenthesis, BehaviorViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
