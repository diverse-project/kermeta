 ...
 * 
 */
public class CallValuePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public CallValuePropertiesEditionComponent(PropertiesEditingContext editingContext, EObject callValue, String editing_mode) {
		super(editingContext, callValue, editing_mode);
		parts = new String[] { BASE_PART };
		repositoryKey = BehaviorViewsRepository.class;
		partKey = BehaviorViewsRepository.CallValue.class;
	}
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			final CallValue callValue = (CallValue)elt;
			final CallValuePropertiesEditionPart basePart = (CallValuePropertiesEditionPart)editingPart;
			// init values
			if (isAccessible(BehaviorViewsRepository.CallValue.Properties.kTag)) {
				kTagSettings = new ReferencesTableSettings(callValue, StructurePackage.eINSTANCE.getKermetaModelElement_KTag());
				basePart.initKTag(kTagSettings);
			}
			if (isAccessible(BehaviorViewsRepository.CallValue.Properties.kType)) {
				// init part
				kTypeSettings = new EObjectFlatComboSettings(callValue, StructurePackage.eINSTANCE.getKermetaModelElement_KType());
				basePart.initKType(kTypeSettings);
				// set the button mode
				basePart.setKTypeButtonMode(ButtonsModeEnum.BROWSE);
			}
			if (isAccessible(BehaviorViewsRepository.CallValue.Properties.staticType)) {
				// init part
				staticTypeSettings = new EObjectFlatComboSettings(callValue, BehaviorPackage.eINSTANCE.getExpression_StaticType());
				basePart.initStaticType(staticTypeSettings);
				// set the button mode
				basePart.setStaticTypeButtonMode(ButtonsModeEnum.BROWSE);
			}
			if (callValue.getName() != null && isAccessible(BehaviorViewsRepository.CallValue.Properties.name))
				basePart.setName(EEFConverterUtil.convertToString(StructurePackage.eINSTANCE.getString(), callValue.getName()));
			
			if (isAccessible(BehaviorViewsRepository.CallValue.Properties.staticTypeVariableBindings)) {
				staticTypeVariableBindingsSettings = new ReferencesTableSettings(callValue, BehaviorPackage.eINSTANCE.getCallExpression_StaticTypeVariableBindings());
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		if (editorKey == BehaviorViewsRepository.CallValue.Properties.kTag) {
			return StructurePackage.eINSTANCE.getKermetaModelElement_KTag();
		}
		if (editorKey == BehaviorViewsRepository.CallValue.Properties.kType) {
			return StructurePackage.eINSTANCE.getKermetaModelElement_KType();
		}
		if (editorKey == BehaviorViewsRepository.CallValue.Properties.staticType) {
			return BehaviorPackage.eINSTANCE.getExpression_StaticType();
		}
		if (editorKey == BehaviorViewsRepository.CallValue.Properties.name) {
			return BehaviorPackage.eINSTANCE.getCallExpression_Name();
		}
		if (editorKey == BehaviorViewsRepository.CallValue.Properties.staticTypeVariableBindings) {
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		CallValue callValue = (CallValue)semanticObject;
		if (BehaviorViewsRepository.CallValue.Properties.kTag == event.getAffectedEditor()) {
		...
		if (BehaviorViewsRepository.CallValue.Properties.kType == event.getAffectedEditor()) {
		...
		if (BehaviorViewsRepository.CallValue.Properties.staticType == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.SET) {
		...
		if (BehaviorViewsRepository.CallValue.Properties.name == event.getAffectedEditor()) {
			callValue.setName((java.lang.String)EEFConverterUtil.createFromString(StructurePackage.eINSTANCE.getString(), (String)event.getNewValue()));
		}
		if (BehaviorViewsRepository.CallValue.Properties.staticTypeVariableBindings == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {
			CallValuePropertiesEditionPart basePart = (CallValuePropertiesEditionPart)editingPart;
			if (StructurePackage.eINSTANCE.getKermetaModelElement_KTag().equals(msg.getFeature())  && isAccessible(BehaviorViewsRepository.CallValue.Properties.kTag))
				basePart.updateKTag();
			if (StructurePackage.eINSTANCE.getKermetaModelElement_KType().equals(msg.getFeature()) && basePart != null && isAccessible(BehaviorViewsRepository.CallValue.Properties.kType))
				basePart.setKType((EObject)msg.getNewValue());
			if (BehaviorPackage.eINSTANCE.getExpression_StaticType().equals(msg.getFeature()) && basePart != null && isAccessible(BehaviorViewsRepository.CallValue.Properties.staticType))
				basePart.setStaticType((EObject)msg.getNewValue());
			if (BehaviorPackage.eINSTANCE.getCallExpression_Name().equals(msg.getFeature()) && basePart != null && isAccessible(BehaviorViewsRepository.CallValue.Properties.name)) {
			...
			if (BehaviorPackage.eINSTANCE.getCallExpression_StaticTypeVariableBindings().equals(msg.getFeature())  && isAccessible(BehaviorViewsRepository.CallValue.Properties.staticTypeVariableBindings))
	...
	public boolean isRequired(Object key, int kind) {
		return key == BehaviorViewsRepository.CallValue.Properties.kType;
	}
