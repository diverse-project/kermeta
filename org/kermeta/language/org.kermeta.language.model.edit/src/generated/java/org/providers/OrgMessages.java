 ...
 * 
 */
public class OrgMessages extends NLS {
	
	private static final String BUNDLE_NAME = "org.providers.orgMessages"; //$NON-NLS-1$
	...
	static {
		...
		NLS.initializeMessages(BUNDLE_NAME, OrgMessages.class);
	}
