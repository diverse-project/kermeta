 ...
 * 
 */
public class CallEnumLiteralPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, CallEnumLiteralPropertiesEditionPart {
	 ...
	 * 
	 */
	public CallEnumLiteralPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
		...
		composer = new PartComposer(callEnumLiteralStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == BehaviorViewsRepository.CallEnumLiteral.Properties.staticEnumLiteral) {
					return createStaticEnumLiteralFlatComboViewer(parent, widgetFactory);
				}
				return parent;
			}
		};
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(BehaviorMessages.CallEnumLiteralPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createKTagReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.kTag.setHelpText(propertiesEditionComponent.getHelpContent(BehaviorViewsRepository.CallEnumLiteral.Properties.kTag, BehaviorViewsRepository.FORM_KIND));
		this.kTag.createControls(parent, widgetFactory);
		this.kTag.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CallEnumLiteralPropertiesEditionPartForm.this, BehaviorViewsRepository.CallEnumLiteral.Properties.kTag, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"kTag", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CallEnumLiteralPropertiesEditionPartForm.this, BehaviorViewsRepository.CallEnumLiteral.Properties.kTag,
	...
	protected void moveKTag(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CallEnumLiteralPropertiesEditionPartForm.this, BehaviorViewsRepository.CallEnumLiteral.Properties.kTag, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		kTag.refresh();
	}
	...
	protected void removeFromKTag(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CallEnumLiteralPropertiesEditionPartForm.this, BehaviorViewsRepository.CallEnumLiteral.Properties.kTag, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		kTag.refresh();
	}
	...
	protected Composite createKTypeFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, BehaviorMessages.CallEnumLiteralPropertiesEditionPart_KTypeLabel, propertiesEditionComponent.isRequired(BehaviorViewsRepository.CallEnumLiteral.Properties.kType, BehaviorViewsRepository.FORM_KIND));
		kType = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(BehaviorViewsRepository.CallEnumLiteral.Properties.kType, BehaviorViewsRepository.FORM_KIND));
		...
		kType.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CallEnumLiteralPropertiesEditionPartForm.this, BehaviorViewsRepository.CallEnumLiteral.Properties.kType, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getKType()));
			}

		});
		kType.setID(BehaviorViewsRepository.CallEnumLiteral.Properties.kType);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(BehaviorViewsRepository.CallEnumLiteral.Properties.kType, BehaviorViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createStaticTypeFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, BehaviorMessages.CallEnumLiteralPropertiesEditionPart_StaticTypeLabel, propertiesEditionComponent.isRequired(BehaviorViewsRepository.CallEnumLiteral.Properties.staticType, BehaviorViewsRepository.FORM_KIND));
		staticType = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(BehaviorViewsRepository.CallEnumLiteral.Properties.staticType, BehaviorViewsRepository.FORM_KIND));
		...
		staticType.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CallEnumLiteralPropertiesEditionPartForm.this, BehaviorViewsRepository.CallEnumLiteral.Properties.staticType, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getStaticType()));
			}

		});
		staticType.setID(BehaviorViewsRepository.CallEnumLiteral.Properties.staticType);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(BehaviorViewsRepository.CallEnumLiteral.Properties.staticType, BehaviorViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, BehaviorMessages.CallEnumLiteralPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(BehaviorViewsRepository.CallEnumLiteral.Properties.name, BehaviorViewsRepository.FORM_KIND));
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CallEnumLiteralPropertiesEditionPartForm.this, BehaviorViewsRepository.CallEnumLiteral.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(BehaviorViewsRepository.CallEnumLiteral.Properties.name, BehaviorViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createStaticTypeVariableBindingsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.staticTypeVariableBindings.setHelpText(propertiesEditionComponent.getHelpContent(BehaviorViewsRepository.CallEnumLiteral.Properties.staticTypeVariableBindings, BehaviorViewsRepository.FORM_KIND));
		...
		this.staticTypeVariableBindings.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CallEnumLiteralPropertiesEditionPartForm.this, BehaviorViewsRepository.CallEnumLiteral.Properties.staticTypeVariableBindings, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addStaticTypeVariableBindings() {
		...
		"staticTypeVariableBindings", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CallEnumLiteralPropertiesEditionPartForm.this, BehaviorViewsRepository.CallEnumLiteral.Properties.staticTypeVariableBindings,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveStaticTypeVariableBindings(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CallEnumLiteralPropertiesEditionPartForm.this, BehaviorViewsRepository.CallEnumLiteral.Properties.staticTypeVariableBindings, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		staticTypeVariableBindings.refresh();
	}
	...
	protected void removeFromStaticTypeVariableBindings(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CallEnumLiteralPropertiesEditionPartForm.this, BehaviorViewsRepository.CallEnumLiteral.Properties.staticTypeVariableBindings, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		staticTypeVariableBindings.refresh();
	}
	 ...
	 * 
	 */
	protected Composite createStaticEnumLiteralFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, BehaviorMessages.CallEnumLiteralPropertiesEditionPart_StaticEnumLiteralLabel, propertiesEditionComponent.isRequired(BehaviorViewsRepository.CallEnumLiteral.Properties.staticEnumLiteral, BehaviorViewsRepository.FORM_KIND));
		staticEnumLiteral = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(BehaviorViewsRepository.CallEnumLiteral.Properties.staticEnumLiteral, BehaviorViewsRepository.FORM_KIND));
		widgetFactory.adapt(staticEnumLiteral);
		...
		staticEnumLiteral.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CallEnumLiteralPropertiesEditionPartForm.this, BehaviorViewsRepository.CallEnumLiteral.Properties.staticEnumLiteral, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getStaticEnumLiteral()));
			}

		});
		staticEnumLiteral.setID(BehaviorViewsRepository.CallEnumLiteral.Properties.staticEnumLiteral);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(BehaviorViewsRepository.CallEnumLiteral.Properties.staticEnumLiteral, BehaviorViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
