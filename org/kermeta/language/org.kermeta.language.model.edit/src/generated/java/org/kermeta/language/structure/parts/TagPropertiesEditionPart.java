...
public interface TagPropertiesEditionPart {
	...
	/**
	 * Init the object
	 * @param settings settings for the object ReferencesTable 
	 */
	public void initObject(ReferencesTableSettings settings);
	...
	/**
	 * @return true if the given element is contained inside the object table
	 * 
	 */
	public boolean isContainedInObjectTable(EObject element);
