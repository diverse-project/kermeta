 ...
 * 
 */
public class UnresolvedPropertyPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, UnresolvedPropertyPropertiesEditionPart {
	 ...
	 * 
	 */
	public UnresolvedPropertyPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
		...
		composer = new PartComposer(unresolvedPropertyStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == StructureViewsRepository.UnresolvedProperty.Properties.propertyIdentifier) {
					return createPropertyIdentifierText(parent);
				}
				return parent;
			}
		};
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(StructureMessages.UnresolvedPropertyPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createKTagAdvancedReferencesTable(Composite parent) {
		...
		this.kTag.setHelpText(propertiesEditionComponent.getHelpContent(StructureViewsRepository.UnresolvedProperty.Properties.kTag, StructureViewsRepository.SWT_KIND));
		this.kTag.createControls(parent);
		this.kTag.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(UnresolvedPropertyPropertiesEditionPartImpl.this, StructureViewsRepository.UnresolvedProperty.Properties.kTag, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"kTag", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(UnresolvedPropertyPropertiesEditionPartImpl.this, StructureViewsRepository.UnresolvedProperty.Properties.kTag,
	...
	protected void moveKTag(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(UnresolvedPropertyPropertiesEditionPartImpl.this, StructureViewsRepository.UnresolvedProperty.Properties.kTag, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		kTag.refresh();
	}
	...
	protected void removeFromKTag(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(UnresolvedPropertyPropertiesEditionPartImpl.this, StructureViewsRepository.UnresolvedProperty.Properties.kTag, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		kTag.refresh();
	}
	...
	protected Composite createKTypeFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, StructureMessages.UnresolvedPropertyPropertiesEditionPart_KTypeLabel, propertiesEditionComponent.isRequired(StructureViewsRepository.UnresolvedProperty.Properties.kType, StructureViewsRepository.SWT_KIND));
		kType = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(StructureViewsRepository.UnresolvedProperty.Properties.kType, StructureViewsRepository.SWT_KIND));
		...
		kType.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(UnresolvedPropertyPropertiesEditionPartImpl.this, StructureViewsRepository.UnresolvedProperty.Properties.kType, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getKType()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(StructureViewsRepository.UnresolvedProperty.Properties.kType, StructureViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createPropertyIdentifierText(Composite parent) {
		SWTUtils.createPartLabel(parent, StructureMessages.UnresolvedPropertyPropertiesEditionPart_PropertyIdentifierLabel, propertiesEditionComponent.isRequired(StructureViewsRepository.UnresolvedProperty.Properties.propertyIdentifier, StructureViewsRepository.SWT_KIND));
		propertyIdentifier = new Text(parent, SWT.BORDER);
		...
		propertyIdentifier.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(UnresolvedPropertyPropertiesEditionPartImpl.this, StructureViewsRepository.UnresolvedProperty.Properties.propertyIdentifier, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, propertyIdentifier.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(StructureViewsRepository.UnresolvedProperty.Properties.propertyIdentifier, StructureViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
