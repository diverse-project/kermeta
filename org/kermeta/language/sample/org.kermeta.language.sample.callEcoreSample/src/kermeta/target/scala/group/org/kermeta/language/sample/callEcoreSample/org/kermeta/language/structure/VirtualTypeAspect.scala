...
trait VirtualTypeAspect extends group.org.kermeta.language.sample.callEcoreSample.org.kermeta.language.structure.ObjectTypeVariableAspect with `_root_`.org.kermeta.language.structure.VirtualType{
