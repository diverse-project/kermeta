...
trait ClassDefinitionAspect extends group.org.kermeta.language.sample.callEcoreSample.org.kermeta.language.structure.GenericTypeDefinitionAspect with `_root_`.org.kermeta.language.structure.ClassDefinition{
