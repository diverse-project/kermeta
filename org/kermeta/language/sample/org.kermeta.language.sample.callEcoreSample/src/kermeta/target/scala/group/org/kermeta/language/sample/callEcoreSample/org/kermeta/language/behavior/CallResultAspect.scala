...
trait CallResultAspect extends group.org.kermeta.language.sample.callEcoreSample.org.kermeta.language.behavior.CallVariableAspect with `_root_`.org.kermeta.language.behavior.CallResult{
