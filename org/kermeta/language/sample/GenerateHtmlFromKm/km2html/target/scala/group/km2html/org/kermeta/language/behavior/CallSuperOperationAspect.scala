...
trait CallSuperOperationAspect extends group.km2html.org.kermeta.language.behavior.CallOperationAspect with `_root_`.org.kermeta.language.behavior.CallSuperOperation{
