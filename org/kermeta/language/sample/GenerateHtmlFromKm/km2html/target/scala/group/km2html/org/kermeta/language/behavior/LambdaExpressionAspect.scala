...
trait LambdaExpressionAspect extends group.km2html.org.kermeta.language.behavior.ExpressionAspect with `_root_`.org.kermeta.language.behavior.LambdaExpression{
