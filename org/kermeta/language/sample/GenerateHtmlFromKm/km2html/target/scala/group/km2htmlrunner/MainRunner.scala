...
object MainRunner  {
	def init() : Unit = {
...

		{
			...
			pack.setEFactoryInstance(group.km2html.org.KerRichFactory)
		}
...

		{
			...
			pack.setEFactoryInstance(group.km2html.org.kermeta.KerRichFactory)
		}
...

		{
			...
			pack.setEFactoryInstance(group.km2html.org.kermeta.language.KerRichFactory)
		}
...

		{
			...
			pack.setEFactoryInstance(group.km2html.org.kermeta.language.structure.KerRichFactory)
		}
...

		{
			...
			pack.setEFactoryInstance(group.km2html.org.kermeta.language.behavior.KerRichFactory)
		}


		 _root_.k2.utils.ReflexivityLoader.pref("group.km2html")

		 _root_.k2.utils.UTilScala.setScalaAspectPrefix("group.km2html")
	}
	def init4eclipse() : Unit = {
			org.impl.OrgPackageImpl.init().setEFactoryInstance(group.km2html.org.KerRichFactory)
		org.kermeta.impl.KmPackageImpl.init().setEFactoryInstance(group.km2html.org.kermeta.KerRichFactory)
		org.kermeta.language.impl.LanguagePackageImpl.init().setEFactoryInstance(group.km2html.org.kermeta.language.KerRichFactory)
		org.kermeta.language.structure.impl.StructurePackageImpl.init().setEFactoryInstance(group.km2html.org.kermeta.language.structure.KerRichFactory)
		org.kermeta.language.behavior.impl.BehaviorPackageImpl.init().setEFactoryInstance(group.km2html.org.kermeta.language.behavior.KerRichFactory)
