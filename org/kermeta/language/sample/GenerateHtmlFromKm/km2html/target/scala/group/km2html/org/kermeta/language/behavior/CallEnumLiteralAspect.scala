...
trait CallEnumLiteralAspect extends group.km2html.org.kermeta.language.behavior.CallExpressionAspect with `_root_`.org.kermeta.language.behavior.CallEnumLiteral{
