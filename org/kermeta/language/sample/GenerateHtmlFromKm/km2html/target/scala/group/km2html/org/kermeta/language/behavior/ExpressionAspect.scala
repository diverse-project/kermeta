...
trait ExpressionAspect extends group.km2html.org.kermeta.language.structure.KermetaModelElementAspect with group.km2html.org.kermeta.language.structure.TypeContainerAspect with `_root_`.org.kermeta.language.behavior.Expression{
