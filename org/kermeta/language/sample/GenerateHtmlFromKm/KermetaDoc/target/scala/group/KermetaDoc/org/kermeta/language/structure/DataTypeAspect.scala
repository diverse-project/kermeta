...
trait DataTypeAspect extends group.KermetaDoc.org.kermeta.language.structure.TypeAspect with group.KermetaDoc.org.kermeta.language.structure.TypeDefinitionAspect with `_root_`.org.kermeta.language.structure.DataType{
