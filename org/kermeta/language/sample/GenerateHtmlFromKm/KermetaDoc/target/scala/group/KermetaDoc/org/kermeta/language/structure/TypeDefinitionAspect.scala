...
trait TypeDefinitionAspect extends group.KermetaDoc.org.kermeta.language.structure.NamedElementAspect with group.KermetaDoc.org.kermeta.language.structure.TypeContainerAspect with `_root_`.org.kermeta.language.structure.TypeDefinition{
