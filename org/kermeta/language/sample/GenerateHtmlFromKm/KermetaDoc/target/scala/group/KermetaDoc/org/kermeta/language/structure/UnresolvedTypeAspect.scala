...
trait UnresolvedTypeAspect extends group.KermetaDoc.org.kermeta.language.structure.TypeAspect with group.KermetaDoc.org.kermeta.language.structure.UnresolvedAspect with group.KermetaDoc.org.kermeta.language.structure.TypeContainerAspect with `_root_`.org.kermeta.language.structure.UnresolvedType{
