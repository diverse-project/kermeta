...
trait CallOperationAspect extends group.KermetaDoc.org.kermeta.language.behavior.CallFeatureAspect with `_root_`.org.kermeta.language.behavior.CallOperation{
