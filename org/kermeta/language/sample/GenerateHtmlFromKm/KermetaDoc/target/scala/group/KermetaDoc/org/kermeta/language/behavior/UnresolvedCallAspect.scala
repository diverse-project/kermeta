...
trait UnresolvedCallAspect extends group.KermetaDoc.org.kermeta.language.structure.UnresolvedAspect with group.KermetaDoc.org.kermeta.language.behavior.CallExpressionAspect with group.KermetaDoc.org.kermeta.language.structure.TypeContainerAspect with `_root_`.org.kermeta.language.behavior.UnresolvedCall{
