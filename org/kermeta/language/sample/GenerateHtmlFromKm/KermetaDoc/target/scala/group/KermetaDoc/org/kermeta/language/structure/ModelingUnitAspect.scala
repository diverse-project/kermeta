...
trait ModelingUnitAspect extends group.KermetaDoc.org.kermeta.language.structure.TypeDefinitionContainerAspect with group.KermetaDoc.org.kermeta.language.structure.KermetaModelElementAspect with `_root_`.org.kermeta.language.structure.ModelingUnit{
