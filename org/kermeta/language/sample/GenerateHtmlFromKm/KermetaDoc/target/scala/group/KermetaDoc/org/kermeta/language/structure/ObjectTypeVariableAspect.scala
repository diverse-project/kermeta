...
trait ObjectTypeVariableAspect extends group.KermetaDoc.org.kermeta.language.structure.TypeVariableAspect with `_root_`.org.kermeta.language.structure.ObjectTypeVariable{
