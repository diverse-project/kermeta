...
trait UnresolvedPropertyAspect extends group.KermetaDoc.org.kermeta.language.structure.AbstractPropertyAspect with group.KermetaDoc.org.kermeta.language.structure.UnresolvedAspect with `_root_`.org.kermeta.language.structure.UnresolvedProperty{
