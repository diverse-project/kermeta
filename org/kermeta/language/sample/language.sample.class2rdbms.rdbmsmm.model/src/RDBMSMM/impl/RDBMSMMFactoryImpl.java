...
public class RDBMSMMFactoryImpl extends EFactoryImpl implements RDBMSMMFactory {
	...
	public static RDBMSMMFactory init() {
		try {
			RDBMSMMFactory theRDBMSMMFactory = (RDBMSMMFactory)EPackage.Registry.INSTANCE.getEFactory("platform:/resource/fr.irisa.triskell.kermeta.samples/class2RDBMS/metamodels/RDBMSMM.ecore"); 
