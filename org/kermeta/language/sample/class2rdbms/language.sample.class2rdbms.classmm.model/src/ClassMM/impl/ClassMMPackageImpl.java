...
public class ClassMMPackageImpl extends EPackageImpl implements ClassMMPackage {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getAttribute_Is_primary(), this.getBoolean(), "is_primary", null, 0, 1, Attribute.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(classEClass, ClassMM.Class.class, "Class", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getClass_Is_persistent(), this.getBoolean(), "is_persistent", null, 0, 1, ClassMM.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
