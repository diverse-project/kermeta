...
class KMLexical extends Lexical with KTokens {
  ...
  val reserved : HashSet[String] = HashSet("abstract", "and", "aspect", "attribute","bag", "class" , "do", "end", "enum", "enumeration", "else","false", "from", "init", "inherits","if","inv","is","loop","method","operation", "or","oset", "package", "post", "pre", "until","then","true", "raise", "reference", "result","require", "self", "seq", "set", "singleton", "super", "using","var","rescue")
