...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Call Property</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.kermeta.language.behavior.impl.CallPropertyImpl#getStaticProperty <em>Static Property</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class CallPropertyImpl extends CallFeatureImpl implements CallProperty {
	/**
	...
	protected EClass eStaticClass() {
		return BehaviorPackage.Literals.CALL_PROPERTY;
	}
		...
		if (staticProperty != null && staticProperty.eIsProxy()) {
			...
			if (staticProperty != oldStaticProperty) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BehaviorPackage.CALL_PROPERTY__STATIC_PROPERTY, oldStaticProperty, staticProperty));
			}
		}
	...
	public void setStaticProperty(Property newStaticProperty) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BehaviorPackage.CALL_PROPERTY__STATIC_PROPERTY, oldStaticProperty, staticProperty));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BehaviorPackage.CALL_PROPERTY__STATIC_PROPERTY:
