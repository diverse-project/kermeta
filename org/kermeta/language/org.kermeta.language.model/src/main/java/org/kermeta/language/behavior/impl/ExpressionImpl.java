...
public abstract class ExpressionImpl extends ObjectImpl implements Expression {
	...
	public EList<Type> getContainedType() {
		if (containedType == null) {
			containedType = new EObjectContainmentWithInverseEList<Type>(Type.class, this, BehaviorPackage.EXPRESSION__CONTAINED_TYPE, StructurePackage.TYPE__TYPE_CONTAINER);
		}
