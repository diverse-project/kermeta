...
public class ModelTypeImpl extends TypeImpl implements ModelType {
	 ...
	 * @ordered
	 */
	protected ModelTypeDefinition typeDefinition;
	 ...
	 * @generated
	 */
	public ModelTypeDefinition getTypeDefinition() {
		if (typeDefinition != null && typeDefinition.eIsProxy()) {
			InternalEObject oldTypeDefinition = (InternalEObject)typeDefinition;
			typeDefinition = (ModelTypeDefinition)eResolveProxy(oldTypeDefinition);
	 ...
	 * @generated
	 */
	public ModelTypeDefinition basicGetTypeDefinition() {
		return typeDefinition;
	}
	 ...
	 * @generated
	 */
	public void setTypeDefinition(ModelTypeDefinition newTypeDefinition) {
		ModelTypeDefinition oldTypeDefinition = typeDefinition;
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case StructurePackage.MODEL_TYPE__TYPE_DEFINITION:
				setTypeDefinition((ModelTypeDefinition)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case StructurePackage.MODEL_TYPE__TYPE_DEFINITION:
				setTypeDefinition((ModelTypeDefinition)null);
				return;
		}
