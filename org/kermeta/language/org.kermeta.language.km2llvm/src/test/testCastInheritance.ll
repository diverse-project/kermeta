...
@"s0" = private unnamed_addr constant [13 x i8] c"Hello World!\00"
...
%"1" = call %struct.kermeta_standard__String* @create_kermeta_standard__String(i8* getelementptr([13 x i8]* @"s0",i32 0,i32 0))
call void @kermeta_io__StdIO___writeln(%struct.kermeta_standard__String* %"1")
ret void
}
