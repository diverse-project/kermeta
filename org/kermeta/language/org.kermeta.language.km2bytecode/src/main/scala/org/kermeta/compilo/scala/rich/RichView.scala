...
class TypeLiteralView extends CallTypeLiteralImpl with CallTypeLiteralAspect
...
class ObjectView extends org.kermeta.language.structure.impl.KermetaModelElementImpl with ObjectAspect
