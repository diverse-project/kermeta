...
object UTilScala {
    ...
    def isInstanceOf(o:Object, typ:Object):Boolean={
        ...
        if (typ.isInstanceOf[org.kermeta.language.structure.PrimitiveType]){
            if ( typ.asInstanceOf[org.kermeta.language.structure.PrimitiveType].getName.equals("EString") && o.getClass.getName.equals("k2.standard.RichString") )
            return true
                
           // println("toto " + typ.asInstanceOf[org.k2.language.structure.PrimitiveType].getName)
        }
       // println(o + "" + typ)
        return false;
    }
    ...
    def newInstance(o:org.kermeta.language.structure.Class): k2.standard.KermetaObject ={
       // println("newInstance " + o + " " +o.getName)
        ...
        var factoryName = scalaAspectPrefix +"." + k2.utils.TypeEquivalence.getPackageEquivalence(name) + ".RichFactory$"
