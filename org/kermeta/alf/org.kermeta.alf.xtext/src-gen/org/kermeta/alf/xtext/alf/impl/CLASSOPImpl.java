 ...
 * <ul>
 *   <li>{@link org.kermeta.alf.xtext.alf.impl.CLASSOPImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.kermeta.alf.xtext.alf.impl.CLASSOPImpl#getStat <em>Stat</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CLASSOPImpl extends MinimalEObjectImpl.Container implements CLASSOP
{
  ...
  public EList<Statement> getStat()
  {
    if (stat == null)
    {
      stat = new EObjectContainmentEList<Statement>(Statement.class, this, AlfPackage.CLASSOP__STAT);
    }
    return stat;
  }
