 ...
 * <ul>
 *   <li>{@link org.kermeta.alf.xtext.alf.SequenceConstructionExpression#getSequenceElement <em>Sequence Element</em>}</li>
 *   <li>{@link org.kermeta.alf.xtext.alf.SequenceConstructionExpression#getRangeUpper <em>Range Upper</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.kermeta.alf.xtext.alf.AlfPackage#getSequenceConstructionExpression()
 * @model
 * @generated
 */
public interface SequenceConstructionExpression extends SequenceElement
{
   ...
   * The list contents are of type {@link org.kermeta.alf.xtext.alf.SequenceElement}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see org.kermeta.alf.xtext.alf.AlfPackage#getSequenceConstructionExpression_SequenceElement()
   ...
   * @see org.kermeta.alf.xtext.alf.AlfPackage#getSequenceConstructionExpression_RangeUpper()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.kermeta.alf.xtext.alf.SequenceConstructionExpression#getRangeUpper <em>Range Upper</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
