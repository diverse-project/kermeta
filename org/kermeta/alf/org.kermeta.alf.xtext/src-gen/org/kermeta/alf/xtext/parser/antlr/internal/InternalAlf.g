...
// Entry rule entryRuleCLASSSTRUCT
entryRuleCLASSSTRUCT returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getCLASSSTRUCTRule()); }
	 iv_ruleCLASSSTRUCT=ruleCLASSSTRUCT 
	 { $current=$iv_ruleCLASSSTRUCT.current; } 
	 EOF 
;

// Rule CLASSSTRUCT
ruleCLASSSTRUCT returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='class' 
