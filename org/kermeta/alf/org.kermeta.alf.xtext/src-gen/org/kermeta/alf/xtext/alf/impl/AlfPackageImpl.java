...
import org.kermeta.alf.xtext.alf.AlfFactory;
...
import org.kermeta.alf.xtext.alf.AnnotationKind;
import org.kermeta.alf.xtext.alf.AssignmentCompletion;
import org.kermeta.alf.xtext.alf.AssignmentOperator;
import org.kermeta.alf.xtext.alf.Block;
import org.kermeta.alf.xtext.alf.BlockStatement;
import org.kermeta.alf.xtext.alf.BooleanValue;
...
import org.kermeta.alf.xtext.alf.CollectOrIterateOperator;
...
import org.kermeta.alf.xtext.alf.ForAllOrExistsOrOneOperator;
...
import org.kermeta.alf.xtext.alf.LinkOperationKind;
...
import org.kermeta.alf.xtext.alf.NonLiteralValueSpecification;
...
import org.kermeta.alf.xtext.alf.SelectOrRejectOperator;
...
import org.kermeta.alf.xtext.alf.SequenceElement;
import org.kermeta.alf.xtext.alf.SequenceExpansionExpression;
...
import org.kermeta.alf.xtext.alf.Statement;
import org.kermeta.alf.xtext.alf.StatementSequence;
import org.kermeta.alf.xtext.alf.SuffixExpression;
...
public class AlfPackageImpl extends EPackageImpl implements AlfPackage
{
   ...
   * @see org.kermeta.alf.xtext.alf.AlfPackage#eNS_URI
   * @see #init()
   * @generated
   */
  ...
  public void initializePackageContents()
  {
    ...
    initEClass(classstructEClass, org.kermeta.alf.xtext.alf.CLASSSTRUCT.class, "CLASSSTRUCT", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getCLASSSTRUCT_Name(), ecorePackage.getEString(), "name", null, 0, 1, org.kermeta.alf.xtext.alf.CLASSSTRUCT.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getCLASSSTRUCT_Clsop(), this.getCLASSOP(), null, "clsop", null, 0, -1, org.kermeta.alf.xtext.alf.CLASSSTRUCT.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(classopEClass, org.kermeta.alf.xtext.alf.CLASSOP.class, "CLASSOP", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getCLASSOP_Name(), ecorePackage.getEString(), "name", null, 0, 1, org.kermeta.alf.xtext.alf.CLASSOP.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getCLASSOP_Stat(), this.getStatement(), null, "stat", null, 0, -1, org.kermeta.alf.xtext.alf.CLASSOP.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(literalEClass, org.kermeta.alf.xtext.alf.LITERAL.class, "LITERAL", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getLITERAL_Suffix(), this.getSuffixExpression(), null, "suffix", null, 0, 1, org.kermeta.alf.xtext.alf.LITERAL.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(booleaN_LITERALEClass, org.kermeta.alf.xtext.alf.BOOLEAN_LITERAL.class, "BOOLEAN_LITERAL", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getBOOLEAN_LITERAL_Value(), this.getBooleanValue(), "value", null, 0, 1, org.kermeta.alf.xtext.alf.BOOLEAN_LITERAL.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(numbeR_LITERALEClass, org.kermeta.alf.xtext.alf.NUMBER_LITERAL.class, "NUMBER_LITERAL", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getNUMBER_LITERAL_Value(), ecorePackage.getEString(), "value", null, 0, 1, org.kermeta.alf.xtext.alf.NUMBER_LITERAL.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(integeR_LITERALEClass, org.kermeta.alf.xtext.alf.INTEGER_LITERAL.class, "INTEGER_LITERAL", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(unlimiteD_LITERALEClass, org.kermeta.alf.xtext.alf.UNLIMITED_LITERAL.class, "UNLIMITED_LITERAL", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(strinG_LITERALEClass, org.kermeta.alf.xtext.alf.STRING_LITERAL.class, "STRING_LITERAL", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getSTRING_LITERAL_Value(), ecorePackage.getEString(), "value", null, 0, 1, org.kermeta.alf.xtext.alf.STRING_LITERAL.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
