 ...
 * <ul>
 *   <li>{@link org3.kermeta.alf.impl.AdditiveExpressionImpl#getExp <em>Exp</em>}</li>
 *   <li>{@link org3.kermeta.alf.impl.AdditiveExpressionImpl#getOp <em>Op</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AdditiveExpressionImpl extends EObjectImpl implements AdditiveExpression {
	...
	public EList getExp() {
		if (exp == null) {
			exp = new EObjectContainmentEList(MultiplicativeExpression.class, this, AlfPackage.ADDITIVE_EXPRESSION__EXP);
		}
		return exp;
	}
	...
	public EList getOp() {
		if (op == null) {
			op = new EDataTypeEList(String.class, this, AlfPackage.ADDITIVE_EXPRESSION__OP);
		}
		return op;
	}
