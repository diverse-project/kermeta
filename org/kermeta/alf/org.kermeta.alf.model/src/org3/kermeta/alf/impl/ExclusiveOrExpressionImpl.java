 ...
 * <ul>
 *   <li>{@link org3.kermeta.alf.impl.ExclusiveOrExpressionImpl#getExp <em>Exp</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExclusiveOrExpressionImpl extends EObjectImpl implements ExclusiveOrExpression {
	...
	public EList getExp() {
		if (exp == null) {
			exp = new EObjectContainmentEList(AndExpression.class, this, AlfPackage.EXCLUSIVE_OR_EXPRESSION__EXP);
		}
		return exp;
	}
