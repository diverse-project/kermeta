...
import org3.kermeta.alf.AdditiveExpression;
import org3.kermeta.alf.AlfFactory;
import org3.kermeta.alf.AlfPackage;
import org3.kermeta.alf.AndExpression;
import org3.kermeta.alf.AnnotatedStatement;
import org3.kermeta.alf.Annotation;
import org3.kermeta.alf.AnnotationKind;
import org3.kermeta.alf.AssignmentCompletion;
import org3.kermeta.alf.AssignmentOperator;
import org3.kermeta.alf.Block;
import org3.kermeta.alf.BlockStatement;
import org3.kermeta.alf.BooleanValue;
import org3.kermeta.alf.BreakStatement;
import org3.kermeta.alf.ClassExtentExpression;
import org3.kermeta.alf.ClassificationClause;
import org3.kermeta.alf.ClassificationExpression;
import org3.kermeta.alf.ClassificationFromClause;
import org3.kermeta.alf.ClassificationToClause;
import org3.kermeta.alf.ClassifyStatement;
...
import org3.kermeta.alf.ConcurrentClauses;
import org3.kermeta.alf.ConditionalAndExpression;
import org3.kermeta.alf.ConditionalOrExpression;
import org3.kermeta.alf.ConditionalTestExpression;
import org3.kermeta.alf.DoStatement;
import org3.kermeta.alf.DocumentedStatement;
import org3.kermeta.alf.EmptyStatement;
import org3.kermeta.alf.EqualityExpression;
import org3.kermeta.alf.ExclusiveOrExpression;
import org3.kermeta.alf.Expression;
import org3.kermeta.alf.FinalClause;
...
import org3.kermeta.alf.IfStatement;
import org3.kermeta.alf.InclusiveOrExpression;
import org3.kermeta.alf.InlineStatement;
import org3.kermeta.alf.InstanceCreationExpression;
import org3.kermeta.alf.InstanceCreationInvocationStatement;
import org3.kermeta.alf.InvocationOrAssignementOrDeclarationStatement;
import org3.kermeta.alf.IsUniqueOperation;
import org3.kermeta.alf.LinkOperationExpression;
import org3.kermeta.alf.LinkOperationKind;
import org3.kermeta.alf.LinkOperationTuple;
import org3.kermeta.alf.LinkOperationTupleElement;
import org3.kermeta.alf.LocalNameDeclarationStatement;
import org3.kermeta.alf.LoopVariableDefinition;
import org3.kermeta.alf.MultiplicativeExpression;
import org3.kermeta.alf.NameExpression;
import org3.kermeta.alf.NamedTemplateBinding;
import org3.kermeta.alf.NonEmptyStatementSequence;
import org3.kermeta.alf.NonFinalClause;
import org3.kermeta.alf.NonLiteralValueSpecification;
import org3.kermeta.alf.NullExpression;
import org3.kermeta.alf.OperationCallExpression;
import org3.kermeta.alf.OperationCallExpressionWithoutDot;
import org3.kermeta.alf.ParenthesizedExpression;
import org3.kermeta.alf.PartialSequenceConstructionCompletion;
import org3.kermeta.alf.PrimaryExpression;
import org3.kermeta.alf.PropertyCallExpression;
...
import org3.kermeta.alf.ReclassifyAllClause;
import org3.kermeta.alf.RelationalExpression;
import org3.kermeta.alf.ReturnStatement;
import org3.kermeta.alf.SelectOrRejectOperation;
import org3.kermeta.alf.SelectOrRejectOperator;
import org3.kermeta.alf.SequenceConstructionCompletion;
import org3.kermeta.alf.SequenceConstructionExpression;
import org3.kermeta.alf.SequenceConstructionOrAccessCompletion;
import org3.kermeta.alf.SequenceElement;
import org3.kermeta.alf.SequenceExpansionExpression;
import org3.kermeta.alf.SequenceOperationExpression;
import org3.kermeta.alf.SequenceReductionExpression;
import org3.kermeta.alf.SequentialClauses;
import org3.kermeta.alf.ShiftExpression;
...
import org3.kermeta.alf.SuperInvocationExpression;
import org3.kermeta.alf.SuperInvocationStatement;
import org3.kermeta.alf.SwitchCase;
import org3.kermeta.alf.SwitchClause;
import org3.kermeta.alf.SwitchDefaultClause;
import org3.kermeta.alf.SwitchStatement;
import org3.kermeta.alf.TemplateBinding;
import org3.kermeta.alf.ThisExpression;
import org3.kermeta.alf.ThisInvocationStatement;
import org3.kermeta.alf.Tuple;
import org3.kermeta.alf.TupleElement;
import org3.kermeta.alf.UnaryExpression;
import org3.kermeta.alf.UnqualifiedName;
import org3.kermeta.alf.ValueSpecification;
import org3.kermeta.alf.VariableDeclarationCompletion;
import org3.kermeta.alf.WhileStatement;
...
public class AlfPackageImpl extends EPackageImpl implements AlfPackage {
	 ...
	 * @see org3.kermeta.alf.AlfPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEClass(classstructEClass, org3.kermeta.alf.CLASSSTRUCT.class, "CLASSSTRUCT", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getCLASSSTRUCT_Name(), ecorePackage.getEString(), "name", null, 0, 1, org3.kermeta.alf.CLASSSTRUCT.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCLASSSTRUCT_Clsop(), this.getCLASSOP(), null, "clsop", null, 0, -1, org3.kermeta.alf.CLASSSTRUCT.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(classopEClass, org3.kermeta.alf.CLASSOP.class, "CLASSOP", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getCLASSOP_Name(), ecorePackage.getEString(), "name", null, 0, 1, org3.kermeta.alf.CLASSOP.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCLASSOP_Stat(), this.getStatement(), null, "stat", null, 0, -1, org3.kermeta.alf.CLASSOP.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(literalEClass, org3.kermeta.alf.LITERAL.class, "LITERAL", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getLITERAL_Suffix(), this.getSuffixExpression(), null, "suffix", null, 0, 1, org3.kermeta.alf.LITERAL.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(booleaN_LITERALEClass, org3.kermeta.alf.BOOLEAN_LITERAL.class, "BOOLEAN_LITERAL", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getBOOLEAN_LITERAL_Value(), this.getBooleanValue(), "value", null, 0, 1, org3.kermeta.alf.BOOLEAN_LITERAL.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(numbeR_LITERALEClass, org3.kermeta.alf.NUMBER_LITERAL.class, "NUMBER_LITERAL", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getNUMBER_LITERAL_Value(), ecorePackage.getEString(), "value", null, 0, 1, org3.kermeta.alf.NUMBER_LITERAL.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(integeR_LITERALEClass, org3.kermeta.alf.INTEGER_LITERAL.class, "INTEGER_LITERAL", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(unlimiteD_LITERALEClass, org3.kermeta.alf.UNLIMITED_LITERAL.class, "UNLIMITED_LITERAL", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(strinG_LITERALEClass, org3.kermeta.alf.STRING_LITERAL.class, "STRING_LITERAL", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getSTRING_LITERAL_Value(), ecorePackage.getEString(), "value", null, 0, 1, org3.kermeta.alf.STRING_LITERAL.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
