 ...
 * <ul>
 *   <li>{@link org3.kermeta.alf.impl.ShiftExpressionImpl#getExp <em>Exp</em>}</li>
 *   <li>{@link org3.kermeta.alf.impl.ShiftExpressionImpl#getOp <em>Op</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ShiftExpressionImpl extends EObjectImpl implements ShiftExpression {
	...
	public EList getExp() {
		if (exp == null) {
			exp = new EObjectContainmentEList(AdditiveExpression.class, this, AlfPackage.SHIFT_EXPRESSION__EXP);
		}
		return exp;
	}
