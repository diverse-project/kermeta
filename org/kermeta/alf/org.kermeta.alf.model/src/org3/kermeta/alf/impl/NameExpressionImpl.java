 ...
 * <ul>
 *   <li>{@link org3.kermeta.alf.impl.NameExpressionImpl#getPrefixOp <em>Prefix Op</em>}</li>
 *   <li>{@link org3.kermeta.alf.impl.NameExpressionImpl#getPath <em>Path</em>}</li>
 *   <li>{@link org3.kermeta.alf.impl.NameExpressionImpl#getId <em>Id</em>}</li>
 *   <li>{@link org3.kermeta.alf.impl.NameExpressionImpl#getInvocationCompletion <em>Invocation Completion</em>}</li>
 *   <li>{@link org3.kermeta.alf.impl.NameExpressionImpl#getSequenceConstructionCompletion <em>Sequence Construction Completion</em>}</li>
 *   <li>{@link org3.kermeta.alf.impl.NameExpressionImpl#getPostfixOp <em>Postfix Op</em>}</li>
 *   <li>{@link org3.kermeta.alf.impl.NameExpressionImpl#getSuffix <em>Suffix</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
