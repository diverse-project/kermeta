 ...
 * <ul>
 *   <li>{@link org3.kermeta.alf.impl.MultiplicativeExpressionImpl#getExp <em>Exp</em>}</li>
 *   <li>{@link org3.kermeta.alf.impl.MultiplicativeExpressionImpl#getOp <em>Op</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MultiplicativeExpressionImpl extends EObjectImpl implements MultiplicativeExpression {
	...
	public EList getExp() {
		if (exp == null) {
			exp = new EObjectContainmentEList(UnaryExpression.class, this, AlfPackage.MULTIPLICATIVE_EXPRESSION__EXP);
		}
		return exp;
	}
	...
	public EList getOp() {
		if (op == null) {
			op = new EDataTypeEList(String.class, this, AlfPackage.MULTIPLICATIVE_EXPRESSION__OP);
		}
		return op;
	}
