 ...
 * <ul>
 *   <li>{@link org.kermeta.alf.impl.SwitchStatementImpl#getExpression <em>Expression</em>}</li>
 *   <li>{@link org.kermeta.alf.impl.SwitchStatementImpl#getSwitchClause <em>Switch Clause</em>}</li>
 *   <li>{@link org.kermeta.alf.impl.SwitchStatementImpl#getDefaultClause <em>Default Clause</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SwitchStatementImpl extends StatementImpl implements SwitchStatement {
	...
	public EList getSwitchClause() {
		if (switchClause == null) {
			switchClause = new EObjectContainmentEList(SwitchClause.class, this, AlfPackage.SWITCH_STATEMENT__SWITCH_CLAUSE);
		}
		return switchClause;
	}
