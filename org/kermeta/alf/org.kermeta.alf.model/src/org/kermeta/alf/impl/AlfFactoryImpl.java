...
public class AlfFactoryImpl extends EFactoryImpl implements AlfFactory {
	...
	public static AlfFactory init() {
		try {
			AlfFactory theAlfFactory = (AlfFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.kermeta.org/alf/1_0_0/org/kermeta/alf"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case AlfPackage.CLASSSTRUCT: return createCLASSSTRUCT();
			case AlfPackage.CLASSOP: return createCLASSOP();
