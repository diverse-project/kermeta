...
import org.kermeta.alf.AcceptBlock;
import org.kermeta.alf.AcceptClause;
import org.kermeta.alf.AcceptStatement;
import org.kermeta.alf.AccessCompletion;
import org.kermeta.alf.AdditiveExpression;
import org.kermeta.alf.AlfFactory;
import org.kermeta.alf.AlfPackage;
import org.kermeta.alf.AndExpression;
import org.kermeta.alf.AnnotatedStatement;
import org.kermeta.alf.Annotation;
import org.kermeta.alf.AnnotationKind;
import org.kermeta.alf.AssignmentCompletion;
import org.kermeta.alf.AssignmentOperator;
import org.kermeta.alf.Block;
import org.kermeta.alf.BlockStatement;
import org.kermeta.alf.BooleanValue;
import org.kermeta.alf.BreakStatement;
import org.kermeta.alf.ClassExtentExpression;
import org.kermeta.alf.ClassificationClause;
import org.kermeta.alf.ClassificationExpression;
import org.kermeta.alf.ClassificationFromClause;
import org.kermeta.alf.ClassificationToClause;
import org.kermeta.alf.ClassifyStatement;
import org.kermeta.alf.CollectOrIterateOperation;
import org.kermeta.alf.CollectOrIterateOperator;
import org.kermeta.alf.CompoundAcceptStatementCompletion;
import org.kermeta.alf.ConcurrentClauses;
import org.kermeta.alf.ConditionalAndExpression;
import org.kermeta.alf.ConditionalOrExpression;
import org.kermeta.alf.ConditionalTestExpression;
import org.kermeta.alf.DoStatement;
import org.kermeta.alf.DocumentedStatement;
import org.kermeta.alf.EmptyStatement;
import org.kermeta.alf.EqualityExpression;
import org.kermeta.alf.ExclusiveOrExpression;
import org.kermeta.alf.Expression;
import org.kermeta.alf.FinalClause;
import org.kermeta.alf.ForAllOrExistsOrOneOperation;
import org.kermeta.alf.ForAllOrExistsOrOneOperator;
import org.kermeta.alf.ForControl;
import org.kermeta.alf.ForStatement;
import org.kermeta.alf.IfStatement;
import org.kermeta.alf.InclusiveOrExpression;
import org.kermeta.alf.InlineStatement;
import org.kermeta.alf.InstanceCreationExpression;
import org.kermeta.alf.InstanceCreationInvocationStatement;
import org.kermeta.alf.InvocationOrAssignementOrDeclarationStatement;
import org.kermeta.alf.IsUniqueOperation;
import org.kermeta.alf.LinkOperationExpression;
import org.kermeta.alf.LinkOperationKind;
import org.kermeta.alf.LinkOperationTuple;
import org.kermeta.alf.LinkOperationTupleElement;
import org.kermeta.alf.LocalNameDeclarationStatement;
import org.kermeta.alf.LoopVariableDefinition;
import org.kermeta.alf.MultiplicativeExpression;
import org.kermeta.alf.NameExpression;
import org.kermeta.alf.NamedTemplateBinding;
import org.kermeta.alf.NonEmptyStatementSequence;
import org.kermeta.alf.NonFinalClause;
import org.kermeta.alf.NonLiteralValueSpecification;
import org.kermeta.alf.NullExpression;
import org.kermeta.alf.OperationCallExpression;
import org.kermeta.alf.OperationCallExpressionWithoutDot;
import org.kermeta.alf.ParenthesizedExpression;
import org.kermeta.alf.PartialSequenceConstructionCompletion;
import org.kermeta.alf.PrimaryExpression;
import org.kermeta.alf.PropertyCallExpression;
import org.kermeta.alf.QualifiedNameList;
import org.kermeta.alf.QualifiedNamePath;
import org.kermeta.alf.QualifiedNameWithBinding;
import org.kermeta.alf.ReclassifyAllClause;
import org.kermeta.alf.RelationalExpression;
import org.kermeta.alf.ReturnStatement;
import org.kermeta.alf.SelectOrRejectOperation;
import org.kermeta.alf.SelectOrRejectOperator;
import org.kermeta.alf.SequenceConstructionCompletion;
import org.kermeta.alf.SequenceConstructionExpression;
import org.kermeta.alf.SequenceConstructionOrAccessCompletion;
import org.kermeta.alf.SequenceElement;
import org.kermeta.alf.SequenceExpansionExpression;
import org.kermeta.alf.SequenceOperationExpression;
import org.kermeta.alf.SequenceReductionExpression;
import org.kermeta.alf.SequentialClauses;
import org.kermeta.alf.ShiftExpression;
import org.kermeta.alf.SimpleAcceptStatementCompletion;
import org.kermeta.alf.Statement;
import org.kermeta.alf.StatementSequence;
import org.kermeta.alf.SuffixExpression;
import org.kermeta.alf.SuperInvocationExpression;
import org.kermeta.alf.SuperInvocationStatement;
import org.kermeta.alf.SwitchCase;
import org.kermeta.alf.SwitchClause;
import org.kermeta.alf.SwitchDefaultClause;
import org.kermeta.alf.SwitchStatement;
import org.kermeta.alf.TemplateBinding;
import org.kermeta.alf.ThisExpression;
import org.kermeta.alf.ThisInvocationStatement;
import org.kermeta.alf.Tuple;
import org.kermeta.alf.TupleElement;
import org.kermeta.alf.UnaryExpression;
import org.kermeta.alf.UnqualifiedName;
import org.kermeta.alf.ValueSpecification;
import org.kermeta.alf.VariableDeclarationCompletion;
import org.kermeta.alf.WhileStatement;
...
public class AlfPackageImpl extends EPackageImpl implements AlfPackage {
	 ...
	 * @generated
	 */
	private EClass classstructEClass = null;
	 ...
	 * @see org.kermeta.alf.AlfPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EClass getCLASSSTRUCT() {
		return classstructEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getCLASSSTRUCT_Name() {
		return (EAttribute)classstructEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getCLASSSTRUCT_Clsop() {
		return (EReference)classstructEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getCLASSOP_Name() {
		return (EAttribute)classopEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getCLASSOP_Stat() {
	...
	public void createPackageContents() {
		...
		classstructEClass = createEClass(CLASSSTRUCT);
		createEAttribute(classstructEClass, CLASSSTRUCT__NAME);
		createEReference(classstructEClass, CLASSSTRUCT__CLSOP);

		classopEClass = createEClass(CLASSOP);
		createEAttribute(classopEClass, CLASSOP__NAME);
		createEReference(classopEClass, CLASSOP__STAT);
	...
	public void initializePackageContents() {
		...
		initEClass(classstructEClass, org.kermeta.alf.CLASSSTRUCT.class, "CLASSSTRUCT", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getCLASSSTRUCT_Name(), ecorePackage.getEString(), "name", null, 0, 1, org.kermeta.alf.CLASSSTRUCT.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCLASSSTRUCT_Clsop(), this.getCLASSOP(), null, "clsop", null, 0, -1, org.kermeta.alf.CLASSSTRUCT.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(classopEClass, org.kermeta.alf.CLASSOP.class, "CLASSOP", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getCLASSOP_Name(), ecorePackage.getEString(), "name", null, 0, 1, org.kermeta.alf.CLASSOP.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCLASSOP_Stat(), this.getStatement(), null, "stat", null, 0, -1, org.kermeta.alf.CLASSOP.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(literalEClass, org.kermeta.alf.LITERAL.class, "LITERAL", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getLITERAL_Suffix(), this.getSuffixExpression(), null, "suffix", null, 0, 1, org.kermeta.alf.LITERAL.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(booleaN_LITERALEClass, org.kermeta.alf.BOOLEAN_LITERAL.class, "BOOLEAN_LITERAL", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getBOOLEAN_LITERAL_Value(), this.getBooleanValue(), "value", null, 0, 1, org.kermeta.alf.BOOLEAN_LITERAL.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(numbeR_LITERALEClass, org.kermeta.alf.NUMBER_LITERAL.class, "NUMBER_LITERAL", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getNUMBER_LITERAL_Value(), ecorePackage.getEString(), "value", null, 0, 1, org.kermeta.alf.NUMBER_LITERAL.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(integeR_LITERALEClass, org.kermeta.alf.INTEGER_LITERAL.class, "INTEGER_LITERAL", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(unlimiteD_LITERALEClass, org.kermeta.alf.UNLIMITED_LITERAL.class, "UNLIMITED_LITERAL", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(strinG_LITERALEClass, org.kermeta.alf.STRING_LITERAL.class, "STRING_LITERAL", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getSTRING_LITERAL_Value(), ecorePackage.getEString(), "value", null, 0, 1, org.kermeta.alf.STRING_LITERAL.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEEnumLiteral(assignmentOperatorEEnum, AssignmentOperator.PLUSASSIGN_LITERAL);
		addEEnumLiteral(assignmentOperatorEEnum, AssignmentOperator.MINUSASSIGN_LITERAL);
		addEEnumLiteral(assignmentOperatorEEnum, AssignmentOperator.MULTASSIGN_LITERAL);
		addEEnumLiteral(assignmentOperatorEEnum, AssignmentOperator.MODASSIGN_LITERAL);
		addEEnumLiteral(assignmentOperatorEEnum, AssignmentOperator.DIVASSIGN_LITERAL);
		addEEnumLiteral(assignmentOperatorEEnum, AssignmentOperator.ANDASSIGN_LITERAL);
		addEEnumLiteral(assignmentOperatorEEnum, AssignmentOperator.ORASSIGN_LITERAL);
		addEEnumLiteral(assignmentOperatorEEnum, AssignmentOperator.XORASSIGN_LITERAL);
		addEEnumLiteral(assignmentOperatorEEnum, AssignmentOperator.LSHIFTASSIGN_LITERAL);
		addEEnumLiteral(assignmentOperatorEEnum, AssignmentOperator.RSHIFTASSIGN_LITERAL);
		addEEnumLiteral(assignmentOperatorEEnum, AssignmentOperator.URSHIFTASSIGN_LITERAL);

		initEEnum(booleanValueEEnum, BooleanValue.class, "BooleanValue");
		addEEnumLiteral(booleanValueEEnum, BooleanValue.TRUE_LITERAL);
		addEEnumLiteral(booleanValueEEnum, BooleanValue.FALSE_LITERAL);

		initEEnum(linkOperationKindEEnum, LinkOperationKind.class, "LinkOperationKind");
		addEEnumLiteral(linkOperationKindEEnum, LinkOperationKind.CREATE_LITERAL);
		addEEnumLiteral(linkOperationKindEEnum, LinkOperationKind.DESTROY_LITERAL);
		addEEnumLiteral(linkOperationKindEEnum, LinkOperationKind.CLEAR_LITERAL);

		initEEnum(selectOrRejectOperatorEEnum, SelectOrRejectOperator.class, "SelectOrRejectOperator");
		addEEnumLiteral(selectOrRejectOperatorEEnum, SelectOrRejectOperator.SELECT_LITERAL);
		addEEnumLiteral(selectOrRejectOperatorEEnum, SelectOrRejectOperator.REJECT_LITERAL);

		initEEnum(collectOrIterateOperatorEEnum, CollectOrIterateOperator.class, "CollectOrIterateOperator");
		addEEnumLiteral(collectOrIterateOperatorEEnum, CollectOrIterateOperator.COLLECT_LITERAL);
		addEEnumLiteral(collectOrIterateOperatorEEnum, CollectOrIterateOperator.ITERATE_LITERAL);

		initEEnum(forAllOrExistsOrOneOperatorEEnum, ForAllOrExistsOrOneOperator.class, "ForAllOrExistsOrOneOperator");
		addEEnumLiteral(forAllOrExistsOrOneOperatorEEnum, ForAllOrExistsOrOneOperator.FORALL_LITERAL);
		addEEnumLiteral(forAllOrExistsOrOneOperatorEEnum, ForAllOrExistsOrOneOperator.EXISTS_LITERAL);
		addEEnumLiteral(forAllOrExistsOrOneOperatorEEnum, ForAllOrExistsOrOneOperator.ONE_LITERAL);

		initEEnum(annotationKindEEnum, AnnotationKind.class, "AnnotationKind");
		addEEnumLiteral(annotationKindEEnum, AnnotationKind.ISOLATED_LITERAL);
		addEEnumLiteral(annotationKindEEnum, AnnotationKind.DETERMINED_LITERAL);
		addEEnumLiteral(annotationKindEEnum, AnnotationKind.ASSURED_LITERAL);
		addEEnumLiteral(annotationKindEEnum, AnnotationKind.PARALLEL_LITERAL);
