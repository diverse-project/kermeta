 ...
 * <ul>
 *   <li>{@link org.kermeta.alf.impl.ConditionalOrExpressionImpl#getExp <em>Exp</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConditionalOrExpressionImpl extends EObjectImpl implements ConditionalOrExpression {
	...
	public EList getExp() {
		if (exp == null) {
			exp = new EObjectContainmentEList(ConditionalAndExpression.class, this, AlfPackage.CONDITIONAL_OR_EXPRESSION__EXP);
		}
		return exp;
	}
