 ...
 * <ul>
 *   <li>{@link org.kermeta.alf.impl.SwitchClauseImpl#getSwitchCase <em>Switch Case</em>}</li>
 *   <li>{@link org.kermeta.alf.impl.SwitchClauseImpl#getStatementSequence <em>Statement Sequence</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SwitchClauseImpl extends EObjectImpl implements SwitchClause {
	...
	public EList getSwitchCase() {
		if (switchCase == null) {
			switchCase = new EObjectContainmentEList(SwitchCase.class, this, AlfPackage.SWITCH_CLAUSE__SWITCH_CASE);
		}
		return switchCase;
	}
