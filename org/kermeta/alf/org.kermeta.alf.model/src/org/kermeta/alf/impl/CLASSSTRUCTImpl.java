...
import org.kermeta.alf.CLASSOP;
import org.kermeta.alf.CLASSSTRUCT;
 ...
 * <ul>
 *   <li>{@link org.kermeta.alf.impl.CLASSSTRUCTImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.kermeta.alf.impl.CLASSSTRUCTImpl#getClsop <em>Clsop</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CLASSSTRUCTImpl extends EObjectImpl implements CLASSSTRUCT {
	...
	public EList getClsop() {
		if (clsop == null) {
			clsop = new EObjectContainmentEList(CLASSOP.class, this, AlfPackage.CLASSSTRUCT__CLSOP);
		}
		return clsop;
	}
