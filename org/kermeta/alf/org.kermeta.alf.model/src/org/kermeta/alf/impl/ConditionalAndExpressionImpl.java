 ...
 * <ul>
 *   <li>{@link org.kermeta.alf.impl.ConditionalAndExpressionImpl#getExp <em>Exp</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConditionalAndExpressionImpl extends EObjectImpl implements ConditionalAndExpression {
	...
	public EList getExp() {
		if (exp == null) {
			exp = new EObjectContainmentEList(InclusiveOrExpression.class, this, AlfPackage.CONDITIONAL_AND_EXPRESSION__EXP);
		}
		return exp;
	}
