 ...
 * <ul>
 *   <li>{@link org.kermeta.alf.impl.InclusiveOrExpressionImpl#getExp <em>Exp</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InclusiveOrExpressionImpl extends EObjectImpl implements InclusiveOrExpression {
	...
	public EList getExp() {
		if (exp == null) {
			exp = new EObjectContainmentEList(ExclusiveOrExpression.class, this, AlfPackage.INCLUSIVE_OR_EXPRESSION__EXP);
		}
		return exp;
	}
