...
public class AlfDslSwitch {
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case AlfDslPackage.BOOLEAN_LITERAL: {
			...
			case AlfDslPackage.NUMBER_LITERAL: {
			...
			case AlfDslPackage.INTEGER_LITERAL: {
			...
			case AlfDslPackage.UNLIMITED_LITERAL: {
			...
			case AlfDslPackage.STRING_LITERAL: {
			...
			case AlfDslPackage.NAME_EXPRESSION: {
			...
			case AlfDslPackage.QUALIFIED_NAME_WITH_BINDING: {
			...
			case AlfDslPackage.CONDITIONAL_TEST_EXPRESSION: {
			...
			case AlfDslPackage.CONDITIONAL_OR_EXPRESSION: {
			...
			case AlfDslPackage.CONDITIONAL_AND_EXPRESSION: {
			...
			case AlfDslPackage.INCLUSIVE_OR_EXPRESSION: {
			...
			case AlfDslPackage.EXCLUSIVE_OR_EXPRESSION: {
			...
			case AlfDslPackage.OPERATION_CALL_EXPRESSION_WITHOUT_DOT: {
			...
			case AlfDslPackage.PROPERTY_CALL_EXPRESSION: {
			...
			case AlfDslPackage.LINK_OPERATION_EXPRESSION: {
			...
			case AlfDslPackage.LINK_OPERATION_TUPLE: {
			...
			case AlfDslPackage.LINK_OPERATION_TUPLE_ELEMENT: {
			...
			case AlfDslPackage.SEQUENCE_OPERATION_EXPRESSION: {
			...
			case AlfDslPackage.SEQUENCE_REDUCTION_EXPRESSION: {
			...
			case AlfDslPackage.SEQUENCE_EXPANSION_EXPRESSION: {
			...
			case AlfDslPackage.SELECT_OR_REJECT_OPERATION: {
			...
			case AlfDslPackage.COLLECT_OR_ITERATE_OPERATION: {
			...
			case AlfDslPackage.FOR_ALL_OR_EXISTS_OR_ONE_OPERATION: {
			...
			case AlfDslPackage.IS_UNIQUE_OPERATION: {
			...
			case AlfDslPackage.VALUE_SPECIFICATION: {
			...
			case AlfDslPackage.NON_LITERAL_VALUE_SPECIFICATION: {
			...
			case AlfDslPackage.PARENTHESIZED_EXPRESSION: {
			...
			case AlfDslPackage.NULL_EXPRESSION: {
			...
			case AlfDslPackage.THIS_EXPRESSION: {
			...
			case AlfDslPackage.SUPER_INVOCATION_EXPRESSION: {
			...
			case AlfDslPackage.INSTANCE_CREATION_EXPRESSION: {
			...
			case AlfDslPackage.SEQUENCE_CONSTRUCTION_OR_ACCESS_COMPLETION: {
			...
			case AlfDslPackage.SEQUENCE_CONSTRUCTION_COMPLETION: {
			...
			case AlfDslPackage.SEQUENCE_CONSTRUCTION_EXPRESSION: {
			...
			case AlfDslPackage.ANNOTATED_STATEMENT: {
			...
			case AlfDslPackage.DOCUMENTED_STATEMENT: {
			...
			case AlfDslPackage.EMPTY_STATEMENT: {
			...
			case AlfDslPackage.LOCAL_NAME_DECLARATION_STATEMENT: {
			...
			case AlfDslPackage.IF_STATEMENT: {
			...
			case AlfDslPackage.NON_EMPTY_STATEMENT_SEQUENCE: {
			...
			case AlfDslPackage.WHILE_STATEMENT: {
			...
			case AlfDslPackage.DO_STATEMENT: {
			...
			case AlfDslPackage.FOR_STATEMENT: {
			...
			case AlfDslPackage.BREAK_STATEMENT: {
			...
			case AlfDslPackage.RETURN_STATEMENT: {
			...
			case AlfDslPackage.ACCEPT_STATEMENT: {
			...
			case AlfDslPackage.SIMPLE_ACCEPT_STATEMENT_COMPLETION: {
			...
			case AlfDslPackage.COMPOUND_ACCEPT_STATEMENT_COMPLETION: {
			...
			case AlfDslPackage.CLASSIFICATION_CLAUSE: {
			...
			case AlfDslPackage.CLASSIFICATION_FROM_CLAUSE: {
			...
			case AlfDslPackage.CLASSIFICATION_TO_CLAUSE: {
			...
			case AlfDslPackage.RECLASSIFY_ALL_CLAUSE: {
			...
			case AlfDslPackage.SUPER_INVOCATION_STATEMENT: {
			...
			case AlfDslPackage.THIS_INVOCATION_STATEMENT: {
			...
			case AlfDslPackage.INSTANCE_CREATION_INVOCATION_STATEMENT: {
			...
			case AlfDslPackage.VARIABLE_DECLARATION_COMPLETION: {
			...
			case AlfDslPackage.ASSIGNMENT_COMPLETION: {
