 ...
 * <ul>
 *   <li>{@link alfDsl.ClassificationToClause#getQualifiedNameList <em>Qualified Name List</em>}</li>
 * </ul>
 * </p>
 *
 * @see alfDsl.AlfDslPackage#getClassificationToClause()
 * @model
 * @generated
 */
public interface ClassificationToClause extends EObject {
	 ...
	 * @see alfDsl.AlfDslPackage#getClassificationToClause_QualifiedNameList()
	...
	/**
	 * Sets the value of the '{@link alfDsl.ClassificationToClause#getQualifiedNameList <em>Qualified Name List</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
