 ...
 * <ul>
 *   <li>{@link alfDsl.impl.InclusiveOrExpressionImpl#getExp <em>Exp</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InclusiveOrExpressionImpl extends EObjectImpl implements InclusiveOrExpression {
	...
	protected EClass eStaticClass() {
		return AlfDslPackage.Literals.INCLUSIVE_OR_EXPRESSION;
	}
	...
	public EList getExp() {
		if (exp == null) {
			exp = new EObjectContainmentEList(ExclusiveOrExpression.class, this, AlfDslPackage.INCLUSIVE_OR_EXPRESSION__EXP);
		}
		return exp;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AlfDslPackage.INCLUSIVE_OR_EXPRESSION__EXP:
