 ...
 * <ul>
 *   <li>{@link alfDsl.impl.ClassificationFromClauseImpl#getQualifiedNameList <em>Qualified Name List</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ClassificationFromClauseImpl extends EObjectImpl implements ClassificationFromClause {
	...
	protected EClass eStaticClass() {
		return AlfDslPackage.Literals.CLASSIFICATION_FROM_CLAUSE;
	}
	...
	public NotificationChain basicSetQualifiedNameList(QualifiedNameList newQualifiedNameList, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AlfDslPackage.CLASSIFICATION_FROM_CLAUSE__QUALIFIED_NAME_LIST, oldQualifiedNameList, newQualifiedNameList);
	...
	public void setQualifiedNameList(QualifiedNameList newQualifiedNameList) {
		if (newQualifiedNameList != qualifiedNameList) {
			...
			if (qualifiedNameList != null)
				msgs = ((InternalEObject)qualifiedNameList).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AlfDslPackage.CLASSIFICATION_FROM_CLAUSE__QUALIFIED_NAME_LIST, null, msgs);
			if (newQualifiedNameList != null)
				msgs = ((InternalEObject)newQualifiedNameList).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AlfDslPackage.CLASSIFICATION_FROM_CLAUSE__QUALIFIED_NAME_LIST, null, msgs);
			msgs = basicSetQualifiedNameList(newQualifiedNameList, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AlfDslPackage.CLASSIFICATION_FROM_CLAUSE__QUALIFIED_NAME_LIST, newQualifiedNameList, newQualifiedNameList));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AlfDslPackage.CLASSIFICATION_FROM_CLAUSE__QUALIFIED_NAME_LIST:
