 ...
 * <ul>
 *   <li>{@link alfDsl.impl.ConcurrentClausesImpl#getNonFinalClause <em>Non Final Clause</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConcurrentClausesImpl extends EObjectImpl implements ConcurrentClauses {
	...
	protected EClass eStaticClass() {
		return AlfDslPackage.Literals.CONCURRENT_CLAUSES;
	}
	...
	public EList getNonFinalClause() {
		if (nonFinalClause == null) {
			nonFinalClause = new EObjectContainmentEList(NonFinalClause.class, this, AlfDslPackage.CONCURRENT_CLAUSES__NON_FINAL_CLAUSE);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AlfDslPackage.CONCURRENT_CLAUSES__NON_FINAL_CLAUSE:
