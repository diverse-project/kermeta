 ...
 * <ul>
 *   <li>{@link alfDsl.impl.InstanceCreationInvocationStatementImpl#get_new <em>new</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InstanceCreationInvocationStatementImpl extends StatementImpl implements InstanceCreationInvocationStatement {
	...
	protected EClass eStaticClass() {
		return AlfDslPackage.Literals.INSTANCE_CREATION_INVOCATION_STATEMENT;
	}
	...
	public NotificationChain basicSet_new(InstanceCreationExpression new_new, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AlfDslPackage.INSTANCE_CREATION_INVOCATION_STATEMENT__NEW, old_new, new_new);
	...
	public void set_new(InstanceCreationExpression new_new) {
		if (new_new != _new) {
			...
			if (_new != null)
				msgs = ((InternalEObject)_new).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AlfDslPackage.INSTANCE_CREATION_INVOCATION_STATEMENT__NEW, null, msgs);
			if (new_new != null)
				msgs = ((InternalEObject)new_new).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AlfDslPackage.INSTANCE_CREATION_INVOCATION_STATEMENT__NEW, null, msgs);
			msgs = basicSet_new(new_new, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AlfDslPackage.INSTANCE_CREATION_INVOCATION_STATEMENT__NEW, new_new, new_new));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AlfDslPackage.INSTANCE_CREATION_INVOCATION_STATEMENT__NEW:
