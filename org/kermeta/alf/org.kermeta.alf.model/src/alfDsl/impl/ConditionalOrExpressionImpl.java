 ...
 * <ul>
 *   <li>{@link alfDsl.impl.ConditionalOrExpressionImpl#getExp <em>Exp</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConditionalOrExpressionImpl extends EObjectImpl implements ConditionalOrExpression {
	...
	protected EClass eStaticClass() {
		return AlfDslPackage.Literals.CONDITIONAL_OR_EXPRESSION;
	}
	...
	public EList getExp() {
		if (exp == null) {
			exp = new EObjectContainmentEList(ConditionalAndExpression.class, this, AlfDslPackage.CONDITIONAL_OR_EXPRESSION__EXP);
		}
		return exp;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AlfDslPackage.CONDITIONAL_OR_EXPRESSION__EXP:
