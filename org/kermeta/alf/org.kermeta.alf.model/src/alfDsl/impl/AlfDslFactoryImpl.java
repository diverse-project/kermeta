 ...
 * @generated
 */
public class AlfDslFactoryImpl extends EFactoryImpl implements AlfDslFactory {
	/**
	 ...
	 * @generated
	 */
	public static AlfDslFactory init() {
		try {
			AlfDslFactory theAlfDslFactory = (AlfDslFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.kermeta.org/alf/AlfDsl"); 
			if (theAlfDslFactory != null) {
				return theAlfDslFactory;
			}
		}
		catch (Exception exception) {
			EcorePlugin.INSTANCE.log(exception);
		}
		return new AlfDslFactoryImpl();
	}
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case AlfDslPackage.CLASSSTRUCT: return createCLASSSTRUCT();
			case AlfDslPackage.CLASSOP: return createCLASSOP();
			case AlfDslPackage.LITERAL: return createLITERAL();
			case AlfDslPackage.BOOLEAN_LITERAL: return createBOOLEAN_LITERAL();
			case AlfDslPackage.NUMBER_LITERAL: return createNUMBER_LITERAL();
			case AlfDslPackage.INTEGER_LITERAL: return createINTEGER_LITERAL();
			case AlfDslPackage.UNLIMITED_LITERAL: return createUNLIMITED_LITERAL();
			case AlfDslPackage.STRING_LITERAL: return createSTRING_LITERAL();
			case AlfDslPackage.NAME_EXPRESSION: return createNameExpression();
			case AlfDslPackage.QUALIFIED_NAME_PATH: return createQualifiedNamePath();
			case AlfDslPackage.UNQUALIFIED_NAME: return createUnqualifiedName();
			case AlfDslPackage.TEMPLATE_BINDING: return createTemplateBinding();
			case AlfDslPackage.NAMED_TEMPLATE_BINDING: return createNamedTemplateBinding();
			case AlfDslPackage.QUALIFIED_NAME_WITH_BINDING: return createQualifiedNameWithBinding();
			case AlfDslPackage.TUPLE: return createTuple();
			case AlfDslPackage.TUPLE_ELEMENT: return createTupleElement();
			case AlfDslPackage.EXPRESSION: return createExpression();
			case AlfDslPackage.CONDITIONAL_TEST_EXPRESSION: return createConditionalTestExpression();
			case AlfDslPackage.CONDITIONAL_OR_EXPRESSION: return createConditionalOrExpression();
			case AlfDslPackage.CONDITIONAL_AND_EXPRESSION: return createConditionalAndExpression();
			case AlfDslPackage.INCLUSIVE_OR_EXPRESSION: return createInclusiveOrExpression();
			case AlfDslPackage.EXCLUSIVE_OR_EXPRESSION: return createExclusiveOrExpression();
			case AlfDslPackage.AND_EXPRESSION: return createAndExpression();
			case AlfDslPackage.EQUALITY_EXPRESSION: return createEqualityExpression();
			case AlfDslPackage.CLASSIFICATION_EXPRESSION: return createClassificationExpression();
			case AlfDslPackage.RELATIONAL_EXPRESSION: return createRelationalExpression();
			case AlfDslPackage.SHIFT_EXPRESSION: return createShiftExpression();
			case AlfDslPackage.ADDITIVE_EXPRESSION: return createAdditiveExpression();
			case AlfDslPackage.MULTIPLICATIVE_EXPRESSION: return createMultiplicativeExpression();
			case AlfDslPackage.UNARY_EXPRESSION: return createUnaryExpression();
			case AlfDslPackage.PRIMARY_EXPRESSION: return createPrimaryExpression();
			case AlfDslPackage.SUFFIX_EXPRESSION: return createSuffixExpression();
			case AlfDslPackage.OPERATION_CALL_EXPRESSION: return createOperationCallExpression();
			case AlfDslPackage.OPERATION_CALL_EXPRESSION_WITHOUT_DOT: return createOperationCallExpressionWithoutDot();
			case AlfDslPackage.PROPERTY_CALL_EXPRESSION: return createPropertyCallExpression();
			case AlfDslPackage.LINK_OPERATION_EXPRESSION: return createLinkOperationExpression();
			case AlfDslPackage.LINK_OPERATION_TUPLE: return createLinkOperationTuple();
			case AlfDslPackage.LINK_OPERATION_TUPLE_ELEMENT: return createLinkOperationTupleElement();
			case AlfDslPackage.SEQUENCE_OPERATION_EXPRESSION: return createSequenceOperationExpression();
			case AlfDslPackage.SEQUENCE_REDUCTION_EXPRESSION: return createSequenceReductionExpression();
			case AlfDslPackage.SEQUENCE_EXPANSION_EXPRESSION: return createSequenceExpansionExpression();
			case AlfDslPackage.SELECT_OR_REJECT_OPERATION: return createSelectOrRejectOperation();
			case AlfDslPackage.COLLECT_OR_ITERATE_OPERATION: return createCollectOrIterateOperation();
			case AlfDslPackage.FOR_ALL_OR_EXISTS_OR_ONE_OPERATION: return createForAllOrExistsOrOneOperation();
			case AlfDslPackage.IS_UNIQUE_OPERATION: return createIsUniqueOperation();
			case AlfDslPackage.VALUE_SPECIFICATION: return createValueSpecification();
			case AlfDslPackage.NON_LITERAL_VALUE_SPECIFICATION: return createNonLiteralValueSpecification();
			case AlfDslPackage.PARENTHESIZED_EXPRESSION: return createParenthesizedExpression();
			case AlfDslPackage.NULL_EXPRESSION: return createNullExpression();
			case AlfDslPackage.THIS_EXPRESSION: return createThisExpression();
			case AlfDslPackage.SUPER_INVOCATION_EXPRESSION: return createSuperInvocationExpression();
			case AlfDslPackage.INSTANCE_CREATION_EXPRESSION: return createInstanceCreationExpression();
			case AlfDslPackage.SEQUENCE_CONSTRUCTION_OR_ACCESS_COMPLETION: return createSequenceConstructionOrAccessCompletion();
			case AlfDslPackage.ACCESS_COMPLETION: return createAccessCompletion();
			case AlfDslPackage.PARTIAL_SEQUENCE_CONSTRUCTION_COMPLETION: return createPartialSequenceConstructionCompletion();
			case AlfDslPackage.SEQUENCE_CONSTRUCTION_COMPLETION: return createSequenceConstructionCompletion();
			case AlfDslPackage.SEQUENCE_CONSTRUCTION_EXPRESSION: return createSequenceConstructionExpression();
			case AlfDslPackage.SEQUENCE_ELEMENT: return createSequenceElement();
			case AlfDslPackage.CLASS_EXTENT_EXPRESSION: return createClassExtentExpression();
			case AlfDslPackage.BLOCK: return createBlock();
			case AlfDslPackage.STATEMENT_SEQUENCE: return createStatementSequence();
			case AlfDslPackage.INLINE_STATEMENT: return createInlineStatement();
			case AlfDslPackage.ANNOTATED_STATEMENT: return createAnnotatedStatement();
			case AlfDslPackage.DOCUMENTED_STATEMENT: return createDocumentedStatement();
			case AlfDslPackage.STATEMENT: return createStatement();
			case AlfDslPackage.ANNOTATION: return createAnnotation();
			case AlfDslPackage.BLOCK_STATEMENT: return createBlockStatement();
			case AlfDslPackage.EMPTY_STATEMENT: return createEmptyStatement();
			case AlfDslPackage.LOCAL_NAME_DECLARATION_STATEMENT: return createLocalNameDeclarationStatement();
			case AlfDslPackage.IF_STATEMENT: return createIfStatement();
			case AlfDslPackage.SEQUENTIAL_CLAUSES: return createSequentialClauses();
			case AlfDslPackage.CONCURRENT_CLAUSES: return createConcurrentClauses();
			case AlfDslPackage.NON_FINAL_CLAUSE: return createNonFinalClause();
			case AlfDslPackage.FINAL_CLAUSE: return createFinalClause();
			case AlfDslPackage.SWITCH_STATEMENT: return createSwitchStatement();
			case AlfDslPackage.SWITCH_CLAUSE: return createSwitchClause();
			case AlfDslPackage.SWITCH_CASE: return createSwitchCase();
			case AlfDslPackage.SWITCH_DEFAULT_CLAUSE: return createSwitchDefaultClause();
			case AlfDslPackage.NON_EMPTY_STATEMENT_SEQUENCE: return createNonEmptyStatementSequence();
			case AlfDslPackage.WHILE_STATEMENT: return createWhileStatement();
			case AlfDslPackage.DO_STATEMENT: return createDoStatement();
			case AlfDslPackage.FOR_STATEMENT: return createForStatement();
			case AlfDslPackage.FOR_CONTROL: return createForControl();
			case AlfDslPackage.LOOP_VARIABLE_DEFINITION: return createLoopVariableDefinition();
			case AlfDslPackage.BREAK_STATEMENT: return createBreakStatement();
			case AlfDslPackage.RETURN_STATEMENT: return createReturnStatement();
			case AlfDslPackage.ACCEPT_STATEMENT: return createAcceptStatement();
			case AlfDslPackage.SIMPLE_ACCEPT_STATEMENT_COMPLETION: return createSimpleAcceptStatementCompletion();
			case AlfDslPackage.COMPOUND_ACCEPT_STATEMENT_COMPLETION: return createCompoundAcceptStatementCompletion();
			case AlfDslPackage.ACCEPT_BLOCK: return createAcceptBlock();
			case AlfDslPackage.ACCEPT_CLAUSE: return createAcceptClause();
			case AlfDslPackage.CLASSIFY_STATEMENT: return createClassifyStatement();
			case AlfDslPackage.CLASSIFICATION_CLAUSE: return createClassificationClause();
			case AlfDslPackage.CLASSIFICATION_FROM_CLAUSE: return createClassificationFromClause();
			case AlfDslPackage.CLASSIFICATION_TO_CLAUSE: return createClassificationToClause();
			case AlfDslPackage.RECLASSIFY_ALL_CLAUSE: return createReclassifyAllClause();
			case AlfDslPackage.QUALIFIED_NAME_LIST: return createQualifiedNameList();
			case AlfDslPackage.INVOCATION_OR_ASSIGNEMENT_OR_DECLARATION_STATEMENT: return createInvocationOrAssignementOrDeclarationStatement();
			case AlfDslPackage.SUPER_INVOCATION_STATEMENT: return createSuperInvocationStatement();
			case AlfDslPackage.THIS_INVOCATION_STATEMENT: return createThisInvocationStatement();
			case AlfDslPackage.INSTANCE_CREATION_INVOCATION_STATEMENT: return createInstanceCreationInvocationStatement();
			case AlfDslPackage.VARIABLE_DECLARATION_COMPLETION: return createVariableDeclarationCompletion();
			case AlfDslPackage.ASSIGNMENT_COMPLETION: return createAssignmentCompletion();
			default:
	 ...
	 * @generated
	 */
	public CLASSSTRUCT createCLASSSTRUCT() {
		CLASSSTRUCTImpl classstruct = new CLASSSTRUCTImpl();
		return classstruct;
	}
	 ...
	 * @generated
	 */
	public AlfDslPackage getAlfDslPackage() {
		return (AlfDslPackage)getEPackage();
	}
	 ...
	 * @generated
	 */
	public static AlfDslPackage getPackage() {
		return AlfDslPackage.eINSTANCE;
	}
