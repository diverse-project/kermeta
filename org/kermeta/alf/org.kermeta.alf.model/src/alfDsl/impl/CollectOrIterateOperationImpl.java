 ...
 * <ul>
 *   <li>{@link alfDsl.impl.CollectOrIterateOperationImpl#getOp <em>Op</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CollectOrIterateOperationImpl extends SequenceExpansionExpressionImpl implements CollectOrIterateOperation {
	 ...
	 * @ordered
	 */
	protected static final CollectOrIterateOperator OP_EDEFAULT = CollectOrIterateOperator.COLLECT_LITERAL;
	...
	protected EClass eStaticClass() {
		return AlfDslPackage.Literals.COLLECT_OR_ITERATE_OPERATION;
	}
	...
	public void setOp(CollectOrIterateOperator newOp) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AlfDslPackage.COLLECT_OR_ITERATE_OPERATION__OP, oldOp, op));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AlfDslPackage.COLLECT_OR_ITERATE_OPERATION__OP:
				return getOp();
		}
