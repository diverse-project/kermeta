 ...
 * <ul>
 *   <li>{@link alfDsl.impl.ForAllOrExistsOrOneOperationImpl#getOp <em>Op</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ForAllOrExistsOrOneOperationImpl extends SequenceExpansionExpressionImpl implements ForAllOrExistsOrOneOperation {
	...
	protected EClass eStaticClass() {
		return AlfDslPackage.Literals.FOR_ALL_OR_EXISTS_OR_ONE_OPERATION;
	}
	...
	public void setOp(ForAllOrExistsOrOneOperator newOp) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AlfDslPackage.FOR_ALL_OR_EXISTS_OR_ONE_OPERATION__OP, oldOp, op));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AlfDslPackage.FOR_ALL_OR_EXISTS_OR_ONE_OPERATION__OP:
				return getOp();
		}
