 ...
 * <ul>
 *   <li>{@link alfDsl.impl.SuperInvocationExpressionImpl#getClassName <em>Class Name</em>}</li>
 *   <li>{@link alfDsl.impl.SuperInvocationExpressionImpl#getOperationCallWithoutDot <em>Operation Call Without Dot</em>}</li>
 *   <li>{@link alfDsl.impl.SuperInvocationExpressionImpl#getOperationCall <em>Operation Call</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SuperInvocationExpressionImpl extends ValueSpecificationImpl implements SuperInvocationExpression {
	...
	protected EClass eStaticClass() {
		return AlfDslPackage.Literals.SUPER_INVOCATION_EXPRESSION;
	}
	...
	public void setClassName(String newClassName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AlfDslPackage.SUPER_INVOCATION_EXPRESSION__CLASS_NAME, oldClassName, className));
	}
	...
	public NotificationChain basicSetOperationCallWithoutDot(OperationCallExpressionWithoutDot newOperationCallWithoutDot, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AlfDslPackage.SUPER_INVOCATION_EXPRESSION__OPERATION_CALL_WITHOUT_DOT, oldOperationCallWithoutDot, newOperationCallWithoutDot);
	...
	public void setOperationCallWithoutDot(OperationCallExpressionWithoutDot newOperationCallWithoutDot) {
		if (newOperationCallWithoutDot != operationCallWithoutDot) {
			...
			if (operationCallWithoutDot != null)
				msgs = ((InternalEObject)operationCallWithoutDot).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AlfDslPackage.SUPER_INVOCATION_EXPRESSION__OPERATION_CALL_WITHOUT_DOT, null, msgs);
			if (newOperationCallWithoutDot != null)
				msgs = ((InternalEObject)newOperationCallWithoutDot).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AlfDslPackage.SUPER_INVOCATION_EXPRESSION__OPERATION_CALL_WITHOUT_DOT, null, msgs);
			msgs = basicSetOperationCallWithoutDot(newOperationCallWithoutDot, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AlfDslPackage.SUPER_INVOCATION_EXPRESSION__OPERATION_CALL_WITHOUT_DOT, newOperationCallWithoutDot, newOperationCallWithoutDot));
	}
	...
	public NotificationChain basicSetOperationCall(OperationCallExpression newOperationCall, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AlfDslPackage.SUPER_INVOCATION_EXPRESSION__OPERATION_CALL, oldOperationCall, newOperationCall);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setOperationCall(OperationCallExpression newOperationCall) {
		if (newOperationCall != operationCall) {
			...
			if (operationCall != null)
				msgs = ((InternalEObject)operationCall).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AlfDslPackage.SUPER_INVOCATION_EXPRESSION__OPERATION_CALL, null, msgs);
			if (newOperationCall != null)
				msgs = ((InternalEObject)newOperationCall).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AlfDslPackage.SUPER_INVOCATION_EXPRESSION__OPERATION_CALL, null, msgs);
			msgs = basicSetOperationCall(newOperationCall, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AlfDslPackage.SUPER_INVOCATION_EXPRESSION__OPERATION_CALL, newOperationCall, newOperationCall));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AlfDslPackage.SUPER_INVOCATION_EXPRESSION__OPERATION_CALL_WITHOUT_DOT:
				return basicSetOperationCallWithoutDot(null, msgs);
			case AlfDslPackage.SUPER_INVOCATION_EXPRESSION__OPERATION_CALL:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AlfDslPackage.SUPER_INVOCATION_EXPRESSION__CLASS_NAME:
				return getClassName();
			case AlfDslPackage.SUPER_INVOCATION_EXPRESSION__OPERATION_CALL_WITHOUT_DOT:
