 ...
 * <ul>
 *   <li>{@link alfDsl.impl.InlineStatementImpl#getLangageName <em>Langage Name</em>}</li>
 *   <li>{@link alfDsl.impl.InlineStatementImpl#getBody <em>Body</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InlineStatementImpl extends StatementImpl implements InlineStatement {
	...
	protected EClass eStaticClass() {
		return AlfDslPackage.Literals.INLINE_STATEMENT;
	}
	...
	public void setLangageName(String newLangageName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AlfDslPackage.INLINE_STATEMENT__LANGAGE_NAME, oldLangageName, langageName));
	}
	...
	public void setBody(String newBody) {
		...
		body = newBody;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AlfDslPackage.INLINE_STATEMENT__BODY, oldBody, body));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AlfDslPackage.INLINE_STATEMENT__LANGAGE_NAME:
				return getLangageName();
			case AlfDslPackage.INLINE_STATEMENT__BODY:
				return getBody();
		}
