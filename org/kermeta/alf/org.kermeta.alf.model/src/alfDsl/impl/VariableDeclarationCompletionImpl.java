 ...
 * <ul>
 *   <li>{@link alfDsl.impl.VariableDeclarationCompletionImpl#isMultiplicityIndicator <em>Multiplicity Indicator</em>}</li>
 *   <li>{@link alfDsl.impl.VariableDeclarationCompletionImpl#getVariableName <em>Variable Name</em>}</li>
 *   <li>{@link alfDsl.impl.VariableDeclarationCompletionImpl#getInitValue <em>Init Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class VariableDeclarationCompletionImpl extends EObjectImpl implements VariableDeclarationCompletion {
	/**
	...
	protected EClass eStaticClass() {
		return AlfDslPackage.Literals.VARIABLE_DECLARATION_COMPLETION;
	}
	...
	public void setMultiplicityIndicator(boolean newMultiplicityIndicator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AlfDslPackage.VARIABLE_DECLARATION_COMPLETION__MULTIPLICITY_INDICATOR, oldMultiplicityIndicator, multiplicityIndicator));
	}
	...
	public void setVariableName(String newVariableName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AlfDslPackage.VARIABLE_DECLARATION_COMPLETION__VARIABLE_NAME, oldVariableName, variableName));
	}
	...
	public NotificationChain basicSetInitValue(AssignmentCompletion newInitValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AlfDslPackage.VARIABLE_DECLARATION_COMPLETION__INIT_VALUE, oldInitValue, newInitValue);
	...
	public void setInitValue(AssignmentCompletion newInitValue) {
		if (newInitValue != initValue) {
			...
			if (initValue != null)
				msgs = ((InternalEObject)initValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AlfDslPackage.VARIABLE_DECLARATION_COMPLETION__INIT_VALUE, null, msgs);
			if (newInitValue != null)
				msgs = ((InternalEObject)newInitValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AlfDslPackage.VARIABLE_DECLARATION_COMPLETION__INIT_VALUE, null, msgs);
			msgs = basicSetInitValue(newInitValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AlfDslPackage.VARIABLE_DECLARATION_COMPLETION__INIT_VALUE, newInitValue, newInitValue));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AlfDslPackage.VARIABLE_DECLARATION_COMPLETION__INIT_VALUE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AlfDslPackage.VARIABLE_DECLARATION_COMPLETION__MULTIPLICITY_INDICATOR:
				return isMultiplicityIndicator() ? Boolean.TRUE : Boolean.FALSE;
			case AlfDslPackage.VARIABLE_DECLARATION_COMPLETION__VARIABLE_NAME:
