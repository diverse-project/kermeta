 ...
 * <ul>
 *   <li>{@link alfDsl.impl.ThisInvocationStatementImpl#get_this <em>this</em>}</li>
 *   <li>{@link alfDsl.impl.ThisInvocationStatementImpl#getAssignmentCompletion <em>Assignment Completion</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ThisInvocationStatementImpl extends StatementImpl implements ThisInvocationStatement {
	...
	protected EClass eStaticClass() {
		return AlfDslPackage.Literals.THIS_INVOCATION_STATEMENT;
	}
	...
	public NotificationChain basicSet_this(ThisExpression new_this, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AlfDslPackage.THIS_INVOCATION_STATEMENT__THIS, old_this, new_this);
	...
	public void set_this(ThisExpression new_this) {
		if (new_this != _this) {
			...
			if (_this != null)
				msgs = ((InternalEObject)_this).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AlfDslPackage.THIS_INVOCATION_STATEMENT__THIS, null, msgs);
			if (new_this != null)
				msgs = ((InternalEObject)new_this).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AlfDslPackage.THIS_INVOCATION_STATEMENT__THIS, null, msgs);
			msgs = basicSet_this(new_this, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AlfDslPackage.THIS_INVOCATION_STATEMENT__THIS, new_this, new_this));
	}
	...
	public NotificationChain basicSetAssignmentCompletion(AssignmentCompletion newAssignmentCompletion, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AlfDslPackage.THIS_INVOCATION_STATEMENT__ASSIGNMENT_COMPLETION, oldAssignmentCompletion, newAssignmentCompletion);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAssignmentCompletion(AssignmentCompletion newAssignmentCompletion) {
		if (newAssignmentCompletion != assignmentCompletion) {
			...
			if (assignmentCompletion != null)
				msgs = ((InternalEObject)assignmentCompletion).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AlfDslPackage.THIS_INVOCATION_STATEMENT__ASSIGNMENT_COMPLETION, null, msgs);
			if (newAssignmentCompletion != null)
				msgs = ((InternalEObject)newAssignmentCompletion).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AlfDslPackage.THIS_INVOCATION_STATEMENT__ASSIGNMENT_COMPLETION, null, msgs);
			msgs = basicSetAssignmentCompletion(newAssignmentCompletion, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AlfDslPackage.THIS_INVOCATION_STATEMENT__ASSIGNMENT_COMPLETION, newAssignmentCompletion, newAssignmentCompletion));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AlfDslPackage.THIS_INVOCATION_STATEMENT__THIS:
				return basicSet_this(null, msgs);
			case AlfDslPackage.THIS_INVOCATION_STATEMENT__ASSIGNMENT_COMPLETION:
