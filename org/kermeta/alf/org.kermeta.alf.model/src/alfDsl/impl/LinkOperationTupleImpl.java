 ...
 * <ul>
 *   <li>{@link alfDsl.impl.LinkOperationTupleImpl#getLinkOperationTupleElement <em>Link Operation Tuple Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LinkOperationTupleImpl extends EObjectImpl implements LinkOperationTuple {
	...
	protected EClass eStaticClass() {
		return AlfDslPackage.Literals.LINK_OPERATION_TUPLE;
	}
	...
	public EList getLinkOperationTupleElement() {
		if (linkOperationTupleElement == null) {
			linkOperationTupleElement = new EObjectContainmentEList(LinkOperationTupleElement.class, this, AlfDslPackage.LINK_OPERATION_TUPLE__LINK_OPERATION_TUPLE_ELEMENT);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AlfDslPackage.LINK_OPERATION_TUPLE__LINK_OPERATION_TUPLE_ELEMENT:
