 ...
 * <ul>
 *   <li>{@link alfDsl.impl.ClassificationClauseImpl#getClassifyFromClause <em>Classify From Clause</em>}</li>
 *   <li>{@link alfDsl.impl.ClassificationClauseImpl#getClassifyToClause <em>Classify To Clause</em>}</li>
 *   <li>{@link alfDsl.impl.ClassificationClauseImpl#getReclassyAllClause <em>Reclassy All Clause</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ClassificationClauseImpl extends EObjectImpl implements ClassificationClause {
	/**
	...
	protected EClass eStaticClass() {
		return AlfDslPackage.Literals.CLASSIFICATION_CLAUSE;
	}
	...
	public NotificationChain basicSetClassifyFromClause(ClassificationFromClause newClassifyFromClause, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AlfDslPackage.CLASSIFICATION_CLAUSE__CLASSIFY_FROM_CLAUSE, oldClassifyFromClause, newClassifyFromClause);
	...
	public void setClassifyFromClause(ClassificationFromClause newClassifyFromClause) {
		if (newClassifyFromClause != classifyFromClause) {
			...
			if (classifyFromClause != null)
				msgs = ((InternalEObject)classifyFromClause).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AlfDslPackage.CLASSIFICATION_CLAUSE__CLASSIFY_FROM_CLAUSE, null, msgs);
			if (newClassifyFromClause != null)
				msgs = ((InternalEObject)newClassifyFromClause).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AlfDslPackage.CLASSIFICATION_CLAUSE__CLASSIFY_FROM_CLAUSE, null, msgs);
			msgs = basicSetClassifyFromClause(newClassifyFromClause, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AlfDslPackage.CLASSIFICATION_CLAUSE__CLASSIFY_FROM_CLAUSE, newClassifyFromClause, newClassifyFromClause));
	}
	...
	public NotificationChain basicSetClassifyToClause(ClassificationToClause newClassifyToClause, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AlfDslPackage.CLASSIFICATION_CLAUSE__CLASSIFY_TO_CLAUSE, oldClassifyToClause, newClassifyToClause);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setClassifyToClause(ClassificationToClause newClassifyToClause) {
		if (newClassifyToClause != classifyToClause) {
			...
			if (classifyToClause != null)
				msgs = ((InternalEObject)classifyToClause).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AlfDslPackage.CLASSIFICATION_CLAUSE__CLASSIFY_TO_CLAUSE, null, msgs);
			if (newClassifyToClause != null)
				msgs = ((InternalEObject)newClassifyToClause).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AlfDslPackage.CLASSIFICATION_CLAUSE__CLASSIFY_TO_CLAUSE, null, msgs);
			msgs = basicSetClassifyToClause(newClassifyToClause, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AlfDslPackage.CLASSIFICATION_CLAUSE__CLASSIFY_TO_CLAUSE, newClassifyToClause, newClassifyToClause));
	}
	...
	public NotificationChain basicSetReclassyAllClause(ReclassifyAllClause newReclassyAllClause, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AlfDslPackage.CLASSIFICATION_CLAUSE__RECLASSY_ALL_CLAUSE, oldReclassyAllClause, newReclassyAllClause);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setReclassyAllClause(ReclassifyAllClause newReclassyAllClause) {
		if (newReclassyAllClause != reclassyAllClause) {
			...
			if (reclassyAllClause != null)
				msgs = ((InternalEObject)reclassyAllClause).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AlfDslPackage.CLASSIFICATION_CLAUSE__RECLASSY_ALL_CLAUSE, null, msgs);
			if (newReclassyAllClause != null)
				msgs = ((InternalEObject)newReclassyAllClause).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AlfDslPackage.CLASSIFICATION_CLAUSE__RECLASSY_ALL_CLAUSE, null, msgs);
			msgs = basicSetReclassyAllClause(newReclassyAllClause, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AlfDslPackage.CLASSIFICATION_CLAUSE__RECLASSY_ALL_CLAUSE, newReclassyAllClause, newReclassyAllClause));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AlfDslPackage.CLASSIFICATION_CLAUSE__CLASSIFY_FROM_CLAUSE:
				return basicSetClassifyFromClause(null, msgs);
			case AlfDslPackage.CLASSIFICATION_CLAUSE__CLASSIFY_TO_CLAUSE:
				return basicSetClassifyToClause(null, msgs);
			case AlfDslPackage.CLASSIFICATION_CLAUSE__RECLASSY_ALL_CLAUSE:
