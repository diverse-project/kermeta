 ...
 * <ul>
 *   <li>{@link alfDsl.impl.TemplateBindingImpl#getBindings <em>Bindings</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TemplateBindingImpl extends EObjectImpl implements TemplateBinding {
	...
	protected EClass eStaticClass() {
		return AlfDslPackage.Literals.TEMPLATE_BINDING;
	}
	...
	public EList getBindings() {
		if (bindings == null) {
			bindings = new EObjectContainmentEList(NamedTemplateBinding.class, this, AlfDslPackage.TEMPLATE_BINDING__BINDINGS);
		}
		return bindings;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AlfDslPackage.TEMPLATE_BINDING__BINDINGS:
