 ...
 * <ul>
 *   <li>{@link alfDsl.impl.ForControlImpl#getLoopVariableDefinition <em>Loop Variable Definition</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ForControlImpl extends EObjectImpl implements ForControl {
	...
	protected EClass eStaticClass() {
		return AlfDslPackage.Literals.FOR_CONTROL;
	}
	...
	public EList getLoopVariableDefinition() {
		if (loopVariableDefinition == null) {
			loopVariableDefinition = new EObjectContainmentEList(LoopVariableDefinition.class, this, AlfDslPackage.FOR_CONTROL__LOOP_VARIABLE_DEFINITION);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AlfDslPackage.FOR_CONTROL__LOOP_VARIABLE_DEFINITION:
