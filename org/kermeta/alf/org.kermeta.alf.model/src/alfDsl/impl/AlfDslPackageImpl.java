...
import alfDsl.AcceptStatement;
import alfDsl.AccessCompletion;
import alfDsl.AdditiveExpression;
import alfDsl.AlfDslFactory;
import alfDsl.AlfDslPackage;
import alfDsl.AndExpression;
import alfDsl.AnnotatedStatement;
import alfDsl.Annotation;
import alfDsl.AnnotationKind;
import alfDsl.AssignmentCompletion;
import alfDsl.AssignmentOperator;
import alfDsl.Block;
import alfDsl.BlockStatement;
import alfDsl.BooleanValue;
import alfDsl.BreakStatement;
import alfDsl.ClassExtentExpression;
import alfDsl.ClassificationClause;
import alfDsl.ClassificationExpression;
import alfDsl.ClassificationFromClause;
import alfDsl.ClassificationToClause;
import alfDsl.ClassifyStatement;
import alfDsl.CollectOrIterateOperation;
import alfDsl.CollectOrIterateOperator;
import alfDsl.CompoundAcceptStatementCompletion;
import alfDsl.ConcurrentClauses;
import alfDsl.ConditionalAndExpression;
import alfDsl.ConditionalOrExpression;
import alfDsl.ConditionalTestExpression;
import alfDsl.DoStatement;
import alfDsl.DocumentedStatement;
import alfDsl.EmptyStatement;
import alfDsl.EqualityExpression;
import alfDsl.ExclusiveOrExpression;
import alfDsl.Expression;
import alfDsl.FinalClause;
import alfDsl.ForAllOrExistsOrOneOperation;
import alfDsl.ForAllOrExistsOrOneOperator;
import alfDsl.ForControl;
import alfDsl.ForStatement;
import alfDsl.IfStatement;
import alfDsl.InclusiveOrExpression;
import alfDsl.InlineStatement;
import alfDsl.InstanceCreationExpression;
import alfDsl.InstanceCreationInvocationStatement;
import alfDsl.InvocationOrAssignementOrDeclarationStatement;
import alfDsl.IsUniqueOperation;
...
import alfDsl.LocalNameDeclarationStatement;
import alfDsl.LoopVariableDefinition;
...
import alfDsl.NonFinalClause;
import alfDsl.NonLiteralValueSpecification;
import alfDsl.NullExpression;
import alfDsl.OperationCallExpression;
import alfDsl.OperationCallExpressionWithoutDot;
import alfDsl.ParenthesizedExpression;
import alfDsl.PartialSequenceConstructionCompletion;
import alfDsl.PrimaryExpression;
import alfDsl.PropertyCallExpression;
import alfDsl.QualifiedNameList;
import alfDsl.QualifiedNamePath;
import alfDsl.QualifiedNameWithBinding;
import alfDsl.ReclassifyAllClause;
import alfDsl.RelationalExpression;
import alfDsl.ReturnStatement;
...
import alfDsl.SequenceConstructionOrAccessCompletion;
import alfDsl.SequenceElement;
import alfDsl.SequenceExpansionExpression;
import alfDsl.SequenceOperationExpression;
import alfDsl.SequenceReductionExpression;
import alfDsl.SequentialClauses;
import alfDsl.ShiftExpression;
import alfDsl.SimpleAcceptStatementCompletion;
import alfDsl.Statement;
import alfDsl.StatementSequence;
 ...
 * @generated
 */
public class AlfDslPackageImpl extends EPackageImpl implements AlfDslPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see alfDsl.AlfDslPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private AlfDslPackageImpl() {
		super(eNS_URI, AlfDslFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link AlfDslPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static AlfDslPackage init() {
		if (isInited) return (AlfDslPackage)EPackage.Registry.INSTANCE.getEPackage(AlfDslPackage.eNS_URI);

		// Obtain or create and register package
		AlfDslPackageImpl theAlfDslPackage = (AlfDslPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof AlfDslPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new AlfDslPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theAlfDslPackage.createPackageContents();

		// Initialize created meta-data
		theAlfDslPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theAlfDslPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(AlfDslPackage.eNS_URI, theAlfDslPackage);
		return theAlfDslPackage;
	}
	 ...
	 * @generated
	 */
	public AlfDslFactory getAlfDslFactory() {
		return (AlfDslFactory)getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		initEClass(classstructEClass, alfDsl.CLASSSTRUCT.class, "CLASSSTRUCT", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getCLASSSTRUCT_Name(), ecorePackage.getEString(), "name", null, 0, 1, alfDsl.CLASSSTRUCT.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCLASSSTRUCT_Clsop(), this.getCLASSOP(), null, "clsop", null, 0, -1, alfDsl.CLASSSTRUCT.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(classopEClass, alfDsl.CLASSOP.class, "CLASSOP", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getCLASSOP_Name(), ecorePackage.getEString(), "name", null, 0, 1, alfDsl.CLASSOP.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCLASSOP_Stat(), this.getStatement(), null, "stat", null, 0, -1, alfDsl.CLASSOP.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(literalEClass, alfDsl.LITERAL.class, "LITERAL", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getLITERAL_Suffix(), this.getSuffixExpression(), null, "suffix", null, 0, 1, alfDsl.LITERAL.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(booleaN_LITERALEClass, alfDsl.BOOLEAN_LITERAL.class, "BOOLEAN_LITERAL", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getBOOLEAN_LITERAL_Value(), this.getBooleanValue(), "value", null, 0, 1, alfDsl.BOOLEAN_LITERAL.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(numbeR_LITERALEClass, alfDsl.NUMBER_LITERAL.class, "NUMBER_LITERAL", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getNUMBER_LITERAL_Value(), ecorePackage.getEString(), "value", null, 0, 1, alfDsl.NUMBER_LITERAL.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(integeR_LITERALEClass, alfDsl.INTEGER_LITERAL.class, "INTEGER_LITERAL", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(unlimiteD_LITERALEClass, alfDsl.UNLIMITED_LITERAL.class, "UNLIMITED_LITERAL", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(strinG_LITERALEClass, alfDsl.STRING_LITERAL.class, "STRING_LITERAL", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getSTRING_LITERAL_Value(), ecorePackage.getEString(), "value", null, 0, 1, alfDsl.STRING_LITERAL.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
