 ...
 * <ul>
 *   <li>{@link alfDsl.impl.NameExpressionImpl#getPrefixOp <em>Prefix Op</em>}</li>
 *   <li>{@link alfDsl.impl.NameExpressionImpl#getPath <em>Path</em>}</li>
 *   <li>{@link alfDsl.impl.NameExpressionImpl#getId <em>Id</em>}</li>
 *   <li>{@link alfDsl.impl.NameExpressionImpl#getInvocationCompletion <em>Invocation Completion</em>}</li>
 *   <li>{@link alfDsl.impl.NameExpressionImpl#getSequenceConstructionCompletion <em>Sequence Construction Completion</em>}</li>
 *   <li>{@link alfDsl.impl.NameExpressionImpl#getPostfixOp <em>Postfix Op</em>}</li>
 *   <li>{@link alfDsl.impl.NameExpressionImpl#getSuffix <em>Suffix</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NameExpressionImpl extends ValueSpecificationImpl implements NameExpression {
	...
	protected EClass eStaticClass() {
		return AlfDslPackage.Literals.NAME_EXPRESSION;
	}
	...
	public void setPrefixOp(String newPrefixOp) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AlfDslPackage.NAME_EXPRESSION__PREFIX_OP, oldPrefixOp, prefixOp));
	}
	...
	public NotificationChain basicSetPath(QualifiedNamePath newPath, NotificationChain msgs) {
		...
		path = newPath;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AlfDslPackage.NAME_EXPRESSION__PATH, oldPath, newPath);
	...
	public void setPath(QualifiedNamePath newPath) {
		if (newPath != path) {
			...
			if (path != null)
				msgs = ((InternalEObject)path).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AlfDslPackage.NAME_EXPRESSION__PATH, null, msgs);
			if (newPath != null)
				msgs = ((InternalEObject)newPath).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AlfDslPackage.NAME_EXPRESSION__PATH, null, msgs);
			msgs = basicSetPath(newPath, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AlfDslPackage.NAME_EXPRESSION__PATH, newPath, newPath));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AlfDslPackage.NAME_EXPRESSION__ID, oldId, id));
	}
	...
	public NotificationChain basicSetInvocationCompletion(Tuple newInvocationCompletion, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AlfDslPackage.NAME_EXPRESSION__INVOCATION_COMPLETION, oldInvocationCompletion, newInvocationCompletion);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setInvocationCompletion(Tuple newInvocationCompletion) {
		if (newInvocationCompletion != invocationCompletion) {
			...
			if (invocationCompletion != null)
				msgs = ((InternalEObject)invocationCompletion).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AlfDslPackage.NAME_EXPRESSION__INVOCATION_COMPLETION, null, msgs);
			if (newInvocationCompletion != null)
				msgs = ((InternalEObject)newInvocationCompletion).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AlfDslPackage.NAME_EXPRESSION__INVOCATION_COMPLETION, null, msgs);
			msgs = basicSetInvocationCompletion(newInvocationCompletion, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AlfDslPackage.NAME_EXPRESSION__INVOCATION_COMPLETION, newInvocationCompletion, newInvocationCompletion));
	}
	...
	public NotificationChain basicSetSequenceConstructionCompletion(SequenceConstructionOrAccessCompletion newSequenceConstructionCompletion, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AlfDslPackage.NAME_EXPRESSION__SEQUENCE_CONSTRUCTION_COMPLETION, oldSequenceConstructionCompletion, newSequenceConstructionCompletion);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSequenceConstructionCompletion(SequenceConstructionOrAccessCompletion newSequenceConstructionCompletion) {
		if (newSequenceConstructionCompletion != sequenceConstructionCompletion) {
			...
			if (sequenceConstructionCompletion != null)
				msgs = ((InternalEObject)sequenceConstructionCompletion).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AlfDslPackage.NAME_EXPRESSION__SEQUENCE_CONSTRUCTION_COMPLETION, null, msgs);
			if (newSequenceConstructionCompletion != null)
				msgs = ((InternalEObject)newSequenceConstructionCompletion).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AlfDslPackage.NAME_EXPRESSION__SEQUENCE_CONSTRUCTION_COMPLETION, null, msgs);
			msgs = basicSetSequenceConstructionCompletion(newSequenceConstructionCompletion, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AlfDslPackage.NAME_EXPRESSION__SEQUENCE_CONSTRUCTION_COMPLETION, newSequenceConstructionCompletion, newSequenceConstructionCompletion));
	}
	...
	public void setPostfixOp(String newPostfixOp) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AlfDslPackage.NAME_EXPRESSION__POSTFIX_OP, oldPostfixOp, postfixOp));
	}
	...
	public NotificationChain basicSetSuffix(SuffixExpression newSuffix, NotificationChain msgs) {
		...
		suffix = newSuffix;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AlfDslPackage.NAME_EXPRESSION__SUFFIX, oldSuffix, newSuffix);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSuffix(SuffixExpression newSuffix) {
		if (newSuffix != suffix) {
			NotificationChain msgs = null;
			if (suffix != null)
				msgs = ((InternalEObject)suffix).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AlfDslPackage.NAME_EXPRESSION__SUFFIX, null, msgs);
			if (newSuffix != null)
				msgs = ((InternalEObject)newSuffix).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AlfDslPackage.NAME_EXPRESSION__SUFFIX, null, msgs);
			msgs = basicSetSuffix(newSuffix, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AlfDslPackage.NAME_EXPRESSION__SUFFIX, newSuffix, newSuffix));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AlfDslPackage.NAME_EXPRESSION__PATH:
				return basicSetPath(null, msgs);
			case AlfDslPackage.NAME_EXPRESSION__INVOCATION_COMPLETION:
				return basicSetInvocationCompletion(null, msgs);
			case AlfDslPackage.NAME_EXPRESSION__SEQUENCE_CONSTRUCTION_COMPLETION:
				return basicSetSequenceConstructionCompletion(null, msgs);
			case AlfDslPackage.NAME_EXPRESSION__SUFFIX:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AlfDslPackage.NAME_EXPRESSION__PREFIX_OP:
				return getPrefixOp();
			case AlfDslPackage.NAME_EXPRESSION__PATH:
				return getPath();
			case AlfDslPackage.NAME_EXPRESSION__ID:
				return getId();
			case AlfDslPackage.NAME_EXPRESSION__INVOCATION_COMPLETION:
				return getInvocationCompletion();
			case AlfDslPackage.NAME_EXPRESSION__SEQUENCE_CONSTRUCTION_COMPLETION:
				return getSequenceConstructionCompletion();
			case AlfDslPackage.NAME_EXPRESSION__POSTFIX_OP:
				return getPostfixOp();
			case AlfDslPackage.NAME_EXPRESSION__SUFFIX:
				return getSuffix();
		}
