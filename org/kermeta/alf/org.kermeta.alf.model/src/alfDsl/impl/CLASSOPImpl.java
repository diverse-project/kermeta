 ...
 * <ul>
 *   <li>{@link alfDsl.impl.CLASSOPImpl#getName <em>Name</em>}</li>
 *   <li>{@link alfDsl.impl.CLASSOPImpl#getStat <em>Stat</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CLASSOPImpl extends EObjectImpl implements CLASSOP {
	...
	protected EClass eStaticClass() {
		return AlfDslPackage.Literals.CLASSOP;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AlfDslPackage.CLASSOP__NAME, oldName, name));
	}
	...
	public EList getStat() {
		if (stat == null) {
			stat = new EObjectContainmentEList(Statement.class, this, AlfDslPackage.CLASSOP__STAT);
		}
		return stat;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AlfDslPackage.CLASSOP__STAT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AlfDslPackage.CLASSOP__NAME:
				return getName();
			case AlfDslPackage.CLASSOP__STAT:
				return getStat();
		}
