 ...
 * <ul>
 *   <li>{@link alfDsl.impl.QualifiedNamePathImpl#getNamespace <em>Namespace</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class QualifiedNamePathImpl extends EObjectImpl implements QualifiedNamePath {
	...
	protected EClass eStaticClass() {
		return AlfDslPackage.Literals.QUALIFIED_NAME_PATH;
	}
	...
	public EList getNamespace() {
		if (namespace == null) {
			namespace = new EObjectContainmentEList(UnqualifiedName.class, this, AlfDslPackage.QUALIFIED_NAME_PATH__NAMESPACE);
		}
		return namespace;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AlfDslPackage.QUALIFIED_NAME_PATH__NAMESPACE:
