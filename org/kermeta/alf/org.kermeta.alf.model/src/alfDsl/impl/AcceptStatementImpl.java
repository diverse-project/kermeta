 ...
 * <ul>
 *   <li>{@link alfDsl.impl.AcceptStatementImpl#getClause <em>Clause</em>}</li>
 *   <li>{@link alfDsl.impl.AcceptStatementImpl#getSimpleAccept <em>Simple Accept</em>}</li>
 *   <li>{@link alfDsl.impl.AcceptStatementImpl#getCompoundAccept <em>Compound Accept</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AcceptStatementImpl extends StatementImpl implements AcceptStatement {
	...
	protected EClass eStaticClass() {
		return AlfDslPackage.Literals.ACCEPT_STATEMENT;
	}
	...
	public NotificationChain basicSetClause(AcceptClause newClause, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AlfDslPackage.ACCEPT_STATEMENT__CLAUSE, oldClause, newClause);
	...
	public void setClause(AcceptClause newClause) {
		if (newClause != clause) {
			...
			if (clause != null)
				msgs = ((InternalEObject)clause).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AlfDslPackage.ACCEPT_STATEMENT__CLAUSE, null, msgs);
			if (newClause != null)
				msgs = ((InternalEObject)newClause).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AlfDslPackage.ACCEPT_STATEMENT__CLAUSE, null, msgs);
			msgs = basicSetClause(newClause, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AlfDslPackage.ACCEPT_STATEMENT__CLAUSE, newClause, newClause));
	}
	...
	public NotificationChain basicSetSimpleAccept(SimpleAcceptStatementCompletion newSimpleAccept, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AlfDslPackage.ACCEPT_STATEMENT__SIMPLE_ACCEPT, oldSimpleAccept, newSimpleAccept);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSimpleAccept(SimpleAcceptStatementCompletion newSimpleAccept) {
		if (newSimpleAccept != simpleAccept) {
			...
			if (simpleAccept != null)
				msgs = ((InternalEObject)simpleAccept).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AlfDslPackage.ACCEPT_STATEMENT__SIMPLE_ACCEPT, null, msgs);
			if (newSimpleAccept != null)
				msgs = ((InternalEObject)newSimpleAccept).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AlfDslPackage.ACCEPT_STATEMENT__SIMPLE_ACCEPT, null, msgs);
			msgs = basicSetSimpleAccept(newSimpleAccept, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AlfDslPackage.ACCEPT_STATEMENT__SIMPLE_ACCEPT, newSimpleAccept, newSimpleAccept));
	}
	...
	public NotificationChain basicSetCompoundAccept(CompoundAcceptStatementCompletion newCompoundAccept, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AlfDslPackage.ACCEPT_STATEMENT__COMPOUND_ACCEPT, oldCompoundAccept, newCompoundAccept);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setCompoundAccept(CompoundAcceptStatementCompletion newCompoundAccept) {
		if (newCompoundAccept != compoundAccept) {
			...
			if (compoundAccept != null)
				msgs = ((InternalEObject)compoundAccept).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AlfDslPackage.ACCEPT_STATEMENT__COMPOUND_ACCEPT, null, msgs);
			if (newCompoundAccept != null)
				msgs = ((InternalEObject)newCompoundAccept).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AlfDslPackage.ACCEPT_STATEMENT__COMPOUND_ACCEPT, null, msgs);
			msgs = basicSetCompoundAccept(newCompoundAccept, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AlfDslPackage.ACCEPT_STATEMENT__COMPOUND_ACCEPT, newCompoundAccept, newCompoundAccept));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AlfDslPackage.ACCEPT_STATEMENT__CLAUSE:
				return basicSetClause(null, msgs);
			case AlfDslPackage.ACCEPT_STATEMENT__SIMPLE_ACCEPT:
				return basicSetSimpleAccept(null, msgs);
			case AlfDslPackage.ACCEPT_STATEMENT__COMPOUND_ACCEPT:
