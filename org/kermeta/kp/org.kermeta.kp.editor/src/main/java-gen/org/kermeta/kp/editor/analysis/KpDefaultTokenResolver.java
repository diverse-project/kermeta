 ...
 */
public class KpDefaultTokenResolver implements org.kermeta.kp.editor.IKpTokenResolver {
	 ...
	 */
	public KpDefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, org.kermeta.kp.editor.IKpTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : org.kermeta.kp.editor.grammar.KpGrammarInformationProvider.INSTANCE.getKeywords()) {
