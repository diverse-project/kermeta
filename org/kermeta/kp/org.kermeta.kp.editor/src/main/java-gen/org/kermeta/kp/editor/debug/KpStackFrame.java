...
public class KpStackFrame extends org.kermeta.kp.editor.debug.KpDebugElement implements org.eclipse.debug.core.model.IStackFrame {
	
	private org.kermeta.kp.editor.debug.KpDebugTarget target;
	private String name;
	private int id;
	...
	public KpStackFrame(org.kermeta.kp.editor.debug.KpDebugTarget target, String data) {
		super(target);
		this.target = target;
		
		java.util.List<String> dataParts = org.kermeta.kp.editor.util.KpStringUtil.decode(data, ',');
	...
	private org.kermeta.kp.editor.debug.KpDebugTarget getTarget() {
		return target;
	}
	...
	public boolean equals(Object obj) {
		...
		org.kermeta.kp.editor.debug.KpStackFrame other = (org.kermeta.kp.editor.debug.KpStackFrame) obj;
		if (name == null) {
