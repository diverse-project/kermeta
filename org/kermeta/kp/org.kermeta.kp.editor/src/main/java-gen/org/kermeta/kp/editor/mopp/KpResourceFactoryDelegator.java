...
public class KpResourceFactoryDelegator implements org.eclipse.emf.ecore.resource.Resource.Factory {
	
	protected java.util.Map<String, org.eclipse.emf.ecore.resource.Resource.Factory> factories = null;
	
	public KpResourceFactoryDelegator() {
		init();
	}
	...
	protected void init() {
		...
		if (factories.get("") == null) {
			factories.put("", new org.kermeta.kp.editor.mopp.KpResourceFactory());
		}
	}
