...
public class KpResourceUtil {
	...
	public static org.kermeta.kp.editor.mopp.KpResource getResource(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		new org.kermeta.kp.editor.mopp.KpMetaInformation().registerResourceFactory();
		org.eclipse.emf.ecore.resource.ResourceSet rs = new org.eclipse.emf.ecore.resource.impl.ResourceSetImpl();
		if (options != null) {
			rs.getLoadOptions().putAll(options);
		}
		org.eclipse.emf.ecore.resource.Resource resource = rs.getResource(uri, true);
		return (org.kermeta.kp.editor.mopp.KpResource) resource;
	}
	
	/**
	 * Returns the root element of the resource with the given URI.
	 */
	public static org.kermeta.kp.KermetaProject getResourceContent(org.eclipse.emf.common.util.URI uri) {
	 ...
	 * Returns the root element of the resource with the given URI.
	 */
	public static org.kermeta.kp.KermetaProject getResourceContent(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		...
		return (org.kermeta.kp.KermetaProject) root;
	}
