...
public class KpLineBreakpoint extends org.eclipse.debug.core.model.LineBreakpoint {
	
	private static final String LINE_BREAKPOINT_MARKER_ID = "org.kermeta.kp.editor.debug.lineBreakpoint.marker";
	
	public KpLineBreakpoint() {
		super();
	}
	
	public KpLineBreakpoint(final org.eclipse.core.resources.IResource resource, final int lineNumber) throws org.eclipse.debug.core.DebugException {
	...
	public void install(org.kermeta.kp.editor.debug.KpDebugTarget target) {
		try {
	...
	public void remove(org.kermeta.kp.editor.debug.KpDebugTarget target) {
		try {
			String location = (String) getMarker().getAttribute(org.eclipse.core.resources.IMarker.LOCATION);
