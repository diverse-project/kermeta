 ...
 * 
 */
package org.kermeta.kp.editor.launch;

/**
 * A class that provides common methods that are required by launch configuration
 * delegates.
 */
public class KpLaunchConfigurationHelper {
	
	public static class SystemOutInterpreter extends org.kermeta.kp.editor.util.AbstractKpInterpreter<Void,Void> {
	...
	public <ResultType, ContextType> void launchInterpreter(org.eclipse.debug.core.ILaunchConfiguration configuration, String mode, org.eclipse.debug.core.ILaunch launch, org.eclipse.core.runtime.IProgressMonitor monitor, org.kermeta.kp.editor.util.AbstractKpInterpreter<ResultType, ContextType> delegate, final ContextType context) throws org.eclipse.core.runtime.CoreException {
		...
		final org.kermeta.kp.editor.debug.KpDebuggableInterpreter<ResultType, ContextType> interpreter = new org.kermeta.kp.editor.debug.KpDebuggableInterpreter<ResultType, ContextType>(delegate, eventPort);
		...
		// running process
		org.kermeta.kp.editor.debug.KpDebuggerListener<ResultType, ContextType> debugListener = new org.kermeta.kp.editor.debug.KpDebuggerListener<ResultType, ContextType>(requestPort);
		debugListener.setDebuggable(interpreter);
		new Thread(debugListener).start();
		
		// step 4: start debugger
		org.kermeta.kp.editor.debug.KpDebugProcess process = new org.kermeta.kp.editor.debug.KpDebugProcess(launch);
		launch.addDebugTarget(new org.kermeta.kp.editor.debug.KpDebugTarget(process, launch, requestPort, eventPort));
	}
	...
	public org.eclipse.emf.common.util.URI getURI(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return org.eclipse.emf.common.util.URI.createURI(configuration.getAttribute(org.kermeta.kp.editor.launch.KpLaunchConfigurationDelegate.ATTR_RESOURCE_URI, (String) null));
	}
	...
	public org.eclipse.emf.ecore.EObject getModelRoot(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return org.kermeta.kp.editor.util.KpResourceUtil.getResourceContent(getURI(configuration));
	}
	...
	protected void abort(String message, Throwable e) throws org.eclipse.core.runtime.CoreException {
		throw new org.eclipse.core.runtime.CoreException(new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, org.kermeta.kp.editor.mopp.KpPlugin.DEBUG_MODEL_ID, 0, message, e));
	}
}
