 ...
 */
public class KpExpectedTerminal {
	
	private int followSetID;
	private org.kermeta.kp.editor.IKpExpectedElement terminal;
	...
	public KpExpectedTerminal(org.kermeta.kp.editor.IKpExpectedElement terminal, int followSetID, org.eclipse.emf.ecore.EStructuralFeature... containmentTrace) {
		super();
	...
	public org.kermeta.kp.editor.IKpExpectedElement getTerminal() {
		return terminal;
	}
	...
	public boolean equals(Object o) {
		return this.terminal.equals(((KpExpectedTerminal) o).terminal);
	}
