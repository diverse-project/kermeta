...
public class KpDebugValue extends org.kermeta.kp.editor.debug.KpDebugElement implements org.eclipse.debug.core.model.IValue {
	...
	public KpDebugValue(org.kermeta.kp.editor.debug.KpDebugTarget target, String id, String valueString, String referenceTypeName, java.util.Map<String, Long> children) {
		super(target);
