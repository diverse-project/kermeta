...
public class KptExpectedTerminal {
	...
	public KptExpectedTerminal(org.kermeta.kp.editor.IKptExpectedElement terminal, int followSetID, org.eclipse.emf.ecore.EStructuralFeature... containmentTrace) {
		super();
