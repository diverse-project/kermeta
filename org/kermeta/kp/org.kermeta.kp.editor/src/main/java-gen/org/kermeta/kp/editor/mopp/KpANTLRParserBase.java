...
public abstract class KpANTLRParserBase extends org.antlr.runtime3_3_0.Parser implements org.kermeta.kp.editor.IKpTextParser {
	...
	public KpANTLRParserBase(org.antlr.runtime3_3_0.TokenStream input) {
		super(input);
	}
	
	public KpANTLRParserBase(org.antlr.runtime3_3_0.TokenStream input, org.antlr.runtime3_3_0.RecognizerSharedState state) {
		super(input, state);
	}
	...
	protected org.kermeta.kp.editor.mopp.KpTokenResolveResult getFreshTokenResolveResult() {
