 ...
 *   <li>{@link org.kermeta.kp.impl.DependencyImpl#getUri <em>Uri</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DependencyImpl extends NamedElementImpl implements Dependency {
   ...
   */
    ...
    uri = newUri;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KpPackage.DEPENDENCY__URI, oldUri, uri));
  }
   ...
   */
    ...
    switch (featureID)
    {
      ...
      case KpPackage.DEPENDENCY__URI:
        return getUri();
    }
