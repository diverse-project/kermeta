 ...
 *   <li>{@link org.kermeta.kp.Dependency#getGenmodel <em>Genmodel</em>}</li>
...
public interface Dependency extends NamedElement {
  ...
  void setSourceOnly(boolean value);
		...
		/**
   * Returns the value of the '<em><b>Genmodel</b></em>' attribute.
   * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Genmodel</em>' attribute isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
   * @return the value of the '<em>Genmodel</em>' attribute.
   * @see #setGenmodel(String)
   * @see org.kermeta.kp.KpPackage#getDependency_Genmodel()
   * @model
   * @generated
   */
	String getGenmodel();
		...
		/**
   * Sets the value of the '{@link org.kermeta.kp.Dependency#getGenmodel <em>Genmodel</em>}' attribute.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   * @param value the new value of the '<em>Genmodel</em>' attribute.
   * @see #getGenmodel()
   * @generated
   */
