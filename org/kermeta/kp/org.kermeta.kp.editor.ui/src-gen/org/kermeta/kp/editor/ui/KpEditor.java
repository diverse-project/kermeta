...
/**
 * A text editor for 'kp' models.
 */
public class KpEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider, org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.emf.common.ui.viewer.IViewerProvider, org.kermeta.kp.editor.IKpResourceProvider, org.kermeta.kp.editor.ui.IKpBracketHandlerProvider, org.kermeta.kp.editor.ui.IKpAnnotationModelProvider {
	
	private org.kermeta.kp.editor.ui.KpHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private org.kermeta.kp.editor.ui.KpCodeFoldingManager codeFoldingManager;
	private org.kermeta.kp.editor.ui.KpBackgroundParsingStrategy bgParsingStrategy = new org.kermeta.kp.editor.ui.KpBackgroundParsingStrategy();
	private java.util.Collection<org.kermeta.kp.editor.IKpBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<org.kermeta.kp.editor.IKpBackgroundParsingListener>();
	private org.kermeta.kp.editor.ui.KpColorManager colorManager = new org.kermeta.kp.editor.ui.KpColorManager();
	private org.kermeta.kp.editor.ui.KpOutlinePage outlinePage;
	...
	private org.kermeta.kp.editor.ui.KpPropertySheetPage propertySheetPage;
	...
	private org.kermeta.kp.editor.ui.IKpBracketHandler bracketHandler;
	...
	public KpEditor() {
		super();
		setSourceViewerConfiguration(new org.kermeta.kp.editor.ui.KpEditorConfiguration(this, this, this, colorManager));
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), KpEditor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								org.kermeta.kp.editor.IKpTextResource currentResource = getResource();
				...
				org.kermeta.kp.editor.ui.KpUIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void initializeEditor() {
		...
		setRulerContextMenuId("org.kermeta.kp.editor.EditorRuler");
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new org.kermeta.kp.editor.ui.KpHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new org.kermeta.kp.editor.ui.KpCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		org.kermeta.kp.editor.mopp.KpNature.activate(inputFile.getProject());
		...
		org.kermeta.kp.editor.IKpTextResource loadedResource = (org.kermeta.kp.editor.IKpTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				org.kermeta.kp.editor.IKpTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof org.kermeta.kp.editor.IKpTextResource) {
					setResource((org.kermeta.kp.editor.IKpTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but some other EMF resource
					org.kermeta.kp.editor.ui.KpUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the KpEditor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (Exception e) {
				org.kermeta.kp.editor.ui.KpUIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(org.kermeta.kp.editor.IKpTextResource resource) {
	...
	private Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new org.kermeta.kp.editor.ui.KpOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new org.kermeta.kp.editor.ui.KpPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			org.kermeta.kp.editor.IKpTextResource textResource = (org.kermeta.kp.editor.IKpTextResource) element.eResource();
			...
			org.kermeta.kp.editor.IKpTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				org.kermeta.kp.editor.IKpTextToken token = lexer.getNextToken();
			...
			org.kermeta.kp.editor.ui.KpUIPlugin.logError("Exception in setCaret()", e);
		}
	}
	...
	protected org.eclipse.jface.text.source.ISourceViewer createSourceViewer(org.eclipse.swt.widgets.Composite parent, org.eclipse.jface.text.source.IVerticalRuler ruler, int styles) {
		org.eclipse.jface.text.source.ISourceViewer viewer = new org.eclipse.jface.text.source.projection.ProjectionViewer(parent, ruler, getOverviewRuler(), isOverviewRulerVisible(), styles) {
			...
			public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
				if (!KpEditor.this.setSelection(selection, reveal)) {
	...
	public void addBackgroundParsingListener(org.kermeta.kp.editor.IKpBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (org.kermeta.kp.editor.IKpBackgroundParsingListener listener : bgParsingListeners) {
			listener.parsingCompleted(getResource());
		}
	}
	
	public org.kermeta.kp.editor.ui.IKpBracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(org.kermeta.kp.editor.ui.IKpBracketHandler bracketHandler) {
