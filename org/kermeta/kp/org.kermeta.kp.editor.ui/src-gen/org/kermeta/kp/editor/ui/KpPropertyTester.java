...
public class KpPropertyTester extends org.eclipse.core.expressions.PropertyTester {
	...
	private boolean hasMatchingURI(org.eclipse.core.resources.IResource resource) {
		...
		return path.endsWith("." + new org.kermeta.kp.editor.mopp.KpMetaInformation().getSyntaxName());
	}
