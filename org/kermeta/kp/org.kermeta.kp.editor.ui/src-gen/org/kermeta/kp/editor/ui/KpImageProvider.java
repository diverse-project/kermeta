...
public class KpImageProvider {
	...
	public org.eclipse.swt.graphics.Image getImage(String key) {
		...
		org.eclipse.jface.resource.ImageDescriptor desriptor = org.eclipse.jface.resource.ImageDescriptor.createFromURL(org.eclipse.core.runtime.FileLocator.find(org.kermeta.kp.editor.ui.KpUIPlugin.getDefault().getBundle(), path, null));
