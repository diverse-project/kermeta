 ...
 * @since 3.2
 */
public class KpBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private org.kermeta.kp.editor.ui.KpDocBrowserInformationControlInput fInput;
	 ...
	 */
	public KpBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public KpBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public KpBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof org.kermeta.kp.editor.ui.KpDocBrowserInformationControlInput);
		...
		fInput= (org.kermeta.kp.editor.ui.KpDocBrowserInformationControlInput) input;
		...
		org.kermeta.kp.editor.ui.KpHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = org.kermeta.kp.editor.ui.KpHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public org.kermeta.kp.editor.ui.KpDocBrowserInformationControlInput getInput() {
		return fInput;
	}
