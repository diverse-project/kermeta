...
public class KptMarkerAnnotation extends org.eclipse.ui.texteditor.MarkerAnnotation implements org.eclipse.jface.text.quickassist.IQuickFixableAnnotation {
	
	boolean quickFixableState;
	boolean isQuickFixable;
	
	public KptMarkerAnnotation(org.eclipse.core.resources.IMarker marker) {
		super(marker);
	}
