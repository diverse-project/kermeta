	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
				...
				org.kermeta.kp.editor.ui.KptUIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
		...
		if (loadedResource == null) {
			try {
				...
				if (demandLoadedResource instanceof org.kermeta.kp.editor.IKptTextResource) {
					...
					org.kermeta.kp.editor.ui.KptUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the KptEditor.");
