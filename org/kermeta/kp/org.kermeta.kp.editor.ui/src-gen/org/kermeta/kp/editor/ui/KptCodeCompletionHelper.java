...
public class KptCodeCompletionHelper {
	...
	private org.kermeta.kp.editor.mopp.KptAttributeValueProvider attributeValueProvider = new org.kermeta.kp.editor.mopp.KptAttributeValueProvider();
	 ...
	 * @return
	 */
	public org.kermeta.kp.editor.ui.KptCompletionProposal[] computeCompletionProposals(org.kermeta.kp.editor.IKptTextResource originalResource, String content, int cursorOffset) {
	...
	private java.util.Collection<org.kermeta.kp.editor.ui.KptCompletionProposal> deriveProposals(java.util.List<org.kermeta.kp.editor.mopp.KptExpectedTerminal> expectedElements, String content, org.kermeta.kp.editor.IKptTextResource resource, int cursorOffset) {
	...
	private java.util.Collection<org.kermeta.kp.editor.ui.KptCompletionProposal> deriveProposals(org.kermeta.kp.editor.mopp.KptExpectedTerminal expectedTerminal, String content, org.kermeta.kp.editor.IKptTextResource resource, int cursorOffset) {
		org.kermeta.kp.editor.IKptMetaInformation metaInformation = resource.getMetaInformation();
					...
					for (int i = contentList.size() - 1; i >= 0; i--) {
						...
						if (neededClass.isInstance(object)) {
							...
							if (eStructuralFeature.getEType().isInstance(newContainer)) {
								org.kermeta.kp.editor.util.KptEObjectUtil.setFeature(object, eStructuralFeature, newContainer, false);
