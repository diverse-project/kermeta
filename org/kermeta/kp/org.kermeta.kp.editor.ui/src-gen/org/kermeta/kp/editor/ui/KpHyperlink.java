 ...
 */
public class KpHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public KpHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				if (editorPart instanceof org.kermeta.kp.editor.ui.KpEditor) {
					org.kermeta.kp.editor.ui.KpEditor emftEditor = (org.kermeta.kp.editor.ui.KpEditor) editorPart;
