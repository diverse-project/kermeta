...
public class KpLineBreakpointAdapter implements org.eclipse.debug.ui.actions.IToggleBreakpointsTarget {
	...
	public void toggleLineBreakpoints(org.eclipse.ui.IWorkbenchPart part, org.eclipse.jface.viewers.ISelection selection) throws org.eclipse.core.runtime.CoreException {
		...
		if (textEditor != null) {
			...
			org.eclipse.debug.core.model.IBreakpoint[] breakpoints = org.eclipse.debug.core.DebugPlugin.getDefault().getBreakpointManager().getBreakpoints(org.kermeta.kp.editor.mopp.KpPlugin.DEBUG_MODEL_ID);
			...
			org.kermeta.kp.editor.debug.KpLineBreakpoint lineBreakpoint = new org.kermeta.kp.editor.debug.KpLineBreakpoint(resource, lineNumber + 1);
