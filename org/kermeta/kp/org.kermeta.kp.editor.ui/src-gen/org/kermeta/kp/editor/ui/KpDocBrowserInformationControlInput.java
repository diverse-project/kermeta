 ...
 * olInput</code>.
 */
public class KpDocBrowserInformationControlInput {
	
	private final KpDocBrowserInformationControlInput fPrevious;
	private KpDocBrowserInformationControlInput fNext;
	 ...
	 */
	public KpDocBrowserInformationControlInput(KpDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public KpDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public KpDocBrowserInformationControlInput getNext() {
		return fNext;
	}
