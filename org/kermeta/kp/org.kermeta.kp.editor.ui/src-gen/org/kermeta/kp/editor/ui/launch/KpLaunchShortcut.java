 ...
 */
public class KpLaunchShortcut implements org.eclipse.debug.ui.ILaunchShortcut2 {
	...
	private void launch(org.eclipse.core.resources.IFile file, String mode) {
		try {
			...
			org.eclipse.debug.core.ILaunchConfigurationType type = lm.getLaunchConfigurationType(new org.kermeta.kp.editor.mopp.KpMetaInformation().getLaunchConfigurationType());
			...
			workingCopy.setAttribute(org.kermeta.kp.editor.launch.KpLaunchConfigurationDelegate.ATTR_RESOURCE_URI, uri.toString());
			...
			org.kermeta.kp.editor.mopp.KpPlugin.logError("Exception while launching selection", e);
		}
	}
