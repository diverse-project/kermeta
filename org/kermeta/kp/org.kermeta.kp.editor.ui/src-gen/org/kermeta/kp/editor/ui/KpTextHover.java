...
public class KpTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2{
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final org.kermeta.kp.editor.ui.KpBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(org.kermeta.kp.editor.ui.KpBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			org.kermeta.kp.editor.ui.KpDocBrowserInformationControlInput infoInput = (org.kermeta.kp.editor.ui.KpDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					org.kermeta.kp.editor.ui.KpHyperlink hyperlink = new org.kermeta.kp.editor.ui.KpHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (org.kermeta.kp.editor.ui.KpBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				org.kermeta.kp.editor.ui.KpBrowserInformationControl iControl = new org.kermeta.kp.editor.ui.KpBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof org.kermeta.kp.editor.ui.KpDocBrowserInformationControlInput) {
							org.kermeta.kp.editor.ui.KpDocBrowserInformationControlInput input = (org.kermeta.kp.editor.ui.KpDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (org.kermeta.kp.editor.ui.KpBrowserInformationControl.isAvailable(parent)) {
				org.kermeta.kp.editor.ui.KpBrowserInformationControl iControl = new org.kermeta.kp.editor.ui.KpBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	...
	private static String getStyleSheet() {
		...
		if (css != null) {
			...
			css = org.kermeta.kp.editor.ui.KpHTMLPrinter.convertTopLevelFont(css, fontData);
		}
