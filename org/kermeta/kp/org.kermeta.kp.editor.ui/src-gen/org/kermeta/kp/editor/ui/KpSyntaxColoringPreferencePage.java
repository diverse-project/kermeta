 ...
 */
public class KpSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	public KpSyntaxColoringPreferencePage() {
		super();
		
		org.kermeta.kp.editor.IKpMetaInformation syntaxPlugin = new org.kermeta.kp.editor.mopp.KpMetaInformation();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = org.kermeta.kp.editor.ui.KpSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.kermeta.kp.editor.ui.KpSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = org.kermeta.kp.editor.ui.KpSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.kermeta.kp.editor.ui.KpSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = org.kermeta.kp.editor.ui.KpSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.kermeta.kp.editor.ui.KpSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = org.kermeta.kp.editor.ui.KpSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.kermeta.kp.editor.ui.KpSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = org.kermeta.kp.editor.ui.KpSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.kermeta.kp.editor.ui.KpSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = org.kermeta.kp.editor.ui.KpSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.kermeta.kp.editor.ui.KpSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		org.kermeta.kp.editor.ui.KpPixelConverter pixelConverter = new org.kermeta.kp.editor.ui.KpPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof org.kermeta.kp.editor.ui.KpEditor) {
			org.kermeta.kp.editor.ui.KpEditor emfTextEditor = (org.kermeta.kp.editor.ui.KpEditor) editor;
