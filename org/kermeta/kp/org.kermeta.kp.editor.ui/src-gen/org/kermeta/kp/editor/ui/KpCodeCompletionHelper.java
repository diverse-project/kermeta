 ...
 */
public class KpCodeCompletionHelper {
	
	private org.kermeta.kp.editor.mopp.KpAttributeValueProvider attributeValueProvider = new org.kermeta.kp.editor.mopp.KpAttributeValueProvider();
	 ...
	 * @return
	 */
	public org.kermeta.kp.editor.ui.KpCompletionProposal[] computeCompletionProposals(org.kermeta.kp.editor.IKpTextResource originalResource, String content, int cursorOffset) {
		...
		org.kermeta.kp.editor.IKpTextResource resource = (org.kermeta.kp.editor.IKpTextResource) resourceSet.createResource(originalResource.getURI());
		java.io.ByteArrayInputStream inputStream = new java.io.ByteArrayInputStream(content.getBytes());
		org.kermeta.kp.editor.IKpMetaInformation metaInformation = resource.getMetaInformation();
		org.kermeta.kp.editor.IKpTextParser parser = metaInformation.createParser(inputStream, null);
		org.kermeta.kp.editor.mopp.KpExpectedTerminal[] expectedElements = parseToExpectedElements(parser, resource, cursorOffset);
		if (expectedElements == null) {
			return new org.kermeta.kp.editor.ui.KpCompletionProposal[0];
		}
		if (expectedElements.length == 0) {
			return new org.kermeta.kp.editor.ui.KpCompletionProposal[0];
		}
		java.util.List<org.kermeta.kp.editor.mopp.KpExpectedTerminal> expectedAfterCursor = java.util.Arrays.asList(getElementsExpectedAt(expectedElements, cursorOffset));
		java.util.List<org.kermeta.kp.editor.mopp.KpExpectedTerminal> expectedBeforeCursor = java.util.Arrays.asList(getElementsExpectedAt(expectedElements, cursorOffset - 1));
		...
		java.util.Collection<org.kermeta.kp.editor.ui.KpCompletionProposal> allProposals = new java.util.LinkedHashSet<org.kermeta.kp.editor.ui.KpCompletionProposal>();
		java.util.Collection<org.kermeta.kp.editor.ui.KpCompletionProposal> rightProposals = deriveProposals(expectedAfterCursor, content, resource, cursorOffset);
		java.util.Collection<org.kermeta.kp.editor.ui.KpCompletionProposal> leftProposals = deriveProposals(expectedBeforeCursor, content, resource, cursorOffset - 1);
		...
		final java.util.List<org.kermeta.kp.editor.ui.KpCompletionProposal> sortedProposals = new java.util.ArrayList<org.kermeta.kp.editor.ui.KpCompletionProposal>(allProposals);
		java.util.Collections.sort(sortedProposals);
		return sortedProposals.toArray(new org.kermeta.kp.editor.ui.KpCompletionProposal[sortedProposals.size()]);
	}
	
	public org.kermeta.kp.editor.mopp.KpExpectedTerminal[] parseToExpectedElements(org.kermeta.kp.editor.IKpTextParser parser, org.kermeta.kp.editor.IKpTextResource resource, int cursorOffset) {
		final java.util.List<org.kermeta.kp.editor.mopp.KpExpectedTerminal> expectedElements = parser.parseToExpectedElements(null, resource, cursorOffset);
		if (expectedElements == null) {
			return new org.kermeta.kp.editor.mopp.KpExpectedTerminal[0];
		}
		removeDuplicateEntries(expectedElements);
		removeInvalidEntriesAtEnd(expectedElements);
		return expectedElements.toArray(new org.kermeta.kp.editor.mopp.KpExpectedTerminal[expectedElements.size()]);
	}
	
	private void removeDuplicateEntries(java.util.List<org.kermeta.kp.editor.mopp.KpExpectedTerminal> expectedElements) {
		for (int i = 0; i < expectedElements.size() - 1; i++) {
			org.kermeta.kp.editor.mopp.KpExpectedTerminal elementAtIndex = expectedElements.get(i);
			for (int j = i + 1; j < expectedElements.size();) {
				org.kermeta.kp.editor.mopp.KpExpectedTerminal elementAtNext = expectedElements.get(j);
	...
	private void removeInvalidEntriesAtEnd(java.util.List<org.kermeta.kp.editor.mopp.KpExpectedTerminal> expectedElements) {
		for (int i = 0; i < expectedElements.size() - 1;) {
			org.kermeta.kp.editor.mopp.KpExpectedTerminal elementAtIndex = expectedElements.get(i);
			org.kermeta.kp.editor.mopp.KpExpectedTerminal elementAtNext = expectedElements.get(i + 1);
	...
	private String findPrefix(java.util.List<org.kermeta.kp.editor.mopp.KpExpectedTerminal> expectedElements, org.kermeta.kp.editor.mopp.KpExpectedTerminal expectedAtCursor, String content, int cursorOffset) {
		if (cursorOffset < 0) {
			return "";
		}
		int end = 0;
		for (org.kermeta.kp.editor.mopp.KpExpectedTerminal expectedElement : expectedElements) {
	...
	private java.util.Collection<org.kermeta.kp.editor.ui.KpCompletionProposal> deriveProposals(java.util.List<org.kermeta.kp.editor.mopp.KpExpectedTerminal> expectedElements, String content, org.kermeta.kp.editor.IKpTextResource resource, int cursorOffset) {
		java.util.Collection<org.kermeta.kp.editor.ui.KpCompletionProposal> resultSet = new java.util.LinkedHashSet<org.kermeta.kp.editor.ui.KpCompletionProposal>();
		for (org.kermeta.kp.editor.mopp.KpExpectedTerminal expectedElement : expectedElements) {
	...
	private java.util.Collection<org.kermeta.kp.editor.ui.KpCompletionProposal> deriveProposals(org.kermeta.kp.editor.mopp.KpExpectedTerminal expectedTerminal, String content, org.kermeta.kp.editor.IKpTextResource resource, int cursorOffset) {
		org.kermeta.kp.editor.IKpMetaInformation metaInformation = resource.getMetaInformation();
		org.kermeta.kp.editor.IKpLocationMap locationMap = resource.getLocationMap();
		org.kermeta.kp.editor.IKpExpectedElement expectedElement = (org.kermeta.kp.editor.IKpExpectedElement) expectedTerminal.getTerminal();
		if (expectedElement instanceof org.kermeta.kp.editor.mopp.KpExpectedCsString) {
			org.kermeta.kp.editor.mopp.KpExpectedCsString csString = (org.kermeta.kp.editor.mopp.KpExpectedCsString) expectedElement;
					...
					for (int i = contentList.size() - 1; i >= 0; i--) {
						...
						if (neededClass.isInstance(object)) {
							...
							if (eStructuralFeature.getEType().isInstance(newContainer)) {
								org.kermeta.kp.editor.util.KpEObjectUtil.setFeature(object, eStructuralFeature, newContainer, false);
	...
	private java.util.Collection<org.kermeta.kp.editor.ui.KpCompletionProposal> handleEnumAttribute(org.kermeta.kp.editor.IKpMetaInformation metaInformation, org.kermeta.kp.editor.mopp.KpExpectedStructuralFeature expectedFeature, org.eclipse.emf.ecore.EEnum enumType, String prefix, org.eclipse.emf.ecore.EObject container) {
		java.util.Collection<org.eclipse.emf.ecore.EEnumLiteral> enumLiterals = enumType.getELiterals();
		java.util.Collection<org.kermeta.kp.editor.ui.KpCompletionProposal> result = new java.util.LinkedHashSet<org.kermeta.kp.editor.ui.KpCompletionProposal>();
		for (org.eclipse.emf.ecore.EEnumLiteral literal : enumLiterals) {
			...
			org.kermeta.kp.editor.IKpTokenResolverFactory tokenResolverFactory = metaInformation.getTokenResolverFactory();
			org.kermeta.kp.editor.IKpTokenResolver tokenResolver = tokenResolverFactory.createTokenResolver(expectedFeature.getTokenName());
			...
			result.add(new org.kermeta.kp.editor.ui.KpCompletionProposal(resolvedLiteral, prefix, matchesPrefix, expectedFeature.getFeature(), container));
		}
		return result;
	}
	
	private java.util.Collection<org.kermeta.kp.editor.ui.KpCompletionProposal> handleNCReference(org.kermeta.kp.editor.IKpMetaInformation metaInformation, org.eclipse.emf.ecore.EObject container, org.eclipse.emf.ecore.EReference reference, String prefix, String tokenName) {
		// proposals for non-containment references are derived by calling the reference
		// resolver switch in fuzzy mode.
		org.kermeta.kp.editor.IKpReferenceResolverSwitch resolverSwitch = metaInformation.getReferenceResolverSwitch();
		org.kermeta.kp.editor.IKpTokenResolverFactory tokenResolverFactory = metaInformation.getTokenResolverFactory();
		org.kermeta.kp.editor.IKpReferenceResolveResult<org.eclipse.emf.ecore.EObject> result = new org.kermeta.kp.editor.mopp.KpReferenceResolveResult<org.eclipse.emf.ecore.EObject>(true);
		resolverSwitch.resolveFuzzy(prefix, container, reference, 0, result);
		java.util.Collection<org.kermeta.kp.editor.IKpReferenceMapping<org.eclipse.emf.ecore.EObject>> mappings = result.getMappings();
		if (mappings != null) {
			java.util.Collection<org.kermeta.kp.editor.ui.KpCompletionProposal> resultSet = new java.util.LinkedHashSet<org.kermeta.kp.editor.ui.KpCompletionProposal>();
			for (org.kermeta.kp.editor.IKpReferenceMapping<org.eclipse.emf.ecore.EObject> mapping : mappings) {
				org.eclipse.swt.graphics.Image image = null;
				if (mapping instanceof org.kermeta.kp.editor.mopp.KpElementMapping<?>) {
					org.kermeta.kp.editor.mopp.KpElementMapping<?> elementMapping = (org.kermeta.kp.editor.mopp.KpElementMapping<?>) mapping;
					...
					resultSet.add(new org.kermeta.kp.editor.ui.KpCompletionProposal(identifier, prefix, matchesPrefix, reference, container, image));
				}
			}
			return resultSet;
		}
	...
	private java.util.Collection<org.kermeta.kp.editor.ui.KpCompletionProposal> handleAttribute(org.kermeta.kp.editor.IKpMetaInformation metaInformation, org.kermeta.kp.editor.mopp.KpExpectedStructuralFeature expectedFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.emf.ecore.EAttribute attribute, String prefix) {
		java.util.Collection<org.kermeta.kp.editor.ui.KpCompletionProposal> resultSet = new java.util.LinkedHashSet<org.kermeta.kp.editor.ui.KpCompletionProposal>();
				...
				if (defaultValue != null) {
					...
					if (tokenName != null) {
						...
						if (tokenResolver != null) {
							...
							resultSet.add(new org.kermeta.kp.editor.ui.KpCompletionProposal(defaultValueAsString, prefix, matchesPrefix, expectedFeature.getFeature(), container));
						}
					}
				}
			}
	...
	private java.util.Collection<org.kermeta.kp.editor.ui.KpCompletionProposal> handleKeyword(org.kermeta.kp.editor.mopp.KpExpectedCsString csString, String prefix) {
		String proposal = csString.getValue();
		boolean matchesPrefix = matches(proposal, prefix);
		return java.util.Collections.singleton(new org.kermeta.kp.editor.ui.KpCompletionProposal(proposal, prefix, matchesPrefix, null, null));
	}
	...
	private java.util.Collection<org.kermeta.kp.editor.ui.KpCompletionProposal> handleBooleanLiteral(org.eclipse.emf.ecore.EAttribute attribute, String prefix, String literal) {
		...
		return java.util.Collections.singleton(new org.kermeta.kp.editor.ui.KpCompletionProposal(literal, prefix, matchesPrefix, null, null));
	}
	 ...
	 * element is expected.
	 */
	private void setPrefixes(java.util.List<org.kermeta.kp.editor.mopp.KpExpectedTerminal> expectedElements, String content, int cursorOffset) {
		if (cursorOffset < 0) {
			return;
		}
		for (org.kermeta.kp.editor.mopp.KpExpectedTerminal expectedElement : expectedElements) {
	...
	public org.kermeta.kp.editor.mopp.KpExpectedTerminal[] getElementsExpectedAt(org.kermeta.kp.editor.mopp.KpExpectedTerminal[] allExpectedElements, int cursorOffset) {
		java.util.List<org.kermeta.kp.editor.mopp.KpExpectedTerminal> expectedAtCursor = new java.util.ArrayList<org.kermeta.kp.editor.mopp.KpExpectedTerminal>();
		for (int i = 0; i < allExpectedElements.length; i++) {
			org.kermeta.kp.editor.mopp.KpExpectedTerminal expectedElement = allExpectedElements[i];
		...
		return expectedAtCursor.toArray(new org.kermeta.kp.editor.mopp.KpExpectedTerminal[expectedAtCursor.size()]);
	}
	
	private int getEnd(org.kermeta.kp.editor.mopp.KpExpectedTerminal[] allExpectedElements, int indexInList) {
		org.kermeta.kp.editor.mopp.KpExpectedTerminal elementAtIndex = allExpectedElements[indexInList];
		...
		for (int i = indexInList + 1; i < allExpectedElements.length; i++) {
			org.kermeta.kp.editor.mopp.KpExpectedTerminal elementAtI = allExpectedElements[i];
	...
	private boolean matches(String proposal, String prefix) {
		return (proposal.toLowerCase().startsWith(prefix.toLowerCase()) || org.kermeta.kp.editor.util.KpStringUtil.matchCamelCase(prefix, proposal) != null) && !proposal.equals(prefix);
	}
