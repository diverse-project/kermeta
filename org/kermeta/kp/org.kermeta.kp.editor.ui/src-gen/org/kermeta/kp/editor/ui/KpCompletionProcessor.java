...
public class KpCompletionProcessor implements org.eclipse.jface.text.contentassist.IContentAssistProcessor {
	...
	public org.eclipse.jface.text.contentassist.ICompletionProposal[] computeCompletionProposals(org.eclipse.jface.text.ITextViewer viewer, int offset) {
		...
		org.kermeta.kp.editor.ui.KpProposalPostProcessor proposalPostProcessor = new org.kermeta.kp.editor.ui.KpProposalPostProcessor();
		java.util.List<org.kermeta.kp.editor.ui.KpCompletionProposal> computedProposalList = java.util.Arrays.asList(computedProposals);
		java.util.List<org.kermeta.kp.editor.ui.KpCompletionProposal> extendedProposalList = proposalPostProcessor.process(computedProposalList);
		if (extendedProposalList == null) {
			extendedProposalList = java.util.Collections.emptyList();
		}
		java.util.List<org.kermeta.kp.editor.ui.KpCompletionProposal> finalProposalList = new java.util.ArrayList<org.kermeta.kp.editor.ui.KpCompletionProposal>();
		for (org.kermeta.kp.editor.ui.KpCompletionProposal proposal : extendedProposalList) {
		...
		int i = 0;
		for (org.kermeta.kp.editor.ui.KpCompletionProposal proposal : finalProposalList) {
