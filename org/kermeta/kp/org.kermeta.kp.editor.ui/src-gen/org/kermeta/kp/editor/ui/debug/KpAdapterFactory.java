 ...
 * 
 */
package org.kermeta.kp.editor.ui.debug;

@SuppressWarnings("restriction")
public class KpAdapterFactory implements org.eclipse.core.runtime.IAdapterFactory {
	...
	public Object getAdapter(Object adaptableObject, Class adapterType) {
		if (adaptableObject instanceof org.eclipse.ui.texteditor.ITextEditor) {
			...
			if (resource != null) {
				...
				if (extension != null && extension.equals(new org.kermeta.kp.editor.mopp.KpMetaInformation().getSyntaxName())) {
					return new org.kermeta.kp.editor.ui.debug.KpLineBreakpointAdapter();
				}
			}
		}
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementLabelProvider.class && adaptableObject instanceof org.kermeta.kp.editor.debug.KpDebugVariable) {
			final org.kermeta.kp.editor.debug.KpDebugVariable variable = (org.kermeta.kp.editor.debug.KpDebugVariable) adaptableObject;
		...
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementContentProvider.class && adaptableObject instanceof org.kermeta.kp.editor.debug.KpDebugVariable) {
			final org.kermeta.kp.editor.debug.KpDebugVariable variable = (org.kermeta.kp.editor.debug.KpDebugVariable) adaptableObject;
				...
				public void update(org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate[] updates) {
					try {
						for (org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate update : updates) {
							...
							org.kermeta.kp.editor.debug.KpDebugValue castedValue = (org.kermeta.kp.editor.debug.KpDebugValue) value;
