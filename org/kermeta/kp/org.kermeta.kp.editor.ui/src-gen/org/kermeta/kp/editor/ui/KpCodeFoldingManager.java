 ...
 */
public class KpCodeFoldingManager {
	
	private class FoldingUpdateListener implements org.kermeta.kp.editor.IKpBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(org.kermeta.kp.editor.ui.KpEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof org.kermeta.kp.editor.ui.KpEditor) {
				org.kermeta.kp.editor.ui.KpEditor editor = (org.kermeta.kp.editor.ui.KpEditor) workbenchPart;
	...
	protected org.kermeta.kp.editor.ui.KpEditor editor;
	 ...
	 */
	public KpCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,org.kermeta.kp.editor.ui.KpEditor textEditor) {
	...
	private void addCloseListener(final org.kermeta.kp.editor.ui.KpEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			org.kermeta.kp.editor.ui.KpUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		org.kermeta.kp.editor.IKpTextResource textResource = (org.kermeta.kp.editor.IKpTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
