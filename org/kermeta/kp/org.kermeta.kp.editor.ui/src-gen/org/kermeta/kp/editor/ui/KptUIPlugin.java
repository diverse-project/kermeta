 ...
 */
public class KptUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	...
	private static KptUIPlugin plugin;
	...
	public static KptUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, KptUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, KptUIPlugin.PLUGIN_ID, message);
		}
		final KptUIPlugin pluginInstance = KptUIPlugin.getDefault();
