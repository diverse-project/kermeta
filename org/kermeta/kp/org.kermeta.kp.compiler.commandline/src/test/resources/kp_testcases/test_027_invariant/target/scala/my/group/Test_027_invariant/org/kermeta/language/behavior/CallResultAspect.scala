...
trait CallResultAspect extends my.group.`Test_027_invariant`.org.kermeta.language.behavior.CallVariableAspect with `_root_`.org.kermeta.language.behavior.CallResult{
