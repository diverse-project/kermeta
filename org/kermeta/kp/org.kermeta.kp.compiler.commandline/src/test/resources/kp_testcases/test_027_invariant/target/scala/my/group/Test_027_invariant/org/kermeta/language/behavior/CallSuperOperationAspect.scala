...
trait CallSuperOperationAspect extends my.group.`Test_027_invariant`.org.kermeta.language.behavior.CallOperationAspect with `_root_`.org.kermeta.language.behavior.CallSuperOperation{
