...
trait BlockAspect extends my.group.`Test_027_invariant`.org.kermeta.language.behavior.ExpressionAspect with `_root_`.org.kermeta.language.behavior.Block{
def Scalastatement : k2.standard.KermetaOrderedSet[_root_.org.kermeta.language.behavior.Expression]={new k2.standard.RichReflectiveOrderedSet[org.kermeta.language.behavior.Block,_root_.org.kermeta.language.behavior.Expression](thisUpper = -1,value=this.getStatement())}
...
def ScalarescueBlock : k2.standard.KermetaOrderedSet[_root_.org.kermeta.language.behavior.Rescue]={new k2.standard.RichReflectiveOrderedSet[org.kermeta.language.behavior.Block,_root_.org.kermeta.language.behavior.Rescue](thisUpper = -1,value=this.getRescueBlock())}
