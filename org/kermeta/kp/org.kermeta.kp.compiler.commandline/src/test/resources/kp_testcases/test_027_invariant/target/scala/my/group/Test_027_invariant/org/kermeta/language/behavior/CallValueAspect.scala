...
trait CallValueAspect extends my.group.`Test_027_invariant`.org.kermeta.language.behavior.CallExpressionAspect with `_root_`.org.kermeta.language.behavior.CallValue{
