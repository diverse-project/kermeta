...
trait ProductTypeAspect extends my.group.`Test_027_invariant`.org.kermeta.language.structure.TypeContainerAspect with my.group.`Test_027_invariant`.org.kermeta.language.structure.TypeAspect with `_root_`.org.kermeta.language.structure.ProductType{
def Scalatype : k2.standard.KermetaOrderedSet[_root_.org.kermeta.language.structure.Type]={new k2.standard.RichReflectiveOrderedSet[org.kermeta.language.structure.ProductType,_root_.org.kermeta.language.structure.Type](thisUpper = -1,value=this.getType())}
