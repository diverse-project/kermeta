...
trait PrimitiveTypeAspect extends my.group.`Test_027_invariant`.org.kermeta.language.structure.DataTypeAspect with `_root_`.org.kermeta.language.structure.PrimitiveType{
