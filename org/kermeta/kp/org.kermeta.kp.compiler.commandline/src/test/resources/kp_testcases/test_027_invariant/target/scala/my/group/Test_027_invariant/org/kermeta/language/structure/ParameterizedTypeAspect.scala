...
trait ParameterizedTypeAspect extends my.group.`Test_027_invariant`.org.kermeta.language.structure.TypeAspect with `_root_`.org.kermeta.language.structure.ParameterizedType{
def ScalavirtualTypeBinding : k2.standard.KermetaOrderedSet[_root_.org.kermeta.language.structure.TypeVariableBinding]={new k2.standard.RichReflectiveOrderedSet[org.kermeta.language.structure.ParameterizedType,_root_.org.kermeta.language.structure.TypeVariableBinding](thisUpper = -1,value=this.getVirtualTypeBinding())}
...
def ScalatypeParamBinding : k2.standard.KermetaOrderedSet[_root_.org.kermeta.language.structure.TypeVariableBinding]={new k2.standard.RichReflectiveOrderedSet[org.kermeta.language.structure.ParameterizedType,_root_.org.kermeta.language.structure.TypeVariableBinding](thisUpper = -1,value=this.getTypeParamBinding())}
