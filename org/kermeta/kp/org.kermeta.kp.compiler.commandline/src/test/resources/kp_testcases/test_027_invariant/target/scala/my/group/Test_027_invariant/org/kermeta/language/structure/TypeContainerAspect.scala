...
trait TypeContainerAspect extends my.group.`Test_027_invariant`.org.kermeta.language.structure.KermetaModelElementAspect with `_root_`.org.kermeta.language.structure.TypeContainer{
def ScalacontainedType : k2.standard.KermetaSet[_root_.org.kermeta.language.structure.Type]={new k2.standard.RichReflectiveSet[org.kermeta.language.structure.TypeContainer,_root_.org.kermeta.language.structure.Type](thisUpper = -1,value=this.getContainedType())}
