...
trait TypeVariableAspect extends my.group.`Test_027_invariant`.org.kermeta.language.structure.TypeContainerAspect with my.group.`Test_027_invariant`.org.kermeta.language.structure.TypeAspect with my.group.`Test_027_invariant`.org.kermeta.language.structure.NamedElementAspect with `_root_`.org.kermeta.language.structure.TypeVariable{
