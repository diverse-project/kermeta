...
trait GenericTypeDefinitionAspect extends my.group.`Test_027_invariant`.org.kermeta.language.structure.TypeDefinitionAspect with `_root_`.org.kermeta.language.structure.GenericTypeDefinition{
def ScalatypeParameter : k2.standard.KermetaOrderedSet[_root_.org.kermeta.language.structure.TypeVariable]={new k2.standard.RichReflectiveOrderedSet[org.kermeta.language.structure.GenericTypeDefinition,_root_.org.kermeta.language.structure.TypeVariable](thisUpper = -1,value=this.getTypeParameter())}
