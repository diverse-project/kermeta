...
trait VirtualTypeAspect extends my.group.`Test_027_invariant`.org.kermeta.language.structure.ObjectTypeVariableAspect with `_root_`.org.kermeta.language.structure.VirtualType{
...
def ScalatypeParamBinding : k2.standard.KermetaOrderedSet[_root_.org.kermeta.language.structure.TypeVariableBinding]={new k2.standard.RichReflectiveOrderedSet[org.kermeta.language.structure.VirtualType,_root_.org.kermeta.language.structure.TypeVariableBinding](thisUpper = -1,value=this.getTypeParamBinding())}
