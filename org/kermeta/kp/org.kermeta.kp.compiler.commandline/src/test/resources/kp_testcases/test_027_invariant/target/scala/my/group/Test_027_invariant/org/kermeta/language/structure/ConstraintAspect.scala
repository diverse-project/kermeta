...
trait ConstraintAspect extends my.group.`Test_027_invariant`.org.kermeta.language.structure.NamedElementAspect with `_root_`.org.kermeta.language.structure.Constraint{
