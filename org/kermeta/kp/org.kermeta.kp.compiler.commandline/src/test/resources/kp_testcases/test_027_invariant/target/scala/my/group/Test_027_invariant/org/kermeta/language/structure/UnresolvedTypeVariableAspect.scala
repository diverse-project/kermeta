...
trait UnresolvedTypeVariableAspect extends my.group.`Test_027_invariant`.org.kermeta.language.structure.UnresolvedAspect with my.group.`Test_027_invariant`.org.kermeta.language.structure.TypeVariableAspect with `_root_`.org.kermeta.language.structure.UnresolvedTypeVariable{
