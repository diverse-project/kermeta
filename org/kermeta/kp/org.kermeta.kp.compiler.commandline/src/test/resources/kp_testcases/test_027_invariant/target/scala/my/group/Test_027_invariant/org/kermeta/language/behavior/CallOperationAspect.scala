...
trait CallOperationAspect extends my.group.`Test_027_invariant`.org.kermeta.language.behavior.CallFeatureAspect with `_root_`.org.kermeta.language.behavior.CallOperation{
