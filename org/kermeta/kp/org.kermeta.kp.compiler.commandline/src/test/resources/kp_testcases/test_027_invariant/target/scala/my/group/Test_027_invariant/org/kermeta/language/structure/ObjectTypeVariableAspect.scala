...
trait ObjectTypeVariableAspect extends my.group.`Test_027_invariant`.org.kermeta.language.structure.TypeVariableAspect with `_root_`.org.kermeta.language.structure.ObjectTypeVariable{
