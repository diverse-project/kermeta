...
trait OperationAspect extends my.group.`Test_027_invariant`.org.kermeta.language.structure.MultiplicityElementAspect with my.group.`Test_027_invariant`.org.kermeta.language.structure.AbstractOperationAspect with `_root_`.org.kermeta.language.structure.Operation{
...
def ScalaraisedException : k2.standard.KermetaOrderedSet[_root_.org.kermeta.language.structure.Type]={new k2.standard.RichReflectiveOrderedSet[org.kermeta.language.structure.Operation,_root_.org.kermeta.language.structure.Type](thisUpper = -1,value=this.getRaisedException())}
...
def ScalaownedParameter : k2.standard.KermetaOrderedSet[_root_.org.kermeta.language.structure.Parameter]={new k2.standard.RichReflectiveOrderedSet[org.kermeta.language.structure.Operation,_root_.org.kermeta.language.structure.Parameter](thisUpper = -1,value=this.getOwnedParameter())}
...
def Scalapre : k2.standard.KermetaOrderedSet[_root_.org.kermeta.language.structure.Constraint]={new k2.standard.RichReflectiveOrderedSet[org.kermeta.language.structure.Operation,_root_.org.kermeta.language.structure.Constraint](thisUpper = -1,value=this.getPre())}
...
def Scalapost : k2.standard.KermetaOrderedSet[_root_.org.kermeta.language.structure.Constraint]={new k2.standard.RichReflectiveOrderedSet[org.kermeta.language.structure.Operation,_root_.org.kermeta.language.structure.Constraint](thisUpper = -1,value=this.getPost())}
...
def ScalaownedUnresolvedOperations : k2.standard.KermetaOrderedSet[_root_.org.kermeta.language.structure.UnresolvedOperation]={new k2.standard.RichReflectiveOrderedSet[org.kermeta.language.structure.Operation,_root_.org.kermeta.language.structure.UnresolvedOperation](thisUpper = -1,value=this.getOwnedUnresolvedOperations())}
...
def ScalatypeParameter : k2.standard.KermetaOrderedSet[_root_.org.kermeta.language.structure.TypeVariable]={new k2.standard.RichReflectiveOrderedSet[org.kermeta.language.structure.Operation,_root_.org.kermeta.language.structure.TypeVariable](thisUpper = -1,value=this.getTypeParameter())}
