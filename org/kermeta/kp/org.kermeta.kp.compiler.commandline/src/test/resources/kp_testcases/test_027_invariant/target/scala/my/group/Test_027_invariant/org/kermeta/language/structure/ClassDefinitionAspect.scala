...
trait ClassDefinitionAspect extends my.group.`Test_027_invariant`.org.kermeta.language.structure.GenericTypeDefinitionAspect with `_root_`.org.kermeta.language.structure.ClassDefinition{
def Scalainv : k2.standard.KermetaOrderedSet[_root_.org.kermeta.language.structure.Constraint]={new k2.standard.RichReflectiveOrderedSet[org.kermeta.language.structure.ClassDefinition,_root_.org.kermeta.language.structure.Constraint](thisUpper = -1,value=this.getInv())}
...
def ScalaownedAttribute : k2.standard.KermetaSet[_root_.org.kermeta.language.structure.Property]={new k2.standard.RichReflectiveSet[org.kermeta.language.structure.ClassDefinition,_root_.org.kermeta.language.structure.Property](thisUpper = -1,value=this.getOwnedAttribute())}
...
def ScalaownedOperation : k2.standard.KermetaSet[_root_.org.kermeta.language.structure.Operation]={new k2.standard.RichReflectiveSet[org.kermeta.language.structure.ClassDefinition,_root_.org.kermeta.language.structure.Operation](thisUpper = -1,value=this.getOwnedOperation())}
