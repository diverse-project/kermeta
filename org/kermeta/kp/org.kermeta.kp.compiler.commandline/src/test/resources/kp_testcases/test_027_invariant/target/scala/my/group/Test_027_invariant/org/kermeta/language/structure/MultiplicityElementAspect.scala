...
trait MultiplicityElementAspect extends my.group.`Test_027_invariant`.org.kermeta.language.structure.TypedElementAspect with `_root_`.org.kermeta.language.structure.MultiplicityElement{
