 ...
 * <ul>
 *   <li>{@link fr.tm.elibel.smartqvt.qvt.imperativeocl.impl.SwitchExpImpl#getAlternativePart <em>Alternative Part</em>}</li>
 *   <li>{@link fr.tm.elibel.smartqvt.qvt.imperativeocl.impl.SwitchExpImpl#getElsePart <em>Else Part</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SwitchExpImpl extends ImperativeExpressionImpl implements SwitchExp {
	 ...
	 * @ordered
	 */
	protected EList alternativePart;
	 ...
	 * @generated
	 */
	public EList getAlternativePart() {
		if (alternativePart == null) {
			alternativePart = new EObjectContainmentEList(AltExp.class, this, ImperativeoclPackage.SWITCH_EXP__ALTERNATIVE_PART);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ImperativeoclPackage.SWITCH_EXP__ALTERNATIVE_PART:
				...
				getAlternativePart().addAll((Collection)newValue);
				return;
			case ImperativeoclPackage.SWITCH_EXP__ELSE_PART:
