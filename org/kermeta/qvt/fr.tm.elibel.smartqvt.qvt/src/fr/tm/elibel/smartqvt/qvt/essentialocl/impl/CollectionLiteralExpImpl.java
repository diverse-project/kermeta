 ...
 * <ul>
 *   <li>{@link fr.tm.elibel.smartqvt.qvt.essentialocl.impl.CollectionLiteralExpImpl#getKind <em>Kind</em>}</li>
 *   <li>{@link fr.tm.elibel.smartqvt.qvt.essentialocl.impl.CollectionLiteralExpImpl#getPart <em>Part</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CollectionLiteralExpImpl extends LiteralExpImpl implements CollectionLiteralExp {
	...
	public EList getPart() {
		if (part == null) {
			part = new EObjectContainmentWithInverseEList(CollectionLiteralPart.class, this, EssentialoclPackage.COLLECTION_LITERAL_EXP__PART, EssentialoclPackage.COLLECTION_LITERAL_PART__COLLECTION_LITERAL_EXP);
		}
		return part;
	}
