 ...
 * <ul>
 *   <li>{@link fr.tm.elibel.smartqvt.qvt.imperativeocl.impl.DictLiteralExpImpl#getPart <em>Part</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DictLiteralExpImpl extends LiteralExpImpl implements DictLiteralExp {
	...
	public EList getPart() {
		if (part == null) {
			part = new EObjectContainmentEList(DictLiteralPart.class, this, ImperativeoclPackage.DICT_LITERAL_EXP__PART);
		}
		return part;
	}
