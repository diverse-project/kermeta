...
trait CallResultAspect extends org.kermeta.kompren.org.kermeta.kompren.slicer.compiler.org.kermeta.language.behavior.CallVariableAspect with `_root_`.org.kermeta.language.behavior.CallResult{
