...
trait JavaStaticCallAspect extends org.kermeta.kompren.org.kermeta.kompren.slicer.compiler.org.kermeta.language.behavior.ExpressionAspect with `_root_`.org.kermeta.language.behavior.JavaStaticCall{
def Scalaparameters : k2.standard.ReflectiveOrderedSet[org.kermeta.language.behavior.JavaStaticCall,_root_.org.kermeta.language.behavior.Expression]={  new k2.standard.RichReflectiveOrderedSet[org.kermeta.language.behavior.JavaStaticCall,_root_.org.kermeta.language.behavior.Expression](thisUpper = -1,value=this.getParameters())}
