...
trait CallTypeLiteralAspect extends org.kermeta.kompren.org.kermeta.kompren.slicer.compiler.org.kermeta.language.behavior.LiteralAspect with `_root_`.org.kermeta.language.behavior.CallTypeLiteral{
...
def Scalatyperef_=(`~value` : _root_.org.kermeta.language.behavior.TypeReference):Unit={this.setTyperef(`~value`)}
