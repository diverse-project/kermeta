...
trait CallExpressionAspect extends org.kermeta.kompren.org.kermeta.kompren.slicer.compiler.org.kermeta.language.behavior.ExpressionAspect with `_root_`.org.kermeta.language.behavior.CallExpression{
def Scalaparameters : k2.standard.ReflectiveOrderedSet[org.kermeta.language.behavior.CallExpression,_root_.org.kermeta.language.behavior.Expression]={  new k2.standard.RichReflectiveOrderedSet[org.kermeta.language.behavior.CallExpression,_root_.org.kermeta.language.behavior.Expression](thisUpper = -1,value=this.getParameters())}
...
def ScalastaticTypeVariableBindings : k2.standard.ReflectiveOrderedSet[org.kermeta.language.behavior.CallExpression,_root_.org.kermeta.language.structure.Type]={  new k2.standard.RichReflectiveOrderedSet[org.kermeta.language.behavior.CallExpression,_root_.org.kermeta.language.structure.Type](thisUpper = -1,value=this.getStaticTypeVariableBindings())}
