...
trait CallSuperOperationAspect extends org.kermeta.kompren.org.kermeta.kompren.slicer.compiler.org.kermeta.language.behavior.CallOperationAspect with `_root_`.org.kermeta.language.behavior.CallSuperOperation{
