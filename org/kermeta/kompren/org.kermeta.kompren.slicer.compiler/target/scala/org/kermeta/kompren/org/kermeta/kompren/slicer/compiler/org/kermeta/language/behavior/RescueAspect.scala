...
trait RescueAspect extends org.kermeta.kompren.org.kermeta.kompren.slicer.compiler.org.kermeta.language.structure.KermetaModelElementAspect with `_root_`.org.kermeta.language.behavior.Rescue{
def Scalabody : k2.standard.ReflectiveOrderedSet[org.kermeta.language.behavior.Rescue,_root_.org.kermeta.language.behavior.Expression]={  new k2.standard.RichReflectiveOrderedSet[org.kermeta.language.behavior.Rescue,_root_.org.kermeta.language.behavior.Expression](thisUpper = -1,value=this.getBody())}
