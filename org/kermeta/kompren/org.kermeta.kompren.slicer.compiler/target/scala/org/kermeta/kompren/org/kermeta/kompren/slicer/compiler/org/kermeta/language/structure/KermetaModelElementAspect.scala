...
def ScalakOwnedTags : k2.standard.ReflectiveOrderedSet[org.kermeta.language.structure.KermetaModelElement,_root_.org.kermeta.language.structure.Tag]={  new k2.standard.RichReflectiveOrderedSet[org.kermeta.language.structure.KermetaModelElement,_root_.org.kermeta.language.structure.Tag](thisUpper = -1,value=this.getKOwnedTags())}
