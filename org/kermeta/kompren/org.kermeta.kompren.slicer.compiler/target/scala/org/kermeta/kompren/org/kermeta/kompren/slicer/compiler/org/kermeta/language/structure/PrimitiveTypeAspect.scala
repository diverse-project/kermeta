...
trait PrimitiveTypeAspect extends org.kermeta.kompren.org.kermeta.kompren.slicer.compiler.org.kermeta.language.structure.DataTypeAspect with `_root_`.org.kermeta.language.structure.PrimitiveType{
...
def ScalainstanceType_=(`~value` : _root_.org.kermeta.language.structure.Type):Unit={this.setInstanceType(`~value`)}
