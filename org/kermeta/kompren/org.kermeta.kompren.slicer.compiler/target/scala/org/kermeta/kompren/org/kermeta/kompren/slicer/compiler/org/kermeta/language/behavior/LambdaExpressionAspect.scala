...
trait LambdaExpressionAspect extends org.kermeta.kompren.org.kermeta.kompren.slicer.compiler.org.kermeta.language.behavior.ExpressionAspect with `_root_`.org.kermeta.language.behavior.LambdaExpression{
def Scalaparameters : k2.standard.ReflectiveOrderedSet[org.kermeta.language.behavior.LambdaExpression,_root_.org.kermeta.language.behavior.LambdaParameter]={  new k2.standard.RichReflectiveOrderedSet[org.kermeta.language.behavior.LambdaExpression,_root_.org.kermeta.language.behavior.LambdaParameter](thisUpper = -1,value=this.getParameters())}
