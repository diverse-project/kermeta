...
trait UnresolvedCallAspect extends org.kermeta.kompren.org.kermeta.kompren.slicer.compiler.org.kermeta.language.structure.UnresolvedAspect with org.kermeta.kompren.org.kermeta.kompren.slicer.compiler.org.kermeta.language.behavior.CallExpressionAspect with org.kermeta.kompren.org.kermeta.kompren.slicer.compiler.org.kermeta.language.structure.TypeContainerAspect with `_root_`.org.kermeta.language.behavior.UnresolvedCall{
def Scalausings : k2.standard.ReflectiveOrderedSet[org.kermeta.language.behavior.UnresolvedCall,_root_.org.kermeta.language.structure.Using]={  new k2.standard.RichReflectiveOrderedSet[org.kermeta.language.behavior.UnresolvedCall,_root_.org.kermeta.language.structure.Using](thisUpper = -1,value=this.getUsings())}
...
def Scalagenerics : k2.standard.ReflectiveOrderedSet[org.kermeta.language.behavior.UnresolvedCall,_root_.org.kermeta.language.structure.Type]={  new k2.standard.RichReflectiveOrderedSet[org.kermeta.language.behavior.UnresolvedCall,_root_.org.kermeta.language.structure.Type](thisUpper = -1,value=this.getGenerics())}
