...
trait CallOperationAspect extends org.kermeta.kompren.org.kermeta.kompren.slicer.compiler.org.kermeta.language.behavior.CallFeatureAspect with `_root_`.org.kermeta.language.behavior.CallOperation{
...
def ScalastaticOperation_=(`~value` : _root_.org.kermeta.language.structure.Operation):Unit={this.setStaticOperation(`~value`)}
