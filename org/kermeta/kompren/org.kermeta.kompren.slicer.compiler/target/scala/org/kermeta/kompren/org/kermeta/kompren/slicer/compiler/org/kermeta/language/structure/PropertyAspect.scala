...
trait PropertyAspect extends org.kermeta.kompren.org.kermeta.kompren.slicer.compiler.org.kermeta.language.structure.MultiplicityElementAspect with org.kermeta.kompren.org.kermeta.kompren.slicer.compiler.org.kermeta.language.structure.AbstractPropertyAspect with `_root_`.org.kermeta.language.structure.Property{
...
def ScalaownedUnresolvedProperties : k2.standard.ReflectiveOrderedSet[org.kermeta.language.structure.Property,_root_.org.kermeta.language.structure.UnresolvedProperty]={  new k2.standard.RichReflectiveOrderedSet[org.kermeta.language.structure.Property,_root_.org.kermeta.language.structure.UnresolvedProperty](thisUpper = -1,value=this.getOwnedUnresolvedProperties())}
