...
public class PrologFlora extends FloraConstants
{
	...
	commands = (new String[] {
		...
		//String.valueOf(String.valueOf((new StringBuffer("asserta(library_directory('")).append(engine.unescapedFilePath(FloraRootDir)).append("'))"))),
		"consult(flora2)",
		"bootstrap_flora",
    ...
    ** moduleName : name of FLORA module in which to load
    */
    public void addFile(String fileName,String moduleName)
    {
