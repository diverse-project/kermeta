...
${JAVA_BIN}/javac -deprecation -Xlint:unchecked -Xlint -classpath ..:../interprolog.jar net/sourceforge/flora/javaAPI/util/*.java net/sourceforge/flora/javaAPI/src/*.java  
