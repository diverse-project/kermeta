...
public class FloraObject extends FloraConstants
{
    ...
    ** parameters  : the parameters for the method
    */
    public Iterator getproceduralAll(String moduleName, Object methodName,boolean inherit,boolean isDataAtom,Vector parameters)
    {
	String floraQuery = "";
	String paramList = makeParameterListString(parameters);
    ...
    */
	...
	try {
	    ...
	    e.printStackTrace();
	    throw new FlrException("j2flora2: Error in deleteall. Query was "
				   + floraQuery);
	}
    }
    ...
    */
	...
	try {
	    ...
	    e.printStackTrace();
	    throw new FlrException("j2flora2: Error in delete. Query was "
				   + floraQuery);
	}
    }
    ...
    ** parameters  : the parameters for the method
    */
    public Iterator getvalueAll(String moduleName, Object methodName,boolean inherit,boolean isDataAtom,Vector parameters)
    {
	String floraQuery = "";
	String paramList = makeParameterListString(parameters);
    ...
    ** parameters  : the parameters for the method
    */
    public Iterator getvalue(String moduleName,Object methodName,boolean inherit,boolean isDataAtom,Vector parameters)
    {
	String floraQuery = "";
	String paramList = makeParameterListString(parameters);
    ...
    */
	...
	try {
	    ...
	    e.printStackTrace();
	    throw new FlrException("j2flora2: Error in set. Query was "
				   + floraQuery);
	}
    }
    ...
    */
    ...
    public Iterator getInstances(String moduleName)
    {
	String floraQuery =
    ...
    */
    public Iterator getDirectInstances(String moduleName)
    {
    ...
    public Iterator getSubClasses(String moduleName)
    {
	String floraQuery =
    ...
    public Iterator getDirectSubClasses(String moduleName)
    {
    ...
    public Iterator getSuperClasses(String moduleName)
    {
	String floraQuery =
    ...
    public Iterator getDirectSuperClasses(String moduleName)
    {
    ...
    */
    public Iterator getMethods(String moduleName)
    {
	Vector allMethods = new Vector();
		
	Iterator methodIter = getMethods(moduleName,NONINHERITABLE,VALUE);
	while(methodIter.hasNext())
	    allMethods.add((FloraMethod)(methodIter.next()));
    ...
    */
    private Iterator getMethods(String moduleName, boolean inherit, int methType)
    {
	...
	Iterator methodMatches;
	Vector returnMethodVec = new Vector();
	try {
	    methodMatches = session.FindAllMatches(floraQueryString,vars);
	    HashMap firstmatch;
	    while (methodMatches.hasNext()) {	
		firstmatch = (HashMap)methodMatches.next();
	    ...
	    e.printStackTrace();
	    throw new FlrException("j2flora2: Error in getAllMethods. Query was "
				   + floraQueryString);
	}
