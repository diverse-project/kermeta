...
ant -f test/junit/test_io_build.xml -Declipse.home=$ECLIPSE_HOME -Dreport.dir=$REPORTDIR -Dcobertura.dir=/udd/triskell/bin/multiplatform/cobertura-1.7/ -Ddot.or.bin=@dot -Ddot.or.buildclass=@dot
